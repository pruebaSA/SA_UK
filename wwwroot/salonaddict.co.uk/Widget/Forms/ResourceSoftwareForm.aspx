<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResourceSoftwareForm.aspx.cs" Inherits="SalonAddict.Widget.Forms.ResourceSoftwareFormPage" %>
    ...
    <asp:MultiView ID="mv" runat="server" ActiveViewIndex="0" >
       <asp:View ID="v1" runat="server" >
        <p style="margin-bottom:15px;" >
           To obtain your software please contact the SalonAddict sales team on (0) 20 8123 4322 or fill in your details below 
           and have a member of our team contact you directly.
        </p>
       ...
       <asp:View ID="v2" runat="server" >
          <p style="font-size:14px;line-height:20px;" >
             Thank you for considering SalonAddict for your salon. We have received your online inquiry and forwarded your information to one of our representatives who will be in touch with you shortly.
          </p>
       </asp:View>
    </asp:MultiView>
    </form>
