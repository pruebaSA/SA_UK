<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuickSearchCategoryTypeDropDownList.ascx.cs" Inherits="SalonAddict.Administration.Modules.QuickSearchCategoryTypeDropDownList" %>
