<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StaffReviewDetails.ascx.cs" Inherits="SalonAddict.Administration.Modules.StaffReviewDetails" %>
...
<div class="section-header">
    <div class="title">
        ...
        Edit staff review <a href="StaffReviews.aspx" title="Back to staff reviews">(back to reviews list)</a>
    </div>
    <div class="options">
        <asp:Button ID="btnApproveButton" runat="server" Text="Approve" OnClick="ApproveButton_Click" ToolTip="Approve staff review" />
        <asp:Button ID="btnDeleteButton" runat="server" Text="Delete" OnClick="DeleteButton_Click" CausesValidation="false" OnClientClick="return confirm('Are you sure?')" ToolTip="Delete staff review" />
    </div>
</div>
