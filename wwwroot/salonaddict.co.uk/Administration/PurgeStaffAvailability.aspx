<%@ Page Language="C#" MasterPageFile="~/Administration/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="PurgeStaffAvailability.aspx.cs" Inherits="SalonAddict.Administration.PurgeStaffAvailability" %>
...
<div class="section-header">
    <div class="title">
        ...
        Purge Staff Availability
    </div>
    <div class="options">
        <asp:Button ID="btnPurge" runat="server" Text="Purge" ToolTip="Purge Guest Orders" OnClick="btnPurge_Click" />
    </div>
</div>
    ...
    <tr>
        <td class="title">
            <SA:ToolTipLabel 
                ...
                Text="Start date:"
                IsRequired="true"
                ToolTip="The start date of the orders to purge."
    ...
    <tr>
        <td class="title">
            <SA:ToolTipLabel 
                ...
                Text="End date:"
                IsRequired="true"
                ToolTip="The end date of the orders to purge."
                ToolTipImage="~/Administration/images/ico-help.gif" />
        </td>
        <td class="data-item">
