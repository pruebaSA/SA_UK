<%@ Page Language="C#" MasterPageFile="~/Administration/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="PurgeLeads.aspx.cs" Inherits="SalonAddict.Administration.PurgeLeads" %>
...
<div class="section-header">
    ...
    <div class="options">
        <asp:Button ID="btnPurge" runat="server" Text="Purge" ToolTip="Purge Leads" OnClick="btnPurge_Click" />
    </div>
</div>
    ...
    <tr>
        <td class="title">
            <SA:ToolTipLabel 
                ...
                Text="Start date:"
                IsRequired="true"
                ToolTip="The start date of the leads to purge."
                ToolTipImage="~/Administration/images/ico-help.gif" />
        </td>
        <td class="data-item">
    ...
    <tr>
        <td class="title">
            <SA:ToolTipLabel 
                ...
                Text="End date:"
                IsRequired="true"
                ToolTip="The end date of the leads to purge."
                ToolTipImage="~/Administration/images/ico-help.gif" />
        </td>
        <td class="data-item">
