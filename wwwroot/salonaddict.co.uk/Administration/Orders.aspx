<%@ Page Language="C#" MasterPageFile="~/Administration/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="SalonAddict.Administration.Orders" %>
...
<table class="details" cellpadding="0" cellspacing="0" >
    ...
    <tr>
        ...
        <td class="data-item">
            <SA:OrderStatusList ID="ddlOrderStatus" runat="server" />
        </td>
    </tr>
    <tr>
        <td class="title">
