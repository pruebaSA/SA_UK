<%@ Page Language="C#" MasterPageFile="~/MasterPages/TwoColumn.master" AutoEventWireup="true" CodeBehind="Appointments.aspx.cs" Inherits="SalonPortal.SecureArea.Appointments1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TwoColumnContentPlaceHolder" runat="server">
   <div style="position:relative" class="section-header">
        ...
        <div style="position:absolute;top:5px;right:10px;" >
            ...
            <asp:LinkButton ID="lbViewToday" runat="server" OnClick="lbViewToday_Click" >
                <%= base.GetLocalResourceObject("Label.View.Today") %>
            </asp:LinkButton>
             | <b class="highlight" ><%= base.GetLocalResourceObject("Label.View.All") %></b>
        </div>
   </div>
                ...
                <table cellpadding="0" cellspacing="0" Width="700px"  >
                   ...
                   <tr>
                      <td class="altcol-style">
                          <%# (((DateTime)Eval("Time.StartsOn")).Date.CompareTo(DateTime.Now.Date) == 0)? base.GetLocalResourceObject("gvAppointments.Label.Today") : ((DateTime)Eval("Time.StartsOn")).ToShortDateString() %>
                      </td>
