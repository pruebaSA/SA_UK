namespace System.Xml.Linq
{
    ...
    public abstract class XNode : XObject
    {
        ...
        public XmlReader CreateReader() => 
            new XNodeReader(this, null);

        internal abstract bool DeepEquals(XNode node);
        public static bool DeepEquals(XNode n1, XNode n2) => 
            ((n1 == n2) || (((n1 != null) && (n2 != null)) && n1.DeepEquals(n2)));

        public IEnumerable<XElement> ElementsAfterSelf() => 
            this.GetElementsAfterSelf(null);
        ...
        public IEnumerable<XElement> ElementsBeforeSelf() => 
            this.GetElementsBeforeSelf(null);
        ...
        public bool IsAfter(XNode node) => 
            (CompareDocumentOrder(this, node) > 0);
