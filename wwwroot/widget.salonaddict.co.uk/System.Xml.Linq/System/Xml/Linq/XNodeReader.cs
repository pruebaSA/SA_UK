    ...
    internal class XNodeReader : XmlReader, IXmlLineInfo
    {
        ...
        public override bool MoveToNextAttribute()
        {
            if (this.IsInteractive)
            {
                ...
                if (source != null)
                {
                    if (!this.IsEndElement && (source.lastAttr != null))
                    {
        ...
        {
            IXmlLineInfo info = this.IsEndElement ? null : (this.source as IXmlLineInfo);
        ...
        public override bool HasAttributes
        {
            get
            {
                ...
                XElement elementInAttributeScope = this.GetElementInAttributeScope();
                return ((elementInAttributeScope != null) && (elementInAttributeScope.lastAttr != null));
            }
        }
        ...
        public override string LocalName =>
            this.nameTable.Add(this.GetLocalName());
        ...
        public override string NamespaceURI =>
            this.nameTable.Add(this.GetNamespaceURI());
        ...
        public override string Prefix =>
            this.nameTable.Add(this.GetPrefix());
