namespace System.Xml.Linq
{
    ...
    public sealed class XNamespace
    {
        ...
        public static XNamespace None =>
            EnsureNamespace(ref refNone, string.Empty);

        public static XNamespace Xml =>
            EnsureNamespace(ref refXml, "http://www.w3.org/XML/1998/namespace");

        public static XNamespace Xmlns =>
            EnsureNamespace(ref refXmlns, "http://www.w3.org/2000/xmlns/");
    }
}
