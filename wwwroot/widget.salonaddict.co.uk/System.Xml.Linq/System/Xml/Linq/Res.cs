namespace System.Xml.Linq
{
    ...
    internal sealed class Res
    {
        ...
        private static System.Xml.Linq.Res loader;
        ...
        private static System.Xml.Linq.Res GetLoader()
        {
            if (loader == null)
            {
                System.Xml.Linq.Res res = new System.Xml.Linq.Res();
                Interlocked.CompareExchange<System.Xml.Linq.Res>(ref loader, res, null);
            }
            return loader;
        }
        ...
        {
            System.Xml.Linq.Res loader = GetLoader();
            if (loader == null)
            {
                return null;
            }
