namespace System.Deployment.Internal.CodeSigning
{
    ...
    internal class SignedCmiManifest
    {
        ...
        private static byte[] ComputeHashFromManifest(XmlDocument manifestDom) => 
            ComputeHashFromManifest(manifestDom, false);
        ...
        private static void InsertPublisherIdentity(XmlDocument manifestDom, X509Certificate2 signerCert)
        {
            ...
            if (manifestDom.SelectSingleNode("asm:assembly/asm2:publisherIdentity", nsmgr) == null)
            {
                ...
                XmlElement newChild = manifestDom.CreateElement("publisherIdentity", "urn:schemas-microsoft-com:asm.v2");
