namespace System.Deployment.Application
{
    ...
    internal class PEStream : Stream
    {
        ...
        public bool IsImageFileDll =>
            this._fileHeader.IsImageFileDll;
        ...
        protected class DataDirectory : PEStream.PEComponent
        {
            ...
            public uint VirtualAddress =>
                this._dataDirectory.VirtualAddress;
        }
        ...
        protected class FileHeader : PEStream.PEComponent
        {
            ...
            public bool IsImageFileDll =>
                ((this._fileHeader.Characteristics & 0x2000) != 0);

            public ushort NumberOfSections =>
                this._fileHeader.NumberOfSections;

            public ushort SizeOfOptionalHeader =>
                this._fileHeader.SizeOfOptionalHeader;
        }
        ...
        protected class ResourceDirectory : PEStream.ResourceComponent
        {
            ...
            public int ResourceComponentCount =>
                this._resourceDirectoryItems.Count;
        }
        ...
        protected class ResourceDirectoryEntry : PEStream.ResourceComponent
        {
            ...
            public ushort Id =>
                ((ushort) (this._imageResourceDirectoryEntry.Name & 0xffff));

            public bool IsDirectory =>
                ((this._imageResourceDirectoryEntry.OffsetToData & 0x80000000) != 0);
            ...
            public bool NameIsString =>
                ((this._imageResourceDirectoryEntry.Name & 0x80000000) != 0);

            public long NameOffset =>
                ((long) (this._imageResourceDirectoryEntry.Name & 0x7fffffff));

            public long OffsetToData =>
                ((long) (this._imageResourceDirectoryEntry.OffsetToData & 0x7fffffff));
        }
        ...
        protected class SectionHeader : PEStream.PEComponent
        {
            ...
            public uint PointerToRawData =>
                this._imageSectionHeader.PointerToRawData;
            ...
            public uint SizeOfRawData =>
                this._imageSectionHeader.SizeOfRawData;

            public uint VirtualAddress =>
                this._imageSectionHeader.VirtualAddress;
        }
