namespace System.Deployment.Application
{
    ...
    [StructLayout(LayoutKind.Sequential), Guid("33246f92-d56f-4e34-837a-9a49bfc91df3"), ClassInterface(ClassInterfaceType.AutoDispatch), ComVisible(true), PermissionSet(SecurityAction.Demand, Name="FullTrust")]
                ...
                finally
                {
                    ...
                    if ((((maintenanceInfo.maintenanceFlags & MaintenanceFlags.RestoreSelected) != MaintenanceFlags.ClearFlag) && flag2) || ((((maintenanceInfo.maintenanceFlags & MaintenanceFlags.RemoveSelected) != MaintenanceFlags.ClearFlag) && flag4) && flag2))
                    {
                        ...
                        if ((errorReportUrl != null) && (exception != null))
                        {
                            ...
                            linkUrl = $"{errorReportUrl}?outer={exception.GetType().ToString()}&&inner={innerMostException.GetType().ToString()}&&msg={innerMostException.Message}";
