    ...
    internal class AssemblyManifest
    {
        ...
        internal static CertificateStatus AnalyzeManifestCertificate(string manifestPath)
        {
            ...
            try
            {
                ...
                {
                    return CertificateStatus.NoCertificate;
                }
                return CertificateStatus.TrustedPublisher;
            }
            catch (Exception exception)
            {
                ...
                {
                    case -2146762479:
                        return CertificateStatus.DistrustedPublisger;

                    case -2146885616:
                        return CertificateStatus.RevokedCertificate;

                    case -2146762748:
                        return CertificateStatus.AuthenticodedNotInTrustedList;
                }
                return CertificateStatus.NoCertificate;
            }
        }
        ...
        private static bool IsInvalidHash(HashCollection hashCollection) => 
            !ComponentVerifier.IsVerifiableHashCollection(hashCollection);

        private static bool IsResourceReference(DependentAssembly dependentAssembly) => 
            (((dependentAssembly.ResourceFallbackCulture != null) && (dependentAssembly.Identity != null)) && (dependentAssembly.Identity.Culture == null));
        ...
        internal void ValidateSemanticsForDeploymentRole()
        {
            ...
            {
                throw new InvalidDeploymentException(ExceptionTypes.ManifestSemanticValidation, Resources.GetString("Ex_SemanticallyInvalidDeploymentManifest"), exception);
            }
        }
        ...
        public DependentAssembly[] DependentAssemblies
        {
            get
            {
                ...
                {
                    System.Deployment.Internal.Isolation.ISection assemblyReferenceSection = this._cms?.AssemblyReferenceSection;
                    ...
                    if (celt > 0)
                    {
                        ...
                        System.Deployment.Internal.Isolation.IEnumUnknown unknown = (System.Deployment.Internal.Isolation.IEnumUnknown) assemblyReferenceSection._NewEnum;
        ...
        public EntryPoint[] EntryPoints
        {
            get
            {
                ...
                {
                    System.Deployment.Internal.Isolation.ISection entryPointSection = this._cms?.EntryPointSection;
                    uint celt = (entryPointSection != null) ? entryPointSection.Count : 0;
                    ...
                    if (celt > 0)
                    {
                        ...
                        System.Deployment.Internal.Isolation.IEnumUnknown unknown = (System.Deployment.Internal.Isolation.IEnumUnknown) entryPointSection._NewEnum;
                        Marshal.ThrowExceptionForHR(unknown.Next(celt, rgelt, ref celtFetched));
                        if (celtFetched != celt)
                        {
                            throw new InvalidDeploymentException(ExceptionTypes.Manifest, Resources.GetString("Ex_IsoEnumFetchNotEqualToCount"));
        ...
        public FileAssociation[] FileAssociations
        {
            get
            {
                ...
                {
                    System.Deployment.Internal.Isolation.ISection fileAssociationSection = this._cms?.FileAssociationSection;
                    uint celt = (fileAssociationSection != null) ? fileAssociationSection.Count : 0;
                    ...
                    if (celt > 0)
                    {
                        ...
                        System.Deployment.Internal.Isolation.IEnumUnknown unknown = (System.Deployment.Internal.Isolation.IEnumUnknown) fileAssociationSection._NewEnum;
                        Marshal.ThrowExceptionForHR(unknown.Next(celt, rgelt, ref celtFetched));
                        if (celtFetched != celt)
                        {
                            throw new InvalidDeploymentException(ExceptionTypes.Manifest, Resources.GetString("Ex_IsoEnumFetchNotEqualToCount"));
        ...
        public System.Deployment.Application.Manifest.File[] Files
        {
            get
            {
                if (this._files == null)
                {
                    System.Deployment.Internal.Isolation.ISection fileSection = this._cms?.FileSection;
                    uint celt = (fileSection != null) ? fileSection.Count : 0;
                    ...
                    if (celt > 0)
                    {
                        ...
                        System.Deployment.Internal.Isolation.IEnumUnknown unknown = (System.Deployment.Internal.Isolation.IEnumUnknown) fileSection._NewEnum;
                        Marshal.ThrowExceptionForHR(unknown.Next(celt, rgelt, ref celtFetched));
                        if (celtFetched != celt)
                        {
                            throw new InvalidDeploymentException(ExceptionTypes.Manifest, Resources.GetString("Ex_IsoEnumFetchNotEqualToCount"));
        ...
        public bool Id1ManifestPresent =>
            this._id1ManifestPresent;

        public string Id1RequestedExecutionLevel =>
            this._id1RequestedExecutionLevel;
        ...
        protected class ManifestParseErrors : System.Deployment.Internal.Isolation.IManifestParseErrorCallback, IEnumerable
        {
            ...
            public class ParseErrorEnumerator : IEnumerator
            {
                ...
                public AssemblyManifest.ManifestParseErrors.ManifestParseError Current =>
                    ((AssemblyManifest.ManifestParseErrors.ManifestParseError) this._manifestParseErrors._parsingErrors[this._index]);

                object IEnumerator.Current =>
                    this._manifestParseErrors._parsingErrors[this._index];
            }
        }
