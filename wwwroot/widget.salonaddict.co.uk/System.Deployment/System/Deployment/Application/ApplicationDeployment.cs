namespace System.Deployment.Application
{
    ...
    public sealed class ApplicationDeployment
    {
        ...
        public UpdateCheckInfo CheckForDetailedUpdate() => 
            this.CheckForDetailedUpdate(true);
        ...
        public bool CheckForUpdate(bool persistUpdateCheckResult) => 
            this.CheckForDetailedUpdate(persistUpdateCheckResult).UpdateAvailable;
        ...
        public bool IsFileGroupDownloaded(string groupName) => 
            this._subStore.CheckGroupInstalled(this._subState, this._fullAppId, groupName);
        ...
        public bool IsFirstRun =>
            InternalActivationContextHelper.IsFirstRun(AppDomain.CurrentDomain.ActivationContext);
