namespace System.Deployment.Application
{
    ...
    internal class ProgressPiece : FormPiece, IDownloadNotification
    {
        ...
        private static string FormatProgressText(long completed, long total) => 
            string.Format(CultureInfo.CurrentUICulture, Resources.GetString("UI_ProgressText"), new object[] { FormatBytes(completed), FormatBytes(total) });
        ...
        private void InitializeComponent()
        {
            ...
            this.overarchingTableLayoutPanel.MinimumSize = new Size(0x1f2, 240);
