namespace System.Deployment.Application
{
    ...
    internal class DefinitionIdentity : ICloneable
    {
        ...
        public object Clone() => 
            new System.Deployment.Application.DefinitionIdentity(this._idComPtr.Clone(IntPtr.Zero, null));

        public override bool Equals(object obj) => 
            ((obj is System.Deployment.Application.DefinitionIdentity) && System.Deployment.Internal.Isolation.IsolationInterop.IdentityAuthority.AreDefinitionsEqual(0, this.ComPointer, ((System.Deployment.Application.DefinitionIdentity) obj).ComPointer));

        public override int GetHashCode() => 
            ((int) this.Hash);

        public bool Matches(System.Deployment.Application.ReferenceIdentity refId, bool exact) => 
            (System.Deployment.Internal.Isolation.IsolationInterop.IdentityAuthority.DoesDefinitionMatchReference(exact ? 1 : 0, this._idComPtr, refId.ComPointer) && (this.Version == refId.Version));
        ...
        public override string ToString() => 
            System.Deployment.Internal.Isolation.IsolationInterop.IdentityAuthority.DefinitionToText(0, this._idComPtr);
        ...
        public ulong Hash =>
            System.Deployment.Internal.Isolation.IsolationInterop.IdentityAuthority.HashDefinition(0, this._idComPtr);
        ...
        {
            get => 
                this._idComPtr.GetAttribute(null, name);
            set
            {
        ...
        public string KeyForm =>
            System.Deployment.Internal.Isolation.IsolationInterop.IdentityAuthority.GenerateDefinitionKey(0, this._idComPtr);
