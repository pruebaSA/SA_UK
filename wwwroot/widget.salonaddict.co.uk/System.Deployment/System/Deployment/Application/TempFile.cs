namespace System.Deployment.Application
{
    ...
    internal class TempFile : DisposableBase
    {
        ...
        public TempFile(string basePath, string suffix)
        {
            do
            {
                this._thePath = System.IO.Path.Combine(basePath, PathHelper.GenerateRandomPath(2) + suffix);
            }
        ...
        {
            string rootSegmentPath = PathHelper.GetRootSegmentPath(this._thePath, 2);
