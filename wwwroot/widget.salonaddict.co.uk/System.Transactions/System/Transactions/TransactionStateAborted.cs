namespace System.Transactions
{
    ...
    internal class TransactionStateAborted : TransactionStateEnded
    {
        ...
        private TransactionException CreateTransactionAbortedException(InternalTransaction tx) => 
            TransactionAbortedException.Create(System.Transactions.SR.GetString("TraceSourceLtm"), System.Transactions.SR.GetString("TransactionAborted"), tx.innerException);
