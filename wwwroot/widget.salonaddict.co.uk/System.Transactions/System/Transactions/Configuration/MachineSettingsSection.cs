namespace System.Transactions.Configuration
{
    ...
    public sealed class MachineSettingsSection : ConfigurationSection
    {
        ...
        protected override ConfigurationPropertyCollection Properties =>
            new ConfigurationPropertyCollection { new ConfigurationProperty("maxTimeout", typeof(TimeSpan), "00:10:00", null, new TimeSpanValidator(TimeSpan.Zero, TimeSpan.MaxValue), ConfigurationPropertyOptions.None) };
    }
}
