namespace System.Web.Services.Discovery
{
    ...
    public class ContractReference : DiscoveryReference
    {
        ...
        public override object ReadDocument(Stream stream) => 
            ServiceDescription.Read(stream, true);
        ...
        protected internal override void Resolve(string contentType, Stream stream)
        {
            ...
            foreach (string str in list)
            {
                ...
                if (base.ClientProtocol.Documents[url] == null)
                {
                    ...
                    {
                        throw new InvalidDocumentContentsException(System.Web.Services.Res.GetString("TheWSDLDocumentContainsLinksThatCouldNotBeResolved", new object[] { url }), null);
                    }
                }
            }
        }
