namespace System.Web.Services.Discovery
{
    ...
    public sealed class DiscoveryDocument
    {
        ...
        public static bool CanRead(XmlReader xmlReader) => 
            WebServicesSection.Current.DiscoveryDocumentSerializer.CanDeserialize(xmlReader);
        ...
        public static DiscoveryDocument Read(XmlReader xmlReader) => 
            ((DiscoveryDocument) WebServicesSection.Current.DiscoveryDocumentSerializer.Deserialize(xmlReader));
