    ...
    internal class HttpClientType
    {
        ...
        internal HttpClientType(Type type)
        {
            ...
            for (int i = 0; i < infoArray.Length; i++)
            {
                ...
                {
                    throw new InvalidOperationException(Res.GetString("WebReflectionError", new object[] { info.DeclaringType.FullName, info.Name }), null);
                }
            }
        ...
        internal HttpClientMethod GetMethod(string name) => 
            ((HttpClientMethod) this.methods[name]);
    }
}
