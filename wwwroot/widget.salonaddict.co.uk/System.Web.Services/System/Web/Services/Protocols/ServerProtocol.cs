namespace System.Web.Services.Protocols
{
    ...
    public abstract class ServerProtocol
    {
        ...
        private string CreateKey(System.Type protocolType, System.Type serverType)
        {
            ...
            int capacity = (((fullName.Length + urlKeyComponent.Length) + str2.Length) + str3.Length) + 2;
            StringBuilder builder = new StringBuilder(capacity);
            builder.Append(fullName);
            builder.Append('[');
            builder.Append(urlKeyComponent);
            builder.Append(']');
            builder.Append(str2);
            builder.Append(str3);
        ...
        internal string GenerateFaultString(Exception e) => 
            this.GenerateFaultString(e, false);
        ...
        protected object GetFromCache(System.Type protocolType, System.Type serverType) => 
            HttpRuntime.Cache.Get(this.CreateKey(protocolType, serverType));

        internal virtual string GetUrlKeyComponent() => 
            this.Request.Url.GetLeftPart(UriPartial.Path);
