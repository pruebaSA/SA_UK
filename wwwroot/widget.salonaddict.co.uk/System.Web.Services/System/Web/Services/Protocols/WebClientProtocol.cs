namespace System.Web.Services.Protocols
{
    ...
    public abstract class WebClientProtocol : Component
    {
        ...
        private static void GetRequestStreamAsyncCallback(IAsyncResult asyncResult)
        {
            ...
            {
                ProcessAsyncException(asyncState, new Exception(Res.GetString("NonClsCompliantException")), "GetRequestStreamAsyncCallback");
            }
        }
        ...
        private static void GetResponseAsyncCallback(IAsyncResult asyncResult)
        {
            ...
            {
                ProcessAsyncException(asyncState, new Exception(Res.GetString("NonClsCompliantException")), "GetResponseAsyncCallback");
                if (asyncState.Response == null)
                {
                    return;
                }
        ...
        private static void ReadResponseAsyncCallback(IAsyncResult asyncResult)
        {
            ...
            if (!asyncResult.CompletedSynchronously)
            {
                ...
                {
                    ProcessAsyncException(asyncState, new Exception(Res.GetString("NonClsCompliantException")), "ReadResponseAsyncCallback");
                }
            }
        }
        ...
        [WebServicesDescription("ClientProtocolPreAuthenticate"), DefaultValue(false)]
        ...
        [WebServicesDescription("ClientProtocolEncoding"), RecommendedAsConfigurable(true), DefaultValue((string) null)]
        ...
        [DefaultValue(0x186a0), WebServicesDescription("ClientProtocolTimeout"), RecommendedAsConfigurable(true)]
        public int Timeout
        {
            get => 
                this.timeout;
        ...
        [DefaultValue(""), RecommendedAsConfigurable(true), WebServicesDescription("ClientProtocolUrl")]
        public string Url
        {
            get
            {
