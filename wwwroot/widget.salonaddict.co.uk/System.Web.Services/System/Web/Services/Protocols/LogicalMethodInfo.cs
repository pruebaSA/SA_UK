namespace System.Web.Services.Protocols
{
    ...
    public sealed class LogicalMethodInfo
    {
        ...
        internal static bool CanMerge(Type type) => 
            ((type == typeof(SoapHeaderAttribute)) || typeof(SoapExtensionAttribute).IsAssignableFrom(type));
        ...
        public static bool IsBeginMethod(System.Reflection.MethodInfo methodInfo) => 
            (typeof(IAsyncResult).IsAssignableFrom(methodInfo.ReturnType) && methodInfo.Name.StartsWith("Begin", StringComparison.Ordinal));
