namespace System.Web.Services.Protocols
{
    ...
    internal class ContentType
    {
        ...
        internal static string Compose(string contentType, Encoding encoding) => 
            Compose(contentType, encoding, null);
        ...
        internal static string GetAction(string contentType) => 
            GetParameter(contentType, "action");
        ...
        internal static string GetCharset(string contentType) => 
            GetParameter(contentType, "charset");
        ...
        internal static bool IsApplication(string contentType) => 
            (string.Compare(GetMediaType(contentType), "application", StringComparison.OrdinalIgnoreCase) == 0);

        internal static bool IsHtml(string contentType) => 
            (string.Compare(GetBase(contentType), "text/html", StringComparison.OrdinalIgnoreCase) == 0);
        ...
        internal static bool MatchesBase(string contentType, string baseContentType) => 
            (string.Compare(GetBase(contentType), baseContentType, StringComparison.OrdinalIgnoreCase) == 0);
    }
}
