namespace System.Web.Services.Protocols
{
    ...
    public class SoapException : SystemException
    {
        ...
        private static SoapException CreateSuppressedException(SoapProtocolVersion soapVersion, string message, Exception innerException) => 
            new SoapException(System.Web.Services.Res.GetString("WebSuppressedExceptionMessage"), (soapVersion == SoapProtocolVersion.Soap12) ? new XmlQualifiedName("Receiver", "http://www.w3.org/2003/05/soap-envelope") : new XmlQualifiedName("Server", "http://schemas.xmlsoap.org/soap/envelope/"));
