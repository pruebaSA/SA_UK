namespace System.Web.Services.Protocols
{
    ...
    public class SoapServerProtocol : ServerProtocol
    {
        ...
        internal override bool Initialize()
        {
            ...
            {
                innerException = new Exception(System.Web.Services.Res.GetString("NonClsCompliantException"));
            }
        ...
        internal bool IsSupported(WebServiceProtocols protocol) => 
            ((this.protocolsSupported & protocol) == protocol);
        ...
        internal override object[] ReadParameters()
        {
            ...
            {
                throw new SoapException(System.Web.Services.Res.GetString("WebRequestUnableToRead"), new XmlQualifiedName("Client", "http://schemas.xmlsoap.org/soap/envelope/"), new Exception(System.Web.Services.Res.GetString("NonClsCompliantException")));
            }
            return objArray2;
        }

        protected virtual SoapServerMethod RouteRequest(SoapServerMessage message) => 
            this.helper.RouteRequest();
        ...
        internal override bool WriteException(Exception e, Stream outputStream)
        {
            ...
            if (!flag)
            {
                ...
                catch
                {
                    if (!extensionStream.HasWritten)
                    {
                        exception4 = SoapException.Create(this.Version, System.Web.Services.Res.GetString("WebExtensionError"), new XmlQualifiedName("Server", "http://schemas.xmlsoap.org/soap/envelope/"), null);
                    }
                    return false;
                }
                if (exception4 != null)
        ...
        internal override LogicalMethodInfo MethodInfo =>
            this.serverMethod.methodInfo;

        internal override Exception OnewayInitException =>
            this.onewayInitException;
