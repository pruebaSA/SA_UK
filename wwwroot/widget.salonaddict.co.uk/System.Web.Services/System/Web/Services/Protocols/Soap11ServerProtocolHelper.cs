    ...
    internal class Soap11ServerProtocolHelper : SoapServerProtocolHelper
    {
        ...
        internal override SoapServerMethod RouteRequest()
        {
            ...
            else
            {
                ...
                {
                    throw new SoapException(System.Web.Services.Res.GetString("TheRootElementForTheRequestCouldNotBeDetermined0"), new XmlQualifiedName("Server", "http://schemas.xmlsoap.org/soap/envelope/"), null);
                }
            }
