namespace System.Web.Services.Protocols
{
    ...
    public abstract class HttpSimpleClientProtocol : HttpWebClientProtocol
    {
        ...
        protected void InvokeAsync(string methodName, string requestUrl, object[] parameters, SendOrPostCallback callback, object userState)
        {
            ...
            {
                Exception exception3 = new ArgumentException(Res.GetString("AsyncDuplicateUserState"), new Exception(Res.GetString("NonClsCompliantException")));
            ...
            catch (Exception exception4)
            {
                ...
                if (Tracing.On)
                {
                    Tracing.ExceptionCatch(TraceEventType.Error, this, "InvokeAsync", exception4);
                }
            ...
            catch
            {
                ...
                base.OperationCompleted(userState, objArray4, new Exception(Res.GetString("NonClsCompliantException")), false);
            }
        }
