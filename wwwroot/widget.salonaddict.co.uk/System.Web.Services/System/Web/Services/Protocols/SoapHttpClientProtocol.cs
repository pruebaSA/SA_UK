namespace System.Web.Services.Protocols
{
    ...
    public class SoapHttpClientProtocol : HttpWebClientProtocol
    {
        ...
        protected void InvokeAsync(string methodName, object[] parameters, SendOrPostCallback callback, object userState)
        {
            ...
            {
                Exception exception3 = new ArgumentException(System.Web.Services.Res.GetString("AsyncDuplicateUserState"), new Exception(System.Web.Services.Res.GetString("NonClsCompliantException")));
                object[] objArray2 = new object[1];
                InvokeCompletedEventArgs args2 = new InvokeCompletedEventArgs(objArray2, exception3, false, userState);
                userAsyncState.PostOperationCompleted(callback, args2);
                return;
            }
            try
            {
            ...
            catch (Exception exception4)
            {
                ...
                if (Tracing.On)
                {
                    Tracing.ExceptionCatch(TraceEventType.Warning, this, "InvokeAsync", exception4);
                }
                object[] objArray3 = new object[1];
                base.OperationCompleted(userState, objArray3, exception4, false);
            }
            catch
            {
                object[] objArray4 = new object[1];
                base.OperationCompleted(userState, objArray4, new Exception(System.Web.Services.Res.GetString("NonClsCompliantException")), false);
            }
        }
        ...
        private void InvokeAsyncCallback(IAsyncResult result)
        {
            ...
            if (asyncResult.Request != null)
            {
                ...
                {
                    e = new Exception(System.Web.Services.Res.GetString("NonClsCompliantException"));
                }
                finally
                {
                    if (responseStream != null)
