namespace System.Web.Services.Description
{
    ...
    [XmlRoot("definitions", Namespace="http://schemas.xmlsoap.org/wsdl/"), XmlFormatExtensionPoint("Extensions")]
    public sealed class ServiceDescription : NamedItem
    {
        ...
        internal class ServiceDescriptionSerializer : XmlSerializer
        {
            public override bool CanDeserialize(XmlReader xmlReader) => 
                xmlReader.IsStartElement("definitions", "http://schemas.xmlsoap.org/wsdl/");

            protected override XmlSerializationReader CreateReader() => 
                new ServiceDescriptionSerializationReader();

            protected override XmlSerializationWriter CreateWriter() => 
                new ServiceDescriptionSerializationWriter();

            protected override object Deserialize(XmlSerializationReader reader) => 
                ((ServiceDescriptionSerializationReader) reader).Read125_definitions();
