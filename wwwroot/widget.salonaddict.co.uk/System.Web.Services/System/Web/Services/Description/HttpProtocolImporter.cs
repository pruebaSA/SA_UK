namespace System.Web.Services.Description
{
    ...
    internal abstract class HttpProtocolImporter : ProtocolImporter
    {
        ...
        protected override CodeTypeDeclaration BeginClass()
        {
            ...
            string location = binding?.Location;
            ServiceDescription serviceDescription = base.Binding.ServiceDescription;
            ProtocolImporterUtil.GenerateConstructorStatements(ctor, location, serviceDescription.AppSettingUrlKey, serviceDescription.AppSettingBaseUrl, false);
