namespace System.Web.Services.Description
{
    ...
    public abstract class ProtocolImporter
    {
        ...
        private void GenerateClassForBinding()
        {
            try
            {
                ...
                for (int i = 0; i < this.portType.Operations.Count; i++)
                {
                    ...
                    {
                        throw new InvalidOperationException(System.Web.Services.Res.GetString("UnableToImportOperation1", new object[] { this.operation.Name }), null);
                    }
                    if (method != null)
                    {
            ...
            {
                throw new InvalidOperationException(System.Web.Services.Res.GetString("UnableToImportBindingFromNamespace2", new object[] { this.binding.Name, this.binding.ServiceDescription.TargetNamespace }), null);
            }
        }
        ...
        public Exception OperationBindingSyntaxException(string text) => 
            new Exception(System.Web.Services.Res.GetString("TheOperationBindingFromNamespaceHadInvalid3", new object[] { this.operationBinding.Name, this.operationBinding.Binding.ServiceDescription.TargetNamespace, text }));

        public Exception OperationSyntaxException(string text) => 
            new Exception(System.Web.Services.Res.GetString("TheOperationFromNamespaceHadInvalidSyntax3", new object[] { this.operation.Name, this.operation.PortType.Name, this.operation.PortType.ServiceDescription.TargetNamespace, text }));
        ...
        public CodeIdentifiers ClassNames =>
            this.importContext.TypeIdentifiers;
        ...
        public string MethodName =>
            CodeIdentifier.MakeValid(XmlConvert.DecodeName(this.Operation.Name));
