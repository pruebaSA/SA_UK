            ...
            foreach (OperationBinding binding5 in binding.Operations)
            {
                ...
                if (name != null)
                {
                    ...
                    if (binding5.Input != null)
                    {
                        ...
                        {
                            Message message = (operation2?.Messages.Input == null) ? null : descriptions.GetMessage(operation2?.Messages.Input.Message);
                    ...
                    if (binding5.Output != null)
                    {
                        ...
                        {
                            Message message2 = (operation2?.Messages.Output == null) ? null : descriptions.GetMessage(operation2?.Messages.Output.Message);
                            if (style3 == SoapBindingStyle.Rpc)
                            {
