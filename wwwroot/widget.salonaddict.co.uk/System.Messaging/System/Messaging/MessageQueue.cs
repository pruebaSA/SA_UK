namespace System.Messaging
{
    ...
    [InstallerType(typeof(MessageQueueInstaller)), MessagingDescription("MessageQueueDesc"), Editor("System.Messaging.Design.QueuePathEditor", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultEvent("ReceiveCompleted"), TypeConverter(typeof(MessageQueueConverter))]
    public class MessageQueue : Component, IEnumerable
    {
        ...
        public IAsyncResult BeginPeek() => 
            this.ReceiveAsync(InfiniteTimeout, CursorHandle.NullHandle, -2147483648, null, null);

        public IAsyncResult BeginPeek(TimeSpan timeout) => 
            this.ReceiveAsync(timeout, CursorHandle.NullHandle, -2147483648, null, null);

        public IAsyncResult BeginPeek(TimeSpan timeout, object stateObject) => 
            this.ReceiveAsync(timeout, CursorHandle.NullHandle, -2147483648, null, stateObject);

        public IAsyncResult BeginPeek(TimeSpan timeout, object stateObject, AsyncCallback callback) => 
            this.ReceiveAsync(timeout, CursorHandle.NullHandle, -2147483648, callback, stateObject);
        ...
        public IAsyncResult BeginReceive() => 
            this.ReceiveAsync(InfiniteTimeout, CursorHandle.NullHandle, 0, null, null);

        public IAsyncResult BeginReceive(TimeSpan timeout) => 
            this.ReceiveAsync(timeout, CursorHandle.NullHandle, 0, null, null);

        public IAsyncResult BeginReceive(TimeSpan timeout, object stateObject) => 
            this.ReceiveAsync(timeout, CursorHandle.NullHandle, 0, null, stateObject);

        public IAsyncResult BeginReceive(TimeSpan timeout, object stateObject, AsyncCallback callback) => 
            this.ReceiveAsync(timeout, CursorHandle.NullHandle, 0, callback, stateObject);
        ...
        private static MessageQueue[] CreateMessageQueuesSnapshot(MessageQueueCriteria criteria) => 
            CreateMessageQueuesSnapshot(criteria, true);
        ...
        public static MessageQueue[] GetPublicQueuesByLabel(string label) => 
            GetPublicQueuesByLabel(label, true);
            ...
            try
            {
                ...
                if (result != null)
                {
                    ...
                    if (result2 != null)
                    {
                        ...
                        SearchResultCollection results = new DirectorySearcher(result3.GetDirectoryEntry()) { 
        ...
        {
            if ((receiveResult != -1072824234) && (receiveResult != -1072824313))
            {
                return (receiveResult == -1072824314);
            }
            return true;
        }
        ...
        public Message Peek() => 
            this.ReceiveCurrent(InfiniteTimeout, -2147483648, CursorHandle.NullHandle, this.MessageReadPropertyFilter, null, MessageQueueTransactionType.None);

        public Message Peek(TimeSpan timeout) => 
            this.ReceiveCurrent(timeout, -2147483648, CursorHandle.NullHandle, this.MessageReadPropertyFilter, null, MessageQueueTransactionType.None);
        ...
        public Message PeekByCorrelationId(string correlationId) => 
            this.ReceiveBy(correlationId, TimeSpan.Zero, false, false, false, null, MessageQueueTransactionType.None);

        public Message PeekByCorrelationId(string correlationId, TimeSpan timeout) => 
            this.ReceiveBy(correlationId, timeout, false, false, true, null, MessageQueueTransactionType.None);

        public Message PeekById(string id) => 
            this.ReceiveBy(id, TimeSpan.Zero, false, true, false, null, MessageQueueTransactionType.None);

        public Message PeekById(string id, TimeSpan timeout) => 
            this.ReceiveBy(id, timeout, false, true, true, null, MessageQueueTransactionType.None);

        public Message PeekByLookupId(long lookupId) => 
            this.InternalReceiveByLookupId(false, MessageLookupAction.Current, lookupId, null, MessageQueueTransactionType.None);

        public Message PeekByLookupId(MessageLookupAction action, long lookupId) => 
            this.InternalReceiveByLookupId(false, action, lookupId, null, MessageQueueTransactionType.None);
        ...
        public Message Receive() => 
            this.ReceiveCurrent(InfiniteTimeout, 0, CursorHandle.NullHandle, this.MessageReadPropertyFilter, null, MessageQueueTransactionType.None);
        ...
        public Message Receive(TimeSpan timeout) => 
            this.ReceiveCurrent(timeout, 0, CursorHandle.NullHandle, this.MessageReadPropertyFilter, null, MessageQueueTransactionType.None);
        ...
        public Message ReceiveByCorrelationId(string correlationId) => 
            this.ReceiveBy(correlationId, TimeSpan.Zero, true, false, false, null, MessageQueueTransactionType.None);
        ...
        public Message ReceiveByCorrelationId(string correlationId, TimeSpan timeout) => 
            this.ReceiveBy(correlationId, timeout, true, false, true, null, MessageQueueTransactionType.None);
        ...
        public Message ReceiveById(string id) => 
            this.ReceiveBy(id, TimeSpan.Zero, true, true, false, null, MessageQueueTransactionType.None);
        ...
        public Message ReceiveById(string id, TimeSpan timeout) => 
            this.ReceiveBy(id, timeout, true, true, true, null, MessageQueueTransactionType.None);
        ...
        public Message ReceiveByLookupId(long lookupId) => 
            this.InternalReceiveByLookupId(true, MessageLookupAction.Current, lookupId, null, MessageQueueTransactionType.None);

        public Message ReceiveByLookupId(MessageLookupAction action, long lookupId, MessageQueueTransaction transaction) => 
            this.InternalReceiveByLookupId(true, action, lookupId, transaction, MessageQueueTransactionType.None);

        public Message ReceiveByLookupId(MessageLookupAction action, long lookupId, MessageQueueTransactionType transactionType) => 
            this.InternalReceiveByLookupId(true, action, lookupId, null, transactionType);
        ...
        [RefreshProperties(RefreshProperties.All), Browsable(false), DefaultValue(""), TypeConverter("System.Diagnostics.Design.StringValueConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), MessagingDescription("MQ_Path"), Editor("System.Messaging.Design.QueuePathEditor", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), SettingsBindable(true)]
        public string Path
        {
            get => 
                this.path;
            ...
            private unsafe void RaiseCompletionEvent(int result, NativeOverlapped* overlappedPointer)
            {
                if (MessageQueue.IsMemoryError(result))
                {
                    while (MessageQueue.IsMemoryError(result))
                    {
                        ...
                        {
                            result = (int) exception.MessageQueueErrorCode;
                            break;
                        }
                    }
                ...
                if (this.owner.IsCashedInfoInvalidOnReceive(result))
                {
                    ...
                    {
                        result = (int) exception2.MessageQueueErrorCode;
                    }
                    if (!MessageQueue.IsFatalError(result))
                    {
                        return;
        ...
        internal class QueueInfoKeyHolder
        {
            ...
            public override int GetHashCode() => 
                (this.formatName.GetHashCode() + this.accessMode);
        }
