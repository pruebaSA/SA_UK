namespace Microsoft.InfoCards.Diagnostics
{
    ...
    internal class InfoCardTraceRecord : TraceRecord
    {
        ...
        public override string ToString() => 
            Microsoft.InfoCards.SR.GetString("EventLogMessage", new object[] { this.m_eventID, this.m_message });
        ...
        internal override string EventId =>
            ("http://schemas.microsoft.com/2004/11/InfoCard/" + this.m_eventID + "TraceRecord");
    }
}
