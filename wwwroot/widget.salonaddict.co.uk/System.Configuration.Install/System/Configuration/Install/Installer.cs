namespace System.Configuration.Install
{
    ...
    public class Installer : Component
    {
        ...
        private bool IsWrappedException(Exception e) => 
            (((e is InstallException) && (e.Source == "WrappedExceptionSource")) && (e.TargetSite.ReflectedType == typeof(Installer)));
        ...
        [TypeConverter(typeof(InstallerParentConverter)), Browsable(true), ResDescription("Desc_Installer_Parent"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
