namespace System.Drawing
{
    ...
    internal class SafeNativeMethods
    {
        ...
        public static IntPtr CreateBitmap(int width, int height, int planes, int bpp, IntPtr bitmapData) => 
            System.Internal.HandleCollector.Add(IntCreateBitmap(width, height, planes, bpp, bitmapData), CommonHandles.GDI);

        public static IntPtr CreateCompatibleBitmap(HandleRef hDC, int width, int height) => 
            System.Internal.HandleCollector.Add(IntCreateCompatibleBitmap(hDC, width, height), CommonHandles.GDI);
        ...
        public static IntPtr CreateDIBSection(HandleRef hdc, ref NativeMethods.BITMAPINFO_FLAT bmi, int iUsage, ref IntPtr ppvBits, IntPtr hSection, int dwOffset) => 
            System.Internal.HandleCollector.Add(IntCreateDIBSection(hdc, ref bmi, iUsage, ref ppvBits, hSection, dwOffset), CommonHandles.GDI);
        ...
        public static unsafe IntPtr CreateIconFromResourceEx(byte* pbIconBits, int cbIconBits, bool fIcon, int dwVersion, int csDesired, int cyDesired, int flags) => 
            System.Internal.HandleCollector.Add(IntCreateIconFromResourceEx(pbIconBits, cbIconBits, fIcon, dwVersion, csDesired, cyDesired, flags), CommonHandles.Icon);
        ...
        public static IntPtr ExtractAssociatedIcon(HandleRef hInst, StringBuilder iconPath, ref int index) => 
            System.Internal.HandleCollector.Add(IntExtractAssociatedIcon(hInst, iconPath, ref index), CommonHandles.Icon);
        ...
        public static int GetObject(HandleRef hObject, LOGFONT lp) => 
            GetObject(hObject, Marshal.SizeOf(typeof(LOGFONT)), lp);
        ...
        public static IntPtr GlobalAlloc(int uFlags, uint dwBytes) => 
            IntGlobalAlloc(uFlags, new UIntPtr(dwBytes));
        ...
        public static IntPtr LoadIcon(HandleRef hInst, int iconId) => 
            IntLoadIcon(hInst, new IntPtr(iconId));
        ...
        internal class Gdip
        {
            ...
            private static void Initialize()
            {
                if (!EnsureAtomInitialized())
                {
                    ...
                    string version = null;
                    LoadLibraryShim("Gdiplus.dll", version, IntPtr.Zero, out ptr);
            ...
            private struct StartupInput
            {
                ...
                public static SafeNativeMethods.Gdip.StartupInput GetDefault() => 
                    new SafeNativeMethods.Gdip.StartupInput { 
                        GdiplusVersion = 1,
        ...
        public class PICTDESC
        {
            ...
            public static SafeNativeMethods.PICTDESC CreateIconPICTDESC(IntPtr hicon) => 
                new SafeNativeMethods.PICTDESC { 
                    cbSizeOfStruct = 12,
                    picType = 3,
                    union1 = hicon
                };
