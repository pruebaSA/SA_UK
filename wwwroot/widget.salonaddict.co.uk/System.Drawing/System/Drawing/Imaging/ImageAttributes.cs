namespace System.Drawing.Imaging
{
    ...
    public sealed class ImageAttributes : ICloneable, IDisposable
    {
        ...
        {
            int status = SafeNativeMethods.Gdip.GdipSetImageAttributesRemapTable(new HandleRef(this, this.nativeImageAttributes), type, false, 0, NativeMethods.NullHandleRef);
            if (status != 0)
            {
                throw SafeNativeMethods.Gdip.StatusException(status);
            }
