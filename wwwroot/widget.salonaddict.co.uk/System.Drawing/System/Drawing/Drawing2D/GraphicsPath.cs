namespace System.Drawing.Drawing2D
{
    ...
    public sealed class GraphicsPath : MarshalByRefObject, ICloneable, IDisposable
    {
        ...
        public bool IsOutlineVisible(Point point, Pen pen) => 
            this.IsOutlineVisible(point, pen, null);
        ...
        public bool IsOutlineVisible(int x, int y, Pen pen) => 
            this.IsOutlineVisible(new Point(x, y), pen, null);

        public bool IsOutlineVisible(float x, float y, Pen pen) => 
            this.IsOutlineVisible(new PointF(x, y), pen, null);

        public bool IsOutlineVisible(int x, int y, Pen pen, Graphics graphics) => 
            this.IsOutlineVisible(new Point(x, y), pen, graphics);

        public bool IsOutlineVisible(float x, float y, Pen pen, Graphics graphics) => 
            this.IsOutlineVisible(new PointF(x, y), pen, graphics);

        public bool IsVisible(Point point) => 
            this.IsVisible(point, null);
        ...
        public bool IsVisible(int x, int y) => 
            this.IsVisible(new Point(x, y), null);

        public bool IsVisible(float x, float y) => 
            this.IsVisible(new PointF(x, y), null);

        public bool IsVisible(int x, int y, Graphics graphics) => 
            this.IsVisible(new Point(x, y), graphics);

        public bool IsVisible(float x, float y, Graphics graphics) => 
            this.IsVisible(new PointF(x, y), graphics);
