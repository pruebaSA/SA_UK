namespace System.Drawing
{
    ...
    public sealed class Graphics : MarshalByRefObject, IDeviceContext, IDisposable
    {
        ...
        public void DrawImage(Image image, PointF[] destPoints, RectangleF srcRect, GraphicsUnit srcUnit)
        {
            ...
            IntPtr handle = SafeNativeMethods.Gdip.ConvertPointToMemory(destPoints);
            int errorStatus = SafeNativeMethods.Gdip.GdipDrawImagePointsRect(new HandleRef(this, this.NativeGraphics), new HandleRef(image, image.nativeImage), new HandleRef(this, handle), destPoints.Length, srcRect.X, srcRect.Y, srcRect.Width, srcRect.Height, (int) srcUnit, NativeMethods.NullHandleRef, null, NativeMethods.NullHandleRef);
            Marshal.FreeHGlobal(handle);
            this.IgnoreMetafileErrors(image, ref errorStatus);
            this.CheckErrorStatus(errorStatus);
        }
        ...
        public bool IsVisible(int x, int y) => 
            this.IsVisible(new Point(x, y));

        public bool IsVisible(float x, float y) => 
            this.IsVisible(new PointF(x, y));

        public bool IsVisible(int x, int y, int width, int height) => 
            this.IsVisible(new Rectangle(x, y, width, height));

        public bool IsVisible(float x, float y, float width, float height) => 
            this.IsVisible(new RectangleF(x, y, width, height));
        ...
        public SizeF MeasureString(string text, Font font) => 
            this.MeasureString(text, font, new SizeF(0f, 0f));

        public SizeF MeasureString(string text, Font font, SizeF layoutArea) => 
            this.MeasureString(text, font, layoutArea, null);

        public SizeF MeasureString(string text, Font font, int width) => 
            this.MeasureString(text, font, new SizeF((float) width, 999999f));
        ...
        public SizeF MeasureString(string text, Font font, int width, StringFormat format) => 
            this.MeasureString(text, font, new SizeF((float) width, 999999f), format);
