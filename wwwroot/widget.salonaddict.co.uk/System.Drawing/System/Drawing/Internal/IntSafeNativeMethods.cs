namespace System.Drawing.Internal
{
    ...
    internal static class IntSafeNativeMethods
    {
        public static IntPtr CreatePen(int fnStyle, int nWidth, int crColor) => 
            System.Internal.HandleCollector.Add(IntCreatePen(fnStyle, nWidth, crColor), CommonHandles.GDI);
        ...
        public static IntPtr CreateSolidBrush(int crColor) => 
            System.Internal.HandleCollector.Add(IntCreateSolidBrush(crColor), CommonHandles.GDI);

        public static IntPtr ExtCreatePen(int fnStyle, int dwWidth, IntNativeMethods.LOGBRUSH lplb, int dwStyleCount, int[] lpStyle) => 
            System.Internal.HandleCollector.Add(IntExtCreatePen(fnStyle, dwWidth, lplb, dwStyleCount, lpStyle), CommonHandles.GDI);
