namespace System.Drawing.Internal
{
    ...
    internal sealed class DeviceContext : MarshalByRefObject, IDeviceContext, IDisposable
    {
        ...
        public static DeviceContext CreateDC(string driverName, string deviceName, string fileName, HandleRef devMode) => 
            new DeviceContext(IntUnsafeNativeMethods.CreateDC(driverName, deviceName, fileName, devMode), System.Drawing.Internal.DeviceContextType.NamedDevice);

        public static DeviceContext CreateIC(string driverName, string deviceName, string fileName, HandleRef devMode) => 
            new DeviceContext(IntUnsafeNativeMethods.CreateIC(driverName, deviceName, fileName, devMode), System.Drawing.Internal.DeviceContextType.Information);
        ...
        public static DeviceContext FromCompatibleDC(IntPtr hdc) => 
            new DeviceContext(IntUnsafeNativeMethods.CreateCompatibleDC(new HandleRef(null, hdc)), System.Drawing.Internal.DeviceContextType.Memory);

        public static DeviceContext FromHdc(IntPtr hdc) => 
            new DeviceContext(hdc, System.Drawing.Internal.DeviceContextType.Unknown);
