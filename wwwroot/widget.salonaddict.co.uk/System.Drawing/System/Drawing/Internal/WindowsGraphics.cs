namespace System.Drawing.Internal
{
    ...
    internal sealed class WindowsGraphics : MarshalByRefObject, IDeviceContext, IDisposable
    {
        ...
        public static WindowsGraphics CreateMeasurementWindowsGraphics() => 
            new WindowsGraphics(System.Drawing.Internal.DeviceContext.FromCompatibleDC(IntPtr.Zero)) { disposeDc = true };
        ...
        public static WindowsGraphics FromHdc(IntPtr hDc) => 
            new WindowsGraphics(System.Drawing.Internal.DeviceContext.FromHdc(hDc)) { disposeDc = true };

        public static WindowsGraphics FromHwnd(IntPtr hWnd) => 
            new WindowsGraphics(System.Drawing.Internal.DeviceContext.FromHwnd(hWnd)) { disposeDc = true };
