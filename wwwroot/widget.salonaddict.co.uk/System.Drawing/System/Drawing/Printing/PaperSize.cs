namespace System.Drawing.Printing
{
    ...
    public class PaperSize
    {
        ...
        public override string ToString() => 
            ("[PaperSize " + this.PaperName + " Kind=" + TypeDescriptor.GetConverter(typeof(PaperKind)).ConvertToString((int) this.Kind) + " Height=" + this.Height.ToString(CultureInfo.InvariantCulture) + " Width=" + this.Width.ToString(CultureInfo.InvariantCulture) + "]");
