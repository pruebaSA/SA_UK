namespace System.Drawing.Printing
{
    ...
    public class PageSettings : ICloneable
    {
        ...
        public void CopyToHdevmode(IntPtr hdevmode)
        {
            ...
            if ((structure.dmDriverExtra >= this.ExtraBytes) && (SafeNativeMethods.DocumentProperties(NativeMethods.NullHandleRef, NativeMethods.NullHandleRef, this.printerSettings.PrinterName, lparam, lparam, 10) < 0))
            {
        ...
        public override string ToString() => 
            ("[PageSettings: Color=" + this.Color.ToString() + ", Landscape=" + this.Landscape.ToString() + ", Margins=" + this.Margins.ToString() + ", PaperSize=" + this.PaperSize.ToString() + ", PaperSource=" + this.PaperSource.ToString() + ", PrinterResolution=" + this.PrinterResolution.ToString() + "]");
