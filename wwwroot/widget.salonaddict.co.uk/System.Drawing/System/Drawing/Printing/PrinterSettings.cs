namespace System.Drawing.Printing
{
    ...
    public class PrinterSettings : ICloneable
    {
        ...
        public Graphics CreateMeasurementGraphics() => 
            this.CreateMeasurementGraphics(this.DefaultPageSettings);
        ...
        private static SafeNativeMethods.PRINTDLG CreatePRINTDLG() => 
            new SafeNativeMethods.PRINTDLG { 
        ...
        private static SafeNativeMethods.PRINTDLGX86 CreatePRINTDLGX86() => 
            new SafeNativeMethods.PRINTDLGX86 { 
        ...
        internal IntPtr GetHdevmodeInternal() => 
            this.GetHdevmodeInternal(this.PrinterNameInternal);
        ...
        private IntPtr GetHdevmodeInternal(string printer)
        {
            ...
            else if (SafeNativeMethods.DocumentProperties(NativeMethods.NullHandleRef, NativeMethods.NullHandleRef, printer, destination, NativeMethods.NullHandleRef, 2) < 0)
            {
                throw new Win32Exception();
            }
            ...
            if (SafeNativeMethods.DocumentProperties(NativeMethods.NullHandleRef, NativeMethods.NullHandleRef, printer, destination, destination, 10) < 0)
            {
        ...
        internal short GetModeField(ModeField field, short defaultValue) => 
            this.GetModeField(field, defaultValue, IntPtr.Zero);
        ...
        public bool CanDuplex =>
            (this.DeviceCapabilities(7, IntPtr.Zero, 0) == 1);
        ...
        public bool IsPlotter =>
            (this.GetDeviceCaps(2, 2) == 0);

        public bool IsValid =>
            (this.DeviceCapabilities(0x12, IntPtr.Zero, -1) != -1);

        public int LandscapeAngle =>
            this.DeviceCapabilities(0x11, IntPtr.Zero, 0);

        public int MaximumCopies =>
            this.DeviceCapabilities(0x12, IntPtr.Zero, 1);
        ...
        public PaperSizeCollection PaperSizes =>
            new PaperSizeCollection(this.Get_PaperSizes());

        public PaperSourceCollection PaperSources =>
            new PaperSourceCollection(this.Get_PaperSources());

        internal bool PrintDialogDisplayed
        {
            get => 
                this.printDialogDisplayed;
            set
            {
                System.Drawing.IntSecurity.AllPrinting.Demand();
        ...
        public PrinterResolutionCollection PrinterResolutions =>
            new PrinterResolutionCollection(this.Get_PrinterResolutions());
        ...
        public class PaperSizeCollection : ICollection, IEnumerable
        {
            ...
            public IEnumerator GetEnumerator() => 
                new PrinterSettings.ArrayEnumerator(this.array, 0, this.Count);
