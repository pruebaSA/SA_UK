namespace System.Drawing
{
    ...
    [Serializable, TypeConverter(typeof(IconConverter)), Editor("System.Drawing.Design.IconEditor, System.Drawing.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
    public sealed class Icon : MarshalByRefObject, ISerializable, ICloneable, IDisposable
    {
        ...
        public object Clone() => 
            new Icon(this, this.Size.Width, this.Size.Height);
        ...
        private void DrawIcon(IntPtr dc, Rectangle imageRect, Rectangle targetRect, bool stretch)
        {
            ...
            try
            {
                ...
                SafeNativeMethods.DrawIconEx(new HandleRef(null, dc), num5 - x, num6 - y, new HandleRef(this, this.handle), num9, num10, 0, NativeMethods.NullHandleRef, 3);
            }
            finally
            {
        ...
        private static Icon ExtractAssociatedIcon(string filePath, int index)
        {
            ...
            if (uri.IsFile)
            {
                ...
                IntPtr handle = SafeNativeMethods.ExtractAssociatedIcon(NativeMethods.NullHandleRef, iconPath, ref index);
                if (handle != IntPtr.Zero)
                {
        ...
        private unsafe void Initialize(int width, int height)
        {
            ...
            fixed (byte* numRef = this.iconData)
            {
                ...
                short num3 = this.GetShort(numRef + 2);
                short num4 = this.GetShort(numRef + 4);
                if (((@short != 0) || (num3 != 1)) || (num4 == 0))
                {
                    throw new ArgumentException(System.Drawing.SR.GetString("InvalidPictureType", new object[] { "picture", "Icon" }));
                }
                byte bWidth = 0;
                ...
                int num8 = Marshal.SizeOf(typeof(SafeNativeMethods.ICONDIRENTRY));
                if (((num8 * (num4 - 1)) + num) > this.iconData.Length)
                {
                    throw new ArgumentException(System.Drawing.SR.GetString("InvalidPictureType", new object[] { "picture", "Icon" }));
                }
                for (int i = 0; i < num4; i++)
                {
                    ...
                    {
                        int num11 = Math.Abs((int) (bWidth - width)) + Math.Abs((int) (bHeight - height));
                        int introduced28 = Math.Abs((int) (icondirentry.bWidth - width));
                        int num12 = introduced28 + Math.Abs((int) (icondirentry.bHeight - height));
                        if ((num12 < num11) || ((num12 == num11) && (((wBitCount <= bitDepth) && (wBitCount > this.bestBitDepth)) || ((this.bestBitDepth > bitDepth) && (wBitCount < this.bestBitDepth)))))
                        {
                            flag = true;
                        }
                    }
                ...
                if (length < 0)
                {
                    throw new Win32Exception(0x57);
                }
                try
                {
                    num13 = this.bestImageOffset + length;
                }
                catch (OverflowException)
                {
                    throw new Win32Exception(0x57);
                }
                if (num13 > this.iconData.Length)
                {
                    throw new ArgumentException(System.Drawing.SR.GetString("InvalidPictureType", new object[] { "picture", "Icon" }));
                }
        ...
        public override string ToString() => 
            System.Drawing.SR.GetString("toStringIcon");
