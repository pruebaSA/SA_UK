namespace System.Drawing
{
    ...
    [Serializable, ComVisible(true), Editor("System.Drawing.Design.FontEditor, System.Drawing.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), TypeConverter(typeof(FontConverter))]
    public sealed class Font : MarshalByRefObject, ICloneable, ISerializable, IDisposable
    {
        ...
        public static Font FromHfont(IntPtr hfont)
        {
            ...
            IntPtr dC = System.Drawing.UnsafeNativeMethods.GetDC(NativeMethods.NullHandleRef);
            try
            {
            ...
            {
                System.Drawing.UnsafeNativeMethods.ReleaseDC(NativeMethods.NullHandleRef, new HandleRef(null, dC));
            }
            return font;
        }
        ...
        public override int GetHashCode() => 
            ((((((int) this.fontStyle) << 13) | (((int) this.fontStyle) >> 0x13)) ^ ((((int) this.fontUnit) << 0x1a) | (((int) this.fontUnit) >> 6))) ^ ((int) ((((uint) this.fontSize) << 7) | (((uint) this.fontSize) >> 0x19))));
        ...
        private static bool IsVerticalName(string familyName) => 
            (((familyName != null) && (familyName.Length > 0)) && (familyName[0] == '@'));
        ...
        public override string ToString() => 
            string.Format(CultureInfo.CurrentCulture, "[{0}: Name={1}, Size={2}, Units={3}, GdiCharSet={4}, GdiVerticalFont={5}]", new object[] { base.GetType().Name, this.FontFamily.Name, this.fontSize, (int) this.fontUnit, this.gdiCharSet, this.gdiVerticalFont });

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool Bold =>
            ((this.Style & FontStyle.Bold) != FontStyle.Regular);
        ...
        [Browsable(false)]
        public int Height =>
            ((int) Math.Ceiling((double) this.GetHeight()));

        [Browsable(false)]
        public bool IsSystemFont =>
            !string.IsNullOrEmpty(this.systemFontName);

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool Italic =>
            ((this.Style & FontStyle.Italic) != FontStyle.Regular);

        [TypeConverter(typeof(FontConverter.FontNameConverter)), Editor("System.Drawing.Design.FontNameEditor, System.Drawing.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string Name =>
        ...
        public bool Strikeout =>
            ((this.Style & FontStyle.Strikeout) != FontStyle.Regular);
        ...
        public bool Underline =>
            ((this.Style & FontStyle.Underline) != FontStyle.Regular);
