namespace System.Web.Compilation.WCFModel
{
    ...
    internal abstract class AbstractSvcMapFileLoader
    {
        private static XmlSchemaSet m_ServiceMapSchemaSet;
        private XmlSerializer serializer;

        protected AbstractSvcMapFileLoader()
        {
        }
        ...
        public virtual SvcMapFile LoadMapFile(string fileName)
        {
            if (fileName == null)
            {
            ...
            using (TextReader reader = this.GetMapFileReader())
            {
                ...
                SvcMapFile svcMapFile = null;
                try
                {
                    XmlReader xmlReader = XmlReader.Create(reader, settings, (string) null);
                    try
                    {
                        svcMapFile = (SvcMapFile) this.Serializer.Deserialize(xmlReader);
                    }
        ...
        private void ValidateSvcMapFile(SvcMapFile svcMapFile)
        {
        ...
        protected virtual XmlSerializer Serializer
        {
            get
            {
                ...
                {
                    this.serializer = new XmlSerializer(typeof(SvcMapFile), "urn:schemas-microsoft-com:xml-wcfservicemap");
                }
        ...
        private static XmlSchemaSet ServiceMapSchemaSet
        {
            get
            {
                ...
                {
                    System.Xml.Schema.XmlSchema schema = System.Xml.Schema.XmlSchema.Read(typeof(AbstractSvcMapFileLoader).Assembly.GetManifestResourceStream(typeof(AbstractSvcMapFileLoader), "Schema.ServiceMapSchema.xsd"), null);
