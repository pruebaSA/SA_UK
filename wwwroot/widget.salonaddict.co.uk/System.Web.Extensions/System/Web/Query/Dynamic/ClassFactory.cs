namespace System.Web.Query.Dynamic
{
    ...
    internal class ClassFactory
    {
        ...
        private Dictionary<System.Web.Query.Dynamic.Signature, Type> classes;
        ...
        private ClassFactory()
        {
            ...
            this.classes = new Dictionary<System.Web.Query.Dynamic.Signature, Type>();
        ...
        public Type GetDynamicClass(IEnumerable<DynamicProperty> properties)
        {
            ...
            {
                Type type;
                System.Web.Query.Dynamic.Signature key = new System.Web.Query.Dynamic.Signature(properties);
