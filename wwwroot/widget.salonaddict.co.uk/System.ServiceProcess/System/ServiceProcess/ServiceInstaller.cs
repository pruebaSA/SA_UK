    ...
    public class ServiceInstaller : ComponentInstaller
    {
        ...
        public override void Install(IDictionary stateSaver)
        {
            ...
            try
            {
                ...
                try
                {
                    zero = System.ServiceProcess.NativeMethods.CreateService(databaseHandle, this.ServiceName, this.DisplayName, 0xf01ff, serviceType, (int) this.StartType, 1, binaryPath, null, IntPtr.Zero, dependencies, servicesStartName, password);
                    if (zero == IntPtr.Zero)
                    {
        ...
        private bool ShouldSerializeServicesDependedOn() => 
            ((this.servicesDependedOn != null) && (this.servicesDependedOn.Length > 0));
        ...
        [ComVisible(false), ServiceProcessDescription("ServiceInstallerDescription"), DefaultValue("")]
        ...
        [DefaultValue(""), TypeConverter("System.Diagnostics.Design.StringValueConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ServiceProcessDescription("ServiceInstallerServiceName")]
