namespace System.ServiceProcess
{
    ...
    [ServiceProcessDescription("ServiceControllerDesc"), Designer("System.ServiceProcess.Design.ServiceControllerDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public class ServiceController : Component
    {
        ...
        public unsafe void Continue()
        {
            ...
            try
            {
                NativeMethods.SERVICE_STATUS pStatus = new NativeMethods.SERVICE_STATUS();
        ...
        private static IntPtr GetDataBaseHandleWithEnumerateAccess(string machineName) => 
            GetDataBaseHandleWithAccess(machineName, 4);

        public static ServiceController[] GetDevices() => 
            GetDevices(".");

        public static ServiceController[] GetDevices(string machineName) => 
            GetServicesOfType(machineName, 11);
        ...
        public static ServiceController[] GetServices(string machineName) => 
            GetServicesOfType(machineName, 0x30);

        private static NativeMethods.ENUM_SERVICE_STATUS_PROCESS[] GetServicesInGroup(string machineName, string group)
        {
            NativeMethods.ENUM_SERVICE_STATUS_PROCESS[] enum_service_status_processArray;
            IntPtr zero = IntPtr.Zero;
            ...
            try
            {
                ...
                int num4 = num2;
                enum_service_status_processArray = new NativeMethods.ENUM_SERVICE_STATUS_PROCESS[num4];
                for (int i = 0; i < num4; i++)
                {
                    IntPtr ptr = (IntPtr) (((long) status) + (i * Marshal.SizeOf(typeof(NativeMethods.ENUM_SERVICE_STATUS_PROCESS))));
                    NativeMethods.ENUM_SERVICE_STATUS_PROCESS structure = new NativeMethods.ENUM_SERVICE_STATUS_PROCESS();
        ...
        private static ServiceController[] GetServicesOfType(string machineName, int serviceType)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < num4; i++)
                {
                    IntPtr ptr = (IntPtr) (((long) status) + (i * Marshal.SizeOf(typeof(NativeMethods.ENUM_SERVICE_STATUS))));
                ...
                if (this.dependentServices == null)
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            {
                                NativeMethods.ENUM_SERVICE_STATUS structure = new NativeMethods.ENUM_SERVICE_STATUS();
                                IntPtr ptr = (IntPtr) (((long) ptr2) + (i * Marshal.SizeOf(typeof(NativeMethods.ENUM_SERVICE_STATUS))));
                                Marshal.PtrToStructure(ptr, structure);
        ...
        [ServiceProcessDescription("SPMachineName"), DefaultValue("."), Browsable(false), RecommendedAsConfigurable(true)]
        ...
        [RecommendedAsConfigurable(true), TypeConverter(typeof(ServiceNameConverter)), ReadOnly(true), ServiceProcessDescription("SPServiceName"), DefaultValue("")]
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            NativeMethods.QUERY_SERVICE_CONFIG structure = new NativeMethods.QUERY_SERVICE_CONFIG();
                            ...
                            if (lpDependencies != null)
                            {
                                ...
                                while (lpDependencies[0] != '\0')
                                {
                                    ...
                                    if (lpDependencies[0] == '\0')
                                    {
                                        ...
                                        {
                                            foreach (NativeMethods.ENUM_SERVICE_STATUS_PROCESS enum_service_status_process in GetServicesInGroup(this.machineName, key.Substring(1)))
                                            {
        ...
        [ServiceProcessDescription("SPStatus"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
