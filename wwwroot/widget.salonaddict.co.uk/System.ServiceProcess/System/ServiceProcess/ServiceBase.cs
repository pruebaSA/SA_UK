    ...
    public class ServiceBase : Component
    {
        ...
        public unsafe void ServiceMainCallback(int argCount, IntPtr argPointer)
        {
            fixed (NativeMethods.SERVICE_STATUS* service_statusRef = &this.status)
            {
                ...
                {
                    this.statusHandle = NativeMethods.RegisterServiceCtrlHandlerEx(this.ServiceName, this.commandCallbackEx, IntPtr.Zero);
                }
                else
                {
                ...
                this.status.currentState = 2;
                if (NativeMethods.SetServiceStatus(this.statusHandle, service_statusRef))
                {
        ...
        [TypeConverter("System.Diagnostics.Design.StringValueConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ServiceProcessDescription("SBServiceName")]
