    ...
    public sealed class ProtectedData
    {
        ...
        public static unsafe byte[] Protect(byte[] userData, byte[] optionalEntropy, DataProtectionScope scope)
        {
            ...
            try
            {
                ...
                System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB cryptoapi_blob2 = new System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB {
                    cbData = (uint) userData.Length,
                    pbData = handle.AddrOfPinnedObject()
                };
                System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB cryptoapi_blob3 = new System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB();
            ...
            finally
            {
                ...
                if (cryptoapi_blob.pbData != IntPtr.Zero)
                {
                    System.Security.Cryptography.CAPISafe.ZeroMemory(cryptoapi_blob.pbData, cryptoapi_blob.cbData);
                    System.Security.Cryptography.CAPISafe.LocalFree(cryptoapi_blob.pbData);
                }
            }
            return buffer2;
        }
