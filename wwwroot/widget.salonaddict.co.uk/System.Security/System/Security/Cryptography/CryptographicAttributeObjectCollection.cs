namespace System.Security.Cryptography
{
    ...
    public sealed class CryptographicAttributeObjectCollection : ICollection, IEnumerable
    {
        ...
        private CryptographicAttributeObjectCollection(IntPtr pCryptAttributes) : this((System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTES) Marshal.PtrToStructure(pCryptAttributes, typeof(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTES)))
        {
        }

        internal CryptographicAttributeObjectCollection(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTES cryptAttributes)
        {
            this.m_list = new ArrayList();
            for (uint i = 0; i < cryptAttributes.cAttr; i++)
            {
                IntPtr pAttribute = new IntPtr(((long) cryptAttributes.rgAttr) + (i * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE))));
        ...
        public CryptographicAttributeObjectEnumerator GetEnumerator() => 
            new CryptographicAttributeObjectEnumerator(this);
        ...
        public CryptographicAttributeObject this[int index] =>
            ((CryptographicAttributeObject) this.m_list[index]);
