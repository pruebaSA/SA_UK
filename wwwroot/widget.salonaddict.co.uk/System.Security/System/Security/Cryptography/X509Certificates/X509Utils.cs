namespace System.Security.Cryptography.X509Certificates
{
    ...
    internal class X509Utils
    {
        ...
        internal static unsafe int BuildChain(IntPtr hChainEngine, System.Security.Cryptography.SafeCertContextHandle pCertContext, X509Certificate2Collection extraStore, OidCollection applicationPolicy, OidCollection certificatePolicy, X509RevocationMode revocationMode, X509RevocationFlag revocationFlag, DateTime verificationTime, TimeSpan timeout, ref System.Security.Cryptography.SafeCertChainHandle ppChainContext)
        {
            ...
            System.Security.Cryptography.CAPIBase.CERT_CHAIN_PARA structure = new System.Security.Cryptography.CAPIBase.CERT_CHAIN_PARA();
            ...
            {
                structure.RequestedUsage.dwType = 0;
                structure.RequestedUsage.Usage.cUsageIdentifier = (uint) applicationPolicy.Count;
                handle2 = CopyOidsToUnmanagedMemory(applicationPolicy);
                structure.RequestedUsage.Usage.rgpszUsageIdentifier = handle2.DangerousGetHandle();
            }
            ...
            {
                structure.RequestedIssuancePolicy.dwType = 0;
                structure.RequestedIssuancePolicy.Usage.cUsageIdentifier = (uint) certificatePolicy.Count;
                handle3 = CopyOidsToUnmanagedMemory(certificatePolicy);
                structure.RequestedIssuancePolicy.Usage.rgpszUsageIdentifier = handle3.DangerousGetHandle();
            }
            structure.dwUrlRetrievalTimeout = (uint) timeout.Milliseconds;
            ...
            *((long*) &pTime) = verificationTime.ToFileTime();
            ...
            if (!System.Security.Cryptography.CAPISafe.CertGetCertificateChain(hChainEngine, pCertContext, ref pTime, invalidHandle, ref structure, dwFlags, IntPtr.Zero, ref ppChainContext))
            {
        ...
        internal static string EncodeHexString(byte[] sArray) => 
            EncodeHexString(sArray, 0, (uint) sArray.Length);
        ...
        internal static string EncodeHexStringFromInt(byte[] sArray) => 
            EncodeHexStringFromInt(sArray, 0, (uint) sArray.Length);
        ...
        internal static bool GetPrivateKeyInfo(System.Security.Cryptography.SafeCertContextHandle safeCertContext, ref CspParameters parameters)
        {
            System.Security.Cryptography.SafeLocalAllocHandle invalidHandle = System.Security.Cryptography.SafeLocalAllocHandle.InvalidHandle;
            uint pcbData = 0;
            if (!System.Security.Cryptography.CAPISafe.CertGetCertificateContextProperty(safeCertContext, 2, invalidHandle, ref pcbData))
            {
            ...
            System.Security.Cryptography.CAPIBase.CRYPT_KEY_PROV_INFO crypt_key_prov_info = (System.Security.Cryptography.CAPIBase.CRYPT_KEY_PROV_INFO) Marshal.PtrToStructure(invalidHandle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPT_KEY_PROV_INFO));
        ...
        internal static int VerifyCertificate(System.Security.Cryptography.SafeCertContextHandle pCertContext, OidCollection applicationPolicy, OidCollection certificatePolicy, X509RevocationMode revocationMode, X509RevocationFlag revocationFlag, DateTime verificationTime, TimeSpan timeout, X509Certificate2Collection extraStore, IntPtr pszPolicy, IntPtr pdwErrorStatus)
        {
            ...
            System.Security.Cryptography.CAPIBase.CERT_CHAIN_POLICY_PARA pPolicyPara = new System.Security.Cryptography.CAPIBase.CERT_CHAIN_POLICY_PARA(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CERT_CHAIN_POLICY_PARA)));
            System.Security.Cryptography.CAPIBase.CERT_CHAIN_POLICY_STATUS pPolicyStatus = new System.Security.Cryptography.CAPIBase.CERT_CHAIN_POLICY_STATUS(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CERT_CHAIN_POLICY_STATUS)));
            ...
            if (!System.Security.Cryptography.CAPISafe.CertVerifyCertificateChainPolicy(pszPolicy, invalidHandle, ref pPolicyPara, ref pPolicyStatus))
            {
                return Marshal.GetHRForLastWin32Error();
            }
