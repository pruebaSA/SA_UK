namespace System.Security.Cryptography.Pkcs
{
    ...
    public sealed class KeyTransRecipientInfo : RecipientInfo
    {
        ...
        internal unsafe KeyTransRecipientInfo(System.Security.Cryptography.SafeLocalAllocHandle pRecipientInfo, System.Security.Cryptography.CAPIBase.CERT_INFO certInfo, uint index) : base(RecipientInfoType.KeyTransport, RecipientSubType.Pkcs7KeyTransport, pRecipientInfo, certInfo, index)
        {
            int version = 2;
        ...
        internal KeyTransRecipientInfo(System.Security.Cryptography.SafeLocalAllocHandle pRecipientInfo, System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO keyTrans, uint index) : base(RecipientInfoType.KeyTransport, RecipientSubType.CmsKeyTransport, pRecipientInfo, keyTrans, index)
        {
        ...
        public override byte[] EncryptedKey
        {
            get
            {
                ...
                {
                    System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO cmsgRecipientInfo = (System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO) base.CmsgRecipientInfo;
        ...
        public override AlgorithmIdentifier KeyEncryptionAlgorithm
        {
            get
            {
                if (this.m_encryptionAlgorithm == null)
                {
                    ...
                    {
                        System.Security.Cryptography.CAPIBase.CERT_INFO cert_info = (System.Security.Cryptography.CAPIBase.CERT_INFO) base.CmsgRecipientInfo;
        ...
        public override SubjectIdentifier RecipientIdentifier
        {
            get
            {
                if (this.m_recipientIdentifier == null)
                {
                    ...
                    {
                        System.Security.Cryptography.CAPIBase.CERT_INFO certInfo = (System.Security.Cryptography.CAPIBase.CERT_INFO) base.CmsgRecipientInfo;
