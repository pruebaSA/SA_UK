    ...
    public sealed class EnvelopedCms
    {
        ...
        private unsafe void DecryptContent(RecipientInfoCollection recipientInfos, X509Certificate2Collection extraStore)
        {
            ...
            for (int i = 0; i < recipientInfos.Count; i++)
            {
                ...
                System.Security.Cryptography.CAPIBase.CMSG_CTRL_KEY_AGREE_DECRYPT_PARA cmsg_ctrl_key_agree_decrypt_para;
                System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO cmsg_key_agree_public_key_recipient_info;
                ...
                switch (recipientInfo.Type)
                {
                    ...
                    {
                        System.Security.Cryptography.CAPIBase.CMSG_CTRL_DECRYPT_PARA cmsg_ctrl_decrypt_para = new System.Security.Cryptography.CAPIBase.CMSG_CTRL_DECRYPT_PARA(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_CTRL_DECRYPT_PARA))) {
                    ...
                    case RecipientInfoType.KeyAgreement:
                    {
                        ...
                        System.Security.Cryptography.CAPIBase.CMSG_CMS_RECIPIENT_INFO cmsg_cms_recipient_info = (System.Security.Cryptography.CAPIBase.CMSG_CMS_RECIPIENT_INFO) Marshal.PtrToStructure(info2.pCmsgRecipientInfo.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_CMS_RECIPIENT_INFO));
                        cmsg_ctrl_key_agree_decrypt_para = new System.Security.Cryptography.CAPIBase.CMSG_CTRL_KEY_AGREE_DECRYPT_PARA(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_CTRL_KEY_AGREE_DECRYPT_PARA))) {
                            hCryptProv = cmsgDecryptParam.safeCryptProvHandle.DangerousGetHandle(),
                            dwKeySpec = cmsgDecryptParam.keySpec,
                        ...
                        System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO cmsgRecipientInfo = (System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO) info2.CmsgRecipientInfo;
                ...
                System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context = (System.Security.Cryptography.CAPIBase.CERT_CONTEXT) Marshal.PtrToStructure(invalidHandle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CERT_CONTEXT));
                System.Security.Cryptography.CAPIBase.CERT_INFO cert_info = (System.Security.Cryptography.CAPIBase.CERT_INFO) Marshal.PtrToStructure(cert_context.pCertInfo, typeof(System.Security.Cryptography.CAPIBase.CERT_INFO));
                cmsg_ctrl_key_agree_decrypt_para.OriginatorPublicKey = cert_info.SubjectPublicKeyInfo.PublicKey;
                goto Label_02A7;
            Label_0286:
                cmsg_key_agree_public_key_recipient_info = (System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO) info2.CmsgRecipientInfo;
        ...
        private unsafe void EncryptContent(CmsRecipientCollection recipients)
        {
            ...
            System.Security.Cryptography.CAPIBase.CMSG_ENVELOPED_ENCODE_INFO structure = new System.Security.Cryptography.CAPIBase.CMSG_ENVELOPED_ENCODE_INFO(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_ENVELOPED_ENCODE_INFO)));
            System.Security.Cryptography.SafeLocalAllocHandle handle = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_ENVELOPED_ENCODE_INFO))));
            ...
            {
                Marshal.DestroyStructure(handle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_ENVELOPED_ENCODE_INFO));
                handle.Dispose();
            }
            ...
            if (string.Compare(this.ContentInfo.ContentType.Value, "1.2.840.113549.1.7.1", StringComparison.OrdinalIgnoreCase) == 0)
            {
                ...
                {
                    System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB cryptoapi_blob = new System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB {
            ...
            if ((encodedData.Length > 0) && !System.Security.Cryptography.CAPISafe.CryptMsgUpdate(this.m_safeCryptMsgHandle, encodedData, (uint) encodedData.Length, true))
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
        ...
        private static unsafe int GetCspParams(RecipientInfo recipientInfo, X509Certificate2Collection extraStore, ref CMSG_DECRYPT_PARAM cmsgDecryptParam)
        {
            ...
            switch (recipientInfo.Type)
            {
                case RecipientInfoType.KeyTransport:
                    ...
                    {
                        System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO cmsgRecipientInfo = (System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO) recipientInfo.CmsgRecipientInfo;
                ...
                case RecipientInfoType.KeyAgreement:
                {
                    ...
                    System.Security.Cryptography.CAPIBase.CERT_ID recipientId = info.RecipientId;
            ...
            if (System.Security.Cryptography.CAPISafe.CryptAcquireCertificatePrivateKey(invalidHandle, 6, IntPtr.Zero, ref hCryptProv, ref pdwKeySpec, ref pfCallerFreeProv))
            {
                if (!pfCallerFreeProv)
                {
        ...
        private static System.Security.Cryptography.SafeCryptMsgHandle OpenToDecode(byte[] encodedMessage)
        {
            ...
            hCryptMsg = System.Security.Cryptography.CAPISafe.CryptMsgOpenToDecode(0x10001, 0, 0, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
            if ((hCryptMsg == null) || hCryptMsg.IsInvalid)
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
            if (!System.Security.Cryptography.CAPISafe.CryptMsgUpdate(hCryptMsg, encodedMessage, (uint) encodedMessage.Length, true))
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
        ...
        private static unsafe void SetCmsRecipientParams(CmsRecipientCollection recipients, X509Certificate2Collection certificates, CryptographicAttributeObjectCollection unprotectedAttributes, AlgorithmIdentifier contentEncryptionAlgorithm, ref CMSG_ENCRYPT_PARAM encryptParam)
        {
            ...
            int num2 = 0;
            int num3 = recipients.Count * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCODE_INFO));
            int num4 = num3;
            for (index = 0; index < recipients.Count; index++)
            {
                ...
                if (numArray[index] == 1)
                {
                    num4 += Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO));
                }
                else
                {
                    if (numArray[index] != 2)
                    ...
                    num2++;
                    num4 += Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO));
                }
            }
            ...
            {
                encryptParam.rgCertEncoded = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(certificates.Count * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB))));
                for (index = 0; index < certificates.Count; index++)
                {
                    System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context = (System.Security.Cryptography.CAPIBase.CERT_CONTEXT) Marshal.PtrToStructure(System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(certificates[index]).DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CERT_CONTEXT));
                    System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB* cryptoapi_blobPtr = (System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB*) new IntPtr(((long) encryptParam.rgCertEncoded.DangerousGetHandle()) + (index * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB))));
            ...
            for (index = 0; index < recipients.Count; index++)
            {
                ...
                System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context2 = (System.Security.Cryptography.CAPIBase.CERT_CONTEXT) Marshal.PtrToStructure(System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(certificate).DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CERT_CONTEXT));
                System.Security.Cryptography.CAPIBase.CERT_INFO cert_info = (System.Security.Cryptography.CAPIBase.CERT_INFO) Marshal.PtrToStructure(cert_context2.pCertInfo, typeof(System.Security.Cryptography.CAPIBase.CERT_INFO));
                System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCODE_INFO* cmsg_recipient_encode_infoPtr = (System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCODE_INFO*) new IntPtr(((long) encryptParam.rgpRecipients.DangerousGetHandle()) + (index * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCODE_INFO))));
                cmsg_recipient_encode_infoPtr->dwRecipientChoice = numArray[index];
                cmsg_recipient_encode_infoPtr->pRecipientInfo = ptr;
                if (numArray[index] == 1)
                {
                    IntPtr ptr2 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO), "cbSize")));
                    Marshal.WriteInt32(ptr2, Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO)));
                    IntPtr ptr3 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO), "KeyEncryptionAlgorithm")));
                    ...
                    IntPtr ptr4 = new IntPtr(((long) ptr3) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER), "pszObjId")));
                    Marshal.WriteIntPtr(ptr4, encryptParam.rgszObjId[index].DangerousGetHandle());
                    IntPtr ptr5 = new IntPtr(((long) ptr3) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER), "Parameters")));
                    IntPtr ptr6 = new IntPtr(((long) ptr5) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                    Marshal.WriteInt32(ptr6, (int) cert_info.SubjectPublicKeyInfo.Algorithm.Parameters.cbData);
                    IntPtr ptr7 = new IntPtr(((long) ptr5) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                    Marshal.WriteIntPtr(ptr7, cert_info.SubjectPublicKeyInfo.Algorithm.Parameters.pbData);
                    IntPtr ptr8 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO), "RecipientPublicKey")));
                    ptr6 = new IntPtr(((long) ptr8) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB), "cbData")));
                    Marshal.WriteInt32(ptr6, (int) cert_info.SubjectPublicKeyInfo.PublicKey.cbData);
                    ptr7 = new IntPtr(((long) ptr8) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB), "pbData")));
                    Marshal.WriteIntPtr(ptr7, cert_info.SubjectPublicKeyInfo.PublicKey.pbData);
                    IntPtr ptr9 = new IntPtr(((long) ptr8) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB), "cUnusedBits")));
                    Marshal.WriteInt32(ptr9, (int) cert_info.SubjectPublicKeyInfo.PublicKey.cUnusedBits);
                    IntPtr ptr10 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO), "RecipientId")));
                    if (recipient.RecipientIdentifierType == SubjectIdentifierType.SubjectKeyIdentifier)
                    {
                        ...
                        if (!System.Security.Cryptography.CAPISafe.CertGetCertificateContextProperty(System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(certificate), 20, invalidHandle, ref pcbData))
                        {
                            throw new CryptographicException(Marshal.GetLastWin32Error());
                        }
                        ...
                        IntPtr ptr11 = new IntPtr(((long) ptr10) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ID), "dwIdChoice")));
                        Marshal.WriteInt32(ptr11, 2);
                        IntPtr ptr12 = new IntPtr(((long) ptr10) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ID), "Value")));
                        ptr6 = new IntPtr(((long) ptr12) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                        Marshal.WriteInt32(ptr6, (int) pcbData);
                        ptr7 = new IntPtr(((long) ptr12) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                        Marshal.WriteIntPtr(ptr7, invalidHandle.DangerousGetHandle());
                    }
                    else
                    {
                        IntPtr ptr13 = new IntPtr(((long) ptr10) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ID), "dwIdChoice")));
                        Marshal.WriteInt32(ptr13, 1);
                        IntPtr ptr14 = new IntPtr(((long) ptr10) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ID), "Value")));
                        IntPtr ptr15 = new IntPtr(((long) ptr14) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ISSUER_SERIAL_NUMBER), "Issuer")));
                        ptr6 = new IntPtr(((long) ptr15) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                        Marshal.WriteInt32(ptr6, (int) cert_info.Issuer.cbData);
                        ptr7 = new IntPtr(((long) ptr15) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                        Marshal.WriteIntPtr(ptr7, cert_info.Issuer.pbData);
                        IntPtr ptr16 = new IntPtr(((long) ptr14) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ISSUER_SERIAL_NUMBER), "SerialNumber")));
                        ptr6 = new IntPtr(((long) ptr16) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                        Marshal.WriteInt32(ptr6, (int) cert_info.SerialNumber.cbData);
                        ptr7 = new IntPtr(((long) ptr16) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                        Marshal.WriteIntPtr(ptr7, cert_info.SerialNumber.pbData);
                    }
                    ptr = new IntPtr(((long) ptr) + Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO)));
                }
                else if (numArray[index] == 2)
                {
                    IntPtr ptr17 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "cbSize")));
                    Marshal.WriteInt32(ptr17, Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO)));
                    IntPtr ptr18 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "KeyEncryptionAlgorithm")));
                    ...
                    IntPtr ptr19 = new IntPtr(((long) ptr18) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER), "pszObjId")));
                    Marshal.WriteIntPtr(ptr19, encryptParam.rgszObjId[index].DangerousGetHandle());
                    IntPtr ptr20 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "KeyWrapAlgorithm")));
                    ...
                    ptr19 = new IntPtr(((long) ptr20) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER), "pszObjId")));
                    Marshal.WriteIntPtr(ptr19, encryptParam.rgszKeyWrapObjId[num2].DangerousGetHandle());
                    if (num6 == 0x6602)
                    {
                        IntPtr ptr21 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "pvKeyWrapAuxInfo")));
                        Marshal.WriteIntPtr(ptr21, encryptParam.pvEncryptionAuxInfo.DangerousGetHandle());
                    }
                    IntPtr ptr22 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "dwKeyChoice")));
                    Marshal.WriteInt32(ptr22, 1);
                    IntPtr ptr23 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "pEphemeralAlgorithmOrSenderId")));
                    encryptParam.rgEphemeralIdentifier[num2] = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER))));
                    ...
                    ptr19 = new IntPtr(((long) encryptParam.rgEphemeralIdentifier[num2].DangerousGetHandle()) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER), "pszObjId")));
                    Marshal.WriteIntPtr(ptr19, encryptParam.rgszEphemeralObjId[num2].DangerousGetHandle());
                    IntPtr ptr24 = new IntPtr(((long) encryptParam.rgEphemeralIdentifier[num2].DangerousGetHandle()) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER), "Parameters")));
                    IntPtr ptr25 = new IntPtr(((long) ptr24) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                    Marshal.WriteInt32(ptr25, (int) cert_info.SubjectPublicKeyInfo.Algorithm.Parameters.cbData);
                    IntPtr ptr26 = new IntPtr(((long) ptr24) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                    Marshal.WriteIntPtr(ptr26, cert_info.SubjectPublicKeyInfo.Algorithm.Parameters.pbData);
                    IntPtr ptr27 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "cRecipientEncryptedKeys")));
                    ...
                    IntPtr ptr28 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO), "rgpRecipientEncryptedKeys")));
                    Marshal.WriteIntPtr(ptr28, encryptParam.prgpEncryptedKey[num2].DangerousGetHandle());
                    encryptParam.rgpEncryptedKey[num2] = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO))));
                    ...
                    ptr17 = new IntPtr(((long) encryptParam.rgpEncryptedKey[num2].DangerousGetHandle()) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO), "cbSize")));
                    Marshal.WriteInt32(ptr17, Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO)));
                    IntPtr ptr29 = new IntPtr(((long) encryptParam.rgpEncryptedKey[num2].DangerousGetHandle()) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO), "RecipientPublicKey")));
                    ptr25 = new IntPtr(((long) ptr29) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB), "cbData")));
                    Marshal.WriteInt32(ptr25, (int) cert_info.SubjectPublicKeyInfo.PublicKey.cbData);
                    ptr26 = new IntPtr(((long) ptr29) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB), "pbData")));
                    Marshal.WriteIntPtr(ptr26, cert_info.SubjectPublicKeyInfo.PublicKey.pbData);
                    IntPtr ptr30 = new IntPtr(((long) ptr29) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB), "cUnusedBits")));
                    Marshal.WriteInt32(ptr30, (int) cert_info.SubjectPublicKeyInfo.PublicKey.cUnusedBits);
                    IntPtr ptr31 = new IntPtr(((long) encryptParam.rgpEncryptedKey[num2].DangerousGetHandle()) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_ENCODE_INFO), "RecipientId")));
                    IntPtr ptr32 = new IntPtr(((long) ptr31) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ID), "dwIdChoice")));
                    if (recipient.RecipientIdentifierType == SubjectIdentifierType.SubjectKeyIdentifier)
                    {
                        Marshal.WriteInt32(ptr32, 2);
                        IntPtr ptr33 = new IntPtr(((long) ptr31) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ID), "Value")));
                        uint num7 = 0;
                        System.Security.Cryptography.SafeLocalAllocHandle pvData = System.Security.Cryptography.SafeLocalAllocHandle.InvalidHandle;
                        if (!System.Security.Cryptography.CAPISafe.CertGetCertificateContextProperty(System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(certificate), 20, pvData, ref num7))
                        {
                            throw new CryptographicException(Marshal.GetLastWin32Error());
                        }
                        ...
                        ptr25 = new IntPtr(((long) ptr33) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                        Marshal.WriteInt32(ptr25, (int) num7);
                        ptr26 = new IntPtr(((long) ptr33) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                        Marshal.WriteIntPtr(ptr26, pvData.DangerousGetHandle());
                    }
                    else
                    {
                        Marshal.WriteInt32(ptr32, 1);
                        IntPtr ptr34 = new IntPtr(((long) ptr31) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ID), "Value")));
                        IntPtr ptr35 = new IntPtr(((long) ptr34) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ISSUER_SERIAL_NUMBER), "Issuer")));
                        ptr25 = new IntPtr(((long) ptr35) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                        Marshal.WriteInt32(ptr25, (int) cert_info.Issuer.cbData);
                        ptr26 = new IntPtr(((long) ptr35) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                        Marshal.WriteIntPtr(ptr26, cert_info.Issuer.pbData);
                        IntPtr ptr36 = new IntPtr(((long) ptr34) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_ISSUER_SERIAL_NUMBER), "SerialNumber")));
                        ptr25 = new IntPtr(((long) ptr36) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                        Marshal.WriteInt32(ptr25, (int) cert_info.SerialNumber.cbData);
                        ptr26 = new IntPtr(((long) ptr36) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                        Marshal.WriteIntPtr(ptr26, cert_info.SerialNumber.pbData);
                    }
                    num2++;
                    ptr = new IntPtr(((long) ptr) + Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO)));
                }
            }
        }
        ...
        private static void SetCspParams(AlgorithmIdentifier contentEncryptionAlgorithm, ref CMSG_ENCRYPT_PARAM encryptParam)
        {
            ...
            if (!System.Security.Cryptography.CAPI.CryptAcquireContext(ref invalidHandle, IntPtr.Zero, IntPtr.Zero, 1, 0xf0000000) && !System.Security.Cryptography.CAPI.CryptAcquireContext(ref invalidHandle, IntPtr.Zero, IntPtr.Zero, 1, 0))
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
            ...
            switch (algId)
            {
                ...
                case 0x6801:
                {
                    System.Security.Cryptography.CAPIBase.CMSG_RC2_AUX_INFO structure = new System.Security.Cryptography.CAPIBase.CMSG_RC2_AUX_INFO(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RC2_AUX_INFO)));
                    ...
                    System.Security.Cryptography.SafeLocalAllocHandle handle2 = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_RC2_AUX_INFO))));
        ...
        private static void SetPkcs7RecipientParams(CmsRecipientCollection recipients, ref CMSG_ENCRYPT_PARAM encryptParam, out List<System.Security.Cryptography.SafeCertContextHandle> certContexts)
        {
            ...
            for (num = 0; num < count; num++)
            {
                ...
                System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context = (System.Security.Cryptography.CAPIBase.CERT_CONTEXT) Marshal.PtrToStructure(certContext.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CERT_CONTEXT));
