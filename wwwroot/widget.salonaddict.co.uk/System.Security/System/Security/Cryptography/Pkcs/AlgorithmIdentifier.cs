namespace System.Security.Cryptography.Pkcs
{
    ...
    public sealed class AlgorithmIdentifier
    {
        ...
        internal AlgorithmIdentifier(System.Security.Cryptography.CAPIBase.CERT_PUBLIC_KEY_INFO keyInfo)
        {
            System.Security.Cryptography.SafeLocalAllocHandle handle = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CERT_PUBLIC_KEY_INFO))));
            Marshal.StructureToPtr(keyInfo, handle.DangerousGetHandle(), false);
            int keyLength = (int) System.Security.Cryptography.CAPISafe.CertGetPublicKeyLength(0x10001, handle.DangerousGetHandle());
            ...
            Marshal.DestroyStructure(handle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CERT_PUBLIC_KEY_INFO));
            handle.Dispose();
            this.Reset(new System.Security.Cryptography.Oid(keyInfo.Algorithm.pszObjId), keyLength, destination);
        }

        internal AlgorithmIdentifier(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER algorithmIdentifier)
        {
            int keyLength = 0;
            ...
            if (num3 == 0x6602)
            {
                if (algorithmIdentifier.Parameters.cbData > 0)
                {
                    ...
                    System.Security.Cryptography.CAPIBase.CRYPT_RC2_CBC_PARAMETERS crypt_rc_cbc_parameters = (System.Security.Cryptography.CAPIBase.CRYPT_RC2_CBC_PARAMETERS) Marshal.PtrToStructure(invalidHandle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPT_RC2_CBC_PARAMETERS));
            ...
            else if (((num3 == 0x6801) || (num3 == 0x6601)) || (num3 == 0x6603))
            {
                if (algorithmIdentifier.Parameters.cbData > 0)
                {
                    ...
                    if (cbDecodedValue > 0)
                    {
                        if (num3 == 0x6801)
                        {
                            System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB cryptoapi_blob = (System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB) Marshal.PtrToStructure(invalidHandle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB));
