namespace System.Security.Cryptography.Pkcs
{
    ...
    public sealed class RecipientInfoCollection : ICollection, IEnumerable
    {
        ...
        internal unsafe RecipientInfoCollection(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle)
        {
            ...
            if (flag)
            {
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 0x21, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
                {
                    throw new CryptographicException(Marshal.GetLastWin32Error());
                }
            }
            else if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 0x11, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
            this.m_recipientInfos = new ArrayList();
            for (uint i = 0; i < num; i++)
            {
                ...
                System.Security.Cryptography.CAPIBase.CMSG_CMS_RECIPIENT_INFO cmsg_cms_recipient_info = (System.Security.Cryptography.CAPIBase.CMSG_CMS_RECIPIENT_INFO) Marshal.PtrToStructure(handle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_CMS_RECIPIENT_INFO));
                switch (cmsg_cms_recipient_info.dwRecipientChoice)
                {
                    case 1:
                    {
                        System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO keyTrans = (System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO) Marshal.PtrToStructure(cmsg_cms_recipient_info.pRecipientInfo, typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_TRANS_RECIPIENT_INFO));
                        this.m_recipientInfos.Add(new KeyTransRecipientInfo(handle, keyTrans, i));
                        continue;
                    }
                    case 2:
                    {
                        System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_INFO cmsg_key_agree_recipient_info = (System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_INFO) Marshal.PtrToStructure(cmsg_cms_recipient_info.pRecipientInfo, typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_RECIPIENT_INFO));
                ...
                System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO certIdRecipient = (System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO) Marshal.PtrToStructure(cmsg_cms_recipient_info.pRecipientInfo, typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO));
                ...
                continue;
            Label_0192:
                cmsg_key_agree_public_key_recipient_info = (System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO) Marshal.PtrToStructure(cmsg_cms_recipient_info.pRecipientInfo, typeof(System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO));
            ...
            Label_020B:
                ...
                System.Security.Cryptography.CAPIBase.CERT_INFO certInfo = (System.Security.Cryptography.CAPIBase.CERT_INFO) Marshal.PtrToStructure(handle2.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CERT_INFO));
        ...
        public RecipientInfoEnumerator GetEnumerator() => 
            new RecipientInfoEnumerator(this);

        IEnumerator IEnumerable.GetEnumerator() => 
            new RecipientInfoEnumerator(this);

        public int Count =>
            this.m_recipientInfos.Count;
