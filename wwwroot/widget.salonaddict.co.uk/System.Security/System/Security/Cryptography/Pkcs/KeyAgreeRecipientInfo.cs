namespace System.Security.Cryptography.Pkcs
{
    ...
    public sealed class KeyAgreeRecipientInfo : RecipientInfo
    {
        ...
        private System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO m_encryptedKeyInfo;
        ...
        internal KeyAgreeRecipientInfo(System.Security.Cryptography.SafeLocalAllocHandle pRecipientInfo, System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO certIdRecipient, uint index, uint subIndex) : base(RecipientInfoType.KeyAgreement, RecipientSubType.CertIdKeyAgreement, pRecipientInfo, certIdRecipient, index)
        {
            System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO encryptedKeyInfo = (System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO) Marshal.PtrToStructure(Marshal.ReadIntPtr(new IntPtr(((long) certIdRecipient.rgpRecipientEncryptedKeys) + (subIndex * Marshal.SizeOf(typeof(IntPtr))))), typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO));
            this.Reset(1, certIdRecipient.dwVersion, encryptedKeyInfo, subIndex);
        }

        internal KeyAgreeRecipientInfo(System.Security.Cryptography.SafeLocalAllocHandle pRecipientInfo, System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO publicKeyRecipient, uint index, uint subIndex) : base(RecipientInfoType.KeyAgreement, RecipientSubType.PublicKeyAgreement, pRecipientInfo, publicKeyRecipient, index)
        {
            System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO encryptedKeyInfo = (System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO) Marshal.PtrToStructure(Marshal.ReadIntPtr(new IntPtr(((long) publicKeyRecipient.rgpRecipientEncryptedKeys) + (subIndex * Marshal.SizeOf(typeof(IntPtr))))), typeof(System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO));
            this.Reset(2, publicKeyRecipient.dwVersion, encryptedKeyInfo, subIndex);
        }

        private void Reset(uint originatorChoice, uint version, System.Security.Cryptography.CAPIBase.CMSG_RECIPIENT_ENCRYPTED_KEY_INFO encryptedKeyInfo, uint subIndex)
        {
        ...
        public override AlgorithmIdentifier KeyEncryptionAlgorithm
        {
            get
            {
                if (this.m_encryptionAlgorithm == null)
                {
                    ...
                    {
                        System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO cmsgRecipientInfo = (System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO) base.CmsgRecipientInfo;
                        this.m_encryptionAlgorithm = new AlgorithmIdentifier(cmsgRecipientInfo.KeyEncryptionAlgorithm);
                    }
                    else
                    {
                        System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO cmsg_key_agree_public_key_recipient_info = (System.Security.Cryptography.CAPIBase.CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO) base.CmsgRecipientInfo;
        ...
        public CryptographicAttributeObject OtherKeyAttribute
        {
            get
            {
                if (this.m_otherKeyAttribute == null)
                {
                    ...
                    {
                        System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE_TYPE_VALUE cryptAttribute = (System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE_TYPE_VALUE) Marshal.PtrToStructure(this.m_encryptedKeyInfo.pOtherAttr, typeof(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE_TYPE_VALUE));
        ...
        internal System.Security.Cryptography.CAPIBase.CERT_ID RecipientId =>
            this.m_encryptedKeyInfo.RecipientId;
