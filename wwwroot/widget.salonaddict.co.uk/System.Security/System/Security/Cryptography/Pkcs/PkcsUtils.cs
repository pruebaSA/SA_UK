    ...
    internal class PkcsUtils
    {
        ...
        internal static unsafe uint AddCertsToMessage(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle, X509Certificate2Collection bagOfCerts, X509Certificate2Collection chainOfCerts)
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                {
                    System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context = *((System.Security.Cryptography.CAPIBase.CERT_CONTEXT*) System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(current).DangerousGetHandle());
        ...
        internal static bool CmsSupported()
        {
            if (m_cmsSupported == -1)
            {
                IntPtr hModule = System.Security.Cryptography.CAPISafe.LoadLibrary("Crypt32.dll");
                if (hModule != IntPtr.Zero)
                {
                    m_cmsSupported = (System.Security.Cryptography.CAPISafe.GetProcAddress(hModule, "CryptMsgVerifyCountersignatureEncodedEx") == IntPtr.Zero) ? 0 : 1;
                    System.Security.Cryptography.CAPISafe.FreeLibrary(hModule);
                }
            }
        ...
        internal static unsafe IntPtr CreateCryptAttributes(CryptographicAttributeObjectCollection attributes)
        {
            ...
            uint num3 = AlignedLength((uint) Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB)));
            ...
            while (enumerator3.MoveNext())
            {
                ...
                System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB* cryptoapi_blobPtr = (System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB*) (numPtr + AlignedLength((uint) bytes.Length));
        ...
        internal static unsafe X509Certificate2 CreateDummyCertificate(CspParameters parameters)
        {
            ...
            System.Security.Cryptography.CAPIBase.CRYPT_KEY_PROV_INFO structure = new System.Security.Cryptography.CAPIBase.CRYPT_KEY_PROV_INFO {
            ...
            System.Security.Cryptography.SafeLocalAllocHandle handle3 = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_KEY_PROV_INFO))));
            Marshal.StructureToPtr(structure, handle3.DangerousGetHandle(), false);
            System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER crypt_algorithm_identifier = new System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER {
                pszObjId = "1.3.14.3.2.29"
            };
            System.Security.Cryptography.SafeLocalAllocHandle handle4 = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER))));
            ...
            fixed (byte* numRef = name.RawData)
            {
                ...
                invalidHandle = System.Security.Cryptography.CAPIUnsafe.CertCreateSelfSignCertificate(hCryptProv, new IntPtr((void*) &cryptoapi_blob), 1, handle3.DangerousGetHandle(), handle4.DangerousGetHandle(), IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
            }
            Marshal.DestroyStructure(handle3.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPT_KEY_PROV_INFO));
            handle3.Dispose();
            Marshal.DestroyStructure(handle4.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER));
            handle4.Dispose();
        ...
        internal static unsafe System.Security.Cryptography.SafeLocalAllocHandle CreateEncodedCertBlob(X509Certificate2Collection certificates)
        {
            ...
            {
                invalidHandle = System.Security.Cryptography.CAPI.LocalAlloc(0, new IntPtr(certificates.Count * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB))));
                System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB* handle = (System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB*) invalidHandle.DangerousGetHandle();
                X509Certificate2Enumerator enumerator = certificates.GetEnumerator();
                while (enumerator.MoveNext())
                {
                    System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context = *((System.Security.Cryptography.CAPIBase.CERT_CONTEXT*) System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(enumerator.Current).DangerousGetHandle());
        ...
        internal static System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO CreateSignerEncodeInfo(CmsSigner signer) => 
            CreateSignerEncodeInfo(signer, false);

        internal static unsafe System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO CreateSignerEncodeInfo(CmsSigner signer, bool silent)
        {
            System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO cmsg_signer_encode_info = new System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO)));
            ...
            if (signer.SignerIdentifierType == SubjectIdentifierType.NoSignature)
            {
                ...
                if (!System.Security.Cryptography.CAPI.CryptAcquireContext(ref invalidHandle, (string) null, (string) null, 1, 0xf0000000) && !System.Security.Cryptography.CAPI.CryptAcquireContext(ref invalidHandle, (string) null, (string) null, 1, 0))
                {
                    throw new CryptographicException(Marshal.GetLastWin32Error());
                }
            ...
            if (!System.Security.Cryptography.CAPISafe.CryptAcquireCertificatePrivateKey(certContext, silent ? 70 : 6, IntPtr.Zero, ref invalidHandle, ref pdwKeySpec, ref pfCallerFreeProv))
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
            cmsg_signer_encode_info.dwKeySpec = pdwKeySpec;
            cmsg_signer_encode_info.hCryptProv = invalidHandle.DangerousGetHandle();
            GC.SuppressFinalize(invalidHandle);
            System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context = *((System.Security.Cryptography.CAPIBase.CERT_CONTEXT*) certContext.DangerousGetHandle());
            ...
            if (signer.SignerIdentifierType == SubjectIdentifierType.SubjectKeyIdentifier)
            {
                ...
                if (!System.Security.Cryptography.CAPISafe.CertGetCertificateContextProperty(certContext, 20, pvData, ref pcbData))
                {
                    throw new CryptographicException(Marshal.GetLastWin32Error());
                }
                if (pcbData <= 0)
        ...
        internal static unsafe X509IssuerSerial DecodeIssuerSerial(System.Security.Cryptography.CAPIBase.CERT_ISSUER_SERIAL_NUMBER pIssuerAndSerial)
        {
            System.Security.Cryptography.SafeLocalAllocHandle invalidHandle = System.Security.Cryptography.SafeLocalAllocHandle.InvalidHandle;
            uint csz = System.Security.Cryptography.CAPISafe.CertNameToStrW(0x10001, new IntPtr((void*) &pIssuerAndSerial.Issuer), 0x2000003, invalidHandle, 0);
            if (csz <= 1)
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
            invalidHandle = System.Security.Cryptography.CAPI.LocalAlloc(0, new IntPtr((long) (2 * csz)));
            if (System.Security.Cryptography.CAPISafe.CertNameToStrW(0x10001, new IntPtr((void*) &pIssuerAndSerial.Issuer), 0x2000003, invalidHandle, csz) <= 1)
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
        ...
        internal static string DecodeOctetString(byte[] encodedOctetString)
        {
            ...
            System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB cryptoapi_blob = (System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB) Marshal.PtrToStructure(decodedValue.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB));
        ...
        internal static unsafe AlgorithmIdentifier GetAlgorithmIdentifier(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle)
        {
            ...
            uint num = 0;
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 15, 0, IntPtr.Zero, new IntPtr((void*) &num)))
            {
            ...
            if (num > 0)
            {
                ...
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 15, 0, pvData, new IntPtr((void*) &num)))
                {
                    checkErr(Marshal.GetLastWin32Error());
                }
                System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER algorithmIdentifier = (System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER) Marshal.PtrToStructure(pvData.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER));
        ...
        internal static AsnEncodedDataCollection GetAsnEncodedDataCollection(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE cryptAttribute)
        {
            ...
            {
                IntPtr pBlob = new IntPtr(((long) cryptAttribute.rgValue) + (i * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB))));
        ...
        internal static AsnEncodedDataCollection GetAsnEncodedDataCollection(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE_TYPE_VALUE cryptAttribute) => 
            new AsnEncodedDataCollection { new Pkcs9AttributeObject(new Oid(cryptAttribute.pszObjId), System.Security.Cryptography.CAPI.BlobToByteArray(cryptAttribute.Value)) };
        ...
        internal static unsafe X509Certificate2Collection GetCertificates(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle)
        {
            ...
            X509Certificate2Collection certificates = new X509Certificate2Collection();
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 11, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
            {
                checkErr(Marshal.GetLastWin32Error());
            }
            for (uint i = 0; i < num; i++)
            {
                ...
                if (cbData > 0)
                {
                    System.Security.Cryptography.SafeCertContextHandle handle2 = System.Security.Cryptography.CAPISafe.CertCreateCertificateContext(0x10001, invalidHandle, cbData);
        ...
        {
            uint dwFlags = 1;
            uint num2 = (uint) Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.PROV_ENUMALGS_EX));
            System.Security.Cryptography.SafeLocalAllocHandle handle = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.PROV_ENUMALGS_EX))));
            using (handle)
            {
                while (System.Security.Cryptography.CAPISafe.CryptGetProvParam(safeCryptProvHandle, 0x16, handle.DangerousGetHandle(), new IntPtr((void*) &num2), dwFlags))
                {
                    System.Security.Cryptography.CAPIBase.PROV_ENUMALGS_EX prov_enumalgs_ex = (System.Security.Cryptography.CAPIBase.PROV_ENUMALGS_EX) Marshal.PtrToStructure(handle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.PROV_ENUMALGS_EX));
        ...
        internal static unsafe uint GetMessageType(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle)
        {
            uint num = 0;
            uint num2 = (uint) Marshal.SizeOf(typeof(uint));
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 1, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
            {
                checkErr(Marshal.GetLastWin32Error());
            }
            return num;
        ...
        internal static unsafe void GetParam(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle, uint paramType, uint index, out System.Security.Cryptography.SafeLocalAllocHandle pvData, out uint cbData)
        {
            ...
            {
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, paramType, index, pvData, new IntPtr((void*) numRef)))
                {
                    checkErr(Marshal.GetLastWin32Error());
                }
                if (cbData > 0)
        ...
        internal static unsafe void GetParam(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle, uint paramType, uint index, out byte[] pvData, out uint cbData)
        {
            ...
            fixed (uint* numRef = ((uint*) cbData))
            {
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, paramType, index, IntPtr.Zero, new IntPtr((void*) numRef)))
                {
                    checkErr(Marshal.GetLastWin32Error());
                }
                if (cbData > 0)
                {
                    ...
                    {
                        if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, paramType, index, new IntPtr((void*) numRef2), new IntPtr((void*) numRef)))
                        {
                            checkErr(Marshal.GetLastWin32Error());
                        }
                    }
        ...
        internal static RecipientInfoType GetRecipientInfoType(X509Certificate2 certificate)
        {
            ...
            System.Security.Cryptography.CAPIBase.CERT_CONTEXT cert_context = (System.Security.Cryptography.CAPIBase.CERT_CONTEXT) Marshal.PtrToStructure(System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(certificate).DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CERT_CONTEXT));
        ...
        internal static unsafe int GetSignerIndex(System.Security.Cryptography.SafeCryptMsgHandle safeCrytpMsgHandle, SignerInfo signerInfo, int startIndex)
        {
            uint num = 0;
            uint num2 = (uint) Marshal.SizeOf(typeof(uint));
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCrytpMsgHandle, 5, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
            {
                checkErr(Marshal.GetLastWin32Error());
            }
            ...
            {
                uint num4 = 0;
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCrytpMsgHandle, 6, (uint) i, IntPtr.Zero, new IntPtr((void*) &num4)))
                {
                    checkErr(Marshal.GetLastWin32Error());
                }
                if (num4 > 0)
                {
                    ...
                    if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCrytpMsgHandle, 6, (uint) i, pvData, new IntPtr((void*) &num4)))
                    {
                        checkErr(Marshal.GetLastWin32Error());
                    }
                    System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO cmsgSignerInfo = signerInfo.GetCmsgSignerInfo();
                    System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO cmsg_signer_info2 = (System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO) Marshal.PtrToStructure(pvData.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO));
        ...
        internal static unsafe CryptographicAttributeObjectCollection GetUnprotectedAttributes(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle)
        {
            ...
            System.Security.Cryptography.SafeLocalAllocHandle invalidHandle = System.Security.Cryptography.SafeLocalAllocHandle.InvalidHandle;
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 0x25, 0, invalidHandle, new IntPtr((void*) &num)) && (Marshal.GetLastWin32Error() != -2146889713))
            {
                checkErr(Marshal.GetLastWin32Error());
            }
            if (num <= 0)
            ...
            {
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 0x25, 0, invalidHandle, new IntPtr((void*) &num)))
                {
                    checkErr(Marshal.GetLastWin32Error());
                }
        ...
        internal static unsafe uint GetVersion(System.Security.Cryptography.SafeCryptMsgHandle safeCryptMsgHandle)
        {
            uint num = 0;
            uint num2 = (uint) Marshal.SizeOf(typeof(uint));
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(safeCryptMsgHandle, 30, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
            {
                checkErr(Marshal.GetLastWin32Error());
            }
            return num;
