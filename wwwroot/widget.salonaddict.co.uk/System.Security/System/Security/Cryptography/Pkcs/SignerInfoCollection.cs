namespace System.Security.Cryptography.Pkcs
{
    ...
    public sealed class SignerInfoCollection : ICollection, IEnumerable
    {
        ...
        internal unsafe SignerInfoCollection(SignedCms signedCms)
        {
            ...
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(cryptMsgHandle, 5, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
            {
            ...
            {
                uint num4 = 0;
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(cryptMsgHandle, 6, (uint) i, IntPtr.Zero, new IntPtr((void*) &num4)))
                {
                    throw new CryptographicException(Marshal.GetLastWin32Error());
                }
                ...
                if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(cryptMsgHandle, 6, (uint) i, pvData, new IntPtr((void*) &num4)))
                {
                    throw new CryptographicException(Marshal.GetLastWin32Error());
                }
        ...
        public SignerInfoEnumerator GetEnumerator() => 
            new SignerInfoEnumerator(this);

        IEnumerator IEnumerable.GetEnumerator() => 
            new SignerInfoEnumerator(this);

        public int Count =>
            this.m_signerInfos.Length;
