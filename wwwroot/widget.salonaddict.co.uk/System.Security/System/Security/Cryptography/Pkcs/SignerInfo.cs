namespace System.Security.Cryptography.Pkcs
{
    ...
    public sealed class SignerInfo
    {
        ...
        private System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO m_cmsgSignerInfo;
        ...
        internal SignerInfo(SignedCms signedCms, System.Security.Cryptography.SafeLocalAllocHandle pbCmsgSignerInfo)
        {
            ...
            this.m_cmsgSignerInfo = (System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO) Marshal.PtrToStructure(pbCmsgSignerInfo.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO));
        }
        ...
        internal unsafe SignerInfo(SignedCms signedCms, SignerInfo parentSignerInfo, byte[] encodedSignerInfo)
        {
            ...
            this.m_cmsgSignerInfo = (System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO) Marshal.PtrToStructure(invalidHandle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO));
        }

        public unsafe void CheckHash()
        {
            int size = Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_CTRL_VERIFY_SIGNATURE_EX_PARA));
            System.Security.Cryptography.CAPIBase.CMSG_CTRL_VERIFY_SIGNATURE_EX_PARA cmsg_ctrl_verify_signature_ex_para = new System.Security.Cryptography.CAPIBase.CMSG_CTRL_VERIFY_SIGNATURE_EX_PARA(size) {
                dwSignerType = 4,
        ...
        private void CounterSign(CmsSigner signer)
        {
            ...
            System.Security.Cryptography.SafeLocalAllocHandle handle = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO))));
            System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO structure = PkcsUtils.CreateSignerEncodeInfo(signer);
            try
            {
            ...
            {
                Marshal.DestroyStructure(handle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO));
                handle.Dispose();
                structure.Dispose();
            }
        ...
        internal System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO GetCmsgSignerInfo() => 
            this.m_cmsgSignerInfo;
        ...
        private unsafe void RemoveCounterSignature(int parentIndex, int childIndex)
        {
            ...
            if (PkcsUtils.CmsSupported())
            {
                ...
                System.Security.Cryptography.CAPIBase.CMSG_CMS_SIGNER_INFO cmsg_cms_signer_info = (System.Security.Cryptography.CAPIBase.CMSG_CMS_SIGNER_INFO) Marshal.PtrToStructure(invalidHandle.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_CMS_SIGNER_INFO));
            ...
            else
            {
                ...
                System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO cmsg_signer_info = (System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO) Marshal.PtrToStructure(pvData.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_INFO));
            ...
            {
                System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE crypt_attribute = (System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE) Marshal.PtrToStructure(zero, typeof(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE));
                if ((string.Compare(crypt_attribute.pszObjId, "1.2.840.113549.1.9.6", StringComparison.OrdinalIgnoreCase) == 0) && (crypt_attribute.cValue > 0))
                {
                    ...
                    {
                        System.Security.Cryptography.CAPIBase.CMSG_CTRL_DEL_SIGNER_UNAUTH_ATTR_PARA cmsg_ctrl_del_signer_unauth_attr_para = new System.Security.Cryptography.CAPIBase.CMSG_CTRL_DEL_SIGNER_UNAUTH_ATTR_PARA(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_CTRL_DEL_SIGNER_UNAUTH_ATTR_PARA))) {
                        ...
                        if (crypt_attribute.cValue > 1)
                        {
                            ...
                            {
                                byte[] buffer;
                                uint num5 = (uint) ((crypt_attribute.cValue - 1) * Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB)));
                                ...
                                System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB* rgValue = (System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB*) crypt_attribute.rgValue;
                                System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB* handle = (System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB*) handle4.DangerousGetHandle();
                                int num6 = 0;
                                ...
                                System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE structure = new System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE {
                                    pszObjId = crypt_attribute.pszObjId,
                                    cValue = crypt_attribute.cValue - 1,
                                    rgValue = handle4.DangerousGetHandle()
                                };
                                System.Security.Cryptography.SafeLocalAllocHandle handle5 = System.Security.Cryptography.CAPI.LocalAlloc(0x40, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE))));
                                ...
                                {
                                    Marshal.DestroyStructure(handle5.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE));
                                    handle5.Dispose();
                                }
                                fixed (byte* numRef = buffer)
                                {
                                    System.Security.Cryptography.CAPIBase.CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA cmsg_ctrl_add_signer_unauth_attr_para = new System.Security.Cryptography.CAPIBase.CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA))) {
                                        dwSignerIndex = (uint) parentIndex,
                                        blob = { 
                            ...
                            catch (CryptographicException)
                            {
                                ...
                                if (System.Security.Cryptography.CAPI.EncodeObject(new IntPtr(0x16L), zero, out buffer2))
                                {
                                    ...
                                    {
                                        System.Security.Cryptography.CAPIBase.CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA cmsg_ctrl_add_signer_unauth_attr_para2 = new System.Security.Cryptography.CAPIBase.CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA))) {
                                            dwSignerIndex = (uint) parentIndex,
                                            blob = { 
                                                cbData = (uint) buffer2.Length,
                                                pbData = new IntPtr((void*) numRef2)
                                            }
                                        };
                ...
                zero = new IntPtr(((long) zero) + Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTE)));
            }
        ...
        private unsafe void Verify(X509Certificate2Collection extraStore, X509Certificate2 certificate, bool verifySignatureOnly)
        {
            ...
            IntPtr ptr = new IntPtr(((long) cert_context.pCertInfo) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_INFO), "SubjectPublicKeyInfo")));
            IntPtr ptr2 = new IntPtr(((long) ptr) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CERT_PUBLIC_KEY_INFO), "Algorithm")));
            IntPtr ptr3 = new IntPtr(((long) ptr2) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER), "Parameters")));
            IntPtr pvKey = Marshal.ReadIntPtr(ptr2);
            if (System.Security.Cryptography.CAPI.CryptFindOIDInfo(1, pvKey, 3).Algid == 0x2200)
            {
                bool flag = false;
                IntPtr ptr5 = new IntPtr(((long) ptr3) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "cbData")));
                IntPtr ptr6 = new IntPtr(((long) ptr3) + ((long) Marshal.OffsetOf(typeof(System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB), "pbData")));
                ...
                if (flag)
                {
                    ...
                    uint pcbData = 0;
                    if (!System.Security.Cryptography.CAPISafe.CertGetCertificateContextProperty(System.Security.Cryptography.X509Certificates.X509Utils.GetCertContext(certificate), 0x16, invalidHandle, ref pcbData))
                    {
                        throw new CryptographicException(Marshal.GetLastWin32Error());
                    }
                    if (pcbData > 0)
        ...
        Label_022F:
            ...
            try
            {
                ...
                {
                    if (!System.Security.Cryptography.CAPISafe.CryptMsgVerifyCountersignatureEncoded(IntPtr.Zero, 0x10001, pvData.DangerousGetHandle(), cbData, new IntPtr((void*) numRef), (uint) this.m_encodedSignerInfo.Length, cert_context.pCertInfo))
                    {
        ...
        public Oid DigestAlgorithm =>
            new Oid(this.m_cmsgSignerInfo.HashAlgorithm.pszObjId);
        ...
        public int Version =>
            ((int) this.m_cmsgSignerInfo.dwVersion);
    }
}
