namespace System.Security.Cryptography.Pkcs
{
    ...
    public sealed class SignedCms
    {
        ...
        {
            using (System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO cmsg_signer_encode_info = PkcsUtils.CreateSignerEncodeInfo(signer, silent))
            {
        ...
        {
            System.Security.Cryptography.SafeCryptMsgHandle hCryptMsg = System.Security.Cryptography.CAPISafe.CryptMsgOpenToDecode(0x10001, detached ? 4 : 0, 0, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero);
            ...
            if (detached)
            {
                ...
                if (((content != null) && (content.Length > 0)) && !System.Security.Cryptography.CAPISafe.CryptMsgUpdate(hCryptMsg, content, (uint) content.Length, true))
                {
                    throw new CryptographicException(Marshal.GetLastWin32Error());
                }
            }
        ...
        public unsafe void RemoveSignature(int index)
        {
            ...
            if (!System.Security.Cryptography.CAPISafe.CryptMsgGetParam(this.m_safeCryptMsgHandle, 5, 0, new IntPtr((void*) &num), new IntPtr((void*) &num2)))
            {
                throw new CryptographicException(Marshal.GetLastWin32Error());
            }
        ...
        private unsafe void Sign(CmsSigner signer, bool silent)
        {
            ...
            System.Security.Cryptography.CAPIBase.CMSG_SIGNED_ENCODE_INFO cmsg_signed_encode_info = new System.Security.Cryptography.CAPIBase.CMSG_SIGNED_ENCODE_INFO(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNED_ENCODE_INFO)));
            System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO structure = PkcsUtils.CreateSignerEncodeInfo(signer, silent);
            byte[] encodedMessage = null;
            try
            {
                System.Security.Cryptography.SafeLocalAllocHandle handle2 = System.Security.Cryptography.CAPI.LocalAlloc(0, new IntPtr(Marshal.SizeOf(typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO))));
                try
                {
                    ...
                    if ((this.ContentInfo.Content.Length > 0) && !System.Security.Cryptography.CAPISafe.CryptMsgUpdate(hCryptMsg, this.ContentInfo.pContent, (uint) this.ContentInfo.Content.Length, true))
                    {
                        throw new CryptographicException(Marshal.GetLastWin32Error());
                    }
                ...
                {
                    Marshal.DestroyStructure(handle2.DangerousGetHandle(), typeof(System.Security.Cryptography.CAPIBase.CMSG_SIGNER_ENCODE_INFO));
                    handle2.Dispose();
                }
            }
            finally
