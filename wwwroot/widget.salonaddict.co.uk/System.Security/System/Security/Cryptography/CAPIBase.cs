namespace System.Security.Cryptography
{
    ...
    internal abstract class CAPIBase
    {
        ...
        {
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB SubjectType;
        ...
        internal struct CERT_CHAIN_PARA
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CERT_USAGE_MATCH RequestedUsage;
            internal System.Security.Cryptography.CAPIBase.CERT_USAGE_MATCH RequestedIssuancePolicy;
        ...
        {
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB p;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB q;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB g;
        }
        ...
        internal struct CERT_EXTENSION
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB Value;
        }
        ...
        internal struct CERT_ID
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CERT_ID_UNION Value;
        }
        ...
        {
            [FieldOffset(0)]
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB HashId;
            [FieldOffset(0)]
            internal System.Security.Cryptography.CAPIBase.CERT_ISSUER_SERIAL_NUMBER IssuerSerialNumber;
            [FieldOffset(0)]
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB KeyId;
        }
        ...
        internal struct CERT_INFO
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB SerialNumber;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER SignatureAlgorithm;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB Issuer;
            ...
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB Subject;
            internal System.Security.Cryptography.CAPIBase.CERT_PUBLIC_KEY_INFO SubjectPublicKeyInfo;
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB IssuerUniqueId;
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB SubjectUniqueId;
        ...
        internal struct CERT_KEY_USAGE_RESTRICTION_INFO
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB RestrictedKeyUsage;
        }
        ...
        internal struct CERT_POLICY_QUALIFIER_INFO
        {
            ...
            private System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB Qualifier;
        }

        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Unicode)]
        internal struct CERT_PUBLIC_KEY_INFO
        {
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER Algorithm;
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB PublicKey;
        }

        [StructLayout(LayoutKind.Sequential, CharSet=CharSet.Unicode)]
        internal struct CERT_PUBLIC_KEY_INFO2
        {
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER2 Algorithm;
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB PublicKey;
        }
        ...
        internal struct CERT_USAGE_MATCH
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CERT_ENHKEY_USAGE Usage;
        }
        ...
        {
            internal uint dwVersion;
            internal System.Security.Cryptography.CAPIBase.CERT_ID SignerId;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER HashAlgorithm;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER HashEncryptionAlgorithm;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB EncryptedHash;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTES AuthAttrs;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ATTRIBUTES UnauthAttrs;
        }
        ...
        internal struct CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB blob;
            internal CMSG_CTRL_ADD_SIGNER_UNAUTH_ATTR_PARA(int size)
            {
                this.cbSize = (uint) size;
                this.dwSignerIndex = 0;
                this.blob = new System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB();
            }
        }
        ...
        internal struct CMSG_CTRL_KEY_AGREE_DECRYPT_PARA
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB OriginatorPublicKey;
            internal CMSG_CTRL_KEY_AGREE_DECRYPT_PARA(int size)
            {
                ...
                this.OriginatorPublicKey = new System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB();
            }
        }
        ...
        internal struct CMSG_ENVELOPED_ENCODE_INFO
        {
            internal uint cbSize;
            internal IntPtr hCryptProv;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER ContentEncryptionAlgorithm;
            ...
            internal CMSG_ENVELOPED_ENCODE_INFO(int size)
            {
                this.cbSize = (uint) size;
                this.hCryptProv = IntPtr.Zero;
                this.ContentEncryptionAlgorithm = new System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER();
        ...
        internal struct CMSG_KEY_AGREE_CERT_ID_RECIPIENT_INFO
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CERT_ID OriginatorCertId;
            internal IntPtr Padding;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB UserKeyingMaterial;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER KeyEncryptionAlgorithm;
        ...
        internal struct CMSG_KEY_AGREE_PUBLIC_KEY_RECIPIENT_INFO
        {
            internal uint dwVersion;
            internal uint dwOriginatorChoice;
            internal System.Security.Cryptography.CAPIBase.CERT_PUBLIC_KEY_INFO OriginatorPublicKeyInfo;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB UserKeyingMaterial;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER KeyEncryptionAlgorithm;
            internal uint cRecipientEncryptedKeys;
            internal IntPtr rgpRecipientEncryptedKeys;
        ...
        internal struct CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER KeyWrapAlgorithm;
        ...
        internal struct CMSG_KEY_TRANS_RECIPIENT_ENCODE_INFO
        {
            ...
            internal IntPtr pvKeyEncryptionAuxInfo;
            internal IntPtr hCryptProv;
            internal System.Security.Cryptography.CAPIBase.CRYPT_BIT_BLOB RecipientPublicKey;
            internal System.Security.Cryptography.CAPIBase.CERT_ID RecipientId;
        }
        ...
        internal struct CMSG_KEY_TRANS_RECIPIENT_INFO
        {
            ...
            internal System.Security.Cryptography.CAPIBase.CERT_ID RecipientId;
            internal System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER KeyEncryptionAlgorithm;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB EncryptedKey;
        }
        ...
        internal struct CMSG_SIGNER_ENCODE_INFO
        {
            ...
            internal CMSG_SIGNER_ENCODE_INFO(int size)
            {
                ...
                this.hCryptProv = IntPtr.Zero;
                this.dwKeySpec = 0;
                this.HashAlgorithm = new System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER();
                this.pvHashAuxInfo = IntPtr.Zero;
                this.cAuthAttr = 0;
                this.rgAuthAttr = IntPtr.Zero;
                this.cUnauthAttr = 0;
                this.rgUnauthAttr = IntPtr.Zero;
                this.SignerId = new System.Security.Cryptography.CAPIBase.CERT_ID();
                this.HashEncryptionAlgorithm = new System.Security.Cryptography.CAPIBase.CRYPT_ALGORITHM_IDENTIFIER();
        ...
        internal class CMSG_STREAM_INFO
        {
            ...
            internal System.Security.Cryptography.CAPIBase.PFN_CMSG_STREAM_OUTPUT pfnStreamOutput;
            internal IntPtr pvArg;
            internal CMSG_STREAM_INFO(uint cbContent, System.Security.Cryptography.CAPIBase.PFN_CMSG_STREAM_OUTPUT pfnStreamOutput, IntPtr pvArg)
            {
        ...
        internal struct CRYPT_ALGORITHM_IDENTIFIER
        {
            [MarshalAs(UnmanagedType.LPStr)]
            internal string pszObjId;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB Parameters;
        }
        ...
        internal struct CRYPT_OID_INFO
        {
            ...
            internal uint Algid;
            internal System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB ExtraInfo;
            internal CRYPT_OID_INFO(int size)
            {
                ...
                this.dwGroupId = 0;
                this.Algid = 0;
                this.ExtraInfo = new System.Security.Cryptography.CAPIBase.CRYPTOAPI_BLOB();
            }
        }
