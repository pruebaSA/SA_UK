namespace System.Security.Cryptography.Xml
{
    ...
    internal class Utils
    {
        ...
        internal static bool AllowDetachedSignature()
        {
            ...
            {
                bool flag = GetNetFxSecurityRegistryValue("SignedXmlAllowDetachedSignature", 0L) != 0L;
                s_allowDetachedSignature = new bool?(flag);
            }
        ...
        internal static long GetMaxCharactersFromEntities()
        {
            ...
            {
                maxCharactersFromEntities = new long?(GetNetFxSecurityRegistryValue("SignedXmlMaxCharactersFromEntities", 0x989680L));
            }
        ...
        internal static int GetXmlDsigSearchDepth()
        {
            ...
            {
                xmlDsigSearchDepth = new int?((int) GetNetFxSecurityRegistryValue("SignedDigitalSignatureXmlMaxDepth", 20L));
            }
        ...
        private static bool HasNamespace(XmlElement element, string prefix, string value) => 
            (IsCommittedNamespace(element, prefix, value) || ((element.Prefix == prefix) && (element.NamespaceURI == value)));

        internal static bool HasNamespacePrefix(XmlAttribute a, string nsPrefix) => 
            GetNamespacePrefix(a).Equals(nsPrefix);
        ...
        internal static bool IsEmptyDefaultNamespaceNode(XmlNode n) => 
            (IsDefaultNamespaceNode(n) && (n.Value.Length == 0));
        ...
        internal static bool IsXmlNamespaceNode(XmlNode n) => 
            ((n.NodeType == XmlNodeType.Attribute) && n.Prefix.Equals("xml"));
