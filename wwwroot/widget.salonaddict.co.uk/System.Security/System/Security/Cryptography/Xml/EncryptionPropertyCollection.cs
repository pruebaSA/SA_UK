namespace System.Security.Cryptography.Xml
{
    ...
    public sealed class EncryptionPropertyCollection : IList, ICollection, IEnumerable
    {
        ...
        public IEnumerator GetEnumerator() => 
            this.m_props.GetEnumerator();

        public int IndexOf(EncryptionProperty value) => 
            this.m_props.IndexOf(value);
        ...
        public EncryptionProperty Item(int index) => 
            ((EncryptionProperty) this.m_props[index]);
        ...
        public bool IsFixedSize =>
            this.m_props.IsFixedSize;

        public bool IsReadOnly =>
            this.m_props.IsReadOnly;

        public bool IsSynchronized =>
            this.m_props.IsSynchronized;

        public EncryptionProperty this[int index]
        {
            get => 
                ((EncryptionProperty) ((IList) this)[index]);
            set
            {
