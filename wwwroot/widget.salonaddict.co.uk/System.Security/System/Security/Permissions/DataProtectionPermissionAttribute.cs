namespace System.Security.Permissions
{
    ...
    public sealed class DataProtectionPermissionAttribute : CodeAccessSecurityAttribute
    {
        ...
        {
            get => 
                ((this.m_flags & DataProtectionPermissionFlags.ProtectData) != DataProtectionPermissionFlags.NoFlags);
            set
            {
        ...
        {
            get => 
                ((this.m_flags & DataProtectionPermissionFlags.ProtectMemory) != DataProtectionPermissionFlags.NoFlags);
            set
            {
        ...
        {
            get => 
                ((this.m_flags & DataProtectionPermissionFlags.UnprotectData) != DataProtectionPermissionFlags.NoFlags);
            set
            {
        ...
        {
            get => 
                ((this.m_flags & DataProtectionPermissionFlags.UnprotectMemory) != DataProtectionPermissionFlags.NoFlags);
            set
            {
