        ...
        public Transaction UnmarshalTransaction(WsatTransactionInfo info)
        {
            ...
            if (this.wsatConfig.OleTxUpgradeEnabled)
            {
                ...
                if (propagationToken != null)
                {
                    ...
                    {
                        DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.TxFailedToNegotiateOleTx, System.ServiceModel.SR.GetString("TraceCodeTxFailedToNegotiateOleTx", new object[] { info.Context.Identifier }));
                    }
                }
            }
