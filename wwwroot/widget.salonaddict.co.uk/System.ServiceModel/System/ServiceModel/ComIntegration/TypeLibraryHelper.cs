namespace System.ServiceModel.ComIntegration
{
    ...
    internal sealed class TypeLibraryHelper
    {
        ...
        internal class ConversionEventHandler : ITypeLibImporterNotifySink
        {
            ...
            {
                ComPlusTLBImportTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationTLBImportConverterEvent, "TraceCodeComIntegrationTLBImportConverterEvent", this.iid, this.typeLibraryID, eventKind, eventCode, eventMsg);
            }
