namespace System.ServiceModel.ComIntegration
{
    ...
    internal static class SafeNativeMethods
    {
        ...
        [DllImport("advapi32.dll", EntryPoint="OpenThreadToken", SetLastError=true)]
        internal static extern bool OpenCurrentThreadTokenCritical([In] IntPtr ThreadHandle, [In] TokenAccessLevels DesiredAccess, [In] bool OpenAsSelf, out SafeCloseHandleCritical TokenHandle);
