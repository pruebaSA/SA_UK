    ...
    internal class MexServiceChannelBuilder : IProxyCreator, IDisposable, IProvideChannelBuilderSettings
    {
                ...
                lock (this)
                {
                    if (this.serviceChannel == null)
                    {
                        try
                        {
                            ...
                            ComPlusChannelCreatedTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationChannelCreated, "TraceCodeComIntegrationChannelCreated", this.serviceEndpoint.Address.Uri, this.contractDescription.ContractType);
                            if (this.serviceChannel == null)
                            {
                                throw DiagnosticUtility.ExceptionUtility.ThrowHelperInternal(false);
                            }
        ...
        private void DoMex()
        {
            ...
            try
            {
                ...
                ComPlusMexChannelBuilderMexCompleteTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationMexMonikerMetadataExchangeComplete, "TraceCodeComIntegrationMexMonikerMetadataExchangeComplete", serviceEndpointsRetrieved);
            }
        ...
        Label_0634:
            ...
            ComPlusMexChannelBuilderTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationMexChannelBuilderLoaded, "TraceCodeComIntegrationMexChannelBuilderLoaded", endpoint.Contract, endpoint.Binding, str8);
        }
