namespace System.ServiceModel.ComIntegration
{
    ...
    internal class TransactionProxy : ITransactionProxy, IExtension<InstanceContext>
    {
        ...
        public Guid GetIdentifier() => 
            this.currentTransaction.TransactionInformation.DistributedIdentifier;
        ...
        private class VoterBallot : ITransactionVoterBallotAsync2, IEnlistmentNotification
        {
            ...
            public void Commit(Enlistment enlistment)
            {
                ...
                ComPlusTxProxyTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationTxProxyTxCommitted, "TraceCodeComIntegrationTxProxyTxCommitted", this.proxy.AppId, this.proxy.Clsid, this.transaction.TransactionInformation.DistributedIdentifier, this.proxy.InstanceID);
            ...
            public void Rollback(Enlistment enlistment)
            {
                ...
                ComPlusTxProxyTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationTxProxyTxAbortedByTM, "TraceCodeComIntegrationTxProxyTxAbortedByTM", this.proxy.AppId, this.proxy.Clsid, this.transaction.TransactionInformation.DistributedIdentifier, this.proxy.InstanceID);
                Marshal.ReleaseComObject(this.notification);
                this.notification = null;
            }
            ...
            public void VoteRequestDone(int hr, int reason)
            {
                ...
                else
                {
                    ...
                    ComPlusTxProxyTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationTxProxyTxAbortedByContext, "TraceCodeComIntegrationTxProxyTxAbortedByContext", this.proxy.AppId, this.proxy.Clsid, this.transaction.TransactionInformation.DistributedIdentifier, this.proxy.InstanceID);
                }
            }
        }
    }
