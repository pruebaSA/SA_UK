namespace System.ServiceModel.ComIntegration
{
    ...
    internal class ComPlusInstanceCreationRequestSchema : TraceRecord
    {
        ...
        public override string ToString() => 
            System.ServiceModel.SR.GetString("ComPlusInstanceCreationRequestSchema", new object[] { this.from.ToString(), this.appid.ToString(), this.clsid.ToString(), this.incomingTransactionID.ToString(), this.requestingIdentity });
        ...
        internal override string EventId =>
            "http://schemas.microsoft.com/2006/08/ServiceModel/ComPlusInstanceCreationRequestTraceRecord";
    }
}
