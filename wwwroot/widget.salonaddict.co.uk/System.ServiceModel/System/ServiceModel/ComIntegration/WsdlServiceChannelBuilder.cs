    ...
    internal class WsdlServiceChannelBuilder : IProxyCreator, IDisposable, IProvideChannelBuilderSettings
    {
        ...
        private void ProcessWsdl()
        {
            ...
            try
            {
                ...
                ComPlusWsdlChannelBuilderTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationWsdlChannelBuilderLoaded, "TraceCodeComIntegrationWsdlChannelBuilderLoaded", name2, name, serviceDescription, this.contractDescription, binding, serviceDescription.Types.Schemas);
            }
