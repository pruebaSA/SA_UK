namespace System.ServiceModel.ComIntegration
{
    ...
    internal class ComPlusInstanceProvider : IInstanceProvider
    {
        ...
        public object GetInstance(InstanceContext instanceContext, Message message)
        {
            ...
            ComPlusInstanceCreationTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationInstanceCreationRequest, "TraceCodeComIntegrationInstanceCreationRequest", this.info, message, empty);
            ...
            ComPlusInstanceCreationTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationInstanceCreationSuccess, "TraceCodeComIntegrationInstanceCreationSuccess", this.info, message, obj2.GetHashCode(), empty);
            return obj2;
        }
        ...
        public void ReleaseInstance(InstanceContext instanceContext, object instance)
        {
            ...
            ComPlusInstanceCreationTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationInstanceReleased, "TraceCodeComIntegrationInstanceReleased", this.info, instanceContext, hashCode);
        }
