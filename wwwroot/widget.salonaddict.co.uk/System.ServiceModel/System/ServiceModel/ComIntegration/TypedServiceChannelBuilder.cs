namespace System.ServiceModel.ComIntegration
{
    ...
    internal class TypedServiceChannelBuilder : IProxyCreator, IDisposable, IProvideChannelBuilderSettings, ICreateServiceChannel
    {
        ...
        private bool CheckDispatch(ref Guid riid) => 
            (this.dispatchEnabled && (riid == InterfaceID.idIDispatch));
        ...
        private ServiceEndpoint CreateServiceEndpoint()
        {
            ...
            ComPlusTypedChannelBuilderTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationTypedChannelBuilderLoaded, "TraceCodeComIntegrationTypedChannelBuilderLoaded", this.contractType, this.binding);
                ...
                lock (this)
                {
                    if (this.serviceProxy == null)
                    {
                        try
                        {
                            ...
                            ComPlusChannelCreatedTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationChannelCreated, "TraceCodeComIntegrationChannelCreated", this.serviceEndpoint.Address.Uri, this.contractType);
