namespace System.ServiceModel.ComIntegration
{
    ...
    internal class ComPlusSynchronizationContext : SynchronizationContext
    {
        ...
        {
            ComPlusActivityTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationEnteringActivity, "TraceCodeComIntegrationEnteringActivity");
            ...
            ComPlusActivityTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationLeftActivity, "TraceCodeComIntegrationLeftActivity");
        }
        ...
        private class ServiceCall : IServiceCall
        {
            ...
            public void OnCall()
            {
                ...
                try
                {
                    ...
                    ComPlusActivityTrace.Trace(TraceEventType.Verbose, TraceCode.ComIntegrationExecutingCall, "TraceCodeComIntegrationExecutingCall");
