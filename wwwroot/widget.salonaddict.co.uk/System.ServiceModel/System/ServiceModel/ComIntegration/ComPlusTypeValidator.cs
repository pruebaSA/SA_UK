namespace System.ServiceModel.ComIntegration
{
    ...
    internal static class ComPlusTypeValidator
    {
        ...
        public static bool IsValidInterface(Guid iid) => 
            (((!(iid == IID_Object) && !(iid == IID_IDisposable)) && (!(iid == IID_IManagedObject) && !(iid == IID_IProcessInitializer))) && ((!(iid == IID_IRemoteDispatch) && !(iid == IID_IServicedComponentInfo)) && !iid.ToString("D").EndsWith("C000-000000000046", StringComparison.OrdinalIgnoreCase)));
