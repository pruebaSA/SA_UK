namespace System.ServiceModel.ComIntegration
{
    ...
    internal class ComPlusServiceLoader
    {
        ...
        private void AddBehaviors(System.ServiceModel.Description.ServiceDescription service)
        {
            ...
            if (ServiceHostingEnvironment.IsHosted && (service.Behaviors.Find<AspNetCompatibilityRequirementsAttribute>() == null))
            {
        ...
        public System.ServiceModel.Description.ServiceDescription Load(ServiceHostBase host)
        {
            ...
            ComPlusServiceHostTrace.Trace(TraceEventType.Information, TraceCode.ComIntegrationServiceHostCreatedServiceEndpoint, "TraceCodeComIntegrationServiceHostCreatedServiceEndpoint", this.info, service.Endpoints);
            return service;
        }
        ...
        private void ValidateConfigInstanceSettings(System.ServiceModel.Description.ServiceDescription service)
        {
            ...
            {
                if ((endpoint != null) && !ServiceMetadataBehavior.IsMetadataEndpoint(service, endpoint))
                {
