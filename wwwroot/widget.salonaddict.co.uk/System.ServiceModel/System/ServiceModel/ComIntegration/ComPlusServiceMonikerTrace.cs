namespace System.ServiceModel.ComIntegration
{
    ...
    {
        public static void Trace(TraceEventType type, TraceCode code, string description, Dictionary<MonikerHelper.MonikerAttribute, string> propertyTable)
        {
            if (DiagnosticUtility.ShouldTrace(type))
            {
                ...
                ComPlusServiceMonikerSchema trace = new ComPlusServiceMonikerSchema(str, str2, str15, wsdl, str5, str6, str7, str3, str4, str16, str9, str10, str11, str12, str13, str14);
