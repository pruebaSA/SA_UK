namespace System.ServiceModel
{
    ...
    public class FaultException<TDetail> : FaultException
    {
        ...
        public override MessageFault CreateMessageFault() => 
            MessageFault.CreateFault(base.Code, base.Reason, this.detail);
        ...
        public override string ToString() => 
            System.ServiceModel.SR.GetString("SFxFaultExceptionToString3", new object[] { base.GetType(), this.Message, this.detail.ToString() });
