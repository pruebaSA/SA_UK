namespace System.ServiceModel.Security
{
    ...
    internal class SecuritySessionSecurityTokenProvider : CommunicationObjectSecurityTokenProvider
    {
        ...
        protected override SecurityToken EndGetTokenCore(IAsyncResult result) => 
            SessionOperationAsyncResult.End(result);
        ...
        private void PrepareRequest(Message message)
        {
            ...
            if ((this.webHeaderCollection != null) && (this.webHeaderCollection.Count > 0))
            {
                ...
                {
                    property.Headers.Add(this.webHeaderCollection);
                }
            }
        }
        ...
        internal class RequestChannelFactory : ChannelFactoryBase<IRequestChannel>
        {
            ...
            public override T GetProperty<T>() where T: class => 
                this.serviceChannelFactory.GetProperty<T>();
            ...
            protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                new ChainedCloseAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginClose), new ChainedEndHandler(this.OnEndClose), new ICommunicationObject[] { this.serviceChannelFactory });

            protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.serviceChannelFactory.BeginOpen(timeout, callback, state);
            ...
            protected override IRequestChannel OnCreateChannel(EndpointAddress address, Uri via) => 
                this.serviceChannelFactory.CreateChannel<IRequestChannel>(address, via);
        ...
        private class SessionOperationAsyncResult : AsyncResult
        {
            ...
            private static AsyncCallback closeChannelCallback = System.ServiceModel.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionSecurityTokenProvider.SessionOperationAsyncResult.CloseChannelCallback));
            private SecurityToken currentToken;
            private GenericXmlSecurityToken issuedToken;
            private static AsyncCallback openChannelCallback = System.ServiceModel.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionSecurityTokenProvider.SessionOperationAsyncResult.OpenChannelCallback));
            ...
            public static SecurityToken End(IAsyncResult result) => 
                AsyncResult.End<SecuritySessionSecurityTokenProvider.SessionOperationAsyncResult>(result).issuedToken;
            ...
            private bool OnChannelOpened()
            {
                ...
                try
                {
                    IAsyncResult result = this.channel.BeginRequest(message, this.timeoutHelper.RemainingTime(), System.ServiceModel.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.RequestCallback)), state);
                    if (!result.CompletedSynchronously)
                    {
                        flag = false;
                        return false;
