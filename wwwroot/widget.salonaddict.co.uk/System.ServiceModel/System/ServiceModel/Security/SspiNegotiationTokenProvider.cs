namespace System.ServiceModel.Security
{
    ...
    internal abstract class SspiNegotiationTokenProvider : NegotiationTokenProvider<SspiNegotiationTokenProviderState>
    {
        ...
        protected override BodyWriter GetFirstOutgoingMessageBody(SspiNegotiationTokenProviderState sspiState, out MessageProperties messageProperties)
        {
            ...
            RequestSecurityToken rst = new RequestSecurityToken(base.StandardsManager, false) {
                Context = sspiState.Context,
                TokenType = base.StandardsManager.SecureConversationDriver.TokenTypeUri,
                KeySize = base.SecurityAlgorithmSuite.DefaultSymmetricKeyLength
            };
            rst.OnGetBinaryNegotiation = new RequestSecurityToken.OnGetBinaryNegotiationCallback(new GetOutgoingBlobProxy(sspiState, this, rst).GetOutgoingBlob);
            return rst;
        }
