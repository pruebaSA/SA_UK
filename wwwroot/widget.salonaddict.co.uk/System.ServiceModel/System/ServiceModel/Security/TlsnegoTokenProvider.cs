namespace System.ServiceModel.Security
{
    ...
    internal class TlsnegoTokenProvider : SspiNegotiationTokenProvider
    {
        ...
        protected override IAsyncResult BeginCreateNegotiationState(EndpointAddress target, Uri via, TimeSpan timeout, AsyncCallback callback, object state)
        {
            ...
            {
                return new TypedCompletedAsyncResult<SspiNegotiationTokenProviderState>(this.CreateTlsSspiState(null), callback, state);
            }
        ...
        {
            if (result is TypedCompletedAsyncResult<SspiNegotiationTokenProviderState>)
            {
                return TypedCompletedAsyncResult<SspiNegotiationTokenProviderState>.End(result);
            }
        ...
        {
            private static readonly AsyncCallback getTokensCallback = System.ServiceModel.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(TlsnegoTokenProvider.CreateSspiStateAsyncResult.GetTokensCallback));
            ...
            public static SspiNegotiationTokenProviderState End(IAsyncResult result) => 
                AsyncResult.End<TlsnegoTokenProvider.CreateSspiStateAsyncResult>(result).sspiState;
