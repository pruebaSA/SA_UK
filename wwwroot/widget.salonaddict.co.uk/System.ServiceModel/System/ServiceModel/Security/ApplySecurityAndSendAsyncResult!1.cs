namespace System.ServiceModel.Security
{
    ...
    internal abstract class ApplySecurityAndSendAsyncResult<MessageSenderType> : AsyncResult where MessageSenderType: class
    {
        ...
        {
            ApplySecurityAndSendAsyncResult<MessageSenderType>.sharedCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ApplySecurityAndSendAsyncResult<MessageSenderType>.SharedCallback));
        }
