namespace System.ServiceModel.Security
{
    ...
    public class SecurityContextKeyIdentifierClause : SecurityKeyIdentifierClause
    {
        ...
        public bool Matches(UniqueId contextId, UniqueId generation) => 
            ((contextId == this.contextId) && (generation == this.generation));

        public override string ToString() => 
            string.Format(CultureInfo.InvariantCulture, "SecurityContextKeyIdentifierClause(ContextId = '{0}', Generation = '{1}')", new object[] { this.ContextId, this.Generation });
