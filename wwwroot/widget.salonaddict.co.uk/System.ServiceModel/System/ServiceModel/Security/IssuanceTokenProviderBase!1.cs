    ...
    internal abstract class IssuanceTokenProviderBase<T> : CommunicationObjectSecurityTokenProvider where T: IssuanceTokenProviderState
    {
        ...
        protected override IAsyncResult BeginGetTokenCore(TimeSpan timeout, AsyncCallback callback, object state)
        {
            ...
            lock (this.ThisLock)
            {
                ...
                if (currentServiceToken != null)
                {
                    ...
                    return new TypedCompletedAsyncResult<SecurityToken>(currentServiceToken, callback, state);
                }
        ...
        protected SecurityToken DoNegotiation(TimeSpan timeout)
        {
            ...
            catch (Exception exception3)
            {
                ...
                EndpointAddress remoteAddress = negotiationState?.RemoteAddress;
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(IssuanceTokenProviderBase<T>.WrapExceptionIfRequired(exception3, remoteAddress, this.issuerAddress));
            }
            finally
            {
        ...
        private static bool ShouldWrapException(Exception e) => 
            (((((e is Win32Exception) || (e is XmlException)) || ((e is InvalidOperationException) || (e is ArgumentException))) || (((e is QuotaExceededException) || (e is SecurityException)) || (e is CryptographicException))) || (e is SecurityTokenException));
        ...
        private class SecurityNegotiationAsyncResult : AsyncResult
        {
            ...
            {
                IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.createNegotiationStateCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.CreateNegotiationStateCallback));
                IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.initializeChannelFactoriesCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.InitializeChannelFactoriesCallback));
                IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.closeChannelCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.CloseChannelCallback));
                IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.sendRequestCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.SendRequestCallback));
                IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.openChannelCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult.OpenChannelCallback));
            }
            ...
            public static SecurityToken End(IAsyncResult result) => 
                AsyncResult.End<IssuanceTokenProviderBase<T>.SecurityNegotiationAsyncResult>(result).serviceToken;
            ...
            private Exception OnAsyncNegotiationFailure(Exception e)
            {
                ...
                try
                {
                    targetAddress = this.negotiationState?.RemoteAddress;
                    this.Cleanup();
                }
                catch (CommunicationException exception)
                {
            ...
            {
                EndpointAddress remoteAddress = this.negotiationState?.RemoteAddress;
                return IssuanceTokenProviderBase<T>.WrapExceptionIfRequired(e, remoteAddress, this.issuer);
            }
