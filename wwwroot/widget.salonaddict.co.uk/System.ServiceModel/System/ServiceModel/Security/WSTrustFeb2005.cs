    ...
    internal class WSTrustFeb2005 : WSTrust
    {
        ...
        public class DriverFeb2005 : WSTrust.Driver
        {
            ...
            protected override void ReadReferences(XmlElement rstrXml, out SecurityKeyIdentifierClause requestedAttachedReference, out SecurityKeyIdentifierClause requestedUnattachedReference)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(System.ServiceModel.SR.GetString("TrustApr2004DoesNotSupportCertainIssuedTokens")));
                }
            }
            ...
            public override string IssuedTokensHeaderName =>
                this.DriverDictionary.IssuedTokensHeader.Value;
            ...
            public override string RequestTypeClose =>
                this.DriverDictionary.RequestTypeClose.Value;

            public override string RequestTypeRenew =>
                this.DriverDictionary.RequestTypeRenew.Value;
            ...
            {
                [OperationContract(IsOneWay=false, Action="http://schemas.xmlsoap.org/ws/2005/02/trust/RST/Issue", ReplyAction="http://schemas.xmlsoap.org/ws/2005/02/trust/RSTR/Issue"), FaultContract(typeof(string), Action="*", ProtectionLevel=ProtectionLevel.Sign)]
            ...
            public class RequestChannelFactory<TokenService> : ChannelFactoryBase, IChannelFactory<IRequestChannel>, IChannelFactory, ICommunicationObject
            {
                ...
                public IRequestChannel CreateChannel(EndpointAddress address) => 
                    this.innerChannelFactory.CreateChannel<IRequestChannel>(address);

                public IRequestChannel CreateChannel(EndpointAddress address, Uri via) => 
                    this.innerChannelFactory.CreateChannel<IRequestChannel>(address, via);

                public override T GetProperty<T>() where T: class => 
                    this.innerChannelFactory.GetProperty<T>();
                ...
                protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                    this.innerChannelFactory.BeginClose(timeout, callback, state);
