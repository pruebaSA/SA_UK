namespace System.ServiceModel.Security
{
    ...
    internal static class SecurityUtils
    {
        ...
        internal static IAsyncResult BeginCloseTokenAuthenticatorIfRequired(SecurityTokenAuthenticator tokenAuthenticator, TimeSpan timeout, AsyncCallback callback, object state) => 
            new CloseCommunicationObjectAsyncResult(tokenAuthenticator, timeout, callback, state);
        ...
        internal static IAsyncResult BeginCloseTokenProviderIfRequired(SecurityTokenProvider tokenProvider, TimeSpan timeout, AsyncCallback callback, object state) => 
            new CloseCommunicationObjectAsyncResult(tokenProvider, timeout, callback, state);
        ...
        internal static IAsyncResult BeginOpenTokenAuthenticatorIfRequired(SecurityTokenAuthenticator tokenAuthenticator, TimeSpan timeout, AsyncCallback callback, object state) => 
            new OpenCommunicationObjectAsyncResult(tokenAuthenticator, timeout, callback, state);
        ...
        internal static IAsyncResult BeginOpenTokenProviderIfRequired(SecurityTokenProvider tokenProvider, TimeSpan timeout, AsyncCallback callback, object state) => 
            new OpenCommunicationObjectAsyncResult(tokenProvider, timeout, callback, state);
        ...
        internal static IIdentity CreateIdentity(string name, string authenticationType) => 
            new GenericIdentity(name, authenticationType);
        ...
        internal static Exception CreateSecurityFaultException(Message unverifiedMessage) => 
            CreateSecurityFaultException(MessageFault.CreateFault(unverifiedMessage, 0x4000));

        internal static Exception CreateSecurityFaultException(MessageFault fault) => 
            new MessageSecurityException(System.ServiceModel.SR.GetString("UnsecuredMessageFaultReceived"), FaultException.CreateFault(fault, new Type[] { typeof(string), typeof(object) }));
        ...
        internal static SecurityStandardsManager CreateSecurityStandardsManager(MessageSecurityVersion securityVersion, SecurityTokenManager tokenManager) => 
            new SecurityStandardsManager(securityVersion, tokenManager.CreateSecurityTokenSerializer(securityVersion.SecurityTokenVersion));
        ...
        internal static void EnsureCertificateCanDoKeyExchange(X509Certificate2 certificate)
        {
            ...
            if (!flag)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentException(System.ServiceModel.SR.GetString("SslServerCertMustDoKeyExchange", new object[] { certificate.SubjectName.Name }), innerException));
            }
        }
        ...
        internal static string GenerateId() => 
            System.ServiceModel.Security.SecurityUniqueId.Create().Value;

        internal static string GenerateIdWithPrefix(string prefix) => 
            System.ServiceModel.Security.SecurityUniqueId.Create(prefix).Value;
        ...
        internal static string GetIdentityNamesFromPolicies(IList<IAuthorizationPolicy> authPolicies) => 
            GetIdentityNamesFromContext(AuthorizationContext.CreateDefaultAuthorizationContext(authPolicies));
        ...
        internal static Claim GetPrimaryIdentityClaim(ReadOnlyCollection<IAuthorizationPolicy> authorizationPolicies) => 
            GetPrimaryIdentityClaim(AuthorizationContext.CreateDefaultAuthorizationContext(authorizationPolicies));
        ...
        internal static bool HasSymmetricSecurityKey(SecurityToken token) => 
            (GetSecurityKey<SymmetricSecurityKey>(token) != null);
        ...
        internal static bool IsDefaultNetworkCredential(NetworkCredential credential) => 
            NetworkCredentialHelper.IsDefault(credential);

        internal static bool IsOsGreaterThanXP() => 
            (((Environment.OSVersion.Version.Major >= 5) && (Environment.OSVersion.Version.Minor > 1)) || (Environment.OSVersion.Version.Major > 5));
        ...
        private static WindowsIdentity UnsafeCreateWindowsIdentityFromToken(IntPtr token) => 
        ...
        internal static bool IsChannelBindingDisabled =>
            ((GetSuppressChannelBindingValue() & 1) != 0);

        public static DateTime MaxUtcDateTime =>
            new DateTime(DateTime.MaxValue.Ticks - 0xc92a69c000L, DateTimeKind.Utc);

        public static DateTime MinUtcDateTime =>
            new DateTime(DateTime.MinValue.Ticks + 0xc92a69c000L, DateTimeKind.Utc);
        ...
        private class CloseCommunicationObjectAsyncResult : AsyncResult
        {
            ...
            public CloseCommunicationObjectAsyncResult(object obj, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
            {
                ...
                else
                {
                    if (onClose == null)
                    {
                        onClose = System.ServiceModel.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(System.ServiceModel.Security.SecurityUtils.CloseCommunicationObjectAsyncResult.OnClose));
                    }
        ...
        private static class NetworkCredentialHelper
        {
            ...
            internal static bool IsDefault(NetworkCredential credential) => 
                UnsafeGetDefaultNetworkCredentials().Equals(credential);

            [SecurityTreatAsSafe, SecurityCritical]
            internal static bool IsNullOrEmpty(NetworkCredential credential) => 
                ((credential == null) || ((string.IsNullOrEmpty(UnsafeGetUsername(credential)) && string.IsNullOrEmpty(UnsafeGetDomain(credential))) && string.IsNullOrEmpty(UnsafeGetPassword(credential))));
        ...
        private class OpenCommunicationObjectAsyncResult : AsyncResult
        {
            ...
            public OpenCommunicationObjectAsyncResult(object obj, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
            {
                ...
                else
                {
                    if (onOpen == null)
                    {
                        onOpen = System.ServiceModel.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(System.ServiceModel.Security.SecurityUtils.OpenCommunicationObjectAsyncResult.OnOpen));
                    }
