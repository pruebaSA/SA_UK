namespace System.ServiceModel.Security
{
    ...
    internal sealed class SecuritySessionServerSettings : IListenerSecureConversationSessionSettings, ISecurityCommunicationObject
    {
        ...
        internal static readonly TimeSpan defaultInactivityTimeout = TimeSpan.Parse("00:02:00");
        internal const string defaultInactivityTimeoutString = "00:02:00";
        internal static readonly TimeSpan defaultKeyRenewalInterval = TimeSpan.Parse("15:00:00");
        internal const string defaultKeyRenewalIntervalString = "15:00:00";
        internal static readonly TimeSpan defaultKeyRolloverInterval = TimeSpan.Parse("00:05:00");
        ...
        internal IAsyncResult BeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.communicationObject.BeginOpen(timeout, callback, state);
        ...
        private IServerReliableChannelBinder CreateChannelBinder(SecurityContextSecurityToken sessionToken, EndpointAddress remoteAddress)
        {
            ...
            new SessionInitiationMessageHandler(channelBinder, this, sessionToken).BeginReceive(TimeoutHelper.Infinite);
        ...
        private int GetPendingSessionCount() => 
            ((this.pendingSessions1.Count + this.pendingSessions2.Count) + ((IInputQueueChannelAcceptor) this.channelAcceptor).PendingCount);
        ...
        public void OnOpen(TimeSpan timeout)
        {
            ...
            {
                this.inactivityTimer = new IOThreadTimer(new WaitCallback(this.OnTimer), this, false);
        ...
        {
            get => 
                this.maximumPendingKeysPerSession;
            set
            {
                if (value <= 0)
                {
        ...
        private class SecurityReplySessionChannel : SecuritySessionServerSettings.ServerSecuritySimplexSessionChannel, IReplySessionChannel, IReplyChannel, IChannel, ICommunicationObject, ISessionChannel<IInputSession>
        {
            ...
            public IAsyncResult BeginWaitForRequest(TimeSpan timeout, AsyncCallback callback, object state) => 
                base.ChannelBinder.BeginWaitForRequest(timeout, callback, state);

            public bool EndWaitForRequest(IAsyncResult result) => 
                base.ChannelBinder.EndWaitForRequest(result);

            public bool WaitForRequest(TimeSpan timeout) => 
                base.ChannelBinder.WaitForRequest(timeout);
        ...
        internal class SecuritySessionDemuxFailureHandler : IChannelDemuxFailureHandler
        {
            ...
            public IAsyncResult BeginHandleDemuxFailure(Message message, IOutputChannel faultContext, AsyncCallback callback, object state) => 
                this.BeginHandleDemuxFailure<IOutputChannel>(message, faultContext, callback, state);
            ...
            public IAsyncResult BeginHandleDemuxFailure(Message message, RequestContext faultContext, AsyncCallback callback, object state) => 
                this.BeginHandleDemuxFailure<RequestContext>(message, faultContext, callback, state);
            ...
            public void HandleDemuxFailure(Message message)
            {
                ...
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecuritySessionDemuxFailure, message);
                }
            }
            ...
            private class SendFaultAsyncResult<TFaultContext> : AsyncResult
            {
                ...
                {
                    SecuritySessionServerSettings.SecuritySessionDemuxFailureHandler.SendFaultAsyncResult<TFaultContext>.sendCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.SecuritySessionDemuxFailureHandler.SendFaultAsyncResult<TFaultContext>.SendCallback));
                }
        ...
        private class ServerSecurityDuplexSessionChannel : SecuritySessionServerSettings.ServerSecuritySessionChannel, IDuplexSessionChannel, IDuplexChannel, IInputChannel, IOutputChannel, IChannel, ICommunicationObject, ISessionChannel<IDuplexSession>
        {
            ...
            private IAsyncResult BeginCloseOutputSession(TimeSpan timeout, AsyncCallback callback, object state) => 
                new CloseOutputSessionAsyncResult(this, timeout, callback, state);
            ...
            protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                new CloseAsyncResult(this, timeout, callback, state);
            ...
            public EndpointAddress RemoteAddress =>
                base.ChannelBinder.RemoteAddress;
            ...
            {
                private static readonly AsyncCallback closeCoreCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecurityDuplexSessionChannel.CloseAsyncResult.CloseCoreCallback));
                private static readonly AsyncCallback closeOutputSessionCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecurityDuplexSessionChannel.CloseAsyncResult.CloseOutputSessionCallback));
                private static readonly AsyncCallback inputSessionWaitCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecurityDuplexSessionChannel.CloseAsyncResult.WaitForInputSessionCloseCallback));
                private static readonly AsyncCallback outputSessionWaitCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecurityDuplexSessionChannel.CloseAsyncResult.WaitForOutputSessionCloseCallback));
                private static readonly AsyncCallback receiveCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecurityDuplexSessionChannel.CloseAsyncResult.ReceiveCallback));
            ...
            private class CloseOutputSessionAsyncResult : AsyncResult
            {
                private RequestContext closeRequestContext;
                private Message closeResponseMessage;
                private static AsyncCallback sendCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecurityDuplexSessionChannel.CloseOutputSessionAsyncResult.SendCallback));
        ...
        private abstract class ServerSecuritySessionChannel : ChannelBase, SecuritySessionServerSettings.IServerSecuritySessionChannel
        {
            ...
            internal IAsyncResult BeginSendMessage(RequestContext requestContext, Message response, TimeSpan timeout, AsyncCallback callback, object state) => 
                new SendMessageAsyncResult(this, requestContext, response, timeout, callback, state);

            public IAsyncResult BeginTryReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
                new ReceiveRequestAsyncResult(this, timeout, callback, state);
            ...
            public bool EndTryReceive(IAsyncResult result, out Message message) => 
                ReceiveRequestAsyncResult.EndAsMessage(result, out message);

            public bool EndTryReceiveRequest(IAsyncResult result, out RequestContext requestContext) => 
                ReceiveRequestAsyncResult.EndAsRequestContext(result, out requestContext);

            protected Uri GetLocalUri() => 
                this.channelBinder.LocalAddress?.Uri;
            ...
            private Message ProcessCloseRequest(Message request)
            {
                ...
                {
                    List<RequestSecurityTokenResponse> rstrCollection = new List<RequestSecurityTokenResponse>(1) {
                        response
                    };
            ...
            private Message ProcessRequestContext(RequestContext requestContext, TimeSpan timeout, out SecurityProtocolCorrelationState correlationState, out bool isSecurityProcessingFailure)
            {
                ...
                {
                    if ((!(exception3 is CommunicationException) && !(exception3 is TimeoutException)) && (!DiagnosticUtility.IsFatal(exception3) && this.ShouldWrapException(exception3)))
                    {
            ...
            internal SecurityProtocolCorrelationState VerifyIncomingMessage(ref Message message, TimeSpan timeout) => 
                this.securityProtocol.VerifyIncomingMessage(ref message, timeout, null);
            ...
            internal TimeSpan InternalSendTimeout =>
                base.DefaultSendTimeout;

            public EndpointAddress LocalAddress =>
                this.channelBinder.LocalAddress;
            ...
            {
                private SecuritySessionServerSettings.ServerSecuritySessionChannel channel;
                private static AsyncCallback channelBinderCloseCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySessionChannel.CloseCoreAsyncResult.ChannelBinderCloseCallback));
                private static AsyncCallback settingsLifetimeManagerCloseCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySessionChannel.CloseCoreAsyncResult.SettingsLifetimeManagerCloseCallback));
                private TimeoutHelper timeoutHelper;
            ...
            private class ReceiveRequestAsyncResult : AsyncResult
            {
                ...
                private static AsyncCallback onReceive = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySessionChannel.ReceiveRequestAsyncResult.OnReceive));
                private static WaitCallback onWait = new WaitCallback(SecuritySessionServerSettings.ServerSecuritySessionChannel.ReceiveRequestAsyncResult.OnWait);
                ...
                private static SecuritySessionServerSettings.ServerSecuritySessionChannel.ReceiveRequestAsyncResult End(IAsyncResult result) => 
                    AsyncResult.End<SecuritySessionServerSettings.ServerSecuritySessionChannel.ReceiveRequestAsyncResult>(result);
                ...
                private static void OnWait(object state)
                {
            ...
            private class SendMessageAsyncResult : AsyncResult
            {
                private Message message;
                private RequestContext requestContext;
                private static AsyncCallback sendCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySessionChannel.SendMessageAsyncResult.SendCallback));
            ...
            protected class SoapSecurityInputSession : ISecureConversationSession, ISecuritySession, IInputSession, ISession
            {
                ...
                public string Id =>
                    this.securityContextTokenId.ToString();
        ...
        private abstract class ServerSecuritySimplexSessionChannel : SecuritySessionServerSettings.ServerSecuritySessionChannel
        {
            ...
            private class CloseAsyncResult : AsyncResult
            {
                private static readonly AsyncCallback closeCoreCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySimplexSessionChannel.CloseAsyncResult.CloseCoreCallback));
                private RequestContext closeRequestContext;
                private Message closeResponse;
                private static readonly AsyncCallback receiveCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySimplexSessionChannel.CloseAsyncResult.ReceiveCallback));
                private static readonly AsyncCallback sendCloseResponseCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySimplexSessionChannel.CloseAsyncResult.SendCloseResponseCallback));
                private SecuritySessionServerSettings.ServerSecuritySimplexSessionChannel sessionChannel;
                private TimeoutHelper timeoutHelper;
                private static readonly AsyncCallback waitCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.ServerSecuritySimplexSessionChannel.CloseAsyncResult.WaitForInputSessionCloseCallback));
        ...
        private class SessionInitiationMessageHandler
        {
            ...
            private static AsyncCallback receiveCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionServerSettings.SessionInitiationMessageHandler.ReceiveCallback));
            ...
            public IAsyncResult BeginReceive(TimeSpan timeout) => 
                this.channelBinder.BeginTryReceive(timeout, receiveCallback, this);

            private bool IsRecoverableException(Exception e) => 
                (((((e is ObjectDisposedException) || (e is CommunicationException)) || ((e is TimeoutException) || (e is QuotaExceededException))) || ((e is InvalidOperationException) || (e is XmlException))) || (e is FormatException));
