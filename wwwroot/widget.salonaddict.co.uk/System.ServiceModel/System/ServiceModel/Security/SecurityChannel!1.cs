namespace System.ServiceModel.Security
{
    ...
    internal abstract class SecurityChannel<TChannel> : LayeredChannel<TChannel> where TChannel: class, IChannel
    {
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.BeginCloseSecurityProtocol), new ChainedEndHandler(this.EndCloseSecurityProtocol), new ChainedBeginHandler(this.OnBeginClose), new ChainedEndHandler(this.OnEndClose));
