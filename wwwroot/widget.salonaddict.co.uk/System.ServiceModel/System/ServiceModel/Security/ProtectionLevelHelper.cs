namespace System.ServiceModel.Security
{
    ...
    internal static class ProtectionLevelHelper
    {
        ...
        internal static bool IsStronger(ProtectionLevel v1, ProtectionLevel v2) => 
            (((v1 == ProtectionLevel.EncryptAndSign) && (v2 != ProtectionLevel.EncryptAndSign)) || ((v1 == ProtectionLevel.Sign) && (v2 == ProtectionLevel.None)));

        internal static bool IsStrongerOrEqual(ProtectionLevel v1, ProtectionLevel v2) => 
            ((v1 == ProtectionLevel.EncryptAndSign) || ((v1 == ProtectionLevel.Sign) && (v2 != ProtectionLevel.EncryptAndSign)));
