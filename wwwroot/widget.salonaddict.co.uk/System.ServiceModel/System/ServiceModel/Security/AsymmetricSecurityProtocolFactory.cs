namespace System.ServiceModel.Security
{
    ...
    internal class AsymmetricSecurityProtocolFactory : MessageSecurityProtocolFactory
    {
        ...
        protected override SecurityProtocol OnCreateSecurityProtocol(EndpointAddress target, Uri via, object listenerSecurityState, TimeSpan timeout) => 
            new AsymmetricSecurityProtocol(this, target, via);
        ...
        {
            get => 
                this.asymmetricTokenParameters;
            set
            {
                base.ThrowIfImmutable();
        ...
        private bool RequiresAsymmetricTokenProviderForForwardDirection =>
            ((base.ActAsInitiator && base.ApplyConfidentiality) || (!base.ActAsInitiator && base.RequireConfidentiality));

        private bool RequiresAsymmetricTokenProviderForReturnDirection =>
            ((base.ActAsInitiator && base.RequireIntegrity) || (!base.ActAsInitiator && base.ApplyIntegrity));
    }
}
