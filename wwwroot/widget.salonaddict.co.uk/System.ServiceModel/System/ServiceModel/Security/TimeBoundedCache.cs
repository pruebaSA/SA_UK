namespace System.ServiceModel.Security
{
    ...
    internal class TimeBoundedCache
    {
        ...
        private static WaitCallback purgeCallback;
        ...
        private bool ShouldPurge() => 
            ((this.Count >= this.maxCacheItems) || (((this.purgingMode == PurgingMode.AccessBasedPurge) && (DateTime.UtcNow > this.nextPurgeTimeUtc)) && (this.Count > this.lowWaterMark)));
        ...
        protected bool TryAddItem(object key, object item, DateTime expirationTime, bool replaceExistingEntry) => 
            this.TryAddItem(key, new ExpirableItem(item, expirationTime), replaceExistingEntry);
        ...
        private static WaitCallback PurgeCallback
        {
            get
            {
                ...
                {
                    purgeCallback = new WaitCallback(TimeBoundedCache.PurgeCallbackStatic);
                }
