    ...
    internal class WSTrustDec2005 : WSTrustFeb2005
    {
        ...
        public class DriverDec2005 : WSTrustFeb2005.DriverFeb2005
        {
            ...
            internal override bool IsKeyWrapAlgorithmElement(XmlElement element, out string keyWrapAlgorithm) => 
                WSTrust.CheckElement(element, DXD.TrustDec2005Dictionary.KeyWrapAlgorithm.Value, DXD.TrustDec2005Dictionary.Namespace.Value, out keyWrapAlgorithm);

            internal virtual bool IsSecondaryParametersElement(XmlElement element) => 
                ((element.LocalName == DXD.TrustDec2005Dictionary.SecondaryParameters.Value) && (element.NamespaceURI == DXD.TrustDec2005Dictionary.Namespace.Value));
