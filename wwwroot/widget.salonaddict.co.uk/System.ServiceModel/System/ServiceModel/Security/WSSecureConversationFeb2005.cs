    ...
    internal class WSSecureConversationFeb2005 : WSSecureConversation
    {
        ...
        public class DriverFeb2005 : WSSecureConversation.Driver
        {
            public override XmlDictionaryString CloseAction =>
                XD.SecureConversationFeb2005Dictionary.RequestSecurityContextClose;

            public override XmlDictionaryString CloseResponseAction =>
                XD.SecureConversationFeb2005Dictionary.RequestSecurityContextCloseResponse;
            ...
            public override XmlDictionaryString RenewAction =>
                XD.SecureConversationFeb2005Dictionary.RequestSecurityContextRenew;

            public override XmlDictionaryString RenewResponseAction =>
                XD.SecureConversationFeb2005Dictionary.RequestSecurityContextRenewResponse;

            public override string TokenTypeUri =>
                XD.SecureConversationFeb2005Dictionary.SecurityContextTokenType.Value;
        }
        ...
        private class SctStrEntryFeb2005 : WSSecureConversation.SctStrEntry
        {
            ...
            protected override UniqueId ReadGeneration(XmlDictionaryReader reader) => 
                XmlHelper.GetAttributeAsUniqueId(reader, DXD.SecureConversationDec2005Dictionary.Instance, XD.SecureConversationFeb2005Dictionary.Namespace);
        ...
        private class SecurityContextTokenEntryFeb2005 : WSSecureConversation.SecurityContextTokenEntry
        {
            ...
            protected override bool CanReadGeneration(XmlDictionaryReader reader) => 
                reader.IsStartElement(DXD.SecureConversationDec2005Dictionary.Instance, XD.SecureConversationFeb2005Dictionary.Namespace);

            protected override bool CanReadGeneration(XmlElement element) => 
                ((element.LocalName == DXD.SecureConversationDec2005Dictionary.Instance.Value) && (element.NamespaceURI == XD.SecureConversationFeb2005Dictionary.Namespace.Value));
