namespace System.ServiceModel.Security
{
    ...
    internal class DerivedKeyCachingSecurityTokenSerializer : SecurityTokenSerializer
    {
        ...
        protected override bool CanReadKeyIdentifierClauseCore(XmlReader reader) => 
            this.innerTokenSerializer.CanReadKeyIdentifierClause(reader);

        protected override bool CanReadKeyIdentifierCore(XmlReader reader) => 
            this.innerTokenSerializer.CanReadKeyIdentifier(reader);

        protected override bool CanReadTokenCore(XmlReader reader) => 
            this.innerTokenSerializer.CanReadToken(reader);

        protected override bool CanWriteKeyIdentifierClauseCore(SecurityKeyIdentifierClause keyIdentifierClause) => 
            this.innerTokenSerializer.CanWriteKeyIdentifierClause(keyIdentifierClause);

        protected override bool CanWriteKeyIdentifierCore(SecurityKeyIdentifier keyIdentifier) => 
            this.innerTokenSerializer.CanWriteKeyIdentifier(keyIdentifier);

        protected override bool CanWriteTokenCore(SecurityToken token) => 
            this.innerTokenSerializer.CanWriteToken(token);
        ...
        protected override SecurityKeyIdentifierClause ReadKeyIdentifierClauseCore(XmlReader reader) => 
            this.innerTokenSerializer.ReadKeyIdentifierClause(reader);

        protected override SecurityKeyIdentifier ReadKeyIdentifierCore(XmlReader reader) => 
            this.innerTokenSerializer.ReadKeyIdentifier(reader);
        ...
        protected override SecurityToken ReadTokenCore(XmlReader reader, SecurityTokenResolver tokenResolver)
        {
            ...
            if (this.secureConversation.IsAtDerivedKeyToken(reader2))
            {
                ...
                lock (this.thisLock)
                {
                    ...
                    SecurityToken token3 = this.secureConversation.CreateDerivedKeyToken(str, str2, str3, num, buffer, num2, num3, clause, token) as DerivedKeySecurityToken;
