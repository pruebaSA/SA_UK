namespace System.ServiceModel.Security
{
    ...
    internal sealed class SecurityTimestamp
    {
        ...
        public override string ToString() => 
            string.Format(CultureInfo.InvariantCulture, "SecurityTimestamp: Id={0}, CreationTimeUtc={1}, ExpirationTimeUtc={2}", new object[] { this.Id, XmlConvert.ToString(this.CreationTimeUtc, XmlDateTimeSerializationMode.RoundtripKind), XmlConvert.ToString(this.ExpiryTimeUtc, XmlDateTimeSerializationMode.RoundtripKind) });
