    ...
    internal static class InfoCardHelper
    {
        ...
        private class InternalClientCredentials : ClientCredentials
        {
            ...
            protected override ClientCredentials CloneCore() => 
                new InfoCardHelper.InternalClientCredentials(this);

            public override SecurityTokenManager CreateSecurityTokenManager() => 
                new InternalClientCredentialsSecurityTokenManager(this, this.m_infocardChannelParameter);

            public System.ServiceModel.Security.InfoCardChannelParameter InfoCardChannelParameter =>
                this.m_infocardChannelParameter;
        ...
        private class PolicyElement
        {
            ...
            public CardSpacePolicyElement ToCardSpacePolicyElement() => 
                new CardSpacePolicyElement(this.EndPointAddressToXmlElement(this.m_target), this.EndPointAddressToXmlElement(this.m_issuer), this.m_parameters, this.m_policyNoticeLink, this.m_policyNoticeVersion, this.m_isManagedIssuer);
