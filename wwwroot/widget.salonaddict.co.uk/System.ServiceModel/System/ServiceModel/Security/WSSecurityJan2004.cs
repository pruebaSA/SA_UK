    ...
    internal class WSSecurityJan2004 : System.ServiceModel.Security.WSSecurityTokenSerializer.SerializerEntries
    {
        ...
        internal abstract class BinaryTokenEntry : WSSecurityTokenSerializer.TokenEntry
        {
            ...
            public override SecurityToken ReadTokenCore(XmlDictionaryReader reader, SecurityTokenResolver tokenResolver)
            {
                ...
                string str2 = reader.GetAttribute(EncodingTypeAttribute, null);
                switch (str2)
                {
                    case null:
                    ...
                    default:
                        if (str2 != "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#HexBinary")
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new MessageSecurityException(System.ServiceModel.SR.GetString("UnknownEncodingInBinarySecurityToken")));
                        }
                ...
                return this.ReadBinaryCore(attribute, buffer);
            }
        ...
        private class GenericXmlTokenEntry : WSSecurityTokenSerializer.TokenEntry
        {
            ...
            protected override Type[] GetTokenTypesCore() => 
                new Type[] { typeof(GenericXmlSecurityToken) };
        ...
        private class KerberosHashStrEntry : WSSecurityJan2004.KeyIdentifierStrEntry
        {
            ...
            protected override SecurityKeyIdentifierClause CreateClause(byte[] bytes, byte[] derivationNonce, int derivationLength) => 
                new KerberosTicketHashKeyIdentifierClause(bytes, derivationNonce, derivationLength);

            protected override Type ClauseType =>
                typeof(KerberosTicketHashKeyIdentifierClause);
        ...
        private class KerberosTokenEntry : WSSecurityJan2004.BinaryTokenEntry
        {
            ...
            protected override Type[] GetTokenTypesCore() => 
                new Type[] { typeof(KerberosReceiverSecurityToken), typeof(KerberosRequestorSecurityToken) };

            public override SecurityToken ReadBinaryCore(string id, byte[] rawData) => 
                new KerberosReceiverSecurityToken(rawData, id, false);
        ...
        protected abstract class KeyIdentifierStrEntry : WSSecurityTokenSerializer.StrEntry
        {
            ...
            public override bool SupportsCore(SecurityKeyIdentifierClause clause) => 
                this.ClauseType.IsAssignableFrom(clause.GetType());
        ...
        private class LocalReferenceStrEntry : WSSecurityTokenSerializer.StrEntry
        {
            private WSSecurityTokenSerializer tokenSerializer;
            ...
            public override bool SupportsCore(SecurityKeyIdentifierClause clause) => 
                (clause is LocalIdKeyIdentifierClause);
        ...
        private class RelDirectStrEntry : WSSecurityTokenSerializer.StrEntry
        {
            public override bool CanReadClause(XmlDictionaryReader reader, string tokenType) => 
                (reader.IsStartElement(XD.SecurityJan2004Dictionary.Reference, XD.SecurityJan2004Dictionary.Namespace) && (reader.GetAttribute(XD.SecurityJan2004Dictionary.ValueType, null) == "http://docs.oasis-open.org/wss/oasis-wss-rel-token-profile-1.0.pdf#license"));
            ...
            public override bool SupportsCore(SecurityKeyIdentifierClause clause) => 
                typeof(RelAssertionDirectKeyIdentifierClause).IsAssignableFrom(clause.GetType());
        ...
        protected class SamlJan2004KeyIdentifierStrEntry : WSSecurityTokenSerializer.StrEntry
        {
            ...
            public override bool SupportsCore(SecurityKeyIdentifierClause clause) => 
                typeof(SamlAssertionKeyIdentifierClause).IsAssignableFrom(clause.GetType());
        ...
        protected class SamlTokenEntry : WSSecurityTokenSerializer.TokenEntry
        {
            ...
            protected override Type[] GetTokenTypesCore() => 
                new Type[] { typeof(SamlSecurityToken) };

            public override SecurityToken ReadTokenCore(XmlDictionaryReader reader, SecurityTokenResolver tokenResolver) => 
                this.samlSerializer.ReadToken(reader, this.tokenSerializer, tokenResolver);
            ...
            protected override XmlDictionaryString LocalName =>
                XD.SecurityJan2004Dictionary.SamlAssertion;
        ...
        protected class SecurityTokenReferenceJan2004ClauseEntry : WSSecurityTokenSerializer.KeyIdentifierClauseEntry
        {
            ...
            public override SecurityKeyIdentifierClause ReadKeyIdentifierClauseCore(XmlDictionaryReader reader)
            {
                ...
                {
                    string s = reader.GetAttribute(XD.SecureConversationFeb2005Dictionary.Nonce, XD.SecureConversationFeb2005Dictionary.Namespace);
                    if (s != null)
                    {
                        derivationNonce = Convert.FromBase64String(s);
                    }
        ...
        private class UserNamePasswordTokenEntry : WSSecurityTokenSerializer.TokenEntry
        {
            ...
            public override IAsyncResult BeginReadTokenCore(XmlDictionaryReader reader, SecurityTokenResolver tokenResolver, AsyncCallback callback, object state)
            {
                ...
                return new TypedCompletedAsyncResult<SecurityToken>(new UserNameSecurityToken(str2, str3, str), callback, state);
            }
            ...
            public override SecurityToken EndReadTokenCore(IAsyncResult result) => 
                TypedCompletedAsyncResult<SecurityToken>.End(result);

            protected override Type[] GetTokenTypesCore() => 
                new Type[] { typeof(UserNameSecurityToken) };
            ...
            private void WriteUserNamePassword(XmlDictionaryWriter writer, string id, string userName, string password)
            {
                ...
                if (password != null)
                {
                    ...
                    if (this.tokenSerializer.EmitBspRequiredAttributes)
                    {
                        writer.WriteAttributeString(XD.SecurityJan2004Dictionary.Prefix.Value, XD.SecurityJan2004Dictionary.TypeAttribute, null, "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText");
                    }
        ...
        protected class WrappedKeyTokenEntry : WSSecurityTokenSerializer.TokenEntry
        {
            ...
            protected override Type[] GetTokenTypesCore() => 
                new Type[] { typeof(WrappedKeySecurityToken) };
        ...
        private class X509IssuerSerialStrEntry : WSSecurityTokenSerializer.StrEntry
        {
            public override bool CanReadClause(XmlDictionaryReader reader, string tokenType) => 
                reader.IsStartElement(XD.XmlSignatureDictionary.X509Data, XD.XmlSignatureDictionary.Namespace);
            ...
            public override bool SupportsCore(SecurityKeyIdentifierClause clause) => 
                (clause is X509IssuerSerialKeyIdentifierClause);
        ...
        private class X509SkiStrEntry : WSSecurityJan2004.KeyIdentifierStrEntry
        {
            ...
            protected override SecurityKeyIdentifierClause CreateClause(byte[] bytes, byte[] derivationNonce, int derivationLength) => 
                new X509SubjectKeyIdentifierClause(bytes);

            protected override Type ClauseType =>
                typeof(X509SubjectKeyIdentifierClause);
        ...
        protected class X509TokenEntry : WSSecurityJan2004.BinaryTokenEntry
        {
            ...
            protected override Type[] GetTokenTypesCore() => 
                new Type[] { typeof(X509SecurityToken), typeof(X509WindowsSecurityToken) };
            ...
            public override SecurityToken ReadBinaryCore(string id, byte[] rawData)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new MessageSecurityException("InvalidX509RawData"));
                }
