namespace System.ServiceModel.Security
{
    ...
    internal class WrapperSecurityCommunicationObject : CommunicationObject
    {
        ...
        protected override Type GetCommunicationObjectType() => 
            this.innerCommunicationObject.GetType();
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.innerCommunicationObject.OnBeginClose(timeout, callback, state);

        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.innerCommunicationObject.OnBeginOpen(timeout, callback, state);
        ...
        protected override TimeSpan DefaultCloseTimeout =>
            this.innerCommunicationObject.DefaultCloseTimeout;

        protected override TimeSpan DefaultOpenTimeout =>
            this.innerCommunicationObject.DefaultOpenTimeout;
    }
}
