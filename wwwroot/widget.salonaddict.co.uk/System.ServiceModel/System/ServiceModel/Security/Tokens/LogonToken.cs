namespace System.ServiceModel.Security.Tokens
{
    ...
    internal class LogonToken : IDisposable
    {
        ...
        private static byte[] ComputeHash(string password, byte[] salt)
        {
            ...
            using (SHA1 sha = System.ServiceModel.Security.CryptoHelper.NewSha1HashAlgorithm())
            {
        ...
        public ReadOnlyCollection<IAuthorizationPolicy> GetAuthorizationPolicies() => 
            System.IdentityModel.SecurityUtils.CloneAuthorizationPoliciesIfNecessary(this.authorizationPolicies);
