namespace System.ServiceModel.Security.Tokens
{
    ...
    public class SupportingTokenParameters
    {
        ...
        public SupportingTokenParameters Clone() => 
            new SupportingTokenParameters(this);

        internal bool IsEmpty() => 
            ((((this.signed.Count == 0) && (this.signedEncrypted.Count == 0)) && (this.endorsing.Count == 0)) && (this.signedEndorsing.Count == 0));
