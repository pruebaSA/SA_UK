namespace System.ServiceModel.Security.Tokens
{
    ...
    public class IssuedSecurityTokenParameters : SecurityTokenParameters
    {
        ...
        private static readonly EndpointAddress wsidSelfIssuer = new EndpointAddress(new Uri(string.Format(CultureInfo.InvariantCulture, "{0}/issuer/self", new object[] { "http://schemas.xmlsoap.org/ws/2005/05/identity" })), new AddressHeader[0]);
        ...
        protected override SecurityTokenParameters CloneCore() => 
            new IssuedSecurityTokenParameters(this);
        ...
        internal static IssuedSecurityTokenParameters CreateInfoCardParameters(SecurityStandardsManager standardsManager, SecurityAlgorithmSuite algorithm)
        {
            IssuedSecurityTokenParameters parameters = new IssuedSecurityTokenParameters("http://docs.oasis-open.org/wss/oasis-wss-saml-token-profile-1.1#SAMLV1.1") {
                ...
                ClaimTypeRequirements = { new ClaimTypeRequirement(wsidPPIClaim) },
                IssuerAddress = null
            };
        ...
        public Collection<XmlElement> CreateRequestParameters(MessageSecurityVersion messageSecurityVersion, SecurityTokenSerializer securityTokenSerializer) => 
            this.CreateRequestParameters(System.ServiceModel.Security.SecurityUtils.CreateSecurityStandardsManager(messageSecurityVersion, securityTokenSerializer).TrustDriver);
        ...
        public override string ToString()
        {
            ...
            builder.AppendLine(string.Format(CultureInfo.InvariantCulture, "UseStrTransform: {0}", new object[] { this.useStrTransform.ToString() }));
            if (this.issuerBinding == null)
            {
        ...
        internal Collection<AlternativeIssuerEndpoint> AlternativeIssuerEndpoints =>
            this.alternativeIssuerEndpoints;
