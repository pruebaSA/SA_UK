namespace System.ServiceModel.Security.Tokens
{
    ...
    public class WrappedKeySecurityToken : SecurityToken
    {
        ...
        internal WrappedKeySecurityToken(string id, byte[] keyToWrap, ISspiNegotiation wrappingSspiContext) : this(id, keyToWrap, wrappingSspiContext?.KeyEncryptionAlgorithm, wrappingSspiContext, null)
        {
        }
        ...
        public override bool CanCreateKeyIdentifierClause<T>() where T: SecurityKeyIdentifierClause => 
            ((typeof(T) == typeof(EncryptedKeyHashIdentifierClause)) || base.CanCreateKeyIdentifierClause<T>());
        ...
        public byte[] GetWrappedKey() => 
            System.ServiceModel.Security.SecurityUtils.CloneBuffer(this.wrappedKey);
