namespace System.ServiceModel.Security.Tokens
{
    ...
    internal sealed class DerivedKeySecurityToken : SecurityToken
    {
        ...
        public byte[] GetKeyBytes() => 
            System.ServiceModel.Security.SecurityUtils.CloneBuffer(this.key);

        public byte[] GetNonce() => 
            System.ServiceModel.Security.SecurityUtils.CloneBuffer(this.nonce);
        ...
        public override DateTime ValidFrom =>
            this.tokenToDerive.ValidFrom;

        public override DateTime ValidTo =>
            this.tokenToDerive.ValidTo;
    }
}
