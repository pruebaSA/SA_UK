namespace System.ServiceModel.Security
{
    ...
    internal static class SecurityAuditHelper
    {
        ...
        private const string ApplicationEventSourceName = "ServiceModel Audit 3.0.0.0";
        ...
        private const string SecurityEventSourceName = "ServiceModel 3.0.0.0";
        ...
        private static void WriteAuditEvent(uint auditType, uint auditId, params string[] parameters)
        {
            ...
            try
            {
                try
                {
                    ...
                    privilege.Enable();
                    if (!NativeMethods.AuthzRegisterSecurityEventSource(0, "ServiceModel 3.0.0.0", out handle))
                    {
        ...
        private static void WriteEventToApplicationLog(EventInstance instance, params object[] parameters)
        {
            for (int i = 0; i < parameters.Length; i++)
            {
                ...
                if (param != null)
                {
                    parameters[i] = EventLogger.NormalizeEventLogParameter(param);
                }
            }
            EventLog.WriteEvent("ServiceModel Audit 3.0.0.0", instance, parameters);
        }
        ...
        public static void WriteImpersonationFailureEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, string operationName, string clientIdentity, Exception exception)
        {
            try
            {
                ...
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "ImpersonationFailure"), null, null);
                }
            }
            catch (Exception exception2)
            {
                ...
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "ImpersonationFailure"), null, exception2);
                }
        ...
        public static void WriteImpersonationSuccessEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, string operationName, string clientIdentity)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "ImpersonationSuccess"), null, null);
                }
            }
            catch (Exception exception)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "ImpersonationSuccess"), null, exception);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteMessageAuthenticationFailureEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string action, string clientIdentity, Exception exception)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "MessageAuthenticationFailure"), null, null, message);
                }
            }
            catch (Exception exception2)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "MessageAuthenticationFailure"), null, exception2, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteMessageAuthenticationSuccessEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string action, string clientIdentity)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "MessageAuthenticationSuccess"), null, null, message);
                }
            }
            catch (Exception exception)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "MessageAuthenticationSuccess"), null, exception, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteSecurityNegotiationFailureEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string action, string clientIdentity, string negotiationType, Exception exception)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "SecurityNegotiationFailure"), null, null, message);
                }
            }
            catch (Exception exception2)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "SecurityNegotiationFailure"), null, exception2, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteSecurityNegotiationSuccessEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string action, string clientIdentity, string negotiationType)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "SecurityNegotiationSuccess"), null, null, message);
                }
            }
            catch (Exception exception)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "SecurityNegotiationSuccess"), null, exception, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteServiceAuthorizationFailureEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string action, string clientIdentity, string authContextId, string serviceAuthorizationManager, Exception exception)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "ServiceAuthorizationFailure"), null, null, message);
                }
            }
            catch (Exception exception2)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "ServiceAuthorizationFailure"), null, exception2, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteServiceAuthorizationSuccessEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string action, string clientIdentity, string authContextId, string serviceAuthorizationManager)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "ServiceAuthorizationSuccess"), null, null, message);
                }
            }
            catch (Exception exception)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "ServiceAuthorizationSuccess"), null, exception, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteTransportAuthenticationFailureEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string clientIdentity, Exception exception)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "TransportAuthenticationFailure"), null, null, message);
                }
            }
            catch (Exception exception2)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "TransportAuthenticationFailure"), null, exception2, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        public static void WriteTransportAuthenticationSuccessEvent(AuditLogLocation auditLogLocation, bool suppressAuditFailure, Message message, Uri serviceUri, string clientIdentity)
        {
            try
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.SecurityAuditWrittenSuccess, new SecurityAuditTraceRecord(auditLogLocation, "TransportAuthenticationSuccess"), null, null, message);
                }
            }
            catch (Exception exception)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.SecurityAuditWrittenFailure, new SecurityAuditTraceRecord(auditLogLocation, "TransportAuthenticationSuccess"), null, exception, message);
                }
                if (!suppressAuditFailure)
                {
                    throw;
        ...
        private class SafeLoadLibraryHandle : SafeHandleZeroOrMinusOneIsInvalid
        {
            ...
            protected override bool ReleaseHandle() => 
                SecurityAuditHelper.NativeMethods.FreeLibrary(base.handle);
        }
        ...
        private class SafeSecurityAuditHandle : SafeHandleZeroOrMinusOneIsInvalid
        {
            ...
            protected override bool ReleaseHandle() => 
                SecurityAuditHelper.NativeMethods.AuthzUnregisterSecurityEventSource(0, ref this.handle);
        }
        ...
        private class SafeTokenHandle : SafeHandleZeroOrMinusOneIsInvalid
        {
            ...
            protected override bool ReleaseHandle() => 
                SecurityAuditHelper.NativeMethods.CloseHandle(base.handle);
        }
        ...
        private class SecurityAuditTraceRecord : TraceRecord
        {
            ...
            internal override string EventId =>
                "http://schemas.microsoft.com/2006/08/ServiceModel/SecurityAuditTraceRecord";
        }
    }
}
