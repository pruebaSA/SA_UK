namespace System.ServiceModel.Security
{
    ...
    internal abstract class ReceiveMessageAndVerifySecurityAsyncResultBase : AsyncResult
    {
        ...
        private static AsyncCallback innerTryReceiveCompletedCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReceiveMessageAndVerifySecurityAsyncResultBase.InnerTryReceiveCompletedCallback));
