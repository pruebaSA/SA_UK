namespace System.ServiceModel.Security
{
    ...
    internal sealed class SecuritySessionClientSettings<TChannel> : IChannelSecureConversationSessionSettings, ISecurityCommunicationObject
    {
        ...
        public IAsyncResult BeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.communicationObject.BeginClose(timeout, callback, state);
        ...
        internal TChannel OnCreateChannel(EndpointAddress remoteAddress, Uri via) => 
            this.OnCreateChannel(remoteAddress, via, null);
        ...
        IAsyncResult ISecurityCommunicationObject.OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new OperationWithTimeoutAsyncResult(new OperationWithTimeoutCallback(this.OnClose), timeout, callback, state);

        IAsyncResult ISecurityCommunicationObject.OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new OperationWithTimeoutAsyncResult(new OperationWithTimeoutCallback(this.OnOpen), timeout, callback, state);
        ...
        {
            private WaitCallback completeLater;
            ...
            private ItemDequeuedCallback startReceiving;

            static ClientSecurityDuplexSessionChannel()
            {
                SecuritySessionClientSettings<TChannel>.ClientSecurityDuplexSessionChannel.onReceive = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecurityDuplexSessionChannel.OnReceive));
            }
            ...
            public ClientSecurityDuplexSessionChannel(SecuritySessionClientSettings<TChannel> settings, EndpointAddress to, Uri via) : base(settings, to, via)
            {
                ...
                this.queue = new InputQueue<Message>();
                this.startReceiving = new ItemDequeuedCallback(this.StartReceiving);
                this.completeLater = new WaitCallback(this.CompleteLater);
            }
            ...
            public IAsyncResult BeginWaitForMessage(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.queue.BeginWaitForItem(timeout, callback, state);
            ...
            private void CompleteReceive(IAsyncResult result)
            {
                ...
                if (flag)
                {
                    ...
                    {
                        IOThreadScheduler.ScheduleCallback(this.completeLater, state);
                    }
                }
                if (item != null)
                {
            ...
            public bool EndWaitForMessage(IAsyncResult result) => 
                this.queue.EndWaitForItem(result);
            ...
            Label_0000:
                ...
                try
                {
                    result = base.BeginReceiveInternal(TimeoutHelper.Infinite, null, SecuritySessionClientSettings<TChannel>.ClientSecurityDuplexSessionChannel.onReceive, this);
                }
                catch (CommunicationException exception)
                {
                    if (DiagnosticUtility.ShouldTraceInformation)
            ...
            public bool WaitForMessage(TimeSpan timeout) => 
                this.queue.WaitForItem(timeout);

            protected override bool ExpectClose =>
                true;

            public EndpointAddress LocalAddress =>
                base.InternalLocalAddress;
            ...
            private class SoapSecurityClientDuplexSession : SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SoapSecurityOutputSession, IDuplexSession, IInputSession, IOutputSession, ISession
            {
                ...
                public IAsyncResult BeginCloseOutputSession(AsyncCallback callback, object state) => 
                    this.BeginCloseOutputSession(this.channel.DefaultCloseTimeout, callback, state);
        ...
        private abstract class ClientSecuritySessionChannel : ChannelBase
        {
            ...
            protected virtual IAsyncResult BeginCloseCore(TimeSpan timeout, AsyncCallback callback, object state) => 
                new CloseCoreAsyncResult<TChannel>((SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel) this, timeout, callback, state);
            ...
            protected IAsyncResult BeginReceiveInternal(TimeSpan timeout, SecurityProtocolCorrelationState correlationState, AsyncCallback callback, object state) => 
                new ReceiveAsyncResult<TChannel>((SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel) this, timeout, correlationState, callback, state);
            ...
            protected IAsyncResult BeginSecureOutgoingMessage(Message message, TimeSpan timeout, AsyncCallback callback, object state)
            {
                ...
                {
                    return new TypedCompletedAsyncResult<Message, SecurityProtocolCorrelationState>(message, this.securityProtocol.SecureOutgoingMessage(ref message, timeout, null), callback, state);
                }
            ...
            private IAsyncResult BeginSendCloseResponseMessage(TimeSpan timeout, AsyncCallback callback, object state) => 
                new SecureSendAsyncResult<TChannel>(this.closeResponse, (SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel) this, timeout, callback, state, true);
            ...
            protected bool EndCloseSession(IAsyncResult result, out bool wasAborted) => 
                CloseSessionAsyncResult<TChannel>.End(result, out wasAborted);

            protected Message EndReceiveInternal(IAsyncResult result) => 
                ReceiveAsyncResult<TChannel>.End(result);

            protected Message EndSecureOutgoingMessage(IAsyncResult result, out SecurityProtocolCorrelationState correlationState)
            {
                TimeSpan span;
                if (result is TypedCompletedAsyncResult<Message, SecurityProtocolCorrelationState>)
                {
                    return TypedCompletedAsyncResult<Message, SecurityProtocolCorrelationState>.End(result, out correlationState);
                }
            ...
            public override T GetProperty<T>() where T: class
            {
                ...
                {
                    return (T) this.webHeaderCollection;
                }
            ...
            private bool IsKeyRenewalNeeded() => 
                (DateTime.UtcNow >= this.keyRenewalTime);
            ...
            protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                new CloseAsyncResult<TChannel>((SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel) this, timeout, callback, state);
            ...
            private void ProcessCloseMessage(Message message)
            {
                ...
                else
                {
                    ...
                    List<RequestSecurityTokenResponse> rstrCollection = new List<RequestSecurityTokenResponse> {
                        body
                    };
                    RequestSecurityTokenResponseCollection responses = new RequestSecurityTokenResponseCollection(rstrCollection, this.Settings.SecurityStandardsManager);
            ...
            protected Message ProcessIncomingMessage(Message message, TimeSpan timeout, SecurityProtocolCorrelationState correlationState, out MessageFault protocolFault)
            {
                ...
                {
                    if ((!(exception is CommunicationException) && !(exception is TimeoutException)) && (!DiagnosticUtility.IsFatal(exception) && this.ShouldWrapException(exception)))
                    {
            ...
            protected Message ReceiveInternal(TimeSpan timeout, SecurityProtocolCorrelationState correlationState)
            {
                ...
                while (!this.isInputClosed)
                {
                    ...
                    if (helper.RemainingTimeExpireNegative() < TimeSpan.Zero)
                    {
                        break;
                    }
                }
            ...
            private bool ShouldWrapException(Exception e) => 
                ((e is FormatException) || (e is XmlException));
            ...
            private class CloseAsyncResult : TraceAsyncResult
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseAsyncResult.closeSessionCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseAsyncResult.CloseSessionCallback));
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseAsyncResult.outputSessionClosedCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseAsyncResult.OutputSessionClosedCallback));
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseAsyncResult.closeCoreCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseAsyncResult.CloseCoreCallback));
                }
            ...
            private class CloseCoreAsyncResult : TraceAsyncResult
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseCoreAsyncResult.closeChannelBinderCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseCoreAsyncResult.ChannelBinderCloseCallback));
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseCoreAsyncResult.closeTokenProviderCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseCoreAsyncResult.CloseTokenProviderCallback));
                }
            ...
            private class CloseSessionAsyncResult : TraceAsyncResult
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseSessionAsyncResult.closeOutputSessionCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseSessionAsyncResult.CloseOutputSessionCallback));
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseSessionAsyncResult.shutdownWaitCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.CloseSessionAsyncResult.ShutdownWaitCallback));
                }
            ...
            private class KeyRenewalAsyncResult : TraceAsyncResult
            {
                ...
                private static readonly WaitCallback renewKeyCallback;
                private SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel sessionChannel;
                private TimeoutHelper timeoutHelper;

                static KeyRenewalAsyncResult()
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.KeyRenewalAsyncResult.renewKeyCallback = new WaitCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.KeyRenewalAsyncResult.RenewKeyCallback);
                }
                ...
                public KeyRenewalAsyncResult(Message message, SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel sessionChannel, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
                {
                    ...
                    this.sessionChannel = sessionChannel;
                    IOThreadScheduler.ScheduleCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.KeyRenewalAsyncResult.renewKeyCallback, this);
                }
            ...
            private class OpenAsyncResult : TraceAsyncResult
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.OpenAsyncResult.getTokenCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.OpenAsyncResult.GetTokenCallback));
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.OpenAsyncResult.openTokenProviderCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.OpenAsyncResult.OpenTokenProviderCallback));
                }
            ...
            private class ReceiveAsyncResult : TraceAsyncResult
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.ReceiveAsyncResult.onReceive = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.ReceiveAsyncResult.OnReceive));
                }
                ...
                public static Message End(IAsyncResult result) => 
                    AsyncResult.End<SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.ReceiveAsyncResult>(result).message;
            ...
            internal sealed class SecureSendAsyncResult : SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SecureSendAsyncResultBase
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SecureSendAsyncResult.sendCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SecureSendAsyncResult.SendCallback));
                }
                ...
                public static SecurityProtocolCorrelationState End(IAsyncResult result) => 
                    AsyncResult.End<SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SecureSendAsyncResult>(result).SecurityCorrelationState;
            ...
            internal abstract class SecureSendAsyncResultBase : TraceAsyncResult
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SecureSendAsyncResultBase.secureOutgoingMessageCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SecureSendAsyncResultBase.SecureOutgoingMessageCallback));
                }
                ...
                protected IClientReliableChannelBinder ChannelBinder =>
                    this.sessionChannel.ChannelBinder;

                protected bool DidSecureOutgoingMessageCompleteSynchronously =>
                    this.didSecureOutgoingMessageCompleteSynchronously;
                ...
                protected System.ServiceModel.TimeoutHelper TimeoutHelper =>
                    this.timeoutHelper;
            }
        ...
        private sealed class SecurityRequestSessionChannel : SecuritySessionClientSettings<TChannel>.ClientSecuritySimplexSessionChannel, IRequestSessionChannel, IRequestChannel, IChannel, ICommunicationObject, ISessionChannel<IOutputSession>
        {
            ...
            private IAsyncResult BeginBaseCloseOutputSession(TimeSpan timeout, AsyncCallback callback, object state) => 
                base.BeginCloseOutputSession(timeout, callback, state);
            ...
            public IAsyncResult BeginRequest(Message message, AsyncCallback callback, object state) => 
                this.BeginRequest(message, base.DefaultSendTimeout, callback, state);
            ...
            private SecurityProtocolCorrelationState EndBaseCloseOutputSession(IAsyncResult result) => 
                base.EndCloseOutputSession(result);
            ...
            public Message Request(Message message) => 
                this.Request(message, base.DefaultSendTimeout);
            ...
            private class CloseOutputSessionAsyncResult : TraceAsyncResult
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.SecurityRequestSessionChannel.CloseOutputSessionAsyncResult.baseCloseOutputSessionCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.SecurityRequestSessionChannel.CloseOutputSessionAsyncResult.BaseCloseOutputSessionCallback));
                    SecuritySessionClientSettings<TChannel>.SecurityRequestSessionChannel.CloseOutputSessionAsyncResult.receiveInternalCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.SecurityRequestSessionChannel.CloseOutputSessionAsyncResult.ReceiveInternalCallback));
                }
            ...
            private sealed class SecureRequestAsyncResult : SecuritySessionClientSettings<TChannel>.ClientSecuritySessionChannel.SecureSendAsyncResultBase
            {
                ...
                {
                    SecuritySessionClientSettings<TChannel>.SecurityRequestSessionChannel.SecureRequestAsyncResult.requestCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SecuritySessionClientSettings<TChannel>.SecurityRequestSessionChannel.SecureRequestAsyncResult.RequestCallback));
                }
