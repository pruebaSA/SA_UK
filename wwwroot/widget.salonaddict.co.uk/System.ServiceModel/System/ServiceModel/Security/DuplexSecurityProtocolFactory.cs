namespace System.ServiceModel.Security
{
    ...
    internal sealed class DuplexSecurityProtocolFactory : SecurityProtocolFactory
    {
        ...
        protected override SecurityProtocol OnCreateSecurityProtocol(EndpointAddress target, Uri via, object listenerSecurityState, TimeSpan timeout)
        {
            ...
            SecurityProtocolFactory protocolFactoryForIncomingMessages = this.ProtocolFactoryForIncomingMessages;
            TimeoutHelper helper = new TimeoutHelper(timeout);
            SecurityProtocol outgoingProtocol = protocolFactoryForOutgoingMessages?.CreateSecurityProtocol(target, via, listenerSecurityState, false, helper.RemainingTime());
            return new DuplexSecurityProtocol(outgoingProtocol, protocolFactoryForIncomingMessages?.CreateSecurityProtocol(null, null, listenerSecurityState, false, helper.RemainingTime()));
        }
        ...
        {
            get => 
                this.requireSecurityOnBothDuplexDirections;
            set
            {
                base.ThrowIfImmutable();
        ...
        public override bool SupportsReplayDetection =>
            ((((this.ForwardProtocolFactory != null) && this.ForwardProtocolFactory.SupportsReplayDetection) && (this.ReverseProtocolFactory != null)) && this.ReverseProtocolFactory.SupportsReplayDetection);
        ...
        private sealed class DuplexSecurityProtocol : SecurityProtocol
        {
            ...
            public override IAsyncResult BeginSecureOutgoingMessage(Message message, TimeSpan timeout, SecurityProtocolCorrelationState correlationState, AsyncCallback callback, object state)
            {
                ...
                return new TypedCompletedAsyncResult<Message, SecurityProtocolCorrelationState>(message, null, callback, state);
            }
