namespace System.ServiceModel.Security
{
    ...
    internal sealed class EncryptedHeaderXml
    {
        ...
        public byte[] GetDecryptedBuffer() => 
            this.encryptedData.GetDecryptedBuffer();
        ...
        {
            get => 
                this.encryptedData.EncryptionMethod;
            set
            {
        ...
        {
            get => 
                this.encryptedData.EncryptionMethodDictionaryString;
            set
            {
        ...
        {
            get => 
                this.encryptedData.KeyIdentifier;
            set
            {
        ...
        {
            get => 
                this.encryptedData.SecurityTokenSerializer;
            set
            {
