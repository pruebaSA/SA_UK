namespace System.ServiceModel.Description
{
    ...
    internal class XmlSerializerMessageContractExporter : MessageContractExporter
    {
        ...
        protected override object GetExtensionData() => 
            new ExtensionData(((XmlSerializerOperationBehavior) base.extension).XmlSerializerFormatAttribute);

        protected override bool IsEncoded() => 
            ((XmlSerializerOperationBehavior) base.extension).XmlSerializerFormatAttribute.IsEncoded;

        protected override bool IsRpcStyle() => 
            (((XmlSerializerOperationBehavior) base.extension).XmlSerializerFormatAttribute.Style == OperationFormatStyle.Rpc);
        ...
        protected override object OnExportMessageContract() => 
            this.Reflector.ReflectOperation(base.operation);
