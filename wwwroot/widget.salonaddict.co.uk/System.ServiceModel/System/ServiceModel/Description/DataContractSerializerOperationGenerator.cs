namespace System.ServiceModel.Description
{
    ...
    internal class DataContractSerializerOperationGenerator : IOperationBehavior, IOperationContractGenerationExtension
    {
        ...
        internal DataContractSerializerOperationGenerator() : this(new CodeCompileUnit())
        {
        }

        internal DataContractSerializerOperationGenerator(CodeCompileUnit codeCompileUnit)
        {
        ...
        internal class WrappedBodyTypeGenerator : IWrappedBodyTypeGenerator
        {
            ...
            private bool IsNonNillableReferenceType(MessagePartDescription part) => 
                this.dataContractSerializerOperationGenerator.isNonNillableReferenceTypes?.ContainsKey(part);
