namespace System.ServiceModel.Description
{
    ...
    public class DataContractSerializerOperationBehavior : IOperationBehavior, IWsdlExportExtension
    {
        ...
        public virtual XmlObjectSerializer CreateSerializer(Type type, string name, string ns, IList<Type> knownTypes) => 
            new DataContractSerializer(type, name, ns, knownTypes, this.MaxItemsInObjectGraph, this.IgnoreExtensionDataObject, false, this.DataContractSurrogate);
        ...
        private object GetFormatter(OperationDescription operation, out bool formatRequest, out bool formatReply, bool isProxy)
        {
        ...
        {
            get => 
                this.ignoreExtensionDataObjectSetExplicit;
            set
            {
        ...
        {
            get => 
                this.maxItemsInObjectGraphSetExplicit;
            set
            {
