namespace System.ServiceModel.Description
{
    ...
    public sealed class ServiceAuthorizationBehavior : IServiceBehavior
    {
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private void ApplyRoleProvider(DispatchRuntime behavior)
        {
            behavior.RoleProvider = (System.Web.Security.RoleProvider) this.roleProvider;
        }

        internal ServiceAuthorizationBehavior Clone() => 
            new ServiceAuthorizationBehavior(this);
