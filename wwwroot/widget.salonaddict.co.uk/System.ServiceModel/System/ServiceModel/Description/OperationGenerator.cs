namespace System.ServiceModel.Description
{
    ...
    internal class OperationGenerator
    {
        ...
        internal static CodeAttributeDeclaration GenerateAttributeDeclaration(ServiceContractGenerator generator, Attribute attribute) => 
            CustomAttributeHelper.GenerateAttributeDeclaration(generator, attribute);
        ...
        private static class CustomAttributeHelper
        {
            ...
            internal static CodeAttributeDeclaration FindOrCreateAttributeDeclaration<T>(CodeAttributeDeclarationCollection attributes) where T: Attribute => 
                SecurityAttributeGenerationHelper.FindOrCreateAttributeDeclaration<T>(attributes);
        ...
        private class MethodSignatureGenerator
        {
            ...
            private void GenerateOperationSignatures(ref OperationFormatStyle style)
            {
                if (this.MessageContractType != System.ServiceModel.Description.MessageContractType.None)
                {
                    ...
                    this.GenerateTypedMessageOperation(ref style);
                }
            ...
            private CodeTypeReference GenerateTypedMessageHeaderAndReturnValueParts(CodeNamespace ns, string defaultName, MessageDescription message, bool isReply, ref bool isNewMessage, out IPartCodeGenerator partCodeGenerator)
            {
                ...
                {
                    this.WrapTypedMessage(ns, codeType.Name, message, isReply, this.Context.IsInherited);
                }
            ...
            private void GenerateTypedMessageOperation(ref OperationFormatStyle style)
            {
                this.CreateOrOverrideActionProperties();
                if (this.HasUntypedMessages)
                {
                ...
                CodeCompileUnit targetCompileUnit = this.Context.ServiceContractGenerator.TargetCompileUnit;
                ...
                {
                    CodeTypeReference type = this.GenerateTypedMessageHeaderAndReturnValueParts(ns, this.DefaultName + "Request", this.Request, false, ref this.IsNewRequest, out this.BeginPartCodeGenerator);
                ...
                {
                    CodeTypeReference reference2 = this.GenerateTypedMessageHeaderAndReturnValueParts(ns, this.DefaultName + "Response", this.Response, true, ref this.IsNewResponse, out this.EndPartCodeGenerator);
            ...
            private bool IsEmpty(MessageDescription message) => 
                ((message.Body.Parts.Count == 0) && (message.Headers.Count == 0));
            ...
            private void WrapTypedMessage(CodeNamespace ns, string typeName, MessageDescription messageDescription, bool isReply, bool isInherited)
            {
                UniqueCodeNamespaceScope scope = new UniqueCodeNamespaceScope(ns);
                CodeTypeDeclaration codeType = this.Context.Contract.TypeFactory.CreateClassType();
            ...
            private class ParameterizedMethodGenerator
            {
                ...
                private class ParametersPartCodeGenerator : OperationGenerator.MethodSignatureGenerator.IPartCodeGenerator
                {
                    ...
                    private static bool DoesParameterNameExist(string name, object parametersObject) => 
                        ((OperationGenerator.MethodSignatureGenerator.ParameterizedMethodGenerator.ParametersPartCodeGenerator) parametersObject).NameExists(name);
                    ...
                    private static string GetUniqueParameterName(string name, OperationGenerator.MethodSignatureGenerator.ParameterizedMethodGenerator.ParametersPartCodeGenerator parameters) => 
                        NamingHelper.GetUniqueName(name, new NamingHelper.DoesNameExist(OperationGenerator.MethodSignatureGenerator.ParameterizedMethodGenerator.ParametersPartCodeGenerator.DoesParameterNameExist), parameters);
            ...
            private class TypedMessagePartCodeGenerator : OperationGenerator.MethodSignatureGenerator.IPartCodeGenerator
            {
                ...
                CodeAttributeDeclarationCollection OperationGenerator.MethodSignatureGenerator.IPartCodeGenerator.MessageLevelAttributes =>
                    this.typeDecl.CustomAttributes;
            }
        }
    }
}
