namespace System.ServiceModel.Description
{
    ...
    public abstract class MetadataExporter
    {
        ...
        private Exception CreateExtensionException(IPolicyExportExtension exporter, Exception e) => 
            new InvalidOperationException(System.ServiceModel.SR.GetString("PolicyExtensionExportError", new object[] { exporter.GetType(), e.Message }), e);
