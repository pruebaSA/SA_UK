namespace System.ServiceModel.Description
{
    ...
    public class WsdlImporter : MetadataImporter
    {
        ...
        private Exception CreateAlreadyFaultedException(NamedItem item) => 
            new AlreadyFaultedException(System.ServiceModel.SR.GetString("WsdlItemAlreadyFaulted", new object[] { GetElementName(item) }), this.importErrors[item]);

        private static Exception CreateBeforeImportExtensionException(IWsdlImportExtension importer, Exception e) => 
            new InvalidOperationException(System.ServiceModel.SR.GetString("WsdlExtensionBeforeImportError", new object[] { importer.GetType().AssemblyQualifiedName, e.Message }), e);
        ...
        private static Exception CreateExtensionException(IWsdlImportExtension importer, Exception e) => 
            new InvalidOperationException(System.ServiceModel.SR.GetString("WsdlExtensionImportError", new object[] { importer.GetType().FullName, e.Message }), e);
        ...
        private bool IsBlackListed(NamedItem item) => 
            this.importErrors.ContainsKey(item);

        private static bool IsNonSoapWsdl11BindingExtension(object ext) => 
            ((((ext is HttpAddressBinding) || (ext is HttpBinding)) || ((ext is HttpOperationBinding) || (ext is HttpUrlEncodedBinding))) || ((((ext is HttpUrlReplacementBinding) || (ext is MimeContentBinding)) || ((ext is MimeMultipartRelatedBinding) || (ext is System.Web.Services.Description.MimePart))) || ((ext is MimeTextBinding) || (ext is MimeXmlBinding))));

        [SecurityCritical, SecurityTreatAsSafe]
        private static Collection<IWsdlImportExtension> LoadWsdlExtensionsFromConfig() => 
            ClientSection.UnsafeGetSection().Metadata.LoadWsdlImportExtensions();
        ...
        internal override XmlElement ResolvePolicyReference(string policyReference, XmlElement contextAssertion) => 
            this.PolicyReader.ResolvePolicyReference(policyReference, contextAssertion);
        ...
        internal static class SoapInPolicyWorkaroundHelper
        {
            ...
            public static string FindAdHocTransportPolicy(PolicyConversionContext policyContext, out XmlQualifiedName wsdlBindingQName) => 
                FindAdHocPolicy(policyContext, "TransportBindingElementImporter.TransportUri", out wsdlBindingQName);
        ...
        private class WsdlImportException : Exception
        {
            ...
            internal bool IsChildNodeOf(NamedItem item) => 
                this.XPath.StartsWith(WsdlImporter.CreateXPathString(item), StringComparison.Ordinal);
        ...
        private static class WsdlNamingHelper
        {
            ...
            internal static System.ServiceModel.Description.XmlName GetEndpointName(Port wsdlPort) => 
                new System.ServiceModel.Description.XmlName(wsdlPort.Name, true);
        ...
        internal class WsdlPolicyReader
        {
            ...
            internal XmlElement ResolvePolicyReference(string policyReference, XmlElement contextPolicyAssertion) => 
                this.policyDictionary.ResolvePolicyReference(policyReference, contextPolicyAssertion);
            ...
            private class WsdlPolicyDictionary
            {
                ...
                private static string GetFragmentIdentifier(XmlElement element) => 
                    MetadataImporter.PolicyHelper.GetFragmentIdentifier(element);
