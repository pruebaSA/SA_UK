    ...
    internal class XmlSerializerContract : XmlSerializerImplementation
    {
            ...
            get
            {
                if (this.readMethods == null)
                {
                    Hashtable hashtable = new Hashtable {
                        ["System.ServiceModel.Description.MetadataSet:http://schemas.xmlsoap.org/ws/2004/09/mex:Metadata:True:"] = "Read68_Metadata"
                    };
                    if (this.readMethods == null)
                    {
        ...
        public override Hashtable WriteMethods
        {
            get
            {
                ...
                {
                    Hashtable hashtable = new Hashtable {
                        ["System.ServiceModel.Description.MetadataSet:http://schemas.xmlsoap.org/ws/2004/09/mex:Metadata:True:"] = "Write68_Metadata"
                    };
                    if (this.writeMethods == null)
                    {
