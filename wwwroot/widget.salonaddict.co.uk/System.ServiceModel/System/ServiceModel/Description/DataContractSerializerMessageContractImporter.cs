namespace System.ServiceModel.Description
{
    ...
    public class DataContractSerializerMessageContractImporter : IWsdlImportExtension
    {
        ...
        private const string GenericMessageSchemaTypeName = "MessageBody";
        private const string GenericMessageSchemaTypeNamespace = "http://schemas.microsoft.com/Message";
