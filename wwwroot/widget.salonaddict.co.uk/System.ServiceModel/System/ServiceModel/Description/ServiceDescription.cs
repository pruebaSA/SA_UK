namespace System.ServiceModel.Description
{
    ...
    public class ServiceDescription
    {
        ...
        private static void AddBehaviors(System.ServiceModel.Description.ServiceDescription serviceDescription)
        {
            ...
            if (ServiceHostingEnvironment.IsHosted && (serviceDescription.Behaviors.Find<AspNetCompatibilityRequirementsAttribute>() == null))
            {
                AspNetCompatibilityRequirementsAttribute item = new AspNetCompatibilityRequirementsAttribute();
                serviceDescription.Behaviors.Add(item);
            }
        }
