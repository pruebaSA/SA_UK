namespace System.ServiceModel.Description
{
    ...
    internal class DataContractSerializerMessageContractExporter : MessageContractExporter
    {
        ...
        protected override object GetExtensionData() => 
            new ExtensionData(((DataContractSerializerOperationBehavior) base.extension).DataContractFormatAttribute);

        protected override bool IsEncoded() => 
            false;

        protected override bool IsRpcStyle() => 
            (((DataContractSerializerOperationBehavior) base.extension).DataContractFormatAttribute.Style == OperationFormatStyle.Rpc);
