namespace System.ServiceModel.Dispatcher
{
    ...
    internal class TrieSegment
    {
        ...
        internal TrieSegment(char firstChar, string segmentTail)
        {
            ...
            this.children = new SortedBuffer<TrieSegment, TrieSegmentComparer>();
        }
        ...
        internal int GetChildPosition(char ch) => 
            this.children.IndexOfKey<char>(ch, SegKeyComparer);
        ...
        internal bool CanMerge =>
            ((this.data == null) && (1 == this.children.Count));

        internal bool CanPrune =>
            ((this.data == null) && (0 == this.children.Count));
