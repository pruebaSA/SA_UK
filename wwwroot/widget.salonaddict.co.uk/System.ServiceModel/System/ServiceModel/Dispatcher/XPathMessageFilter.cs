namespace System.ServiceModel.Dispatcher
{
    ...
    public class XPathMessageFilter : MessageFilter, IXmlSerializable
    {
        ...
        private static XPathFilterMatcher dummyMatcher = new XPathFilterMatcher();
        private const string InnerElem = "XPath";
        private XPathFilterMatcher matcher;
        ...
        protected internal override IMessageFilterTable<FilterData> CreateFilterTable<FilterData>() => 
            new XPathMessageFilterTable<FilterData> { NodeQuota = this.NodeQuota };
        ...
        private bool ProcessResult(QueryResult result)
        {
