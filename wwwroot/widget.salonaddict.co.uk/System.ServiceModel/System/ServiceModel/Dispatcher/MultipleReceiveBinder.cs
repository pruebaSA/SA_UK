namespace System.ServiceModel.Dispatcher
{
    ...
    internal class MultipleReceiveBinder : IChannelBinder
    {
        ...
        private static AsyncCallback onInnerReceiveCompleted = DiagnosticUtility.Utility.ThunkCallback(new AsyncCallback(MultipleReceiveBinder.OnInnerReceiveCompleted));
        ...
        public IAsyncResult BeginRequest(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
            this.channelBinder.BeginRequest(message, timeout, callback, state);

        public IAsyncResult BeginSend(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
            this.channelBinder.BeginSend(message, timeout, callback, state);
        ...
        public IAsyncResult BeginWaitForMessage(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.channelBinder.BeginWaitForMessage(timeout, callback, state);
        ...
        public Message EndRequest(IAsyncResult result) => 
            this.channelBinder.EndRequest(result);
        ...
        public bool EndTryReceive(IAsyncResult result, out RequestContext requestContext) => 
            MultipleReceiveAsyncResult.End(result, out requestContext);

        public bool EndWaitForMessage(IAsyncResult result) => 
            this.channelBinder.EndWaitForMessage(result);
        ...
        public Message Request(Message message, TimeSpan timeout) => 
            this.channelBinder.Request(message, timeout);
        ...
        public bool TryReceive(TimeSpan timeout, out RequestContext requestContext) => 
            this.channelBinder.TryReceive(timeout, out requestContext);

        public bool WaitForMessage(TimeSpan timeout) => 
            this.channelBinder.WaitForMessage(timeout);

        public IChannel Channel =>
            this.channelBinder.Channel;

        public bool HasSession =>
            this.channelBinder.HasSession;

        public Uri ListenUri =>
            this.channelBinder.ListenUri;

        public EndpointAddress LocalAddress =>
            this.channelBinder.LocalAddress;

        public EndpointAddress RemoteAddress =>
            this.channelBinder.RemoteAddress;
