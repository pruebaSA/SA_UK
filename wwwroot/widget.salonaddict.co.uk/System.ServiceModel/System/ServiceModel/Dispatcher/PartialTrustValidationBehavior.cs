namespace System.ServiceModel.Dispatcher
{
    ...
    internal class PartialTrustValidationBehavior : IServiceBehavior, IEndpointBehavior
    {
        ...
        {
            private static Type[] unsupportedBindings;
            private static Type[] unsupportedBindingElements;
            ...
            {
                Type bindingType = this.binding.GetType();
