namespace System.ServiceModel.Dispatcher
{
    ...
    internal class ImmutableClientRuntime
    {
        ...
        internal IAsyncResult BeginDisplayInitializationUI(ServiceChannel channel, AsyncCallback callback, object state) => 
            new DisplayInitializationUIAsyncResult(channel, this.interactiveChannelInitializers, callback, state);
        ...
        {
            private static AsyncCallback callback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ImmutableClientRuntime.DisplayInitializationUIAsyncResult.Callback));
