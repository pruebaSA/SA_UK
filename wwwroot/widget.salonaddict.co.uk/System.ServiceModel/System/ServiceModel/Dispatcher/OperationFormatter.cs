namespace System.ServiceModel.Dispatcher
{
    ...
    internal abstract class OperationFormatter : IClientMessageFormatter, IDispatchMessageFormatter
    {
        ...
        protected XmlDictionaryString AddToDictionary(string s) => 
            AddToDictionary(this.dictionary, s);
        ...
        private static object CreateTypedMessageInstance(Type messageContractType)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("SFxMessageContractRequiresDefaultConstructor", new object[] { messageContractType.FullName }), exception));
            }
            return obj3;
        }
        ...
        public object DeserializeReply(Message message, object[] parameters)
        {
            ...
            return this.DeserializeBodyContents(message, parameters, false);
        }
        ...
        internal static bool IsValidReturnValue(MessagePartDescription returnValue) => 
            ((returnValue != null) && (returnValue.Type != typeof(void)));
        ...
        internal static void TraceAndSkipElement(XmlReader xmlReader)
        {
            ...
            {
                DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Verbose, TraceCode.ElementIgnored, System.ServiceModel.SR.GetString("SFxTraceCodeElementIgnored"), new StringTraceRecord("Element", xmlReader.NamespaceURI + ":" + xmlReader.LocalName));
            }
            xmlReader.Skip();
        }
        ...
        internal static void Validate(OperationDescription operation, bool isRpc, bool isEncoded)
        {
            if (isEncoded && !isRpc)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("SFxDocEncodedNotSupported", new object[] { operation.Name })));
            }
            bool flag = false;
            bool flag2 = false;
            bool flag3 = false;
            for (int i = 0; i < operation.Messages.Count; i++)
            {
                ...
                if (description.IsTypedMessage || description.IsUntypedMessage)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("SFxTypedMessageCannotBeRpcLiteral", new object[] { operation.Name })));
                    }
                    flag2 = true;
                }
            ...
            if (flag3 && flag2)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("SFxTypedOrUntypedMessageCannotBeMixedWithParameters", new object[] { operation.Name })));
            }
            if ((isRpc && flag2) && flag)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("SFxTypedOrUntypedMessageCannotBeMixedWithVoidInRpc", new object[] { operation.Name })));
            }
        }
        ...
        internal abstract class OperationFormatterHeader : MessageHeader
        {
            ...
            public override bool IsMessageVersionSupported(MessageVersion messageVersion) => 
                this.innerHeader.IsMessageVersionSupported(messageVersion);
        ...
        private class TypedMessageParts
        {
            ...
            public TypedMessageParts(object instance, MessageDescription description)
            {
                ...
                if (instance == null)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentNullException(System.ServiceModel.SR.GetString("SFxTypedMessageCannotBeNull", new object[] { description.Action })));
                }
