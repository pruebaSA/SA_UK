namespace System.ServiceModel.Dispatcher
{
    ...
    internal class ReplyChannelBinder : IChannelBinder
    {
        ...
        public IAsyncResult BeginTryReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.channel.BeginTryReceiveRequest(timeout, callback, state);
        ...
        public bool EndTryReceive(IAsyncResult result, out RequestContext requestContext) => 
            this.channel.EndTryReceiveRequest(result, out requestContext);
        ...
        public bool TryReceive(TimeSpan timeout, out RequestContext requestContext) => 
            this.channel.TryReceiveRequest(timeout, out requestContext);
        ...
        public bool HasSession =>
            (this.channel is ISessionChannel<IInputSession>);
