namespace System.ServiceModel.Dispatcher
{
    ...
    internal class SeekableMessageNavigator : SeekableXPathNavigator, INodeCounter
    {
        ...
        public override XPathNavigator Clone() => 
            new SeekableMessageNavigator(this);
        ...
        public override string GetName(long pos) => 
            this.GetName(this.dom.DecodePosition(pos).elem);
        ...
        public override XPathNodeType GetNodeType(long pos) => 
            this.dom.nodes[this.dom.DecodePosition(pos).elem].type;
        ...
        public override bool IsEmptyElement =>
            this.dom.nodes[this.location].empty;
        ...
        public override XPathNodeType NodeType =>
            this.dom.nodes[this.location].type;
        ...
        public override string Value =>
            this.dom.GetValue(this.location);
