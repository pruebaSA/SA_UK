namespace System.ServiceModel
{
    ...
    public abstract class ChannelFactory : CommunicationObject, IChannelFactory, ICommunicationObject, IDisposable
    {
        ...
        protected virtual IChannelFactory CreateFactory()
        {
            ...
            {
                return ServiceChannelFactory.BuildChannelFactory(this.Endpoint);
            }
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new CloseAsyncResult(this.innerFactory, timeout, callback, state);

        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new OpenAsyncResult(this.innerFactory, timeout, callback, state);
        ...
        internal bool IsSharable =>
            this.isSharable;

        private class CloseAsyncResult : AsyncResult
        {
            private ICommunicationObject communicationObject;
            private static AsyncCallback onCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ChannelFactory.CloseAsyncResult.OnCloseComplete));
        ...
        {
            private ICommunicationObject communicationObject;
            private static AsyncCallback onOpenComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ChannelFactory.OpenAsyncResult.OnOpenComplete));
