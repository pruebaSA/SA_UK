namespace System.ServiceModel
{
    ...
    [KnownType(typeof(IPAddress[])), DataContract(Name="PeerNodeAddress", Namespace="http://schemas.microsoft.com/net/2006/05/peer")]
    public sealed class PeerNodeAddress
    {
        ...
        internal EndpointAddress10 InnerEPR
        {
            ...
            set
            {
                this.endpointAddress = value?.ToEndpointAddress();
            }
        }
