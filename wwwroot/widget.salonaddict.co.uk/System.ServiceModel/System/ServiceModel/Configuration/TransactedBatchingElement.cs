namespace System.ServiceModel.Configuration
{
    ...
    public sealed class TransactedBatchingElement : BehaviorExtensionElement
    {
        ...
        protected internal override object CreateBehavior() => 
            new TransactedBatchingBehavior(this.MaxBatchSize);
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("maxBatchSize", typeof(int), 0, null, new IntegerValidator(0, 0x7fffffff, false), ConfigurationPropertyOptions.None)
                    };
