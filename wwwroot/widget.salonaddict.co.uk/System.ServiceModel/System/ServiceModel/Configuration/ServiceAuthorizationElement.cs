namespace System.ServiceModel.Configuration
{
    ...
    public sealed class ServiceAuthorizationElement : BehaviorExtensionElement
    {
        ...
        protected internal override object CreateBehavior()
        {
            ...
            {
                behavior.RoleProvider = Roles.Providers[roleProviderName];
        ...
        public AuthorizationPolicyTypeElementCollection AuthorizationPolicies =>
            ((AuthorizationPolicyTypeElementCollection) base["authorizationPolicies"]);
        ...
        {
            get => 
                ((bool) base["impersonateCallerForAllOperations"]);
            set
            {
        ...
        {
            get => 
                ((System.ServiceModel.Description.PrincipalPermissionMode) base["principalPermissionMode"]);
            set
            {
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("principalPermissionMode", typeof(System.ServiceModel.Description.PrincipalPermissionMode), System.ServiceModel.Description.PrincipalPermissionMode.UseWindowsGroups, null, new ServiceModelEnumValidator(typeof(PrincipalPermissionModeHelper)), ConfigurationPropertyOptions.None),
                        new ConfigurationProperty("roleProviderName", typeof(string), string.Empty, null, new StringValidator(0, 0x7fffffff, null), ConfigurationPropertyOptions.None),
                        ...
                        new ConfigurationProperty("serviceAuthorizationManagerType", typeof(string), string.Empty, null, new StringValidator(0, 0x7fffffff, null), ConfigurationPropertyOptions.None),
        ...
        {
            get => 
                ((string) base["serviceAuthorizationManagerType"]);
            set
            {
                if (string.IsNullOrEmpty(value))
                {
