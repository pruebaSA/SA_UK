            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("protectionLevel", typeof(System.Net.Security.ProtectionLevel), System.Net.Security.ProtectionLevel.EncryptAndSign, null, new StandardRuntimeEnumValidator(typeof(System.Net.Security.ProtectionLevel)), ConfigurationPropertyOptions.None)
                    };
