namespace System.ServiceModel.Configuration
{
    ...
    public sealed class SecureConversationServiceElement : ConfigurationElement
    {
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("securityStateEncoderType", typeof(string), string.Empty, null, new StringValidator(0, 0x7fffffff, null), ConfigurationPropertyOptions.None)
                    };
        ...
        [ConfigurationProperty("securityStateEncoderType", DefaultValue=""), StringValidator(MinLength=0)]
        public string SecurityStateEncoderType
        {
            get => 
                ((string) base["securityStateEncoderType"]);
            set
            {
