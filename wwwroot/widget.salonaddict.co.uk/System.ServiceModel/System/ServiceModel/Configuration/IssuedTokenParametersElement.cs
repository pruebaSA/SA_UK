namespace System.ServiceModel.Configuration
{
    ...
    public sealed class IssuedTokenParametersElement : ConfigurationElement
    {
        ...
        public XmlElementElementCollection AdditionalRequestParameters =>
            ((XmlElementElementCollection) base["additionalRequestParameters"]);
        ...
        [ConfigurationProperty("defaultMessageSecurityVersion"), TypeConverter(typeof(MessageSecurityVersionConverter))]
        public MessageSecurityVersion DefaultMessageSecurityVersion
        {
            get => 
                ((MessageSecurityVersion) base["defaultMessageSecurityVersion"]);
            set
            {
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        ...
                        new ConfigurationProperty("keySize", typeof(int), 0, null, new IntegerValidator(0, 0x7fffffff, false), ConfigurationPropertyOptions.None),
                        ...
                        new ConfigurationProperty("tokenType", typeof(string), string.Empty, null, new StringValidator(0, 0x7fffffff, null), ConfigurationPropertyOptions.None),
        ...
        [ConfigurationProperty("tokenType", DefaultValue=""), StringValidator(MinLength=0)]
        public string TokenType
        {
            get => 
                ((string) base["tokenType"]);
            set
            {
