namespace System.ServiceModel.Configuration
{
    ...
    internal static class ConfigurationStrings
    {
        ...
        internal static string BehaviorsSectionPath =>
            ConfigurationHelpers.GetSectionPath("behaviors");

        internal static string BindingsSectionGroupPath =>
            ConfigurationHelpers.GetSectionPath("bindings");

        internal static string ClientSectionPath =>
            ConfigurationHelpers.GetSectionPath("client");

        internal static string ComContractsSectionPath =>
            ConfigurationHelpers.GetSectionPath("comContracts");

        internal static string CommonBehaviorsSectionPath =>
            ConfigurationHelpers.GetSectionPath("commonBehaviors");

        internal static string DiagnosticSectionPath =>
            ConfigurationHelpers.GetSectionPath("diagnostics");

        internal static string ExtensionsSectionPath =>
            ConfigurationHelpers.GetSectionPath("extensions");

        internal static string ServiceHostingEnvironmentSectionPath =>
            ConfigurationHelpers.GetSectionPath("serviceHostingEnvironment");

        internal static string ServicesSectionPath =>
            ConfigurationHelpers.GetSectionPath("services");
    }
}
