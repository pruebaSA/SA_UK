namespace System.ServiceModel.Configuration
{
    ...
    public sealed class IssuedTokenServiceElement : ConfigurationElement
    {
        ...
        [ServiceModelEnumValidator(typeof(AudienceUriModeValidationHelper)), ConfigurationProperty("audienceUriMode", DefaultValue=2)]
        public System.IdentityModel.Selectors.AudienceUriMode AudienceUriMode
        {
            get => 
                ((System.IdentityModel.Selectors.AudienceUriMode) base["audienceUriMode"]);
            set
            {
        ...
        public X509CertificateTrustedIssuerElementCollection KnownCertificates =>
            ((X509CertificateTrustedIssuerElementCollection) base["knownCertificates"]);
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        ...
                        new ConfigurationProperty("audienceUriMode", typeof(System.IdentityModel.Selectors.AudienceUriMode), System.IdentityModel.Selectors.AudienceUriMode.BearerKeyOnly, null, new ServiceModelEnumValidator(typeof(AudienceUriModeValidationHelper)), ConfigurationPropertyOptions.None),
                        ...
                        new ConfigurationProperty("samlSerializerType", typeof(string), string.Empty, null, new StringValidator(0, 0x7fffffff, null), ConfigurationPropertyOptions.None),
        ...
        {
            get => 
                ((string) base["samlSerializerType"]);
            set
            {
                if (string.IsNullOrEmpty(value))
                {
