namespace System.ServiceModel.Configuration
{
    ...
    public sealed class XmlElementElement : ConfigurationElement
    {
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("xmlElement", typeof(System.Xml.XmlElement), null, null, null, ConfigurationPropertyOptions.IsKey)
                    };
        ...
        {
            get => 
                ((System.Xml.XmlElement) base["xmlElement"]);
            set
            {
