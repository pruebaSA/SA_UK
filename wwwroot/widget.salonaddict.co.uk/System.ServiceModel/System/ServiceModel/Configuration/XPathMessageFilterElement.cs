namespace System.ServiceModel.Configuration
{
    ...
    public sealed class XPathMessageFilterElement : ConfigurationElement
    {
        ...
        {
            get => 
                ((XPathMessageFilter) base["filter"]);
            set
            {
                base["filter"] = value;
            }
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("filter", typeof(XPathMessageFilter), null, null, null, ConfigurationPropertyOptions.IsKey | ConfigurationPropertyOptions.IsRequired)
                    };
