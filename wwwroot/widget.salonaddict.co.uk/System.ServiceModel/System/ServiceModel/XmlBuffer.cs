namespace System.ServiceModel
{
    ...
    internal class XmlBuffer
    {
        ...
        public XmlBuffer(int maxBufferSize)
        {
            ...
            this.stream = new BufferedOutputStream("XmlBufferQuotaExceeded", initialSize, maxBufferSize, BufferManager.CreateBufferManager(0L, 0x7fffffff));
        ...
        private Exception CreateInvalidStateException() => 
            new InvalidOperationException(System.ServiceModel.SR.GetString("XmlBufferInInvalidState"));
