namespace System.ServiceModel
{
    ...
    [Serializable, KnownType(typeof(FaultException.FaultCodeData[])), KnownType(typeof(FaultException.FaultReasonData[])), KnownType(typeof(FaultException.FaultCodeData)), KnownType(typeof(FaultException.FaultReasonData))]
    public class FaultException : CommunicationException
    {
        ...
        public static FaultException CreateFault(MessageFault messageFault, params Type[] faultDetailTypes) => 
            CreateFault(messageFault, null, faultDetailTypes);
        ...
        private static FaultReason DefaultReason =>
            new FaultReason(System.ServiceModel.SR.GetString("SFxFaultReason"));

        internal MessageFault Fault =>
            this.fault;

        public override string Message =>
            GetSafeReasonText(this.Reason);
