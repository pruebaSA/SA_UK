namespace System.ServiceModel
{
    ...
    public class EndpointAddressBuilder
    {
        ...
        public EndpointAddress ToEndpointAddress() => 
            new EndpointAddress(this.uri, this.identity, new AddressHeaderCollection(this.headers), this.GetReaderAtMetadata(), this.GetReaderAtExtensions(), this.epr?.GetReaderAtPsp());
