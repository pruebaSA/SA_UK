namespace System.ServiceModel
{
    ...
    internal sealed class SR
    {
        ...
        internal const string BufferIsNotRightSizeForBufferManager = "BufferIsNotRightSizeForBufferManager";
        ...
        internal const string ExportOfBindingWithAsymmetricAndTransportSecurityNotSupported = "ExportOfBindingWithAsymmetricAndTransportSecurityNotSupported";
        internal const string ExportOfBindingWithSymmetricAndTransportSecurityNotSupported = "ExportOfBindingWithSymmetricAndTransportSecurityNotSupported";
        ...
        internal const string ExtendedProtectionPolicyCustomChannelBindingMismatch = "ExtendedProtectionPolicyCustomChannelBindingMismatch";
        ...
        internal const string ExtendedProtectionPolicyEnforcementMismatch = "ExtendedProtectionPolicyEnforcementMismatch";
        internal const string ExtendedProtectionPolicyScenarioMismatch = "ExtendedProtectionPolicyScenarioMismatch";
        ...
        internal const string Hosting_AddressIsAbsoluteUri = "Hosting_AddressIsAbsoluteUri";
        internal const string Hosting_AddressPointsOutsideTheVirtualDirectory = "Hosting_AddressPointsOutsideTheVirtualDirectory";
        internal const string Hosting_AuthSchemesRequireOtherAuth = "Hosting_AuthSchemesRequireOtherAuth";
        internal const string Hosting_AuthSchemesRequireWindowsAuth = "Hosting_AuthSchemesRequireWindowsAuth";
        internal const string Hosting_BadMetabaseSettingsIis7Type = "Hosting_BadMetabaseSettingsIis7Type";
        internal const string Hosting_BaseUriDeserializedNotValid = "Hosting_BaseUriDeserializedNotValid";
        internal const string Hosting_BuildProviderAmbiguousType = "Hosting_BuildProviderAmbiguousType";
        internal const string Hosting_BuildProviderAttributeEmpty = "Hosting_BuildProviderAttributeEmpty";
        internal const string Hosting_BuildProviderAttributeMissing = "Hosting_BuildProviderAttributeMissing";
        internal const string Hosting_BuildProviderCouldNotCreateType = "Hosting_BuildProviderCouldNotCreateType";
        internal const string Hosting_BuildProviderDirectiveEndBracketMissing = "Hosting_BuildProviderDirectiveEndBracketMissing";
        internal const string Hosting_BuildProviderDirectiveMissing = "Hosting_BuildProviderDirectiveMissing";
        internal const string Hosting_BuildProviderDirectiveNameMissing = "Hosting_BuildProviderDirectiveNameMissing";
        internal const string Hosting_BuildProviderDuplicateAttribute = "Hosting_BuildProviderDuplicateAttribute";
        internal const string Hosting_BuildProviderDuplicateDirective = "Hosting_BuildProviderDuplicateDirective";
        internal const string Hosting_BuildProviderInvalidValueForBooleanAttribute = "Hosting_BuildProviderInvalidValueForBooleanAttribute";
        internal const string Hosting_BuildProviderInvalidValueForNonNegativeIntegerAttribute = "Hosting_BuildProviderInvalidValueForNonNegativeIntegerAttribute";
        internal const string Hosting_BuildProviderMainAttributeMissing = "Hosting_BuildProviderMainAttributeMissing";
        internal const string Hosting_BuildProviderMutualExclusiveAttributes = "Hosting_BuildProviderMutualExclusiveAttributes";
        internal const string Hosting_BuildProviderRequiredAttributesMissing = "Hosting_BuildProviderRequiredAttributesMissing";
        internal const string Hosting_BuildProviderUnknownAttribute = "Hosting_BuildProviderUnknownAttribute";
        internal const string Hosting_BuildProviderUnknownDirective = "Hosting_BuildProviderUnknownDirective";
        internal const string Hosting_CompatibilityServiceNotHosted = "Hosting_CompatibilityServiceNotHosted";
        internal const string Hosting_CompilationResultEmpty = "Hosting_CompilationResultEmpty";
        internal const string Hosting_CompilationResultInvalid = "Hosting_CompilationResultInvalid";
        internal const string Hosting_EnvironmentShuttingDown = "Hosting_EnvironmentShuttingDown";
        internal const string Hosting_ExtendedProtectionDotlessSpnNotEnabled = "Hosting_ExtendedProtectionDotlessSpnNotEnabled";
        internal const string Hosting_ExtendedProtectionFlagsNotSupport = "Hosting_ExtendedProtectionFlagsNotSupport";
        internal const string Hosting_ExtendedProtectionPoliciesMustMatch2 = "Hosting_ExtendedProtectionPoliciesMustMatch2";
        internal const string Hosting_ExtendedProtectionSpnFormatError = "Hosting_ExtendedProtectionSpnFormatError";
        internal const string Hosting_ExtendedProtectionSPNListNotSubset = "Hosting_ExtendedProtectionSPNListNotSubset";
        internal const string Hosting_GetGlobalMemoryFailed = "Hosting_GetGlobalMemoryFailed";
        internal const string Hosting_ImpersonationFailed = "Hosting_ImpersonationFailed";
        internal const string Hosting_IServiceHostNotImplemented = "Hosting_IServiceHostNotImplemented";
        internal const string Hosting_ListenerNotFoundForActivation = "Hosting_ListenerNotFoundForActivation";
        internal const string Hosting_ListenerNotFoundForActivationInRecycling = "Hosting_ListenerNotFoundForActivationInRecycling";
        internal const string Hosting_MemoryGatesCheckFailed = "Hosting_MemoryGatesCheckFailed";
        internal const string Hosting_MemoryGatesCheckFailedUnderPartialTrust = "Hosting_MemoryGatesCheckFailedUnderPartialTrust";
        internal const string Hosting_MetabaseAccessError = "Hosting_MetabaseAccessError";
        internal const string Hosting_MetabaseDataStringsTerminate = "Hosting_MetabaseDataStringsTerminate";
        internal const string Hosting_MetabaseDataTypeUnsupported = "Hosting_MetabaseDataTypeUnsupported";
        internal const string Hosting_MetabaseSettingsIis7TypeNotFound = "Hosting_MetabaseSettingsIis7TypeNotFound";
        ...
        internal const string Hosting_NoDefaultCtor = "Hosting_NoDefaultCtor";
        internal const string Hosting_NoHttpTransportManagerForUri = "Hosting_NoHttpTransportManagerForUri";
        internal const string Hosting_NonHTTPInCompatibilityMode = "Hosting_NonHTTPInCompatibilityMode";
        internal const string Hosting_NoTcpPipeTransportManagerForUri = "Hosting_NoTcpPipeTransportManagerForUri";
        internal const string Hosting_NotSupportedAuthScheme = "Hosting_NotSupportedAuthScheme";
        ...
        internal const string Hosting_ProtocolNoConfiguration = "Hosting_ProtocolNoConfiguration";
        internal const string Hosting_ServiceActivationFailed = "Hosting_ServiceActivationFailed";
        internal const string Hosting_ServiceCannotBeActivated = "Hosting_ServiceCannotBeActivated";
        internal const string Hosting_ServiceCompatibilityNotAllowed = "Hosting_ServiceCompatibilityNotAllowed";
        internal const string Hosting_ServiceCompatibilityRequire = "Hosting_ServiceCompatibilityRequire";
        internal const string Hosting_ServiceHostBaseIsNull = "Hosting_ServiceHostBaseIsNull";
        internal const string Hosting_ServiceNotExist = "Hosting_ServiceNotExist";
        internal const string Hosting_ServiceTypeNotProvided = "Hosting_ServiceTypeNotProvided";
        internal const string Hosting_ServiceTypeNotResolved = "Hosting_ServiceTypeNotResolved";
        internal const string Hosting_SslSettingsMisconfigured = "Hosting_SslSettingsMisconfigured";
        internal const string Hosting_TransportBindingNotFound = "Hosting_TransportBindingNotFound";
        internal const string Hosting_UnrecognizedTokenCheckingValue = "Hosting_UnrecognizedTokenCheckingValue";
        ...
        internal const string HttpConcurrentReceiveQuotaReached = "HttpConcurrentReceiveQuotaReached";
        ...
        internal const string InvalidLockOperation = "InvalidLockOperation";
        internal const string InvalidLockOperationStack = "InvalidLockOperationStack";
        ...
        internal const string PartialTrustNonHttpActivation = "PartialTrustNonHttpActivation";
        ...
        internal const string SFxTransactionAutoEnlistOrAutoComplete2 = "SFxTransactionAutoEnlistOrAutoComplete2";
        ...
        internal const string SFxWrongType2 = "SFxWrongType2";
        ...
        internal const string SslClientCertMustHavePrivateKey = "SslClientCertMustHavePrivateKey";
        internal const string SslServerCertMustDoKeyExchange = "SslServerCertMustDoKeyExchange";
        ...
        internal const string ThreadAcquisitionTimedOut = "ThreadAcquisitionTimedOut";
        internal const string ThreadNeutralSemaphoreAborted = "ThreadNeutralSemaphoreAborted";
        internal const string ThreadNeutralSemaphoreAsyncAbort = "ThreadNeutralSemaphoreAsyncAbort";
        internal const string TimeoutInputQueueDequeue1 = "TimeoutInputQueueDequeue1";
        ...
        internal const string TraceCodeWebHostCompilation = "TraceCodeWebHostCompilation";
        internal const string TraceCodeWebHostDebugRequest = "TraceCodeWebHostDebugRequest";
        ...
        internal const string TraceCodeWebHostNoCBTSupport = "TraceCodeWebHostNoCBTSupport";
        internal const string TraceCodeWebHostProtocolMisconfigured = "TraceCodeWebHostProtocolMisconfigured";
        internal const string TraceCodeWebHostServiceActivated = "TraceCodeWebHostServiceActivated";
        internal const string TraceCodeWebHostServiceCloseFailed = "TraceCodeWebHostServiceCloseFailed";
        ...
        internal const string TrustApr2004DoesNotSupportCertainIssuedTokens = "TrustApr2004DoesNotSupportCertainIssuedTokens";
