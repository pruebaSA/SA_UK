namespace System.ServiceModel.Activation
{
    ...
    internal class MetabaseSettingsIis6 : MetabaseSettingsIis
    {
        ...
        [SecurityTreatAsSafe, SecurityCritical, RegistryPermission(SecurityAction.Assert, Read=@"HKEY_LOCAL_MACHINE\System\CurrentControlSet\Services\W3SVC\Parameters\ExtendedProtection")]
        private ExtendedProtectionPolicy GetExtendedProtectionPolicy()
        {
            using (RegistryKey key = Registry.LocalMachine.OpenSubKey(@"System\CurrentControlSet\Services\W3SVC\Parameters\ExtendedProtection"))
            {
                ...
                {
                    TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.WebHostNoCBTSupport, null, this, null);
                }
            }
            return null;
        }
