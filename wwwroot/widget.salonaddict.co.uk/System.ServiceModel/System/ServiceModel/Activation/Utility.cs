namespace System.ServiceModel.Activation
{
    ...
    internal static class Utility
    {
        ...
        private static void EditKernelObjectSecurity(SafeCloseHandle kernelObject, List<SecurityIdentifier> accounts, SecurityIdentifier account, int right, bool add)
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new Win32Exception());
            }
        ...
        internal static int GetPidForService(string serviceName) => 
            GetStatusForService(serviceName).dwProcessId;
        ...
        internal static unsafe void KeepOnlyPrivilegeInProcess(string privilege)
        {
            ...
            try
            {
                ...
                try
                {
                    System.ServiceModel.ComIntegration.LUID luid;
                    ...
                    try
                    {
                        fixed (byte* numRef = tokenInformation)
                        {
                            ...
                            System.ServiceModel.ComIntegration.LUID_AND_ATTRIBUTES* luid_and_attributesPtr = &newState->Privileges;
                            int index = 0;
                            ...
                            if (!flag || (num5 != 0))
                            {
                                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new Win32Exception(num5));
                            }
                        }
                    }
                    finally
