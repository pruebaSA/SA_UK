namespace System.ServiceModel.Activation
{
    ...
    internal static class ListenerUnsafeNativeMethods
    {
        ...
        internal static extern int CorBindToRuntimeEx(IntPtr pwszVersion, IntPtr pwszBuildFlavor, int flags, [In] ref Guid rclsid, [In] ref Guid riid, [MarshalAs(UnmanagedType.Interface)] out ICorRuntimeHost host);
        ...
        [DllImport("advapi32.dll", CharSet=CharSet.Unicode, SetLastError=true)]
        internal static extern unsafe bool LookupPrivilegeValue(IntPtr lpSystemName, string lpName, System.ServiceModel.ComIntegration.LUID* lpLuid);
        [DllImport("kernel32.dll", SetLastError=true, ExactSpelling=true)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("CB2F6722-AB3A-11D2-9C40-00C04FA30A3E"), ComConversionLoss]
        ...
        internal struct TOKEN_PRIVILEGES
        {
            ...
            internal System.ServiceModel.ComIntegration.LUID_AND_ATTRIBUTES Privileges;
        }
