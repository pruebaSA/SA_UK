namespace System.ServiceModel.Activation.Configuration
{
    ...
    public sealed class SecurityIdentifierElement : ConfigurationElement
    {
            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("securityIdentifier", typeof(System.Security.Principal.SecurityIdentifier), null, new SecurityIdentifierConverter(), null, ConfigurationPropertyOptions.IsKey)
                    };
        ...
        {
            get => 
                ((System.Security.Principal.SecurityIdentifier) base["securityIdentifier"]);
            set
            {
