namespace System.ServiceModel.Administration
{
    ...
    internal class WbemProvider : WbemNative.IWbemProviderInit, WbemNative.IWbemServices
    {
        ...
        private void RegisterWbemProvider(object state)
        {
            ...
            if (num != 0)
            {
                DiagnosticUtility.EventLog.LogEvent(TraceEventType.Error, EventLogCategory.Wmi, (EventLogEventId) (-1073610734), new string[] { DiagnosticTrace.CreateSourceString(this), num.ToString("x", CultureInfo.InvariantCulture) });
        ...
        int WbemNative.IWbemServices.GetObjectAsync(string objectPath, int flags, WbemNative.IWbemContext wbemContext, WbemNative.IWbemObjectSink wbemSink)
        {
            ...
            using (DiagnosticUtility.ShouldUseActivity ? ServiceModelActivity.CreateActivity(true, System.ServiceModel.SR.GetString("WmiGetObject", new object[] { string.IsNullOrEmpty(objectPath) ? string.Empty : objectPath }), ActivityType.WmiGetObject) : null)
            {
                ...
                {
                    DiagnosticUtility.EventLog.LogEvent(TraceEventType.Error, EventLogCategory.Wmi, (EventLogEventId) (-1073610740), new string[] { DiagnosticTrace.CreateSourceString(this), exception.ToString() });
                    wbemSink.SetStatus(0, exception.ErrorCode, null, null);
                    return exception.ErrorCode;
                }
                catch (Exception exception2)
                {
                    DiagnosticUtility.EventLog.LogEvent(TraceEventType.Error, EventLogCategory.Wmi, (EventLogEventId) (-1073610740), new string[] { DiagnosticTrace.CreateSourceString(this), exception2.ToString() });
                    wbemSink.SetStatus(0, -2147217407, null, null);
                    return -2147217407;
                }
                finally
        ...
        int WbemNative.IWbemServices.PutInstanceAsync(WbemNative.IWbemClassObject wbemObject, int lFlags, WbemNative.IWbemContext wbemContext, WbemNative.IWbemObjectSink wbemSink)
        {
            ...
            using (ServiceModelActivity activity = DiagnosticUtility.ShouldUseActivity ? ServiceModelActivity.CreateBoundedActivity() : null)
            {
                ...
                {
                    DiagnosticUtility.EventLog.LogEvent(TraceEventType.Error, EventLogCategory.Wmi, (EventLogEventId) (-1073610739), new string[] { DiagnosticTrace.CreateSourceString(this), exception.ToString() });
                    wbemSink.SetStatus(0, exception.ErrorCode, null, null);
                    return exception.ErrorCode;
                }
                catch (Exception exception2)
                {
                    DiagnosticUtility.EventLog.LogEvent(TraceEventType.Error, EventLogCategory.Wmi, (EventLogEventId) (-1073610739), new string[] { DiagnosticTrace.CreateSourceString(this), exception2.ToString() });
                    wbemSink.SetStatus(0, -2147217407, null, null);
                    return -2147217407;
                }
                finally
        ...
        private void UnRegisterWbemProvider(object state)
        {
            if (this.wbemRegistrar != null)
            {
                ...
                if (num != 0)
                {
                    DiagnosticUtility.EventLog.LogEvent(TraceEventType.Error, EventLogCategory.Wmi, (EventLogEventId) (-1073610733), new string[] { DiagnosticTrace.CreateSourceString(this), num.ToString("x", CultureInfo.InvariantCulture) });
                }
                this.wbemRegistrar = null;
            }
        }
        ...
        private class InstanceContext : IWmiInstance
        {
            ...
            object IWmiInstance.GetProperty(string name) => 
                this.wbemInstance.GetProperty(name);

            IWmiInstance IWmiInstance.NewInstance(string className) => 
                new WbemProvider.InstanceContext(new WbemProvider.WbemInstance(this.wbemInstance, className));
        ...
        private class InstancesContext : IWmiInstances
        {
            ...
            IWmiInstance IWmiInstances.NewInstance(string className) => 
                new WbemProvider.InstanceContext(new WbemProvider.WbemInstance(this.parms, className));
        }
