namespace System.ServiceModel
{
    ...
    internal class ServiceChannelManager : LifetimeManager
    {
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.BeginCloseInput), new ChainedEndHandler(this.EndCloseInput), new ChainedBeginHandler(this.OnBeginCloseContinue), new ChainedEndHandler(this.OnEndCloseContinue));
        ...
        private class ChannelCollection : SynchronizedCollection<IChannel>
        {
            private ServiceChannelManager channelManager;

            public ChannelCollection(ServiceChannelManager channelManager, object mutex) : base(mutex)
            {
            ...
            protected override void ClearItems()
            {
                lock (base.SyncRoot)
                {
                    foreach (IChannel channel in base.Items)
                    {
            ...
            protected override void RemoveItem(int index)
            {
                lock (base.SyncRoot)
                {
                    IChannel channel = base.Items[index];
