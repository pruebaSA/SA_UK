namespace System.ServiceModel.Channels
{
    ...
    internal class ClientReliableSession : ChannelReliableSession, IOutputSession, ISession
    {
        ...
        {
            private static AsyncCallback onRequestComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ClientReliableSession.OpenAsyncResult.OnRequestCompleteStatic));
