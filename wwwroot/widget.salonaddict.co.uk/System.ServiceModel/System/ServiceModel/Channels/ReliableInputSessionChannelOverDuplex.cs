namespace System.ServiceModel.Channels
{
    ...
    internal sealed class ReliableInputSessionChannelOverDuplex : ReliableInputSessionChannel
    {
        ...
        public ReliableInputSessionChannelOverDuplex(ReliableChannelListenerBase<IInputSessionChannel> listener, IServerReliableChannelBinder binder, FaultHelper faultHelper, UniqueId inputID) : base(listener, binder, faultHelper, inputID)
        {
            ...
            base.DeliveryStrategy.DequeueCallback = new ItemDequeuedCallback(this.OnDeliveryStrategyItemDequeued);
        ...
        protected override IAsyncResult BeginCloseGuards(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.guard.BeginClose(timeout, callback, state);
        ...
        private void ProcessMessage(WsrmMessageInfo info)
        {
            ...
            try
            {
                ...
                if (flag6 && (info.TerminateSequenceInfo != null))
                {
                    ...
                    lock (base.ThisLock)
                    {
                        flag9 = !base.Connection.Terminate();
                    }
                    if (flag9)
                    {
                ...
                {
                    bool flag10 = info.TerminateSequenceInfo != null;
                    WsrmRequestInfo info2 = flag10 ? ((WsrmRequestInfo) info.TerminateSequenceInfo) : ((WsrmRequestInfo) info.CloseSequenceInfo);
                    long last = flag10 ? info.TerminateSequenceInfo.LastMsgNumber : info.CloseSequenceInfo.LastMsgNumber;
                    ...
                    lock (base.ThisLock)
                    {
                        ...
                        {
                            flag12 = last == base.Connection.Last;
                            if ((flag10 && flag12) && base.Connection.IsSequenceClosed)
                            {
                                flag5 = true;
                            }
                        }
                    ...
                    {
                        message2 = flag10 ? WsrmUtilities.CreateTerminateResponseMessage(base.Listener.MessageVersion, info2.MessageId, base.ReliableSession.InputID) : WsrmUtilities.CreateCloseSequenceResponse(base.Listener.MessageVersion, info2.MessageId, base.ReliableSession.InputID);
                        flag4 = true;
                    }
                }
            Label_0628:
