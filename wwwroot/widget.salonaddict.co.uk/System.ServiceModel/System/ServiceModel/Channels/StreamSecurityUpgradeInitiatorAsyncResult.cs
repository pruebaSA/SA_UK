namespace System.ServiceModel.Channels
{
    ...
    {
        private static AsyncCallback onAuthenticateAsClient = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamSecurityUpgradeInitiatorAsyncResult.OnAuthenticateAsClient));
