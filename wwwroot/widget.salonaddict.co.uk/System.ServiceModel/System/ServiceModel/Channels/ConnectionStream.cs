namespace System.ServiceModel.Channels
{
    ...
    internal class ConnectionStream : Stream
    {
        ...
        public override IAsyncResult BeginRead(byte[] buffer, int offset, int count, AsyncCallback callback, object state) => 
            new ReadAsyncResult(this.connection, buffer, offset, count, TimeoutHelper.FromMilliseconds(this.ReadTimeout), callback, state);

        public override IAsyncResult BeginWrite(byte[] buffer, int offset, int count, AsyncCallback callback, object state) => 
            this.connection.BeginWrite(buffer, offset, count, this.Immediate, TimeoutHelper.FromMilliseconds(this.WriteTimeout), callback, state);
        ...
        public override int EndRead(IAsyncResult asyncResult) => 
            ReadAsyncResult.End(asyncResult);
        ...
        public override int Read(byte[] buffer, int offset, int count) => 
            this.Read(buffer, offset, count, TimeoutHelper.FromMilliseconds(this.ReadTimeout));

        protected int Read(byte[] buffer, int offset, int count, TimeSpan timeout) => 
            this.connection.Read(buffer, offset, count, timeout);
        ...
        private class ReadAsyncResult : AsyncResult
        {
            ...
            public static int End(IAsyncResult result) => 
                AsyncResult.End<ConnectionStream.ReadAsyncResult>(result).bytesRead;
