    ...
    internal sealed class CreateSequence : BodyWriter
    {
        ...
        public static CreateSequenceInfo Create(MessageVersion messageVersion, ReliableMessagingVersion reliableMessagingVersion, ISecureConversationSession securitySession, XmlDictionaryReader reader)
        {
            ...
            try
            {
                ...
                {
                    case "DiscardEntireSequence":
                    case "DiscardFollowingFirstGap":
                    case "NoDiscard":
                        goto Label_01A9;

                    default:
                    {
                        string str4 = System.ServiceModel.SR.GetString("CSRefusedInvalidIncompleteSequenceBehavior");
                        Message message2 = WsrmUtilities.CreateCSRefusedProtocolFault(messageVersion, reliableMessagingVersion, str4);
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(WsrmMessageInfo.CreateInternalFaultException(message2, str4, new ProtocolException(str4)));
                    }
                }
            Label_01A3:
                reader.Skip();
            ...
            Label_01B7:
                ...
                string reason = System.ServiceModel.SR.GetString("CSRefusedRequiredSecurityElementMissing");
