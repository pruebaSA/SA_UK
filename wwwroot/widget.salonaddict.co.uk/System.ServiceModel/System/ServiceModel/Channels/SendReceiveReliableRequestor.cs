namespace System.ServiceModel.Channels
{
    ...
    internal sealed class SendReceiveReliableRequestor : ReliableRequestor
    {
        ...
        protected override IAsyncResult OnBeginRequest(Message request, TimeSpan timeout, AsyncCallback callback, object state) => 
            new SendReceiveAsyncResult(this, request, timeout, callback, state);

        protected override Message OnEndRequest(bool last, IAsyncResult result) => 
            SendReceiveAsyncResult.End(result);
        ...
        private class SendReceiveAsyncResult : AsyncResult
        {
            ...
            private static AsyncCallback sendCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SendReceiveReliableRequestor.SendReceiveAsyncResult.SendCallback));
            private TimeoutHelper timeoutHelper;
            private static AsyncCallback tryReceiveCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(SendReceiveReliableRequestor.SendReceiveAsyncResult.TryReceiveCallback));
            ...
            public static Message End(IAsyncResult result) => 
                AsyncResult.End<SendReceiveReliableRequestor.SendReceiveAsyncResult>(result).response;
            ...
            private bool EndTryReceive(IAsyncResult result)
            {
                ...
                this.response = context?.RequestMessage;
                return true;
            }
