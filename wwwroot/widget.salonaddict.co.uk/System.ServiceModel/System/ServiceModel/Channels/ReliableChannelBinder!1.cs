namespace System.ServiceModel.Channels
{
    ...
    internal abstract class ReliableChannelBinder<TChannel> : IReliableChannelBinder where TChannel: class, IChannel
    {
        ...
        public IAsyncResult BeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.BeginClose(timeout, this.defaultMaskingMode, callback, state);
        ...
        public IAsyncResult BeginSend(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
            this.BeginSend(message, timeout, this.defaultMaskingMode, callback, state);
        ...
        public virtual IAsyncResult BeginTryReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.BeginTryReceive(timeout, this.defaultMaskingMode, callback, state);
        ...
        internal IAsyncResult BeginWaitForPendingOperations(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.synchronizer.BeginWaitForPendingOperations(timeout, callback, state);
        ...
        private void CloseChannel(TChannel channel)
        {
            ...
            {
                this.onCloseChannelComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnCloseChannelComplete));
            }
            try
            {
        ...
        protected bool HandleException(Exception e, MaskingMode maskingMode, bool autoAborted) => 
            (((this.TolerateFaults && autoAborted) && (e is CommunicationObjectAbortedException)) || this.HandleException(e, maskingMode));
        ...
        public virtual bool TryReceive(TimeSpan timeout, out RequestContext requestContext) => 
            this.TryReceive(timeout, out requestContext, this.defaultMaskingMode);
        ...
        protected class ChannelSynchronizer
        {
            ...
            private static WaitCallback asyncGetChannelCallback;
            private ReliableChannelBinder<TChannel> binder;
            private int count;
            ...
            {
                ReliableChannelBinder<TChannel>.ChannelSynchronizer.asyncGetChannelCallback = new WaitCallback(ReliableChannelBinder<TChannel>.ChannelSynchronizer.AsyncGetChannelCallback);
            }
            ...
            private IAsyncResult BeginTryGetChannel(bool canGetChannel, bool canCauseFault, TimeSpan timeout, MaskingMode maskingMode, AsyncCallback callback, object state)
            {
                ...
                if (item == null)
                {
                    return new TypedCompletedAsyncResult<TChannel>(data, callback, state);
                }
                if (flag)
                {
            ...
            public IAsyncResult BeginTryGetChannelForInput(bool canGetChannel, TimeSpan timeout, AsyncCallback callback, object state) => 
                this.BeginTryGetChannel(canGetChannel, false, timeout, MaskingMode.All, callback, state);
            ...
            public IAsyncResult BeginTryGetChannelForOutput(TimeSpan timeout, MaskingMode maskingMode, AsyncCallback callback, object state) => 
                this.BeginTryGetChannel(true, true, timeout, maskingMode, callback, state);
            ...
            public bool EndTryGetChannel(IAsyncResult result, out TChannel channel)
            {
                ...
                channel = TypedCompletedAsyncResult<TChannel>.End(result);
                return true;
            }
            ...
            private void OnGetChannelFailed()
            {
                ...
                {
                    IOThreadScheduler.ScheduleCallback(ReliableChannelBinder<TChannel>.ChannelSynchronizer.asyncGetChannelCallback, state);
                }
            }
            ...
            public bool TryGetChannelForInput(bool canGetChannel, TimeSpan timeout, out TChannel channel) => 
                this.TryGetChannel(canGetChannel, false, timeout, MaskingMode.All, out channel);

            public bool TryGetChannelForOutput(TimeSpan timeout, MaskingMode maskingMode, out TChannel channel) => 
                this.TryGetChannel(true, true, timeout, maskingMode, out channel);
            ...
            public sealed class AsyncWaiter : AsyncResult, ReliableChannelBinder<TChannel>.ChannelSynchronizer.IWaiter
            {
                ...
                private static WaitCallback onTimeoutElapsed;
                ...
                static AsyncWaiter()
                {
                    ReliableChannelBinder<TChannel>.ChannelSynchronizer.AsyncWaiter.onOpenComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.ChannelSynchronizer.AsyncWaiter.OnOpenComplete));
                    ReliableChannelBinder<TChannel>.ChannelSynchronizer.AsyncWaiter.onTimeoutElapsed = new WaitCallback(ReliableChannelBinder<TChannel>.ChannelSynchronizer.AsyncWaiter.OnTimeoutElapsed);
                    ReliableChannelBinder<TChannel>.ChannelSynchronizer.AsyncWaiter.onTryGetChannelComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.ChannelSynchronizer.AsyncWaiter.OnTryGetChannelComplete));
                }
            ...
            private sealed class SyncWaiter : ReliableChannelBinder<TChannel>.ChannelSynchronizer.IWaiter
            {
                ...
                private bool Wait()
                {
                    if (!TimeoutHelper.WaitOne(this.completeEvent, this.timeoutHelper.RemainingTime(), false))
                    {
                        if (this.synchronizer.RemoveWaiter(this))
                        {
                            return false;
                        }
                        TimeoutHelper.WaitOne(this.completeEvent, TimeSpan.MaxValue, false);
                    }
                    return true;
                }
        ...
        private sealed class CloseAsyncResult : AsyncResult
        {
            ...
            {
                ReliableChannelBinder<TChannel>.CloseAsyncResult.onBinderCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.CloseAsyncResult.OnBinderCloseComplete));
                ReliableChannelBinder<TChannel>.CloseAsyncResult.onChannelCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.CloseAsyncResult.OnChannelCloseComplete));
            }
        ...
        protected abstract class InputAsyncResult<TBinder> : AsyncResult where TBinder: ReliableChannelBinder<TChannel>
        {
            ...
            {
                ReliableChannelBinder<TChannel>.InputAsyncResult<TBinder>.onInputComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.InputAsyncResult<TBinder>.OnInputCompleteStatic));
                ReliableChannelBinder<TChannel>.InputAsyncResult<TBinder>.onTryGetChannelComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.InputAsyncResult<TBinder>.OnTryGetChannelCompleteStatic));
            }
        ...
        private sealed class MessageRequestContext : ReliableChannelBinder<TChannel>.BinderRequestContext
        {
            ...
            protected override IAsyncResult OnBeginReply(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
                new ReplyAsyncResult<TChannel>((ReliableChannelBinder<TChannel>.MessageRequestContext) this, message, timeout, callback, state);
            ...
            private class ReplyAsyncResult : AsyncResult
            {
                ...
                public ReplyAsyncResult(ReliableChannelBinder<TChannel>.MessageRequestContext context, Message message, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
                {
                    if (message != null)
                    {
                        ...
                        {
                            ReliableChannelBinder<TChannel>.MessageRequestContext.ReplyAsyncResult.onSend = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.MessageRequestContext.ReplyAsyncResult.OnSend));
                        }
        ...
        protected abstract class OutputAsyncResult<TBinder> : AsyncResult where TBinder: ReliableChannelBinder<TChannel>
        {
            ...
            {
                ReliableChannelBinder<TChannel>.OutputAsyncResult<TBinder>.onTryGetChannelComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.OutputAsyncResult<TBinder>.OnTryGetChannelCompleteStatic));
                ReliableChannelBinder<TChannel>.OutputAsyncResult<TBinder>.onOutputComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinder<TChannel>.OutputAsyncResult<TBinder>.OnOutputCompleteStatic));
            }
        ...
        private sealed class SendAsyncResult : ReliableChannelBinder<TChannel>.OutputAsyncResult<ReliableChannelBinder<TChannel>>
        {
            ...
            protected override string GetTimeoutString(TimeSpan timeout) => 
                System.ServiceModel.SR.GetString("TimeoutOnSend", new object[] { timeout });
        }
        ...
        private sealed class TryReceiveAsyncResult : ReliableChannelBinder<TChannel>.InputAsyncResult<ReliableChannelBinder<TChannel>>
        {
            ...
            protected override IAsyncResult BeginInput(ReliableChannelBinder<TChannel> binder, TChannel channel, TimeSpan timeout, AsyncCallback callback, object state) => 
                binder.OnBeginTryReceive(channel, timeout, callback, state);
