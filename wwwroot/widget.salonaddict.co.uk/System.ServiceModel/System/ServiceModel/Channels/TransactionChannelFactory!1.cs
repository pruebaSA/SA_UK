namespace System.ServiceModel.Channels
{
    ...
    internal sealed class TransactionChannelFactory<TChannel> : LayeredChannelFactory<TChannel>, ITransactionChannelManager
    {
        ...
        public TransactionChannelFactory(System.ServiceModel.TransactionProtocol transactionProtocol, BindingContext context, Dictionary<DirectionalAction, TransactionFlowOption> dictionary) : base(context.Binding, context.BuildInnerChannelFactory<TChannel>())
        {
