namespace System.ServiceModel.Channels
{
    ...
    {
        private WaitCallback asyncHandleReceiveComplete;
        ...
        {
            this.asyncHandleReceiveComplete = new WaitCallback(this.AsyncHandleReceiveComplete);
            this.onTryReceiveComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnTryReceiveComplete));
        ...
        protected override IAsyncResult BeginCloseInnerListener(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.BeginCloseInnerListener), new ChainedEndHandler(this.EndCloseInnerListener), new ChainedBeginHandler(this.channelTracker.BeginClose), new ChainedEndHandler(this.channelTracker.EndClose));
        ...
        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.channelTracker.BeginOpen), new ChainedEndHandler(this.channelTracker.EndOpen), new ChainedBeginHandler(this.OnBeginOpen), new ChainedEndHandler(this.OnEndOpen));
        ...
        private void StartReceiving(TInnerChannel channel, bool canBlock)
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    if (!canBlock)
                    {
                        IOThreadScheduler.ScheduleCallback(this.asyncHandleReceiveComplete, state);
                        break;
                    }
