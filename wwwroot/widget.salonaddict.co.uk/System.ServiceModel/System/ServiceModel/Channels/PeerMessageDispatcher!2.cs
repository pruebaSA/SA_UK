namespace System.ServiceModel.Channels
{
    ...
    internal class PeerMessageDispatcher<ChannelInterfaceType, TChannel> : CommunicationObject where ChannelInterfaceType: class, IChannel where TChannel: InputQueueChannel<Message>
    {
        ...
        public void OnMessageAvailable(Message message)
        {
            ...
            this.queueHandler.EnqueueAndDispatch(message, new ItemDequeuedCallback(this.quotaHelper.ItemDequeued));
        }
        ...
        protected override TimeSpan DefaultCloseTimeout =>
            this.channelManager.InternalCloseTimeout;

        protected override TimeSpan DefaultOpenTimeout =>
            this.channelManager.InternalOpenTimeout;
        ...
        public class PeerMessageQueueAdapter
        {
            ...
            public void EnqueueAndDispatch(Message message, ItemDequeuedCallback callback)
            {
