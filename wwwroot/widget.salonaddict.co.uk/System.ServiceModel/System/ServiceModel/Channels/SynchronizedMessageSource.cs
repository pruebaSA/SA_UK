namespace System.ServiceModel.Channels
{
    ...
    internal class SynchronizedMessageSource
    {
        ...
        public IAsyncResult BeginWaitForMessage(TimeSpan timeout, AsyncCallback callback, object state) => 
            new WaitForMessageAsyncResult(this, timeout, callback, state);

        public Message EndReceive(IAsyncResult result) => 
            SynchronizedAsyncResult<Message>.End(result);

        public bool EndWaitForMessage(IAsyncResult result) => 
            SynchronizedAsyncResult<bool>.End(result);
        ...
        private abstract class SynchronizedAsyncResult<T> : AsyncResult
        {
            ...
            private static WaitCallback onEnterComplete;
            ...
            {
                SynchronizedMessageSource.SynchronizedAsyncResult<T>.onEnterComplete = new WaitCallback(SynchronizedMessageSource.SynchronizedAsyncResult<T>.OnEnterComplete);
            }
            ...
            public SynchronizedAsyncResult(SynchronizedMessageSource syncSource, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
            {
                ...
                if (syncSource.sourceLock.Enter(SynchronizedMessageSource.SynchronizedAsyncResult<T>.onEnterComplete, this))
                {
                    bool flag2;
                    this.exitLock = true;
                    bool flag = false;
            ...
            public static T End(IAsyncResult result) => 
                AsyncResult.End<SynchronizedMessageSource.SynchronizedAsyncResult<T>>(result).returnValue;
