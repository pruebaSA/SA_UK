namespace System.ServiceModel.Channels
{
    ...
    internal sealed class ReliableOutputConnection
    {
        ...
        private static AsyncCallback onSendRetriesComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableOutputConnection.OnSendRetriesComplete));
        private static AsyncCallback onSendRetryComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableOutputConnection.OnSendRetryComplete));
        ...
        private static WaitCallback sendRetries = new WaitCallback(ReliableOutputConnection.SendRetries);
        ...
        public bool AddMessage(Message message, TimeSpan timeout, object state) => 
            this.InternalAddMessage(message, timeout, state, false);
        ...
        public IAsyncResult BeginAddMessage(Message message, TimeSpan timeout, object state, AsyncCallback callback, object asyncState) => 
            new AddAsyncResult(message, false, timeout, state, this, callback, asyncState);
        ...
        public bool CheckForTermination() => 
            this.strategy.DoneTransmitting;
        ...
        public bool IsFinalAckConsistent(SequenceRangeCollection ranges) => 
            this.strategy.IsFinalAckConsistent(ranges);
        ...
        {
            private static AsyncCallback addCompleteStatic = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableOutputConnection.AddAsyncResult.AddComplete));
            private ReliableOutputConnection connection;
            private bool isLast;
            private static AsyncCallback sendCompleteStatic = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableOutputConnection.AddAsyncResult.SendComplete));
