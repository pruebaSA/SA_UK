namespace System.ServiceModel.Channels
{
    ...
    internal class DatagramAdapter
    {
        internal static IChannelListener<IInputChannel> GetInputListener(IChannelListener<IInputSessionChannel> inner, ServiceThrottle throttle, IDefaultCommunicationTimeouts timeouts) => 
            new InputDatagramAdapterListener(inner, throttle, timeouts);
        ...
        internal static IOutputChannel GetOutputChannel(Source<IOutputSessionChannel> channelSource, IDefaultCommunicationTimeouts timeouts) => 
            new OutputDatagramAdapterChannel(channelSource, timeouts);
        ...
        internal static IChannelListener<IReplyChannel> GetReplyListener(IChannelListener<IReplySessionChannel> inner, ServiceThrottle throttle, IDefaultCommunicationTimeouts timeouts) => 
            new ReplyDatagramAdapterListener(inner, throttle, timeouts);
        ...
        internal static IRequestChannel GetRequestChannel(Source<IRequestSessionChannel> channelSource, IDefaultCommunicationTimeouts timeouts) => 
            new RequestDatagramAdapterChannel(channelSource, timeouts);
        ...
        private abstract class DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType> : DelegatingChannelListener<TChannel>, ISessionThrottleNotification where TChannel: class, IChannel where TSessionChannel: class, IChannel where ItemType: class
        {
            ...
            private ItemDequeuedCallback channelPumpAfterExceptionDelegate;
            private static WaitCallback channelPumpDelegate;
            ...
            {
                DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.acceptCallbackDelegate = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.AcceptCallbackStatic));
                DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.channelPumpDelegate = new WaitCallback(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.ChannelPump);
            }
            ...
            protected DatagramAdapterListenerBase(IChannelListener<TSessionChannel> listener, ServiceThrottle throttle, IDefaultCommunicationTimeouts timeouts) : base(timeouts, listener)
            {
                ...
                this.channelPumpAfterExceptionDelegate = new ItemDequeuedCallback(this.ChannelPump);
            }
            ...
            protected abstract void Enqueue(ItemType item, ItemDequeuedCallback callback);
            protected abstract void Enqueue(Exception exception, ItemDequeuedCallback callback);
            ...
            protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginClose), new ChainedEndHandler(this.OnEndClose), new ChainedBeginHandler(this.BeginWaitForAcceptLoop), new ChainedEndHandler(this.EndWaitForAcceptLoop));
            ...
            protected override void OnEndOpen(IAsyncResult result)
            {
                ...
                IOThreadScheduler.ScheduleCallback(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.channelPumpDelegate, this);
            }
            ...
            internal class AsyncWaiter : AsyncResult, DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.IWaiter
            {
                ...
                static AsyncWaiter()
                {
                    DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.AsyncWaiter.timerCallback = new WaitCallback(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.AsyncWaiter.TimerCallback);
                }
            ...
            private class DatagramAdapterReceiver
            {
                ...
                private ItemDequeuedCallback itemDequeuedDelegate;
                ...
                private static WaitCallback startNextReceiveDelegate;

                static DatagramAdapterReceiver()
                {
                    DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.DatagramAdapterReceiver.receiveCallbackDelegate = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.DatagramAdapterReceiver.ReceiveCallbackStatic));
                    DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.DatagramAdapterReceiver.startNextReceiveDelegate = new WaitCallback(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.DatagramAdapterReceiver.StartNextReceive);
                }
                ...
                private DatagramAdapterReceiver(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType> parent, TSessionChannel channel)
                {
                    ...
                    this.itemDequeuedDelegate = new ItemDequeuedCallback(this.StartNextReceive);
                    ...
                    catch (Exception exception3)
                    {
                        ...
                        {
                            TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.FailedToOpenIncomingChannel, System.ServiceModel.SR.GetString("TraceCodeFailedToOpenIncomingChannel"));
                        }
                        channel.Abort();
                ...
                internal static void Pump(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType> listener, TSessionChannel channel)
                {
                    ...
                    IOThreadScheduler.ScheduleCallback(DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.DatagramAdapterReceiver.startNextReceiveDelegate, state);
                }
            ...
            internal class SyncWaiter : DatagramAdapter.DatagramAdapterListenerBase<TChannel, TSessionChannel, ItemType>.IWaiter
            {
                ...
                public bool Wait(TimeSpan timeout)
                {
                    ...
                    if ((this.wait == null) || TimeoutHelper.WaitOne(this.wait, timeout, false))
                    {
                        if (this.wait != null)
                        {
                            this.wait.Close();
        ...
        private class InputDatagramAdapterAcceptor : InputChannelAcceptor
        {
            ...
            protected override InputChannel OnCreateChannel() => 
                new DatagramAdapter.InputDatagramAdapterChannel(this.listener);
        }
        ...
        private class InputDatagramAdapterListener : DatagramAdapter.DatagramAdapterListenerBase<IInputChannel, IInputSessionChannel, Message>
        {
            ...
            protected override IAsyncResult CallBeginReceive(IInputSessionChannel channel, AsyncCallback callback, object state) => 
                channel.BeginReceive(TimeSpan.MaxValue, callback, state);

            protected override Message CallEndReceive(IInputSessionChannel channel, IAsyncResult result) => 
                channel.EndReceive(result);

            protected override void Enqueue(Exception exception, ItemDequeuedCallback callback)
            {
                this.acceptor.Enqueue(exception, callback);
            }

            protected override void Enqueue(Message message, ItemDequeuedCallback callback)
            {
        ...
        private class OutputDatagramAdapterChannel : DatagramAdapter.DatagramAdapterChannelBase<IOutputSessionChannel>, IOutputChannel, IChannel, ICommunicationObject
        {
            ...
            public IAsyncResult BeginSend(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
                new SendAsyncResult(this, message, timeout, callback, state);
            ...
            private class SendAsyncResult : AsyncResult
            {
                ...
                public SendAsyncResult(DatagramAdapter.OutputDatagramAdapterChannel adapter, Message message, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
                {
                    ...
                    try
                    {
                        if (innerChannel.State == CommunicationState.Created)
                        {
                            ...
                            innerChannel.BeginOpen(this.timeoutHelper.RemainingTime(), DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnOpenComplete)), innerChannel);
                        }
                        else
                        {
                            innerChannel.BeginSend(message, this.timeoutHelper.RemainingTime(), DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnSendComplete)), innerChannel);
                        }
                    }
                    catch
                    {
                ...
                private void OnOpenComplete(IAsyncResult result)
                {
                    ...
                    try
                    {
                        ...
                        asyncState.BeginSend(this.message, this.timeoutHelper.RemainingTime(), DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnSendComplete)), asyncState);
                    }
                ...
                private void OnSendComplete(IAsyncResult result)
                {
                    ...
                    if (!this.adapter.ReturnChannel(asyncState))
                    {
                        try
                        {
                            asyncState.BeginClose(this.timeoutHelper.RemainingTime(), DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnCloseComplete)), asyncState);
                        }
                        catch (Exception exception2)
                        {
                            if (DiagnosticUtility.IsFatal(exception2))
        ...
        private class ReplyDatagramAdapterAcceptor : ReplyChannelAcceptor
        {
            ...
            protected override ReplyChannel OnCreateChannel() => 
                new DatagramAdapter.ReplyDatagramAdapterChannel(this.listener);
        }
        ...
        private class ReplyDatagramAdapterListener : DatagramAdapter.DatagramAdapterListenerBase<IReplyChannel, IReplySessionChannel, RequestContext>
        {
            ...
            protected override void Enqueue(RequestContext request, ItemDequeuedCallback callback)
            {
        ...
        private class RequestDatagramAdapterChannel : DatagramAdapter.DatagramAdapterChannelBase<IRequestSessionChannel>, IRequestChannel, IChannel, ICommunicationObject
        {
            ...
            public IAsyncResult BeginRequest(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
                new RequestAsyncResult(this, message, timeout, callback, state);

            public Message EndRequest(IAsyncResult result) => 
                RequestAsyncResult.End(result);

            public Message Request(Message request) => 
                this.Request(request, base.DefaultSendTimeout);
            ...
            private class RequestAsyncResult : AsyncResult
            {
                ...
                public RequestAsyncResult(DatagramAdapter.RequestDatagramAdapterChannel adapter, Message message, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
                {
                    ...
                    try
                    {
                        ...
                        {
                            innerChannel.BeginRequest(message, this.timeoutHelper.RemainingTime(), DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnRequestComplete)), innerChannel);
                        }
                    }
                    catch
                    {
                ...
                public static Message End(IAsyncResult result) => 
                    AsyncResult.End<DatagramAdapter.RequestDatagramAdapterChannel.RequestAsyncResult>(result).reply;
                ...
                private void OnOpenComplete(IAsyncResult result)
                {
                    ...
                    {
                        asyncState.EndOpen(result);
                        asyncState.BeginRequest(this.message, this.timeoutHelper.RemainingTime(), DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnRequestComplete)), asyncState);
                    }
                    catch (Exception exception)
                    {
                        if (DiagnosticUtility.IsFatal(exception))
