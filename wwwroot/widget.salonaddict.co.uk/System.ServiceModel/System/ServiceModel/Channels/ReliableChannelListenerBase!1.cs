namespace System.ServiceModel.Channels
{
    ...
    internal abstract class ReliableChannelListenerBase<TChannel> : DelegatingChannelListener<TChannel>, IReliableFactorySettings where TChannel: class, IChannel
    {
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new CloseAsyncResult<TChannel>((ReliableChannelListenerBase<TChannel>) this, new OperationWithTimeoutBeginCallback(this.OnBeginClose), new OperationEndCallback(this.OnEndClose), timeout, callback, state);
        ...
        public IAsyncResult OnReliableChannelBeginClose(UniqueId inputId, UniqueId outputId, TimeSpan timeout, AsyncCallback callback, object state) => 
            new OnReliableChannelCloseAsyncResult<TChannel>((ReliableChannelListenerBase<TChannel>) this, inputId, outputId, timeout, callback, state);
        ...
        private class CloseAsyncResult : AsyncResult
        {
            ...
            {
                ReliableChannelListenerBase<TChannel>.CloseAsyncResult.onBaseChannelListenerCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelListenerBase<TChannel>.CloseAsyncResult.OnBaseChannelListenerCloseCompleteStatic));
                ReliableChannelListenerBase<TChannel>.CloseAsyncResult.onInnerChannelListenerCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelListenerBase<TChannel>.CloseAsyncResult.OnInnerChannelListenerCloseCompleteStatic));
            }
        ...
        private class OnReliableChannelCloseAsyncResult : AsyncResult
        {
            ...
            {
                ReliableChannelListenerBase<TChannel>.OnReliableChannelCloseAsyncResult.onInnerChannelListenerCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelListenerBase<TChannel>.OnReliableChannelCloseAsyncResult.OnInnerChannelListenerCloseCompleteStatic));
            }
