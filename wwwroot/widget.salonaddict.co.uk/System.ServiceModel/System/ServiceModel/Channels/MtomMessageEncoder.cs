namespace System.ServiceModel.Channels
{
    ...
    internal class MtomMessageEncoder : MessageEncoder
    {
        ...
        internal string FormatContentType(string boundary, string startInfo) => 
            string.Format(CultureInfo.InvariantCulture, "{0};start=\"<{1}>\";boundary=\"{2}\";start-info=\"{3}\"", new object[] { "multipart/related; type=\"application/xop+xml\"", "http://tempuri.org/0", boundary, startInfo });
        ...
        internal bool IsMTOMContentType(string contentType) => 
            base.IsContentTypeSupported(contentType, this.ContentType, this.MediaType);
        ...
        public override ArraySegment<byte> WriteMessage(Message message, int maxMessageSize, BufferManager bufferManager, int messageOffset) => 
            this.WriteMessage(message, maxMessageSize, bufferManager, messageOffset, this.GenerateStartInfoString(), null, null, true);
        ...
        internal ArraySegment<byte> WriteMessage(Message message, int maxMessageSize, BufferManager bufferManager, int messageOffset, string boundary) => 
            this.WriteMessage(message, maxMessageSize, bufferManager, messageOffset, this.GenerateStartInfoString(), boundary, "http://tempuri.org/0", false);
