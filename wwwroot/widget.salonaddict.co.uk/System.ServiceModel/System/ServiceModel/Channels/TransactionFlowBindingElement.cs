namespace System.ServiceModel.Channels
{
    ...
    public sealed class TransactionFlowBindingElement : BindingElement, IPolicyExportExtension
    {
        ...
        public override IChannelFactory<TChannel> BuildChannelFactory<TChannel>(BindingContext context)
        {
            ...
            return new TransactionChannelFactory<TChannel>(this.transactionProtocol, context, dictionary) { FlowIssuedTokens = this.IssuedTokens };
        }
        ...
        public override BindingElement Clone() => 
            new TransactionFlowBindingElement(this);
