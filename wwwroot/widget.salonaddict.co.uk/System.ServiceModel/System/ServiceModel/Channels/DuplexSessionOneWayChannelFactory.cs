namespace System.ServiceModel.Channels
{
    ...
    internal class DuplexSessionOneWayChannelFactory : LayeredChannelFactory<IOutputChannel>
    {
        ...
        protected override IOutputChannel OnCreateChannel(EndpointAddress address, Uri via) => 
            new DuplexSessionOutputChannel(this, address, via);
        ...
        private class DuplexSessionOutputChannel : OutputChannel
        {
            ...
            private class SendAsyncResult : AsyncResult
            {
                ...
                private static AsyncCallback onInnerSend = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(DuplexSessionOneWayChannelFactory.DuplexSessionOutputChannel.SendAsyncResult.OnInnerSend));
                ...
                private bool OpenNewChannel()
                {
                    if (onOpen == null)
                    {
                        onOpen = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(DuplexSessionOneWayChannelFactory.DuplexSessionOutputChannel.SendAsyncResult.OnOpen));
                    }
