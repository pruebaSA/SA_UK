namespace System.ServiceModel.Channels
{
    ...
    {
        private static AsyncCallback onReceiveCompleted = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableOutputSessionChannelOverDuplex.OnReceiveCompletedStatic));
        ...
        protected override void OnOpened()
        {
            ...
            {
                IOThreadScheduler.ScheduleCallback(new WaitCallback(ReliableOutputSessionChannelOverDuplex.StartReceiving), this);
            }
        }
