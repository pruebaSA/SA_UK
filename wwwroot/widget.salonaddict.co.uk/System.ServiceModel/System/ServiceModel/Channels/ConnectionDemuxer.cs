namespace System.ServiceModel.Channels
{
    ...
    internal sealed class ConnectionDemuxer : IDisposable
    {
        ...
        private ItemDequeuedCallback pooledConnectionDequeuedCallback;
        private WaitCallback reuseConnectionCallback;
        ...
        private void OnDuplexConnection(IConnection connection, ItemDequeuedCallback connectionDequeuedCallback, long streamPosition, int offset, int size, TimeSpan timeout)
        {
        ...
        private void OnSingletonConnection(IConnection connection, ItemDequeuedCallback connectionDequeuedCallback, long streamPosition, int offset, int size, TimeSpan timeout)
        {
        ...
        public void ReuseConnection(IConnection connection, TimeSpan closeTimeout)
        {
            ...
            if (modeReader != null)
            {
                ...
                {
                    this.reuseConnectionCallback = new WaitCallback(this.ReuseConnectionCallback);
                }
                IOThreadScheduler.ScheduleCallback(this.reuseConnectionCallback, new ReuseConnectionState(modeReader, closeTimeout));
            }
        }
        ...
        private void ReuseConnectionCallback(object state)
        {
            ...
            if (flag)
            {
                ...
                {
                    DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Warning, TraceCode.ServerMaxPooledConnectionsQuotaReached, System.ServiceModel.SR.GetString("TraceCodeServerMaxPooledConnectionsQuotaReached", new object[] { this.maxPooledConnections }), new StringTraceRecord("MaxOutboundConnectionsPerEndpoint", this.maxPooledConnections.ToString(CultureInfo.InvariantCulture)), null, this);
                }
            ...
            else
            {
                ...
                {
                    this.pooledConnectionDequeuedCallback = new ItemDequeuedCallback(this.PooledConnectionDequeuedCallback);
                }
