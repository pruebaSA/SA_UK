namespace System.ServiceModel.Channels
{
    ...
    internal class RequestOneWayChannelFactory : LayeredChannelFactory<IOutputChannel>
    {
        ...
        protected override IOutputChannel OnCreateChannel(EndpointAddress to, Uri via) => 
            new RequestOutputChannel(this, ((IChannelFactory<IRequestChannel>) base.InnerChannelFactory).CreateChannel(to, via), this.packetRoutableHeader);
        ...
        private class RequestOutputChannel : OutputChannel
        {
            ...
            protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerChannel.BeginClose(timeout, callback, state);

            protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerChannel.BeginOpen(timeout, callback, state);

            protected override IAsyncResult OnBeginSend(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerChannel.BeginRequest(message, timeout, callback, state);
