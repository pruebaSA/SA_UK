namespace System.ServiceModel.Channels
{
    ...
    {
        private static AsyncCallback begin1Callback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ChainedAsyncResult.Begin1Callback));
        private ChainedBeginHandler begin2;
        private static AsyncCallback begin2Callback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ChainedAsyncResult.Begin2Callback));
