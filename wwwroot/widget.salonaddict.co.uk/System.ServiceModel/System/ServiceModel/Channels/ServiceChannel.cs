namespace System.ServiceModel.Channels
{
    ...
    internal sealed class ServiceChannel : CommunicationObject, IClientChannel, IDisposable, IDuplexContextChannel, IOutputChannel, IRequestChannel, IServiceChannel, IContextChannel, IChannel, ICommunicationObject, IExtensibleObject<IContextChannel>
    {
        ...
        private bool wasChannelAutoClosed;
        ...
        internal IAsyncResult BeginCall(string action, bool oneway, ProxyOperationRuntime operation, object[] ins, AsyncCallback callback, object asyncState) => 
            this.BeginCall(action, oneway, operation, ins, this.operationTimeout, callback, asyncState);
        ...
        public IAsyncResult BeginRequest(Message message, AsyncCallback callback, object state) => 
            this.BeginRequest(message, this.OperationTimeout, callback, state);
        ...
        public IAsyncResult BeginSend(Message message, AsyncCallback callback, object state) => 
            this.BeginSend(message, this.OperationTimeout, callback, state);
        ...
        internal object Call(string action, bool oneway, ProxyOperationRuntime operation, object[] ins, object[] outs) => 
            this.Call(action, oneway, operation, ins, outs, this.operationTimeout);
                    ...
                    if (base.State == CommunicationState.Opened)
                    {
                        if (this.IsClient)
                        {
                            ...
                            if (innerChannel != null)
                            {
                                ...
                                this.wasChannelAutoClosed = true;
                            }
                        }
                        else
                        {
        ...
        public Message EndRequest(IAsyncResult result) => 
            ((Message) this.EndCall("*", EmptyArray<object>.Instance, result));
        ...
        private void HandleReply(ProxyOperationRuntime operation, ref ProxyRpc rpc)
        {
            try
            {
                if (rpc.Reply != null)
                {
                    ...
                    if ((operation.DeserializeReply && rpc.Reply.IsFault) && (this.messageVersion.Envelope != EnvelopeVersion.None))
                    {
        ...
        private void PrepareCall(ProxyOperationRuntime operation, bool oneway, ref ProxyRpc rpc)
        {
            ...
            else if (TraceUtility.PropagateUserActivity)
            {
        ...
        public Message Request(Message message) => 
            this.Request(message, this.OperationTimeout);
        ...
        IAsyncResult IDuplexContextChannel.BeginCloseOutputSession(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.GetDuplexSessionOrThrow().BeginCloseOutputSession(timeout, callback, state);
        ...
        private void TraceChannelOpen()
        {
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                ...
                if (flag)
                {
                    TraceUtility.TraceEvent(TraceEventType.Information, TraceCode.ServiceChannelLifetime, new DictionaryTraceRecord(dictionary), this, null);
                }
            }
        }
        ...
        private ProxyOperationRuntime UnhandledProxyOperation =>
            this.ClientRuntime.GetRuntime().UnhandledProxyOperation;
        ...
        private class CallDisplayUIOnce : ServiceChannel.ICallOnce
        {
            ...
            IAsyncResult ServiceChannel.ICallOnce.BeginCall(ServiceChannel channel, TimeSpan timeout, AsyncCallback callback, object state) => 
                channel.BeginDisplayInitializationUI(callback, state);
        ...
        private class CallOnceManager
        {
            ...
            private static WaitCallback signalWaiter = new WaitCallback(ServiceChannel.CallOnceManager.SignalWaiter);
            ...
            private class AsyncWaiter : AsyncResult, ServiceChannel.CallOnceManager.IWaiter
            {
                ...
                private static WaitCallback timerCallback = new WaitCallback(ServiceChannel.CallOnceManager.AsyncWaiter.TimerCallback);
            ...
            private class SyncWaiter : ServiceChannel.CallOnceManager.IWaiter
            {
                ...
                private bool ShouldSignalNext =>
                    (this.isTimedOut && this.isSignaled);
            }
        }
        ...
        {
            private static AsyncCallback ensureInteractiveInitCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ServiceChannel.SendAsyncResult.EnsureInteractiveInitCallback));
            private static AsyncCallback ensureOpenCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ServiceChannel.SendAsyncResult.EnsureOpenCallback));
            private readonly bool isOneWay;
            private readonly ProxyOperationRuntime operation;
            private OperationContext operationContext;
            internal ProxyRpc Rpc;
            private static AsyncCallback sendCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ServiceChannel.SendAsyncResult.SendCallback));
            ...
            private void StartEnsureOpen(bool completedSynchronously)
            {
                ...
                {
                    this.FinishEnsureOpen(result, true);
                }
            }
        ...
        internal class SessionIdleManager
        {
            ...
            private static WaitCallback GetTimerCallback()
            {
                if (timerCallback == null)
                {
                    timerCallback = new WaitCallback(ServiceChannel.SessionIdleManager.TimerCallback);
                }
