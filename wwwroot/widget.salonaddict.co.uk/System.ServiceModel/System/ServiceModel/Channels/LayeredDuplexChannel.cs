namespace System.ServiceModel.Channels
{
    ...
    internal class LayeredDuplexChannel : LayeredInputChannel, IDuplexChannel, IInputChannel, IOutputChannel, IChannel, ICommunicationObject
    {
        ...
        public IAsyncResult BeginSend(Message message, TimeSpan timeout, AsyncCallback callback, object state) => 
            this.innerOutputChannel.BeginSend(message, timeout, callback, state);
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedCloseAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginClose), new ChainedEndHandler(this.OnEndClose), new ICommunicationObject[] { this.innerOutputChannel });

        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedOpenAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginOpen), new ChainedEndHandler(this.OnEndOpen), new ICommunicationObject[] { this.innerOutputChannel });
        ...
        public EndpointAddress RemoteAddress =>
            this.innerOutputChannel.RemoteAddress;

        public Uri Via =>
            this.innerOutputChannel.Via;
    }
}
