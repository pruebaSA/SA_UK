namespace System.ServiceModel.Channels
{
    ...
    internal class PeerIdentityClaim
    {
        ...
        internal static System.IdentityModel.Claims.Claim Claim() => 
            new System.IdentityModel.Claims.Claim("http://schemas.microsoft.com/net/2006/05/peer/peer", "peer", "peer");

        internal static bool IsMatch(EndpointIdentity identity) => 
            (identity.IdentityClaim.ClaimType == "http://schemas.microsoft.com/net/2006/05/peer/peer");
    }
}
