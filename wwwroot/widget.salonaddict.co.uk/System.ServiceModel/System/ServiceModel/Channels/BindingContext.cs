namespace System.ServiceModel.Channels
{
    ...
    public class BindingContext
    {
        ...
        public IChannelFactory<TChannel> BuildInnerChannelFactory<TChannel>() => 
            this.RemoveNextElement().BuildChannelFactory<TChannel>(this);

        public IChannelListener<TChannel> BuildInnerChannelListener<TChannel>() where TChannel: class, IChannel => 
            this.RemoveNextElement().BuildChannelListener<TChannel>(this);
        ...
        public BindingContext Clone() => 
            new BindingContext(this.binding, this.remainingBindingElements, this.bindingParameters, this.listenUriBaseAddress, this.listenUriRelativeAddress, this.listenUriMode);
