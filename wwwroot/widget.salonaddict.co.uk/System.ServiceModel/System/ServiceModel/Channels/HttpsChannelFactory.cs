    ...
    internal class HttpsChannelFactory : HttpChannelFactory
    {
        ...
        private class HttpsRequestChannel : HttpChannelFactory.HttpRequestChannel
        {
            ...
            public IAsyncResult BeginBaseGetWebRequest(EndpointAddress to, Uri via, SecurityTokenContainer clientCertificateToken, ref TimeoutHelper timeoutHelper, AsyncCallback callback, object state) => 
                base.BeginGetWebRequest(to, via, clientCertificateToken, ref timeoutHelper, callback, state);
            ...
            public override IAsyncResult BeginGetWebRequest(EndpointAddress to, Uri via, ref TimeoutHelper timeoutHelper, AsyncCallback callback, object state) => 
                new GetWebRequestAsyncResult(this, to, via, ref timeoutHelper, callback, state);
            ...
            private class GetWebRequestAsyncResult : AsyncResult
            {
                ...
                private static AsyncCallback onGetBaseWebRequestCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpsChannelFactory.HttpsRequestChannel.GetWebRequestAsyncResult.OnGetBaseWebRequestCallback));
                ...
                public static HttpWebRequest End(IAsyncResult result) => 
                    AsyncResult.End<HttpsChannelFactory.HttpsRequestChannel.GetWebRequestAsyncResult>(result).request;
                ...
                private bool GetToken()
                {
                    if (this.certificateProvider != null)
                    {
                        ...
                        {
                            onGetTokenCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpsChannelFactory.HttpsRequestChannel.GetWebRequestAsyncResult.OnGetTokenCallback));
                        }
