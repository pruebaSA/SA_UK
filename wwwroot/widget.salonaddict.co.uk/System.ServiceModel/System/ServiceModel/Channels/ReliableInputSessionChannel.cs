namespace System.ServiceModel.Channels
{
    ...
    internal abstract class ReliableInputSessionChannel : InputChannel, IInputSessionChannel, IInputChannel, IChannel, ICommunicationObject, ISessionChannel<IInputSession>
    {
        ...
        private static WaitCallback asyncReceiveComplete = new WaitCallback(ReliableInputSessionChannel.AsyncReceiveCompleteStatic);
        ...
        private static AsyncCallback onReceiveCompleted = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableInputSessionChannel.OnReceiveCompletedStatic));
        ...
        private IAsyncResult BeginUnregisterChannel(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.listener.OnReliableChannelBeginClose(this.ReliableSession.InputID, null, timeout, callback, state);
