namespace System.ServiceModel.Channels
{
    ...
    internal static class PeerValidateHelper
    {
        ...
        public static bool ValidNodeAddress(PeerNodeAddress address) => 
            (((((address != null) && (address.EndpointAddress != null)) && ((address.EndpointAddress.Uri != null) && (address.IPAddresses != null))) && (address.IPAddresses.Count > 0)) && (string.Compare(address.EndpointAddress.Uri.Scheme, Uri.UriSchemeNetTcp, StringComparison.OrdinalIgnoreCase) == 0));
