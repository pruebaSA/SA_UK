namespace System.ServiceModel.Channels
{
    ...
    internal class PipeSharedMemory : IDisposable
    {
        ...
        private static Exception CreatePipeNameCannotBeAccessedException(int error, Uri pipeUri) => 
            new AddressAccessDeniedException(System.ServiceModel.SR.GetString("PipeNameCanNotBeAccessed2", new object[] { pipeUri.AbsoluteUri }), new PipeException(System.ServiceModel.SR.GetString("PipeNameCanNotBeAccessed", new object[] { PipeError.GetErrorString(error) }), error));
        ...
        public static unsafe bool TryCreate(List<SecurityIdentifier> allowedSids, Uri pipeUri, string sharedMemoryName, out PipeSharedMemory result)
        {
            ...
            if (handle.IsInvalid)
            {
                ...
                Exception innerException = new PipeException(System.ServiceModel.SR.GetString("PipeNameCantBeReserved", new object[] { pipeUri.AbsoluteUri, PipeError.GetErrorString(num) }), num);
