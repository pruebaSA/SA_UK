    ...
    internal class RequestReplyCorrelator : IRequestReplyCorrelator
    {
        ...
        private class Key
        {
            ...
            public override int GetHashCode() => 
                (this.MessageId.GetHashCode() ^ this.StateType.GetHashCode());

            public override string ToString() => 
                string.Concat(new object[] { typeof(RequestReplyCorrelator.Key).ToString(), ": {", this.MessageId, ", ", this.StateType.ToString(), "}" });
        }
        ...
        internal struct ReplyToInfo
        {
            ...
            internal bool HasFaultTo =>
                !this.IsTrivial(this.FaultTo);
            internal bool HasFrom =>
                !this.IsTrivial(this.From);
            internal bool HasReplyTo =>
                !this.IsTrivial(this.ReplyTo);
