namespace System.ServiceModel.Channels
{
    ...
    internal class ConnectionUpgradeHelper
    {
        public static IAsyncResult BeginDecodeFramingFault(ClientFramingDecoder decoder, IConnection connection, Uri via, string contentType, ref TimeoutHelper timeoutHelper, AsyncCallback callback, object state) => 
            new DecodeFailedUpgradeAsyncResult(decoder, connection, via, contentType, ref timeoutHelper, callback, state);
        ...
        public static IAsyncResult BeginInitiateUpgrade(IDefaultCommunicationTimeouts timeouts, EndpointAddress remoteAddress, IConnection connection, ClientFramingDecoder decoder, StreamUpgradeInitiator upgradeInitiator, string contentType, WindowsIdentity identityToImpersonate, TimeoutHelper timeoutHelper, AsyncCallback callback, object state) => 
            new InitiateUpgradeAsyncResult(timeouts, remoteAddress, connection, decoder, upgradeInitiator, contentType, identityToImpersonate, timeoutHelper, callback, state);
        ...
        public static IConnection EndInitiateUpgrade(IAsyncResult result) => 
            InitiateUpgradeAsyncResult.End(result);
        ...
        private class InitiateUpgradeAsyncResult : AsyncResult
        {
            ...
            private static AsyncCallback onInitiateUpgrade = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ConnectionUpgradeHelper.InitiateUpgradeAsyncResult.OnInitiateUpgrade));
            ...
            private static AsyncCallback onWriteUpgradeBytes = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ConnectionUpgradeHelper.InitiateUpgradeAsyncResult.OnWriteUpgradeBytes));
            ...
            private bool CompleteReadUpgradeResponse()
            {
                ...
                if (!ConnectionUpgradeHelper.ValidateUpgradeResponse(this.connection.AsyncReadBuffer, count, this.decoder))
                {
                    ...
                    {
                        onFailedUpgrade = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ConnectionUpgradeHelper.InitiateUpgradeAsyncResult.OnFailedUpgrade));
                    }
                ...
                WindowsImpersonationContext context = this.identityToImpersonate?.Impersonate();
                try
                {
                    using (context)
                    {
            ...
            public static IConnection End(IAsyncResult result) => 
                AsyncResult.End<ConnectionUpgradeHelper.InitiateUpgradeAsyncResult>(result).connection;
