namespace System.ServiceModel.Channels
{
    ...
    public sealed class MessageHeaders : IEnumerable<MessageHeaderInfo>, IEnumerable
    {
        ...
        internal MessageHeaders(System.ServiceModel.Channels.MessageVersion version, XmlDictionaryReader reader, IBufferedMessageData bufferedMessageData, RecycledMessageState recycledMessageState, bool[] understoodHeaders)
        {
            this.headers = new Header[4];
            this.Init(version, reader, bufferedMessageData, recycledMessageState, understoodHeaders);
        }
        ...
        private IEnumerator<MessageHeaderInfo> GetEnumerator(MessageHeaderInfo[] headers) => 
            Array.AsReadOnly<MessageHeaderInfo>(headers).GetEnumerator();
        ...
        public T GetHeader<T>(string name, string ns) => 
            this.GetHeader<T>(name, ns, DataContractSerializerDefaults.CreateSerializer(typeof(T), name, ns, 0x7fffffff));
        ...
        internal Collection<MessageHeaderInfo> GetHeadersNotUnderstood()
        {
            ...
            for (int i = 0; i < this.headerCount; i++)
            {
                if (this.headers[i].HeaderProcessing == HeaderProcessing.MustUnderstand)
                {
                    ...
                    {
                        TraceUtility.TraceEvent(TraceEventType.Warning, TraceCode.DidNotUnderstandMessageHeader, new MessageHeaderInfoTraceRecord(headerInfo), null, null);
                    }
        ...
        public bool HaveMandatoryHeadersBeenUnderstood() => 
            this.HaveMandatoryHeadersBeenUnderstood(this.version.Envelope.MustUnderstandActorValues);
        ...
        internal void Init(System.ServiceModel.Channels.MessageVersion version, XmlDictionaryReader reader, IBufferedMessageData bufferedMessageData, RecycledMessageState recycledMessageState, bool[] understoodHeaders)
        {
            this.nodeCount = 0;
            this.attrCount = 0;
            this.version = version;
        ...
        internal bool IsUnderstood(int i) => 
            (((byte) (this.headers[i].HeaderProcessing & HeaderProcessing.Understood)) != 0);
        ...
        private static void TraceUnderstood(MessageHeaderInfo info)
        {
            ...
            {
                TraceUtility.TraceEvent(TraceEventType.Verbose, TraceCode.UnderstoodMessageHeader, new MessageHeaderInfoTraceRecord(info), null, null);
            }
        }
        ...
        internal bool HasMustUnderstandBeenModified =>
            ((this.understoodHeaders != null) && this.understoodHeaders.Modified);
        ...
        {
            get => 
                this.GetRelatesTo(RelatesToHeader.ReplyRelationshipType);
            set
            {
        ...
        public System.ServiceModel.Channels.UnderstoodHeaders UnderstoodHeaders
        {
            get
            {
                if (this.understoodHeaders == null)
                {
                    this.understoodHeaders = new System.ServiceModel.Channels.UnderstoodHeaders(this);
                }
        ...
        private struct Header
        {
            ...
            public System.ServiceModel.Channels.MessageHeader MessageHeader =>
                ((System.ServiceModel.Channels.MessageHeader) this.info);
            ...
            public ReadableMessageHeader ReadableHeader =>
                ((ReadableMessageHeader) this.info);
        }
