namespace System.ServiceModel.Channels
{
    ...
    internal abstract class EncodedFramingRecord
    {
        ...
        public override bool Equals(object o) => 
            ((o is EncodedFramingRecord) && this.Equals((EncodedFramingRecord) o));
        ...
        public override int GetHashCode() => 
            (((this.encodedBytes[0] << 0x10) | (this.encodedBytes[((int) this.encodedBytes.Length) / 2] << 8)) | this.encodedBytes[this.encodedBytes.Length - 1]);
