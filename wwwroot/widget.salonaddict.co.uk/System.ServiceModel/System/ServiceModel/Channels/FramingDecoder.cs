namespace System.ServiceModel.Channels
{
    ...
    internal abstract class FramingDecoder
    {
        ...
        protected Exception CreateException(InvalidDataException innerException) => 
            new ProtocolException(System.ServiceModel.SR.GetString("FramingError", new object[] { this.StreamPosition, this.CurrentStateAsString }), innerException);
        ...
        private Exception CreateInvalidRecordTypeException(FramingRecordType expectedType, FramingRecordType foundType) => 
            new InvalidDataException(System.ServiceModel.SR.GetString("FramingRecordTypeMismatch", new object[] { expectedType.ToString(), foundType.ToString() }));

        public Exception CreatePrematureEOFException() => 
            this.CreateException(new InvalidDataException(System.ServiceModel.SR.GetString("FramingPrematureEOF")));
