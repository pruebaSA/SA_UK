namespace System.ServiceModel.Channels
{
    ...
    internal abstract class LayeredChannelListener<TChannel> : ChannelListenerBase<TChannel> where TChannel: class, IChannel
    {
        ...
        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new OpenAsyncResult<TChannel>(this.InnerChannelListener, this.sharedInnerListener, timeout, callback, state);
        ...
        internal bool SharedInnerListener =>
            this.sharedInnerListener;

        public override System.Uri Uri =>
            this.GetInnerListenerSnapshot().Uri;
        ...
        private class CloseAsyncResult : AsyncResult
        {
            ...
            {
                LayeredChannelListener<TChannel>.CloseAsyncResult.onCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(LayeredChannelListener<TChannel>.CloseAsyncResult.OnCloseComplete));
            }
        ...
        private class OpenAsyncResult : AsyncResult
        {
            ...
            {
                LayeredChannelListener<TChannel>.OpenAsyncResult.onOpenComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(LayeredChannelListener<TChannel>.OpenAsyncResult.OnOpenComplete));
            }
