namespace System.ServiceModel.Channels
{
    ...
    public abstract class SecurityBindingElement : BindingElement
    {
        ...
        public static SymmetricSecurityBindingElement CreateAnonymousForCertificateBindingElement() => 
            new SymmetricSecurityBindingElement(new X509SecurityTokenParameters(X509KeyIdentifierClauseType.Thumbprint, SecurityTokenInclusionMode.Never)) { 
                MessageSecurityVersion = System.ServiceModel.MessageSecurityVersion.WSSecurity11WSTrustFebruary2005WSSecureConversationFebruary2005WSSecurityPolicy11,
                RequireSignatureConfirmation = true
            };

        public static TransportSecurityBindingElement CreateCertificateOverTransportBindingElement() => 
            CreateCertificateOverTransportBindingElement(System.ServiceModel.MessageSecurityVersion.Default);
        ...
        public static AsymmetricSecurityBindingElement CreateCertificateSignatureBindingElement() => 
            new AsymmetricSecurityBindingElement(new X509SecurityTokenParameters(X509KeyIdentifierClauseType.Any, SecurityTokenInclusionMode.Never, false), new X509SecurityTokenParameters(X509KeyIdentifierClauseType.Any, SecurityTokenInclusionMode.AlwaysToRecipient, false)) { 
        ...
        public static SymmetricSecurityBindingElement CreateIssuedTokenForSslBindingElement(IssuedSecurityTokenParameters issuedTokenParameters) => 
            CreateIssuedTokenForSslBindingElement(issuedTokenParameters, false);
        ...
        public static SymmetricSecurityBindingElement CreateKerberosBindingElement() => 
            new SymmetricSecurityBindingElement(new KerberosSecurityTokenParameters()) { DefaultAlgorithmSuite = SecurityAlgorithmSuite.KerberosDefault };
        ...
        public static SecurityBindingElement CreateMutualCertificateBindingElement() => 
            CreateMutualCertificateBindingElement(System.ServiceModel.MessageSecurityVersion.WSSecurity11WSTrustFebruary2005WSSecureConversationFebruary2005WSSecurityPolicy11);
        ...
        public static SecurityBindingElement CreateMutualCertificateBindingElement(System.ServiceModel.MessageSecurityVersion version) => 
            CreateMutualCertificateBindingElement(version, false);
        ...
        public static SecurityBindingElement CreateMutualCertificateBindingElement(System.ServiceModel.MessageSecurityVersion version, bool allowSerializedSigningTokenOnReply)
        {
            ...
            else
            {
                element = new SymmetricSecurityBindingElement(new X509SecurityTokenParameters(X509KeyIdentifierClauseType.Thumbprint, SecurityTokenInclusionMode.Never)) {
                    EndpointSupportingTokenParameters = { Endorsing = { new X509SecurityTokenParameters(X509KeyIdentifierClauseType.Thumbprint, SecurityTokenInclusionMode.AlwaysToRecipient, false) } }
                };
        ...
        public static AsymmetricSecurityBindingElement CreateMutualCertificateDuplexBindingElement() => 
            CreateMutualCertificateDuplexBindingElement(System.ServiceModel.MessageSecurityVersion.WSSecurity11WSTrustFebruary2005WSSecureConversationFebruary2005WSSecurityPolicy11);
        ...
        public static SecurityBindingElement CreateSecureConversationBindingElement(SecurityBindingElement bootstrapSecurity) => 
            CreateSecureConversationBindingElement(bootstrapSecurity, true, null);
        ...
        public static SecurityBindingElement CreateSecureConversationBindingElement(SecurityBindingElement bootstrapSecurity, bool requireCancellation) => 
            CreateSecureConversationBindingElement(bootstrapSecurity, requireCancellation, null);
        ...
        public static SymmetricSecurityBindingElement CreateSslNegotiationBindingElement(bool requireClientCertificate) => 
            CreateSslNegotiationBindingElement(requireClientCertificate, false);
        ...
        public static SymmetricSecurityBindingElement CreateSslNegotiationBindingElement(bool requireClientCertificate, bool requireCancellation) => 
            new SymmetricSecurityBindingElement(new SslSecurityTokenParameters(requireClientCertificate, requireCancellation));

        public static SymmetricSecurityBindingElement CreateSspiNegotiationBindingElement() => 
            CreateSspiNegotiationBindingElement(false);

        public static SymmetricSecurityBindingElement CreateSspiNegotiationBindingElement(bool requireCancellation) => 
            new SymmetricSecurityBindingElement(new SspiSecurityTokenParameters(requireCancellation));

        public static TransportSecurityBindingElement CreateSspiNegotiationOverTransportBindingElement() => 
            CreateSspiNegotiationOverTransportBindingElement(true);
        ...
        public static SymmetricSecurityBindingElement CreateUserNameForCertificateBindingElement() => 
            new SymmetricSecurityBindingElement(new X509SecurityTokenParameters(X509KeyIdentifierClauseType.Thumbprint, SecurityTokenInclusionMode.Never)) { 
                EndpointSupportingTokenParameters = { SignedEncrypted = { new UserNameSecurityTokenParameters() } },
                MessageSecurityVersion = System.ServiceModel.MessageSecurityVersion.WSSecurity11WSTrustFebruary2005WSSecureConversationFebruary2005WSSecurityPolicy11
            };

        public static SymmetricSecurityBindingElement CreateUserNameForSslBindingElement() => 
            CreateUserNameForSslBindingElement(false);

        public static SymmetricSecurityBindingElement CreateUserNameForSslBindingElement(bool requireCancellation) => 
            new SymmetricSecurityBindingElement(new SslSecurityTokenParameters(false, requireCancellation)) { 
                EndpointSupportingTokenParameters = { SignedEncrypted = { new UserNameSecurityTokenParameters() } },
                MessageSecurityVersion = System.ServiceModel.MessageSecurityVersion.WSSecurity11WSTrustFebruary2005WSSecureConversationFebruary2005WSSecurityPolicy11
            };
                ...
                foreach (OperationDescription description in policyContext.Contract.Operations)
                {
                    foreach (MessageDescription description2 in description.Messages)
                    {
                        if (description2.Direction == MessageDirection.Input)
                        {
                            ...
                            {
                                AddAssertionIfNotNull(policyContext, description, securityPolicyDriver.CreateWsspSupportingTokensAssertion(exporter, parameters?.Signed, parameters?.SignedEncrypted, parameters?.Endorsing, parameters?.SignedEndorsing, parameters2?.Signed, parameters2?.SignedEncrypted, parameters2?.Endorsing, parameters2?.SignedEndorsing));
                            }
                        }
                    }
                }
        ...
        internal static void ExportPolicy(MetadataExporter exporter, PolicyConversionContext context)
        {
            ...
            try
            {
                if (binding is SymmetricSecurityBindingElement)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("ExportOfBindingWithSymmetricAndTransportSecurityNotSupported")));
                    }
                ...
                else if (binding is AsymmetricSecurityBindingElement)
                {
                    if (transportTokenAssertionProvider != null)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("ExportOfBindingWithAsymmetricAndTransportSecurityNotSupported")));
                    }
            ...
            finally
            {
                ...
                {
                    if (flag || DiagnosticUtility.IsFatal(exception))
                    {
                        throw;
                    }
                }
        ...
        internal static bool IsIssuedTokenForSslBinding(SecurityBindingElement sbe, out IssuedSecurityTokenParameters issuedTokenParameters) => 
            IsIssuedTokenForSslBinding(sbe, false, out issuedTokenParameters);
        ...
        internal static bool IsMutualCertificateBinding(SecurityBindingElement sbe) => 
            IsMutualCertificateBinding(sbe, false);
        ...
        internal static bool IsSecureConversationBinding(SecurityBindingElement sbe, out SecurityBindingElement bootstrapSecurity) => 
            IsSecureConversationBinding(sbe, true, out bootstrapSecurity);
        ...
        internal bool IsUnderlyingListenerDuplex<TChannel>(BindingContext context) => 
            (((typeof(TChannel) == typeof(IDuplexSessionChannel)) && context.CanBuildInnerChannelListener<IDuplexChannel>()) && !context.CanBuildInnerChannelListener<IDuplexSessionChannel>());
        ...
        internal bool RequiresChannelDemuxer(SecurityTokenParameters parameters) => 
            (((parameters is SecureConversationSecurityTokenParameters) || (parameters is SslSecurityTokenParameters)) || (parameters is SspiSecurityTokenParameters));
        ...
        public override string ToString()
        {
            ...
            builder.AppendLine(string.Format(CultureInfo.InvariantCulture, "ProtectTokens: {0}", new object[] { this.protectTokens.ToString() }));
