namespace System.ServiceModel.Channels
{
    ...
    public sealed class OneWayBindingElement : BindingElement, IPolicyExportExtension
    {
        ...
        public override bool CanBuildChannelFactory<TChannel>(BindingContext context)
        {
            ...
            return (context.Clone().CanBuildInnerChannelFactory<IDuplexSessionChannel>() || context.CanBuildInnerChannelFactory<IRequestChannel>());
        }
        ...
        public override bool CanBuildChannelListener<TChannel>(BindingContext context) where TChannel: class, IChannel
        {
            ...
            return (context.Clone().CanBuildInnerChannelListener<IDuplexSessionChannel>() || context.CanBuildInnerChannelListener<IReplyChannel>());
        }

        public override BindingElement Clone() => 
            new OneWayBindingElement(this);
