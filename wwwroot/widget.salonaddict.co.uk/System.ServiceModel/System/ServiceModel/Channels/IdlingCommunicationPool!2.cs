    ...
    internal abstract class IdlingCommunicationPool<TKey, TItem> : CommunicationPool<TKey, TItem> where TKey: class where TItem: class
    {
        ...
        protected class IdleTimeoutEndpointConnectionPool : CommunicationPool<TKey, TItem>.EndpointConnectionPool
        {
            ...
            protected class IdleTimeoutIdleConnectionPool : CommunicationPool<TKey, TItem>.EndpointConnectionPool.PoolIdleConnectionPool
            {
                ...
                private TimeSpan leaseTimeout;
                private static WaitCallback onIdle;
                ...
                private void OnIdle()
                {
                    ...
                    Monitor.Enter(obj2 = this.thisLock);
                    try
                    {
                ...
                private void StartTimerIfNecessary()
                {
                    if (this.Count > 1)
                    {
                        if (this.idleTimer == null)
                        {
                            ...
                            {
                                IdlingCommunicationPool<TKey, TItem>.IdleTimeoutEndpointConnectionPool.IdleTimeoutIdleConnectionPool.onIdle = new WaitCallback(IdlingCommunicationPool<TKey, TItem>.IdleTimeoutEndpointConnectionPool.IdleTimeoutIdleConnectionPool.OnIdle);
                            }
                ...
                private void TraceConnectionIdleTimeoutExpired()
                {
                    ...
                    {
                        DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.ConnectionPoolIdleTimeoutReached, System.ServiceModel.SR.GetString("TraceCodeConnectionPoolIdleTimeoutReached", new object[] { this.idleTimeout }), null, null, this);
                    }
                }
                ...
                private void TraceConnectionLeaseTimeoutExpired()
                {
                    if (DiagnosticUtility.ShouldTraceInformation)
                    {
                        DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.ConnectionPoolLeaseTimeoutReached, System.ServiceModel.SR.GetString("TraceCodeConnectionPoolLeaseTimeoutReached", new object[] { this.leaseTimeout }), null, null, this);
                    }
                }
