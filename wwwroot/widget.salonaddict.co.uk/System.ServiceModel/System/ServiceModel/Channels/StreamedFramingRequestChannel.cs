namespace System.ServiceModel.Channels
{
    ...
    internal class StreamedFramingRequestChannel : RequestChannel
    {
        ...
        protected override IAsyncRequest CreateAsyncRequest(Message message, AsyncCallback callback, object state) => 
            new StreamedFramingAsyncRequest(this, callback, state);

        protected override IRequest CreateRequest(Message message) => 
            new StreamedFramingRequest(this);

        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            base.BeginWaitForPendingRequests(timeout, callback, state);
        ...
        private class ClientSingletonConnectionReader : SingletonConnectionReader
        {
            ...
            protected override long StreamPosition =>
                this.connectionPoolHelper.Decoder.StreamPosition;
        }
        ...
        internal class StreamedConnectionPoolHelper : ConnectionPoolHelper
        {
            ...
            protected override TimeoutException CreateNewConnectionTimeoutException(TimeSpan timeout, TimeoutException innerException) => 
                new TimeoutException(System.ServiceModel.SR.GetString("RequestTimedOutEstablishingTransportSession", new object[] { timeout, this.channel.Via.AbsoluteUri }), innerException);

            protected override IConnection EndAcceptPooledConnection(IAsyncResult result) => 
                SendPreambleAsyncResult.End(result, out this.remoteSecurity);
            ...
            private class SendPreambleAsyncResult : AsyncResult
            {
                ...
                private static AsyncCallback onWritePreamble = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamedFramingRequestChannel.StreamedConnectionPoolHelper.SendPreambleAsyncResult.OnWritePreamble));
                ...
                private bool HandlePreambleAck()
                {
                    ...
                    if (!ConnectionUpgradeHelper.ValidatePreambleResponse(this.connection.AsyncReadBuffer, count, this.decoder, this.channel.Via))
                    {
                        ...
                        {
                            onFailedUpgrade = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamedFramingRequestChannel.StreamedConnectionPoolHelper.SendPreambleAsyncResult.OnFailedUpgrade));
                        }
                ...
                private bool HandleUpgrade(IAsyncResult result)
                {
                    ...
                    {
                        onWritePreambleEnd = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamedFramingRequestChannel.StreamedConnectionPoolHelper.SendPreambleAsyncResult.OnWritePreambleEnd));
                    }
                ...
                private bool HandleWritePreamble(IAsyncResult result)
                {
                    ...
                    if (onUpgrade == null)
                    {
                        onUpgrade = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamedFramingRequestChannel.StreamedConnectionPoolHelper.SendPreambleAsyncResult.OnUpgrade));
                    }
        ...
        private class StreamedFramingAsyncRequest : AsyncResult, IAsyncRequest, IAsyncResult, IRequestBase
        {
            ...
            private static AsyncCallback onEstablishConnection = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamedFramingRequestChannel.StreamedFramingAsyncRequest.OnEstablishConnection));
            private static AsyncCallback onReceiveReply = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamedFramingRequestChannel.StreamedFramingAsyncRequest.OnReceiveReply));
            private static AsyncCallback onWriteMessage = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamedFramingRequestChannel.StreamedFramingAsyncRequest.OnWriteMessage));
