namespace System.ServiceModel.Channels
{
    ...
    {
        private static AsyncCallback onAuthenticateAsServer = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(StreamSecurityUpgradeAcceptorAsyncResult.OnAuthenticateAsServer));
