namespace System.ServiceModel.Channels
{
    ...
    internal class PeerChannelAuthenticatorExtension : IExtension<IPeerNeighbor>
    {
        ...
        public void Attach(IPeerNeighbor host)
        {
            ...
            this.host = host;
            this.timer = new IOThreadTimer(new WaitCallback(this.OnTimeout), null, true);
            ...
            using (new OperationContextScope(new OperationContext(null)))
            {
                ...
                catch (Exception exception)
                {
                    ...
                    if (DiagnosticUtility.ShouldTraceError)
                    {
                        ...
                        TraceUtility.TraceEvent(TraceEventType.Error, TraceCode.PeerNodeAuthenticationFailure, extendedData, this, null);
                    }
        ...
        private void OnFailed(IPeerNeighbor neighbor)
        {
            ...
            if (DiagnosticUtility.ShouldTraceError)
            {
                ...
                else
                {
                    ...
                    if (DiagnosticUtility.ShouldTraceError)
                    {
                        TraceUtility.TraceEvent(TraceEventType.Error, TraceCode.PeerNodeAuthenticationTimeout, extendedData, this, null);
                    }
                }
            }
