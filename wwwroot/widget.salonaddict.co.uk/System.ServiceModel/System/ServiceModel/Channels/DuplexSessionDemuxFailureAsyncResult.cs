namespace System.ServiceModel.Channels
{
    ...
    internal class DuplexSessionDemuxFailureAsyncResult : AsyncResult
    {
        ...
        private static AsyncCallback channelCloseCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(DuplexSessionDemuxFailureAsyncResult.ChannelCloseCallback));
        private IChannelDemuxFailureHandler demuxFailureHandler;
        private static AsyncCallback demuxFailureHandlerCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(DuplexSessionDemuxFailureAsyncResult.DemuxFailureHandlerCallback));
