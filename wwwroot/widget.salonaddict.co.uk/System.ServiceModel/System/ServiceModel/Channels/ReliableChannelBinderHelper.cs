namespace System.ServiceModel.Channels
{
    ...
    internal static class ReliableChannelBinderHelper
    {
        internal static IAsyncResult BeginCloseDuplexSessionChannel(ReliableChannelBinder<IDuplexSessionChannel> binder, IDuplexSessionChannel channel, TimeSpan timeout, AsyncCallback callback, object state) => 
            new CloseDuplexSessionChannelAsyncResult(binder, channel, timeout, callback, state);
        ...
        internal static IAsyncResult BeginCloseReplySessionChannel(ReliableChannelBinder<IReplySessionChannel> binder, IReplySessionChannel channel, TimeSpan timeout, AsyncCallback callback, object state) => 
            new CloseReplySessionChannelAsyncResult(binder, channel, timeout, callback, state);
        ...
        internal static bool MaskHandled(MaskingMode maskingMode) => 
            ((maskingMode & MaskingMode.Handled) == MaskingMode.Handled);

        internal static bool MaskUnhandled(MaskingMode maskingMode) => 
            ((maskingMode & MaskingMode.Unhandled) == MaskingMode.Unhandled);
        ...
        {
            private static AsyncCallback onCloseOutputSessionCompleteStatic = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinderHelper.CloseDuplexSessionChannelAsyncResult.OnCloseOutputSessionCompleteStatic));
            ...
            protected override IAsyncResult BeginTryInput(TimeSpan timeout, AsyncCallback callback, object state) => 
                base.Channel.BeginTryReceive(timeout, callback, state);
            ...
            protected override bool EndTryInput(IAsyncResult result, out Message item) => 
                base.Channel.EndTryReceive(result, out item);
        ...
        private abstract class CloseInputSessionChannelAsyncResult<TChannel, TItem> : AsyncResult where TChannel: class, IChannel where TItem: class
        {
            ...
            {
                ReliableChannelBinderHelper.CloseInputSessionChannelAsyncResult<TChannel, TItem>.onChannelCloseCompleteStatic = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinderHelper.CloseInputSessionChannelAsyncResult<TChannel, TItem>.OnChannelCloseCompleteStatic));
                ReliableChannelBinderHelper.CloseInputSessionChannelAsyncResult<TChannel, TItem>.onInputCompleteStatic = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinderHelper.CloseInputSessionChannelAsyncResult<TChannel, TItem>.OnInputCompleteStatic));
                ReliableChannelBinderHelper.CloseInputSessionChannelAsyncResult<TChannel, TItem>.onWaitForPendingOperationsCompleteStatic = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelBinderHelper.CloseInputSessionChannelAsyncResult<TChannel, TItem>.OnWaitForPendingOperationsCompleteStatic));
            }
        ...
        private sealed class CloseReplySessionChannelAsyncResult : ReliableChannelBinderHelper.CloseInputSessionChannelAsyncResult<IReplySessionChannel, RequestContext>
        {
            ...
            protected override IAsyncResult BeginTryInput(TimeSpan timeout, AsyncCallback callback, object state) => 
                base.Channel.BeginTryReceiveRequest(timeout, callback, state);
            ...
            protected override bool EndTryInput(IAsyncResult result, out RequestContext item) => 
                base.Channel.EndTryReceiveRequest(result, out item);
        }
    }
}
