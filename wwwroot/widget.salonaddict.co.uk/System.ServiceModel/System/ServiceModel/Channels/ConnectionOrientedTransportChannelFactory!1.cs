namespace System.ServiceModel.Channels
{
    ...
    internal abstract class ConnectionOrientedTransportChannelFactory<TChannel> : TransportChannelFactory<TChannel>, IConnectionOrientedTransportChannelFactorySettings, IConnectionOrientedTransportFactorySettings, ITransportFactorySettings, IDefaultCommunicationTimeouts, IConnectionOrientedConnectionSettings
    {
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new CloseAsyncResult<TChannel>((ConnectionOrientedTransportChannelFactory<TChannel>) this, timeout, callback, state);

        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new OpenAsyncResult<TChannel>(this.Upgrade, timeout, callback, state);
        ...
        private class CloseAsyncResult : AsyncResult
        {
            ...
            private static WaitCallback onReleaseConnectionPoolScheduled;
            ...
            {
                ConnectionOrientedTransportChannelFactory<TChannel>.CloseAsyncResult.onCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ConnectionOrientedTransportChannelFactory<TChannel>.CloseAsyncResult.OnCloseComplete));
            }
            ...
            public CloseAsyncResult(ConnectionOrientedTransportChannelFactory<TChannel> parent, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
            {
                ...
                else
                {
                    ...
                    {
                        ConnectionOrientedTransportChannelFactory<TChannel>.CloseAsyncResult.onReleaseConnectionPoolScheduled = new WaitCallback(ConnectionOrientedTransportChannelFactory<TChannel>.CloseAsyncResult.OnReleaseConnectionPoolScheduled);
                    }
                    IOThreadScheduler.ScheduleCallback(ConnectionOrientedTransportChannelFactory<TChannel>.CloseAsyncResult.onReleaseConnectionPoolScheduled, this);
                }
            }
        ...
        private class OpenAsyncResult : AsyncResult
        {
            ...
            {
                ConnectionOrientedTransportChannelFactory<TChannel>.OpenAsyncResult.onOpenComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ConnectionOrientedTransportChannelFactory<TChannel>.OpenAsyncResult.OnOpenComplete));
            }
