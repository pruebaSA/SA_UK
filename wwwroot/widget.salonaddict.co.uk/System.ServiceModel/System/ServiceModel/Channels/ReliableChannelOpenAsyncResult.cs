namespace System.ServiceModel.Channels
{
    ...
    internal class ReliableChannelOpenAsyncResult : AsyncResult
    {
        ...
        private static AsyncCallback onBinderOpenComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelOpenAsyncResult.OnBinderOpenComplete));
        private static AsyncCallback onSessionOpenComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelOpenAsyncResult.OnSessionOpenComplete));
        ...
        {
            IAsyncResult result = this.binder.BeginClose(this.timeoutHelper.RemainingTime(), DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnBinderCloseComplete)), e);
            if (result.CompletedSynchronously)
            {
