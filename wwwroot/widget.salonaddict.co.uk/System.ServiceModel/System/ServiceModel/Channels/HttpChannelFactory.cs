namespace System.ServiceModel.Channels
{
    ...
    internal class HttpChannelFactory : TransportChannelFactory<IRequestChannel>, IHttpTransportFactorySettings, ITransportFactorySettings, IDefaultCommunicationTimeouts
    {
        ...
        private string AppendWindowsAuthenticationInfo(string inputString, NetworkCredential credential, AuthenticationLevel authenticationLevel, TokenImpersonationLevel impersonationLevel) => 
            System.ServiceModel.Security.SecurityUtils.AppendWindowsAuthenticationInfo(inputString, credential, authenticationLevel, impersonationLevel);
        ...
        private SecurityMessageProperty CreateMutuallyAuthenticatedReplySecurityProperty(HttpWebResponse response)
        {
            ...
            return new SecurityMessageProperty { 
                TransportToken = new SecurityTokenSpecification(null, tokenPolicies),
        ...
        internal Exception CreateToMustEqualViaException(Uri to, Uri via) => 
            new ArgumentException(System.ServiceModel.SR.GetString("HttpToMustEqualVia", new object[] { to, via }));
        ...
        protected virtual bool IsSecurityTokenManagerRequired() => 
            ((this.AuthenticationScheme != AuthenticationSchemes.Anonymous) || ((this.proxyFactory != null) && (this.proxyFactory.AuthenticationScheme != AuthenticationSchemes.Anonymous)));

        private bool MapIdentity(EndpointAddress target) => 
            (((target.Identity != null) && !(target.Identity is X509CertificateEndpointIdentity)) && AuthenticationSchemesHelper.IsWindowsAuth(this.AuthenticationScheme));
        ...
        protected class HttpRequestChannel : RequestChannel
        {
            ...
            public virtual IAsyncResult BeginGetWebRequest(EndpointAddress to, Uri via, ref TimeoutHelper timeoutHelper, AsyncCallback callback, object state) => 
                this.BeginGetWebRequest(to, via, null, ref timeoutHelper, callback, state);
            ...
            protected IAsyncResult BeginGetWebRequest(EndpointAddress to, Uri via, SecurityTokenContainer clientCertificateToken, ref TimeoutHelper timeoutHelper, AsyncCallback callback, object state) => 
                new GetWebRequestAsyncResult(this, to, via, clientCertificateToken, ref timeoutHelper, callback, state);
            ...
            protected override IRequest CreateRequest(Message message) => 
                new HttpChannelRequest(this, this.Factory);

            public virtual HttpWebRequest EndGetWebRequest(IAsyncResult result) => 
                GetWebRequestAsyncResult.End(result);
            ...
            public virtual HttpWebRequest GetWebRequest(EndpointAddress to, Uri via, ref TimeoutHelper timeoutHelper) => 
                this.GetWebRequest(to, via, null, ref timeoutHelper);
            ...
            public virtual bool WillGetWebRequestCompleteSynchronously() => 
                ((this.tokenProvider == null) && !this.Factory.ManualAddressing);
            ...
            private class GetWebRequestAsyncResult : AsyncResult
            {
                ...
                public GetWebRequestAsyncResult(HttpChannelFactory.HttpRequestChannel channel, EndpointAddress to, Uri via, SecurityTokenContainer clientCertificateToken, ref TimeoutHelper timeoutHelper, AsyncCallback callback, object state) : base(callback, state)
                {
                    ...
                    else if (this.factory.AuthenticationScheme == AuthenticationSchemes.Basic)
                    {
                        ...
                        {
                            onGetUserNameCredential = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpChannelFactory.HttpRequestChannel.GetWebRequestAsyncResult.OnGetUserNameCredential));
                        }
                    ...
                    else
                    {
                        ...
                        {
                            onGetSspiCredential = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpChannelFactory.HttpRequestChannel.GetWebRequestAsyncResult.OnGetSspiCredential));
                        }
                ...
                public static HttpWebRequest End(IAsyncResult result) => 
                    AsyncResult.End<HttpChannelFactory.HttpRequestChannel.GetWebRequestAsyncResult>(result).request;
            ...
            private class HttpChannelAsyncRequest : TraceAsyncResult, IAsyncRequest, IAsyncResult, IRequestBase
            {
                ...
                private static AsyncCallback onGetResponse = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpChannelFactory.HttpRequestChannel.HttpChannelAsyncRequest.OnGetResponse));
                private static AsyncCallback onGetWebRequestCompleted;
                private static AsyncCallback onProcessIncomingMessage = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpChannelFactory.HttpRequestChannel.HttpChannelAsyncRequest.OnParseIncomingMessage));
                private static AsyncCallback onSend = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpChannelFactory.HttpRequestChannel.HttpChannelAsyncRequest.OnSend));
                ...
                public void BeginSendRequest(Message message, TimeSpan timeout)
                {
                    ...
                    else
                    {
                        ...
                        {
                            onGetWebRequestCompleted = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(HttpChannelFactory.HttpRequestChannel.HttpChannelAsyncRequest.OnGetWebRequestCompletedCallback));
                        }
                        ...
                        if (result.CompletedSynchronously && this.OnGetWebRequestCompleted(result))
                        {
                            base.Complete(true);
                        }
                    }
                ...
                private bool CompleteSend(IAsyncResult result)
                {
                    ...
                    {
                        throw TraceUtility.ThrowHelperError(new CommunicationException(exception2.Message, exception2), this.message);
                    }
                    catch (WebException exception3)
                    {
                        throw TraceUtility.ThrowHelperError(new CommunicationException(exception3.Message, exception3), this.message);
                    }
                    catch (ObjectDisposedException exception4)
                    {
                        if (this.abortReason == HttpAbortReason.Aborted)
                        {
                            throw TraceUtility.ThrowHelperError(new CommunicationObjectAbortedException(System.ServiceModel.SR.GetString("HttpRequestAborted", new object[] { this.to.Uri }), exception4), this.message);
                        }
                        throw TraceUtility.ThrowHelperError(new TimeoutException(System.ServiceModel.SR.GetString("HttpRequestTimedOut", new object[] { this.to.Uri, this.timeoutHelper.OriginalTimeout }), exception4), this.message);
                    }
                    return flag2;
                }
                ...
                {
                    bool flag3;
                    this.httpOutput = HttpOutput.CreateHttpOutput(this.request, this.factory, this.message, this.factory.IsChannelBindingSupportEnabled);
                    bool flag = true;
                    try
                    {
                        bool flag2 = false;
                ...
                private IOThreadTimer SendTimer
                {
                    get
                    {
                        if (this.sendTimer == null)
                        {
                            ...
                            {
                                onSendTimeout = new WaitCallback(HttpChannelFactory.HttpRequestChannel.HttpChannelAsyncRequest.OnSendTimeout);
                            }
            ...
            private class HttpChannelRequest : IRequest, IRequestBase
            {
                ...
                public void SendRequest(Message message, TimeSpan timeout)
                {
                    ...
                    HttpOutput output = HttpOutput.CreateHttpOutput(this.webRequest, this.factory, message, this.factory.IsChannelBindingSupportEnabled);
                    bool flag = false;
                    try
                    {
        ...
        private class WebProxyFactory
        {
            ...
            public IWebProxy CreateWebProxy(HttpWebRequest request, SecurityTokenProviderContainer tokenProvider, TimeSpan timeout)
            {
                ...
                if (this.authenticationScheme != AuthenticationSchemes.Anonymous)
                {
                    TokenImpersonationLevel level;
                    AuthenticationLevel level2;
                    NetworkCredential credential = HttpChannelUtilities.GetCredential(this.authenticationScheme, tokenProvider, timeout, out level, out level2);
