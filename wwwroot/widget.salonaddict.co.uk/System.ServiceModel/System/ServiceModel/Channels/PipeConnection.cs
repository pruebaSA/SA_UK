namespace System.ServiceModel.Channels
{
    ...
    internal sealed class PipeConnection : IConnection
    {
        ...
        private static WaitCallback onReadTimeout;
        private static WaitCallback onWriteTimeout;
        ...
        public PipeConnection(PipeHandle pipe, int connectionBufferSize, bool isBoundToCompletionPort, bool autoBindToCompletionPort)
        {
            if (pipe == null)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperArgumentNull("pipe");
            }
            if (pipe.IsInvalid)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperArgumentNull("pipe");
        ...
        public unsafe AsyncReadResult BeginRead(int offset, int size, TimeSpan timeout, WaitCallback callback, object state)
        {
            ...
            Monitor.Enter(obj2 = this.readLock);
            try
            {
                ...
                {
                    throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperInternal(false);
                }
                try
                {
                    ...
                    if (UnsafeNativeMethods.ReadFile(this.pipe.DangerousGetHandle(), this.readOverlapped.BufferPtr + offset, size, IntPtr.Zero, this.readOverlapped.NativeOverlapped) == 0)
                    {
                        ...
                        if ((error != 0x3e5) && (error != 0xea))
                        {
                            ...
                            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(Exceptions.CreateReadException(error));
                        }
                    }
                }
                finally
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(this.ConvertPipeException(exception2, TransferOperation.Read), this.ExceptionEventType);
            }
            finally
            {
                Monitor.Exit(obj2);
        ...
        public unsafe IAsyncResult BeginWrite(byte[] buffer, int offset, int size, bool immediate, TimeSpan timeout, AsyncCallback callback, object state)
        {
            ...
            Monitor.Enter(obj4 = this.writeLock);
            try
            {
                this.ValidateEnterWritingState(true);
                ...
                try
                {
                    ...
                    if (UnsafeNativeMethods.WriteFile(this.pipe.DangerousGetHandle(), this.writeOverlapped.BufferPtr + offset, size, IntPtr.Zero, this.writeOverlapped.NativeOverlapped) == 0)
                    {
                        ...
                        if (error != 0x3e5)
                        {
                            ...
                            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(Exceptions.CreateWriteException(error));
                        }
                    }
                }
                finally
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(this.ConvertPipeException(exception2, TransferOperation.Write), this.ExceptionEventType);
            }
            finally
            {
                Monitor.Exit(obj4);
        ...
        public void Close(TimeSpan timeout, bool asyncAndLinger)
        {
            ...
            try
            {
                ...
                lock (this.readLock)
                {
                    lock (this.writeLock)
                    {
                        ...
                        {
                            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new PipeException(System.ServiceModel.SR.GetString("PipeCantCloseWithPendingWrite")), this.ExceptionEventType);
                        }
                ...
                {
                    throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new TimeoutException(System.ServiceModel.SR.GetString("PipeShutdownWriteError"), exception), this.ExceptionEventType);
                }
                if (flag3)
                {
                    try
                    ...
                    {
                        throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new TimeoutException(System.ServiceModel.SR.GetString("PipeShutdownReadError"), exception2), this.ExceptionEventType);
                    }
                }
                if (flag2 && !TimeoutHelper.WaitOne(this.atEOFEvent, helper.RemainingTime(), false))
                {
                    throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new TimeoutException(System.ServiceModel.SR.GetString("PipeShutdownReadError")), this.ExceptionEventType);
                }
            Label_017D:
                try
                {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new TimeoutException(System.ServiceModel.SR.GetString("PipeCloseFailed"), exception6), this.ExceptionEventType);
            }
            catch (PipeException exception7)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(this.ConvertPipeException(System.ServiceModel.SR.GetString("PipeCloseFailed"), exception7, TransferOperation.Undefined), this.ExceptionEventType);
            }
            finally
            {
                if (flag)
        ...
        private void CloseHandle(bool abort, string timeoutErrorString, TransferOperation transferOperation)
        {
            ...
            if (abort)
            {
                ...
                if (System.ServiceModel.DiagnosticUtility.ShouldTrace(warning))
                {
                    TraceUtility.TraceEvent(warning, TraceCode.PipeConnectionAbort, this);
                }
            }
        }

        private Exception ConvertPipeException(PipeException pipeException, TransferOperation transferOperation) => 
            this.ConvertPipeException(pipeException.Message, pipeException, transferOperation);
        ...
        private Exception CreatePipeClosedException(TransferOperation transferOperation) => 
            this.ConvertPipeException(new PipeException(System.ServiceModel.SR.GetString("PipeClosed")), transferOperation);
        ...
        {
            object obj2;
            System.IdentityModel.SafeCloseHandle hTargetProcessHandle = ListenerUnsafeNativeMethods.OpenProcess(0x40, false, targetProcessId);
            if (hTargetProcessHandle.IsInvalid)
            {
                hTargetProcessHandle.SetHandleAsInvalid();
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(this.CreatePipeDuplicationFailedException(Marshal.GetLastWin32Error()), this.ExceptionEventType);
            }
            try
            {
                IntPtr ptr2;
        ...
        public int EndRead()
        {
            if (this.asyncReadException != null)
            {
                ...
                this.asyncReadException = null;
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(asyncReadException, this.ExceptionEventType);
            }
        ...
        private void FinishPendingWrite(TimeSpan timeout)
        {
            if (this.pendingWriteBuffer != null)
            {
                ...
                {
                    throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(this.ConvertPipeException(exception, TransferOperation.Write), this.ExceptionEventType);
                }
            }
        }
        ...
        private unsafe int FinishSyncRead(bool traceExceptionsAsErrors)
        {
            ...
            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(exception, information);
        }
            ...
            lock (this.readLock)
            {
                try
                {
                    try
                    {
                        ...
                        if (this.closeState == CloseState.HandleClosed)
                        {
                            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(this.CreatePipeClosedException(TransferOperation.Read));
                        }
                        if (!haveResult)
                        {
                    ...
                    {
                        throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(this.ConvertPipeException(exception, TransferOperation.Read));
                    }
                }
                catch (Exception exception2)
                {
                    if (System.ServiceModel.DiagnosticUtility.IsFatal(exception2))
                    {
                        throw;
                    }
            ...
            lock (this.writeLock)
            {
                try
                {
                    try
                    {
                        if (this.closeState == CloseState.HandleClosed)
                        {
                            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(this.CreatePipeClosedException(TransferOperation.Write));
                        }
                        if (!haveResult)
                        {
                        ...
                        {
                            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new PipeException(System.ServiceModel.SR.GetString("PipeWriteIncomplete")));
                        }
                    }
                    catch (PipeException exception2)
                    {
                ...
                {
                    if (System.ServiceModel.DiagnosticUtility.IsFatal(exception3))
                    {
                        throw;
                    }
                    e = exception3;
        ...
        public int Read(byte[] buffer, int offset, int size, TimeSpan timeout)
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(this.ConvertPipeException(exception, TransferOperation.Read), this.ExceptionEventType);
            }
            return num2;
        }
        ...
        public void Shutdown(TimeSpan timeout)
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(this.ConvertPipeException(exception, TransferOperation.Undefined), this.ExceptionEventType);
            }
        }
        ...
        private void ValidateEnterReadingState(bool checkEOF)
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new PipeException(System.ServiceModel.SR.GetString("PipeAlreadyClosing")), this.ExceptionEventType);
            }
            if (this.inReadingState)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new PipeException(System.ServiceModel.SR.GetString("PipeReadPending")), this.ExceptionEventType);
            }
            if (this.closeState == CloseState.HandleClosed)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new PipeException(System.ServiceModel.SR.GetString("PipeClosed")), this.ExceptionEventType);
            }
        }
        ...
        private void ValidateEnterWritingState(bool checkShutdown)
        {
            if (checkShutdown)
            {
                if (this.isShutdownWritten)
                {
                    throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new PipeException(System.ServiceModel.SR.GetString("PipeAlreadyShuttingDown")), this.ExceptionEventType);
                }
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new PipeException(System.ServiceModel.SR.GetString("PipeWritePending")), this.ExceptionEventType);
            }
            if (this.closeState == CloseState.HandleClosed)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelper(new PipeException(System.ServiceModel.SR.GetString("PipeClosed")), this.ExceptionEventType);
        ...
        public byte[] AsyncReadBuffer
        {
            get
            {
                ...
                {
                    Interlocked.CompareExchange<byte[]>(ref this.asyncReadBuffer, System.ServiceModel.DiagnosticUtility.Utility.AllocateByteArray(this.AsyncReadBufferSize), null);
                }
        ...
        private IOThreadTimer ReadTimer
        {
            get
            {
                if (this.readTimer == null)
                {
                    ...
                    {
                        onReadTimeout = new WaitCallback(PipeConnection.OnReadTimeout);
                    }
        ...
        private IOThreadTimer WriteTimer
        {
            get
            {
                if (this.writeTimer == null)
                {
                    ...
                    {
                        onWriteTimeout = new WaitCallback(PipeConnection.OnWriteTimeout);
                    }
        ...
        private static class Exceptions
        {
            private static PipeException CreateException(string resourceString, int error) => 
                new PipeException(System.ServiceModel.SR.GetString(resourceString, new object[] { PipeError.GetErrorString(error) }), error);

            public static PipeException CreateReadException(int error) => 
                CreateException("PipeReadError", error);

            public static PipeException CreateWriteException(int error) => 
                CreateException("PipeWriteError", error);
