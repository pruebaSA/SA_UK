namespace System.ServiceModel.Channels
{
    ...
    internal class ReliableChannelCloseAsyncResult : AsyncResult
    {
        ...
        private static AsyncCallback onBinderCloseComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelCloseAsyncResult.OnBinderCloseComplete));
        private static AsyncCallback onComposeAsyncOperationsComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableChannelCloseAsyncResult.OnComposeAsyncOperationsComplete));
