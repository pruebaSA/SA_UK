namespace System.ServiceModel.Channels
{
    ...
    public abstract class MessageFault
    {
        ...
        public T GetDetail<T>() => 
            this.GetDetail<T>(DataContractSerializerDefaults.CreateSerializer(typeof(T), 0x7fffffff));
