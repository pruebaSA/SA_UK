namespace System.ServiceModel.Channels
{
    ...
    internal class ReplyChannelDemuxFailureAsyncResult : AsyncResult
    {
        ...
        private static AsyncCallback demuxFailureHandlerCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReplyChannelDemuxFailureAsyncResult.DemuxFailureHandlerCallback));
