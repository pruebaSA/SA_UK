namespace System.ServiceModel.Channels
{
    ...
    internal class ServerSingletonPreambleConnectionReader : InitialServerConnectionReader
    {
        ...
        public ServerSingletonPreambleConnectionReader(IConnection connection, ItemDequeuedCallback connectionDequeuedCallback, long streamPosition, int offset, int size, TransportSettingsCallback transportSettingsCallback, ConnectionClosedCallback closedCallback, ServerSingletonPreambleCallback callback) : base(connection, closedCallback)
        {
