namespace System.ServiceModel.Channels
{
    ...
    internal abstract class SingletonConnectionReader
    {
        ...
        public IAsyncResult BeginReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ReceiveAsyncResult(this, timeout, callback, state);
        ...
        public Message Receive(TimeSpan timeout)
        {
            ...
            if (this.size > 0)
            {
                System.Buffer.BlockCopy(this.connection.AsyncReadBuffer, this.offset, dst, this.offset, this.size);
            }
            TimeoutHelper helper = new TimeoutHelper(timeout);
            ...
            if (this.size > 0)
            {
                ...
                System.Buffer.BlockCopy(dst, this.offset, buffer2, 0, this.size);
        ...
        public RequestContext ReceiveRequest(TimeSpan timeout) => 
            new StreamedFramingRequestContext(this, this.Receive(timeout));
        ...
        private class ReceiveAsyncResult : AsyncResult
        {
            ...
            private static WaitCallback onReceiveScheduled = new WaitCallback(SingletonConnectionReader.ReceiveAsyncResult.OnReceiveScheduled);
            ...
            public static Message End(IAsyncResult result) => 
                AsyncResult.End<SingletonConnectionReader.ReceiveAsyncResult>(result).message;
        ...
        private class SingletonInputConnectionStream : ConnectionStream
        {
            ...
            public override IAsyncResult BeginRead(byte[] buffer, int offset, int count, AsyncCallback callback, object state) => 
                new ReadAsyncResult(this, buffer, offset, count, callback, state);
            ...
            private void DecodeSize(byte[] buffer, ref int offset, ref int size)
            {
                while (size > 0)
                {
                    ...
                    {
                        System.Buffer.BlockCopy(buffer, offset, this.chunkBuffer, 0, size);
            ...
            public override int Read(byte[] buffer, int offset, int count)
            {
                ...
                while (count != 0)
                {
                    ...
                    if (this.chunkBufferSize > 0)
                    {
                        ...
                        System.Buffer.BlockCopy(this.chunkBuffer, this.chunkBufferOffset, buffer, offset, num2);
                    ...
                    else
                    {
                        ...
                        {
                            int num3 = this.ReadCore(buffer, offset, Math.Min(count, this.chunkBytesRemaining + 5));
                            ...
                            if (num3 > this.chunkBytesRemaining)
                            {
                                ...
                                int size = num3 - this.chunkBytesRemaining;
                                int num5 = offset + this.chunkBytesRemaining;
                                this.chunkBytesRemaining = 0;
                                this.DecodeSize(buffer, ref num5, ref size);
                                return num;
                            }
                            num += num3;
            ...
            public class ReadAsyncResult : AsyncResult
            {
                ...
                public static int End(IAsyncResult result) => 
                    AsyncResult.End<SingletonConnectionReader.SingletonInputConnectionStream.ReadAsyncResult>(result).result;
            }
        }
