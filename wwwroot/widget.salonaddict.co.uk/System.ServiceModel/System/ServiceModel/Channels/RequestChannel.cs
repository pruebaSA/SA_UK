namespace System.ServiceModel.Channels
{
    ...
    internal abstract class RequestChannel : ChannelBase, IRequestChannel, IChannel, ICommunicationObject
    {
        ...
        protected IAsyncResult BeginWaitForPendingRequests(TimeSpan timeout, AsyncCallback callback, object state) => 
            new WaitForPendingRequestsAsyncResult(timeout, this, this.SetupWaitForPendingRequests(), callback, state);
        ...
        public Message Request(Message message, TimeSpan timeout)
        {
            ...
            try
            {
                ...
                if (DiagnosticUtility.ShouldTraceInformation)
                {
                    TraceUtility.TraceEvent(TraceEventType.Information, TraceCode.RequestChannelReplyReceived, message2);
                }
                message3 = message2;
            }
            finally
