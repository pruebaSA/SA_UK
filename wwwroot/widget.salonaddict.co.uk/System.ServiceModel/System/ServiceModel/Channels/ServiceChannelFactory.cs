namespace System.ServiceModel.Channels
{
    ...
    internal abstract class ServiceChannelFactory : ChannelFactoryBase
    {
        ...
        public static ServiceChannelFactory BuildChannelFactory(ServiceEndpoint serviceEndpoint)
        {
            ...
            foreach (Type type in requiredChannels)
            {
                ...
                if ((type == typeof(IDuplexSessionChannel)) && binding2.CanBuildChannelFactory<IDuplexSessionChannel>(parameters))
                {
                    ...
                    return new ServiceChannelFactoryOverDuplexSession(binding2.BuildChannelFactory<IDuplexSessionChannel>(parameters), clientRuntime, binding);
                }
            }
        ...
        public static ServiceChannelFactory BuildChannelFactory(ChannelBuilder channelBuilder, System.ServiceModel.Dispatcher.ClientRuntime clientRuntime)
        {
            ...
            {
                return new ServiceChannelFactoryOverDuplexSession(channelBuilder.BuildChannelFactory<IDuplexSessionChannel>(), clientRuntime, channelBuilder.Binding);
            }
        ...
        public void ChannelCreated(IChannel channel)
        {
            ...
            {
                DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Verbose, TraceCode.ChannelCreated, System.ServiceModel.SR.GetString("TraceCodeChannelCreated", new object[] { DiagnosticTrace.CreateSourceString(channel) }), null, null, this);
            }
            lock (base.ThisLock)
            {
        ...
        public void ChannelDisposed(IChannel channel)
        {
            if (DiagnosticUtility.ShouldTraceVerbose)
            {
                DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Verbose, TraceCode.ChannelDisposed, System.ServiceModel.SR.GetString("TraceCodeChannelDisposed", new object[] { DiagnosticTrace.CreateSourceString(channel) }), null, null, this);
            }
            lock (base.ThisLock)
            {
        ...
        public TChannel CreateChannel<TChannel>(EndpointAddress address) => 
            this.CreateChannel<TChannel>(address, null);
        ...
        public object CreateChannel(Type channelType, EndpointAddress address) => 
            this.CreateChannel(channelType, address, null);
        ...
        protected override TimeSpan DefaultCloseTimeout =>
            this.timeouts.CloseTimeout;

        protected override TimeSpan DefaultOpenTimeout =>
            this.timeouts.OpenTimeout;

        protected override TimeSpan DefaultReceiveTimeout =>
            this.timeouts.ReceiveTimeout;

        protected override TimeSpan DefaultSendTimeout =>
            this.timeouts.SendTimeout;
        ...
        private class ServiceChannelFactoryOverDuplex : ServiceChannelFactory.TypedServiceChannelFactory<IDuplexChannel>
        {
            ...
            protected override IChannelBinder CreateInnerChannelBinder(EndpointAddress to, Uri via) => 
                new DuplexChannelBinder(base.InnerChannelFactory.CreateChannel(to, via), base.RequestReplyCorrelator);
        }
        ...
        {
            public ServiceChannelFactoryOverDuplexSession(IChannelFactory<IDuplexSessionChannel> innerChannelFactory, ClientRuntime clientRuntime, Binding binding) : base(innerChannelFactory, clientRuntime, binding)
            {
            }
        ...
        private class ServiceChannelFactoryOverOutput : ServiceChannelFactory.TypedServiceChannelFactory<IOutputChannel>
        {
            ...
            protected override IChannelBinder CreateInnerChannelBinder(EndpointAddress to, Uri via) => 
                new OutputChannelBinder(base.InnerChannelFactory.CreateChannel(to, via));
        }
        ...
        private class ServiceChannelFactoryOverRequest : ServiceChannelFactory.TypedServiceChannelFactory<IRequestChannel>
        {
            ...
            protected override IChannelBinder CreateInnerChannelBinder(EndpointAddress to, Uri via) => 
                new RequestChannelBinder(base.InnerChannelFactory.CreateChannel(to, via));
        }
        ...
        private abstract class TypedServiceChannelFactory<TChannel> : ServiceChannelFactory where TChannel: class, IChannel
        {
            ...
            protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginClose), new ChainedEndHandler(this.OnEndClose), new ChainedBeginHandler(this.innerChannelFactory.BeginClose), new ChainedEndHandler(this.innerChannelFactory.EndClose));

            protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerChannelFactory.BeginOpen(timeout, callback, state);
