namespace System.ServiceModel.Channels
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        internal static string GetComputerName(ComputerNameFormat nameType)
        {
            ...
            if (size < 0)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(System.ServiceModel.SR.GetString("GetComputerNameReturnedInvalidLenth", new object[] { size })));
            }
            ...
            if (!GetComputerNameEx(nameType, lpBuffer, ref size))
            {
                ...
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new Win32Exception(num3));
            }
        ...
        internal static unsafe bool HasOverlappedIoCompleted(NativeOverlapped* overlapped) => 
            (overlapped.InternalLow != ((IntPtr) 0x103));
