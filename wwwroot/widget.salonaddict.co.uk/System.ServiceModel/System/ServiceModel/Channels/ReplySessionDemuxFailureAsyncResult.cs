namespace System.ServiceModel.Channels
{
    ...
    internal class ReplySessionDemuxFailureAsyncResult : ReplyChannelDemuxFailureAsyncResult
    {
        ...
        private static AsyncCallback closeChannelCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReplySessionDemuxFailureAsyncResult.ChannelCloseCallback));
