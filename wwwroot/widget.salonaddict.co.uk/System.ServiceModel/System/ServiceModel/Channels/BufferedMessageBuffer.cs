namespace System.ServiceModel.Channels
{
    ...
    internal class BufferedMessageBuffer : MessageBuffer
    {
        ...
        public BufferedMessageBuffer(IBufferedMessageData messageData, KeyValuePair<string, object>[] properties, bool[] understoodHeaders)
        {
        ...
        public override Message CreateMessage()
        {
            lock (this.ThisLock)
            {
                ...
                BufferedMessage message = new BufferedMessage(this.messageData, recycledMessageState, this.understoodHeaders);
