namespace System.ServiceModel.Channels
{
    ...
    public sealed class MessageVersion
    {
        ...
        public static MessageVersion CreateVersion(EnvelopeVersion envelopeVersion) => 
            CreateVersion(envelopeVersion, AddressingVersion.WSAddressing10);
        ...
        public override string ToString() => 
            System.ServiceModel.SR.GetString("MessageVersionToStringFormat", new object[] { this.envelope.ToString(), this.addressing.ToString() });
