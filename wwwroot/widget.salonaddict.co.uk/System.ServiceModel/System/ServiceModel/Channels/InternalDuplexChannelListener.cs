namespace System.ServiceModel.Channels
{
    ...
    internal sealed class InternalDuplexChannelListener : DelegatingChannelListener<IDuplexChannel>
    {
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedCloseAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginClose), new ChainedEndHandler(this.OnEndClose), new ICommunicationObject[] { this.innerChannelFactory });

        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedOpenAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginOpen), new ChainedEndHandler(this.OnEndOpen), new ICommunicationObject[] { this.innerChannelFactory });
        ...
        private sealed class CompositeDuplexChannelAcceptor : LayeredChannelAcceptor<IDuplexChannel, IInputChannel>
        {
            ...
            protected override IDuplexChannel OnAcceptChannel(IInputChannel innerChannel) => 
                new InternalDuplexChannelListener.ServerCompositeDuplexChannel((InternalDuplexChannelListener) base.ChannelManager, innerChannel);
        }
        ...
        private sealed class ServerCompositeDuplexChannel : ChannelBase, IDuplexChannel, IInputChannel, IOutputChannel, IChannel, ICommunicationObject
        {
            ...
            public IAsyncResult BeginTryReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerInputChannel.BeginTryReceive(timeout, callback, state);

            public IAsyncResult BeginWaitForMessage(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerInputChannel.BeginWaitForMessage(timeout, callback, state);
            ...
            public bool EndTryReceive(IAsyncResult result, out Message message) => 
                this.innerInputChannel.EndTryReceive(result, out message);

            public bool EndWaitForMessage(IAsyncResult result) => 
                this.innerInputChannel.EndWaitForMessage(result);
            ...
            protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerInputChannel.BeginClose(timeout, callback, state);

            protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.innerInputChannel.BeginOpen(callback, state);
            ...
            public bool TryReceive(TimeSpan timeout, out Message message) => 
                this.innerInputChannel.TryReceive(timeout, out message);
            ...
            public bool WaitForMessage(TimeSpan timeout) => 
                this.innerInputChannel.WaitForMessage(timeout);

            private InternalDuplexChannelListener Listener =>
                ((InternalDuplexChannelListener) base.Manager);

            public EndpointAddress LocalAddress =>
                this.innerInputChannel.LocalAddress;
            ...
            private class SendAsyncResult : AsyncResult
            {
                ...
                private static AsyncCallback sendCompleteCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(InternalDuplexChannelListener.ServerCompositeDuplexChannel.SendAsyncResult.SendCompleteCallback));
