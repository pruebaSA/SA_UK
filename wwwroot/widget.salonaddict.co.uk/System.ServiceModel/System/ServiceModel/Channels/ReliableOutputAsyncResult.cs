namespace System.ServiceModel.Channels
{
    ...
    internal abstract class ReliableOutputAsyncResult : AsyncResult
    {
        ...
        private static AsyncCallback operationCallback = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReliableOutputAsyncResult.OperationCallback));
        ...
        public void Begin(TimeSpan timeout)
        {
            ...
            else
            {
                ...
                {
                    if (DiagnosticUtility.IsFatal(exception) || !this.HandleException(exception))
                    {
                        throw;
                    }
                    flag = true;
        ...
        {
            protected get => 
                this.messageAttemptInfo.Message;
            set
            {
