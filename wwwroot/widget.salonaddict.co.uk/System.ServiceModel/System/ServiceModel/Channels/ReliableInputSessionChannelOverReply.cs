        ...
        private void ProcessRequest(RequestContext context, WsrmMessageInfo info)
        {
            ...
            Label_0104:
                ...
                else if (flag7 && ((info.TerminateSequenceInfo != null) || (info.CloseSequenceInfo != null)))
                {
                    ...
                    WsrmRequestInfo info2 = flag11 ? ((WsrmRequestInfo) info.TerminateSequenceInfo) : ((WsrmRequestInfo) info.CloseSequenceInfo);
                    long last = flag11 ? info.TerminateSequenceInfo.LastMsgNumber : info.CloseSequenceInfo.LastMsgNumber;
                    ...
                    lock (base.ThisLock)
                    {
                        ...
                        {
                            flag13 = last == base.Connection.Last;
                    ...
                    {
                        message2 = flag11 ? WsrmUtilities.CreateTerminateResponseMessage(base.Listener.MessageVersion, info2.MessageId, base.ReliableSession.InputID) : WsrmUtilities.CreateCloseSequenceResponse(base.Listener.MessageVersion, info2.MessageId, base.ReliableSession.InputID);
                        flag8 = true;
                    }
                }
            Label_05B3:
