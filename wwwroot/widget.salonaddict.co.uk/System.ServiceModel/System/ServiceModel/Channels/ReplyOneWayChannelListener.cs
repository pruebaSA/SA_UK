namespace System.ServiceModel.Channels
{
    ...
    internal class ReplyOneWayChannelListener : LayeredChannelListener<IInputChannel>
    {
        ...
        protected override IAsyncResult OnBeginAcceptChannel(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.innerChannelListener.BeginAcceptChannel(timeout, callback, state);

        protected override IAsyncResult OnBeginWaitForChannel(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.innerChannelListener.BeginWaitForChannel(timeout, callback, state);
        ...
        protected override bool OnEndWaitForChannel(IAsyncResult result) => 
            this.innerChannelListener.EndWaitForChannel(result);
        ...
        protected override bool OnWaitForChannel(TimeSpan timeout) => 
            this.innerChannelListener.WaitForChannel(timeout);
        ...
        private class ReplyOneWayInputChannel : LayeredChannel<IReplyChannel>, IInputChannel, IChannel, ICommunicationObject
        {
            ...
            public IAsyncResult BeginReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
                new ReceiveAsyncResult(base.InnerChannel, timeout, this.validateHeader, callback, state);

            public IAsyncResult BeginTryReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
                new TryReceiveAsyncResult(base.InnerChannel, timeout, this.validateHeader, callback, state);
            ...
            private class ReceiveAsyncResult : ReplyOneWayChannelListener.ReplyOneWayInputChannel.ReceiveAsyncResultBase
            {
                ...
                public static Message End(IAsyncResult result) => 
                    AsyncResult.End<ReplyOneWayChannelListener.ReplyOneWayInputChannel.ReceiveAsyncResult>(result).Message;
            ...
            private abstract class ReceiveAsyncResultBase : AsyncResult
            {
                ...
                private static AsyncCallback onReceiveRequest = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReplyOneWayChannelListener.ReplyOneWayInputChannel.ReceiveAsyncResultBase.OnReceiveRequest));
                private static AsyncCallback onReply = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReplyOneWayChannelListener.ReplyOneWayInputChannel.ReceiveAsyncResultBase.OnReply));
            ...
            private class TryReceiveAsyncResult : ReplyOneWayChannelListener.ReplyOneWayInputChannel.ReceiveAsyncResultBase
            {
                ...
                protected override IAsyncResult OnBeginReceiveRequest(TimeSpan timeout, AsyncCallback callback, object state) => 
                    base.InnerChannel.BeginTryReceiveRequest(timeout, callback, state);
