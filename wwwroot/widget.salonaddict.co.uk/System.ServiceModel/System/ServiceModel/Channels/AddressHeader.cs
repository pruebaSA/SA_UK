namespace System.ServiceModel.Channels
{
    ...
    public abstract class AddressHeader
    {
        ...
        public static AddressHeader CreateAddressHeader(string name, string ns, object value) => 
            CreateAddressHeader(name, ns, value, DataContractSerializerDefaults.CreateSerializer(GetObjectType(value), name, ns, 0x7fffffff));

        internal static AddressHeader CreateAddressHeader(XmlDictionaryString name, XmlDictionaryString ns, object value) => 
            new DictionaryAddressHeader(name, ns, value);
        ...
        internal string GetComparableForm() => 
            this.GetComparableForm(new StringBuilder());

        internal string GetComparableForm(StringBuilder builder) => 
            EndpointAddressProcessor.GetComparableForm(builder, this.GetComparableReader());
        ...
        public override int GetHashCode() => 
            this.GetComparableForm().GetHashCode();
        ...
        public T GetValue<T>() => 
            this.GetValue<T>(DataContractSerializerDefaults.CreateSerializer(typeof(T), this.Name, this.Namespace, 0x7fffffff));
