    ...
    internal struct ChannelRequirements
    {
        ...
        public static Type[] ComputeRequiredChannels(ref ChannelRequirements requirements)
        {
            ...
            else if (requirements.usesInput && requirements.usesReply)
            {
                ...
                {
                    case SessionMode.Allowed:
                        return new Type[] { typeof(IRequestChannel), typeof(IRequestSessionChannel), typeof(IDuplexChannel), typeof(IDuplexSessionChannel) };

                    case SessionMode.Required:
                        return new Type[] { typeof(IRequestSessionChannel), typeof(IDuplexSessionChannel) };
            ...
            else if (requirements.usesInput)
            {
                ...
                {
                    case SessionMode.Allowed:
                        return new Type[] { typeof(IOutputChannel), typeof(IOutputSessionChannel), typeof(IRequestChannel), typeof(IRequestSessionChannel), typeof(IDuplexChannel), typeof(IDuplexSessionChannel) };

                    case SessionMode.Required:
                        return new Type[] { typeof(IOutputSessionChannel), typeof(IRequestSessionChannel), typeof(IDuplexSessionChannel) };

                    case SessionMode.NotAllowed:
                        return new Type[] { typeof(IOutputChannel), typeof(IRequestChannel), typeof(IDuplexChannel) };
                }
            }
            ...
            else
            {
                ...
                {
                    case SessionMode.Allowed:
                        return new Type[] { typeof(IOutputSessionChannel), typeof(IOutputChannel), typeof(IRequestSessionChannel), typeof(IRequestChannel), typeof(IDuplexChannel), typeof(IDuplexSessionChannel) };
