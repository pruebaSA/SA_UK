namespace System.ServiceModel.Channels
{
    ...
    internal abstract class InitialServerConnectionReader : IDisposable
    {
        ...
        private ItemDequeuedCallback connectionDequeuedCallback;
        ...
        public static IAsyncResult BeginUpgradeConnection(IConnection connection, StreamUpgradeAcceptor upgradeAcceptor, IDefaultCommunicationTimeouts defaultTimeouts, AsyncCallback callback, object state) => 
            new UpgradeConnectionAsyncResult(connection, upgradeAcceptor, defaultTimeouts, callback, state);
        ...
        public static IConnection EndUpgradeConnection(IAsyncResult result) => 
            UpgradeConnectionAsyncResult.End(result);

        public ItemDequeuedCallback GetConnectionDequeuedCallback()
        {
            ItemDequeuedCallback connectionDequeuedCallback = this.connectionDequeuedCallback;
        ...
        private class UpgradeConnectionAsyncResult : AsyncResult
        {
            ...
            private static AsyncCallback onAcceptUpgrade = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(InitialServerConnectionReader.UpgradeConnectionAsyncResult.OnAcceptUpgrade));
            ...
            public static IConnection End(IAsyncResult result) => 
                AsyncResult.End<InitialServerConnectionReader.UpgradeConnectionAsyncResult>(result).connection;
