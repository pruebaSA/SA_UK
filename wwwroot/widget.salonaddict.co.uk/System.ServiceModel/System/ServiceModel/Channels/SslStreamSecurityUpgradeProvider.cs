namespace System.ServiceModel.Channels
{
    ...
    internal class SslStreamSecurityUpgradeProvider : StreamSecurityUpgradeProvider, IStreamUpgradeChannelBindingProvider, IChannelBindingProvider
    {
        ...
        public static SslStreamSecurityUpgradeProvider CreateServerProvider(SslStreamSecurityBindingElement bindingElement, BindingContext context)
        {
            ...
            return new SslStreamSecurityUpgradeProvider(context.Binding, serverTokenProvider, bindingElement.RequireClientCertificate, TransportSecurityHelpers.GetCertificateTokenAuthenticator(tokenManager, context.Binding.Scheme), context.Binding.Scheme, bindingElement.IdentityVerifier);
        }
        ...
        internal override T GetProperty<T>() where T: class
        {
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            System.ServiceModel.Security.SecurityUtils.BeginCloseTokenAuthenticatorIfRequired(this.clientCertificateAuthenticator, timeout, callback, state);
        ...
        public SecurityTokenManager ClientSecurityTokenManager =>
            this.clientSecurityTokenManager;
        ...
        private class OpenAsyncResult : AsyncResult
        {
            ...
            public OpenAsyncResult(SslStreamSecurityUpgradeProvider parent, TimeSpan timeout, AsyncCallback callback, object state) : base(callback, state)
            {
                ...
                this.onOpenTokenAuthenticator = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnOpenTokenAuthenticator));
            ...
            private bool HandleOpenTokenProviderComplete(IAsyncResult result)
            {
                ...
                this.onGetToken = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnGetToken));
