namespace System.ServiceModel.Channels
{
    ...
    internal class PeerInputChannel : InputChannel
    {
        ...
        protected override IAsyncResult OnBeginClose(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginCloseNode), new ChainedEndHandler(this.OnEndCloseNode), new ChainedBeginHandler(this.OnBeginClose), new ChainedEndHandler(this.OnEndClose));

        private IAsyncResult OnBeginCloseNode(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.peerNode.InnerNode.BeginClose(timeout, callback, state);

        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ChainedAsyncResult(timeout, callback, state, new ChainedBeginHandler(this.OnBeginOpen), new ChainedEndHandler(this.OnEndOpen), new ChainedBeginHandler(this.OnBeginOpenNode), new ChainedEndHandler(this.OnEndOpenNode));

        private IAsyncResult OnBeginOpenNode(TimeSpan timeout, AsyncCallback callback, object state) => 
            this.peerNode.InnerNode.BeginOpen(timeout, callback, state, true);
