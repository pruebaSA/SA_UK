namespace System.ServiceModel.Channels
{
    ...
    internal abstract class FramingDuplexSessionChannel : TransportOutputChannel, IDuplexSessionChannel, IDuplexChannel, IInputChannel, IOutputChannel, IChannel, ICommunicationObject, ISessionChannel<IDuplexSession>
    {
        ...
        public IAsyncResult BeginTryReceive(TimeSpan timeout, AsyncCallback callback, object state) => 
            new TryReceiveAsyncResult(this, timeout, callback, state);
        ...
        private ArraySegment<byte> EncodeMessage(Message message) => 
            SessionEncoder.EncodeMessageFrame(this.MessageEncoder.WriteMessage(message, 0x7fffffff, this.bufferManager, 6));
        ...
        public bool EndTryReceive(IAsyncResult result, out Message message) => 
            TryReceiveAsyncResult.End(result, out message);
        ...
        private class CloseAsyncResult : AsyncResult
        {
            ...
            private static AsyncCallback onCloseInputSession = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(FramingDuplexSessionChannel.CloseAsyncResult.OnCloseInputSession));
            private static AsyncCallback onCloseOutputSession = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(FramingDuplexSessionChannel.CloseAsyncResult.OnCloseOutputSession));
            private static WaitCallback onCompleteCloseScheduled;
            ...
            private bool ScheduleCompleteClose(bool isStillSynchronous)
            {
                if (isStillSynchronous)
                {
                    ...
                    {
                        onCompleteCloseScheduled = new WaitCallback(FramingDuplexSessionChannel.CloseAsyncResult.OnCompleteCloseScheduled);
                    }
        ...
        {
            private FramingDuplexSessionChannel channel;
            private static WaitCallback onEnterComplete = new WaitCallback(FramingDuplexSessionChannel.CloseOutputSessionAsyncResult.OnEnterComplete);
            private static AsyncCallback onWriteComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(FramingDuplexSessionChannel.CloseOutputSessionAsyncResult.OnWriteComplete));
            private TimeoutHelper timeoutHelper;
        ...
        private class ConnectionDuplexSession : IDuplexSession, IInputSession, IOutputSession, ISession
        {
            ...
            public IAsyncResult BeginCloseOutputSession(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.channel.BeginCloseOutputSession(timeout, callback, state);
        ...
        private class SendAsyncResult : TraceAsyncResult
        {
            ...
            private static WaitCallback onEnterComplete = new WaitCallback(FramingDuplexSessionChannel.SendAsyncResult.OnEnterComplete);
            private static AsyncCallback onWriteComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(FramingDuplexSessionChannel.SendAsyncResult.OnWriteComplete));
            private TimeoutHelper timeoutHelper;
        ...
        private class TryReceiveAsyncResult : AsyncResult
        {
            private FramingDuplexSessionChannel channel;
            private Message message;
            private static AsyncCallback onReceive = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(FramingDuplexSessionChannel.TryReceiveAsyncResult.OnReceive));
