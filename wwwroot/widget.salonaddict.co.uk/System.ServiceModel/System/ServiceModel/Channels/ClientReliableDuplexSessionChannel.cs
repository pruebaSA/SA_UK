namespace System.ServiceModel.Channels
{
    ...
    internal class ClientReliableDuplexSessionChannel : ReliableDuplexSessionChannel
    {
        ...
        private static AsyncCallback onReconnectComplete = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ClientReliableDuplexSessionChannel.OnReconnectComplete));
        private static WaitCallback onReconnectTimerElapsed = new WaitCallback(ClientReliableDuplexSessionChannel.OnReconnectTimerElapsed);
        ...
        protected override IAsyncResult OnBeginOpen(TimeSpan timeout, AsyncCallback callback, object state) => 
            new ReliableChannelOpenAsyncResult(base.Binder, base.ReliableSession, timeout, callback, state);
        ...
        protected override void OnOpened()
        {
            ...
            {
                IOThreadScheduler.ScheduleCallback(new WaitCallback(ClientReliableDuplexSessionChannel.StartReceivingStatic), this);
            }
        }
        ...
        private class DuplexClientReliableSession : ClientReliableSession, IDuplexSession, IInputSession, IOutputSession, ISession
        {
            ...
            public IAsyncResult BeginCloseOutputSession(TimeSpan timeout, AsyncCallback callback, object state) => 
                this.channel.OnBeginCloseOutputSession(timeout, callback, state);
