namespace System.ServiceModel
{
    ...
    {
        private WaitCallback backoffCallback;
        ...
        private TimeSpan WaitTimeWithDrift() => 
            Ticks.ToTimeSpan(Math.Max(Ticks.FromTimeSpan(defaultInitialWaitTime), Ticks.Add(Ticks.FromTimeSpan(this.waitTime), ((long) (((ulong) this.random.Next()) % ((2L * maxDriftTicks) + 1L))) - maxDriftTicks)));
