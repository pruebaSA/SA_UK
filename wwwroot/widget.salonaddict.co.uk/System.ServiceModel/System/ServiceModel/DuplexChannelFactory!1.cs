    ...
    public class DuplexChannelFactory<TChannel> : ChannelFactory<TChannel>
    {
        public DuplexChannelFactory(object callbackObject) : base(typeof(TChannel))
        {
            using (ServiceModelActivity activity = DiagnosticUtility.ShouldUseActivity ? ServiceModelActivity.CreateBoundedActivity() : null)
            {
                ...
                {
                    ServiceModelActivity.Start(activity, System.ServiceModel.SR.GetString("ActivityConstructChannelFactory", new object[] { DiagnosticTrace.CreateSourceString(this) }), ActivityType.Construct);
                }
        ...
        public TChannel CreateChannel(InstanceContext callbackInstance) => 
            this.CreateChannel(callbackInstance, base.CreateEndpointAddress(base.Endpoint), null);

        public static TChannel CreateChannel(object callbackObject, string endpointConfigurationName) => 
            DuplexChannelFactory<TChannel>.CreateChannel(DuplexChannelFactory<TChannel>.GetInstanceContextForObject(callbackObject), endpointConfigurationName);

        public override TChannel CreateChannel(EndpointAddress address, Uri via) => 
            this.CreateChannel(base.CallbackInstance, address, via);
        ...
        public static TChannel CreateChannel(object callbackObject, Binding binding, EndpointAddress endpointAddress) => 
            DuplexChannelFactory<TChannel>.CreateChannel(DuplexChannelFactory<TChannel>.GetInstanceContextForObject(callbackObject), binding, endpointAddress);
        ...
        public static TChannel CreateChannel(object callbackObject, Binding binding, EndpointAddress endpointAddress, Uri via) => 
            DuplexChannelFactory<TChannel>.CreateChannel(DuplexChannelFactory<TChannel>.GetInstanceContextForObject(callbackObject), binding, endpointAddress, via);
