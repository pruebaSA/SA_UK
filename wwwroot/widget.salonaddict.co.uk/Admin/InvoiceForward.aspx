<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="InvoiceForward.aspx.cs" Inherits="IFRAME.Admin.InvoiceForwardPage" %>
    ...
    <asp:Panel ID="pnl" runat="server" SkinID="BoxPanel" DefaultButton="btnSave" >
        ...
        <table class="details" cellpadding="0" cellspacing="0" >
           ...
           <tr>
              ...
              <td class="data-item" >
                 <asp:Literal ID="ltrTotalAmountDue" runat="server" EnableViewState="true" ></asp:Literal>
              </td>
           </tr>
          <tr>
