<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="InvoiceDetails.aspx.cs" Inherits="IFRAME.Admin.InvoiceDetailsPage" %>
        ...
        <table cellpadding="0" cellspacing="0" >
           <tr>
              ...
              <td style="vertical-align:top;" >
                 <p>&bull; <a href='<%= IFRMHelper.GetURL("invoiceadjustments.aspx", String.Format("{0}={1}", Constants.QueryStrings.SALON_INVOICE_ID, this.PostedSalonInvoiceId)) %>' ><u><%= base.GetLocaleResourceString("hlManageCredits.Text") %></u></a></p>
                 <p>&bull; <a href='<%= IFRMHelper.GetURL("invoiceWTs.aspx", String.Format("{0}={1}", Constants.QueryStrings.SALON_INVOICE_ID, this.PostedSalonInvoiceId)) %>' ><u><%= base.GetLocaleResourceString("hlManageTransactions.Text") %></u></a></p>
              </td>
           </tr>
        </table>
     </asp:Panel>
