<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Ticket-Alerts.aspx.cs" Inherits="IFRAME.Admin.SalonManagement.Ticket_AlertsPage" %>
        ...
        <table style="margin:-20px" cellpadding="0" cellspacing="20" >
           <tr>
              ...
              <td style="vertical-align:middle" >
                  <asp:Button ID="btnAdd" runat="server" SkinID="SubmitButton" OnClick="btnAdd_Click" Text="Add" />
              </td>
           </tr>
        </table>
