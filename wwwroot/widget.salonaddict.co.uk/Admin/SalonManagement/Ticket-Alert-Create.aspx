<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Ticket-Alert-Create.aspx.cs" Inherits="IFRAME.Admin.SalonManagement.Ticket_Alert_CreatePage" %>
