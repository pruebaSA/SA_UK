<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Settings.aspx.cs" Inherits="IFRAME.Admin.SalonManagement.SettingsPage" %>
    ...
    <asp:Panel ID="pnl" runat="server" SkinID="BoxPanel" >
        ...
        <table cellpadding="0" cellspacing="0" width="100%" >
           <tr>
              ...
              <td>
                 <p>&bull; <a href='<%= IFRMHelper.GetURL("opening-hours.aspx", String.Format("{0}={1}", Constants.QueryStrings.SALON_ID, this.PostedSalonId)) %>' ><u><%= base.GetLocaleResourceString("hlOpeningHoursEdit.Text") %></u></a></p>
                 <p>&bull; <a href='<%= IFRMHelper.GetURL("holidays.aspx", String.Format("{0}={1}", Constants.QueryStrings.SALON_ID, this.PostedSalonId)) %>' ><u><%= base.GetLocaleResourceString("hlHolidays.Text") %></u></a></p>
                 <p>&bull; <a href='<%= IFRMHelper.GetURL("settingcompany-edit.aspx", String.Format("{0}={1}", Constants.QueryStrings.SALON_ID, this.PostedSalonId)) %>' ><u>Change Company Name</u></a></p>
                 <p>&bull; <a href='<%= IFRMHelper.GetURL("settingvat-edit.aspx", String.Format("{0}={1}", Constants.QueryStrings.SALON_ID, this.PostedSalonId)) %>' ><u><%= base.GetLocaleResourceString("hlVAT.Text") %></u></a></p>
                 <p>&bull; <a href='<%= IFRMHelper.GetURL("ticket-alerts.aspx", String.Format("{0}={1}", Constants.QueryStrings.SALON_ID, this.PostedSalonId)) %>' ><u>Ticket Alerts</u></a></p>
              </td>
           </tr>
        </table>
    </asp:Panel>
