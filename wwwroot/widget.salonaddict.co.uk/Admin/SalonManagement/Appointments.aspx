<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Appointments.aspx.cs" Inherits="IFRAME.Admin.SalonManagement.AppointmentsPage" %>
              ...
              <td style="width:100%" >
                <asp:UpdatePanel ID="up" runat="server" UpdateMode="Conditional" >
                   ...
                   <Columns>
                      <asp:TemplateField>
                         <ItemTemplate>
                             <asp:HyperLink ID="hlMail" runat="server" NavigateUrl='<%# IFRMHelper.GetURL("appointment-details.aspx", String.Format("{0}={1}", Constants.QueryStrings.TICKET_ID, Eval("TicketId")), String.Format("{0}={1}", Constants.QueryStrings.SALON_ID, Eval("SalonId"))) %>' >
                     ...
                     <asp:TemplateField>
                      ...
                      <asp:TemplateField>
                         <ItemTemplate>
                              <asp:HyperLink ID="hlDetails" runat="server" NavigateUrl='<%# IFRMHelper.GetURL("appointment-details.aspx", String.Format("{0}={1}", Constants.QueryStrings.TICKET_ID, Eval("TicketId")), String.Format("{0}={1}", Constants.QueryStrings.SALON_ID, Eval("SalonId"))) %>'><u><%= base.GetLocaleResourceString("hlDetails.Text") %></u></asp:HyperLink>
                         </ItemTemplate>
                         <ItemStyle Width="40px" />
                      </asp:TemplateField>
                      </Columns>
