            ...
            get
            {
                if (this.properties == null)
                {
                    ConfigurationPropertyCollection propertys = new ConfigurationPropertyCollection {
                        new ConfigurationProperty("addressPrefix", typeof(string), "WsatService", null, new StringValidator(0, 0x7fffffff, null), ConfigurationPropertyOptions.None)
                    };
