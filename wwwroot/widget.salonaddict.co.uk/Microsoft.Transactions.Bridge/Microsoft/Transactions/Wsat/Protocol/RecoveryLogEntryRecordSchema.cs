namespace Microsoft.Transactions.Wsat.Protocol
{
    ...
    internal class RecoveryLogEntryRecordSchema : TraceRecord
    {
        ...
        public override string ToString() => 
            Microsoft.Transactions.SR.GetString("RecoveryLogEntryRecordSchema", new object[] { this.transactionId, this.RecoveryDataLength.ToString(CultureInfo.CurrentCulture), this.RecoveryDataBase64 });
        ...
        internal override string EventId =>
            "http://schemas.microsoft.com/2006/08/ServiceModel/RecoveryLogEntryTraceRecord";

        [DataMember(Name="RecoveryDataBase64", IsRequired=true)]
        private string RecoveryDataBase64
        {
            get => 
                Convert.ToBase64String(this.recoveryData);
            set
            {
            }
        }
