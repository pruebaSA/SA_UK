namespace Microsoft.Transactions.Wsat.Protocol
{
    ...
    internal class LookupTables
    {
        ...
        public TransactionEnlistment FindEnlistment(Guid enlistmentId) => 
            this.Find<Guid, TransactionEnlistment>(this.enlistments, this.enlistmentLock, enlistmentId);
        ...
        public TransactionContextManager FindOrAddTransactionContextManager(TransactionContextManager contextManager, out bool found) => 
            this.FindOrAdd<string, TransactionContextManager>(this.transactions, this.transactionLock, contextManager.Identifier, contextManager, out found);

        public TransactionContextManager FindTransactionContextManager(string contextId) => 
            this.Find<string, TransactionContextManager>(this.transactions, this.transactionLock, contextId);
