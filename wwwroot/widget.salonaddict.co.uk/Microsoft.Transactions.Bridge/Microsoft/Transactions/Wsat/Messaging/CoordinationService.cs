namespace Microsoft.Transactions.Wsat.Messaging
{
    ...
    internal class CoordinationService
    {
        ...
        private CoordinationServiceHost CreateService(object dispatcher, Type contract, string pathSuffix)
        {
            Binding namedPipeActivationBinding;
            ServiceCredentials serviceCredentials;
            CoordinationServiceHost host = new CoordinationServiceHost(this, dispatcher);
            host.InternalBaseAddresses.Add(this.httpsBaseAddressUri);
