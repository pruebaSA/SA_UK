namespace Microsoft.Transactions.Wsat.Messaging
{
    ...
    internal sealed class DebugTraceHelper
    {
        ...
        private string FormatMessage(string message) => 
            string.Format(CultureInfo.InvariantCulture, "{0} [{1,4:x8}] [{2}] : {3}", new object[] { DateTime.Now.ToString("u", DateTimeFormatInfo.InvariantInfo), Thread.CurrentThread.ManagedThreadId.ToString("x", CultureInfo.InvariantCulture), this.name, message });
