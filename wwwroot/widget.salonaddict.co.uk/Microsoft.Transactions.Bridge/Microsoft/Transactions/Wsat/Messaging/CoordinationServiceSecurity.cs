namespace Microsoft.Transactions.Wsat.Messaging
{
    ...
    internal class CoordinationServiceSecurity
    {
        ...
        private static SecurityStandardsManager CreateStandardsManager(MessageSecurityVersion securityVersion) => 
            new SecurityStandardsManager(securityVersion, new WSSecurityTokenSerializer(securityVersion.SecurityVersion, securityVersion.TrustVersion, securityVersion.SecureConversationVersion, false, null, null, null));

        public static byte[] DeriveIssuedTokenKey(Guid transactionId, string sctId) => 
            Psha1DerivedKeyGeneratorHelper.GenerateDerivedKey(transactionId.ToByteArray(), Label, Encoding.UTF8.GetBytes(sctId), SecurityAlgorithmSuite.Default.DefaultSymmetricKeyLength, 0);
        ...
        public static string GetSenderName(Message message) => 
            GetSenderName(message.Properties);
