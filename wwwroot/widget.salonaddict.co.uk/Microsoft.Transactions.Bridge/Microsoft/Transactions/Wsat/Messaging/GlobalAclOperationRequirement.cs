namespace Microsoft.Transactions.Wsat.Messaging
{
    ...
    internal class GlobalAclOperationRequirement : ServiceAuthorizationManager
    {
        ...
        public bool AccessCheckReply(Message reply, string binding) => 
            this.AccessCheck(reply.Properties.Security.ServiceSecurityContext.AuthorizationContext, reply.Properties, binding);
        ...
        protected override bool CheckAccessCore(OperationContext operationContext) => 
            this.AccessCheck(operationContext.ServiceSecurityContext.AuthorizationContext, operationContext.IncomingMessageProperties, operationContext.EndpointDispatcher.ChannelDispatcher.BindingName);
