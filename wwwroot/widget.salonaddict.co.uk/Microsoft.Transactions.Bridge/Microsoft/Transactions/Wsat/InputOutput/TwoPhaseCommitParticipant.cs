namespace Microsoft.Transactions.Wsat.InputOutput
{
    ...
    internal class TwoPhaseCommitParticipant : ITwoPhaseCommitParticipant
    {
        ...
        {
            this.state = state;
            this.durableSendComplete = Microsoft.Transactions.Bridge.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.DurableSendComplete));
            this.volatileSendComplete = Microsoft.Transactions.Bridge.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.VolatileSendComplete));
            this.politeSendComplete = Microsoft.Transactions.Bridge.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.PoliteSendComplete));
        }
