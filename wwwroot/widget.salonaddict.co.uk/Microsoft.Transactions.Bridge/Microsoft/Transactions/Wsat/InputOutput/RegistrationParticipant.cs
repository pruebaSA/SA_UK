namespace Microsoft.Transactions.Wsat.InputOutput
{
    ...
    internal class RegistrationParticipant
    {
        ...
        {
            this.state = state;
            this.sendDurableRegisterComplete = Microsoft.Transactions.Bridge.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnSendDurableRegisterComplete));
            this.sendVolatileRegisterComplete = Microsoft.Transactions.Bridge.DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(this.OnSendVolatileRegisterComplete));
        }
