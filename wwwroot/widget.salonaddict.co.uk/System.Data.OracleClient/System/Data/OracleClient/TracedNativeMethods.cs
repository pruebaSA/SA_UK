namespace System.Data.OracleClient
{
    ...
    internal static class TracedNativeMethods
    {
        ...
        {
            int num = System.Data.Common.UnsafeNativeMethods.OCIDescriptorAlloc(parenth, out hndlpp, type, 0, IntPtr.Zero);
            if (Bid.AdvancedOn)
            {
        ...
        internal static int OCIEnvCreate(out IntPtr envhpp, OCI.MODE mode)
        {
            ...
            int num = System.Data.Common.UnsafeNativeMethods.OCIEnvCreate(out envhpp, mode, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, 0, IntPtr.Zero);
            if (Bid.AdvancedOn)
            {
        ...
        internal static int OCIEnvNlsCreate(out IntPtr envhpp, OCI.MODE mode, ushort charset, ushort ncharset)
        {
            ...
            int num = System.Data.Common.UnsafeNativeMethods.OCIEnvNlsCreate(out envhpp, mode, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, IntPtr.Zero, 0, IntPtr.Zero, charset, ncharset);
            if (Bid.AdvancedOn)
            {
        ...
        {
            int num = System.Data.Common.UnsafeNativeMethods.OCIHandleAlloc(parenth, out hndlpp, type, 0, IntPtr.Zero);
            if (Bid.AdvancedOn)
            {
