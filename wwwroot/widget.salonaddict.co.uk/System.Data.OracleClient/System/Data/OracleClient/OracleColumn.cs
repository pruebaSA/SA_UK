namespace System.Data.OracleClient
{
    ...
    internal sealed class OracleColumn
    {
        ...
        internal Type GetFieldOracleType() => 
            this._metaType.NoConvertType;

        internal Type GetFieldType() => 
            this._metaType.BaseType;
        ...
        internal bool IsDBNull(NativeBuffer_RowBuffer buffer) => 
            (this._isNullable && (buffer.ReadInt16(this._indicatorOffset) == -1));
        ...
        internal bool IsLob =>
            this._metaType.IsLob;

        internal bool IsLong =>
            this._metaType.IsLong;

        internal bool IsNullable =>
            this._isNullable;

        internal System.Data.OracleClient.OracleType OracleType =>
            this._metaType.OracleType;
