namespace System.Data.OracleClient
{
    ...
    public sealed class OracleCommandBuilder : DbCommandBuilder
    {
        ...
        public OracleCommand GetDeleteCommand() => 
            ((OracleCommand) base.GetDeleteCommand());

        public OracleCommand GetDeleteCommand(bool useColumnsForParameterNames) => 
            ((OracleCommand) base.GetDeleteCommand(useColumnsForParameterNames));

        public OracleCommand GetInsertCommand() => 
            ((OracleCommand) base.GetInsertCommand());

        public OracleCommand GetInsertCommand(bool useColumnsForParameterNames) => 
            ((OracleCommand) base.GetInsertCommand(useColumnsForParameterNames));

        protected override string GetParameterName(int parameterOrdinal) => 
            ("p" + parameterOrdinal.ToString(CultureInfo.CurrentCulture));

        protected override string GetParameterName(string parameterName) => 
            parameterName;

        protected override string GetParameterPlaceholder(int parameterOrdinal) => 
            (":" + this.GetParameterName(parameterOrdinal));

        public OracleCommand GetUpdateCommand() => 
            ((OracleCommand) base.GetUpdateCommand());

        public OracleCommand GetUpdateCommand(bool useColumnsForParameterNames) => 
            ((OracleCommand) base.GetUpdateCommand(useColumnsForParameterNames));
        ...
        {
            get => 
                System.Data.Common.CatalogLocation.End;
            set
            {
        ...
        [System.Data.OracleClient.ResDescription("OracleCommandBuilder_DataAdapter"), DefaultValue((string) null), System.Data.OracleClient.ResCategory("OracleCategory_Update")]
        public OracleDataAdapter DataAdapter
        {
            get => 
                ((OracleDataAdapter) base.DataAdapter);
            set
            {
