namespace System.Data.Services.Client
{
    ...
    internal static class Evaluator
    {
        private static bool CanBeEvaluatedLocally(Expression expression) => 
            (((expression.NodeType != ExpressionType.Parameter) && (expression.NodeType != ExpressionType.Lambda)) && (expression.NodeType != ((ExpressionType) 0x2710)));

        internal static Expression PartialEval(Expression expression) => 
            PartialEval(expression, new Func<Expression, bool>(Evaluator.CanBeEvaluatedLocally));
