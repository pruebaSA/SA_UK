namespace System.IdentityModel
{
    ...
    internal static class DiagnosticUtility
    {
        ...
        internal const string EventSourceName = "System.IdentityModel 3.0.0.0";
        ...
        private static System.ServiceModel.Diagnostics.ExceptionUtility GetExceptionUtility()
        {
            lock (lockObject)
            {
                ...
                {
                    exceptionUtility = new System.ServiceModel.Diagnostics.ExceptionUtility("System.IdentityModel", "System.IdentityModel 3.0.0.0", diagnosticTrace);
                }
            }
        ...
        {
            diagnosticTrace = new System.ServiceModel.Diagnostics.DiagnosticTrace(sourceType, traceSourceName, "System.IdentityModel 3.0.0.0");
            UpdateLevel();
        }
