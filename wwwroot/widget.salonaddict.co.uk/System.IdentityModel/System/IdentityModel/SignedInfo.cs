namespace System.IdentityModel
{
    ...
    internal abstract class SignedInfo : ISecurityElement
    {
        ...
        protected string[] GetInclusivePrefixes() => 
            this.canonicalizationMethodElement.GetInclusivePrefixes();
        ...
        {
            get => 
                this.canonicalizationMethodElement.Algorithm;
            set
            {
        ...
        {
            get => 
                this.signatureMethodElement.Algorithm;
            set
            {
        ...
        {
            get => 
                this.signatureMethodElement.AlgorithmDictionaryString;
            set
            {
