namespace System.IdentityModel
{
    ...
    internal sealed class Reference
    {
        ...
        public bool CheckDigest() => 
            CryptoHelper.IsEqual(this.ComputeDigest(), this.GetDigestValue());
        ...
        public byte[] GetDigestValue() => 
            this.digestValueElement.Value;

        public bool IsStrTranform() => 
            ((this.TransformChain.TransformCount == 1) && (this.TransformChain[0].Algorithm == "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-soap-message-security-1.0#STR-Transform"));
        ...
        {
            get => 
                this.digestMethodElement.Algorithm;
            set
            {
        ...
        {
            get => 
                this.digestMethodElement.AlgorithmDictionaryString;
            set
            {
        ...
        public int TransformCount =>
            this.transformChain.TransformCount;
