namespace System.IdentityModel.Tokens
{
    ...
    public class RsaKeyIdentifierClause : SecurityKeyIdentifierClause
    {
        ...
        public byte[] GetExponent() => 
            System.IdentityModel.SecurityUtils.CloneBuffer(this.rsaParameters.Exponent);

        public byte[] GetModulus() => 
            System.IdentityModel.SecurityUtils.CloneBuffer(this.rsaParameters.Modulus);
        ...
        public override string ToString() => 
            string.Format(CultureInfo.InvariantCulture, "RsaKeyIdentifierClause(Modulus = {0}, Exponent = {1})", new object[] { Convert.ToBase64String(this.rsaParameters.Modulus), Convert.ToBase64String(this.rsaParameters.Exponent) });
