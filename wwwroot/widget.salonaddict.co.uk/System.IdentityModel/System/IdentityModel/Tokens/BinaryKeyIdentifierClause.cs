namespace System.IdentityModel.Tokens
{
    ...
    public abstract class BinaryKeyIdentifierClause : SecurityKeyIdentifierClause
    {
        ...
        public byte[] GetBuffer() => 
            System.IdentityModel.SecurityUtils.CloneBuffer(this.identificationData);
        ...
        internal string ToBase64String() => 
            Convert.ToBase64String(this.identificationData);

        internal string ToHexString() => 
            new SoapHexBinary(this.identificationData).ToString();
    }
}
