namespace System.IdentityModel.Tokens
{
    ...
    public class GenericXmlSecurityToken : SecurityToken
    {
        ...
        public GenericXmlSecurityToken(XmlElement tokenXml, SecurityToken proofToken, DateTime effectiveTime, DateTime expirationTime, SecurityKeyIdentifierClause internalTokenReference, SecurityKeyIdentifierClause externalTokenReference, ReadOnlyCollection<IAuthorizationPolicy> authorizationPolicies)
        {
            ...
            if ((internalTokenReference == null) && (this.id != null))
            {
                internalTokenReference = new LocalIdKeyIdentifierClause(this.id);
            }
        ...
        public override bool CanCreateKeyIdentifierClause<T>() where T: SecurityKeyIdentifierClause => 
            (((this.internalTokenReference != null) && (typeof(T) == this.internalTokenReference.GetType())) || ((this.externalTokenReference != null) && (typeof(T) == this.externalTokenReference.GetType())));
        ...
        public override bool MatchesKeyIdentifierClause(SecurityKeyIdentifierClause keyIdentifierClause) => 
            (((this.internalTokenReference != null) && this.internalTokenReference.Matches(keyIdentifierClause)) || ((this.externalTokenReference != null) && this.externalTokenReference.Matches(keyIdentifierClause)));
