namespace System.IdentityModel.Claims
{
    ...
    public class WindowsClaimSet : ClaimSet, IIdentityInfo, IDisposable
    {
        ...
        private WindowsClaimSet(WindowsClaimSet from) : this(from.WindowsIdentity, from.includeWindowsGroups, from.expirationTime, true)
        {
        }
        ...
        internal WindowsClaimSet(System.Security.Principal.WindowsIdentity windowsIdentity, bool includeWindowsGroups, bool clone) : this(windowsIdentity, includeWindowsGroups, DateTime.UtcNow.AddHours(10.0), clone)
        {
        }

        public WindowsClaimSet(System.Security.Principal.WindowsIdentity windowsIdentity, bool includeWindowsGroups, DateTime expirationTime) : this(windowsIdentity, includeWindowsGroups, expirationTime, true)
        {
        }

        internal WindowsClaimSet(System.Security.Principal.WindowsIdentity windowsIdentity, bool includeWindowsGroups, DateTime expirationTime, bool clone)
        {
        ...
        private static SafeHGlobalHandle GetTokenInformation(IntPtr tokenHandle, System.IdentityModel.TokenInformationClass tokenInformationClass, out uint dwLength)
        {
            ...
            bool flag = NativeMethods.GetTokenInformation(tokenHandle, (uint) tokenInformationClass, invalidHandle, 0, out dwLength);
            ...
            flag = NativeMethods.GetTokenInformation(tokenHandle, (uint) tokenInformationClass, invalidHandle, dwLength, out dwLength);
