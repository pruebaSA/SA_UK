namespace System.IdentityModel.Selectors
{
    ...
    public class SamlSecurityTokenAuthenticator : SecurityTokenAuthenticator
    {
        ...
        public SamlSecurityTokenAuthenticator(IList<SecurityTokenAuthenticator> supportingAuthenticators, TimeSpan maxClockSkew)
        {
            ...
            this.audienceUriMode = System.IdentityModel.Selectors.AudienceUriMode.Never;
            this.allowedAudienceUris = new Collection<string>();
        }

        protected override bool CanValidateTokenCore(SecurityToken token) => 
            (token is SamlSecurityToken);
        ...
        protected override ReadOnlyCollection<IAuthorizationPolicy> ValidateTokenCore(SecurityToken token)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SecurityTokenException(System.IdentityModel.SR.GetString("SAMLTokenTimeInvalid", new object[] { DateTime.Now.ToUniversalTime(), token2.ValidFrom.ToString(), token2.ValidTo.ToString() })));
            }
