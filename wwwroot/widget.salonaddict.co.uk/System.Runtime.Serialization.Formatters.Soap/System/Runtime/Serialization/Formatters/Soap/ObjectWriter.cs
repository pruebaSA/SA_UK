namespace System.Runtime.Serialization.Formatters.Soap
{
    ...
    internal sealed class ObjectWriter
    {
        ...
        private NameInfo TypeToNameInfo(WriteObjectInfo objectInfo) => 
            this.TypeToNameInfo(objectInfo.objectType, objectInfo, Converter.ToCode(objectInfo.objectType), null);

        private NameInfo TypeToNameInfo(Type type) => 
            this.TypeToNameInfo(type, null, Converter.ToCode(type), null);

        private NameInfo TypeToNameInfo(WriteObjectInfo objectInfo, NameInfo nameInfo) => 
            this.TypeToNameInfo(objectInfo.objectType, objectInfo, Converter.ToCode(objectInfo.objectType), nameInfo);
