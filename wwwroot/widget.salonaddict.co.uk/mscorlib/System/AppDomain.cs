namespace System
{
    ...
    public sealed class AppDomain : MarshalByRefObject, _AppDomain, IEvidenceFactory
    {
        ...
        private int ActivateApplication() => 
            ((int) Activator.CreateInstance(CurrentDomain.ActivationContext).Unwrap());
        ...
        public static AppDomain CreateDomain(string friendlyName) => 
            CreateDomain(friendlyName, null, null);

        public static AppDomain CreateDomain(string friendlyName, System.Security.Policy.Evidence securityInfo) => 
            CreateDomain(friendlyName, securityInfo, null);
        ...
        public object CreateInstanceAndUnwrap(string assemblyName, string typeName) => 
            this.CreateInstance(assemblyName, typeName)?.Unwrap();

        public object CreateInstanceAndUnwrap(string assemblyName, string typeName, object[] activationAttributes) => 
            this.CreateInstance(assemblyName, typeName, activationAttributes)?.Unwrap();
        ...
        public object CreateInstanceAndUnwrap(string assemblyName, string typeName, bool ignoreCase, BindingFlags bindingAttr, Binder binder, object[] args, CultureInfo culture, object[] activationAttributes, System.Security.Policy.Evidence securityAttributes) => 
            this.CreateInstance(assemblyName, typeName, ignoreCase, bindingAttr, binder, args, culture, activationAttributes, securityAttributes)?.Unwrap();
        ...
        public object CreateInstanceFromAndUnwrap(string assemblyName, string typeName) => 
            this.CreateInstanceFrom(assemblyName, typeName)?.Unwrap();

        public object CreateInstanceFromAndUnwrap(string assemblyName, string typeName, object[] activationAttributes) => 
            this.CreateInstanceFrom(assemblyName, typeName, activationAttributes)?.Unwrap();
        ...
        public object CreateInstanceFromAndUnwrap(string assemblyName, string typeName, bool ignoreCase, BindingFlags bindingAttr, Binder binder, object[] args, CultureInfo culture, object[] activationAttributes, System.Security.Policy.Evidence securityAttributes) => 
            this.CreateInstanceFrom(assemblyName, typeName, ignoreCase, bindingAttr, binder, args, culture, activationAttributes, securityAttributes)?.Unwrap();
        ...
        public int ExecuteAssembly(string assemblyFile) => 
            this.ExecuteAssembly(assemblyFile, null, null);

        public int ExecuteAssembly(string assemblyFile, System.Security.Policy.Evidence assemblySecurity) => 
            this.ExecuteAssembly(assemblyFile, assemblySecurity, null);
        ...
        public int ExecuteAssemblyByName(string assemblyName) => 
            this.ExecuteAssemblyByName(assemblyName, null, null);

        public int ExecuteAssemblyByName(string assemblyName, System.Security.Policy.Evidence assemblySecurity) => 
            this.ExecuteAssemblyByName(assemblyName, assemblySecurity, null);
        ...
        internal AssemblyBuilder InternalDefineDynamicAssembly(AssemblyName name, AssemblyBuilderAccess access, string dir, System.Security.Policy.Evidence evidence, PermissionSet requiredPermissions, PermissionSet optionalPermissions, PermissionSet refusedPermissions, ref StackCrawlMark stackMark, IEnumerable<CustomAttributeBuilder> unsafeAssemblyAttributes)
        {
            lock (typeof(AssemblyBuilderLock))
            {
                ...
                AssemblyBuilder assembly = new AssemblyBuilder((AssemblyBuilder) this.nCreateDynamicAssembly(name, evidence, ref stackMark, requiredPermissions, optionalPermissions, refusedPermissions, access, none));
                assembly.m_assemblyData = new AssemblyBuilderData(assembly, name.Name, access, dir);
                assembly.m_assemblyData.AddPermissionRequests(requiredPermissions, optionalPermissions, refusedPermissions);
                if (list != null)
                {
                    foreach (CustomAttributeBuilder builder3 in list)
                    {
                        assembly.SetCustomAttribute(builder3);
                    }
                }
                assembly.m_assemblyData.GetInMemoryAssemblyModule();
                return assembly;
            }
        }
        ...
        internal int nExecuteAssembly(Assembly assembly, string[] args) => 
            this._nExecuteAssembly(assembly.InternalAssembly, args);
        ...
        private Assembly ResolveAssemblyForIntrospection(object sender, ResolveEventArgs args) => 
            Assembly.ReflectionOnlyLoad(this.ApplyPolicy(args.Name));
        ...
        public System.ApplicationIdentity ApplicationIdentity =>
            this._applicationIdentity;

        public System.Security.Policy.ApplicationTrust ApplicationTrust =>
            this._applicationTrust;

        public string BaseDirectory =>
            this.FusionStore.ApplicationBase;
        ...
        public string RelativeSearchPath =>
            this.FusionStore.PrivateBinPath;
        ...
        public AppDomainSetup SetupInformation =>
            new AppDomainSetup(this.FusionStore, true);
