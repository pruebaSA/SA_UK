namespace System.Runtime.Remoting.Proxies
{
    ...
    public abstract class RealProxy
    {
        ...
        public virtual IntPtr GetCOMIUnknown(bool fIsMarshalled) => 
            MarshalByRefObject.GetComIUnknown((MarshalByRefObject) this.GetTransparentProxy());
        ...
        public IConstructionReturnMessage InitializeServerObject(IConstructionCallMessage ctorMsg)
        {
            ...
            if (e == null)
            {
                object[] outArgs = message2?.OutArgs;
                int outArgsCount = (outArgs == null) ? 0 : outArgs.Length;
                LogicalCallContext logicalCallContext = message2?.LogicalCallContext;
                message = new ConstructorReturnMessage(transparentProxy, outArgs, outArgsCount, logicalCallContext, ctorMsg);
                this.SetupIdentity();
        ...
        internal bool IsRemotingProxy() => 
            ((this._flags & RealProxyFlags.RemotingProxy) == RealProxyFlags.RemotingProxy);
        ...
        private void PrivateInvoke(ref MessageData msgData, int type)
        {
            ...
            else if (CallType.ConstructorCall == type2)
            {
                ...
                if (!this.IsRemotingProxy())
                {
                    ccm = new ConstructorCallMessage(null, null, null, this.GetProxiedType());
                }
                else
                {
        ...
        {
            get => 
                ((this._flags & RealProxyFlags.Initialized) == RealProxyFlags.Initialized);
            set
            {
                if (value)
                {
