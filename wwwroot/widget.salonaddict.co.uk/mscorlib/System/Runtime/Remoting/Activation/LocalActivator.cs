namespace System.Runtime.Remoting.Activation
{
    ...
    internal class LocalActivator : ContextAttribute, IActivator
    {
        ...
        public override bool IsContextOK(Context ctx, IConstructionCallMessage ctorMsg)
        {
            ...
            WellKnownClientTypeEntry entry = RemotingConfigHandler.IsWellKnownClientType(ctorMsg.ActivationType);
            string objectUrl = entry?.ObjectUrl;
            if (objectUrl != null)
            {
                ctorMsg.Properties["Connect"] = objectUrl;
                return false;
            }
            ActivatedClientTypeEntry entry2 = RemotingConfigHandler.IsRemotelyActivatedClientType(ctorMsg.ActivationType);
