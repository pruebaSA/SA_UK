namespace System.Runtime.Remoting
{
    ...
    internal class Identity
    {
        ...
        internal static string GetNewLogicalCallID() => 
            (IDGuidString + GetNextSeqNum());

        private static int GetNextSeqNum() => 
            SharedStatics.Remoting_Identity_GetNextSeqNum();
        ...
        internal void SetOrCreateURI(string uri, bool bIdCtor)
        {
            ...
            if (uri == null)
            {
                ...
                this._ObjURI = string.Concat(new object[] { IDGuidString, str.Replace('/', '_'), "_", GetNextSeqNum(), ".rem" }).ToLower(CultureInfo.InvariantCulture);
            }
        ...
        internal static string ProcessIDGuid =>
            SharedStatics.Remoting_Identity_IDGuid;

        internal ArrayWithSize ProxySideDynamicSinks =>
            this._dph?.DynamicSinks;

        internal MarshalByRefObject TPOrObject =>
            ((MarshalByRefObject) this._tpOrObject);
