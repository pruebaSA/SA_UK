namespace System.Runtime.Remoting.Channels
{
    ...
    public sealed class ChannelServices
    {
        ...
        internal static ServerIdentity CheckDisconnectedOrCreateWellKnownObject(IMessage msg)
        {
            ...
            string uRI = InternalSink.GetURI(msg);
            throw new RemotingException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Remoting_Disconnected"), new object[] { uRI }));
        }
        ...
        [Obsolete("Use System.Runtime.Remoting.ChannelServices.RegisterChannel(IChannel chnl, bool ensureSecurity) instead.", false), SecurityPermission(SecurityAction.Demand, Flags=SecurityPermissionFlag.RemotingConfiguration)]
        ...
        internal static unsafe void RegisterChannelInternal(IChannel chnl, bool ensureSecurity)
        {
            ...
            try
            {
                ...
                if (ensureSecurity)
                {
                    ...
                    if (channel == null)
                    {
                        object[] args = new object[] { chnl.ChannelName ?? chnl.ToString() };
                        throw new RemotingException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Remoting_Channel_CannotBeSecured"), args));
                    }
        ...
        {
            get => 
                Thread.GetDomain().RemotingData.ChannelServicesData.remoteCalls;
            set
            {
