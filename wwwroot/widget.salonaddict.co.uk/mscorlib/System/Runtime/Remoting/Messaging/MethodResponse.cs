namespace System.Runtime.Remoting.Messaging
{
    ...
    [Serializable, CLSCompliant(false), ComVisible(true), SecurityPermission(SecurityAction.InheritanceDemand, Flags=SecurityPermissionFlag.Infrastructure), SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.Infrastructure)]
    public class MethodResponse : IMethodReturnMessage, IMethodMessage, IMessage, ISerializable, ISerializationRootObject, IInternalMessage
    {
        ...
        internal void SetObjectFromSoapData(SerializationInfo info)
        {
            ...
            else
            {
                ...
                ParameterInfo[] parameters = this._methodCache.Parameters;
                object obj3 = this.InternalProperties?["__UnorderedParams"];
