namespace System.Runtime.Remoting
{
    ...
    public sealed class RemotingServices
    {
        ...
        [ComVisible(true), SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.RemotingConfiguration)]
        public static object Connect(Type classToProxy, string url) => 
            Unmarshal(classToProxy, url, null);

        [ComVisible(true), SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.RemotingConfiguration)]
        public static object Connect(Type classToProxy, string url, object data) => 
            Unmarshal(classToProxy, url, data);
        ...
        internal static GCHandle CreateDelegateInvocation(WaitCallback waitDelegate, object state) => 
            GCHandle.Alloc(new object[] { waitDelegate, state });
        ...
        internal static object CreateProxyForDomain(int appDomainId, IntPtr defCtxID) => 
            ((AppDomain) Unmarshal(CreateDataForDomain(appDomainId, defCtxID)));
        ...
        internal static string GetDefaultQualifiedTypeName(Type type) => 
            InternalRemotingServices.GetReflectionCachedData(type).QualifiedTypeName;
        ...
        [MethodImpl(MethodImplOptions.InternalCall), ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success), SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.Infrastructure)]
        ...
        internal static int GetServerDomainIdForProxy(object tp) => 
            GetRealProxy(tp).IdentityObject.ObjectRef.GetServerDomainId();
        ...
        internal static Type InternalGetTypeFromQualifiedTypeName(string qualifiedTypeName) => 
            InternalGetTypeFromQualifiedTypeName(qualifiedTypeName, true);
        ...
        internal static Type InternalGetTypeFromQualifiedTypeName(string qualifiedTypeName, bool partialFallback)
        {
            ...
            if (num != -1)
            {
                ...
                Type interopTypeFromXmlType = SoapServices.GetInteropTypeFromXmlType(xmlType, xmlTypeNamespace);
        ...
        public static bool IsMethodOverloaded(IMethodMessage msg) => 
            InternalRemotingServices.GetReflectionCachedData(msg.MethodBase).IsOverloaded();
        ...
        private static Type LoadClrTypeWithPartialBindFallback(string typeName, bool partialFallback)
        {
            ...
            RuntimeTypeHandle handle = new RuntimeTypeHandle(RuntimeTypeHandle._GetTypeByName(typeName, false, false, false, ref lookForMyCaller, true));
            return handle.GetRuntimeType();
        }

        [Conditional("REMOTING_PERF"), Obsolete("Use of this method is not recommended. The LogRemotingStage existed for internal diagnostic purposes only."), SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.Infrastructure)]
        ...
        public static ObjRef Marshal(MarshalByRefObject Obj) => 
            MarshalInternal(Obj, null, null);

        [SecurityPermission(SecurityAction.Demand, Flags=SecurityPermissionFlag.RemotingConfiguration)]
        public static ObjRef Marshal(MarshalByRefObject Obj, string URI) => 
            MarshalInternal(Obj, URI, null);

        [SecurityPermission(SecurityAction.Demand, Flags=SecurityPermissionFlag.RemotingConfiguration)]
        public static ObjRef Marshal(MarshalByRefObject Obj, string ObjURI, Type RequestedType) => 
            MarshalInternal(Obj, ObjURI, RequestedType);

        internal static ObjRef MarshalInternal(MarshalByRefObject Obj, string ObjURI, Type RequestedType) => 
            MarshalInternal(Obj, ObjURI, RequestedType, true);
        ...
        internal static byte[] MarshalToBuffer(object o)
        {
            ...
            }.Serialize(serializationStream, o, null, false);
        ...
        private static MarshalByRefObject SetOrCreateProxy(Identity idObj, Type classToProxy, object proxy)
        {
            ...
            if (proxy == null)
            {
                ...
                if (realProxy == null)
                {
                    realProxy = ActivationServices.DefaultProxyAttribute.CreateProxy(idObj.ObjectRef, classToProxy, null, identity?.ServerContext);
                }
            }
            else
            {
        ...
        public static object Unmarshal(ObjRef objectRef) => 
            InternalUnmarshal(objectRef, null, false);

        [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.Infrastructure)]
        public static object Unmarshal(ObjRef objectRef, bool fRefine) => 
            InternalUnmarshal(objectRef, null, fRefine);
        ...
        internal static object UnmarshalFromBuffer(byte[] b)
        {
            ...
            return formatter.Deserialize(serializationStream, null, false);
        }
