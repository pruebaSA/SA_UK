namespace System.Runtime.Remoting.Metadata
{
    ...
    internal class RemotingMethodCachedData : RemotingCachedData
    {
        ...
        internal bool IsOverloaded()
        {
            ...
            return ((checkedOverloaded & MethodCacheFlags.IsOverloaded) != MethodCacheFlags.None);
        }
        ...
        private void UpdateNames()
        {
            ...
            {
                this._typeAndAssemblyName = RemotingServices.GetDefaultQualifiedTypeName(rI.DeclaringType);
            }
        }
