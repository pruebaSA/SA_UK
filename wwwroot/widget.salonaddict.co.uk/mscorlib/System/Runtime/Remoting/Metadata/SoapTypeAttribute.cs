namespace System.Runtime.Remoting.Metadata
{
    ...
    [ComVisible(true), AttributeUsage(AttributeTargets.Interface | AttributeTargets.Enum | AttributeTargets.Struct | AttributeTargets.Class)]
    public sealed class SoapTypeAttribute : SoapAttribute
    {
        ...
        internal bool IsInteropXmlElement() => 
            ((this._explicitlySet & (ExplicitlySet.XmlNamespace | ExplicitlySet.XmlElementName)) != ExplicitlySet.None);

        internal bool IsInteropXmlType() => 
            ((this._explicitlySet & (ExplicitlySet.XmlTypeNamespace | ExplicitlySet.XmlTypeName)) != ExplicitlySet.None);
        ...
        public string XmlTypeNamespace
        {
            get
            {
                ...
                {
                    this._XmlTypeNamespace = XmlNamespaceEncoder.GetXmlNamespaceForTypeNamespace((Type) base.ReflectInfo, null);
                }
