    ...
    internal sealed class __BinaryParser
    {
        ...
        private void ReadArray(BinaryHeaderEnum binaryHeaderEnum)
        {
            ...
            if (array.binaryTypeEnum == BinaryTypeEnum.ObjectUser)
            {
                if (array.assemId < 1)
                {
                    throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_AssemblyId"), new object[] { array.typeInformation }));
                }
            ...
            else
            {
                ...
                throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_ObjectTypeEnum"), new object[] { progress2.objectTypeEnum.ToString() }));
            }
        Label_018B:
            ...
            switch (array.binaryArrayTypeEnum)
            {
                ...
                default:
                    throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_ArrayType"), new object[] { array.binaryArrayTypeEnum.ToString() }));
            }
            if (!flag)
            {
                this.stack.Push(op);
        ...
        internal void ReadAssembly(BinaryHeaderEnum binaryHeaderEnum)
        {
            ...
            if (binaryHeaderEnum == BinaryHeaderEnum.CrossAppDomainAssembly)
            {
                ...
                {
                    throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_CrossAppDomainError"), new object[] { "String", assembly2.assemblyIndex }));
                }
            }
            else
            {
        ...
        internal void ReadCrossAppDomainMap()
        {
            ...
            else
            {
                ...
                if (typed == null)
                {
                    throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_CrossAppDomainError"), new object[] { "BinaryObjectMap", obj2 }));
                }
        ...
        internal DateTime ReadDateTime() => 
            DateTime.FromBinaryRaw(this.ReadInt64());
        ...
        private void ReadMemberPrimitiveTyped()
        {
            ...
            else
            {
                ...
                throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_ObjectTypeEnum"), new object[] { progress.objectTypeEnum.ToString() }));
            }
        Label_016B:
        ...
        private void ReadObject()
        {
            ...
            else
            {
                ...
                throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_Map"), new object[] { progress2.objectTypeEnum.ToString() }));
            }
        Label_01AF:
        ...
        private void ReadObjectString(BinaryHeaderEnum binaryHeaderEnum)
        {
            ...
            else
            {
                ...
                {
                    throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_CrossAppDomainError"), new object[] { "String", this.crossAppDomainString.value }));
                }
        ...
        internal void Run()
        {
            try
            {
                ...
                Label_0131:
                    ...
                    goto Label_0187;
                Label_0141:;
                    throw new SerializationException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Serialization_BinaryHeader"), new object[] { num }));
                Label_0187:
