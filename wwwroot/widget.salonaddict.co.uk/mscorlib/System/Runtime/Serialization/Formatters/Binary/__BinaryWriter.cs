    ...
    internal sealed class __BinaryWriter
    {
        ...
        private void WriteArrayAsBytes(Array array, int typeLength)
        {
            ...
            while (num < array.Length)
            {
                ...
                int count = num2 * typeLength;
                Buffer.InternalBlockCopy(array, num * typeLength, this.byteBuffer, 0, count);
                this.WriteBytes(this.byteBuffer, 0, count);
                num += num2;
            }
        }
        ...
        internal object[] WriteCallArray(string uri, string methodName, string typeName, Type[] instArgs, object[] args, object methodSignature, object callContext, object[] properties) => 
            this.binaryMethodCall?.WriteArray(uri, methodName, typeName, instArgs, args, methodSignature, callContext, properties);
        ...
        internal object[] WriteReturnArray(object returnValue, object[] args, Exception exception, object callContext, object[] properties) => 
            this.binaryMethodReturn?.WriteArray(returnValue, args, exception, callContext, properties);
