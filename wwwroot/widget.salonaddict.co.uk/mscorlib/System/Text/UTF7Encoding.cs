namespace System.Text
{
    ...
    public class UTF7Encoding : Encoding
    {
        ...
        public override int GetHashCode() => 
            ((this.CodePage + base.EncoderFallback.GetHashCode()) + base.DecoderFallback.GetHashCode());
        ...
        internal sealed class DecoderUTF7Fallback : DecoderFallback
        {
            public override DecoderFallbackBuffer CreateFallbackBuffer() => 
                new UTF7Encoding.DecoderUTF7FallbackBuffer(this);

            public override bool Equals(object value) => 
                (value is UTF7Encoding.DecoderUTF7Fallback);
