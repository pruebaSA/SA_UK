namespace System.Text
{
    ...
    public sealed class StringBuilder : ISerializable
    {
        ...
        public StringBuilder AppendFormat(string format, object arg0) => 
            this.AppendFormat(null, format, new object[] { arg0 });

        public StringBuilder AppendFormat(string format, params object[] args) => 
            this.AppendFormat(null, format, args);
        ...
        public StringBuilder AppendFormat(string format, object arg0, object arg1) => 
            this.AppendFormat(null, format, new object[] { arg0, arg1 });

        public StringBuilder AppendFormat(string format, object arg0, object arg1, object arg2) => 
            this.AppendFormat(null, format, new object[] { arg0, arg1, arg2 });
        ...
        public StringBuilder Insert(int index, bool value) => 
            this.Insert(index, value.ToString(), 1);

        public StringBuilder Insert(int index, byte value) => 
            this.Insert(index, value.ToString(CultureInfo.CurrentCulture), 1);

        public StringBuilder Insert(int index, char value) => 
            this.Insert(index, char.ToString(value), 1);
        ...
        private bool NeedsAllocation(string currentString, int requiredLength) => 
            (currentString.ArrayLength <= requiredLength);
        ...
        public string ToString(int startIndex, int length) => 
            this.m_StringValue.InternalSubStringWithChecks(startIndex, length, true);
