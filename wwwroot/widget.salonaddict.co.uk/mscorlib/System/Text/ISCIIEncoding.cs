namespace System.Text
{
    ...
    internal class ISCIIEncoding : EncodingNLS, ISerializable
    {
        ...
        internal override unsafe int GetByteCount(char* chars, int count, EncoderNLS baseEncoder) => 
            this.GetBytes(chars, count, null, 0, baseEncoder);
        ...
        internal override unsafe int GetCharCount(byte* bytes, int count, DecoderNLS baseDecoder) => 
            this.GetChars(bytes, count, null, 0, baseDecoder);
        ...
        public override System.Text.Decoder GetDecoder() => 
            new ISCIIDecoder(this);

        public override System.Text.Encoder GetEncoder() => 
            new ISCIIEncoder(this);

        public override int GetHashCode() => 
            ((this.defaultCodePage + base.EncoderFallback.GetHashCode()) + base.DecoderFallback.GetHashCode());
