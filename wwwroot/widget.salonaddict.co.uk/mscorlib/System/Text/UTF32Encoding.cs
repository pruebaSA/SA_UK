namespace System.Text
{
    ...
    public sealed class UTF32Encoding : Encoding
    {
        ...
        public override System.Text.Decoder GetDecoder() => 
            new UTF32Decoder(this);

        public override System.Text.Encoder GetEncoder() => 
            new EncoderNLS(this);

        public override int GetHashCode() => 
            ((((base.EncoderFallback.GetHashCode() + base.DecoderFallback.GetHashCode()) + this.CodePage) + (this.emitUTF32ByteOrderMark ? 4 : 0)) + (this.bigEndian ? 8 : 0));

        private char GetHighSurrogate(uint iChar) => 
            ((char) (((iChar - 0x10000) / 0x400) + 0xd800));

        private char GetLowSurrogate(uint iChar) => 
            ((char) (((iChar - 0x10000) % 0x400) + 0xdc00));
        ...
        private uint GetSurrogate(char cHigh, char cLow) => 
            ((uint) ((((cHigh - 0xd800) * 0x400) + (cLow - 0xdc00)) + 0x10000));
