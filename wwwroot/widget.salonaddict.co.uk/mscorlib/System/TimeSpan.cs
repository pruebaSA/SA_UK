namespace System
{
    ...
    public struct TimeSpan : IComparable, IComparable<TimeSpan>, IEquatable<TimeSpan>
    {
        ...
        public long Ticks =>
            this._ticks;
        public int Days =>
            ((int) (this._ticks / 0xc92a69c000L));
        public int Hours =>
            ((int) ((this._ticks / 0x861c46800L) % 0x18L));
        public int Milliseconds =>
            ((int) ((this._ticks / 0x2710L) % 0x3e8L));
        public int Minutes =>
            ((int) ((this._ticks / 0x23c34600L) % 60L));
        public int Seconds =>
            ((int) ((this._ticks / 0x989680L) % 60L));
        public double TotalDays =>
            (this._ticks * 1.1574074074074074E-12);
        public double TotalHours =>
            (this._ticks * 2.7777777777777777E-11);
        ...
        public double TotalMinutes =>
            (this._ticks * 1.6666666666666667E-09);
        ...
        public override bool Equals(object value) => 
            ((value is TimeSpan) && (this._ticks == ((TimeSpan) value)._ticks));

        public bool Equals(TimeSpan obj) => 
            (this._ticks == obj._ticks);

        public static bool Equals(TimeSpan t1, TimeSpan t2) => 
            (t1._ticks == t2._ticks);

        public override int GetHashCode() => 
            (((int) this._ticks) ^ ((int) (this._ticks >> 0x20)));

        public static TimeSpan FromHours(double value) => 
            Interval(value, 0x36ee80);
        ...
        private string IntToString(int n, int digits) => 
            ParseNumbers.IntToString(n, 10, digits, '0', 0);
