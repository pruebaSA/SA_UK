namespace System
{
    ...
    public abstract class Enum : ValueType, IComparable, IFormattable, IConvertible
    {
        ...
        bool IConvertible.ToBoolean(IFormatProvider provider) => 
            Convert.ToBoolean(this.GetValue(), CultureInfo.CurrentCulture);

        byte IConvertible.ToByte(IFormatProvider provider) => 
            Convert.ToByte(this.GetValue(), CultureInfo.CurrentCulture);

        char IConvertible.ToChar(IFormatProvider provider) => 
            Convert.ToChar(this.GetValue(), CultureInfo.CurrentCulture);
        ...
        decimal IConvertible.ToDecimal(IFormatProvider provider) => 
            Convert.ToDecimal(this.GetValue(), CultureInfo.CurrentCulture);

        double IConvertible.ToDouble(IFormatProvider provider) => 
            Convert.ToDouble(this.GetValue(), CultureInfo.CurrentCulture);

        short IConvertible.ToInt16(IFormatProvider provider) => 
            Convert.ToInt16(this.GetValue(), CultureInfo.CurrentCulture);

        int IConvertible.ToInt32(IFormatProvider provider) => 
            Convert.ToInt32(this.GetValue(), CultureInfo.CurrentCulture);

        long IConvertible.ToInt64(IFormatProvider provider) => 
            Convert.ToInt64(this.GetValue(), CultureInfo.CurrentCulture);

        sbyte IConvertible.ToSByte(IFormatProvider provider) => 
            Convert.ToSByte(this.GetValue(), CultureInfo.CurrentCulture);

        float IConvertible.ToSingle(IFormatProvider provider) => 
            Convert.ToSingle(this.GetValue(), CultureInfo.CurrentCulture);

        object IConvertible.ToType(Type type, IFormatProvider provider) => 
            Convert.DefaultToType(this, type, provider);

        ushort IConvertible.ToUInt16(IFormatProvider provider) => 
            Convert.ToUInt16(this.GetValue(), CultureInfo.CurrentCulture);

        uint IConvertible.ToUInt32(IFormatProvider provider) => 
            Convert.ToUInt32(this.GetValue(), CultureInfo.CurrentCulture);

        ulong IConvertible.ToUInt64(IFormatProvider provider) => 
            Convert.ToUInt64(this.GetValue(), CultureInfo.CurrentCulture);

        private string ToHexString() => 
            InternalFormattedHexString(((RtFieldInfo) GetValueField(base.GetType())).InternalGetValue(this, false));
