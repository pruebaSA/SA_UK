namespace System
{
    ...
    public struct Single : IComparable, IFormattable, IConvertible, IComparable<float>, IEquatable<float>
    {
        ...
        public override string ToString() => 
            Number.FormatSingle(this, null, NumberFormatInfo.CurrentInfo);

        public string ToString(IFormatProvider provider) => 
            Number.FormatSingle(this, null, NumberFormatInfo.GetInstance(provider));

        public string ToString(string format) => 
            Number.FormatSingle(this, format, NumberFormatInfo.CurrentInfo);

        public string ToString(string format, IFormatProvider provider) => 
            Number.FormatSingle(this, format, NumberFormatInfo.GetInstance(provider));
        ...
        public static float Parse(string s, IFormatProvider provider) => 
            Parse(s, NumberStyles.Float | NumberStyles.AllowThousands, NumberFormatInfo.GetInstance(provider));
        ...
        public static bool TryParse(string s, out float result) => 
            TryParse(s, NumberStyles.Float | NumberStyles.AllowThousands, NumberFormatInfo.CurrentInfo, out result);
