namespace System.Resources
{
    ...
    internal sealed class RuntimeResourceSet : ResourceSet, IEnumerable
    {
        ...
        public override object GetObject(string key) => 
            this.GetObject(key, false, false);

        public override object GetObject(string key, bool ignoreCase) => 
            this.GetObject(key, ignoreCase, false);
        ...
        private object GetObject(string key, bool ignoreCase, bool isString)
        {
            ...
            lock (base.Reader)
            {
                ...
                if ((!flag && ignoreCase) && this._caseInsensitiveTable.TryGetValue(key, out locator))
                {
                    flag = true;
                    keyInWrongCase = true;
                    obj3 = this.ResolveResourceLocator(locator, key, this._resCache, keyInWrongCase);
        ...
        public override string GetString(string key) => 
            ((string) this.GetObject(key, false, true));

        public override string GetString(string key, bool ignoreCase) => 
            ((string) this.GetObject(key, ignoreCase, true));
