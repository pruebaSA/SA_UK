namespace System
{
    ...
    public abstract class Type : MemberInfo, _Type, IReflect
    {
        ...
        public override bool Equals(object o) => 
            (((o != null) && (o is Type)) && (this.UnderlyingSystemType == ((Type) o).UnderlyingSystemType));
        ...
        public ConstructorInfo GetConstructor(Type[] types) => 
            this.GetConstructor(BindingFlags.Public | BindingFlags.Instance, null, types, null);
        ...
        public EventInfo GetEvent(string name) => 
            this.GetEvent(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);

        public abstract EventInfo GetEvent(string name, BindingFlags bindingAttr);
        public virtual EventInfo[] GetEvents() => 
            this.GetEvents(BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);

        public abstract EventInfo[] GetEvents(BindingFlags bindingAttr);
        public FieldInfo GetField(string name) => 
            this.GetField(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);

        public abstract FieldInfo GetField(string name, BindingFlags bindingAttr);
        public FieldInfo[] GetFields() => 
            this.GetFields(BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);
        ...
        public MemberInfo[] GetMember(string name) => 
            this.GetMember(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);

        public virtual MemberInfo[] GetMember(string name, BindingFlags bindingAttr) => 
            this.GetMember(name, MemberTypes.All, bindingAttr);
        ...
        public MemberInfo[] GetMembers() => 
            this.GetMembers(BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);
        ...
        public MethodInfo[] GetMethods() => 
            this.GetMethods(BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);

        public abstract MethodInfo[] GetMethods(BindingFlags bindingAttr);
        public Type GetNestedType(string name) => 
            this.GetNestedType(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);

        public abstract Type GetNestedType(string name, BindingFlags bindingAttr);
        public Type[] GetNestedTypes() => 
            this.GetNestedTypes(BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);

        public abstract Type[] GetNestedTypes(BindingFlags bindingAttr);
        public PropertyInfo[] GetProperties() => 
            this.GetProperties(BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance);
        ...
        public static Type GetTypeFromCLSID(Guid clsid) => 
            RuntimeType.GetTypeFromCLSIDImpl(clsid, null, false);

        public static Type GetTypeFromCLSID(Guid clsid, bool throwOnError) => 
            RuntimeType.GetTypeFromCLSIDImpl(clsid, null, throwOnError);

        public static Type GetTypeFromCLSID(Guid clsid, string server) => 
            RuntimeType.GetTypeFromCLSIDImpl(clsid, server, false);

        public static Type GetTypeFromCLSID(Guid clsid, string server, bool throwOnError) => 
            RuntimeType.GetTypeFromCLSIDImpl(clsid, server, throwOnError);

        [MethodImpl(MethodImplOptions.InternalCall)]
        public static extern Type GetTypeFromHandle(RuntimeTypeHandle handle);
        [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
        public static Type GetTypeFromProgID(string progID) => 
            RuntimeType.GetTypeFromProgIDImpl(progID, null, false);

        [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
        public static Type GetTypeFromProgID(string progID, bool throwOnError) => 
            RuntimeType.GetTypeFromProgIDImpl(progID, null, throwOnError);

        [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
        public static Type GetTypeFromProgID(string progID, string server) => 
            RuntimeType.GetTypeFromProgIDImpl(progID, server, false);

        [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
        public static Type GetTypeFromProgID(string progID, string server, bool throwOnError) => 
            RuntimeType.GetTypeFromProgIDImpl(progID, server, throwOnError);
        ...
        public object InvokeMember(string name, BindingFlags invokeAttr, Binder binder, object target, object[] args) => 
            this.InvokeMember(name, invokeAttr, binder, target, args, null, null, null);

        [DebuggerStepThrough, DebuggerHidden]
        public object InvokeMember(string name, BindingFlags invokeAttr, Binder binder, object target, object[] args, CultureInfo culture) => 
            this.InvokeMember(name, invokeAttr, binder, target, args, null, culture, null);
        ...
        protected virtual bool IsContextfulImpl() => 
            typeof(ContextBoundObject).IsAssignableFrom(this);
        ...
        protected virtual bool IsMarshalByRefImpl() => 
            typeof(MarshalByRefObject).IsAssignableFrom(this);
        ...
        public bool HasElementType =>
            this.HasElementTypeImpl();

        internal bool HasProxyAttribute =>
            this.HasProxyAttributeImpl();

        public bool IsAbstract =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.Abstract) != TypeAttributes.AnsiClass);

        public bool IsAnsiClass =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.CustomFormatClass) == TypeAttributes.AnsiClass);

        public bool IsArray =>
            this.IsArrayImpl();

        public bool IsAutoClass =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.CustomFormatClass) == TypeAttributes.AutoClass);

        public bool IsAutoLayout =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.LayoutMask) == TypeAttributes.AnsiClass);

        public bool IsByRef =>
            this.IsByRefImpl();

        public bool IsClass =>
            (((this.GetAttributeFlagsImpl() & TypeAttributes.ClassSemanticsMask) == TypeAttributes.AnsiClass) && !this.IsSubclassOf(valueType));

        public bool IsCOMObject =>
            this.IsCOMObjectImpl();

        public bool IsContextful =>
            this.IsContextfulImpl();

        public bool IsEnum =>
            this.IsSubclassOf(enumType);

        public bool IsExplicitLayout =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.LayoutMask) == TypeAttributes.ExplicitLayout);
        ...
        public bool IsImport =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.Import) != TypeAttributes.AnsiClass);
        ...
        public bool IsLayoutSequential =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.LayoutMask) == TypeAttributes.SequentialLayout);

        public bool IsMarshalByRef =>
            this.IsMarshalByRefImpl();

        public bool IsNested =>
            (this.DeclaringType != null);

        public bool IsNestedAssembly =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.NestedAssembly);

        public bool IsNestedFamANDAssem =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.NestedFamANDAssem);

        public bool IsNestedFamily =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.NestedFamily);

        public bool IsNestedFamORAssem =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.NestedFamORAssem);

        public bool IsNestedPrivate =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.NestedPrivate);

        public bool IsNestedPublic =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.NestedPublic);

        public bool IsNotPublic =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.AnsiClass);

        public bool IsPointer =>
            this.IsPointerImpl();

        public bool IsPrimitive =>
            this.IsPrimitiveImpl();

        public bool IsPublic =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.NestedFamORAssem) == TypeAttributes.Public);

        public bool IsSealed =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.Sealed) != TypeAttributes.AnsiClass);
        ...
        public bool IsSpecialName =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.SpecialName) != TypeAttributes.AnsiClass);

        internal virtual bool IsSzArray =>
            false;

        public bool IsUnicodeClass =>
            ((this.GetAttributeFlagsImpl() & TypeAttributes.CustomFormatClass) == TypeAttributes.UnicodeClass);

        public bool IsValueType =>
            this.IsValueTypeImpl();

        public bool IsVisible =>
            this.GetTypeHandleInternal().IsVisible();
        ...
        public ConstructorInfo TypeInitializer =>
            this.GetConstructorImpl(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static, null, CallingConventions.Any, EmptyTypes, null);
