namespace System.Collections.Generic
{
    ...
    public class List<T> : IList<T>, ICollection<T>, IEnumerable<T>, IList, ICollection, IEnumerable
    {
        ...
        public int BinarySearch(T item) => 
            this.BinarySearch(0, this.Count, item, null);
        ...
        public int FindIndex(Predicate<T> match) => 
            this.FindIndex(0, this._size, match);

        public int FindIndex(int startIndex, Predicate<T> match) => 
            this.FindIndex(startIndex, this._size - startIndex, match);
        ...
        public int FindLastIndex(Predicate<T> match) => 
            this.FindLastIndex(this._size - 1, this._size, match);

        public int FindLastIndex(int startIndex, Predicate<T> match) => 
            this.FindLastIndex(startIndex, startIndex + 1, match);
        ...
        public int IndexOf(T item) => 
            Array.IndexOf<T>(this._items, item, 0, this._size);
        ...
        public int LastIndexOf(T item) => 
            this.LastIndexOf(item, this._size - 1, this._size);
        ...
        bool IList.Contains(object item) => 
            (List<T>.IsCompatibleObject(item) && this.Contains((T) item));
