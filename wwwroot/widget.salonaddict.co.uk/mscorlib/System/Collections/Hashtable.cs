namespace System.Collections
{
    ...
    public class Hashtable : IDictionary, ICollection, IEnumerable, ISerializable, IDeserializationCallback, ICloneable
    {
        ...
        public virtual IDictionaryEnumerator GetEnumerator() => 
            new HashtableEnumerator(this, 3);
        ...
        internal class HashtableDebugView
        {
            ...
            public KeyValuePairs[] Items =>
                this.hashtable.ToKeyValuePairsArray();
        }
        ...
        private class KeyCollection : ICollection, IEnumerable
        {
            ...
            public virtual IEnumerator GetEnumerator() => 
                new Hashtable.HashtableEnumerator(this._hashtable, 1);

            public virtual int Count =>
                this._hashtable.count;

            public virtual bool IsSynchronized =>
                this._hashtable.IsSynchronized;

            public virtual object SyncRoot =>
                this._hashtable.SyncRoot;
        }
        ...
        private class SyncHashtable : Hashtable
        {
            ...
            public override bool Contains(object key) => 
                this._table.Contains(key);

            public override bool ContainsKey(object key) => 
                this._table.ContainsKey(key);
            ...
            internal override KeyValuePairs[] ToKeyValuePairsArray() => 
                this._table.ToKeyValuePairsArray();

            public override int Count =>
                this._table.Count;

            public override bool IsFixedSize =>
                this._table.IsFixedSize;

            public override bool IsReadOnly =>
                this._table.IsReadOnly;
        ...
        private class ValueCollection : ICollection, IEnumerable
        {
            ...
            public virtual IEnumerator GetEnumerator() => 
                new Hashtable.HashtableEnumerator(this._hashtable, 2);
