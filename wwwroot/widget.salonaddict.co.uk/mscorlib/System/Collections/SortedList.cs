namespace System.Collections
{
    ...
    public class SortedList : IDictionary, ICollection, IEnumerable, ICloneable
    {
        ...
        public virtual IDictionaryEnumerator GetEnumerator() => 
            new SortedListEnumerator(this, 0, this._size, 3);
        ...
        public virtual int IndexOfValue(object value) => 
            Array.IndexOf<object>(this.values, value, 0, this._size);
        ...
        private class KeyList : IList, ICollection, IEnumerable
        {
            ...
            public virtual IEnumerator GetEnumerator() => 
                new SortedList.SortedListEnumerator(this.sortedList, 0, this.sortedList.Count, 1);
            ...
            public virtual bool IsSynchronized =>
                this.sortedList.IsSynchronized;

            public virtual object this[int index]
            {
                get => 
                    this.sortedList.GetKey(index);
                set
                {
        ...
        internal class SortedListDebugView
        {
            ...
            public KeyValuePairs[] Items =>
                this.sortedList.ToKeyValuePairsArray();
        }
        ...
        private class SyncSortedList : SortedList
        {
            ...
            internal override KeyValuePairs[] ToKeyValuePairsArray() => 
                this._list.ToKeyValuePairsArray();
        ...
        private class ValueList : IList, ICollection, IEnumerable
        {
            ...
            public virtual bool Contains(object value) => 
                this.sortedList.ContainsValue(value);
            ...
            public virtual IEnumerator GetEnumerator() => 
                new SortedList.SortedListEnumerator(this.sortedList, 0, this.sortedList.Count, 2);

            public virtual int IndexOf(object value) => 
                Array.IndexOf<object>(this.sortedList.values, value, 0, this.sortedList.Count);
            ...
            {
                get => 
                    this.sortedList.GetByIndex(index);
                set
                {
                    throw new NotSupportedException(Environment.GetResourceString("NotSupported_SortedListNestedWrite"));
                }
