namespace System
{
    ...
    public struct Guid : IFormattable, IComparable, IComparable<Guid>, IEquatable<Guid>
    {
        ...
        private static bool IsHexPrefix(string str, int i) => 
            ((str[i] == '0') && (char.ToLower(str[i + 1], CultureInfo.InvariantCulture) == 'x'));

        public byte[] ToByteArray() => 
            new byte[] { ((byte) this._a), ((byte) (this._a >> 8)), ((byte) (this._a >> 0x10)), ((byte) (this._a >> 0x18)), ((byte) this._b), ((byte) (this._b >> 8)), ((byte) this._c), ((byte) (this._c >> 8)), this._d, this._e, this._f, this._g, this._h, this._i, this._j, this._k };

        public override string ToString() => 
            this.ToString("D", null);

        public override int GetHashCode() => 
            ((this._a ^ ((this._b << 0x10) | ((ushort) this._c))) ^ ((this._f << 0x18) | this._k));
