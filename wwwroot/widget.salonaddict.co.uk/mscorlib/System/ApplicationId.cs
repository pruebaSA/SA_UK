namespace System
{
    ...
    public sealed class ApplicationId
    {
        ...
        public ApplicationId Copy() => 
            new ApplicationId(this.m_publicKeyToken, this.m_name, this.m_version, this.m_processorArchitecture, this.m_culture);
        ...
        public override int GetHashCode() => 
            (this.m_name.GetHashCode() ^ this.m_version.GetHashCode());
