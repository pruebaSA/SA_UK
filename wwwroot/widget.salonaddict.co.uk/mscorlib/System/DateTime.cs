namespace System
{
    ...
    public struct DateTime : IComparable, IFormattable, IConvertible, ISerializable, IComparable<DateTime>, IEquatable<DateTime>
    {
        ...
        public DateTime AddDays(double value) => 
            this.Add(value, 0x5265c00);

        public DateTime AddHours(double value) => 
            this.Add(value, 0x36ee80);

        public DateTime AddMilliseconds(double value) => 
            this.Add(value, 1);

        public DateTime AddMinutes(double value) => 
            this.Add(value, 0xea60);
        ...
        public bool Equals(DateTime value) => 
            (this.InternalTicks == value.InternalTicks);
        ...
        public static bool Equals(DateTime t1, DateTime t2) => 
            (t1.InternalTicks == t2.InternalTicks);
        ...
        public static DateTime FromFileTime(long fileTime) => 
            FromFileTimeUtc(fileTime).ToLocalTime();
        ...
        public string[] GetDateTimeFormats() => 
            this.GetDateTimeFormats(CultureInfo.CurrentCulture);

        public string[] GetDateTimeFormats(char format) => 
            this.GetDateTimeFormats(format, CultureInfo.CurrentCulture);

        public string[] GetDateTimeFormats(IFormatProvider provider) => 
            DateTimeFormat.GetAllDateTimes(this, DateTimeFormatInfo.GetInstance(provider));

        public string[] GetDateTimeFormats(char format, IFormatProvider provider) => 
            DateTimeFormat.GetAllDateTimes(this, format, DateTimeFormatInfo.GetInstance(provider));
        ...
        internal bool IsAmbiguousDaylightSavingTime() => 
            (this.InternalKind == 13835058055282163712L);

        public bool IsDaylightSavingTime() => 
            TimeZone.CurrentTimeZone.IsDaylightSavingTime(this);
        ...
        public static bool operator ==(DateTime d1, DateTime d2) => 
            (d1.InternalTicks == d2.InternalTicks);
        ...
        public static TimeSpan operator -(DateTime d1, DateTime d2) => 
            new TimeSpan(d1.InternalTicks - d2.InternalTicks);
        ...
        public static DateTime SpecifyKind(DateTime value, DateTimeKind kind) => 
            new DateTime(value.InternalTicks, kind);

        public TimeSpan Subtract(DateTime value) => 
            new TimeSpan(this.InternalTicks - value.InternalTicks);
        ...
        public long ToFileTime() => 
            this.ToUniversalTime().ToFileTimeUtc();
        ...
        public string ToLongDateString() => 
            DateTimeFormat.Format(this, "D", DateTimeFormatInfo.CurrentInfo);

        public string ToLongTimeString() => 
            DateTimeFormat.Format(this, "T", DateTimeFormatInfo.CurrentInfo);

        public double ToOADate() => 
            TicksToOADate(this.InternalTicks);
        ...
        public string ToString(IFormatProvider provider) => 
            DateTimeFormat.Format(this, null, DateTimeFormatInfo.GetInstance(provider));

        public string ToString(string format) => 
            DateTimeFormat.Format(this, format, DateTimeFormatInfo.CurrentInfo);

        public string ToString(string format, IFormatProvider provider) => 
            DateTimeFormat.Format(this, format, DateTimeFormatInfo.GetInstance(provider));

        public DateTime ToUniversalTime() => 
            TimeZone.CurrentTimeZone.ToUniversalTime(this);
        ...
        public static bool TryParse(string s, out DateTime result) => 
            DateTimeParse.TryParse(s, DateTimeFormatInfo.CurrentInfo, DateTimeStyles.None, out result);
        ...
        public System.DayOfWeek DayOfWeek =>
            ((System.DayOfWeek) ((int) (((this.InternalTicks / 0xc92a69c000L) + 1L) % 7L)));

        public int DayOfYear =>
            this.GetDatePart(1);

        public int Hour =>
            ((int) ((this.InternalTicks / 0x861c46800L) % 0x18L));

        private ulong InternalKind =>
            (this.dateData & 13835058055282163712L);

        private long InternalTicks =>
            (((long) this.dateData) & 0x3fffffffffffffffL);
        ...
        public int Millisecond =>
            ((int) ((this.InternalTicks / 0x2710L) % 0x3e8L));

        public int Minute =>
            ((int) ((this.InternalTicks / 0x23c34600L) % 60L));
        ...
        public int Second =>
            ((int) ((this.InternalTicks / 0x989680L) % 60L));

        public long Ticks =>
            this.InternalTicks;

        public TimeSpan TimeOfDay =>
            new TimeSpan(this.InternalTicks % 0xc92a69c000L);
