namespace System.Globalization
{
    ...
    public sealed class CharUnicodeInfo
    {
        ...
        public static int GetDecimalDigitValue(char ch) => 
            InternalGetDecimalDigitValue(ch);
        ...
        internal static sbyte InternalGetDecimalDigitValue(int ch) => 
            InternalGetDigitValues(ch).decimalDigit;

        internal static sbyte InternalGetDigitValue(int ch) => 
            InternalGetDigitValues(ch).digit;
        ...
        internal static UnicodeCategory InternalGetUnicodeCategory(int ch) => 
            ((UnicodeCategory) InternalGetCategoryValue(ch, 0));

        internal static UnicodeCategory InternalGetUnicodeCategory(string value, int index) => 
            InternalGetUnicodeCategory(InternalConvertToUtf32(value, index));

        internal static UnicodeCategory InternalGetUnicodeCategory(string str, int index, out int charLength) => 
            InternalGetUnicodeCategory(InternalConvertToUtf32(str, index, out charLength));
