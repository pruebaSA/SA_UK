namespace System.Globalization
{
    ...
    internal class CalendarTable : BaseInfoTable
    {
        ...
        internal unsafe int ICURRENTERA(int id) => 
            this.m_calendars[id].iCurrentEra;

        internal unsafe int IFORMATFLAGS(int id) => 
            this.m_calendars[id].iFormatFlags;
        ...
        internal unsafe string[] SABBREVDAYNAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saAbbrevDayNames);

        internal unsafe string[] SABBREVENGERANAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saAbbrevEnglishEraNames);

        internal unsafe string[] SABBREVERANAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saAbbrevEraNames);

        internal unsafe string[] SABBREVMONTHNAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saAbbrevMonthNames);

        internal unsafe string[] SDAYNAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saDayNames);

        internal unsafe string[] SERANAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saEraNames);

        internal unsafe int[][] SERARANGES(int id) => 
            base.GetWordArrayArray(this.m_calendars[id].waaEraRanges);
        ...
        internal unsafe string[] SLEAPYEARMONTHNAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saLeapYearMonthNames);

        internal unsafe string[] SLONGDATE(int id) => 
            base.GetStringArray(this.m_calendars[id].saLongDate);

        internal unsafe string SMONTHDAY(int id) => 
            base.GetStringPoolString(this.m_calendars[id].sMonthDay);

        internal unsafe string[] SMONTHNAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saMonthNames);

        internal unsafe string[] SSHORTDATE(int id) => 
            base.GetStringArray(this.m_calendars[id].saShortDate);

        internal unsafe string[] SSUPERSHORTDAYNAMES(int id) => 
            base.GetStringArray(this.m_calendars[id].saSuperShortDayNames);

        internal unsafe string[] SYEARMONTH(int id) => 
            base.GetStringArray(this.m_calendars[id].saYearMonth);
