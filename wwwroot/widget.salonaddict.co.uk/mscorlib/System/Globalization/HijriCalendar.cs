namespace System.Globalization
{
    ...
    public class HijriCalendar : Calendar
    {
        ...
        private long GetAbsoluteDateHijri(int y, int m, int d) => 
            ((((this.DaysUpToHijriYear(y) + HijriMonthDays[m - 1]) + d) - 1L) - this.HijriAdjustment);
