namespace System.Globalization
{
    ...
    public sealed class DateTimeFormatInfo : ICloneable, IFormatProvider
    {
        ...
        {
            get => 
                ((string[]) this.GetAbbreviatedDayOfWeekNames().Clone());
            set
            {
                this.VerifyWritable();
                if (value == null)
        ...
        {
            get => 
                ((string[]) this.internalGetGenitiveMonthNames(true).Clone());
            set
            {
                this.VerifyWritable();
                if (value == null)
        ...
        {
            get => 
                ((string[]) this.GetAbbreviatedMonthNames().Clone());
            set
            {
                this.VerifyWritable();
                if (value == null)
        ...
        {
            get => 
                ((System.Globalization.CalendarWeekRule) this.calendarWeekRule);
            set
            {
                this.VerifyWritable();
        ...
        internal int CultureId =>
            this.m_cultureTableRecord.CultureID;
        ...
        {
            get => 
                ((string[]) this.GetDayOfWeekNames().Clone());
            set
            {
                this.VerifyWritable();
                if (value == null)
        ...
        internal bool HasSpacesInDayNames =>
            ((this.FormatFlags & DateTimeFormatFlags.UseSpacesInDayNames) != DateTimeFormatFlags.None);

        internal bool HasSpacesInMonthNames =>
            ((this.FormatFlags & DateTimeFormatFlags.UseSpacesInMonthNames) != DateTimeFormatFlags.None);

        internal bool HasYearMonthAdjustment =>
            ((this.FormatFlags & DateTimeFormatFlags.UseHebrewRule) != DateTimeFormatFlags.None);
        ...
        {
            get => 
                ((string[]) this.internalGetGenitiveMonthNames(false).Clone());
            set
            {
                this.VerifyWritable();
                if (value == null)
        ...
        {
            get => 
                ((string[]) this.GetMonthNames().Clone());
            set
            {
                this.VerifyWritable();
                if (value == null)
        ...
        {
            get => 
                ((string[]) this.internalGetSuperShortDayNames().Clone());
            set
            {
                this.VerifyWritable();
                if (value == null)
