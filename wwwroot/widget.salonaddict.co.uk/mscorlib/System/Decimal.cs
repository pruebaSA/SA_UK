namespace System
{
    ...
    public struct Decimal : IFormattable, IComparable, IConvertible, IComparable<decimal>, IEquatable<decimal>
    {
        ...
        public static decimal FromOACurrency(long cy) => 
            Currency.ToDecimal(Currency.FromOACurrency(cy));
        ...
        internal static decimal Abs(decimal d) => 
            new decimal(d.lo, d.mid, d.hi, d.flags & 0x7fffffff);
        ...
        public override bool Equals(object value) => 
            ((value is decimal) && (Compare(this, (decimal) value) == 0));

        public bool Equals(decimal value) => 
            (Compare(this, value) == 0);
        ...
        public override string ToString() => 
            Number.FormatDecimal(this, null, NumberFormatInfo.CurrentInfo);

        public string ToString(string format) => 
            Number.FormatDecimal(this, format, NumberFormatInfo.CurrentInfo);

        public string ToString(IFormatProvider provider) => 
            Number.FormatDecimal(this, null, NumberFormatInfo.GetInstance(provider));

        public string ToString(string format, IFormatProvider provider) => 
            Number.FormatDecimal(this, format, NumberFormatInfo.GetInstance(provider));

        public static decimal Parse(string s) => 
            Number.ParseDecimal(s, NumberStyles.Number, NumberFormatInfo.CurrentInfo);
        ...
        public static decimal Parse(string s, IFormatProvider provider) => 
            Number.ParseDecimal(s, NumberStyles.Number, NumberFormatInfo.GetInstance(provider));
        ...
        public static bool TryParse(string s, out decimal result) => 
            Number.TryParseDecimal(s, NumberStyles.Number, NumberFormatInfo.CurrentInfo, out result);
        ...
        public static int[] GetBits(decimal d) => 
            new int[] { d.lo, d.mid, d.hi, d.flags };
        ...
        public static decimal Negate(decimal d) => 
            new decimal(d.lo, d.mid, d.hi, d.flags ^ -2147483648);
