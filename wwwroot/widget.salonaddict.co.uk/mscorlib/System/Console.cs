namespace System
{
    ...
    public static class Console
    {
        ...
        private static bool IsKeyDownEvent(Win32Native.InputRecord ir) => 
            ((ir.eventType == 1) && ir.keyEvent.keyDown);
        ...
        public static bool CapsLock =>
            ((Win32Native.GetKeyState(20) & 1) == 1);
        ...
        {
            get => 
                GetBufferInfo().dwCursorPosition.X;
            set
            {
        ...
        {
            get => 
                GetBufferInfo().dwCursorPosition.Y;
            set
            {
        ...
        {
            get => 
                Encoding.GetEncoding((int) Win32Native.GetConsoleCP());
            set
            {
                if (value == null)
                {
        ...
        public static int LargestWindowHeight =>
            Win32Native.GetLargestConsoleWindowSize(ConsoleOutputHandle).Y;

        public static int LargestWindowWidth =>
            Win32Native.GetLargestConsoleWindowSize(ConsoleOutputHandle).X;

        public static bool NumberLock =>
            ((Win32Native.GetKeyState(0x90) & 1) == 1);
        ...
        {
            get => 
                Encoding.GetEncoding((int) Win32Native.GetConsoleOutputCP());
            set
            {
                if (value == null)
                {
