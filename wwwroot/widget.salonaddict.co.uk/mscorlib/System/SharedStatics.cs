namespace System
{
    ...
    internal sealed class SharedStatics
    {
        ...
        internal static long AddMemoryFailPointReservation(long size) => 
            Interlocked.Add(ref _sharedStatics._memFailPointReservedMemory, size);
        ...
        internal static int Remoting_Identity_GetNextSeqNum() => 
            Interlocked.Increment(ref _sharedStatics._Remoting_Identity_IDSeqNum);

        internal static ulong MemoryFailPointReservedMemory =>
            ((ulong) _sharedStatics._memFailPointReservedMemory);
