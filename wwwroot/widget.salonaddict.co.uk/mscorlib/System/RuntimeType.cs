namespace System
{
    ...
    internal class RuntimeType : Type, ISerializable, ICloneable
    {
        ...
        internal static bool CanCastTo(RuntimeType fromType, RuntimeType toType) => 
            fromType.GetTypeHandleInternal().CanCastTo(toType.GetTypeHandleInternal());
        ...
        internal static object CreateEnum(RuntimeTypeHandle enumType, long value) => 
            _CreateEnum(enumType.Value, value);
        ...
        internal object CreateInstanceImpl(bool publicOnly) => 
            this.CreateInstanceImpl(publicOnly, false, true);
        ...
        public override ConstructorInfo[] GetConstructors(BindingFlags bindingAttr) => 
            this.GetConstructorCandidates(null, bindingAttr, CallingConventions.Any, null, false);
        ...
        public override Type GetElementType() => 
            this.GetTypeHandleInternal().GetElementType().GetRuntimeType();
        ...
        public override EventInfo[] GetEvents(BindingFlags bindingAttr) => 
            this.GetEventCandidates(null, bindingAttr, false);
        ...
        internal static FieldInfo GetFieldInfo(RuntimeFieldHandle fieldHandle) => 
            GetFieldInfo(fieldHandle.GetApproxDeclaringType(), fieldHandle);
        ...
        public override FieldInfo[] GetFields(BindingFlags bindingAttr) => 
            this.GetFieldCandidates(null, bindingAttr, false);
        ...
        public override int GetHashCode() => 
            ((int) this.GetTypeHandleInternal().Value);
        ...
        internal static MethodBase GetMethodBase(RuntimeMethodHandle methodHandle) => 
            GetMethodBase(RuntimeTypeHandle.EmptyHandle, methodHandle);

        internal static MethodBase GetMethodBase(ModuleHandle scope, int typeMetadataToken) => 
            GetMethodBase(scope.ResolveMethodHandle(typeMetadataToken));
        ...
        public override MethodInfo[] GetMethods(BindingFlags bindingAttr) => 
            this.GetMethodCandidates(null, bindingAttr, CallingConventions.Any, null, false);
        ...
        public override Type[] GetNestedTypes(BindingFlags bindingAttr) => 
            this.GetNestedTypeCandidates(null, bindingAttr, false);
        ...
        public override PropertyInfo[] GetProperties(BindingFlags bindingAttr) => 
            this.GetPropertyCandidates(null, bindingAttr, null, false);
        ...
        internal override bool HasProxyAttributeImpl() => 
            this.GetTypeHandleInternal().HasProxyAttribute();
        ...
        protected override bool IsByRefImpl() => 
            (this.GetTypeHandleInternal().GetCorElementType() == CorElementType.ByRef);

        protected override bool IsCOMObjectImpl() => 
            this.GetTypeHandleInternal().IsComObject(false);

        protected override bool IsContextfulImpl() => 
            this.GetTypeHandleInternal().IsContextful();
        ...
        internal bool IsGenericCOMObjectImpl() => 
            this.m_handle.IsComObject(true);

        public override bool IsInstanceOfType(object o) => 
            this.GetTypeHandleInternal().IsInstanceOfType(o);

        protected override bool IsPointerImpl() => 
            (this.GetTypeHandleInternal().GetCorElementType() == CorElementType.Ptr);
        ...
        public override Type MakeArrayType() => 
            this.m_handle.MakeSZArray().GetRuntimeType();
        ...
        public override Type MakeByRefType() => 
            this.m_handle.MakeByRef().GetRuntimeType();
        ...
        public override Type MakePointerType() => 
            this.m_handle.MakePointer().GetRuntimeType();
        ...
        internal static Type PrivateGetType(string typeName, bool throwOnError, bool ignoreCase, ref StackCrawlMark stackMark) => 
            PrivateGetType(typeName, throwOnError, ignoreCase, false, ref stackMark);
        ...
        internal bool SupportsInterface(object o) => 
            this.TypeHandle.SupportsInterface(o);
        ...
        public override System.Reflection.Assembly Assembly =>
            this.GetTypeHandleInternal().GetAssemblyHandle().GetAssembly();
        ...
        public override bool ContainsGenericParameters =>
            this.GetRootElementType().GetTypeHandleInternal().ContainsGenericVariables();
        ...
        public override Type DeclaringType =>
            this.Cache.GetEnclosingType();

        internal bool DomainInitialized
        {
            get => 
                this.Cache.DomainInitialized;
            set
            {
        ...
        public override bool IsGenericParameter =>
            this.m_handle.IsGenericVariable();

        public override bool IsGenericType =>
            (!base.HasElementType && this.GetTypeHandleInternal().HasInstantiation());

        public override bool IsGenericTypeDefinition =>
            this.m_handle.IsGenericTypeDefinition();

        internal override bool IsSzArray =>
            (this.GetTypeHandleInternal().GetCorElementType() == CorElementType.SzArray);
        ...
        public override int MetadataToken =>
            this.m_handle.GetToken();

        public override System.Reflection.Module Module =>
            this.GetTypeHandleInternal().GetModuleHandle().GetModule();
        ...
        public override System.Runtime.InteropServices.StructLayoutAttribute StructLayoutAttribute =>
            ((System.Runtime.InteropServices.StructLayoutAttribute) System.Runtime.InteropServices.StructLayoutAttribute.GetCustomAttribute(this));
        ...
        internal class RuntimeTypeCache
        {
            ...
            internal CerArrayList<RuntimeConstructorInfo> GetConstructorList(MemberListType listType, string name) => 
                this.GetMemberList<RuntimeConstructorInfo>(ref this.m_constructorInfoCache, listType, name, CacheType.Constructor);
            ...
            internal CerArrayList<RuntimeEventInfo> GetEventList(MemberListType listType, string name) => 
                this.GetMemberList<RuntimeEventInfo>(ref this.m_eventInfoCache, listType, name, CacheType.Event);
            ...
            internal CerArrayList<RuntimeFieldInfo> GetFieldList(MemberListType listType, string name) => 
                this.GetMemberList<RuntimeFieldInfo>(ref this.m_fieldInfoCache, listType, name, CacheType.Field);
            ...
            internal CerArrayList<System.RuntimeType> GetInterfaceList(MemberListType listType, string name) => 
                this.GetMemberList<System.RuntimeType>(ref this.m_interfaceCache, listType, name, CacheType.Interface);
            ...
            private CerArrayList<T> GetMemberList<T>(ref MemberInfoCache<T> m_cache, MemberListType listType, string name, CacheType cacheType) where T: MemberInfo => 
                this.GetMemberCache<T>(ref m_cache).GetMemberList(listType, name, cacheType);
            ...
            internal CerArrayList<RuntimeMethodInfo> GetMethodList(MemberListType listType, string name) => 
                this.GetMemberList<RuntimeMethodInfo>(ref this.m_methodInfoCache, listType, name, CacheType.Method);

            internal string GetName() => 
                this.ConstructName(ref this.m_name, false, false, false);
            ...
            internal CerArrayList<System.RuntimeType> GetNestedTypeList(MemberListType listType, string name) => 
                this.GetMemberList<System.RuntimeType>(ref this.m_nestedClassesCache, listType, name, CacheType.NestedType);

            internal CerArrayList<RuntimePropertyInfo> GetPropertyList(MemberListType listType, string name) => 
                this.GetMemberList<RuntimePropertyInfo>(ref this.m_propertyInfoCache, listType, name, CacheType.Property);

            internal string GetToString() => 
                this.ConstructName(ref this.m_toString, true, false, false);
            ...
            private class MemberInfoCache<T> where T: MemberInfo
            {
                ...
                internal RuntimeType ReflectedType =>
                    this.ReflectedTypeHandle.GetRuntimeType();

                internal RuntimeTypeHandle ReflectedTypeHandle =>
                    this.m_runtimeTypeCache.RuntimeTypeHandle;
            }
