namespace System.Security.Permissions
{
    ...
    public sealed class KeyContainerPermission : CodeAccessPermission, IUnrestrictedPermission, IBuiltInPermission
    {
        ...
        {
            KeyContainerPermissionAccessEntry entry = new KeyContainerPermissionAccessEntry(accessEntry);
            entry.Flags &= GetApplicableFlags(accessEntry, target);
