namespace System.Security.Permissions
{
    ...
    public sealed class RegistryPermission : CodeAccessPermission, IUnrestrictedPermission, IBuiltInPermission
    {
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            StringExpressionSet set = this.m_read?.Intersect(permission.m_read);
            StringExpressionSet set2 = this.m_write?.Intersect(permission.m_write);
            StringExpressionSet set3 = this.m_create?.Intersect(permission.m_create);
            StringExpressionSet set4 = this.m_viewAcl?.Intersect(permission.m_viewAcl);
            StringExpressionSet set5 = this.m_changeAcl?.Intersect(permission.m_changeAcl);
