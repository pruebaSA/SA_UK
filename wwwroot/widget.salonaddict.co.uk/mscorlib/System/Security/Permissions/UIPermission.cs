namespace System.Security.Permissions
{
    ...
    public sealed class UIPermission : CodeAccessPermission, IUnrestrictedPermission, IBuiltInPermission
    {
        ...
        public override IPermission Copy() => 
            new UIPermission(this.m_windowFlag, this.m_clipboardFlag);
        ...
        public bool IsUnrestricted() => 
            ((this.m_windowFlag == UIPermissionWindow.AllWindows) && (this.m_clipboardFlag == UIPermissionClipboard.AllClipboard));
