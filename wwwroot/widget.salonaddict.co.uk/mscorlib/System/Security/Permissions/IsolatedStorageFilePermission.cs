namespace System.Security.Permissions
{
    ...
    public sealed class IsolatedStorageFilePermission : IsolatedStoragePermission, IBuiltInPermission
    {
        ...
        public override SecurityElement ToXml() => 
            base.ToXml("System.Security.Permissions.IsolatedStorageFilePermission");
        ...
        public override IPermission Union(IPermission target)
        {
            ...
            return new IsolatedStorageFilePermission(PermissionState.None) { 
                m_userQuota = IsolatedStoragePermission.max(base.m_userQuota, permission.m_userQuota),
                m_machineQuota = IsolatedStoragePermission.max(base.m_machineQuota, permission.m_machineQuota),
                m_expirationDays = IsolatedStoragePermission.max(base.m_expirationDays, permission.m_expirationDays),
                m_permanentData = base.m_permanentData || permission.m_permanentData,
                m_allowed = (IsolatedStorageContainment) ((int) IsolatedStoragePermission.max((long) base.m_allowed, (long) permission.m_allowed))
            };
        }
    }
}
