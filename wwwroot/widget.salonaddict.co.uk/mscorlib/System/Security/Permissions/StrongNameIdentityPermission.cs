    ...
    public sealed class StrongNameIdentityPermission : CodeAccessPermission, IBuiltInPermission
    {
        ...
        public override void FromXml(SecurityElement e)
        {
            ...
            else
            {
                ...
                if (list.Count != 0)
                {
                    this.m_strongNames = (StrongName2[]) list.ToArray(typeof(StrongName2));
                }
            }
        }
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            foreach (StrongName2 name in this.m_strongNames)
            {
                ...
                {
                    StrongName2 name3 = name.Intersect(name2);
                    if (name3 != null)
                    {
                        list.Add(name3);
                    }
            ...
            return new StrongNameIdentityPermission(PermissionState.None) { m_strongNames = (StrongName2[]) list.ToArray(typeof(StrongName2)) };
        }
