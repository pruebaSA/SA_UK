    ...
    public sealed class UrlIdentityPermission : CodeAccessPermission, IBuiltInPermission
    {
        ...
        public override void FromXml(SecurityElement esd)
        {
            ...
            else
            {
                ...
                if (list.Count != 0)
                {
                    this.m_urls = (URLString[]) list.ToArray(typeof(URLString));
                }
            }
        }
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            foreach (URLString str in this.m_urls)
            {
                ...
                {
                    URLString str3 = (URLString) str.Intersect(str2);
                    if (str3 != null)
                    {
                        list.Add(str3);
                    }
            ...
            return new UrlIdentityPermission(PermissionState.None) { m_urls = (URLString[]) list.ToArray(typeof(URLString)) };
        }
