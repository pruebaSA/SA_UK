    ...
    public sealed class SiteIdentityPermission : CodeAccessPermission, IBuiltInPermission
    {
        ...
        public override void FromXml(SecurityElement esd)
        {
            ...
            else
            {
                ...
                if (list.Count != 0)
                {
                    this.m_sites = (SiteString[]) list.ToArray(typeof(SiteString));
                }
            }
        }
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            foreach (SiteString str in this.m_sites)
            {
                ...
                {
                    SiteString str3 = str.Intersect(str2);
                    if (str3 != null)
                    {
                        list.Add(str3);
                    }
            ...
            return new SiteIdentityPermission(PermissionState.None) { m_sites = (SiteString[]) list.ToArray(typeof(SiteString)) };
        }
