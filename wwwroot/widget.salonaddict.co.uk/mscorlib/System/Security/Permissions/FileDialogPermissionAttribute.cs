namespace System.Security.Permissions
{
    ...
    public sealed class FileDialogPermissionAttribute : CodeAccessSecurityAttribute
    {
        ...
        {
            get => 
                ((this.m_access & FileDialogPermissionAccess.Open) != FileDialogPermissionAccess.None);
            set
            {
        ...
        {
            get => 
                ((this.m_access & FileDialogPermissionAccess.Save) != FileDialogPermissionAccess.None);
            set
            {
