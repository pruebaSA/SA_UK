namespace System.Security.AccessControl
{
    ...
    public abstract class GenericSecurityDescriptor
    {
        ...
        public static bool IsSddlConversionSupported() => 
            System.Security.AccessControl.Win32.IsSddlConversionSupported();
        ...
        internal static int UnmarshalInt(byte[] binaryForm, int offset) => 
            (((binaryForm[offset] + (binaryForm[offset + 1] << 8)) + (binaryForm[offset + 2] << 0x10)) + (binaryForm[offset + 3] << 0x18));
        ...
        private bool IsCraftedAefaDacl =>
            ((this.GenericDacl is DiscretionaryAcl) && (this.GenericDacl as DiscretionaryAcl).EveryOneFullAccessForNullDacl);
