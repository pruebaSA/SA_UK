namespace System.Security.AccessControl
{
    ...
    public sealed class CommonSecurityDescriptor : GenericSecurityDescriptor
    {
        ...
        private void CreateFromParts(bool isContainer, bool isDS, System.Security.AccessControl.ControlFlags flags, SecurityIdentifier owner, SecurityIdentifier group, System.Security.AccessControl.SystemAcl systemAcl, System.Security.AccessControl.DiscretionaryAcl discretionaryAcl)
        {
            ...
            this._rawSd = new RawSecurityDescriptor(flags2, owner, group, systemAcl?.RawAcl, discretionaryAcl.RawAcl);
        }
        ...
        internal bool IsDiscretionaryAclPresent =>
            ((this._rawSd.ControlFlags & System.Security.AccessControl.ControlFlags.DiscretionaryAclPresent) != System.Security.AccessControl.ControlFlags.None);
        ...
        internal bool IsSystemAclPresent =>
            ((this._rawSd.ControlFlags & System.Security.AccessControl.ControlFlags.SystemAclPresent) != System.Security.AccessControl.ControlFlags.None);
