namespace System.Security.Policy
{
    ...
    public sealed class StrongNameMembershipCondition : IConstantMembershipCondition, IReportMatchMembershipCondition, IMembershipCondition, ISecurityEncodable, ISecurityPolicyEncodable
    {
        ...
        public IMembershipCondition Copy() => 
            new StrongNameMembershipCondition(this.PublicKey, this.Name, this.Version);
        ...
        bool IReportMatchMembershipCondition.Check(Evidence evidence, out object usedEvidence)
        {
            ...
            if (evidence != null)
            {
                ...
                while (hostEnumerator.MoveNext())
                {
                    ...
                    {
                        StrongName current = (StrongName) hostEnumerator.Current;
                        if ((((this.PublicKey != null) && this.PublicKey.Equals(current.PublicKey)) && ((this.Name == null) || ((current.Name != null) && StrongName.CompareNames(current.Name, this.Name)))) && ((this.Version == null) || ((current.Version != null) && (current.Version.CompareTo(this.Version) == 0))))
                        {
