namespace System.Security.Policy
{
    ...
    [ComVisible(true), SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.ControlPolicy)]
    public sealed class ApplicationTrustCollection : ICollection, IEnumerable
    {
        ...
        public ApplicationTrustEnumerator GetEnumerator() => 
            new ApplicationTrustEnumerator(this);
        ...
        public ApplicationTrust this[int index] =>
            (this.AppTrusts[index] as ApplicationTrust);
