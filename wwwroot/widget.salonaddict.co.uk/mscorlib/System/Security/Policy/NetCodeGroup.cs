    ...
    public sealed class NetCodeGroup : CodeGroup, IUnionSemanticCodeGroup
    {
        ...
        private PolicyStatement CalculateAssemblyPolicy(Evidence evidence)
        {
            ...
            while (hostEnumerator.MoveNext())
            {
                ...
                if (current != null)
                {
                    statement = this.CalculatePolicy(current.GetURLString().Host, current.GetURLString().Scheme, current.GetURLString().Port);
                }
                else if (site == null)
                {
        ...
        {
            SecurityElement child = this.CreateWebPermission(host, scheme, port);
        ...
        private SecurityElement CreateWebPermission(string host, string scheme, string port)
        {
            ...
            element.AddAttribute("class", "System.Net.WebPermission, System, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
            ...
            string str = this.TryPermissionAsOneString(access, scheme, host, intPort);
            if (str != null)
            {
                SecurityElement element3 = new SecurityElement("URI");
                element3.AddAttribute("uri", str);
            ...
            else
            {
                ...
                {
                    str = this.GetPermissionAccessElementString(access[i], scheme, host, port);
                    SecurityElement element4 = new SecurityElement("URI");
                    element4.AddAttribute("uri", str);
        ...
        public override int GetHashCode() => 
            (base.GetHashCode() + this.GetRulesHashCode());
        ...
        public override string PermissionSetName =>
            Environment.GetResourceString("NetCodeGroup_PermissionSet");
    }
}
