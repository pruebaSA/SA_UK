namespace System.Security.Policy
{
    ...
    public static class ApplicationSecurityManager
    {
        ...
        private static SecurityElement CreateDefaultApplicationTrustManagerElement()
        {
            ...
            element.AddAttribute("class", "System.Security.Policy.TrustManager, System.Windows.Forms, Version=" + Assembly.GetExecutingAssembly().GetVersion() + ", Culture=neutral, PublicKeyToken=b77a5c561934e089");
        ...
        private static IApplicationTrustManager DecodeAppTrustManager()
        {
            if (File.InternalExists(s_machineConfigFile))
            {
                ...
                SecurityElement element2 = SecurityElement.FromString(new StreamReader(stream).ReadToEnd()).SearchForChildByTag("mscorlib");
                if (element2 != null)
                {
        ...
        [SecurityPermission(SecurityAction.Assert, Unrestricted=true), SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.ControlPolicy | SecurityPermissionFlag.ControlEvidence)]
        ...
        public static ApplicationTrustCollection UserApplicationTrusts =>
            new ApplicationTrustCollection(true);
    }
}
