namespace System.Security.Cryptography
{
    ...
    public sealed class RC2CryptoServiceProvider : RC2
    {
        ...
        private ICryptoTransform _NewEncryptor(byte[] rgbKey, CipherMode mode, byte[] rgbIV, int effectiveKeySize, int feedbackSize, CryptoAPITransformMode encryptMode)
        {
            ...
            {
                throw new CryptographicException(string.Format(CultureInfo.CurrentCulture, Environment.GetResourceString("Cryptography_CSP_AlgKeySizeNotAvailable"), new object[] { bitLength }));
            }
        ...
        public override ICryptoTransform CreateDecryptor(byte[] rgbKey, byte[] rgbIV) => 
            this._NewEncryptor(rgbKey, base.ModeValue, rgbIV, base.EffectiveKeySizeValue, base.FeedbackSizeValue, CryptoAPITransformMode.Decrypt);

        public override ICryptoTransform CreateEncryptor(byte[] rgbKey, byte[] rgbIV) => 
            this._NewEncryptor(rgbKey, base.ModeValue, rgbIV, base.EffectiveKeySizeValue, base.FeedbackSizeValue, CryptoAPITransformMode.Encrypt);
