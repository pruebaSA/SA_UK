namespace System.Security.Cryptography
{
    ...
    public sealed class CryptoAPITransform : ICryptoTransform, IDisposable
    {
            ...
            for (int j = 0; j < cArgs; j++)
            {
                ...
                switch (rgArgIds[j])
                {
                    case 1:
                    {
                        ...
                        Utils._SetKeyParamRgb(this._safeKeyHandle, destinationArray[j], iVValue);
                        continue;
                    }
                    case 4:
                ...
                Utils._SetKeyParamDw(this._safeKeyHandle, destinationArray[j], num);
            }
        }
        ...
        public int InputBlockSize =>
            (this.BlockSizeValue / 8);

        public IntPtr KeyHandle =>
            this._safeKeyHandle.DangerousGetHandle();
