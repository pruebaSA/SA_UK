namespace System.Security.Cryptography
{
    ...
    public abstract class DES : SymmetricAlgorithm
    {
        ...
        public static DES Create() => 
            Create("System.Security.Cryptography.DES");

        public static DES Create(string algName) => 
            ((DES) CryptoConfig.CreateFromName(algName));

        private static bool IsLegalKeySize(byte[] rgbKey) => 
            ((rgbKey != null) && (rgbKey.Length == 8));
        ...
        private static ulong QuadWordFromBigEndian(byte[] block) => 
            ((ulong) ((((((((block[0] << 0x38) | (block[1] << 0x30)) | (block[2] << 40)) | (block[3] << 0x20)) | (block[4] << 0x18)) | (block[5] << 0x10)) | (block[6] << 8)) | block[7]));
