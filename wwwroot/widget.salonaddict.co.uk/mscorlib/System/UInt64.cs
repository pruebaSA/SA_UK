namespace System
{
    ...
    public struct UInt64 : IComparable, IFormattable, IConvertible, IComparable<ulong>, IEquatable<ulong>
    {
        ...
        public override string ToString() => 
            Number.FormatUInt64(this, null, NumberFormatInfo.CurrentInfo);

        public string ToString(IFormatProvider provider) => 
            Number.FormatUInt64(this, null, NumberFormatInfo.GetInstance(provider));

        public string ToString(string format) => 
            Number.FormatUInt64(this, format, NumberFormatInfo.CurrentInfo);

        public string ToString(string format, IFormatProvider provider) => 
            Number.FormatUInt64(this, format, NumberFormatInfo.GetInstance(provider));

        [CLSCompliant(false)]
        public static ulong Parse(string s) => 
            Number.ParseUInt64(s, NumberStyles.Integer, NumberFormatInfo.CurrentInfo);
        ...
        public static ulong Parse(string s, IFormatProvider provider) => 
            Number.ParseUInt64(s, NumberStyles.Integer, NumberFormatInfo.GetInstance(provider));
        ...
        public static bool TryParse(string s, out ulong result) => 
            Number.TryParseUInt64(s, NumberStyles.Integer, NumberFormatInfo.CurrentInfo, out result);
