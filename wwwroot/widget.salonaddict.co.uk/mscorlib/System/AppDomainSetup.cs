namespace System
{
    ...
    public sealed class AppDomainSetup : IAppDomainSetup
    {
        ...
        {
            get => 
                this._AppDomainInitializerArguments;
            set
            {
        ...
        {
            get => 
                this.VerifyDir(this.Value[0], false);
            set
            {
        ...
        {
            get => 
                this.VerifyDir(this.Value[9], false);
            set
            {
        ...
        {
            get => 
                this.VerifyDir(this.Value[1], true);
            set
            {
                this.Value[1] = value;
            }
        ...
        internal string ConfigurationFileInternal =>
            this.NormalizePath(this.Value[1], true);
        ...
        {
            get => 
                this.VerifyDir(this.Value[2], true);
            set
            {
                if (value == null)
                {
        ...
        {
            get => 
                this.VerifyDir(this.Value[10], true);
            set
            {
                this.Value[10] = value;
            }
