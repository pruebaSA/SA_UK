namespace System
{
    ...
    public struct Double : IComparable, IFormattable, IConvertible, IComparable<double>, IEquatable<double>
    {
        ...
        internal static unsafe bool IsNegative(double d) => 
            ((*(((long*) &d)) & -9223372036854775808L) == -9223372036854775808L);
        ...
        public string ToString(string format) => 
            Number.FormatDouble(this, format, NumberFormatInfo.CurrentInfo);

        public string ToString(IFormatProvider provider) => 
            Number.FormatDouble(this, null, NumberFormatInfo.GetInstance(provider));

        public string ToString(string format, IFormatProvider provider) => 
            Number.FormatDouble(this, format, NumberFormatInfo.GetInstance(provider));
