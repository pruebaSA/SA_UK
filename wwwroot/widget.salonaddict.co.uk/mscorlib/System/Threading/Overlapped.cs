namespace System.Threading
{
    ...
    public class Overlapped
    {
        ...
        public unsafe NativeOverlapped* Pack(IOCompletionCallback iocb, object userData) => 
            this.m_overlappedData.Pack(iocb, userData);
        ...
        public unsafe NativeOverlapped* UnsafePack(IOCompletionCallback iocb, object userData) => 
            this.m_overlappedData.UnsafePack(iocb, userData);

        public IAsyncResult AsyncResult
        {
            get => 
                this.m_overlappedData.m_asyncResult;
            set
            {
        ...
        {
            get => 
                this.m_overlappedData.UserHandle.ToInt32();
            set
            {
        ...
        {
            get => 
                this.m_overlappedData.UserHandle;
            set
            {
        ...
        internal _IOCompletionCallback iocbHelper =>
            this.m_overlappedData.m_iocbHelper;

        public int OffsetHigh
        {
            get => 
                this.m_overlappedData.m_nativeOverlapped.OffsetHigh;
            set
            {
        ...
        {
            get => 
                this.m_overlappedData.m_nativeOverlapped.OffsetLow;
            set
            {
