namespace System.Threading
{
    ...
    public sealed class Mutex : WaitHandle
    {
        ...
        public MutexSecurity GetAccessControl() => 
            new MutexSecurity(base.safeWaitHandle, AccessControlSections.Group | AccessControlSections.Owner | AccessControlSections.Access);
        ...
        public static Mutex OpenExisting(string name) => 
            OpenExisting(name, MutexRights.Synchronize | MutexRights.Modify);
