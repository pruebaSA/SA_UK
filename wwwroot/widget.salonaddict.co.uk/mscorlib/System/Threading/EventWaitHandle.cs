namespace System.Threading
{
    ...
    public class EventWaitHandle : WaitHandle
    {
        ...
        public EventWaitHandleSecurity GetAccessControl() => 
            new EventWaitHandleSecurity(base.safeWaitHandle, AccessControlSections.Group | AccessControlSections.Owner | AccessControlSections.Access);

        [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
        public static EventWaitHandle OpenExisting(string name) => 
            OpenExisting(name, EventWaitHandleRights.Synchronize | EventWaitHandleRights.Modify);
