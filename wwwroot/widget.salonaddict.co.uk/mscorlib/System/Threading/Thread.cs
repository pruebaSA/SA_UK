namespace System.Threading
{
    ...
    public sealed class Thread : CriticalFinalizerObject, _Thread
    {
        ...
        public static LocalDataStoreSlot AllocateDataSlot() => 
            LocalDataStoreManager.AllocateDataSlot();

        [HostProtection(SecurityAction.LinkDemand, SharedState=true, ExternalThreading=true)]
        public static LocalDataStoreSlot AllocateNamedDataSlot(string name) => 
            LocalDataStoreManager.AllocateNamedDataSlot(name);
        ...
        public System.Threading.ApartmentState GetApartmentState() => 
            ((System.Threading.ApartmentState) this.GetApartmentStateNative());
        ...
        internal IllogicalCallContext GetIllogicalCallContext() => 
            this.ExecutionContext.IllogicalCallContext;

        [HostProtection(SecurityAction.LinkDemand, SharedState=true, ExternalThreading=true)]
        internal LogicalCallContext GetLogicalCallContext() => 
            this.ExecutionContext.LogicalCallContext;

        [HostProtection(SecurityAction.LinkDemand, SharedState=true, ExternalThreading=true)]
        public static LocalDataStoreSlot GetNamedDataSlot(string name) => 
            LocalDataStoreManager.GetNamedDataSlot(name);
        ...
        internal object InternalCrossContextCallback(Context ctx, InternalCrossContextDelegate ftnToCall, object[] args) => 
            this.InternalCrossContextCallback(ctx, ctx.InternalContextID, 0, ftnToCall, args);
        ...
        public bool Join(int millisecondsTimeout) => 
            this.JoinInternal(millisecondsTimeout);
        ...
        public bool TrySetApartmentState(System.Threading.ApartmentState state) => 
            this.SetApartmentStateHelper(state, false);
        ...
        public static Context CurrentContext =>
            CurrentThread.GetCurrentContextInternal();
        ...
        {
            get => 
                ((ThreadPriority) this.GetPriorityNative());
            [HostProtection(SecurityAction.LinkDemand, SelfAffectingThreading=true)]
            set
            {
        ...
        public System.Threading.ThreadState ThreadState =>
            ((System.Threading.ThreadState) this.GetThreadStateNative());
    }
}
