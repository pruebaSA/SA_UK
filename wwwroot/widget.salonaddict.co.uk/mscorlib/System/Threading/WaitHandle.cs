namespace System.Threading
{
    ...
    public abstract class WaitHandle : MarshalByRefObject, IDisposable
    {
        ...
        public static bool SignalAndWait(WaitHandle toSignal, WaitHandle toWaitOn) => 
            SignalAndWait(toSignal, toWaitOn, -1, false);
        ...
        public static bool WaitAll(WaitHandle[] waitHandles) => 
            WaitAll(waitHandles, -1, true);

        public static bool WaitAll(WaitHandle[] waitHandles, int millisecondsTimeout) => 
            WaitAll(waitHandles, millisecondsTimeout, true);

        public static bool WaitAll(WaitHandle[] waitHandles, TimeSpan timeout) => 
            WaitAll(waitHandles, timeout, true);
        ...
        public static int WaitAny(WaitHandle[] waitHandles) => 
            WaitAny(waitHandles, -1, true);

        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        public static int WaitAny(WaitHandle[] waitHandles, int millisecondsTimeout) => 
            WaitAny(waitHandles, millisecondsTimeout, true);

        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        public static int WaitAny(WaitHandle[] waitHandles, TimeSpan timeout) => 
            WaitAny(waitHandles, timeout, true);
        ...
        public virtual bool WaitOne() => 
            this.WaitOne(-1, false);

        public virtual bool WaitOne(int millisecondsTimeout) => 
            this.WaitOne(millisecondsTimeout, false);

        public virtual bool WaitOne(TimeSpan timeout) => 
            this.WaitOne(timeout, false);
