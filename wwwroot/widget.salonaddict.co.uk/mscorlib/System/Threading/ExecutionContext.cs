namespace System.Threading
{
    ...
    public sealed class ExecutionContext : ISerializable
    {
        ...
        internal static ExecutionContext Capture(ref StackCrawlMark stackMark)
        {
            ...
            {
                context2._syncContext = executionContextNoCreate._syncContext?.CreateCopy();
        ...
        public ExecutionContext CreateCopy()
        {
            ...
            ExecutionContext context = new ExecutionContext {
                isNewCapture = true,
                _syncContext = this._syncContext?.CreateCopy(),
                _hostExecutionContext = this._hostExecutionContext?.CreateCopy()
            };
        ...
        internal static ExecutionContextSwitcher SetExecutionContext(ExecutionContext executionContext)
        {
            ...
            try
            {
                ...
                {
                    System.Security.SecurityContext prevSecurityContext = switcher.prevEC?.SecurityContext;
                ...
                {
                    System.Security.SecurityContext context3 = switcher.prevEC?.SecurityContext;
                ...
                {
                    System.Threading.SynchronizationContext prevSyncContext = switcher.prevEC?.SynchronizationContext;
