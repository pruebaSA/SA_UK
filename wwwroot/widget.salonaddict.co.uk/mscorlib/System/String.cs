namespace System
{
    ...
    public sealed class String : IComparable, ICloneable, IConvertible, IComparable<string>, IEnumerable<char>, IEnumerable, IEquatable<string>
    {
        ...
        public bool Contains(string value) => 
            (this.IndexOf(value, StringComparison.Ordinal) >= 0);
        ...
        public bool EndsWith(string value) => 
            this.EndsWith(value, false, null);
        ...
        public static bool Equals(string a, string b) => 
            ((a == b) || (((a != null) && (b != null)) && EqualsHelper(a, b)));
        ...
        internal static string GetStringForStringBuilder(string value, int capacity) => 
            GetStringForStringBuilder(value, 0, value.Length, capacity);
        ...
        public int IndexOf(char value) => 
            this.IndexOf(value, 0, this.Length);

        public int IndexOf(string value) => 
            CultureInfo.CurrentCulture.CompareInfo.IndexOf(this, value);

        public int IndexOf(char value, int startIndex) => 
            this.IndexOf(value, startIndex, this.Length - startIndex);

        public int IndexOf(string value, int startIndex) => 
            CultureInfo.CurrentCulture.CompareInfo.IndexOf(this, value, startIndex);

        public int IndexOf(string value, StringComparison comparisonType) => 
            this.IndexOf(value, 0, this.Length, comparisonType);
        ...
        public int IndexOf(string value, int startIndex, StringComparison comparisonType) => 
            this.IndexOf(value, startIndex, this.Length - startIndex, comparisonType);
        ...
        public int IndexOfAny(char[] anyOf) => 
            this.IndexOfAny(anyOf, 0, this.Length);

        public int IndexOfAny(char[] anyOf, int startIndex) => 
            this.IndexOfAny(anyOf, startIndex, this.Length - startIndex);
        ...
        public bool IsNormalized() => 
            this.IsNormalized(NormalizationForm.FormC);
        ...
        public int LastIndexOf(char value) => 
            this.LastIndexOf(value, this.Length - 1, this.Length);

        public int LastIndexOf(string value) => 
            this.LastIndexOf(value, this.Length - 1, this.Length, StringComparison.CurrentCulture);

        public int LastIndexOf(char value, int startIndex) => 
            this.LastIndexOf(value, startIndex, startIndex + 1);

        public int LastIndexOf(string value, int startIndex) => 
            this.LastIndexOf(value, startIndex, startIndex + 1, StringComparison.CurrentCulture);

        public int LastIndexOf(string value, StringComparison comparisonType) => 
            this.LastIndexOf(value, this.Length - 1, this.Length, comparisonType);
        ...
        public int LastIndexOf(string value, int startIndex, StringComparison comparisonType) => 
            this.LastIndexOf(value, startIndex, startIndex + 1, comparisonType);
        ...
        public int LastIndexOfAny(char[] anyOf) => 
            this.LastIndexOfAny(anyOf, this.Length - 1, this.Length);

        public int LastIndexOfAny(char[] anyOf, int startIndex) => 
            this.LastIndexOfAny(anyOf, startIndex, startIndex + 1);
        ...
        public string Normalize() => 
            this.Normalize(NormalizationForm.FormC);
        ...
        public string PadLeft(int totalWidth) => 
            this.PadHelper(totalWidth, ' ', false);

        public string PadLeft(int totalWidth, char paddingChar) => 
            this.PadHelper(totalWidth, paddingChar, false);

        public string PadRight(int totalWidth) => 
            this.PadHelper(totalWidth, ' ', true);

        public string PadRight(int totalWidth, char paddingChar) => 
            this.PadHelper(totalWidth, paddingChar, true);
        ...
        public string[] Split(params char[] separator) => 
            this.Split(separator, 0x7fffffff, StringSplitOptions.None);

        public string[] Split(char[] separator, int count) => 
            this.Split(separator, count, StringSplitOptions.None);

        [ComVisible(false)]
        public string[] Split(char[] separator, StringSplitOptions options) => 
            this.Split(separator, 0x7fffffff, options);
        ...
        public bool StartsWith(string value) => 
            this.StartsWith(value, false, null);
        ...
        public string Substring(int startIndex) => 
            this.Substring(startIndex, this.Length - startIndex);

        public string Substring(int startIndex, int length) => 
            this.InternalSubStringWithChecks(startIndex, length, false);
        ...
        bool IConvertible.ToBoolean(IFormatProvider provider) => 
            Convert.ToBoolean(this, provider);

        byte IConvertible.ToByte(IFormatProvider provider) => 
            Convert.ToByte(this, provider);

        char IConvertible.ToChar(IFormatProvider provider) => 
            Convert.ToChar(this, provider);

        DateTime IConvertible.ToDateTime(IFormatProvider provider) => 
            Convert.ToDateTime(this, provider);

        decimal IConvertible.ToDecimal(IFormatProvider provider) => 
            Convert.ToDecimal(this, provider);

        double IConvertible.ToDouble(IFormatProvider provider) => 
            Convert.ToDouble(this, provider);

        short IConvertible.ToInt16(IFormatProvider provider) => 
            Convert.ToInt16(this, provider);

        int IConvertible.ToInt32(IFormatProvider provider) => 
            Convert.ToInt32(this, provider);

        long IConvertible.ToInt64(IFormatProvider provider) => 
            Convert.ToInt64(this, provider);

        sbyte IConvertible.ToSByte(IFormatProvider provider) => 
            Convert.ToSByte(this, provider);

        float IConvertible.ToSingle(IFormatProvider provider) => 
            Convert.ToSingle(this, provider);

        object IConvertible.ToType(Type type, IFormatProvider provider) => 
            Convert.DefaultToType(this, type, provider);

        ushort IConvertible.ToUInt16(IFormatProvider provider) => 
            Convert.ToUInt16(this, provider);

        uint IConvertible.ToUInt32(IFormatProvider provider) => 
            Convert.ToUInt32(this, provider);

        ulong IConvertible.ToUInt64(IFormatProvider provider) => 
            Convert.ToUInt64(this, provider);
        ...
        public string ToLower() => 
            this.ToLower(CultureInfo.CurrentCulture);

        public string ToLower(CultureInfo culture) => 
            culture?.TextInfo.ToLower(this);

        public string ToLowerInvariant() => 
            this.ToLower(CultureInfo.InvariantCulture);
        ...
        public string ToUpper() => 
            this.ToUpper(CultureInfo.CurrentCulture);

        public string ToUpper(CultureInfo culture) => 
            culture?.TextInfo.ToUpper(this);

        public string ToUpperInvariant() => 
            this.ToUpper(CultureInfo.InvariantCulture);

        public string Trim() => 
            this.TrimHelper(WhitespaceChars, 2);
