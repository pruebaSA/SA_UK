namespace System
{
    ...
    public struct ModuleHandle
    {
        ...
        public RuntimeTypeHandle GetRuntimeTypeHandleFromMetadataToken(int typeToken) => 
            this.ResolveTypeHandle(typeToken);

        public RuntimeTypeHandle ResolveTypeHandle(int typeToken) => 
            this.ResolveTypeHandle(typeToken, null, null);
        ...
        public RuntimeMethodHandle GetRuntimeMethodHandleFromMetadataToken(int methodToken) => 
            this.ResolveMethodHandle(methodToken);

        public RuntimeMethodHandle ResolveMethodHandle(int methodToken) => 
            this.ResolveMethodHandle(methodToken, null, null);
        ...
        public RuntimeFieldHandle GetRuntimeFieldHandleFromMetadataToken(int fieldToken) => 
            this.ResolveFieldHandle(fieldToken);

        public RuntimeFieldHandle ResolveFieldHandle(int fieldToken) => 
            this.ResolveFieldHandle(fieldToken, null, null);
        ...
        internal RuntimeTypeHandle GetModuleTypeHandle() => 
            new RuntimeTypeHandle(this._GetModuleTypeHandle());
