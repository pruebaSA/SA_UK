namespace Microsoft.Win32
{
    ...
    internal static class Win32Native
    {
        ...
        internal const int LCMAP_SORTKEY = 0x400;
        ...
        internal static extern unsafe int FindNLSString(int Locale, int dwFindFlags, char* lpStringSource, int cchSource, char* lpStringValue, int cchValue, IntPtr pcchFound);
        ...
        [DllImport("kernel32.dll", CharSet=CharSet.Unicode, ExactSpelling=true)]
        internal static extern unsafe int LCMapStringW(int lcid, int flags, char* src, int cchSrc, char* target, int cchTarget);
        [DllImport("kernel32.dll", CharSet=CharSet.Auto, SetLastError=true)]
        ...
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail), DllImport("advapi32.dll", EntryPoint="LookupPrivilegeValueW", CharSet=CharSet.Auto, SetLastError=true)]
        ...
        internal static SafeFileHandle UnsafeCreateFile(string lpFileName, int dwDesiredAccess, FileShare dwShareMode, SECURITY_ATTRIBUTES securityAttrs, FileMode dwCreationDisposition, int dwFlagsAndAttributes, IntPtr hTemplateFile) => 
            CreateFile(lpFileName, dwDesiredAccess, dwShareMode, securityAttrs, dwCreationDisposition, dwFlagsAndAttributes, hTemplateFile);
        ...
        internal struct FILE_TIME
        {
            ...
            public long ToTicks() => 
                ((long) ((this.ftTimeHigh << 0x20) + this.ftTimeLow));
        }
