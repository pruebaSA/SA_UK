namespace System.Runtime.Remoting.MetadataServices
{
    ...
    internal class WsdlParser
    {
        ...
        internal string Atomize(string str) => 
            this._XMLReader.NameTable.Add(str);
        ...
        internal static void DisableDtdProcessing(XmlTextReader reader)
        {
            if (!AppSettings.AllowDtdProcessingInWSDL)
            {
        ...
        private static bool IsCSharpKeyword(string value) => 
            cSharpKeywords?.ContainsKey(value);
        ...
        {
            if (!AppSettings.AllowUnsanitizedWSDLUrls)
            {
                return TransliterateString(value);
            }
            if (value == null)
            {
                return "\"\"";
        ...
        private bool MatchingNamespace(string elmNS) => 
            MatchingStrings(this._XMLReader.NamespaceURI, elmNS);
        ...
        internal void Parse()
        {
            ...
            do
            {
                ...
                DisableDtdProcessing(this._XMLReader);
        ...
        private string ParseQName(ref string qname) => 
            this.ParseQName(ref qname, null);
        ...
        private void ParseWsdlBinding(URTNamespace inparsingNamespace)
        {
            ...
            binding.typeNs = this.ParseQName(ref binding.type);
            ...
            while (this._XMLReader.Depth > depth)
            {
                ...
                if (this.MatchingNamespace(s_wsdlSudsNamespaceString))
                {
                    ...
                    if (MatchingStrings(localName, s_classString) || MatchingStrings(localName, s_structString))
                    {
                        ...
                        suds.ns = this.ParseQName(ref suds.typeName);
                        suds.extendsTypeName = this.LookupAttribute(s_extendsString, null, false);
                    ...
                    else
                    {
                        ...
                        WsdlBindingSuds suds2 = new WsdlBindingSuds {
                            elementName = localName,
                            typeName = this.LookupAttribute(s_typeString, null, true)
                        };
                        suds2.ns = this.ParseQName(ref suds2.typeName);
        ...
        private void ParseWsdlBindingSuds(WsdlBindingSuds suds)
        {
            ...
            while (this._XMLReader.Depth > depth)
            {
                ...
                {
                    WsdlBindingSudsImplements implements = new WsdlBindingSudsImplements {
                        typeName = this.LookupAttribute(s_typeString, null, true)
                    };
                    implements.ns = this.ParseQName(ref implements.typeName);
                    suds.implements.Add(implements);
                    this.ReadNextXmlElement();
                }
                else if (MatchingStrings(localName, s_nestedTypeString))
                {
                    WsdlBindingSudsNestedType type = new WsdlBindingSudsNestedType {
                        name = this.LookupAttribute(s_nameString, null, true),
                        typeName = this.LookupAttribute(s_typeString, null, true)
                    };
                    type.ns = this.ParseQName(ref type.typeName);
        ...
        private void ParseWsdlPortType()
        {
            ...
            while (this._XMLReader.Depth > depth)
            {
                if (MatchingStrings(this._XMLReader.LocalName, s_operationString))
                {
                    ...
                    portTypeOperation.nameNs = this.ParseQName(ref portTypeOperation.nameNs);
                    portTypeOperation.parameterOrder = this.LookupAttribute(s_parameterOrderString, null, false);
                    this.ParseWsdlPortTypeOperationContent(portType, portTypeOperation);
        ...
        private void ParseWsdlPortTypeOperationContent(WsdlPortType portType, WsdlPortTypeOperation portTypeOperation)
        {
            ...
            while (this._XMLReader.Depth > depth)
            {
                ...
                {
                    WsdlPortTypeOperationContent content2 = new WsdlPortTypeOperationContent {
                        element = this.Atomize("output"),
                        name = this.LookupAttribute(s_nameString, null, false)
                    };
                    content2.nameNs = this.ParseQName(ref content2.name);
        ...
        private void ParseWsdlService()
        {
            ...
            while (this._XMLReader.Depth > depth)
            {
                ...
                if (this.MatchingNamespace(s_wsdlNamespaceString) && MatchingStrings(localName, s_portString))
                {
                    ...
                    port.nameNs = this.ParseQName(ref port.nameNs);
                    port.binding = this.LookupAttribute(s_bindingString, null, true);
                    port.bindingNs = this.ParseQName(ref port.binding);
        ...
        private bool Qualify(string typeNS, string curNS) => 
            ((!this.MatchingSchemaStrings(typeNS) && !MatchingStrings(typeNS, s_soapNamespaceString)) && ((!MatchingStrings(typeNS, s_wsdlSoapNamespaceString) && !MatchingStrings(typeNS, "System")) && !MatchingStrings(typeNS, curNS)));
        ...
        private static string TransliterateString(string str)
        {
            ...
            foreach (char ch in str)
            {
                if (!char.IsControl(ch))
                {
                    ...
                    {
                        builder.Append(@"\u");
                        builder.Append(Convert.ToInt32(ch).ToString("X4"));
                    }
                }
            }
            builder.Append("\"");
        ...
        internal abstract class BaseInterface
        {
            ...
            internal bool IsURTInterface =>
                (this._namespace == this._encodedNS);
        ...
        internal class URTComplexType : WsdlParser.BaseType
        {
            ...
            internal override string FieldNamespace =>
                ((WsdlParser.URTField) this._fields[0]).TypeNS;
            ...
            internal override bool PrimitiveField =>
                ((WsdlParser.URTField) this._fields[0]).IsPrimitive;
        ...
        internal class URTField
        {
            ...
            internal string GetTypeString(string curNS, bool bNS) => 
                this._parser.GetTypeString(curNS, bNS, this._urtNamespace, this.TypeName, this._typeNS);
        ...
        internal abstract class URTMethod
        {
            ...
            internal string GetTypeString(string curNS, bool bNS) => 
                this._methodType?.GetTypeString(curNS, bNS);
        ...
        internal class URTNamespace
        {
            ...
            internal bool IsEmpty =>
                ((this.ComplexTypeOnlyArrayorEmpty() && (this._URTInterfaces.Count == 0)) && (this._numURTSimpleTypes == 0));

            internal bool IsSystem =>
                ((this._namespace != null) && this._namespace.StartsWith("System", StringComparison.Ordinal));
        ...
        internal class URTParam
        {
            ...
            internal string GetTypeString(string curNS, bool bNS) => 
                this._parser.GetTypeString(curNS, bNS, this._urtNamespace, this._typeName, this._encodedNS);
