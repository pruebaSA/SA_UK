namespace System.Runtime.Remoting.Channels
{
    ...
    internal sealed class SocketStream : Stream
    {
        ...
        public override IAsyncResult BeginRead(byte[] buffer, int offset, int size, AsyncCallback callback, object state) => 
            this._socket.BeginReceive(buffer, offset, Math.Min(size, 0x400000), SocketFlags.None, callback, state);

        public override IAsyncResult BeginWrite(byte[] buffer, int offset, int size, AsyncCallback callback, object state) => 
            this._socket.BeginSend(buffer, offset, size, SocketFlags.None, callback, state);
        ...
        public override int EndRead(IAsyncResult asyncResult) => 
            this._socket.EndReceive(asyncResult);
