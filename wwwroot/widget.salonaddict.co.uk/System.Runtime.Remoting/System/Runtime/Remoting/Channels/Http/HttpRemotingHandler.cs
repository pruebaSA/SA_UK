namespace System.Runtime.Remoting.Channels.Http
{
    ...
    public class HttpRemotingHandler : IHttpHandler
    {
        ...
        private void InternalProcessRequest(HttpContext context)
        {
                    ...
                    lock (ApplicationConfigurationFile)
                    {
                        if (!bLoadedConfiguration)
                        {
                            ...
                            if (File.Exists(path))
                            {
                                ...
                                {
                                    Exception e = new Exception(CoreChannel.GetResourceString("Remoting_nonClsCompliantException"));
                                    s_fatalException = e;
                            ...
                            {
                                s_fatalException = exception3;
                                this.WriteException(context, exception3);
                                return;
                            }
                            catch
                            {
                                Exception exception4 = new Exception(CoreChannel.GetResourceString("Remoting_nonClsCompliantException"));
                                s_fatalException = exception4;
                                this.WriteException(context, exception4);
                                return;
                            }
            ...
            {
                this.WriteException(context, exception5);
            }
            catch
            {
