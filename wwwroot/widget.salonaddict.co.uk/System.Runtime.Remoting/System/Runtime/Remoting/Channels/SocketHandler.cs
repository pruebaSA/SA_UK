namespace System.Runtime.Remoting.Channels
{
    ...
    internal abstract class SocketHandler
    {
        ...
        internal bool IsLocal() => 
            ((this.NetSocket == null) || IPAddress.IsLoopback(((IPEndPoint) this.NetSocket.RemoteEndPoint).Address));
        ...
        public bool RaceForControl() => 
            (1 == Interlocked.Exchange(ref this._controlCookie, 0));
        ...
        {
            get => 
                this._dataArrivedCallbackState;
            set
            {
