    ...
    public abstract class RequestBase
    {
        ...
        public TResult GetResponse<TResult>() where TResult: ResponseBase, new()
        {
            ...
            try
            {
                ...
                HttpWebRequest request = (HttpWebRequest) WebRequest.Create("https://epage.payandshop.com/epage-remote.cgi");
            ...
            {
                throw new RealAuthException(exception.Message, exception);
            }
            return local2;
        }
