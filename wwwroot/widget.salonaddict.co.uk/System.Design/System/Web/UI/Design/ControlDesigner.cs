namespace System.Web.UI.Design
{
    ...
    public class ControlDesigner : HtmlControlDesigner
    {
        ...
        internal static DesignerAutoFormatCollection CreateAutoFormats(string schemes, CreateAutoFormatDelegate createAutoFormatDelegate)
        {
            ...
            try
            {
                ...
                {
                    formats.Add(createAutoFormatDelegate(table.Rows[i]));
                }
            }
            catch (Exception)
            {
        ...
        protected string CreateErrorDesignTimeHtml(string errorMessage) => 
            this.CreateErrorDesignTimeHtml(errorMessage, null);

        protected string CreateErrorDesignTimeHtml(string errorMessage, Exception e) => 
            CreateErrorDesignTimeHtml(errorMessage, e, base.Component);
        ...
        internal string CreateInvalidParentDesignTimeHtml(System.Type controlType, System.Type requiredParentType) => 
            this.CreateErrorDesignTimeHtml(System.Design.SR.GetString("Control_CanOnlyBePlacedInside", new object[] { controlType.Name, requiredParentType.Name }));

        protected string CreatePlaceHolderDesignTimeHtml() => 
            this.CreatePlaceHolderDesignTimeHtml(null);
        ...
        protected virtual System.Web.UI.Control CreateViewControl() => 
            this.CreateClonedControl((IDesignerHost) this.GetService(typeof(IDesignerHost)), true);
        ...
        protected virtual string GetErrorDesignTimeHtml(Exception e) => 
            this.CreateErrorDesignTimeHtml(System.Design.SR.GetString("ControlDesigner_UnhandledException"), e);

        public virtual string GetPersistenceContent() => 
            this.GetPersistInnerHtml();
        ...
        public virtual string GetPersistInnerHtml() => 
            this.GetPersistInnerHtmlInternal();
        ...
        internal void HideAllPropertiesExceptID(IDictionary properties)
        {
            ...
            if (values != null)
            {
                ...
                {
                    PropertyDescriptor oldPropertyDescriptor = (PropertyDescriptor) array[i];
                    if ((oldPropertyDescriptor != null) && !string.Equals(oldPropertyDescriptor.Name, "ID", StringComparison.OrdinalIgnoreCase))
                    {
                        properties[oldPropertyDescriptor.Name] = TypeDescriptor.CreateProperty(oldPropertyDescriptor.ComponentType, oldPropertyDescriptor, new Attribute[] { BrowsableAttribute.No });
                    }
                }
            }
        }
        ...
        public bool IsPropertyBound(string propName) => 
            (base.DataBindings[propName] != null);
        ...
        public virtual void OnComponentChanged(object sender, ComponentChangedEventArgs ce)
        {
            if (!this.IsIgnoringComponentChanges)
            {
                ...
                if (base.DesignTimeElementInternal != null)
                {
                    ...
                    if (member != null)
                    {
                        System.Type type = System.Type.GetType("System.ComponentModel.ReflectPropertyDescriptor, System, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
                        ...
                        if (((PropertyDescriptor) member).SerializationVisibility != DesignerSerializationVisibility.Hidden)
                        {
                            ...
                            switch (attribute.Mode)
                            {
                                ...
                                case PersistenceMode.EncodedInnerDefaultProperty:
                                {
                                    ...
                                    if (service != null)
                                    {
                                        ArrayList attributes = ControlSerializer.GetControlPersistedAttribute(control, (PropertyDescriptor) member, service);
                    ...
                    else
                    {
                        ...
                        {
                            object obj2;
                            PropertyDescriptor descriptor2 = GetComplexProperty(base.Component, str2, out obj2);
                            if (descriptor2 != null)
                            {
                                this.IgnoreComponentChanges(true);
                                try
                                {
                                    descriptor2.ResetValue(obj2);
                                }
                                finally
                                {
        ...
        internal bool UseRegions(DesignerRegionCollection regions, ITemplate componentTemplate) => 
            (this.UseRegionsCore(regions) && (componentTemplate != null));
        ...
        private bool UseRegionsCore(DesignerRegionCollection regions) => 
            (((regions != null) && (this.View != null)) && this.View.SupportsRegions);
        ...
        {
            get => 
                ((System.Web.UI.Control) base.Component).ID;
            set
            {
                if (this.RootDesigner != null)
                {
        ...
        internal class ControlDesignerActionList : DesignerActionList
        {
            ...
            {
                ControlDesigner.InvokeTransactedChange(this._parent.Component, new TransactedChangeCallback(this.DataBindingsCallback), null, System.Design.SR.GetString("Designer_DataBindingsVerb"));
