namespace System.Web.UI.Design.WebControls
{
    ...
    public class PasswordRecoveryDesigner : ControlDesigner
    {
        ...
        private bool Templated =>
            (this.GetTemplate(this._passwordRecovery) != null);
        ...
        private class PasswordRecoveryDesignerActionList : DesignerActionList
        {
            ...
            private class PasswordRecoveryViewTypeConverter : TypeConverter
            {
                public override TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context) => 
                    new TypeConverter.StandardValuesCollection(new string[] { System.Design.SR.GetString("PasswordRecovery_UserNameView"), System.Design.SR.GetString("PasswordRecovery_QuestionView"), System.Design.SR.GetString("PasswordRecovery_SuccessView") });
