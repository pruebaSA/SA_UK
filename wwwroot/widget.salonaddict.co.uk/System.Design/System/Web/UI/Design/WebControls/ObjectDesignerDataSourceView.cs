namespace System.Web.UI.Design.WebControls
{
    ...
    public class ObjectDesignerDataSourceView : DesignerDataSourceView
    {
        ...
        public override bool CanDelete =>
            (this._owner.ObjectDataSource.DeleteMethod.Length > 0);

        public override bool CanInsert =>
            (this._owner.ObjectDataSource.InsertMethod.Length > 0);

        public override bool CanPage =>
            this._owner.ObjectDataSource.EnablePaging;

        public override bool CanRetrieveTotalRowCount =>
            (this._owner.ObjectDataSource.SelectCountMethod.Length > 0);
        ...
        public override bool CanUpdate =>
            (this._owner.ObjectDataSource.UpdateMethod.Length > 0);
