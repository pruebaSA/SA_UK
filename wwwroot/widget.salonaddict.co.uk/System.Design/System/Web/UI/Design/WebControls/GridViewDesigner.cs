namespace System.Web.UI.Design.WebControls
{
    ...
    public class GridViewDesigner : DataBoundControlDesigner
    {
        ...
        {
            get => 
                ((GridView) base.Component).AllowPaging;
            set
            {
                Cursor current = Cursor.Current;
                try
        ...
        {
            get => 
                ((GridView) base.Component).AllowSorting;
            set
            {
                Cursor current = Cursor.Current;
                try
