namespace System.Web.UI.Design.WebControls
{
    ...
    internal class SqlDataSourceConfigureFilterForm : DesignerForm
    {
        ...
        {
            _parameterEditors = new Dictionary<System.Type, ParameterEditor>();
            _parameterEditors.Add(typeof(Parameter), new StaticParameterEditor(base.ServiceProvider));
            _parameterEditors.Add(typeof(ControlParameter), new ControlParameterEditor(base.ServiceProvider, (SqlDataSource) this._sqlDataSourceDesigner.Component));
            _parameterEditors.Add(typeof(CookieParameter), new CookieParameterEditor(base.ServiceProvider));
            _parameterEditors.Add(typeof(FormParameter), new FormParameterEditor(base.ServiceProvider));
            _parameterEditors.Add(typeof(ProfileParameter), new ProfileParameterEditor(base.ServiceProvider));
            _parameterEditors.Add(typeof(QueryStringParameter), new QueryStringParameterEditor(base.ServiceProvider));
            _parameterEditors.Add(typeof(SessionParameter), new SessionParameterEditor(base.ServiceProvider));
        }
        ...
        public IList<SqlDataSourceFilterClause> FilterClauses =>
            this._tableQuery.FilterClauses;

        protected override string HelpTopic =>
            "net.Asp.SqlDataSource.ConfigureFilter";
        ...
        private sealed class CookieParameterEditor : SqlDataSourceConfigureFilterForm.ParameterEditor
        {
            ...
            public override bool HasCompleteInformation =>
                (this._parameter.CookieName.Length > 0);
        ...
        private sealed class FormParameterEditor : SqlDataSourceConfigureFilterForm.ParameterEditor
        {
            ...
            public override bool HasCompleteInformation =>
                (this._parameter.FormField.Length > 0);
        ...
        private sealed class ProfileParameterEditor : SqlDataSourceConfigureFilterForm.ParameterEditor
        {
            ...
            public override bool HasCompleteInformation =>
                (this._parameter.PropertyName.Length > 0);
        ...
        private sealed class QueryStringParameterEditor : SqlDataSourceConfigureFilterForm.ParameterEditor
        {
            ...
            public override bool HasCompleteInformation =>
                (this._parameter.QueryStringField.Length > 0);
        ...
        private sealed class SessionParameterEditor : SqlDataSourceConfigureFilterForm.ParameterEditor
        {
            ...
            public override bool HasCompleteInformation =>
                (this._parameter.SessionField.Length > 0);
