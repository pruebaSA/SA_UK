namespace System.Web.UI.Design.WebControls
{
    ...
    [ToolboxItem(false), Obsolete("Use of this type is not recommended because the AutoFormat dialog is launched by the designer host. The list of available AutoFormats is exposed on the ControlDesigner in the AutoFormats property. http://go.microsoft.com/fwlink/?linkid=14202"), SecurityPermission(SecurityAction.Demand, Flags=SecurityPermissionFlag.UnmanagedCode)]
    public class CalendarAutoFormatDialog : Form
    {
        ...
        private class WCSchemeClassic : CalendarAutoFormatDialog.WCScheme
        {
            ...
            public override string GetDescription() => 
                System.Design.SR.GetString("CalAFmt_Scheme_Classic");
        }
        ...
        private class WCSchemeColorful1 : CalendarAutoFormatDialog.WCScheme
        {
            ...
            public override string GetDescription() => 
                System.Design.SR.GetString("CalAFmt_Scheme_Colorful1");
        }
        ...
        private class WCSchemeColorful2 : CalendarAutoFormatDialog.WCScheme
        {
            ...
            public override string GetDescription() => 
                System.Design.SR.GetString("CalAFmt_Scheme_Colorful2");
        }
        ...
        private class WCSchemeNone : CalendarAutoFormatDialog.WCScheme
        {
            ...
            public override string GetDescription() => 
                System.Design.SR.GetString("CalAFmt_Scheme_Default");
        }
        ...
        private class WCSchemeProfessional1 : CalendarAutoFormatDialog.WCScheme
        {
            ...
            public override string GetDescription() => 
                System.Design.SR.GetString("CalAFmt_Scheme_Professional1");
        }
        ...
        private class WCSchemeProfessional2 : CalendarAutoFormatDialog.WCScheme
        {
            ...
            public override string GetDescription() => 
                System.Design.SR.GetString("CalAFmt_Scheme_Professional2");
        }
        ...
        private class WCSchemeStandard : CalendarAutoFormatDialog.WCScheme
        {
            ...
            public override string GetDescription() => 
                System.Design.SR.GetString("CalAFmt_Scheme_Simple");
        }
    }
}
