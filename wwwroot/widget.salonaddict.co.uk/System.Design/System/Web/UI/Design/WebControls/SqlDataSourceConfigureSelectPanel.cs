    ...
    internal class SqlDataSourceConfigureSelectPanel : WizardPanel
    {
        ...
        private Hashtable SaveTableQueryState()
        {
            Hashtable hashtable = new Hashtable {
                { 
                    "Conn_ConnectionStringHash",
                    this._tableQuery.DesignerDataConnection.ConnectionString.GetHashCode()
                },
                { 
                    "Conn_ProviderName",
                    this._tableQuery.DesignerDataConnection.ProviderName
                },
                { 
                    "Generate_Mode",
                    this._generateMode
                ...
                { 
                    "Table_Name",
                    this._tableQuery.DesignerDataTable.Name
                },
                { 
                    "Fields_Count",
                    this._tableQuery.Fields.Count
                }
            };
            ...
            for (int j = 0; j < this._tableQuery.FilterClauses.Count; j++)
            {
                ...
                hashtable.Add("Filters_ParameterName" + str, clause.Parameter?.Name);
            }
        ...
        private void UpdateFieldsCheckedListBoxColumnWidth()
        {
            ...
            {
                foreach (ColumnItem item in this._fieldsCheckedListBox.Items)
                {
        ...
        private sealed class TableItem
        {
            ...
            public override string ToString() => 
                this._designerDataTable.Name;

            public DesignerDataTableBase DesignerDataTable =>
                this._designerDataTable;
        }
    }
}
