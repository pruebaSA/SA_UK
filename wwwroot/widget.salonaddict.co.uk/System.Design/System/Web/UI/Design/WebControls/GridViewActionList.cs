namespace System.Web.UI.Design.WebControls
{
    ...
    internal class GridViewActionList : DesignerActionList
    {
        ...
        {
            get => 
                this._gridViewDesigner.EnableDeleting;
            set
            {
        ...
        {
            get => 
                this._gridViewDesigner.EnableEditing;
            set
            {
        ...
        {
            get => 
                this._gridViewDesigner.EnablePaging;
            set
            {
        ...
        {
            get => 
                this._gridViewDesigner.EnableSelection;
            set
            {
        ...
        {
            get => 
                this._gridViewDesigner.EnableSorting;
            set
            {
