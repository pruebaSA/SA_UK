namespace System.Web.UI.Design.WebControls
{
    ...
    public class LoginViewDesigner : ControlDesigner
    {
        ...
        private EditableDesignerRegion BuildRegion() => 
            new LoginViewDesignerRegion(this, this.CurrentObject, this.CurrentTemplate, this.CurrentTemplateDescriptor, this.TemplateDefinition) { Description = System.Design.SR.GetString("ContainerControlDesigner_RegionWatermark") };
        ...
        protected override string GetErrorDesignTimeHtml(Exception e) => 
            base.CreatePlaceHolderDesignTimeHtml(System.Design.SR.GetString("LoginView_ErrorRendering") + "<br />" + e.Message);
