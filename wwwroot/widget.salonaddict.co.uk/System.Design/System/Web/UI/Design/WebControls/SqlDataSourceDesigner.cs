namespace System.Web.UI.Design.WebControls
{
    ...
    public class SqlDataSourceDesigner : DataSourceDesigner
    {
        ...
        internal static TypeCode ConvertDbTypeToTypeCode(DbType dbType) => 
            Parameter.ConvertDbTypeToTypeCode(dbType);

        internal static DbType ConvertTypeCodeToDbType(TypeCode typeCode) => 
            Parameter.ConvertTypeCodeToDbType(typeCode);
        ...
        internal virtual SqlDataSourceWizardForm CreateConfigureDataSourceWizardForm(IServiceProvider serviceProvider, IDataEnvironment dataEnvironment) => 
            new SqlDataSourceWizardForm(serviceProvider, this, dataEnvironment);
        ...
        protected virtual SqlDesignerDataSourceView CreateView(string viewName) => 
            new SqlDesignerDataSourceView(this, viewName);
        ...
        protected virtual string GetConnectionString() => 
            this.SqlDataSource.ConnectionString;
        ...
        internal static bool SupportsNamedParameters(DbProviderFactory factory)
        {
            ...
            if ((factory != SqlClientFactory.Instance) && (factory != OracleClientFactory.Instance))
            {
                return false;
            }
            return true;
        ...
        [System.Design.SRDescription("SqlDataSourceDesigner_DeleteQuery"), TypeConverter(typeof(SqlDataSourceQueryConverter)), Category("Data"), DefaultValue(0), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Editor(typeof(SqlDataSourceQueryEditor), typeof(UITypeEditor)), MergableProperty(false)]
        ...
        [TypeConverter(typeof(SqlDataSourceQueryConverter)), Category("Data"), DefaultValue(1), System.Design.SRDescription("SqlDataSourceDesigner_InsertQuery"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Editor(typeof(SqlDataSourceQueryEditor), typeof(UITypeEditor)), MergableProperty(false)]
        ...
        {
            get => 
                this.SqlDataSource.ProviderName;
            set
            {
        ...
        internal System.Web.UI.WebControls.SqlDataSource SqlDataSource =>
            ((System.Web.UI.WebControls.SqlDataSource) base.Component);

        internal Hashtable TableQueryState
        {
            get => 
                (base.DesignerState["TableQueryState"] as Hashtable);
            set
            {
        ...
        [Category("Data"), Editor(typeof(SqlDataSourceQueryEditor), typeof(UITypeEditor)), DefaultValue(3), System.Design.SRDescription("SqlDataSourceDesigner_UpdateQuery"), TypeConverter(typeof(SqlDataSourceQueryConverter)), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MergableProperty(false)]
