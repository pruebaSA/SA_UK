namespace System.Web.UI.Design.WebControls
{
    ...
    internal sealed class SqlDataSourceTableQuery
    {
        ...
        public string GetTableName() => 
            SqlDataSourceColumnData.EscapeObjectName(this.DesignerDataConnection, this.DesignerDataTable.Name);
            ...
            if (includeOldValues)
            {
                foreach (SqlDataSourceColumnData data2 in effectiveColumns)
                {
                    if (!data2.Column.PrimaryKey)
                    {
                        ...
                        parameters.Add(SqlDataSourceDesigner.CreateParameter(dbProviderFactory, data2.GetOldValueWebParameterName(oldValuesFormatString), data2.Column.DataType));
                    }
                }
            }
