namespace System.Web.UI.Design.WebControls
{
    ...
    public class LoginDesigner : CompositeControlDesigner
    {
        ...
        private bool Templated =>
            (this._login.LayoutTemplate != null);

        private System.Web.UI.Design.TemplateDefinition TemplateDefinition =>
            new System.Web.UI.Design.TemplateDefinition(this, "LayoutTemplate", this._login, "LayoutTemplate", ((WebControl) base.ViewControl).ControlStyle);

        private PropertyDescriptor TemplateDescriptor =>
            TypeDescriptor.GetProperties(base.Component).Find("LayoutTemplate", false);
