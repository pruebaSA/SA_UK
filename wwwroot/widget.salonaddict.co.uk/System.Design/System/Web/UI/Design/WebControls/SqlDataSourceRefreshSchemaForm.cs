namespace System.Web.UI.Design.WebControls
{
    ...
    internal class SqlDataSourceRefreshSchemaForm : DesignerForm
    {
        ...
        protected override string HelpTopic =>
            "net.Asp.SqlDataSource.RefreshSchema";

        private sealed class DbTypeComparer : IComparer
        {
            int IComparer.Compare(object x, object y) => 
                string.Compare(Enum.GetName(typeof(DbType), x), Enum.GetName(typeof(DbType), y), StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            int IComparer.Compare(object x, object y) => 
                string.Compare(Enum.GetName(typeof(TypeCode), x), Enum.GetName(typeof(TypeCode), y), StringComparison.OrdinalIgnoreCase);
        }
    }
}
