namespace System.Web.UI.Design.WebControls
{
    ...
    public class ObjectDataSourceDesigner : DataSourceDesigner
    {
        ...
        public override bool CanConfigure =>
            this.TypeServiceAvailable;

        public override bool CanRefreshSchema =>
            ((!string.IsNullOrEmpty(this.TypeName) && !string.IsNullOrEmpty(this.SelectMethod)) && this.TypeServiceAvailable);

        internal System.Web.UI.WebControls.ObjectDataSource ObjectDataSource =>
            ((System.Web.UI.WebControls.ObjectDataSource) base.Component);

        public string SelectMethod
        {
            get => 
                this.ObjectDataSource.SelectMethod;
            set
            {
        ...
        {
            get => 
                base.DesignerState["ShowOnlyDataComponentsState"];
            set
            {
        ...
        {
            get => 
                this.ObjectDataSource.TypeName;
            set
            {
