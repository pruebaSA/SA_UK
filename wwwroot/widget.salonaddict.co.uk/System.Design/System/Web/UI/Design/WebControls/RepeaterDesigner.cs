namespace System.Web.UI.Design.WebControls
{
    ...
    public class RepeaterDesigner : ControlDesigner, IDataSourceProvider
    {
        ...
        protected override string GetEmptyDesignTimeHtml() => 
            base.CreatePlaceHolderDesignTimeHtml(System.Design.SR.GetString("Repeater_NoTemplatesInst"));

        protected override string GetErrorDesignTimeHtml(Exception e) => 
            base.CreatePlaceHolderDesignTimeHtml(System.Design.SR.GetString("Control_ErrorRendering"));
        ...
        {
            get => 
                ((Repeater) base.Component).DataMember;
            set
            {
        ...
        public IDataSourceDesigner DataSourceDesigner =>
            this._dataSourceDesigner;

        public string DataSourceID
        {
            get => 
                ((Repeater) base.Component).DataSourceID;
            set
            {
