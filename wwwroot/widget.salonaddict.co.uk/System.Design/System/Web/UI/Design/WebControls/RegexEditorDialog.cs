            ...
            get
            {
                if (cannedExpressions == null)
                {
                    ArrayList list = new ArrayList {
                        System.Design.SR.GetString("RegexCanned_Custom"),
                        new CannedExpression(System.Design.SR.GetString("RegexCanned_Email"), @"\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"),
                        new CannedExpression(System.Design.SR.GetString("RegexCanned_URL"), @"http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?")
                    };
