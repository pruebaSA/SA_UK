        ...
        private class LoginStatusDesignerActionList : DesignerActionList
        {
            ...
            private class LoginStatusViewTypeConverter : TypeConverter
            {
                public override TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context) => 
                    new TypeConverter.StandardValuesCollection(new string[] { System.Design.SR.GetString("LoginStatus_LoggedOutView"), System.Design.SR.GetString("LoginStatus_LoggedInView") });
