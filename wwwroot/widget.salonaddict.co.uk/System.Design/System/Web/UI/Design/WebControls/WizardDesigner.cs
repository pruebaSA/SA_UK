    ...
    public class WizardDesigner : CompositeControlDesigner
    {
        ...
        public override string GetDesignTimeHtml()
        {
            ...
            if (this.ActiveStepIndex != -1)
            {
                Wizard viewControl = (Wizard) base.ViewControl;
                IControlDesignerAccessor accessor = viewControl;
                DataList list = accessor.GetDesignModeState()["SideBarList"] as DataList;
                if (list != null)
                {
                    list.ItemDataBound += new DataListItemEventHandler(this.DataListItemDataBound);
                    ICompositeControlDesignerAccessor accessor2 = viewControl;
                    accessor2.RecreateChildControls();
                }
                ArrayList list2 = new ArrayList(viewControl.WizardSteps.Count);
                foreach (WizardStepBase base2 in viewControl.WizardSteps)
                {
                    list2.Add(base2.Title);
        ...
        public override string GetDesignTimeHtml(DesignerRegionCollection regions)
        {
            ...
            DataList list = dictionary["SideBarList"] as DataList;
            if (list != null)
            {
                list.ItemDataBound += new DataListItemEventHandler(this.DataListItemDataBound);
            }
        ...
        {
            DataList list = (DataList) dictionary["SideBarList"];
            if (list != null)
            {
        ...
        {
            get => 
                ((Wizard) base.Component).DisplaySideBar;
            set
            {
        ...
        private class WizardDesignerActionList : DesignerActionList
        {
            ...
            {
                get => 
                    this._designer.ActiveStepIndex;
                set
                {
