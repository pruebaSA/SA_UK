namespace System.Web.UI.Design.WebControls.WebParts
{
    ...
    public class CatalogZoneDesigner : ToolZoneDesigner
    {
                ...
                else
                {
                    ...
                    if (flag)
                    {
                        ...
                        CatalogPartEditableDesignerRegion region = new CatalogPartEditableDesignerRegion(viewControl, base.TemplateDefinition) {
                            Properties = { [typeof(Control)] = viewControl },
        ...
        public override string GetEditableDesignerRegionContent(EditableDesignerRegion region) => 
            ControlPersister.PersistTemplate(this._zone.ZoneTemplate, (IDesignerHost) base.Component.Site.GetService(typeof(IDesignerHost)));

        protected override string GetEmptyDesignTimeHtml() => 
            base.CreatePlaceHolderDesignTimeHtml(System.Design.SR.GetString("CatalogZoneDesigner_Empty"));
