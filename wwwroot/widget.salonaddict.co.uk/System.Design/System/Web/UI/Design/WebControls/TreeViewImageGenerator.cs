namespace System.Web.UI.Design.WebControls
{
    ...
    internal class TreeViewImageGenerator : DesignerForm
    {
        ...
        protected override string HelpTopic =>
            "net.Asp.TreeView.ImageGenerator";
        ...
        private class ColorIndexTable
        {
            ...
            internal static int GetColorKey(Color c) => 
                ((((c.R & 0xff) << 0x10) | ((c.G & 0xff) << 8)) | (c.B & 0xff));
        ...
        private class LineImageInfo
        {
            ...
            [System.Design.SRDescription("TreeViewImageGenerator_ExpandImage"), DefaultValue((string) null)]
