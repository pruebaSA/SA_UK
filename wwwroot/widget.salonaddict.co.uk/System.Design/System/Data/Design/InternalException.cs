namespace System.Data.Design
{
    ...
    internal class InternalException : Exception, ISerializable
    {
        ...
        internal InternalException(Exception innerException, string internalMessage, int errorCode, bool showErrorMesageOnReport, bool needAssert) : base(SR.GetString("ERR_INTERNAL"), innerException)
        {
            this.internalMessage = string.Empty;
            this.errorCode = -1;
