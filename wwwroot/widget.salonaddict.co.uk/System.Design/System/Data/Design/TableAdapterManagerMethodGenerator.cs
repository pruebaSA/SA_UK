namespace System.Data.Design
{
    ...
    internal sealed class TableAdapterManagerMethodGenerator
    {
        ...
        private void AddAdapterMembers(CodeTypeDeclaration dataComponentClass)
        {
            foreach (DesignTable table in this.dataSource.DesignTables)
            {
                if (this.CanAddTableAdapter(table))
                {
                    ...
                    property.CustomAttributes.Add(CodeGenHelper.AttributeDecl("System.ComponentModel.EditorAttribute", CodeGenHelper.Str("Microsoft.VSDesigner.DataSource.Design.TableAdapterManagerPropertyEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), CodeGenHelper.Str("System.Drawing.Design.UITypeEditor")));
        ...
        private void AddSelfRefComparer(CodeTypeDeclaration dataComponentClass)
        {
            ...
            string str3 = "child";
            string str4 = "parent";
            string str5 = "newParent";
            string str6 = "IsChildAndParent";
            CodeMemberMethod method = CodeGenHelper.MethodDecl(CodeGenHelper.GlobalType(typeof(bool)), str6, MemberAttributes.Private);
            method.Parameters.Add(CodeGenHelper.ParameterDecl(CodeGenHelper.GlobalType(typeof(DataRow)), str3));
            method.Parameters.Add(CodeGenHelper.ParameterDecl(CodeGenHelper.GlobalType(typeof(DataRow)), str4));
            ...
            method.Statements.Add(CodeGenHelper.MethodCallStm(CodeGenHelper.GlobalTypeExpr(typeof(Debug)), "Assert", CodeGenHelper.IdIsNotNull(CodeGenHelper.Argument(str4))));
            method.Statements.Add(CodeGenHelper.VariableDecl(CodeGenHelper.GlobalType(typeof(DataRow)), str5, CodeGenHelper.MethodCall(CodeGenHelper.Argument(str3), "GetParentRow", new CodeExpression[] { CodeGenHelper.ThisField(name), CodeGenHelper.Field(CodeGenHelper.GlobalTypeExpr(typeof(DataRowVersion)), "Default") })));
            CodeIterationStatement statement = new CodeIterationStatement {
                TestExpression = CodeGenHelper.And(CodeGenHelper.IdIsNotNull(CodeGenHelper.Variable(str5)), CodeGenHelper.And(CodeGenHelper.ReferenceNotEquals(CodeGenHelper.Variable(str5), CodeGenHelper.Argument(str3)), CodeGenHelper.ReferenceNotEquals(CodeGenHelper.Variable(str5), CodeGenHelper.Argument(str4)))),
                InitStatement = new CodeSnippetStatement(),
                IncrementStatement = new CodeSnippetStatement()
            };
            statement.Statements.Add(CodeGenHelper.Assign(CodeGenHelper.Variable(str5), CodeGenHelper.MethodCall(CodeGenHelper.Variable(str5), "GetParentRow", new CodeExpression[] { CodeGenHelper.ThisField(name), CodeGenHelper.Field(CodeGenHelper.GlobalTypeExpr(typeof(DataRowVersion)), "Default") })));
            method.Statements.Add(statement);
            statement = new CodeIterationStatement {
                TestExpression = CodeGenHelper.And(CodeGenHelper.IdIsNotNull(CodeGenHelper.Variable(str5)), CodeGenHelper.And(CodeGenHelper.ReferenceNotEquals(CodeGenHelper.Variable(str5), CodeGenHelper.Argument(str3)), CodeGenHelper.ReferenceNotEquals(CodeGenHelper.Variable(str5), CodeGenHelper.Argument(str4)))),
                InitStatement = CodeGenHelper.Assign(CodeGenHelper.Variable(str5), CodeGenHelper.MethodCall(CodeGenHelper.Argument(str3), "GetParentRow", new CodeExpression[] { 
                    CodeGenHelper.ThisField(name),
                    CodeGenHelper.Field(CodeGenHelper.GlobalTypeExpr(typeof(DataRowVersion)), "Original")
                })),
                IncrementStatement = new CodeSnippetStatement()
            };
            statement.Statements.Add(CodeGenHelper.Assign(CodeGenHelper.Variable(str5), CodeGenHelper.MethodCall(CodeGenHelper.Argument(str5), "GetParentRow", new CodeExpression[] { CodeGenHelper.ThisField(name), CodeGenHelper.Field(CodeGenHelper.GlobalTypeExpr(typeof(DataRowVersion)), "Original") })));
            method.Statements.Add(CodeGenHelper.If(CodeGenHelper.IdIsNull(CodeGenHelper.Variable(str5)), statement));
            method.Statements.Add(CodeGenHelper.If(CodeGenHelper.ReferenceEquals(CodeGenHelper.Variable(str5), CodeGenHelper.Argument(str4)), CodeGenHelper.Return(CodeGenHelper.Primitive(true))));
            method.Statements.Add(CodeGenHelper.Return(CodeGenHelper.Primitive(false)));
            ...
            method2.Parameters.Add(CodeGenHelper.ParameterDecl(CodeGenHelper.GlobalType(typeof(DataRow)), str7));
            method2.Parameters.Add(CodeGenHelper.ParameterDecl(CodeGenHelper.GlobalType(typeof(DataRow)), str8));
            method2.ImplementationTypes.Add(reference);
            declaration.Members.Add(method2);
            method2.Statements.Add(CodeGenHelper.If(CodeGenHelper.ReferenceEquals(CodeGenHelper.Argument(str7), CodeGenHelper.Argument(str8)), CodeGenHelper.Return(CodeGenHelper.Primitive(0))));
            method2.Statements.Add(CodeGenHelper.If(CodeGenHelper.IdIsNull(CodeGenHelper.Argument(str7)), CodeGenHelper.Return(CodeGenHelper.Primitive(-1))));
            method2.Statements.Add(CodeGenHelper.If(CodeGenHelper.IdIsNull(CodeGenHelper.Argument(str8)), CodeGenHelper.Return(CodeGenHelper.Primitive(1))));
            method2.Statements.Add(new CodeSnippetStatement());
            method2.Statements.Add(new CodeCommentStatement("Is row1 the child or grandchild of row2"));
            method2.Statements.Add(CodeGenHelper.If(CodeGenHelper.MethodCall(CodeGenHelper.This(), str6, new CodeExpression[] { CodeGenHelper.Argument(str7), CodeGenHelper.Argument(str8) }), CodeGenHelper.Return(CodeGenHelper.ThisField(str2))));
            method2.Statements.Add(new CodeSnippetStatement());
            method2.Statements.Add(new CodeCommentStatement("Is row2 the child or grandchild of row1"));
            method2.Statements.Add(CodeGenHelper.If(CodeGenHelper.MethodCall(CodeGenHelper.This(), str6, new CodeExpression[] { CodeGenHelper.Argument(str8), CodeGenHelper.Argument(str7) }), CodeGenHelper.Return(CodeGenHelper.BinOperator(CodeGenHelper.Primitive(-1), CodeBinaryOperatorType.Multiply, CodeGenHelper.ThisField(str2)))));
            method2.Statements.Add(CodeGenHelper.Return(CodeGenHelper.Primitive(0)));
        }
        ...
        private CodeStatement AddUpdateAllTAUpdate(DesignTable table, string dataSetStr, string resultStr, string updateRowsStr, string allUpdateRowsStr, string rowState, string allAddedRowsStr)
        {
            ...
            List<CodeStatement> list2 = new List<CodeStatement>(3) {
                CodeGenHelper.VariableDecl(CodeGenHelper.GlobalType(typeof(DataRow), 1), updateRowsStr, CodeGenHelper.MethodCall(CodeGenHelper.Property(CodeGenHelper.Argument(dataSetStr), table.GeneratorTablePropName), "Select", new CodeExpression[] { 
        ...
        private CodeStatement GetForLoopItoCount(CodeExpression countExp, CodeStatement[] forStms) => 
            this.GetForLoopItoCount("i", countExp, forStms);
