namespace System.Data.Design
{
    ...
    internal class DesignDataSource : DataSourceComponent, IDataSourceNamedObject, INamedObject, IDataSourceCommandTarget
    {
        ...
        bool IDataSourceCommandTarget.CanAddChildOfType(Type childType) => 
            (((typeof(DesignTable).IsAssignableFrom(childType) || typeof(IDesignConnection).IsAssignableFrom(childType)) || typeof(Source).IsAssignableFrom(childType)) || (typeof(DesignRelation).IsAssignableFrom(childType) && (this.DesignTables.Count > 0)));
        ...
        [Browsable(false), DisplayName("Connections"), DataSourceXmlSubItem(Name="Connections", ItemType=typeof(DesignConnection))]
        ...
        {
            get => 
                (this.DataSet.ExtendedProperties[EXTPROPNAME_GENERATOR_DATASETNAME] as string);
            set
            {
        ...
        {
            get => 
                this.generatorFunctionsComponentClassName;
            set
            {
        ...
        {
            get => 
                (this.DataSet.ExtendedProperties[EXTPROPNAME_USER_DATASETNAME] as string);
            set
            {
        ...
        {
            get => 
                this.userFunctionsComponentName;
            set
            {
