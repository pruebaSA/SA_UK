namespace System.Data.Design
{
    ...
    internal abstract class QueryGeneratorBase
    {
        ...
        internal static CodeStatement SetCommandTextStatement(CodeExpression commandExpression, string commandText) => 
            CodeGenHelper.Assign(CodeGenHelper.Property(commandExpression, "CommandText"), CodeGenHelper.Str(commandText));

        internal static CodeStatement SetCommandTypeStatement(CodeExpression commandExpression, CommandType commandType) => 
            CodeGenHelper.Assign(CodeGenHelper.Property(commandExpression, "CommandType"), CodeGenHelper.Field(CodeGenHelper.GlobalTypeExpr(typeof(CommandType)), commandType.ToString()));
        ...
        {
            get => 
                this.updateParameterTypeReference;
            set
            {
