    ...
    internal sealed class ProviderManager
    {
        ...
        private class CachedProviderData
        {
            ...
            public bool Matches(DbProviderFactory factory) => 
                ((this.CachedFactory != null) && this.CachedFactory.GetType().Equals(factory.GetType()));

            public bool Matches(string invariantName) => 
                (((this.CachedFactory != null) && (this.CachedInvariantProviderName != null)) && StringUtil.EqualValue(this.CachedInvariantProviderName, invariantName));

            public bool Matches(Type type) => 
                (((this.CachedFactory != null) && (this.CachedType != null)) && this.CachedType.Equals(type));

            public PropertyInfo ProviderTypeProperty
            {
                get => 
                    this.providerTypeProperty;
                set
                {
