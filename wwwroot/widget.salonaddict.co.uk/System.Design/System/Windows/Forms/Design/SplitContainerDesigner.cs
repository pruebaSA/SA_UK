namespace System.Windows.Forms.Design
{
    ...
    internal class SplitContainerDesigner : ParentControlDesigner
    {
        ...
        protected override bool GetHitTest(Point point) => 
            ((this.InheritanceAttribute != InheritanceAttribute.InheritedReadOnly) && this.splitContainerSelected);
        ...
        private void OnSplitterMoved(object sender, SplitterEventArgs e)
        {
            if ((this.InheritanceAttribute != InheritanceAttribute.InheritedReadOnly) && !this.splitterDistanceException)
            {
                try
                {
                    ...
                    {
                        using (BehaviorServiceAdornerCollectionEnumerator enumerator = base.BehaviorService.Adorners.GetEnumerator())
                        {
