namespace System.Windows.Forms.Design
{
    ...
    internal class ToolStripDesigner : ControlDesigner
    {
        ...
        private bool CheckIfItemSelected()
        {
            ...
            if (item != null)
            {
                ...
                if (item.IsOnDropDown && (item.Placement != ToolStripItemPlacement.Overflow))
                {
                    ...
                    if (component != null)
                    {
                        ToolStripDropDown down3 = ((ToolStripMenuItemDesigner) this.host.GetDesigner(component))?.GetFirstDropDown((ToolStripDropDownItem) component);
        ...
        internal static bool IsGlyphTotallyVisible(Rectangle itemBounds, Rectangle parentBounds) => 
            parentBounds.Contains(itemBounds);
        ...
        private bool ShouldSerializeAllowItemReorder() => 
            ((bool) base.ShadowProperties["AllowItemReorder"]);
        ...
        internal override bool ControlSupportsSnaplines =>
            !(this.ToolStrip.Parent is ToolStripPanel);
        ...
        {
            get => 
                this.indexOfItemUnderMouseToDrag;
            set
            {
        ...
        {
            get => 
                this._insertMenuItemTransaction;
            set
            {
        ...
        protected System.Windows.Forms.ToolStrip ToolStrip =>
            ((System.Windows.Forms.ToolStrip) base.Component);
