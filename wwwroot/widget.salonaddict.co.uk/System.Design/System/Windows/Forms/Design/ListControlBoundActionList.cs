namespace System.Windows.Forms.Design
{
    ...
    internal class ListControlBoundActionList : DesignerActionList
    {
        ...
        [TypeConverter("System.Windows.Forms.Design.DesignBindingConverter"), Editor("System.Windows.Forms.Design.DesignBindingEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        {
            get => 
                ((ListControl) base.Component).DataSource;
            set
            {
                ListControl component = (ListControl) base.Component;
                IDesignerHost host = base.GetService(typeof(IDesignerHost)) as IDesignerHost;
        ...
        {
            get => 
                ((ListControl) base.Component).DisplayMember;
            set
            {
                ListControl component = (ListControl) base.Component;
                IDesignerHost host = base.GetService(typeof(IDesignerHost)) as IDesignerHost;
        ...
        {
            get => 
                ((ListControl) base.Component).ValueMember;
            set
            {
