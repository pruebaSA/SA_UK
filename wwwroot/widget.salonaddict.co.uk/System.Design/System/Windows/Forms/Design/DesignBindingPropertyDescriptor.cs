namespace System.Windows.Forms.Design
{
    ...
    internal class DesignBindingPropertyDescriptor : PropertyDescriptor
    {
        ...
        public override bool CanResetValue(object component) => 
            !GetBinding((ControlBindingsCollection) component, this.property).IsNull;
        ...
        public override object GetValue(object component) => 
            GetBinding((ControlBindingsCollection) component, this.property);
        ...
        public override TypeConverter Converter =>
            designBindingConverter;

        public override bool IsReadOnly =>
            this.readOnly;

        public override System.Type PropertyType =>
            typeof(DesignBinding);
    }
}
