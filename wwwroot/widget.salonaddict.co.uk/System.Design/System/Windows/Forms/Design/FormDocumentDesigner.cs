namespace System.Windows.Forms.Design
{
    ...
    internal class FormDocumentDesigner : DocumentDesigner
    {
        ...
        {
            get => 
                (base.ShadowProperties["AcceptButton"] as IButtonControl);
            set
            {
        ...
        {
            get => 
                (base.ShadowProperties["CancelButton"] as IButtonControl);
            set
            {
        ...
        {
            get => 
                ((Form) this.Control).IsMdiContainer;
            set
            {
                if (!value)
                {
        ...
        {
            get => 
                ((MainMenu) base.ShadowProperties["Menu"]);
            set
            {
        ...
        {
            get => 
                ((double) base.ShadowProperties["Opacity"]);
            set
            {
        ...
        {
            get => 
                ((bool) base.ShadowProperties["ShowInTaskbar"]);
            set
            {
        ...
        {
            get => 
                ((FormWindowState) base.ShadowProperties["WindowState"]);
            set
            {
