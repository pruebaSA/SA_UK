namespace System.Windows.Forms.Design
{
    ...
    internal class ToolStripPanelDesigner : ScrollableControlDesigner
    {
        ...
        public override bool CanBeParentedTo(IDesigner parentDesigner) => 
            ((this.panel != null) && !(this.panel.Parent is ToolStripContainer));
        ...
        private Pen BorderPen =>
            new Pen((this.Control.BackColor.GetBrightness() < 0.5) ? ControlPaint.Light(this.Control.BackColor) : ControlPaint.Dark(this.Control.BackColor)) { DashStyle=DashStyle.Dash };
        ...
        {
            get => 
                ((System.Windows.Forms.Padding) base.ShadowProperties["Padding"]);
            set
            {
