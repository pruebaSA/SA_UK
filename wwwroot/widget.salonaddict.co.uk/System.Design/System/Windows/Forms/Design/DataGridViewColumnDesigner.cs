        ...
        private string Name
        {
            ...
            set
            {
                ...
                if ((component != null) && (string.Compare(value, component.Name, false, CultureInfo.InvariantCulture) != 0))
                {
                    ...
                    if ((dataGridView != null) && !DataGridViewAddColumnDialog.ValidName(value, dataGridView.Columns, container, nameCreationService, this.liveDataGridView?.Columns, true, out errorString))
                    {
                        if ((dataGridView != null) && (dataGridView.Site != null))
                        {
