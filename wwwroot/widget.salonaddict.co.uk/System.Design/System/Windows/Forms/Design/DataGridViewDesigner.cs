    ...
    internal class DataGridViewDesigner : ControlDesigner
    {
        ...
        private void DataGridViewDesigner_ComponentRemoving(object sender, ComponentEventArgs e)
        {
            ...
            if ((e.Component != null) && (e.Component == component.DataSource))
            {
                ...
                PropertyDescriptor member = properties?["DataMember"];
        ...
        {
            IContainer container = dataGridView.Site?.Container;
            for (int i = 0; i < dataGridView.Columns.Count; i++)
            {
                DataGridViewColumn component = dataGridView.Columns[i];
                IContainer container2 = component.Site?.Container;
        ...
        private bool ProcessSimilarSchema(DataGridView dataGridView)
        {
            ...
            for (int i = 0; i < dataGridView.Columns.Count; i++)
            {
                ...
                if (!string.IsNullOrEmpty(component.DataPropertyName))
                {
                    ...
                    {
                        PropertyDescriptor descriptor2 = itemProperties?[component.DataPropertyName];
                        bool flag2 = false;
                        if (descriptor2 == null)
                        {
                            flag2 = true;
            ...
            if (flag)
            {
                ...
                while (num2 < dataGridView.Columns.Count)
                {
                    ...
                    else
                    {
                        ...
                        PropertyDescriptor descriptor5 = itemProperties?[column2.DataPropertyName];
                        bool flag3 = false;
                        if (descriptor5 == null)
                        {
                            flag3 = true;
        ...
        private bool ShouldSerializeDataSource() => 
            (((DataGridView) base.Component).DataSource != null);
        ...
        {
            get => 
                ((DataGridView) base.Component).DataSource;
            set
            {
                DataGridView component = base.Component as DataGridView;
        ...
        private class DataGridViewPropertiesActionList : DesignerActionList
        {
            ...
            {
                get => 
                    ((DataGridView) this.owner.Component).AllowUserToAddRows;
                set
                {
            ...
            {
                get => 
                    ((DataGridView) this.owner.Component).AllowUserToDeleteRows;
                set
                {
            ...
            {
                get => 
                    ((DataGridView) this.owner.Component).AllowUserToOrderColumns;
                set
                {
            ...
            {
                get => 
                    !((DataGridView) this.owner.Component).ReadOnly;
                set
                {
