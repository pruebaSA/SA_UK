namespace System.Windows.Forms.Design
{
    ...
    internal class FlowLayoutPanelDesigner : FlowPanelDesigner
    {
        ...
        private Rectangle GetMarginBounds(System.Windows.Forms.Control control) => 
            new Rectangle(control.Bounds.Left - ((this.Control.RightToLeft == RightToLeft.No) ? control.Margin.Left : control.Margin.Right), control.Bounds.Top - control.Margin.Top, control.Bounds.Width + control.Margin.Horizontal, control.Bounds.Height + control.Margin.Vertical);
        ...
        private FlowLayoutPanel Control =>
            (base.Control as FlowLayoutPanel);

        private System.Windows.Forms.FlowDirection FlowDirection
        {
            get => 
                this.Control.FlowDirection;
            set
            {
