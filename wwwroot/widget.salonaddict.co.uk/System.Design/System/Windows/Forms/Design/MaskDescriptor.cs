namespace System.Windows.Forms.Design
{
    ...
    public abstract class MaskDescriptor
    {
        ...
        public override string ToString() => 
            string.Format(CultureInfo.CurrentCulture, "{0}<Name={1}, Mask={2}, ValidatingType={3}", new object[] { base.GetType(), (this.Name != null) ? this.Name : "null", (this.Mask != null) ? this.Mask : "null", (this.ValidatingType != null) ? this.ValidatingType.ToString() : "null" });
