namespace System.Windows.Forms.Design
{
    ...
    internal class OleDragDropHandler
    {
        ...
        public IComponent[] CreateTool(ToolboxItem tool, Control parent, int x, int y, int width, int height, bool hasLocation, bool hasSize) => 
            this.CreateTool(tool, parent, x, y, width, height, hasLocation, hasSize, null);
        ...
        public object[] GetDraggingObjects(DragEventArgs de) => 
            this.GetDraggingObjects(de.Data);

        public object[] GetDraggingObjects(IDataObject dataObj) => 
            this.GetDraggingObjects(dataObj, false);
        ...
        internal class CfCodeToolboxItem : ToolboxItem
        {
            ...
            protected override IComponent[] CreateComponentsCore(IDesignerHost host) => 
                this.CreateComponentsCore(host, null);
        ...
        protected class ComponentDataObject : IDataObject
        {
            ...
            public bool GetDataPresent(string format) => 
                this.GetDataPresent(format, false);

            public bool GetDataPresent(System.Type format) => 
                this.GetDataPresent(format.FullName, false);

            public bool GetDataPresent(string format, bool autoConvert) => 
                (Array.IndexOf<string>(this.GetFormats(), format) != -1);

            public string[] GetFormats() => 
                new string[] { OleDragDropHandler.NestedToolboxItemFormat, OleDragDropHandler.DataFormat, DataFormats.Serializable, OleDragDropHandler.ExtraInfoFormat };
