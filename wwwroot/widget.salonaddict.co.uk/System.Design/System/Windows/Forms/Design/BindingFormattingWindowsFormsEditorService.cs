namespace System.Windows.Forms.Design
{
    ...
    internal class BindingFormattingWindowsFormsEditorService : Panel, IWindowsFormsEditorService, ITypeDescriptorContext, IServiceProvider
    {
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new BindingFormattingWindowFormsEditorAccessibleObject(this);
        ...
        private void DropDownPicker()
        {
            ...
            if (binding2 != null)
            {
                ...
                IFormatProvider formatInfo = binding?.FormatInfo;
                object nullValue = binding?.NullValue;
        ...
        private int PreferredHeight =>
            ((TextRenderer.MeasureText("j^", this.Font, new Size(0x7fff, (int) (base.FontHeight * 1.25))).Height + (SystemInformation.BorderSize.Height * 8)) + base.Padding.Size.Height);
        ...
        private class BindingFormattingWindowFormsEditorAccessibleObject : Control.ControlAccessibleObject
        {
            ...
            public override string Name =>
                System.Design.SR.GetString("BindingFormattingDialogBindingPickerAccName");
