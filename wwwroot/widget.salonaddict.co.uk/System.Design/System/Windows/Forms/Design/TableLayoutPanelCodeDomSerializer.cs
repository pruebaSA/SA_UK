namespace System.Windows.Forms.Design
{
    ...
    internal class TableLayoutPanelCodeDomSerializer : CodeDomSerializer
    {
        ...
        public override object Deserialize(IDesignerSerializationManager manager, object codeObject) => 
            this.GetBaseSerializer(manager).Deserialize(manager, codeObject);

        private CodeDomSerializer GetBaseSerializer(IDesignerSerializationManager manager) => 
            ((CodeDomSerializer) manager.GetSerializer(typeof(TableLayoutPanel).BaseType, typeof(CodeDomSerializer)));
        ...
        public override object Serialize(IDesignerSerializationManager manager, object value)
        {
            ...
            if (component != null)
            {
                ...
                if ((attribute == null) || (attribute.InheritanceLevel != InheritanceLevel.InheritedReadOnly))
                {
                    ...
                    {
                        object obj3 = TypeDescriptor.GetProperties(component)[LayoutSettingsPropName]?.GetValue(component);
                        if (obj3 != null)
                        {
