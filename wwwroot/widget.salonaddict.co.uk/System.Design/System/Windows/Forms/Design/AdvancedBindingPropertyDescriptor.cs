namespace System.Windows.Forms.Design
{
    ...
    internal class AdvancedBindingPropertyDescriptor : PropertyDescriptor
    {
        ...
        public override AttributeCollection Attributes =>
            new AttributeCollection(new Attribute[] { new System.Design.SRDescriptionAttribute("AdvancedBindingPropertyDescriptorDesc"), NotifyParentPropertyAttribute.Yes, new MergablePropertyAttribute(false) });

        public override System.Type ComponentType =>
            typeof(ControlBindingsCollection);
