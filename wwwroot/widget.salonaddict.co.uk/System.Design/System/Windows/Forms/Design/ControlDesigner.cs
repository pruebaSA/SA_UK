namespace System.Windows.Forms.Design
{
    ...
    public class ControlDesigner : ComponentDesigner
    {
        ...
        internal override bool CanBeAssociatedWith(IDesigner parentDesigner) => 
            this.CanBeParentedTo(parentDesigner);
        ...
        internal ControlBodyGlyph GetControlGlyphInternal(GlyphSelectionType selectionType) => 
            this.GetControlGlyph(selectionType);
        ...
        {
            Point p = new Point(System.Design.NativeMethods.Util.SignedLOWORD((int) lParam), System.Design.NativeMethods.Util.SignedHIWORD((int) lParam));
        ...
        private bool ShouldSerializeAllowDrop() => 
            (this.AllowDrop != this.hadDragDrop);

        private bool ShouldSerializeEnabled() => 
            base.ShadowProperties.ShouldSerializeValue("Enabled", true);
        ...
        private bool ShouldSerializeVisible() => 
            base.ShadowProperties.ShouldSerializeValue("Visible", true);

        internal IList SnapLinesInternal() => 
            this.SnapLinesInternal(this.Control.Margin);
        ...
        protected virtual void WndProc(ref Message m)
        {
            ...
            {
                this.inHitTest = true;
                Point point = new Point((short) System.Design.NativeMethods.Util.LOWORD((int) m.LParam), (short) System.Design.NativeMethods.Util.HIWORD((int) m.LParam));
                try
                {
            ...
            if ((m.Msg >= 0x200) && (m.Msg <= 0x20a))
            {
                System.Design.NativeMethods.POINT pt = new System.Design.NativeMethods.POINT {
                    x = System.Design.NativeMethods.Util.SignedLOWORD((int) m.LParam),
                    y = System.Design.NativeMethods.Util.SignedHIWORD((int) m.LParam)
                };
                ...
                case 15:
                    ...
                    if (this.Control != null)
                    {
                        ...
                        try
                        {
                            ...
                            PaintEventArgs pe = new PaintEventArgs(graphics2, empty);
                            try
                            {
                                graphics2.Clip = region;
                                if (this.thrownException == null)
                                {
                                    this.OnPaintAdornments(pe);
                                }
                                else
                                {
                                    ...
                                    this.PaintException(pe, this.thrownException);
        ...
        {
            get => 
                ((bool) base.ShadowProperties["AllowDrop"]);
            set
            {
        ...
        {
            get => 
                ((System.Windows.Forms.ContextMenu) base.ShadowProperties["ContextMenu"]);
            set
            {
        ...
        public virtual System.Windows.Forms.Control Control =>
            ((System.Windows.Forms.Control) base.Component);
        ...
        {
            get => 
                ((bool) base.ShadowProperties["Enabled"]);
            set
            {
        ...
        {
            get => 
                ((bool) base.ShadowProperties["Visible"]);
            set
            {
        ...
        private class CanResetSizePropertyDescriptor : PropertyDescriptor
        {
            ...
            public override bool CanResetValue(object component) => 
                this._basePropDesc.ShouldSerializeValue(component);

            public override object GetValue(object component) => 
                this._basePropDesc.GetValue(component);
            ...
            public override System.Type ComponentType =>
                this._basePropDesc.ComponentType;

            public override string DisplayName =>
                this._basePropDesc.DisplayName;

            public override bool IsReadOnly =>
                this._basePropDesc.IsReadOnly;

            public override System.Type PropertyType =>
                this._basePropDesc.PropertyType;
        }
        ...
        private class ChildSubClass : NativeWindow, ControlDesigner.IDesignerTarget, IDisposable
        {
            ...
            protected override void WndProc(ref Message m)
            {
                ...
                else
                {
                    ...
                    if ((m.Msg == 0x210) && (System.Design.NativeMethods.Util.LOWORD((int) m.WParam) == 1))
                    {
        ...
        public class ControlDesignerAccessibleObject : AccessibleObject
        {
            ...
            public override int GetChildCount() => 
                this.control.AccessibilityObject.GetChildCount();
            ...
            public override AccessibleObject HitTest(int x, int y) => 
                this.control.AccessibilityObject.HitTest(x, y);

            public override Rectangle Bounds =>
                this.control.AccessibilityObject.Bounds;

            public override string DefaultAction =>
                "";

            public override string Description =>
                this.control.AccessibilityObject.Description;
            ...
            public override AccessibleObject Parent =>
                this.control.AccessibilityObject.Parent;

            public override AccessibleRole Role =>
                this.control.AccessibilityObject.Role;
            ...
            public override string Value =>
                this.control.AccessibilityObject.Value;
        }
        ...
        internal class DesignerControlCollection : Control.ControlCollection, IList, ICollection, IEnumerable
        {
            ...
            public override bool Equals(object other) => 
                this.realCollection.Equals(other);

            public override int GetChildIndex(Control child, bool throwException) => 
                this.realCollection.GetChildIndex(child, throwException);

            public IEnumerator GetEnumerator() => 
                this.realCollection.GetEnumerator();

            public override int GetHashCode() => 
                this.realCollection.GetHashCode();
            ...
            int IList.Add(object control) => 
                ((IList) this.realCollection).Add(control);

            bool IList.Contains(object control) => 
                ((IList) this.realCollection).Contains(control);

            int IList.IndexOf(object control) => 
                ((IList) this.realCollection).IndexOf(control);
            ...
            public override int Count =>
                this.realCollection.Count;

            public bool IsReadOnly =>
                this.realCollection.IsReadOnly;
