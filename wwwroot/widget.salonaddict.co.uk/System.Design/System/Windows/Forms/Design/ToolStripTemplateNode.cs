namespace System.Windows.Forms.Design
{
    ...
    internal class ToolStripTemplateNode : IMenuStatusHandler
    {
        ...
        {
            get => 
                this.isSystemContextMenuDisplayed;
            set
            {
        ...
        public class MiniToolStripRenderer : ToolStripSystemRenderer
        {
            ...
            protected override void OnRenderLabelBackground(ToolStripItemRenderEventArgs e)
            {
                ...
                if (this.state == 1)
                {
                    g.FillRectangle(new SolidBrush(this.toolStripBorderColor), rect);
            ...
            protected override void OnRenderSplitButtonBackground(ToolStripItemRenderEventArgs e)
            {
                ...
                if (item != null)
                {
                    ...
                    if (item.DropDownButtonPressed)
                    {
                        ...
                        g.FillRectangle(new SolidBrush(this.dropDownMouseDownColor), rectangle3);
                        flag = true;
                    }
                    else if (this.state == 2)
                    {
                        g.FillRectangle(new SolidBrush(this.dropDownMouseOverColor), item.ButtonBounds);
                        flag = true;
                    }
                    else if (this.state == 3)
                    {
                        ...
                        g.FillRectangle(new SolidBrush(this.dropDownMouseOverColor), rectangle4);
                        flag = true;
                    }
