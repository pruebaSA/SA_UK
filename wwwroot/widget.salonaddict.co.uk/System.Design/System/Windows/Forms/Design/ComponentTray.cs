namespace System.Windows.Forms.Design
{
    ...
    [ToolboxItem(false), ProvideProperty("Location", typeof(IComponent)), ProvideProperty("TrayLocation", typeof(IComponent)), DesignTimeVisible(false)]
    public class ComponentTray : ScrollableControl, IExtenderProvider, ISelectionUIHandler, IOleDragClient
    {
        ...
        [DesignOnly(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Design.SRDescription("ControlLocationDescr"), Category("Layout"), Browsable(false), Localizable(false)]
        ...
        internal TrayControl GetTrayControlFromComponent(IComponent comp) => 
            TrayControl.FromComponent(comp);

        [System.Design.SRDescription("ControlLocationDescr"), DesignOnly(true), Category("Layout"), Localizable(false), Browsable(false)]
        ...
        bool ISelectionUIHandler.QueryBeginDrag(object[] components, SelectionRules rules, int initialX, int initialY) => 
            this.DragHandler.QueryBeginDrag(components, rules, initialX, initialY);
        ...
        protected override void WndProc(ref Message m)
        {
            switch (m.Msg)
            {
                ...
                case 0x84:
                    if (this.glyphManager != null)
                    {
                        Point p = new Point((short) System.Design.NativeMethods.Util.LOWORD((int) m.LParam), (short) System.Design.NativeMethods.Util.HIWORD((int) m.LParam));
                ...
                case 0x7b:
                {
                    int x = System.Design.NativeMethods.Util.SignedLOWORD((int) m.LParam);
                    int y = System.Design.NativeMethods.Util.SignedHIWORD((int) m.LParam);
                    if ((x == -1) && (y == -1))
                    {
                        Point mousePosition = Control.MousePosition;
                        x = mousePosition.X;
        ...
        internal bool IsWindowVisible =>
            (base.IsHandleCreated && System.Design.NativeMethods.IsWindowVisible(base.Handle));
        ...
        private class ComponentTrayGlyphManager
        {
            ...
            public bool OnMouseDoubleClick(MouseEventArgs e) => 
                (((this.hitTestedGlyph != null) && (this.hitTestedGlyph.Behavior != null)) && this.hitTestedGlyph.Behavior.OnMouseDoubleClick(this.hitTestedGlyph, e.Button, new Point(e.X, e.Y)));

            public bool OnMouseDown(MouseEventArgs e) => 
                (((this.hitTestedGlyph != null) && (this.hitTestedGlyph.Behavior != null)) && this.hitTestedGlyph.Behavior.OnMouseDown(this.hitTestedGlyph, e.Button, new Point(e.X, e.Y)));

            public bool OnMouseMove(MouseEventArgs e) => 
                (((this.hitTestedGlyph != null) && (this.hitTestedGlyph.Behavior != null)) && this.hitTestedGlyph.Behavior.OnMouseMove(this.hitTestedGlyph, e.Button, new Point(e.X, e.Y)));

            public bool OnMouseUp(MouseEventArgs e) => 
                (((this.hitTestedGlyph != null) && (this.hitTestedGlyph.Behavior != null)) && this.hitTestedGlyph.Behavior.OnMouseUp(this.hitTestedGlyph, e.Button));
            ...
            public GlyphCollection SelectionGlyphs =>
                this.traySelectionAdorner.Glyphs;
        }
        ...
        internal class TrayControl : Control
        {
            ...
            protected override AccessibleObject CreateAccessibilityInstance() => 
                new TrayControlAccessibleObject(this, this.tray);
            ...
            public override string ToString() => 
                ("ComponentTray: " + this.component.ToString());
            ...
            private class TrayControlAccessibleObject : Control.ControlAccessibleObject
            {
                ...
                private IComponent Component =>
                    ((ComponentTray.TrayControl) base.Owner).Component;
        ...
        private class TraySelectionUIHandler : SelectionUIHandler
        {
            ...
            protected override Control GetControl(IComponent component) => 
                ComponentTray.TrayControl.FromComponent(component);

            protected override Size GetCurrentSnapSize() => 
                this.snapSize;

            protected override object GetService(System.Type serviceType) => 
                this.tray.GetService(serviceType);
