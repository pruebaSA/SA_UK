    ...
    internal class ToolboxItemSnapLineBehavior : System.Windows.Forms.Design.Behavior.Behavior
    {
        ...
        public override bool OnMouseMove(Glyph g, MouseButtons button, Point mouseLoc)
        {
            ...
            if (dragBounds != this.lastRectangle)
            {
                ...
                {
                    Region r = new Region(this.lastRectangle);
                    r.Exclude(dragBounds);
                    this.behaviorService.Invalidate(r);
                }
                if (this.targetAllowsDragBox)
                {
                    this.Graphics.DrawImage(DesignerUtils.BoxImage, dragBounds.Location);
                }
