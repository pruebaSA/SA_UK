        ...
        public override void OnLoseCapture(Glyph g, EventArgs e)
        {
            if (this.pushedBehavior)
            {
                ...
                if (this.BehaviorService != null)
                {
                    ...
                    {
                        this.dragging = false;
                        for (int i = 0; (this.graphics != null) && (i < this.resizeComponents.Length); i++)
                        {
                    ...
                    finally
                    {
                        ...
                        if (!empty.IsEmpty)
                        {
                            using (Region region = new Region(empty))
                            {
                                ...
                                if (this.graphics != null)
                                {
                                    if ((this.lastResizeRegion != null) && !this.lastResizeRegion.Equals(region, this.graphics))
                                    {
                                    ...
                                    DesignerUtils.DrawResizeBorder(this.graphics, region, backColor);
                                    if (this.lastResizeRegion == null)
                                    {
