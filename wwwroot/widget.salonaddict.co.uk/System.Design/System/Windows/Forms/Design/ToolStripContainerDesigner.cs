namespace System.Windows.Forms.Design
{
    ...
    internal class ToolStripContainerDesigner : ParentControlDesigner
    {
        ...
        private PanelDesigner GetDesigner(ToolStripContentPanel panel) => 
            (this.designerHost.GetDesigner(panel) as PanelDesigner);

        private ToolStripPanelDesigner GetDesigner(ToolStripPanel panel) => 
            (this.designerHost.GetDesigner(panel) as ToolStripPanelDesigner);
        ...
        {
            get => 
                ((bool) base.ShadowProperties["BottomToolStripPanelVisible"]);
            set
            {
        ...
        {
            get => 
                ((bool) base.ShadowProperties["LeftToolStripPanelVisible"]);
            set
            {
        ...
        {
            get => 
                ((bool) base.ShadowProperties["RightToolStripPanelVisible"]);
            set
            {
        ...
        public override IList SnapLines =>
            (base.SnapLinesInternal() as ArrayList);

        private bool TopToolStripPanelVisible
        {
            get => 
                ((bool) base.ShadowProperties["TopToolStripPanelVisible"]);
            set
            {
