namespace System.Windows.Forms.Design
{
    ...
    public class ParentControlDesigner : ControlDesigner, IOleDragClient
    {
        ...
        public virtual bool CanParent(Control control) => 
            !control.Contains(this.Control);

        public virtual bool CanParent(ControlDesigner controlDesigner) => 
            this.CanParent(controlDesigner.Control);
        ...
        private SnapLine[] GenerateNewToolSnapLines(Rectangle r) => 
            new SnapLine[] { new SnapLine(SnapLineType.Left, r.Right), new SnapLine(SnapLineType.Right, r.Right), new SnapLine(SnapLineType.Bottom, r.Bottom), new SnapLine(SnapLineType.Top, r.Bottom) };
        ...
        internal Rectangle GetSnappedRect(Rectangle originalRect, Rectangle dragRect, bool updateSize) => 
            this.GetUpdatedRect(originalRect, dragRect, updateSize);
        ...
        bool IOleDragClient.AddComponent(IComponent component, string name, bool firstAdd)
        {
            ...
            if (!firstAdd)
            {
                if (component.Site != null)
                {
                    ...
                    IDesignerHost host1 = (IDesignerHost) component.Site.GetService(typeof(IDesignerHost));
        ...
        bool IOleDragClient.CanModifyComponents =>
            !this.InheritanceAttribute.Equals(InheritanceAttribute.InheritedReadOnly);
