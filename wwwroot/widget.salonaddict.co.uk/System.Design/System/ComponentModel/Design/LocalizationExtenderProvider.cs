namespace System.ComponentModel.Design
{
    ...
    [ProvideProperty("LoadLanguage", typeof(object)), ProvideProperty("Language", typeof(object)), ProvideProperty("Localizable", typeof(object)), Obsolete("This class has been deprecated. Use CodeDomLocalizationProvider instead.  http://go.microsoft.com/fwlink/?linkid=14202")]
    public class LocalizationExtenderProvider : IExtenderProvider, IDisposable
    {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DesignOnly(true), Browsable(false)]
        ...
        [System.Design.SRDescription("ParentControlDesignerLocalizableDescr"), DesignOnly(true), Localizable(true)]
        ...
        public bool ShouldSerializeLanguage(object o) => 
            ((this.language != null) && (this.language != CultureInfo.InvariantCulture));
