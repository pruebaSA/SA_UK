    ...
    internal sealed class DesignerHost : Container, IDesignerLoaderHost2, IDesignerLoaderHost, IDesignerHost, IServiceContainer, IServiceProvider, IDesignerHostTransactionState, IComponentChangeService, IReflect
    {
        ...
        protected override ISite CreateSite(IComponent component, string name)
        {
            ...
            if (name == null)
            {
                if (service != null)
                {
                    name = service.CreateName(this, TypeDescriptor.GetReflectionType(component));
                }
                else
                {
                    name = string.Empty;
        ...
        DesignerTransaction IDesignerHost.CreateTransaction() => 
            ((IDesignerHost) this).CreateTransaction(null);
        ...
        FieldInfo IReflect.GetField(string name, BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetField(name, bindingAttr);

        FieldInfo[] IReflect.GetFields(BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetFields(bindingAttr);

        MemberInfo[] IReflect.GetMember(string name, BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetMember(name, bindingAttr);

        MemberInfo[] IReflect.GetMembers(BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetMembers(bindingAttr);

        MethodInfo IReflect.GetMethod(string name, BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetMethod(name, bindingAttr);

        MethodInfo IReflect.GetMethod(string name, BindingFlags bindingAttr, Binder binder, Type[] types, ParameterModifier[] modifiers) => 
            typeof(IDesignerHost).GetMethod(name, bindingAttr, binder, types, modifiers);

        MethodInfo[] IReflect.GetMethods(BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetMethods(bindingAttr);

        PropertyInfo[] IReflect.GetProperties(BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetProperties(bindingAttr);

        PropertyInfo IReflect.GetProperty(string name, BindingFlags bindingAttr) => 
            typeof(IDesignerHost).GetProperty(name, bindingAttr);
        ...
        {
            get => 
                this._state[StateIsClosingTransaction];
            set
            {
        ...
        bool IDesignerHost.InTransaction =>
            (((this._transactions != null) && (this._transactions.Count > 0)) || this.IsClosingTransaction);

        bool IDesignerHost.Loading =>
            ((this._state[StateLoading] || this._state[StateUnloading]) || ((this._loader != null) && this._loader.Loading));
        ...
        bool IDesignerHostTransactionState.IsClosingTransaction =>
            this.IsClosingTransaction;

        bool IDesignerLoaderHost2.CanReloadWithErrors
        {
            get => 
                this._canReloadWithErrors;
            set
            {
        ...
        {
            get => 
                this._ignoreErrorsDuringReload;
            set
            {
