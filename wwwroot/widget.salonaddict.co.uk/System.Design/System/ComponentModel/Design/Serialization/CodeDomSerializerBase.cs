    ...
    public abstract class CodeDomSerializerBase
    {
                    ...
                    if (expression3 != null)
                    {
                        ...
                        if (instance != null)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    obj4 = null;
                                    field = TypeDescriptor.GetReflectionType(type).GetField(expression3.FieldName, BindingFlags.GetField | BindingFlags.Public | BindingFlags.Static);
                                }
                                else
                                {
                                    obj4 = instance;
                                    field = TypeDescriptor.GetReflectionType(instance).GetField(expression3.FieldName, BindingFlags.GetField | BindingFlags.Public | BindingFlags.Instance);
                                }
                                if (field != null)
                                {
                                    ...
                                    if (!(obj5 is CodeExpression))
                                    {
                                        ...
                                        if ((convertible != null) && (field.FieldType != obj5.GetType()))
                                        {
                                            try
                                            {
                                                obj5 = convertible.ToType(field.FieldType, null);
                                            }
                                            catch
                                            {
                                            }
                                ...
                                else
                                {
                                    ...
                                    {
                                        this.Error(manager, System.Design.SR.GetString("SerializerNoSuchField", new object[] { instance.GetType().FullName, expression3.FieldName }), "SerializerNoSuchField");
                                    }
                                }
                            }
                        }
        ...
        private void DeserializeAttachEventStatement(IDesignerSerializationManager manager, CodeAttachEventStatement statement)
        {
            using (TraceScope("CodeDomSerializerBase::DeserializeAttachEventStatement"))
            {
                ...
                object obj2 = null;
                object component = this.DeserializeExpression(manager, null, statement.Event.TargetObject);
                ...
                if ((eventName != null) && (component != null))
                {
                    ...
                    if (((methodName != null) && flag) && !(component is CodeExpression))
                    {
                        EventDescriptor e = TypeDescriptor.GetEvents(component)[eventName];
                        if (e != null)
                        {
                            IEventBindingService service = (IEventBindingService) manager.GetService(typeof(IEventBindingService));
                            if (service != null)
                            {
                                service.GetEventProperty(e).SetValue(component, methodName);
                            }
                        }
                        else
                        {
                            this.Error(manager, System.Design.SR.GetString("SerializerNoSuchEvent", new object[] { component.GetType().FullName, eventName }), "SerializerNoSuchEvent");
                        }
                    }
                }
            }
        ...
        private void DeserializeDetachEventStatement(IDesignerSerializationManager manager, CodeRemoveEventStatement statement)
        {
            using (TraceScope("CodeDomSerializerBase::DeserializeDetachEventStatement"))
            {
                ...
                if (expression != null)
                {
                    ...
                    {
                        object component = this.DeserializeExpression(manager, null, statement.Event.TargetObject);
                        if (!(component is CodeExpression))
                        {
                            EventDescriptor e = TypeDescriptor.GetEvents(component)[statement.Event.EventName];
                            if (e != null)
                            {
                                IEventBindingService service = (IEventBindingService) manager.GetService(typeof(IEventBindingService));
                                if (service != null)
                                {
                                    service.GetEventProperty(e).SetValue(component, null);
                                }
                            }
                            else
                            {
                                this.Error(manager, System.Design.SR.GetString("SerializerNoSuchEvent", new object[] { component.GetType().FullName, statement.Event.EventName }), "SerializerNoSuchEvent");
                            }
                        }
                    }
                }
            ...
            using (TraceScope("CodeDomSerializerBase::DeserializeExpression"))
            {
                while (instance != null)
                {
                    ...
                    if (instance is CodeThisReferenceExpression)
                    {
                        ...
                        if (instance == null)
                        {
                            this.Error(manager, System.Design.SR.GetString("SerializerNoRootExpression"), "SerializerNoRootExpression");
                        }
                        return instance;
                    }
                    ...
                    if (expression5 != null)
                    {
                                        ...
                                        if (!(expression19.TargetObject is CodeThisReferenceExpression))
                                        {
                                            ...
                                            if (!(obj3 is CodeExpression))
                                            {
                                                ...
                                                if (method != null)
                                                {
                                                    ...
                                                    MethodInfo info2 = TypeDescriptor.GetReflectionType(obj3).GetMethod(expression19.MethodName, types);
                                                    if (info2 != null)
                                                    {
                        ...
                        this.Error(manager, System.Design.SR.GetString("SerializerTypeNotFound", new object[] { expression5.CreateType.BaseType }), "SerializerTypeNotFound");
                        return instance;
                    }
                    ...
                    if (expression6 != null)
                    {
                        ...
                        if (instance == null)
                        {
                            this.Error(manager, System.Design.SR.GetString("SerializerUndeclaredName", new object[] { expression6.ParameterName }), "SerializerUndeclaredName");
                        }
                        return instance;
                    }
                    ...
                    if (expression7 != null)
                    {
                        ...
                        if ((obj4 != null) && !(obj4 is CodeExpression))
                        {
                            ...
                            if ((context2 != null) && (context2.Value == obj4))
                            {
                                ...
                                this.Error(manager, System.Design.SR.GetString("SerializerUndeclaredName", new object[] { expression7.FieldName }), "SerializerUndeclaredName");
                                return instance;
                            }
                            ...
                            {
                                obj6 = null;
                                field = TypeDescriptor.GetReflectionType(type).GetField(expression7.FieldName, BindingFlags.GetField | BindingFlags.Public | BindingFlags.Static);
                            }
                            else
                            {
                                obj6 = obj4;
                                field = TypeDescriptor.GetReflectionType(obj4).GetField(expression7.FieldName, BindingFlags.GetField | BindingFlags.Public | BindingFlags.Instance);
                            }
                            if (field != null)
                            {
                        ...
                        this.Error(manager, System.Design.SR.GetString("SerializerFieldTargetEvalFailed", new object[] { expression7.FieldName }), "SerializerFieldTargetEvalFailed");
                        return instance;
                    }
                    ...
                    if (expression8 != null)
                    {
                        ...
                        if (component != null)
                        {
                            ...
                            if (flag2)
                            {
                                ...
                                if (type3 != null)
                                {
                                    return TypeDescriptor.GetReflectionType(type3).InvokeMember(expression8.Method.MethodName, BindingFlags.InvokeMethod | BindingFlags.Public | BindingFlags.Static, null, null, args, null, null, null);
                                }
                                if (service != null)
                                {
                                ...
                                try
                                {
                                    instance = TypeDescriptor.GetReflectionType(component).InvokeMember(expression8.Method.MethodName, BindingFlags.InvokeMethod | BindingFlags.Public | BindingFlags.Instance, null, component, args, null, null, null);
                                }
                                catch (MissingMethodException)
                                {
                                    ...
                                    instance = TypeDescriptor.GetReflectionType(type4).InvokeMember(expression8.Method.MethodName, BindingFlags.InvokeMethod | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance, null, component, args, null, null, null);
                                }
                                if (service != null)
                                {
                    ...
                    if (expression9 != null)
                    {
                        ...
                        if (instance == null)
                        {
                            this.Error(manager, System.Design.SR.GetString("SerializerUndeclaredName", new object[] { expression9.VariableName }), "SerializerUndeclaredName");
                        }
                        return instance;
                    }
                    ...
                    if (expression11 != null)
                    {
                        ...
                        {
                            this.Error(manager, System.Design.SR.GetString("SerializerTypeNotFound", new object[] { expression11.CreateType.BaseType }), "SerializerTypeNotFound");
                        }
                        instance = array;
                    ...
                    if (expression16 != null)
                    {
                        ...
                        if (target != null)
                        {
                            ...
                            if (flag5)
                            {
                                instance = TypeDescriptor.GetReflectionType(target).InvokeMember("Item", BindingFlags.GetProperty | BindingFlags.Public | BindingFlags.Instance, null, target, objArray4, null, null, null);
                            }
                        }
                        return instance;
                    }
                    ...
                    if (expression18 != null)
                    {
                        ...
                        if (instance == null)
                        {
                            this.Error(manager, System.Design.SR.GetString("SerializerTypeNotFound", new object[] { typeNameFromCodeTypeReference }), "SerializerTypeNotFound");
                        }
                        return instance;
                    }
        ...
        protected void DeserializePropertiesFromResources(IDesignerSerializationManager manager, object value, Attribute[] filter)
        {
            using (TraceScope("ComponentCodeDomSerializerBase::DeserializePropertiesFromResources"))
            {
                ...
                if (metadataEnumerator != null)
                {
                    ...
                    {
                        object current = metadataEnumerator.Current;
                        ...
                        if ((index != -1) && key.Substring(0, index).Equals(name))
                        {
                            ...
                            PropertyDescriptor descriptor = properties[str4];
                            if (descriptor != null)
                            {
                                bool flag = true;
                                if (filter != null)
        ...
        {
            object component = this.DeserializeExpression(manager, null, propertyReferenceEx.TargetObject);
            if ((component != null) && !(component is CodeExpression))
            {
                PropertyDescriptor member = TypeDescriptor.GetProperties(component, runTimeProperties)[propertyReferenceEx.PropertyName];
                if (member != null)
                {
                    ...
                    if (statement.Right is CodePropertyReferenceExpression)
                    {
                        ...
                        if (service != null)
                        {
                            ...
                            PropertyDescriptor descriptor2 = TypeDescriptor.GetProperties(obj4)[right.PropertyName];
                            if (descriptor2 != null)
                            {
                                MemberRelationship source = new MemberRelationship(component, member);
                    ...
                    else
                    {
                        ...
                        if (service != null)
                        {
                            empty = service[component, member];
                            service[component, member] = MemberRelationship.Empty;
                        }
                    }
                    try
                    {
                        member.SetValue(component, underlyingSystemType);
                    }
                    catch
                    {
                        if (service != null)
                        {
                            service[component, member] = empty;
                        }
                        throw;
                    }
                    return true;
                ...
                if (reportError)
                {
                    this.Error(manager, System.Design.SR.GetString("SerializerNoSuchProperty", new object[] { component.GetType().FullName, propertyReferenceEx.PropertyName }), "SerializerNoSuchProperty");
                }
            }
            return false;
        }
        ...
        private object DeserializePropertyReferenceExpression(IDesignerSerializationManager manager, CodePropertyReferenceExpression propertyReferenceEx, bool reportError)
        {
            ...
            if ((component != null) && !(component is CodeExpression))
            {
                ...
                {
                    PropertyInfo property = TypeDescriptor.GetReflectionType((Type) component).GetProperty(propertyReferenceEx.PropertyName, BindingFlags.GetProperty | BindingFlags.Public | BindingFlags.Static);
                    if (property != null)
                    {
                ...
                {
                    PropertyDescriptor descriptor = TypeDescriptor.GetProperties(component)[propertyReferenceEx.PropertyName];
                    if (descriptor != null)
                    {
                        obj2 = descriptor.GetValue(component);
                    }
                    else if (this.GetExpression(manager, component) is CodeThisReferenceExpression)
                    {
                        PropertyInfo info = TypeDescriptor.GetReflectionType(component).GetProperty(propertyReferenceEx.PropertyName, BindingFlags.GetProperty | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance);
                        if (info != null)
                        {
                            obj2 = info.GetValue(component, null);
                        }
                    }
                }
                if ((obj2 == propertyReferenceEx) && reportError)
                {
                    string str = (component is Type) ? ((Type) component).FullName : TypeDescriptor.GetReflectionType(component).FullName;
                    this.Error(manager, System.Design.SR.GetString("SerializerNoSuchProperty", new object[] { str, propertyReferenceEx.PropertyName }), "SerializerNoSuchProperty");
                }
            }
            return obj2;
        }
            ...
            using (TraceScope("CodeDomSerializerBase::FillStatementTable"))
            {
                ...
                Label_00FB:
                    ...
                    if (expression10 != null)
                    {
                        ...
                        {
                            Type objectType = GetType(trs, expression10.FieldName, names);
                            if (objectType != null)
                            {
                    ...
                    if (expression12 != null)
                    {
                        ...
                        if (names != null)
                        {
                            Type type2 = GetType(trs, expression12.VariableName, names);
                            if (type2 != null)
                            {
            ...
            if (value != null)
            {
                ...
                if (attributes.Count != attributes2.Count)
                {
                    ...
                    foreach (Attribute attribute in attributes)
                    {
                        ...
                        if ((attribute2 != null) && (manager.GetType(attribute2.SerializerBaseTypeName) == type))
                        {
                    ...
                    if (typeName != null)
                    {
                        foreach (Attribute attribute3 in attributes2)
                        {
                            DesignerSerializerAttribute attribute4 = attribute3 as DesignerSerializerAttribute;
                            if ((attribute4 != null) && (manager.GetType(attribute4.SerializerBaseTypeName) == type))
                            {
                    ...
                    if (typeName != null)
                    {
                        Type c = manager.GetType(typeName);
        ...
        protected CodeDomSerializer GetSerializer(IDesignerSerializationManager manager, Type valueType) => 
            (manager.GetSerializer(valueType, typeof(CodeDomSerializer)) as CodeDomSerializer);
        ...
        internal static Type GetType(ITypeResolutionService trs, string name, Dictionary<string, string> names)
        {
            ...
            if ((names != null) && names.ContainsKey(name))
            {
                ...
                if ((trs != null) && !string.IsNullOrEmpty(str))
                {
                    type = trs.GetType(str, false);
                }
            }
            return type;
        }
        ...
        protected string GetUniqueName(IDesignerSerializationManager manager, object value)
        {
            ...
            if (service != null)
            {
                str2 = service.CreateName(null, reflectionType);
            }
            else
            {
                str2 = reflectionType.Name.ToLower(CultureInfo.InvariantCulture);
            }
            int num = 1;
        ...
        protected bool IsSerialized(IDesignerSerializationManager manager, object value) => 
            this.IsSerialized(manager, value, false);
        ...
        protected CodeExpression SerializeCreationExpression(IDesignerSerializationManager manager, object value, out bool isComplete)
        {
            ...
            if (TypeDescriptor.GetReflectionType(value).GetConstructor(new Type[0]) != null)
            {
                isComplete = false;
        ...
        {
            foreach (EventDescriptor descriptor in TypeDescriptor.GetEvents(value, filter).Sort())
            {
        ...
        protected void SerializeProperties(IDesignerSerializationManager manager, CodeStatementCollection statements, object value, Attribute[] filter)
        {
            using (TraceScope("CodeDomSerializerBase::SerializeProperties"))
            {
                ...
                InheritanceAttribute context = (InheritanceAttribute) TypeDescriptor.GetAttributes(value)[typeof(InheritanceAttribute)];
                if (context == null)
                {
        ...
        protected CodeExpression SerializeToResourceExpression(IDesignerSerializationManager manager, object value) => 
            this.SerializeToResourceExpression(manager, value, true);
