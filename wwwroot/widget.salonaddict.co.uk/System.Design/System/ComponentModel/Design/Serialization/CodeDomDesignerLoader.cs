    ...
    public abstract class CodeDomDesignerLoader : BasicDesignerLoader, INameCreationService, IDesignerSerializationService
    {
        ...
        private class ModifierConverter : TypeConverter
        {
            public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType) => 
                this.GetConverter(context).CanConvertFrom(context, sourceType);

            public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType) => 
                this.GetConverter(context).CanConvertTo(context, destinationType);

            public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) => 
                this.GetConverter(context).ConvertFrom(context, culture, value);

            public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType) => 
                this.GetConverter(context).ConvertTo(context, culture, value, destinationType);

            public override object CreateInstance(ITypeDescriptorContext context, IDictionary propertyValues) => 
                this.GetConverter(context).CreateInstance(context, propertyValues);
            ...
            public override bool GetCreateInstanceSupported(ITypeDescriptorContext context) => 
                this.GetConverter(context).GetCreateInstanceSupported(context);

            public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes) => 
                this.GetConverter(context).GetProperties(context, value, attributes);

            public override bool GetPropertiesSupported(ITypeDescriptorContext context) => 
                this.GetConverter(context).GetPropertiesSupported(context);
            ...
            public override bool GetStandardValuesExclusive(ITypeDescriptorContext context) => 
                this.GetConverter(context).GetStandardValuesExclusive(context);

            public override bool GetStandardValuesSupported(ITypeDescriptorContext context) => 
                this.GetConverter(context).GetStandardValuesSupported(context);

            public override bool IsValid(ITypeDescriptorContext context, object value) => 
                this.GetConverter(context).IsValid(context, value);
        }
        ...
        private class ModifiersExtenderProvider : IExtenderProvider
        {
            ...
            [System.Design.SRDescription("CodeDomDesignerLoaderPropGenerateMember"), Category("Design"), HelpKeyword("Designer_GenerateMember"), DefaultValue(true), DesignOnly(true)]
            ...
            [DesignOnly(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), HelpKeyword("Designer_Modifiers"), TypeConverter(typeof(CodeDomDesignerLoader.ModifierConverter)), Category("Design"), DefaultValue(0x5000), System.Design.SRDescription("CodeDomDesignerLoaderPropModifiers")]
        ...
        private class ModifiersInheritedExtenderProvider : IExtenderProvider
        {
            ...
            [DesignOnly(true), Category("Design"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), TypeConverter(typeof(CodeDomDesignerLoader.ModifierConverter)), DefaultValue(0x5000), System.Design.SRDescription("CodeDomDesignerLoaderPropModifiers")]
            public MemberAttributes GetModifiers(IComponent comp)
            {
