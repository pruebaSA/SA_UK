namespace System.ComponentModel.Design.Serialization
{
    ...
    public sealed class CodeDomLocalizationProvider : IDisposable, IDesignerSerializationProvider
    {
        ...
        [ProvideProperty("Language", typeof(IComponent)), ProvideProperty("LoadLanguage", typeof(IComponent)), ProvideProperty("Localizable", typeof(IComponent))]
        internal class LanguageExtenders : IExtenderProvider
        {
            ...
            [DesignOnly(true), TypeConverter(typeof(CodeDomLocalizationProvider.LanguageCultureInfoConverter)), Category("Design"), System.Design.SRDescription("LocalizationProviderLanguageDescr")]
            ...
            [DesignOnly(true), Category("Design"), System.Design.SRDescription("LocalizationProviderLocalizableDescr")]
            ...
            private bool ShouldSerializeLanguage(IComponent o) => 
                ((this._language != null) && (this._language != CultureInfo.InvariantCulture));
