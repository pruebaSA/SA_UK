    ...
    public sealed class MultilineStringEditor : UITypeEditor
    {
        ...
        private class MultilineStringEditorUI : RichTextBox
        {
            ...
            protected override object CreateRichEditOleCallback() => 
                new MultilineStringEditor.OleCallback(this);
            ...
            protected override bool IsInputKey(Keys keyData) => 
                (((((keyData & Keys.KeyCode) == Keys.Enter) && this.Multiline) && ((keyData & Keys.Alt) == Keys.None)) || base.IsInputKey(keyData));
            ...
            public override Size MinimumSize
            {
                get
                {
                    ...
                    {
                        Rectangle workingArea = Screen.GetWorkingArea(this);
                        this._minimumSize = new Size((int) Math.Min(Math.Ceiling((double) (this.WatermarkSize.Width * 1.75)), (double) (workingArea.Width / 4)), Math.Min((int) (this.Font.Height * 10), (int) (workingArea.Height / 4)));
                    }
