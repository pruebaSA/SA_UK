namespace System
{
    ...
    internal class UriTemplateLiteralPathSegment : UriTemplatePathSegment, IComparable<UriTemplateLiteralPathSegment>
    {
        ...
        public string AsUnescapedString() => 
            Uri.UnescapeDataString(this.segment);
        ...
        public int CompareTo(UriTemplateLiteralPathSegment other) => 
            StringComparer.OrdinalIgnoreCase.Compare(this.segment, other.segment);
        ...
        public static UriTemplateLiteralPathSegment CreateFromUriTemplate(string segment, UriTemplate template)
        {
            ...
            if (str == string.Empty)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("segment", SR2.GetString(SR2.UTInvalidFormatSegmentOrQueryPart, new object[] { segment }));
            }
        ...
        public static UriTemplateLiteralPathSegment CreateFromWireData(string segment) => 
            new UriTemplateLiteralPathSegment(segment);
        ...
        public override int GetHashCode() => 
            StringComparer.OrdinalIgnoreCase.GetHashCode(this.segment);
        ...
        public bool IsNullOrEmpty() => 
            string.IsNullOrEmpty(this.segment);
