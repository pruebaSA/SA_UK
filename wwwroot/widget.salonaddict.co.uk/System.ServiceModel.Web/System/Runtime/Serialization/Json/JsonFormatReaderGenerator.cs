namespace System.Runtime.Serialization.Json
{
    ...
    internal sealed class JsonFormatReaderGenerator
    {
        ...
        public JsonFormatGetOnlyCollectionReaderDelegate GenerateGetOnlyCollectionReader(CollectionDataContract collectionContract) => 
            this.helper.GenerateGetOnlyCollectionReader(collectionContract);
        ...
        private class CriticalHelper
        {
            ...
            public JsonFormatClassReaderDelegate GenerateClassReader(ClassDataContract classContract)
            {
                ...
                bool allowPrivateMemberAccess = classContract.RequiresMemberAccessForRead(null) && RequiresJsonMemberAccessForRead(classContract.UnderlyingType);
                try
                {
            ...
            private bool HasFactoryMethod(ClassDataContract classContract) => 
                Globals.TypeOfIObjectReference.IsAssignableFrom(classContract.UnderlyingType);
            ...
            private static bool RequiresJsonMemberAccessForRead(Type underlyingType) => 
                !JsonDataContract.IsTypeVisibleInJsonSerializationModule(underlyingType);
