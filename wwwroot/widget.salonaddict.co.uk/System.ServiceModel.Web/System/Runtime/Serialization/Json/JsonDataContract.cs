namespace System.Runtime.Serialization.Json
{
    ...
    internal class JsonDataContract
    {
        ...
        public static JsonDataContract GetJsonDataContract(DataContract traditionalDataContract) => 
            JsonDataContractCriticalHelper.GetJsonDataContract(traditionalDataContract);
        ...
        internal static bool IsTypeVisibleInJsonSerializationModule(Type type) => 
            type.Module.Equals(JsonGlobals.JsonSerializationModule);
        ...
        public virtual object ReadJsonValueCore(XmlReaderDelegator jsonReader, XmlObjectSerializerReadContextComplexJson context) => 
            this.TraditionalDataContract.ReadXmlValue(jsonReader, context);
        ...
        protected DataContract TraditionalDataContract =>
            this.helper.TraditionalDataContract;
                ...
                lock (createDataContractLock)
                {
                    ...
                    if (contract == null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("traditionalDataContract", SR2.GetString(SR2.JsonTypeNotSupportedByDataContractJsonSerializer, new object[] { traditionalDataContract.UnderlyingType }));
                            }
                ...
                lock (cacheLock)
                {
                    ...
                    if (!typeToIDCache.TryGetValue(typeHandleRef, out ref2))
                    {
                        ...
                        if (num >= dataContractCache.Length)
                        {
                            ...
                            if (newSize <= num)
                            {
                                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SerializationException(System.Runtime.Serialization.SR.GetString("DataContractCacheOverflow")));
                            }
                        ...
                        catch (Exception exception)
                        {
                            ...
                            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperFatal(exception.Message, exception);
                        }
                    }
                    return ref2.Value;
                }
