    ...
    internal class JsonFormatWriterGenerator
    {
        ...
        private class CriticalHelper
        {
            ...
            internal JsonFormatClassWriterDelegate GenerateClassWriter(ClassDataContract classContract)
            {
                ...
                bool allowPrivateMemberAccess = classContract.RequiresMemberAccessForWrite(null) && RequiresJsonMemberAccessForWrite(classContract.UnderlyingType);
                try
                {
            ...
            private static bool RequiresJsonMemberAccessForWrite(Type underlyingType) => 
