namespace System.Runtime.Serialization.Json
{
    ...
    internal class XmlJsonReader : XmlBaseReader, IXmlJsonReaderInitializer
    {
        ...
        internal static void CheckArray(Array array, int offset, int count)
        {
            ...
            if (offset < 0)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("offset", SR2.GetString(SR2.ValueMustBeNonNegative, new object[0])));
            }
            if (offset > array.Length)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("offset", SR2.GetString(SR2.OffsetExceedsBufferSize, new object[] { array.Length })));
            }
            if (count < 0)
            {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", SR2.GetString(SR2.SizeExceedsRemainingBufferSpace, new object[] { array.Length - offset })));
            }
        }
        ...
        public override void Close()
        {
            ...
            if (onReaderClose != null)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperCallback(exception);
                }
            }
        }
        ...
        private static int ComputeQuotedTextLengthUntilEndQuote(byte[] buffer, int offset, int offsetMax, out bool escaped)
        {
            ...
            while (offset < offsetMax)
            {
                ...
                if (num2 < 0x20)
                {
                    throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SR2.GetString(SR2.InvalidCharacterEncountered, new object[] { (char) num2 })));
                }
        ...
        {
            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(SR2.GetString(SR2.JsonMethodNotSupported, new object[] { "CreateSigningNodeWriter" })));
        }
        ...
        public override string GetAttribute(int index) => 
            this.UnescapeJsonString(base.GetAttribute(index));
        ...
        private static int ParseInt(string value, NumberStyles style)
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(value, "Int32", exception2));
            }
            catch (OverflowException exception3)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(value, "Int32", exception3));
            }
            return num;
        }
                    ...
                    if (@byte != 0x7d)
                    {
                        switch (@byte)
                        {
                            ...
                            case 0x22:
                                ...
                                {
                                    XmlExceptionHelper.ThrowXmlException(this, new XmlException(SR2.GetString(SR2.JsonEncounteredUnexpectedCharacter, new object[] { '"' })));
                                }
                                goto Label_062F;
                        ...
                        {
                            XmlExceptionHelper.ThrowXmlException(this, new XmlException(SR2.GetString(SR2.JsonEncounteredUnexpectedCharacter, new object[] { (char) @byte })));
                        }
                        goto Label_062F;
                    }
                    base.BufferReader.SkipByte();
        ...
        public override decimal ReadContentAsDecimal()
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "decimal", exception));
            }
            catch (FormatException exception2)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "decimal", exception2));
            }
            catch (OverflowException exception3)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "decimal", exception3));
            }
            return num;
        }

        public override int ReadContentAsInt() => 
            ParseInt(this.ReadContentAsString(), NumberStyles.Float);
        ...
        public override long ReadContentAsLong()
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "Int64", exception));
            }
            catch (FormatException exception2)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "Int64", exception2));
            }
            catch (OverflowException exception3)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "Int64", exception3));
            }
            return num;
        }
        ...
        private void ReadEscapedCharacter(bool moveToText)
        {
            ...
            switch (@byte)
            {
                ...
                default:
                    XmlExceptionHelper.ThrowXmlException(this, new XmlException(SR2.GetString(SR2.JsonEncounteredUnexpectedCharacter, new object[] { @byte })));
                    break;
            }
            base.BufferReader.SkipByte();
        ...
        private int ReadNonFFFE()
        {
            ...
            {
                XmlExceptionHelper.ThrowXmlException(this, new XmlException(SR2.GetString(SR2.JsonInvalidFFFE, new object[0])));
            }
            return 3;
        }
        ...
        public override int ReadValueAsBase64(byte[] buffer, int offset, int count)
        {
            ...
            if (offset < 0)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("offset", System.Runtime.Serialization.SR.GetString("ValueMustBeNonNegative")));
            }
            if (offset > buffer.Length)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("offset", System.Runtime.Serialization.SR.GetString("OffsetExceedsBufferSize", new object[] { buffer.Length })));
            }
            if (count < 0)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", System.Runtime.Serialization.SR.GetString("ValueMustBeNonNegative")));
            }
            if (count > (buffer.Length - offset))
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", System.Runtime.Serialization.SR.GetString("SizeExceedsRemainingBufferSpace", new object[] { buffer.Length - offset })));
            }
            return 0;
        }
        ...
        public override int ReadValueChunk(char[] chars, int offset, int count)
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("offset", System.Runtime.Serialization.SR.GetString("OffsetExceedsBufferSize", new object[] { chars.Length })));
            }
            if (count < 0)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", System.Runtime.Serialization.SR.GetString("ValueMustBeNonNegative")));
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", System.Runtime.Serialization.SR.GetString("SizeExceedsRemainingBufferSpace", new object[] { chars.Length - offset })));
            }
        ...
        public void SetInput(byte[] buffer, int offset, int count, Encoding encoding, XmlDictionaryReaderQuotas quotas, OnXmlDictionaryReaderClose onClose)
        {
            ...
            if (offset > buffer.Length)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("offset", SR2.GetString(SR2.JsonOffsetExceedsBufferSize, new object[] { buffer.Length })));
            }
            if (count < 0)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", SR2.GetString(SR2.ValueMustBeNonNegative, new object[0])));
            ...
            if (count > (buffer.Length - offset))
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("count", SR2.GetString(SR2.JsonSizeExceedsRemainingBufferSpace, new object[] { buffer.Length - offset })));
            }
            this.MoveToInitial(quotas, onClose);
        ...
        private string UnescapeJsonString(string val)
        {
            ...
            for (int i = 0; i < val.Length; i++)
            {
                if (val[i] == '\\')
                {
                    ...
                    if (i >= val.Length)
                    {
                        XmlExceptionHelper.ThrowXmlException(this, new XmlException(SR2.GetString(SR2.JsonEncounteredUnexpectedCharacter, new object[] { val[i] })));
                    }
                    switch (val[i])
                    {
                        case '/':
        ...
        private bool IsReadingCollection =>
            ((this.scopeDepth > 0) && (this.scopes[this.scopeDepth] == JsonNodeType.Collection));

        private bool IsReadingComplexText =>
            (!base.Node.IsAtomicValue && (base.Node.NodeType == XmlNodeType.Text));
