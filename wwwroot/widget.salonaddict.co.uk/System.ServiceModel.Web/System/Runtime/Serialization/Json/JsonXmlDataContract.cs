namespace System.Runtime.Serialization.Json
{
    ...
    internal class JsonXmlDataContract : JsonDataContract
    {
        ...
        public override object ReadJsonValueCore(XmlReaderDelegator jsonReader, XmlObjectSerializerReadContextComplexJson context)
        {
            ...
            DataContractSerializer serializer = new DataContractSerializer(base.TraditionalDataContract.UnderlyingType, this.GetKnownTypesFromContext(context, context?.SerializerKnownTypeList), 1, false, false, null);
        ...
        {
            DataContractSerializer serializer = new DataContractSerializer(Type.GetTypeFromHandle(declaredTypeHandle), this.GetKnownTypesFromContext(context, context?.SerializerKnownTypeList), 1, false, false, null);
