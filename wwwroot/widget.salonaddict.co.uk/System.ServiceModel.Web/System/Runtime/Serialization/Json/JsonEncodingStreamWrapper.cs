    ...
    internal class JsonEncodingStreamWrapper : Stream
    {
        ...
        private void CleanupCharBreak()
        {
            ...
            if ((this.byteCount % 2) != 0)
            {
                ...
                if (num2 < 0)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR2.GetString(SR2.JsonUnexpectedEndOfFile, new object[0])));
                }
        ...
        private static Encoding GetEncoding(SupportedEncoding e)
        {
            ...
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR2.GetString(SR2.JsonEncodingNotSupported, new object[0])));
        }
        ...
        private void InitForReading(Stream inputStream, Encoding expectedEncoding)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR2.GetString(SR2.JsonInvalidBytes, new object[0]), exception));
            }
        }
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            try
            {
                ...
                System.Buffer.BlockCopy(this.bytes, this.byteOffset, buffer, offset, count);
        ...
        private static SupportedEncoding ReadEncoding(byte b1, byte b2)
        {
            ...
            if ((b1 == 0) && (b2 == 0))
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR2.GetString(SR2.JsonInvalidBytes, new object[0])));
            }
            return SupportedEncoding.UTF8;
        }
        ...
        {
            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR2.GetString(SR2.JsonExpectedEncoding, new object[] { GetEncodingName(expEnc), GetEncodingName(actualEnc) })));
        }
