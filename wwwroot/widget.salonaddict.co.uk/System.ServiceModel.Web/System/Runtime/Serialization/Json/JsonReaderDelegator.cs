namespace System.Runtime.Serialization.Json
{
    ...
    internal class JsonReaderDelegator : XmlReaderDelegator
    {
        ...
        internal static DateTime ParseJsonDate(string originalDateTimeValue)
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SR2.GetString(SR2.JsonInvalidDateTimeString, new object[] { originalDateTimeValue, @"\/Date(", @")\/" })));
            }
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "DateTime", exception4));
            }
            return time2;
        }
        ...
        internal override char ReadContentAsChar() => 
            XmlConvert.ToChar(base.ReadContentAsString());

        internal override DateTime ReadContentAsDateTime() => 
            ParseJsonDate(base.ReadContentAsString());

        internal override XmlQualifiedName ReadContentAsQName() => 
            ParseQualifiedName(base.ReadContentAsString());
        ...
        internal override ulong ReadContentAsUnsignedLong()
        {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(XmlObjectSerializer.TryAddLineInfo(this, System.ServiceModel.SR.GetString("XmlInvalidConversion", new object[] { s, "UInt64" }))));
            }
            try
            {
            ...
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "UInt64", exception));
            }
            catch (FormatException exception2)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "UInt64", exception2));
            }
            catch (OverflowException exception3)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(s, "UInt64", exception3));
            }
            return num;
        }
        ...
        internal override byte[] ReadElementContentAsBase64()
        {
            if (base.isEndOfEmptyElement)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(System.Runtime.Serialization.SR.GetString("XmlStartElementExpected", new object[] { "EndElement" })));
            }
        ...
        internal override char ReadElementContentAsChar() => 
            XmlConvert.ToChar(base.ReadElementContentAsString());

        internal override DateTime ReadElementContentAsDateTime() => 
            ParseJsonDate(base.ReadElementContentAsString());
        ...
        internal override ulong ReadElementContentAsUnsignedLong()
        {
            ...
            if ((s == null) || (s.Length == 0))
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(XmlObjectSerializer.TryAddLineInfo(this, System.Runtime.Serialization.SR.GetString("XmlInvalidConversion", new object[] { s, "UInt64" }))));
            }
            try
            {
                num = ulong.Parse(s, NumberStyles.Float, NumberFormatInfo.InvariantInfo);
