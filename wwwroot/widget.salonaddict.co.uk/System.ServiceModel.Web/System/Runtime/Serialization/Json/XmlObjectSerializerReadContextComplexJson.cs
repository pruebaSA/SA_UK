namespace System.Runtime.Serialization.Json
{
    ...
    internal class XmlObjectSerializerReadContextComplexJson : XmlObjectSerializerReadContextComplex
    {
        ...
        public XmlObjectSerializerReadContextComplexJson(DataContractJsonSerializer serializer, DataContract rootTypeDataContract) : base(serializer, serializer.MaxItemsInObjectGraph, new StreamingContext(StreamingContextStates.All), serializer.IgnoreExtensionDataObject)
        {
            ...
            base.serializerKnownDataContracts = serializer.KnownDataContracts;
        ...
        internal static XmlObjectSerializerReadContextComplexJson CreateContext(DataContractJsonSerializer serializer, DataContract rootTypeDataContract) => 
            new XmlObjectSerializerReadContextComplexJson(serializer, rootTypeDataContract);

        protected override XmlReaderDelegator CreateReaderDelegatorForReader(XmlReader xmlReader) => 
            new JsonReaderDelegator(xmlReader);
        ...
        internal int GetJsonMemberIndex(XmlReaderDelegator xmlReader, XmlDictionaryString[] memberNames, int memberIndex, ExtensionDataObject extensionData)
        {
        ...
        protected override object ReadDataContractValue(DataContract dataContract, XmlReaderDelegator reader) => 
            DataContractJsonSerializer.ReadJsonValue(dataContract, reader, this);
        ...
        protected override IDataNode ReadPrimitiveExtensionDataValue(XmlReaderDelegator xmlReader, string dataContractName, string dataContractNamespace)
        {
            ...
            if (((str = this.extensionDataValueType) != null) && (str != "string"))
            {
                if (str != "boolean")
                {
                    if (str != "number")
                    {
                        throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer.CreateSerializationException(SR2.GetString(SR2.JsonUnexpectedAttributeValue, new object[] { this.extensionDataValueType })));
                    }
        ...
        internal static void ThrowDuplicateMemberException(object obj, XmlDictionaryString[] memberNames, int memberIndex)
        {
            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SerializationException(SR2.GetString(SR2.JsonDuplicateMemberInInput, new object[] { DataContract.GetClrTypeFullName(obj.GetType()), memberNames[memberIndex] })));
        }

        internal static void ThrowMissingRequiredMembers(object obj, XmlDictionaryString[] memberNames, byte[] expectedElements, byte[] requiredElements)
        {
            ...
            if (num == 1)
            {
                throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SerializationException(SR2.GetString(SR2.JsonOneRequiredMemberNotFound, new object[] { DataContract.GetClrTypeFullName(obj.GetType()), builder.ToString() })));
            }
            throw System.ServiceModel.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new SerializationException(SR2.GetString(SR2.JsonRequiredMembersNotFound, new object[] { DataContract.GetClrTypeFullName(obj.GetType()), builder.ToString() })));
        }
