namespace System.ServiceModel.Syndication
{
    ...
    internal struct ExtensibleSyndicationObject : IExtensibleSyndicationObject
    {
        ...
        internal void LoadElementExtensions(XmlReader readerOverUnparsedExtensions, int maxExtensionSize)
        {
            ...
            {
                throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperArgumentNull("readerOverUnparsedExtensions");
            }
            if (maxExtensionSize < 0)
            {
                throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(new ArgumentOutOfRangeException("maxExtensionSize"));
            }
        ...
        public ExtensibleSyndicationObject Clone() => 
            new ExtensibleSyndicationObject(this);
    }
}
