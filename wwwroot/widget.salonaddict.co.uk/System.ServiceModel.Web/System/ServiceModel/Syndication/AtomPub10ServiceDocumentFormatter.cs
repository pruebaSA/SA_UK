namespace System.ServiceModel.Syndication
{
    ...
    public class AtomPub10ServiceDocumentFormatter : ServiceDocumentFormatter, IXmlSerializable
    {
        ...
        public AtomPub10ServiceDocumentFormatter(Type documentTypeToCreate)
        {
            ...
            {
                throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperArgumentNull("documentTypeToCreate");
            }
            if (!typeof(ServiceDocument).IsAssignableFrom(documentTypeToCreate))
            {
                throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("documentTypeToCreate", SR2.GetString(SR2.InvalidObjectTypePassed, new object[] { "documentTypeToCreate", "ServiceDocument" }));
            }
            this.maxExtensionSize = 0x7fffffff;
            this.preserveAttributeExtensions = true;
            this.preserveElementExtensions = true;
        ...
        public override bool CanRead(XmlReader reader) => 
            reader?.IsStartElement("service", "http://www.w3.org/2007/app");
        ...
        internal static void TraceServiceDocumentReadBegin()
        {
            ...
            {
                System.Runtime.Serialization.DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.SyndicationReadServiceDocumentBegin, SR2.GetString(SR2.TraceCodeSyndicationReadServiceDocumentBegin, new object[0]));
            }
        }
        ...
        internal static void TraceServiceDocumentReadEnd()
        {
            if (System.Runtime.Serialization.DiagnosticUtility.ShouldTraceInformation)
            {
                System.Runtime.Serialization.DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.SyndicationReadServiceDocumentEnd, SR2.GetString(SR2.TraceCodeSyndicationReadServiceDocumentEnd, new object[0]));
            }
        }
        ...
        internal static void TraceServiceDocumentWriteBegin()
        {
            if (System.Runtime.Serialization.DiagnosticUtility.ShouldTraceInformation)
            {
                System.Runtime.Serialization.DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.SyndicationWriteServiceDocumentBegin, SR2.GetString(SR2.TraceCodeSyndicationWriteServiceDocumentBegin, new object[0]));
            }
        }
        ...
        internal static void TraceServiceDocumentWriteEnd()
        {
            if (System.Runtime.Serialization.DiagnosticUtility.ShouldTraceInformation)
            {
                System.Runtime.Serialization.DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.SyndicationWriteServiceDocumentEnd, SR2.GetString(SR2.TraceCodeSyndicationWriteServiceDocumentEnd, new object[0]));
            }
        }
