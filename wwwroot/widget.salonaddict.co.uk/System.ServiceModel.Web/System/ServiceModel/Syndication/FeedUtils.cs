namespace System.ServiceModel.Syndication
{
    ...
    internal static class FeedUtils
    {
        public static string AddLineInfo(XmlReader reader, string error)
        {
            ...
            {
                error = string.Format(CultureInfo.InvariantCulture, "{0} {1}", new object[] { SR2.GetString(SR2.ErrorInLine, new object[] { info.LineNumber, info.LinePosition }), error });
            }
            return error;
        }
        ...
        internal static bool IsXmlSchemaType(string name, string ns) => 
            ((name == "type") && (ns == "http://www.w3.org/2001/XMLSchema-instance"));
    }
}
