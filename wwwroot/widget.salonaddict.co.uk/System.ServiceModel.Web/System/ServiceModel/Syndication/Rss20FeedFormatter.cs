namespace System.ServiceModel.Syndication
{
    ...
    public class Rss20FeedFormatter : SyndicationFeedFormatter, IXmlSerializable
    {
        ...
        public Rss20FeedFormatter(Type feedTypeToCreate)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("feedTypeToCreate", SR2.GetString(SR2.InvalidObjectTypePassed, new object[] { "feedTypeToCreate", "SyndicationFeed" }));
            }
        ...
        public override bool CanRead(XmlReader reader) => 
            reader?.IsStartElement("rss", "");

        protected override SyndicationFeed CreateFeedInstance() => 
            SyndicationFeedFormatter.CreateFeedInstance(this.feedType);
        ...
        private static DateTimeOffset DateFromString(string dateTimeString, XmlReader reader)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(FeedUtils.AddLineInfo(reader, SR2.ErrorParsingDateTime)));
            }
            if (stringBuilder[3] == ',')
            {
        ...
        public override void ReadFrom(XmlReader reader)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(SR2.GetString(SR2.UnknownFeedXml, new object[] { reader.LocalName, reader.NamespaceURI })));
            }
        ...
        private void ReadItemFrom(XmlReader reader, SyndicationItem result, Uri feedBaseUri)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(FeedUtils.AddLineInfo(reader, SR2.ErrorParsingItem), exception));
            }
            catch (ArgumentException exception2)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(FeedUtils.AddLineInfo(reader, SR2.ErrorParsingItem), exception2));
            }
        }
        ...
        private void ReadXml(XmlReader reader, SyndicationFeed result)
        {
            try
            {
                ...
                if (attribute != "2.0")
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(FeedUtils.AddLineInfo(reader, SR2.GetString(SR2.UnsupportedRssVersion, new object[] { attribute }))));
                }
                    ...
                    while (reader.IsStartElement())
                    {
                        ...
                        else
                        {
                            ...
                            if (reader.IsStartElement("item", ""))
                            {
                                if (flag2)
                                {
                                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(new InvalidOperationException(SR2.GetString(SR2.FeedHasNonContiguousItems, new object[] { base.GetType().ToString() })));
                                }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(FeedUtils.AddLineInfo(reader, SR2.ErrorParsingFeed), exception));
            }
            catch (ArgumentException exception2)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new XmlException(FeedUtils.AddLineInfo(reader, SR2.ErrorParsingFeed), exception2));
            }
        }
        ...
        internal static void TraceExtensionsIgnoredOnWrite(string message)
        {
            ...
            {
                DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Information, TraceCode.SyndicationProtocolElementIgnoredOnWrite, SR2.GetString(message, new object[0]));
            }
        }
        ...
        private void WriteFeed(XmlWriter writer)
        {
            if (base.Feed == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.FeedFormatterDoesNotHaveFeed, new object[0])));
            }
            ...
            {
                TraceExtensionsIgnoredOnWrite(SR2.FeedAuthorsIgnoredOnWrite);
            }
            ...
            if (base.Feed.Contributors.Count > 0)
            {
                ...
                {
                    TraceExtensionsIgnoredOnWrite(SR2.FeedContributorsIgnoredOnWrite);
                }
            }
            ...
            else
            {
                ...
                {
                    TraceExtensionsIgnoredOnWrite(SR2.FeedIdIgnoredOnWrite);
                }
                if (base.Feed.Links.Count > 1)
                {
                    TraceExtensionsIgnoredOnWrite(SR2.FeedLinksIgnoredOnWrite);
                }
            }
        ...
        private void WriteItemContents(XmlWriter writer, SyndicationItem item, Uri feedBaseUri)
        {
            ...
            {
                TraceExtensionsIgnoredOnWrite(SR2.ItemAuthorsIgnoredOnWrite);
            }
            ...
            if (flag5)
            {
                TraceExtensionsIgnoredOnWrite(SR2.ItemLinksIgnoredOnWrite);
            }
            if (item.LastUpdatedTime > DateTimeOffset.MinValue)
            {
                ...
                {
                    TraceExtensionsIgnoredOnWrite(SR2.ItemLastUpdatedTimeIgnoredOnWrite);
                }
            }
            if (this.serializeExtensionsAsAtom)
            {
            ...
            {
                TraceExtensionsIgnoredOnWrite(SR2.ItemCopyrightIgnoredOnWrite);
            }
            if (!flag3)
            {
                if (this.serializeExtensionsAsAtom)
                ...
                {
                    TraceExtensionsIgnoredOnWrite(SR2.ItemContentIgnoredOnWrite);
                }
            }
            if (item.Contributors.Count > 0)
            {
                ...
                {
                    TraceExtensionsIgnoredOnWrite(SR2.ItemContributorsIgnoredOnWrite);
                }
            }
