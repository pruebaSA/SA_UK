namespace System
{
    ...
    public class UriTemplate
    {
            ...
            if (!string.IsNullOrEmpty(str2))
            {
                ...
                while (num5 < str2.Length)
                {
                    ...
                    if (num6 != -1)
                    {
                        ...
                        if (num5 >= str2.Length)
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTQueryCannotEndInAmpersand, new object[] { this.originalTemplate })));
                        }
                    }
                    else
                    {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTQueryCannotHaveEmptyName, new object[] { this.originalTemplate })));
                    }
                    if (UriTemplateHelpers.IdentifyPartType(str4) != UriTemplatePartType.Literal)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("template", SR2.GetString(SR2.UTQueryMustHaveLiteralNames, new object[] { this.originalTemplate }));
                    }
                    str4 = UrlUtility.UrlDecode(str4, Encoding.UTF8);
                    if (this.queries.ContainsKey(str4))
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTQueryNamesMustBeUnique, new object[] { this.originalTemplate })));
                    }
            ...
            if (additionalDefaults != null)
            {
                ...
                else
                {
                    foreach (KeyValuePair<string, string> pair in additionalDefaults)
                    {
                        ...
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("additionalDefaults", SR2.GetString(SR2.UTAdditionalDefaultIsInvalid, new object[] { pair.Key, this.originalTemplate }));
                        }
                        ...
                        else
                        {
                            ...
                            {
                                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTDefaultValueToQueryVarFromAdditionalDefaults, new object[] { this.originalTemplate, key })));
                            }
                            if (string.Compare(pair.Value, "null", StringComparison.OrdinalIgnoreCase) == 0)
                            {
                                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTNullableDefaultAtAdditionalDefaults, new object[] { this.originalTemplate, key })));
                            }
        ...
        internal string AddPathVariable(UriTemplatePartType sourceNature, string varDeclaration, out bool hasDefaultValue) => 
            this.variables?.AddPathVariable(sourceNature, varDeclaration, out hasDefaultValue);

        internal string AddQueryVariable(string varDeclaration) => 
            this.variables?.AddQueryVariable(varDeclaration);
            ...
            if ((this.queries.Count != 0) || (additionalParameters != null))
            {
                ...
                if (additionalParameters != null)
                {
                    foreach (string str2 in additionalParameters.Keys)
                    {
                        ...
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("parameters", SR2.GetString(SR2.UTBothLiteralAndNameValueCollectionKey, new object[] { str2 }));
                        }
        ...
        public Uri BindByName(Uri baseAddress, IDictionary<string, string> parameters) => 
            this.BindByName(baseAddress, parameters, false);
        ...
        public Uri BindByName(Uri baseAddress, IDictionary<string, string> parameters, bool omitDefaults)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("baseAddress", SR2.GetString(SR2.UTBadBaseAddress, new object[0]));
            }
            if (this.variables == null)
            {
        ...
        public Uri BindByPosition(Uri baseAddress, params string[] values)
        {
            ...
            if (this.variables == null)
            {
                if (values.Length > 0)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SR2.GetString(SR2.UTBindByPositionNoVariables, new object[] { this.originalTemplate, values.Length })));
                }
        ...
        private BindInformation PrepareBindInformation(IDictionary<string, string> parameters, bool omitDefaults)
        {
            ...
            foreach (KeyValuePair<string, string> pair in parameters)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("parameters", SR2.GetString(SR2.UTBindByNameCalledWithEmptyKey, new object[0]));
                }
        ...
        public ReadOnlyCollection<string> PathSegmentVariableNames =>
            this.variables?.PathSegmentVariableNames;

        public ReadOnlyCollection<string> QueryValueVariableNames =>
            this.variables?.QueryValueVariableNames;
        ...
        private struct BindInformation
        {
            ...
            public int LastNonDefaultPathParameter =>
                this.lastNonDefaultPathParameter;
            public int LastNonNullablePathParameter =>
                this.lastNonNullablePathParameter;
        ...
        private class UriTemplateDefaults : IDictionary<string, string>, ICollection<KeyValuePair<string, string>>, IEnumerable<KeyValuePair<string, string>>, IEnumerable
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new NotSupportedException(SR2.GetString(SR2.UTDefaultValuesAreImmutable, new object[0])));
            }
            ...
            public bool Contains(KeyValuePair<string, string> item) => 
                this.defaults.Contains(item);

            public bool ContainsKey(string key) => 
                this.defaults.ContainsKey(key);
            ...
            public bool TryGetValue(string key, out string value) => 
                this.defaults.TryGetValue(key, out value);
        ...
        private class VariablesCollection
        {
            ...
            public void AddDefaultValue(string varName, string value)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTStarVariableWithDefaultsFromAdditionalDefaults, new object[] { this.owner.originalTemplate, varName })));
                }
                if (((UriTemplatePartType) this.pathSegmentVariableNature[index]) != UriTemplatePartType.Variable)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTDefaultValueToCompoundSegmentVarFromAdditionalDefaults, new object[] { this.owner.originalTemplate, varName })));
                }
            ...
            public string AddPathVariable(UriTemplatePartType sourceNature, string varDeclaration, out bool hasDefaultValue)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SR2.GetString(SR2.UTInvalidWildcardInVariableOrLiteral, new object[] { this.owner.originalTemplate, "*" })));
                }
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTVarNamesMustBeUnique, new object[] { this.owner.originalTemplate, str })));
                }
                ...
                if (hasDefaultValue)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTInvalidDefaultPathValue, new object[] { this.owner.originalTemplate, varDeclaration, str })));
                    }
            ...
            public string AddQueryVariable(string varDeclaration)
            {
                ...
                if (str2 != null)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTDefaultValueToQueryVar, new object[] { this.owner.originalTemplate, varDeclaration, str })));
                }
                string item = str.ToUpperInvariant();
                if (this.pathSegmentVariableNames.Contains(item) || this.queryValueVariableNames.Contains(item))
                {
            ...
            private void LoadDefaultsAndValidate(string[] normalizedParameters, out int lastNonDefaultPathParameter, out int lastNonNullablePathParameter)
            {
                ...
                for (int j = 0; j <= lastNonNullablePathParameter; j++)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperArgument("parameters", SR2.GetString(SR2.BindUriTemplateToNullOrEmptyPathParam, new object[] { this.pathSegmentVariableNames[j] }));
                    }
                }
            }
            ...
            private void ParseVariableDeclaration(string varDeclaration, out string varName, out string defaultValue)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SR2.GetString(SR2.UTInvalidVarDeclaration, new object[] { this.owner.originalTemplate, varDeclaration })));
                }
            ...
            public UriTemplate.BindInformation PrepareBindInformation(params string[] parameters)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new FormatException(SR2.GetString(SR2.GetString(SR2.UTBindByPositionWrongCount, new object[] { this.owner.originalTemplate, this.pathSegmentVariableNames.Count, this.queryValueVariableNames.Count, parameters.Length }), new object[0])));
                }
            ...
            public void ValidateDefaults(out int firstOptionalSegment)
            {
                ...
                if (this.firstNullablePathVariable > 1)
                {
                    for (int j = this.firstNullablePathVariable - 2; j >= 0; j--)
                    {
                        ...
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTNullableDefaultMustBeFollowedWithNullables, new object[] { this.owner.originalTemplate, str3, this.pathSegmentVariableNames[j + 1] })));
                        }
                    }
                }
                if (this.firstNullablePathVariable < this.pathSegmentVariableNames.Count)
                {
                    ...
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTNullableDefaultMustNotBeFollowedWithWildcard, new object[] { this.owner.originalTemplate, this.pathSegmentVariableNames[this.firstNullablePathVariable] })));
                    }
                    for (int k = this.pathSegmentVariableNames.Count - 1; k >= this.firstNullablePathVariable; k--)
                    {
                        ...
                        {
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTNullableDefaultMustNotBeFollowedWithLiteral, new object[] { this.owner.originalTemplate, this.pathSegmentVariableNames[this.firstNullablePathVariable], this.owner.segments[num4].OriginalSegment })));
                        }
                    }
                }
        ...
        private class WildcardInfo
        {
            ...
            public WildcardInfo(UriTemplate owner, string segment)
            {
                ...
                if (flag)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(new InvalidOperationException(SR2.GetString(SR2.UTStarVariableWithDefaults, new object[] { owner.originalTemplate, segment, this.varName })));
                }
                this.owner = owner;
            }
            ...
            internal bool HasVariable =>
                !string.IsNullOrEmpty(this.varName);
        }
    }
}
