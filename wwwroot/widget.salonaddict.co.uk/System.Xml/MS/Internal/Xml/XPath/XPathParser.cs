namespace MS.Internal.Xml.XPath
{
    ...
    internal class XPathParser
    {
        ...
        private static bool IsPrimaryExpr(XPathScanner scanner) => 
            ((((scanner.Kind == XPathScanner.LexKind.String) || (scanner.Kind == XPathScanner.LexKind.Number)) || ((scanner.Kind == XPathScanner.LexKind.Dollar) || (scanner.Kind == XPathScanner.LexKind.LParens))) || (((scanner.Kind == XPathScanner.LexKind.Name) && scanner.CanBeFunction) && !IsNodeType(scanner)));
        ...
        private bool TestOp(string op) => 
            (((this.scanner.Kind == XPathScanner.LexKind.Name) && (this.scanner.Prefix.Length == 0)) && this.scanner.Name.Equals(op));
