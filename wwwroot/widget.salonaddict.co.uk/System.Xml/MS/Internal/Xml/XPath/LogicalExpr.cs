namespace MS.Internal.Xml.XPath
{
    ...
    internal sealed class LogicalExpr : ValueQuery
    {
        ...
        {
            Operator.Op[] opArray = new Operator.Op[6];
            opArray[0] = Operator.Op.GT;
            opArray[2] = Operator.Op.GE;
            opArray[3] = Operator.Op.LE;
            opArray[4] = Operator.Op.EQ;
            opArray[5] = Operator.Op.NE;
            this.invertOp = opArray;
            this.op = other.op;
        ...
        private static bool cmpBoolStringO(Operator.Op op, object val1, object val2) => 
            cmpNumberNumberO(op, NumberFunctions.Number((bool) val1), NumberFunctions.Number((string) val2));
        ...
        private static bool cmpRtfBoolO(Operator.Op op, object val1, object val2) => 
            cmpNumberNumberO(op, NumberFunctions.Number(Rtf(val1)), NumberFunctions.Number((bool) val2));
