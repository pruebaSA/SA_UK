namespace MS.Internal.Xml.Cache
{
    ...
    internal sealed class XPathDocumentNavigator : XPathNavigator, IXmlLineInfo
    {
        ...
        public override XPathNavigator Clone() => 
            new XPathDocumentNavigator(this.pageCurrent, this.idxCurrent, this.pageParent, this.idxParent);
        ...
        public bool HasLineInfo() => 
            this.pageCurrent[this.idxCurrent].Document.HasLineInfo;

        public bool IsContentKindMatch(XPathNodeType typ) => 
            (((((int) 1) << this.pageCurrent[this.idxCurrent].NodeType) & XPathNavigator.GetContentKindMask(typ)) != 0);
        ...
        public bool IsKindMatch(XPathNodeType typ) => 
            (((((int) 1) << this.pageCurrent[this.idxCurrent].NodeType) & XPathNavigator.GetKindMask(typ)) != 0);
        ...
        public override bool MoveToNext() => 
            XPathNodeHelper.GetContentSibling(ref this.pageCurrent, ref this.idxCurrent);

        public override bool MoveToNext(XPathNodeType type) => 
            XPathNodeHelper.GetContentSibling(ref this.pageCurrent, ref this.idxCurrent, type);
        ...
        public override bool MoveToNextAttribute() => 
            XPathNodeHelper.GetNextAttribute(ref this.pageCurrent, ref this.idxCurrent);
        ...
        public override XPathNodeIterator SelectChildren(XPathNodeType type) => 
            new XPathDocumentKindChildIterator(this, type);
        ...
        public override XPathNodeIterator SelectDescendants(XPathNodeType type, bool matchSelf) => 
            new XPathDocumentKindDescendantIterator(this, type, matchSelf);
        ...
        public override bool HasAttributes =>
            this.pageCurrent[this.idxCurrent].HasAttribute;

        public override bool HasChildren =>
            this.pageCurrent[this.idxCurrent].HasContentChild;

        public override bool IsEmptyElement =>
            this.pageCurrent[this.idxCurrent].AllowShortcutTag;
        ...
        public override string LocalName =>
            this.pageCurrent[this.idxCurrent].LocalName;

        public override string Name =>
            this.pageCurrent[this.idxCurrent].Name;

        public override string NamespaceURI =>
            this.pageCurrent[this.idxCurrent].NamespaceUri;

        public override XmlNameTable NameTable =>
            this.pageCurrent[this.idxCurrent].Document.NameTable;

        public override XPathNodeType NodeType =>
            this.pageCurrent[this.idxCurrent].NodeType;

        public override string Prefix =>
            this.pageCurrent[this.idxCurrent].Prefix;
