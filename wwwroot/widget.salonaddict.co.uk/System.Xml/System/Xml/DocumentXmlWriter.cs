namespace System.Xml
{
    ...
    internal sealed class DocumentXmlWriter : XmlRawWriter, IXmlNamespaceResolver
    {
        ...
        static DocumentXmlWriter()
        {
            ...
            stateArray[0x35] = State.Content;
            stateArray[0x36] = State.Content;
            stateArray[0x39] = State.Prolog;
        ...
        string IXmlNamespaceResolver.LookupNamespace(string prefix) => 
            this.namespaceManager.LookupNamespace(prefix);
        ...
        internal override void WriteNamespaceDeclaration(string prefix, string ns)
        {
            ...
            this.VerifyState(Method.WriteNamespaceDeclaration);
            if (prefix.Length == 0)
            {
