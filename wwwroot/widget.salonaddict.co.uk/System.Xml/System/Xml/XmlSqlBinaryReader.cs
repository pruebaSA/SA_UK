    ...
    internal sealed class XmlSqlBinaryReader : XmlReader, IXmlNamespaceResolver
    {
        ...
        private unsafe XmlNodeType CheckText(bool attr)
        {
            ...
            Label_0076:
                ...
                {
                    if ((index < 0xd800) || (index > 0xdbff))
                    {
                        throw XmlConvert.CreateInvalidCharException(index, ExceptionType.XmlException);
                    }
                    if ((tokDataPos + 4) > num)
                    {
                        throw this.ThrowXmlException("Xml_InvalidSurrogateMissingLowChar");
                    }
                    char hi = (char) (numRef[tokDataPos + 2] | (numRef[tokDataPos + 3] << 8));
                    if ((hi < 0xdc00) || (hi > 0xdfff))
                    {
                        throw XmlConvert.CreateInvalidSurrogatePairException(index, hi);
                    }
                    tokDataPos += 4;
                }
                goto Label_0076;
        ...
        private XmlValueConverter GetValueConverter(XmlTypeCode typeCode) => 
            DatatypeImplementation.GetSimpleTypeFromTypeCode(typeCode).ValueConverter;
            ...
            switch (token)
            {
                ...
                case BinXmlToken.SQL_TEXT:
                    ...
                    if (checkChars && this.checkCharacters)
                    {
                        ...
                        XmlConvert.VerifyCharData(data, ExceptionType.XmlException);
        ...
        private Exception ThrowUnexpectedToken(BinXmlToken token) => 
            this.ThrowXmlException("XmlBinary_UnexpectedToken");
        ...
        public override string LocalName =>
            this.qnameOther.localname;

        public override string NamespaceURI =>
            this.qnameOther.namespaceUri;
        ...
        public override string Prefix =>
            this.qnameOther.prefix;

        public override System.Xml.ReadState ReadState =>
            ScanState2ReadState[(int) this.state];
        ...
        private struct AttrInfo
        {
            ...
            public bool MatchNS(string localname, string namespaceUri) => 
                this.name.MatchNs(localname, namespaceUri);

            public bool MatchHashNS(int hash, string localname, string namespaceUri) => 
                ((this.hashCode == hash) && this.name.MatchNs(localname, namespaceUri));
        ...
        internal struct QName
        {
            ...
            public bool MatchNs(string lname, string nsUri) => 
                ((lname == this.localname) && (nsUri == this.namespaceUri));

            public bool MatchPrefix(string prefix, string lname) => 
                ((lname == this.localname) && (prefix == this.prefix));
            ...
            public int GetNSHashCode(SecureStringHasher hasher) => 
                (hasher.GetHashCode(this.namespaceUri) ^ hasher.GetHashCode(this.localname));
            ...
            public static bool operator ==(XmlSqlBinaryReader.QName a, XmlSqlBinaryReader.QName b) => 
                (((a.prefix == b.prefix) && (a.localname == b.localname)) && (a.namespaceUri == b.namespaceUri));
