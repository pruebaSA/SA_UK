    ...
    public abstract class XmlNode : ICloneable, IEnumerable, IXPathNavigable
    {
        ...
        public XmlNode SelectSingleNode(string xpath, XmlNamespaceManager nsmgr)
        {
            ...
            if (navigator != null)
            {
                XPathExpression expr = navigator.Compile(xpath);
                expr.SetContext(nsmgr);
                XmlNodeList list = new XPathNodeList(navigator.Select(expr));
                if (list.Count > 0)
                {
                    return list[0];
                }
        ...
        public virtual XmlNodeList ChildNodes =>
            new XmlChildNodes(this);

        private object debuggerDisplayProxy =>
            new DebuggerDisplayXmlNodeProxy(this);
        ...
        public virtual IXmlSchemaInfo SchemaInfo =>
            XmlDocument.NotKnownSchemaInfo;
        ...
        internal virtual System.Xml.XmlSpace XmlSpace
        {
            get
            {
                ...
                do
                {
                    ...
                    {
                        string attribute = element.GetAttribute("xml:space");
