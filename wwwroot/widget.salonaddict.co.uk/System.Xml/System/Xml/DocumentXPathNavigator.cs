namespace System.Xml
{
    ...
    internal sealed class DocumentXPathNavigator : XPathNavigator, IHasXmlNode
    {
        ...
        public override XPathNavigator Clone() => 
            new DocumentXPathNavigator(this);
        ...
        public override string GetAttribute(string localName, string namespaceURI) => 
            this.source.GetXPAttribute(localName, namespaceURI);
                ...
                switch (scope)
                {
                    ...
                    case XPathNamespaceScope.ExcludeXml:
                        ...
                        if (MoveToFirstNamespaceGlobal(ref attributes, ref index))
                        {
                            ...
                            while (object.Equals(attribute.LocalName, this.document.strXml))
                            {
                ...
                if (CheckAttributePosition(source, out attributes, attributeIndex) || ResetAttributePosition(source, attributes, out attributeIndex))
                {
                    switch (scope)
                    {
                        ...
                        case XPathNamespaceScope.ExcludeXml:
                            ...
                            while (this.PathHasDuplicateNamespace(source.OwnerElement, this.namespaceParent, localName) || object.Equals(localName, this.document.strXml));
                            this.source = source;
                            this.attributeIndex = attributeIndex;
                            goto Label_014A;
