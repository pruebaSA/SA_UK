namespace System.Xml
{
    ...
    public class XmlElement : XmlLinkedNode
    {
        ...
        public virtual bool HasAttribute(string name) => 
            (this.GetAttributeNode(name) != null);

        public virtual bool HasAttribute(string localName, string namespaceURI) => 
            (this.GetAttributeNode(localName, namespaceURI) != null);
        ...
        {
            XmlNode node = e;
            XmlNode nextSibling = e;
        Label_0004:
            e = nextSibling as XmlElement;
            ...
            nextSibling.WriteTo(writer);
        Label_0067:
            while ((nextSibling != node) && (nextSibling == nextSibling.ParentNode.LastChild))
            {
