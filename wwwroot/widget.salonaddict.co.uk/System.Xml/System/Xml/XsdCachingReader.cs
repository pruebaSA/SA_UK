namespace System.Xml
{
    ...
    internal class XsdCachingReader : XmlReader, IXmlLineInfo
    {
        ...
        public override string LookupNamespace(string prefix) => 
            this.coreReader.LookupNamespace(prefix);
        ...
        public override int Depth =>
            this.cachedNode.Depth;

        public override bool EOF =>
            ((this.cacheState == CachingReaderState.ReaderClosed) && this.coreReader.EOF);

        public override bool HasValue =>
            XmlReader.HasValueInternal(this.cachedNode.NodeType);
        ...
        public override string LocalName =>
            this.cachedNode.LocalName;

        public override string Name =>
            this.cachedNode.GetAtomizedNameWPrefix(this.coreReaderNameTable);

        public override string NamespaceURI =>
            this.cachedNode.Namespace;

        public override XmlNameTable NameTable =>
            this.coreReaderNameTable;

        public override XmlNodeType NodeType =>
            this.cachedNode.NodeType;

        public override string Prefix =>
            this.cachedNode.Prefix;

        public override char QuoteChar =>
            this.coreReader.QuoteChar;

        public override System.Xml.ReadState ReadState =>
            this.coreReader.ReadState;

        public override XmlReaderSettings Settings =>
            this.coreReader.Settings;

        int IXmlLineInfo.LineNumber =>
            this.cachedNode.LineNumber;

        int IXmlLineInfo.LinePosition =>
            this.cachedNode.LinePosition;
