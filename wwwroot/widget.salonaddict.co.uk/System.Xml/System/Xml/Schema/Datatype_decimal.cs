namespace System.Xml.Schema
{
    ...
    internal class Datatype_decimal : Datatype_anySimpleType
    {
        ...
        internal override XmlValueConverter CreateValueConverter(XmlSchemaType schemaType) => 
            XmlNumeric10Converter.Create(schemaType);
        ...
        internal override RestrictionFlags ValidRestrictionFlags =>
            (RestrictionFlags.FractionDigits | RestrictionFlags.TotalDigits | RestrictionFlags.MinExclusive | RestrictionFlags.MinInclusive | RestrictionFlags.MaxExclusive | RestrictionFlags.MaxInclusive | RestrictionFlags.WhiteSpace | RestrictionFlags.Enumeration | RestrictionFlags.Pattern);
