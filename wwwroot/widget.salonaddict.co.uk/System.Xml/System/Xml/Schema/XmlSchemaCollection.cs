namespace System.Xml.Schema
{
    ...
    public sealed class XmlSchemaCollection : ICollection, IEnumerable
    {
        ...
        public XmlSchema Add(XmlSchema schema) => 
            this.Add(schema, this.xmlResolver);
        ...
        public XmlSchema Add(string ns, XmlReader reader) => 
            this.Add(ns, reader, this.xmlResolver);
        ...
        internal XmlSchema Add(string ns, SchemaInfo schemaInfo, XmlSchema schema, bool compile) => 
            this.Add(ns, schemaInfo, schema, compile, this.xmlResolver);
        ...
        public bool Contains(string ns) => 
            (this.collection[(ns != null) ? ns : string.Empty] != null);
        ...
        public XmlSchemaCollectionEnumerator GetEnumerator() => 
            new XmlSchemaCollectionEnumerator(this.collection);
