namespace System.Xml.Schema
{
    ...
    internal struct XsdDateTime
    {
        ...
        private DateTimeTypeCode InternalTypeCode =>
            ((DateTimeTypeCode) ((this.extra & -16777216) >> 0x18));
        private XsdDateTimeKind InternalKind =>
            ((XsdDateTimeKind) ((this.extra & 0xff0000) >> 0x10));
        public XmlTypeCode TypeCode =>
            typeCodes[(int) this.InternalTypeCode];
        ...
        public static implicit operator DateTimeOffset(XsdDateTime xdt)
        {
            ...
            return new DateTimeOffset(dt, TimeZone.CurrentTimeZone.GetUtcOffset(dt));
        }
        ...
        private struct Parser
        {
            ...
            private bool ParseDate(int start) => 
                (((((this.Parse4Dig(start, ref this.year) && (1 <= this.year)) && (this.ParseChar(start + XsdDateTime.Lzyyyy, '-') && this.Parse2Dig(start + XsdDateTime.Lzyyyy_, ref this.month))) && (((1 <= this.month) && (this.month <= 12)) && (this.ParseChar(start + XsdDateTime.Lzyyyy_MM, '-') && this.Parse2Dig(start + XsdDateTime.Lzyyyy_MM_, ref this.day)))) && (1 <= this.day)) && (this.day <= DateTime.DaysInMonth(this.year, this.month)));

            private bool ParseTimeAndZoneAndWhitespace(int start) => 
                (this.ParseTime(ref start) && this.ParseZoneAndWhitespace(start));
            ...
            private bool ParseChar(int start, char ch) => 
                ((start < this.length) && (this.text[start] == ch));
