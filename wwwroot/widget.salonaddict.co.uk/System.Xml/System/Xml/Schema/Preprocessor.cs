    ...
    internal sealed class Preprocessor : BaseProcessor
    {
        ...
        private int CountGroupSelfReference(XmlSchemaObjectCollection items, XmlQualifiedName name, XmlSchemaGroup redefined)
        {
            ...
            foreach (XmlSchemaParticle particle in items)
            {
                ...
                {
                    num += this.CountGroupSelfReference(((XmlSchemaGroupBase) particle).Items, name, redefined);
                }
                if (num > 1)
                {
                    return num;
        ...
        public bool Execute(XmlSchema schema, string targetNamespace, bool loadExternals)
        {
            ...
            try
            {
                ...
                {
                    foreach (RedefineEntry entry in this.redefinedList)
                    {
                        this.PreprocessRedefine(entry);
                    }
                }
            }
            finally
        ...
        private object GetSchemaEntity(Uri ruri) => 
            this.xmlResolver.GetEntity(ruri, null, null);
        ...
        private void LoadExternals(XmlSchema schema)
        {
            if (!schema.IsProcessing)
            {
                ...
                {
                    Uri key = null;
                    XmlSchema xmlSchema = external.Schema;
                    if (xmlSchema != null)
                    {
                    ...
                    else
                    {
                        ...
                        if (external.Compositor == System.Xml.Schema.Compositor.Import)
                        {
                            XmlSchemaImport import = external as XmlSchemaImport;
                            ...
                            {
                                external.Schema = GetBuildInSchema();
                                goto Label_0391;
                            }
                        }
                        if (ruri == null)
                        {
                            if (schemaLocation != null)
                            {
                                base.SendValidationEvent(new XmlSchemaException("Sch_InvalidIncludeLocation", null, innerException, external.SourceUri, external.LineNumber, external.LinePosition, external), XmlSeverityType.Warning);
                            }
                        }
                        else if (this.schemaLocations[ruri] == null)
                        {
                            ...
                            if (schemaEntity != null)
                            {
                                ...
                                {
                                    external.Schema = (XmlSchema) schemaEntity;
                                    this.schemaLocations.Add(ruri, external.Schema);
                                    this.LoadExternals(external.Schema);
                                    goto Label_0391;
                                }
                                ...
                                try
                                {
                                    ...
                                    {
                                        base.SendValidationEvent(new XmlSchemaException("Sch_InvalidIncludeLocation", null, exception5, external.SourceUri, external.LineNumber, external.LinePosition, external), XmlSeverityType.Warning);
                                    }
                                    goto Label_0391;
                                }
                                finally
                        ...
                        {
                            external.Schema = (XmlSchema) this.schemaLocations[ruri];
                        }
                    Label_0391:;
                    }
                }
        ...
        private void Preprocess(XmlSchema schema, string targetNamespace, ArrayList imports)
        {
            ...
            if (!schema.IsProcessing)
            {
                ...
                {
                    string str3;
                    XmlSchema chameleonSchema = external.Schema;
                    this.SetParent(external, schema);
                    this.PreprocessAnnotation(external);
                    string schemaLocation = external.SchemaLocation;
                    if (schemaLocation != null)
                    {
                        this.ParseUri(schemaLocation, "Sch_InvalidSchemaLocation", external);
                    }
                    else if (((external.Compositor == System.Xml.Schema.Compositor.Include) || (external.Compositor == System.Xml.Schema.Compositor.Redefine)) && (external.Schema == null))
                    {
                    ...
                    switch (external.Compositor)
                    {
                        ...
                        {
                            XmlSchemaImport source = external as XmlSchemaImport;
                    ...
                    if (str3 != null)
                    {
                        if (str3.Length == 0)
                        {
                            base.SendValidationEvent("Sch_InvalidNamespaceAttribute", str3, external);
                        }
                        else
                        {
                            this.ParseUri(str3, "Sch_InvalidNamespace", external);
                        }
                    }
                    continue;
                Label_024E:
                    if (chameleonSchema.TargetNamespace != null)
                    {
                        ...
                        {
                            base.SendValidationEvent("Sch_MismatchTargetNamespaceInclude", chameleonSchema.TargetNamespace, schema.TargetNamespace, external);
                        }
                    }
                    else if ((targetNamespace != null) && (targetNamespace.Length != 0))
                    {
                        chameleonSchema = this.GetChameleonSchema(targetNamespace, chameleonSchema);
                        external.Schema = chameleonSchema;
                    }
                ...
                {
                    XmlSchemaExternal external2 = (XmlSchemaExternal) schema.Includes[i];
                    ...
                    else if (external2.Compositor == System.Xml.Schema.Compositor.Redefine)
                    {
                        ...
                        {
                            using (XmlSchemaObjectEnumerator enumerator2 = redefine.Items.GetEnumerator())
                            {
                ...
                foreach (XmlSchemaObject obj4 in schema.Items)
                {
                    this.SetParent(obj4, schema);
                    if (obj4 is XmlSchemaAttribute)
                    {
                        XmlSchemaAttribute attribute = (XmlSchemaAttribute) obj4;
                        this.PreprocessAttribute(attribute);
                        base.AddToTable(schema.Attributes, attribute.QualifiedName, attribute);
                    }
                    else if (obj4 is XmlSchemaAttributeGroup)
                    {
                        XmlSchemaAttributeGroup attributeGroup = (XmlSchemaAttributeGroup) obj4;
                    ...
                    else if (obj4 is XmlSchemaComplexType)
                    {
                        XmlSchemaComplexType complexType = (XmlSchemaComplexType) obj4;
                        this.PreprocessComplexType(complexType, false);
                        base.AddToTable(schema.SchemaTypes, complexType.QualifiedName, complexType);
                    }
                    else if (obj4 is XmlSchemaSimpleType)
                    {
                        XmlSchemaSimpleType simpleType = (XmlSchemaSimpleType) obj4;
                        this.PreprocessSimpleType(simpleType, false);
                        base.AddToTable(schema.SchemaTypes, simpleType.QualifiedName, simpleType);
                    }
                    else if (obj4 is XmlSchemaElement)
                    {
                        XmlSchemaElement element = (XmlSchemaElement) obj4;
                        this.PreprocessElement(element);
                        base.AddToTable(schema.Elements, element.QualifiedName, element);
                    }
                    else if (obj4 is XmlSchemaGroup)
                    {
                        XmlSchemaGroup group = (XmlSchemaGroup) obj4;
                        this.PreprocessGroup(group);
                        base.AddToTable(schema.Groups, group.QualifiedName, group);
                    }
                    else if (obj4 is XmlSchemaNotation)
                    {
                        XmlSchemaNotation notation = (XmlSchemaNotation) obj4;
                        this.PreprocessNotation(notation);
                        base.AddToTable(schema.Notations, notation.QualifiedName, notation);
                    }
                    else if (obj4 is XmlSchemaAnnotation)
                    {
                        this.PreprocessAnnotation(obj4 as XmlSchemaAnnotation);
                    }
                    else
                    {
                        base.SendValidationEvent("Sch_InvalidCollection", obj4);
                        list.Add(obj4);
                    }
                }
                foreach (XmlSchemaObject obj5 in list)
                {
                    schema.Items.Remove(obj5);
                }
            }
        }
        ...
        private void PreprocessAnnotation(XmlSchemaAnnotation annotation)
        {
            ...
            using (XmlSchemaObjectEnumerator enumerator = annotation.Items.GetEnumerator())
            {
                while (enumerator.MoveNext())
                {
                    enumerator.Current.Parent = annotation;
                }
            }
        }
        ...
        private void PreprocessRedefine(RedefineEntry redefineEntry)
        {
            ...
            else
            {
                ...
                foreach (XmlSchemaObject obj2 in currentSchemaObject.Items)
                {
                    this.SetParent(obj2, currentSchemaObject);
