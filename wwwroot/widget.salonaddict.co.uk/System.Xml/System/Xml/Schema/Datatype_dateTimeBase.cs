namespace System.Xml.Schema
{
    ...
    internal class Datatype_dateTimeBase : Datatype_anySimpleType
    {
        ...
        internal override XmlValueConverter CreateValueConverter(XmlSchemaType schemaType) => 
            XmlDateTimeConverter.Create(schemaType);
        ...
        internal override Exception TryParseValue(string s, XmlNameTable nameTable, IXmlNamespaceResolver nsmgr, out object typedValue)
        {
            ...
            if (exception == null)
            {
                ...
                {
                    return new FormatException(Res.GetString("XmlConvert_BadFormat", new object[] { s, "XsdDateTime" }));
                }
        ...
        internal override System.Xml.Schema.FacetsChecker FacetsChecker =>
            DatatypeImplementation.dateTimeFacetsChecker;
