namespace System.Xml.Schema
{
    ...
    public sealed class XmlSchemaValidator
    {
        ...
        private void AddIdentityConstraints()
        {
            ...
            foreach (ConstraintStruct struct2 in this.context.Constr)
            {
        ...
        internal static string BuildElementName(XmlQualifiedName qname) => 
            BuildElementName(qname.Name, qname.Namespace);
        ...
        private SchemaAttDef CheckIsXmlAttribute(XmlQualifiedName attQName)
        {
            ...
            return (SchemaAttDef) this.compiledSchemaInfo.AttributeDecls[attQName];
        }
                ...
                switch (dtype.TokenizedType)
                {
                    ...
                    case XmlTokenizedType.IDREF:
                        if (dtype.Variety == XmlSchemaDatatypeVariety.List)
                        {
                            ...
                            {
                                this.ProcessTokenizedType(dtype.TokenizedType, str, attrValue);
                            }
                            return;
                        }
        ...
        private SchemaElementDecl CheckXsiTypeAndNil(SchemaElementDecl elementDecl, string xsiType, string xsiNil, ref bool declFound)
        {
            ...
            if (xsiType != null)
            {
                ...
                if (innerException != null)
                {
                    this.SendValidationEvent(new XmlSchemaException("Sch_InvalidValueDetailed", new string[] { xsiType, dtQName.TypeCodeString, innerException.Message }, innerException, null, 0, 0, null));
                }
                else
                {
        ...
        internal static void CompleteValidationError(ValidationState context, System.Xml.Schema.ValidationEventHandler eventHandler, object sender, string sourceUri, int lineNo, int linePos, bool getParticles)
        {
            ...
            if (context.ElementDecl != null)
            {
                if (getParticles)
                {
                    expected = context.ElementDecl.ContentValidator.ExpectedParticles(context, true);
                }
                else
                {
        ...
        private void ElementIdentityConstraints()
        {
            ...
            for (int i = this.startIDConstraint; i < this.validationStack.Length; i++)
            {
                if (((ValidationState) this.validationStack[i]).Constr != null)
                {
                    foreach (ConstraintStruct struct2 in ((ValidationState) this.validationStack[i]).Constr)
                    {
                        if (struct2.axisSelector.MoveToStartElement(localName, uRN))
                        {
                            struct2.axisSelector.PushKS(this.positionInfo.LineNumber, this.positionInfo.LinePosition);
                        }
                        foreach (LocatedActiveAxis axis in struct2.axisFields)
                        {
        ...
        internal static void ElementValidationError(XmlQualifiedName name, ValidationState context, System.Xml.Schema.ValidationEventHandler eventHandler, object sender, string sourceUri, int lineNo, int linePos, bool getParticles)
        {
            ArrayList expected = null;
            if (context.ElementDecl != null)
            {
                ...
                if ((contentType == XmlSchemaContentType.ElementOnly) || (((contentType == XmlSchemaContentType.Mixed) && (contentValidator != ContentValidator.Mixed)) && (contentValidator != ContentValidator.Any)))
                {
                    if (getParticles)
                    {
                        expected = contentValidator.ExpectedParticles(context, false);
                    }
                    else
                    {
            ...
            for (int i = this.validationStack.Length - 1; i >= this.startIDConstraint; i--)
            {
                if (((ValidationState) this.validationStack[i]).Constr != null)
                {
                    foreach (ConstraintStruct struct2 in ((ValidationState) this.validationStack[i]).Constr)
                    {
                        ...
                        if (struct2.axisSelector.EndElement(localName, uRN))
                        {
                            ...
                            switch (struct2.constraint.Role)
                            {
                                case CompiledIdentityConstraint.ConstraintRole.Unique:
                                    if (sequence.IsQualified())
                                    {
                                        ...
                                        this.SendValidationEvent(new XmlSchemaValidationException("Sch_DuplicateKey", new string[] { sequence.ToString(), struct2.constraint.name.ToString() }, this.sourceUriString, sequence.PosLine, sequence.PosCol));
                                    }
                                    break;
                                ...
                                case CompiledIdentityConstraint.ConstraintRole.Key:
                                    ...
                                    this.SendValidationEvent(new XmlSchemaValidationException("Sch_MissingKey", struct2.constraint.name.ToString(), this.sourceUriString, sequence.PosLine, sequence.PosCol));
                                    break;
        ...
        public XmlSchemaParticle[] GetExpectedParticles()
        {
            ...
            {
                ArrayList list = this.context.ElementDecl.ContentValidator.ExpectedParticles(this.context, false);
                if (list != null)
                {
                    return (list.ToArray(typeof(XmlSchemaParticle)) as XmlSchemaParticle[]);
                }
            }
            return EmptyParticleArray;
        }
        ...
        private XmlSchemaElement GetSchemaElement()
        {
            ...
            {
                XmlSchemaElement element = (XmlSchemaElement) elementDeclBeforeXsi.SchemaElement.Clone();
        ...
        internal void GetUnspecifiedDefaultAttributes(ArrayList defaultAttributes, bool createNodeData)
        {
            ...
            {
                foreach (SchemaAttDef def in elementDecl.DefaultAttDefs)
                {
        ...
        private object InternalValidateEndElement(XmlSchemaInfo schemaInfo, object typedValue)
        {
            ...
            if (elementDecl != null)
            {
                ...
                if (!this.context.IsNill && this.context.NeedValidateChildren)
                {
                    ...
                    {
                        CompleteValidationError(this.context, this.eventHandler, this.nsResolver, this.sourceUriString, this.positionInfo.LineNumber, this.positionInfo.LinePosition, true);
        ...
        private void ProcessEntity(string name)
        {
            if (this.checkEntity)
            {
                ...
                {
                    entity = (SchemaEntity) this.dtdSchemaInfo.GeneralEntities[new XmlQualifiedName(name)];
                }
                if (entity == null)
                {
        ...
        private void ProcessSchemaLocations(string xsiSchemaLocation, string xsiNoNamespaceSchemaLocation)
        {
            ...
            if (xsiSchemaLocation != null)
            {
                ...
                if (innerException != null)
                {
                    this.SendValidationEvent(new XmlSchemaException("Sch_InvalidValueDetailed", new string[] { xsiSchemaLocation, dtStringArray.TypeCodeString, innerException.Message }, innerException, null, 0, 0, null));
                    return;
                }
        ...
        Label_0409:
            ...
            if (schemaInfo != null)
            {
                ...
                schemaInfo.SchemaType = schemaAttribute?.AttributeSchemaType;
        ...
        Label_00AA:
            ...
            if (element == null)
            {
                ElementValidationError(elementName, this.context, this.eventHandler, this.nsResolver, this.sourceUriString, this.positionInfo.LineNumber, this.positionInfo.LinePosition, true);
                invalidElementInContext = true;
                this.processContents = this.context.ProcessContents = XmlSchemaContentProcessing.Skip;
            }
            return element;
        ...
        public object ValidateEndElement(XmlSchemaInfo schemaInfo) => 
            this.InternalValidateEndElement(schemaInfo, null);
                ...
                else
                {
                    switch (this.context.ElementDecl.ContentValidator.ContentType)
                    {
                        ...
                        case XmlSchemaContentType.ElementOnly:
                        {
                            ...
                            {
                                ArrayList expected = this.context.ElementDecl.ContentValidator.ExpectedParticles(this.context, false);
                                if ((expected == null) || (expected.Count == 0))
                                {
        ...
        internal XmlSchemaContentType CurrentContentType =>
            this.context.ElementDecl?.ContentValidator.ContentType;

        internal XmlSchemaContentProcessing CurrentProcessContents =>
            this.processContents;

        private bool HasIdentityConstraints =>
            (this.ProcessIdentityConstraints && (this.startIDConstraint != -1));
        ...
        internal bool ProcessIdentityConstraints =>
            ((this.validationFlags & XmlSchemaValidationFlags.ProcessIdentityConstraints) != XmlSchemaValidationFlags.None);

        internal bool ProcessInlineSchema =>
            ((this.validationFlags & XmlSchemaValidationFlags.ProcessInlineSchema) != XmlSchemaValidationFlags.None);
        ...
        internal bool ProcessSchemaLocation =>
            ((this.validationFlags & XmlSchemaValidationFlags.ProcessSchemaLocation) != XmlSchemaValidationFlags.None);

        internal bool ReportValidationWarnings =>
            ((this.validationFlags & XmlSchemaValidationFlags.ReportValidationWarnings) != XmlSchemaValidationFlags.None);
        ...
        private bool StrictlyAssessed =>
            ((((this.processContents == XmlSchemaContentProcessing.Strict) || (this.processContents == XmlSchemaContentProcessing.Lax)) && (this.context.ElementDecl != null)) && !this.context.ValidationSkipped);

        public object ValidationEventSender
        {
            get => 
                this.validationEventSender;
            set
            {
