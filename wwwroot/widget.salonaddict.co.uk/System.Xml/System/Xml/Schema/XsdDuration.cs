namespace System.Xml.Schema
{
    ...
    internal struct XsdDuration
    {
        ...
        public int Nanoseconds =>
            (((int) this.nanoseconds) & 0x7fffffff);
        public int Microseconds =>
            (this.Nanoseconds / 0x3e8);
        public int Milliseconds =>
            (this.Nanoseconds / 0xf4240);
        ...
        public TimeSpan ToTimeSpan() => 
            this.ToTimeSpan(DurationType.Duration);
        ...
        internal Exception TryToTimeSpan(out TimeSpan result) => 
            this.TryToTimeSpan(DurationType.Duration, out result);
        ...
        public override string ToString() => 
            this.ToString(DurationType.Duration);
        ...
        internal static Exception TryParse(string s, out XsdDuration result) => 
            TryParse(s, DurationType.Duration, out result);
