namespace System.Xml.Schema
{
    ...
    public class XmlSchemaObjectTable
    {
        ...
        public IDictionaryEnumerator GetEnumerator() => 
            new XSODictionaryEnumerator(this.entries, this.table.Count, EnumeratorType.DictionaryEntry);
        ...
        public ICollection Names =>
            new NamesCollection(this.entries, this.table.Count);

        public ICollection Values =>
            new ValuesCollection(this.entries, this.table.Count);
        ...
        internal class NamesCollection : ICollection, IEnumerable
        {
            ...
            public IEnumerator GetEnumerator() => 
                new XmlSchemaObjectTable.XSOEnumerator(this.entries, this.size, XmlSchemaObjectTable.EnumeratorType.Keys);

            public int Count =>
                this.size;

            public bool IsSynchronized =>
                ((ICollection) this.entries).IsSynchronized;

            public object SyncRoot =>
                ((ICollection) this.entries).SyncRoot;
        }
        ...
        internal class ValuesCollection : ICollection, IEnumerable
        {
            ...
            public IEnumerator GetEnumerator() => 
                new XmlSchemaObjectTable.XSOEnumerator(this.entries, this.size, XmlSchemaObjectTable.EnumeratorType.Values);
