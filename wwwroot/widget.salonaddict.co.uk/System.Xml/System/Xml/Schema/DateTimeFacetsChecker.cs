namespace System.Xml.Schema
{
    ...
    internal class DateTimeFacetsChecker : FacetsChecker
    {
        ...
        {
            foreach (DateTime time in enumeration)
            {
                if (datatype.Compare(value, time) == 0)
                {
                    return true;
                }
            }
        ...
        internal override bool MatchEnumeration(object value, ArrayList enumeration, XmlSchemaDatatype datatype) => 
            this.MatchEnumeration(datatype.ValueConverter.ToDateTime(value), enumeration, datatype);
    }
}
