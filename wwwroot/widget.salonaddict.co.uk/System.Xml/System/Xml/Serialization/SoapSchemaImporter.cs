namespace System.Xml.Serialization
{
    ...
    public class SoapSchemaImporter : SchemaImporter
    {
        ...
        public XmlTypeMapping ImportDerivedTypeMapping(XmlQualifiedName name, Type baseType, bool baseTypeCanBeIndirect)
        {
            ...
            return new XmlTypeMapping(base.Scope, new ElementAccessor { 
                IsSoap = true,
                Name = name.Name,
        ...
        public XmlMembersMapping ImportMembersMapping(string name, string ns, SoapSchemaMember member)
        {
            ...
            return new XmlMembersMapping(base.Scope, new ElementAccessor { 
                IsSoap = true,
                Name = name,
                Namespace = (mapping.Namespace != null) ? mapping.Namespace : ns,
                Mapping = mapping2,
                IsNullable = false,
                Form = XmlSchemaForm.Qualified
        ...
        public XmlMembersMapping ImportMembersMapping(string name, string ns, SoapSchemaMember[] members) => 
            this.ImportMembersMapping(name, ns, members, true);

        public XmlMembersMapping ImportMembersMapping(string name, string ns, SoapSchemaMember[] members, bool hasWrapperElement) => 
            this.ImportMembersMapping(name, ns, members, hasWrapperElement, null, false);
