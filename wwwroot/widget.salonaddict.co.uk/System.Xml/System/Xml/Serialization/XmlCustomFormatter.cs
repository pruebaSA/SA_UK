namespace System.Xml.Serialization
{
    ...
    internal class XmlCustomFormatter
    {
        ...
        internal static string FromDate(DateTime value) => 
            XmlConvert.ToString(value, "yyyy-MM-dd");
        ...
        internal static string FromTime(DateTime value) => 
            XmlConvert.ToString(DateTime.MinValue + value.TimeOfDay, "HH:mm:ss.fffffffzzzzzz");

        internal static string FromXmlName(string name) => 
            XmlConvert.EncodeName(name);

        internal static string FromXmlNCName(string ncName) => 
            XmlConvert.EncodeLocalName(ncName);

        internal static string FromXmlNmToken(string nmToken) => 
            XmlConvert.EncodeNmToken(nmToken);
        ...
        internal static char ToChar(string value) => 
            ((char) XmlConvert.ToUInt16(value));

        internal static DateTime ToDate(string value) => 
            ToDateTime(value, allDateFormats);
        ...
        internal static DateTime ToDateTime(string value, string[] formats) => 
            XmlConvert.ToDateTime(value, formats);
        ...
        internal static DateTime ToTime(string value) => 
            DateTime.ParseExact(value, allTimeFormats, DateTimeFormatInfo.InvariantInfo, DateTimeStyles.NoCurrentDateDefault | DateTimeStyles.AllowTrailingWhite | DateTimeStyles.AllowLeadingWhite);

        internal static string ToXmlName(string value) => 
            XmlConvert.DecodeName(CollapseWhitespace(value));
