namespace System.Xml.Serialization
{
    ...
    public abstract class CodeExporter
    {
        ...
        private bool EnableDataBinding =>
            ((this.options & CodeGenerationOptions.EnableDataBinding) != CodeGenerationOptions.None);
        ...
        internal bool GenerateProperties =>
            ((this.options & CodeGenerationOptions.GenerateProperties) != CodeGenerationOptions.None);
