namespace System.Xml.Serialization
{
    ...
    public class XmlSerializer
    {
        ...
        public object Deserialize(XmlReader xmlReader) => 
            this.Deserialize(xmlReader, (string) null);

        public object Deserialize(XmlReader xmlReader, string encodingStyle) => 
            this.Deserialize(xmlReader, encodingStyle, this.events);

        public object Deserialize(XmlReader xmlReader, XmlDeserializationEvents events) => 
            this.Deserialize(xmlReader, null, events);
        ...
        public object Deserialize(XmlReader xmlReader, string encodingStyle, XmlDeserializationEvents events)
        {
            ...
            catch
            {
                if (xmlReader is IXmlLineInfo)
                {
                    IXmlLineInfo info2 = (IXmlLineInfo) xmlReader;
                    throw new InvalidOperationException(Res.GetString("XmlSerializeErrorDetails", new object[] { info2.LineNumber.ToString(CultureInfo.InvariantCulture), info2.LinePosition.ToString(CultureInfo.InvariantCulture) }), null);
                }
        ...
        public static XmlSerializer[] FromMappings(XmlMapping[] mappings) => 
            FromMappings(mappings, (Type) null);
        ...
        internal static TempAssembly GenerateTempAssembly(XmlMapping xmlMapping) => 
            GenerateTempAssembly(xmlMapping, null, null);
        ...
        internal static TempAssembly GenerateTempAssembly(XmlMapping xmlMapping, Type type, string defaultNamespace, string location, Evidence evidence) => 
            new TempAssembly(new XmlMapping[] { xmlMapping }, new Type[] { type }, defaultNamespace, location, evidence);
        ...
        public static string GetXmlSerializerAssemblyName(Type type) => 
            GetXmlSerializerAssemblyName(type, null);
