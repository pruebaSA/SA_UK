namespace System.Xml.Serialization
{
    ...
    internal class StructMapping : TypeMapping, INameScope
    {
        ...
        internal StructMapping DerivedMappings =>
            this.derivedMappings;

        internal bool HasElements =>
            ((this.elements != null) && (this.elements.Values.Count > 0));
        ...
        internal bool IsFullyInitialized =>
            ((this.baseMapping != null) && (this.Members != null));
        ...
        {
            get => 
                (this.isSequence && !base.TypeDesc.IsRoot);
            set
            {
