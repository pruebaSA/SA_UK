namespace System.Xml.Serialization
{
    ...
    public abstract class XmlSerializationReader : XmlSerializationGeneratedCode
    {
        ...
        protected Exception CreateAbstractTypeException(string name, string ns) => 
            new InvalidOperationException(Res.GetString("XmlAbstractType", new object[] { name, ns, this.CurrentTag() }));
        ...
        protected Exception CreateBadDerivationException(string xsdDerived, string nsDerived, string xsdBase, string nsBase, string clrDerived, string clrBase) => 
            new InvalidOperationException(Res.GetString("XmlSerializableBadDerivation", new object[] { xsdDerived, nsDerived, xsdBase, nsBase, clrDerived, clrBase }));

        protected Exception CreateCtorHasSecurityException(string typeName) => 
            new InvalidOperationException(Res.GetString("XmlConstructorHasSecurityAttributes", new object[] { typeName }));

        protected Exception CreateInaccessibleConstructorException(string typeName) => 
            new InvalidOperationException(Res.GetString("XmlConstructorInaccessible", new object[] { typeName }));

        protected Exception CreateInvalidCastException(Type type, object value) => 
            this.CreateInvalidCastException(type, value, null);
        ...
        protected Exception CreateMissingIXmlSerializableType(string name, string ns, string clrType) => 
            new InvalidOperationException(Res.GetString("XmlSerializableMissingClrType", new object[] { name, ns, typeof(XmlIncludeAttribute).Name, clrType }));

        protected Exception CreateReadOnlyCollectionException(string name) => 
            new InvalidOperationException(Res.GetString("XmlReadOnlyCollection", new object[] { name }));

        protected Exception CreateUnknownConstantException(string value, Type enumType) => 
            new InvalidOperationException(Res.GetString("XmlUnknownConstant", new object[] { value, enumType.Name }));

        protected Exception CreateUnknownNodeException() => 
            new InvalidOperationException(Res.GetString("XmlUnknownNode", new object[] { this.CurrentTag() }));

        protected Exception CreateUnknownTypeException(XmlQualifiedName type) => 
            new InvalidOperationException(Res.GetString("XmlUnknownType", new object[] { type.Name, type.Namespace, this.CurrentTag() }));
        ...
        private byte[] ReadByteArray(bool isBase64)
        {
            ...
            foreach (byte[] buffer3 in list)
            {
                ...
                if (count > 0)
                {
                    System.Buffer.BlockCopy(buffer3, 0, dst, index, count);
                    index += count;
                    num4 -= count;
                }
            }
        ...
        protected object ReadReferencedElement() => 
            this.ReadReferencedElement(null, null);
        ...
        protected object ReadReferencingElement(out string fixupReference) => 
            this.ReadReferencingElement(null, null, out fixupReference);

        protected object ReadReferencingElement(string name, string ns, out string fixupReference) => 
            this.ReadReferencingElement(name, ns, false, out fixupReference);
        ...
        protected IXmlSerializable ReadSerializable(IXmlSerializable serializable) => 
            this.ReadSerializable(serializable, false);
        ...
        protected object ReadTypedPrimitive(XmlQualifiedName type) => 
            this.ReadTypedPrimitive(type, false);
        ...
        protected static Assembly ResolveDynamicAssembly(string assemblyFullName) => 
            DynamicAssemblies.Get(assemblyFullName);
        ...
        protected static byte[] ToByteArrayBase64(string value) => 
            XmlCustomFormatter.ToByteArrayBase64(value);
        ...
        protected static byte[] ToByteArrayHex(string value) => 
            XmlCustomFormatter.ToByteArrayHex(value);

        protected static char ToChar(string value) => 
            XmlCustomFormatter.ToChar(value);

        protected static DateTime ToDate(string value) => 
            XmlCustomFormatter.ToDate(value);

        protected static DateTime ToDateTime(string value) => 
            XmlCustomFormatter.ToDateTime(value);

        protected static long ToEnum(string value, Hashtable h, string typeName) => 
            XmlCustomFormatter.ToEnum(value, h, typeName, true);

        protected static DateTime ToTime(string value) => 
            XmlCustomFormatter.ToTime(value);

        protected static string ToXmlName(string value) => 
            XmlCustomFormatter.ToXmlName(value);

        protected static string ToXmlNCName(string value) => 
            XmlCustomFormatter.ToXmlNCName(value);

        protected static string ToXmlNmToken(string value) => 
            XmlCustomFormatter.ToXmlNmToken(value);

        protected static string ToXmlNmTokens(string value) => 
            XmlCustomFormatter.ToXmlNmTokens(value);

        protected XmlQualifiedName ToXmlQualifiedName(string value) => 
            this.ToXmlQualifiedName(value, this.DecodeName);
        ...
        {
            get => 
                (this.isReturnValue && !this.soap12);
            set
            {
