namespace System.Xml.Serialization
{
    ...
    public abstract class XmlSerializationWriter : XmlSerializationGeneratedCode
    {
        ...
        protected Exception CreateChoiceIdentifierValueException(string value, string identifier, string name, string ns) => 
            new InvalidOperationException(Res.GetString("XmlChoiceIdentifierMismatch", new object[] { value, identifier, name, ns }));

        protected Exception CreateInvalidAnyTypeException(object o) => 
            this.CreateInvalidAnyTypeException(o.GetType());

        protected Exception CreateInvalidAnyTypeException(Type type) => 
            new InvalidOperationException(Res.GetString("XmlIllegalAnyElement", new object[] { type.FullName }));

        protected Exception CreateInvalidChoiceIdentifierValueException(string type, string identifier) => 
            new InvalidOperationException(Res.GetString("XmlInvalidChoiceIdentifierValue", new object[] { type, identifier }));

        protected Exception CreateInvalidEnumValueException(object value, string typeName) => 
            new InvalidOperationException(Res.GetString("XmlUnknownConstant", new object[] { value, typeName }));

        protected Exception CreateMismatchChoiceException(string value, string elementName, string enumValue) => 
            new InvalidOperationException(Res.GetString("XmlChoiceMismatchChoiceException", new object[] { elementName, value, enumValue }));

        protected Exception CreateUnknownAnyElementException(string name, string ns) => 
            new InvalidOperationException(Res.GetString("XmlUnknownAnyElement", new object[] { name, ns }));

        protected Exception CreateUnknownTypeException(object o) => 
            this.CreateUnknownTypeException(o.GetType());
        ...
        protected static string FromByteArrayHex(byte[] value) => 
            XmlCustomFormatter.FromByteArrayHex(value);

        protected static string FromChar(char value) => 
            XmlCustomFormatter.FromChar(value);

        protected static string FromDate(DateTime value) => 
            XmlCustomFormatter.FromDate(value);

        protected static string FromDateTime(DateTime value) => 
            XmlCustomFormatter.FromDateTime(value);

        protected static string FromEnum(long value, string[] values, long[] ids) => 
            XmlCustomFormatter.FromEnum(value, values, ids, null);

        protected static string FromEnum(long value, string[] values, long[] ids, string typeName) => 
            XmlCustomFormatter.FromEnum(value, values, ids, typeName);

        protected static string FromTime(DateTime value) => 
            XmlCustomFormatter.FromTime(value);

        protected static string FromXmlName(string name) => 
            XmlCustomFormatter.FromXmlName(name);

        protected static string FromXmlNCName(string ncName) => 
            XmlCustomFormatter.FromXmlNCName(ncName);

        protected static string FromXmlNmToken(string nmToken) => 
            XmlCustomFormatter.FromXmlNmToken(nmToken);

        protected static string FromXmlNmTokens(string nmTokens) => 
            XmlCustomFormatter.FromXmlNmTokens(nmTokens);

        protected string FromXmlQualifiedName(XmlQualifiedName xmlQualifiedName) => 
            this.FromXmlQualifiedName(xmlQualifiedName, true);
        ...
        private XmlQualifiedName GetPrimitiveTypeName(Type type) => 
            this.GetPrimitiveTypeName(type, true);
        ...
        private bool IsIdDefined(object o) => 
            ((this.references != null) && this.references.Contains(o));
