namespace System.Xml.Serialization
{
    ...
    public class SoapReflectionImporter
    {
        ...
        public XmlMembersMapping ImportMembersMapping(string elementName, string ns, XmlReflectionMember[] members) => 
            this.ImportMembersMapping(elementName, ns, members, true, true, false);
        ...
        public XmlMembersMapping ImportMembersMapping(string elementName, string ns, XmlReflectionMember[] members, bool hasWrapperElement, bool writeAccessors) => 
            this.ImportMembersMapping(elementName, ns, members, hasWrapperElement, writeAccessors, false);

        public XmlMembersMapping ImportMembersMapping(string elementName, string ns, XmlReflectionMember[] members, bool hasWrapperElement, bool writeAccessors, bool validate) => 
            this.ImportMembersMapping(elementName, ns, members, hasWrapperElement, writeAccessors, validate, XmlMappingAccess.Write | XmlMappingAccess.Read);
        ...
        public XmlTypeMapping ImportTypeMapping(Type type) => 
            this.ImportTypeMapping(type, null);
        ...
        public XmlTypeMapping ImportTypeMapping(Type type, string defaultNamespace)
        {
            ...
            accessor.Name = accessor.Mapping.DefaultElementName;
            accessor.Namespace = (accessor.Mapping.Namespace == null) ? defaultNamespace : accessor.Mapping.Namespace;
            accessor.Form = XmlSchemaForm.Qualified;
        ...
        private TypeMapping ImportTypeMapping(TypeModel model, RecursionLimiter limiter) => 
            this.ImportTypeMapping(model, string.Empty, limiter);
