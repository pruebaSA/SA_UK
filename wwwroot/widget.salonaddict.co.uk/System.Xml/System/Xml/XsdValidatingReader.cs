namespace System.Xml
{
    ...
    internal class XsdValidatingReader : XmlReader, IXmlSchemaInfo, IXmlLineInfo, IXmlNamespaceResolver
    {
        ...
        private object InternalReadContentAsObject() => 
            this.InternalReadContentAsObject(false);
        ...
        private object InternalReadElementContentAsObject(out XmlSchemaType xmlType) => 
            this.InternalReadElementContentAsObject(out xmlType, false);
        ...
        public override string LookupNamespace(string prefix) => 
            this.thisNSResolver.LookupNamespace(prefix);
        ...
        private XmlSchemaInfo AttributeSchemaInfo =>
            this.attributePSVI.attributeSchemaInfo;
        ...
        private XmlSchemaType ElementXmlType =>
            this.xmlSchemaInfo.XmlType;

        public override bool EOF =>
            this.coreReader.EOF;

        public override bool HasValue =>
            ((this.validationState < ValidatingReaderState.None) || this.coreReader.HasValue);

        public override bool IsDefault =>
            ((this.validationState == ValidatingReaderState.OnDefaultAttribute) || this.coreReader.IsDefault);
