namespace System.Xml
{
    ...
    internal class XmlNodeReaderNavigator
    {
        ...
        public bool MoveToAttribute(string name) => 
            this.MoveToAttribute(name, string.Empty);
        ...
        public string BaseURI =>
            this.curNode.BaseURI;

        internal bool CreatedOnAttribute =>
            this.bCreatedOnAttribute;
        ...
        public bool IsDefault =>
            ((this.curNode.NodeType == XmlNodeType.Attribute) && !((XmlAttribute) this.curNode).Specified);

        public bool IsEmptyElement =>
            ((this.curNode.NodeType == XmlNodeType.Element) && ((XmlElement) this.curNode).IsEmpty);
        ...
        public string XmlLang =>
            this.curNode.XmlLang;

        public System.Xml.XmlSpace XmlSpace =>
            this.curNode.XmlSpace;
