namespace System.Xml
{
    ...
    internal sealed class XmlSubtreeReader : XmlWrappingReader, IXmlNamespaceResolver
    {
        ...
        private void AddNamespace(string prefix, string ns)
        {
            ...
            if (prefix.Length == 0)
            {
                this.nsAttributes[length].Set(XmlNodeType.Attribute, this.xmlns, string.Empty, this.xmlns, "http://www.w3.org/2000/xmlns/", ns);
            }
            else
            {
                this.nsAttributes[length].Set(XmlNodeType.Attribute, prefix, this.xmlns, this.xmlns + ":" + prefix, "http://www.w3.org/2000/xmlns/", ns);
            }
        ...
        public override string LookupNamespace(string prefix) => 
            ((IXmlNamespaceResolver) this).LookupNamespace(prefix);
        ...
        public override bool CanReadBinaryContent =>
            base.reader.CanReadBinaryContent;

        public override bool CanReadValueChunk =>
            base.reader.CanReadValueChunk;

        public override bool CanResolveEntity =>
            base.reader.CanResolveEntity;
        ...
        private bool InAttributeActiveState =>
            (0 != (0x62 & (((int) 1) << this.state)));

        private bool InNamespaceActiveState =>
            (0 != (0x7e2 & (((int) 1) << this.state)));

        public override int LineNumber
        {
            get
            {
                if ((base.readerAsIXmlLineInfo != null) && !this.useCurNode)
                {
                    return base.readerAsIXmlLineInfo.LineNumber;
                }
                return 0;
            }
        }
        ...
        public override int LinePosition
        {
            get
            {
                if ((base.readerAsIXmlLineInfo != null) && !this.useCurNode)
                {
                    return base.readerAsIXmlLineInfo.LinePosition;
                }
                return 0;
            }
        }
