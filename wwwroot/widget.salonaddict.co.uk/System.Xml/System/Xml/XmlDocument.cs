namespace System.Xml
{
    ...
    public class XmlDocument : XmlNode
    {
        ...
        internal XmlName AddXmlName(string prefix, string localName, string namespaceURI, IXmlSchemaInfo schemaInfo) => 
            this.domNameTable.AddName(prefix, localName, namespaceURI, schemaInfo);
        ...
        public virtual XmlAttribute CreateAttribute(string prefix, string localName, string namespaceURI) => 
            new XmlAttribute(this.AddAttrXmlName(prefix, localName, namespaceURI, null), this);
        ...
        public virtual XmlComment CreateComment(string data) => 
            new XmlComment(data, this);

        protected internal virtual XmlAttribute CreateDefaultAttribute(string prefix, string localName, string namespaceURI) => 
            new XmlUnspecifiedAttribute(prefix, localName, namespaceURI, this);

        public virtual XmlDocumentFragment CreateDocumentFragment() => 
            new XmlDocumentFragment(this);

        [PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust")]
        public virtual XmlDocumentType CreateDocumentType(string name, string publicId, string systemId, string internalSubset) => 
            new XmlDocumentType(name, publicId, systemId, internalSubset, this);
        ...
        public virtual XmlEntityReference CreateEntityReference(string name) => 
            new XmlEntityReference(name, this);

        public override XPathNavigator CreateNavigator() => 
            this.CreateNavigator(this);
        ...
        public virtual XmlNode CreateNode(string nodeTypeString, string name, string namespaceURI) => 
            this.CreateNode(this.ConvertToNodeType(nodeTypeString), name, namespaceURI);

        public virtual XmlNode CreateNode(XmlNodeType type, string name, string namespaceURI) => 
            this.CreateNode(type, null, name, namespaceURI);
        ...
        public virtual XmlProcessingInstruction CreateProcessingInstruction(string target, string data) => 
            new XmlProcessingInstruction(target, data, this);

        public virtual XmlSignificantWhitespace CreateSignificantWhitespace(string text) => 
            new XmlSignificantWhitespace(text, this);

        public virtual XmlText CreateTextNode(string text) => 
            new XmlText(text, this);

        public virtual XmlWhitespace CreateWhitespace(string text) => 
            new XmlWhitespace(text, this);

        public virtual XmlDeclaration CreateXmlDeclaration(string version, string encoding, string standalone) => 
            new XmlDeclaration(version, encoding, standalone, this);
        ...
        public virtual XmlNodeList GetElementsByTagName(string name) => 
            new XmlElementList(this, name);

        public virtual XmlNodeList GetElementsByTagName(string localName, string namespaceURI) => 
            new XmlElementList(this, localName, namespaceURI);
        ...
        private SchemaElementDecl GetSchemaElementDecl(XmlElement elem)
        {
            ...
            {
                XmlQualifiedName name = new XmlQualifiedName(elem.LocalName, (dtdSchemaInfo.SchemaType == SchemaType.DTD) ? elem.Prefix : elem.NamespaceURI);
                return (SchemaElementDecl) dtdSchemaInfo.ElementDecls[name];
            }
            return null;
        }

        internal XmlName GetXmlName(string prefix, string localName, string namespaceURI, IXmlSchemaInfo schemaInfo) => 
            this.domNameTable.GetName(prefix, localName, namespaceURI, schemaInfo);
        ...
        public virtual XmlNode ImportNode(XmlNode node, bool deep) => 
            this.ImportNodeInternal(node, deep);
        ...
        public XmlElement DocumentElement =>
            ((XmlElement) this.FindChild(XmlNodeType.Element));

        public virtual XmlDocumentType DocumentType =>
            ((XmlDocumentType) this.FindChild(XmlNodeType.DocumentType));
