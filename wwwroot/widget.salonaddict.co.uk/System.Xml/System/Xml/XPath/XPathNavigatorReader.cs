namespace System.Xml.XPath
{
    ...
    internal class XPathNavigatorReader : XmlReader, IXmlNamespaceResolver
    {
        ...
        public override string LookupNamespace(string prefix) => 
            this.nav.LookupNamespace(prefix);
        ...
        IDictionary<string, string> IXmlNamespaceResolver.GetNamespacesInScope(XmlNamespaceScope scope) => 
            this.nav.GetNamespacesInScope(scope);

        string IXmlNamespaceResolver.LookupNamespace(string prefix) => 
            this.nav.LookupNamespace(prefix);

        string IXmlNamespaceResolver.LookupPrefix(string namespaceName) => 
            this.nav.LookupPrefix(namespaceName);
        ...
        public override bool HasValue =>
            (((this.nodeType != XmlNodeType.Element) && (this.nodeType != XmlNodeType.Document)) && ((this.nodeType != XmlNodeType.EndElement) && (this.nodeType != XmlNodeType.None)));

        public override bool IsEmptyElement =>
            this.nav.IsEmptyElement;

        protected bool IsReading =>
            ((this.state > State.Initial) && (this.state < State.EOF));
        ...
        internal override XmlNamespaceManager NamespaceManager =>
            XPathNavigator.GetNamespaces(this);
