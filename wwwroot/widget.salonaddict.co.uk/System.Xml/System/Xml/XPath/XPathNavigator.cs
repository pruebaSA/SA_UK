namespace System.Xml.XPath
{
    ...
    public abstract class XPathNavigator : XPathItem, ICloneable, IXPathNavigable, IXmlNamespaceResolver
    {
        ...
        private XmlReader CreateReader() => 
            XPathNavigatorReader.Create(this);
        ...
        public virtual object Evaluate(string xpath) => 
            this.Evaluate(XPathExpression.Compile(xpath), null);

        public virtual object Evaluate(XPathExpression expr) => 
            this.Evaluate(expr, null);
        ...
        public virtual bool Matches(string xpath) => 
            this.Matches(CompileMatchPattern(xpath));
        ...
        public bool MoveToFirstNamespace() => 
            this.MoveToFirstNamespace(XPathNamespaceScope.All);

        public abstract bool MoveToFirstNamespace(XPathNamespaceScope namespaceScope);
        public virtual bool MoveToFollowing(XPathNodeType type) => 
            this.MoveToFollowing(type, null);

        public virtual bool MoveToFollowing(string localName, string namespaceURI) => 
            this.MoveToFollowing(localName, namespaceURI, null);
        ...
        public bool MoveToNextNamespace() => 
            this.MoveToNextNamespace(XPathNamespaceScope.All);
        ...
        public virtual XPathNodeIterator Select(string xpath) => 
            this.Select(XPathExpression.Compile(xpath));
        ...
        public virtual XPathNodeIterator Select(string xpath, IXmlNamespaceResolver resolver) => 
            this.Select(XPathExpression.Compile(xpath, resolver));

        public virtual XPathNodeIterator SelectAncestors(XPathNodeType type, bool matchSelf) => 
            new XPathAncestorIterator(this.Clone(), type, matchSelf);

        public virtual XPathNodeIterator SelectAncestors(string name, string namespaceURI, bool matchSelf) => 
            new XPathAncestorIterator(this.Clone(), name, namespaceURI, matchSelf);

        public virtual XPathNodeIterator SelectChildren(XPathNodeType type) => 
            new XPathChildIterator(this.Clone(), type);

        public virtual XPathNodeIterator SelectChildren(string name, string namespaceURI) => 
            new XPathChildIterator(this.Clone(), name, namespaceURI);

        public virtual XPathNodeIterator SelectDescendants(XPathNodeType type, bool matchSelf) => 
            new XPathDescendantIterator(this.Clone(), type, matchSelf);

        public virtual XPathNodeIterator SelectDescendants(string name, string namespaceURI, bool matchSelf) => 
            new XPathDescendantIterator(this.Clone(), name, namespaceURI, matchSelf);

        public virtual XPathNavigator SelectSingleNode(string xpath) => 
            this.SelectSingleNode(XPathExpression.Compile(xpath));
        ...
        public virtual XPathNavigator SelectSingleNode(string xpath, IXmlNamespaceResolver resolver) => 
            this.SelectSingleNode(XPathExpression.Compile(xpath, resolver));
        ...
        public override object ValueAs(Type returnType, IXmlNamespaceResolver nsResolver)
        {
            ...
            if (schemaInfo != null)
            {
                ...
                if (schemaInfo.Validity == XmlSchemaValidity.Valid)
                {
                    ...
                    return schemaType?.ValueConverter.ChangeType(this.Value, returnType, nsResolver);
                }
                schemaType = schemaInfo.SchemaType;
                if (schemaType != null)
                {
                    ...
                    if (datatype != null)
                    {
                        return schemaType.ValueConverter.ChangeType(datatype.ParseValue(this.Value, this.NameTable, nsResolver), returnType, nsResolver);
                    }
                }
            }
        ...
        public override bool ValueAsBoolean
        {
            get
            {
                ...
                if (schemaInfo != null)
                {
                    ...
                    {
                        schemaType = schemaInfo.MemberType;
                        return schemaType?.ValueConverter.ToBoolean(this.Value);
                    }
                    schemaType = schemaInfo.SchemaType;
                    if (schemaType != null)
                    {
                        ...
                        if (datatype != null)
                        {
                            return schemaType.ValueConverter.ToBoolean(datatype.ParseValue(this.Value, this.NameTable, this));
                        }
                    }
                }
        ...
        public override DateTime ValueAsDateTime
        {
            get
            {
                ...
                if (schemaInfo != null)
                {
                    ...
                    {
                        schemaType = schemaInfo.MemberType;
                        return schemaType?.ValueConverter.ToDateTime(this.Value);
                    }
                    schemaType = schemaInfo.SchemaType;
                    if (schemaType != null)
                    {
                        ...
                        if (datatype != null)
                        {
                            return schemaType.ValueConverter.ToDateTime(datatype.ParseValue(this.Value, this.NameTable, this));
                        }
                    }
                }
        ...
        public override double ValueAsDouble
        {
            get
            {
                ...
                if (schemaInfo != null)
                {
                    ...
                    {
                        schemaType = schemaInfo.MemberType;
                        return schemaType?.ValueConverter.ToDouble(this.Value);
                    }
                    schemaType = schemaInfo.SchemaType;
                    if (schemaType != null)
                    {
                        ...
                        if (datatype != null)
                        {
                            return schemaType.ValueConverter.ToDouble(datatype.ParseValue(this.Value, this.NameTable, this));
                        }
                    }
                }
        ...
        public override int ValueAsInt
        {
            get
            {
                ...
                if (schemaInfo != null)
                {
                    ...
                    {
                        schemaType = schemaInfo.MemberType;
                        return schemaType?.ValueConverter.ToInt32(this.Value);
                    }
                    schemaType = schemaInfo.SchemaType;
                    if (schemaType != null)
                    {
                        ...
                        if (datatype != null)
                        {
                            return schemaType.ValueConverter.ToInt32(datatype.ParseValue(this.Value, this.NameTable, this));
                        }
                    }
                }
        ...
        public override long ValueAsLong
        {
            get
            {
                ...
                if (schemaInfo != null)
                {
                    ...
                    {
                        schemaType = schemaInfo.MemberType;
                        return schemaType?.ValueConverter.ToInt64(this.Value);
                    }
                    schemaType = schemaInfo.SchemaType;
                    if (schemaType != null)
                    {
                        ...
                        if (datatype != null)
                        {
                            return schemaType.ValueConverter.ToInt64(datatype.ParseValue(this.Value, this.NameTable, this));
                        }
                    }
                }
