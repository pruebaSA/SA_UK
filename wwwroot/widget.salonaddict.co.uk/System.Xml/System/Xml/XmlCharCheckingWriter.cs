namespace System.Xml
{
    ...
    internal class XmlCharCheckingWriter : XmlWrappingWriter
    {
        ...
        private void ValidateQName(string name)
        {
            ...
            if (num2 != name.Length)
            {
                string str = ((num2 == 0) || ((num > -1) && (num2 == (num + 1)))) ? "Xml_BadStartNameChar" : "Xml_BadNameChar";
                throw new ArgumentException(Res.GetString(str, XmlException.BuildCharExceptionStr(name[num2])));
            }
        }
