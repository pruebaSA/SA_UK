<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="WeekView.aspx.cs" Inherits="IFRAME.WeekViewPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ph1c" runat="server">
    <asp:Panel ID="pnl" runat="server" SkinID="BoxPanel" >
        ...
        <IFRM:ViewTypes ID="cntlViewTypes" runat="server" SelectedView="Week" />
        ...
        <asp:Panel ID="pnlt" runat="server" SkinID="AvailableTimesPanel" >
            ...
            <div style="padding-bottom:5px;" >
                <IFRM:TimeSlotsGrid ID="DayTimes4" runat="server" OnTimeSelected="DayTimes_TimeSelected"/>
            </div>
            <div style="padding-bottom:5px;" >
                <IFRM:TimeSlotsGrid ID="DayTimes5" runat="server" OnTimeSelected="DayTimes_TimeSelected"/>
            </div>
            <div style="padding-bottom:5px;" >
                <IFRM:TimeSlotsGrid ID="DayTimes6" runat="server" OnTimeSelected="DayTimes_TimeSelected"/>
            </div>
            <div>
                <IFRM:TimeSlotsGrid ID="DayTimes7" runat="server" OnTimeSelected="DayTimes_TimeSelected"/>
            </div>
        </asp:Panel>
