namespace System.ComponentModel
{
    ...
    internal sealed class ExtendedPropertyDescriptor : PropertyDescriptor
    {
        ...
        public override bool CanResetValue(object comp) => 
            this.extenderInfo.ExtenderCanResetValue(this.provider, comp);

        public override object GetValue(object comp) => 
            this.extenderInfo.ExtenderGetValue(this.provider, comp);
        ...
        public override bool ShouldSerializeValue(object comp) => 
            this.extenderInfo.ExtenderShouldSerializeValue(this.provider, comp);

        public override Type ComponentType =>
            this.extenderInfo.ComponentType;
        ...
        public override Type PropertyType =>
            this.extenderInfo.ExtenderGetType(this.provider);
    }
}
