namespace System.ComponentModel
{
    ...
    public class PropertyDescriptorCollection : IList, IDictionary, ICollection, IEnumerable
    {
        ...
        public int IndexOf(PropertyDescriptor value) => 
            Array.IndexOf<PropertyDescriptor>(this.properties, value, 0, this.propCount);
        ...
        public virtual PropertyDescriptorCollection Sort() => 
            new PropertyDescriptorCollection(this.properties, this.propCount, this.namedSort, this.comparer);

        public virtual PropertyDescriptorCollection Sort(string[] names) => 
            new PropertyDescriptorCollection(this.properties, this.propCount, names, this.comparer);

        public virtual PropertyDescriptorCollection Sort(IComparer comparer) => 
            new PropertyDescriptorCollection(this.properties, this.propCount, this.namedSort, comparer);

        public virtual PropertyDescriptorCollection Sort(string[] names, IComparer comparer) => 
            new PropertyDescriptorCollection(this.properties, this.propCount, names, comparer);
        ...
        bool IDictionary.Contains(object key) => 
            ((key is string) && (this[(string) key] != null));

        IDictionaryEnumerator IDictionary.GetEnumerator() => 
            new PropertyDescriptorEnumerator(this);
        ...
        bool IList.Contains(object value) => 
            this.Contains((PropertyDescriptor) value);

        int IList.IndexOf(object value) => 
            this.IndexOf((PropertyDescriptor) value);
