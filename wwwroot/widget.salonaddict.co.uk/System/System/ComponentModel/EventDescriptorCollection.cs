namespace System.ComponentModel
{
    ...
    public class EventDescriptorCollection : IList, ICollection, IEnumerable
    {
        ...
        public int IndexOf(EventDescriptor value) => 
            Array.IndexOf<EventDescriptor>(this.events, value, 0, this.eventCount);
        ...
        public virtual EventDescriptorCollection Sort() => 
            new EventDescriptorCollection(this.events, this.eventCount, this.namedSort, this.comparer);

        public virtual EventDescriptorCollection Sort(string[] names) => 
            new EventDescriptorCollection(this.events, this.eventCount, names, this.comparer);

        public virtual EventDescriptorCollection Sort(IComparer comparer) => 
            new EventDescriptorCollection(this.events, this.eventCount, this.namedSort, comparer);

        public virtual EventDescriptorCollection Sort(string[] names, IComparer comparer) => 
            new EventDescriptorCollection(this.events, this.eventCount, names, comparer);
        ...
        int IList.Add(object value) => 
            this.Add((EventDescriptor) value);
        ...
        bool IList.Contains(object value) => 
            this.Contains((EventDescriptor) value);

        int IList.IndexOf(object value) => 
            this.IndexOf((EventDescriptor) value);
