namespace System.ComponentModel
{
    ...
    public sealed class TypeDescriptor
    {
        ...
        public static EventDescriptor CreateEvent(Type componentType, EventDescriptor oldEventDescriptor, params Attribute[] attributes) => 
            new ReflectEventDescriptor(componentType, oldEventDescriptor, attributes);

        [ReflectionPermission(SecurityAction.LinkDemand, Flags=ReflectionPermissionFlag.MemberAccess)]
        public static EventDescriptor CreateEvent(Type componentType, string name, Type type, params Attribute[] attributes) => 
            new ReflectEventDescriptor(componentType, name, type, attributes);
        ...
        public static PropertyDescriptor CreateProperty(Type componentType, string name, Type type, params Attribute[] attributes) => 
            new ReflectPropertyDescriptor(componentType, name, type, attributes);
        ...
        public static string GetClassName(object component) => 
            GetClassName(component, false);

        public static string GetClassName(Type componentType) => 
            GetDescriptor(componentType, "componentType").GetClassName();

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public static string GetClassName(object component, bool noCustomTypeDesc) => 
            GetDescriptor(component, noCustomTypeDesc).GetClassName();
        ...
        public static string GetComponentName(object component, bool noCustomTypeDesc) => 
            GetDescriptor(component, noCustomTypeDesc).GetComponentName();

        public static TypeConverter GetConverter(object component) => 
            GetConverter(component, false);

        public static TypeConverter GetConverter(Type type) => 
            GetDescriptor(type, "type").GetConverter();

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public static TypeConverter GetConverter(object component, bool noCustomTypeDesc) => 
            GetDescriptor(component, noCustomTypeDesc).GetConverter();
        ...
        public static object GetEditor(object component, Type editorBaseType) => 
            GetEditor(component, editorBaseType, false);
        ...
        public static EventDescriptorCollection GetEvents(object component) => 
            GetEvents(component, null, false);
        ...
        public static EventDescriptorCollection GetEvents(object component, bool noCustomTypeDesc) => 
            GetEvents(component, null, noCustomTypeDesc);

        public static EventDescriptorCollection GetEvents(object component, Attribute[] attributes) => 
            GetEvents(component, attributes, false);
        ...
        public static PropertyDescriptorCollection GetProperties(object component, bool noCustomTypeDesc) => 
            GetPropertiesImpl(component, null, noCustomTypeDesc, true);

        public static PropertyDescriptorCollection GetProperties(object component, Attribute[] attributes) => 
            GetProperties(component, attributes, false);
        ...
        public static PropertyDescriptorCollection GetProperties(object component, Attribute[] attributes, bool noCustomTypeDesc) => 
            GetPropertiesImpl(component, attributes, noCustomTypeDesc, false);
        ...
        private static TypeDescriptionNode NodeFor(Type type, bool createDelegator)
        {
            ...
            while (node == null)
            {
                node = (TypeDescriptionNode) _providerTypeTable[type2];
                if (node == null)
                {
                    node = (TypeDescriptionNode) _providerTable[type2];
                }
                if (node == null)
                {
        ...
        private static ICollection PipelineFilter(int pipelineType, ICollection members, object instance, IDictionary cache)
        {
            ...
            Hashtable attributes = new Hashtable(members.Count);
            switch (pipelineType)
            {
                case 0:
        ...
        public static Type ComObjectType =>
            typeof(TypeDescriptorComObject);
        ...
        private sealed class AttributeProvider : TypeDescriptionProvider
        {
            ...
            public override ICustomTypeDescriptor GetTypeDescriptor(Type objectType, object instance) => 
                new AttributeTypeDescriptor(this._attrs, base.GetTypeDescriptor(objectType, instance));
        ...
        private sealed class ComNativeDescriptionProvider : TypeDescriptionProvider
        {
            ...
            private sealed class ComNativeTypeDescriptor : ICustomTypeDescriptor
            {
                ...
                AttributeCollection ICustomTypeDescriptor.GetAttributes() => 
                    this._handler.GetAttributes(this._instance);

                string ICustomTypeDescriptor.GetClassName() => 
                    this._handler.GetClassName(this._instance);

                string ICustomTypeDescriptor.GetComponentName() => 
                    null;

                TypeConverter ICustomTypeDescriptor.GetConverter() => 
                    this._handler.GetConverter(this._instance);

                EventDescriptor ICustomTypeDescriptor.GetDefaultEvent() => 
                    this._handler.GetDefaultEvent(this._instance);

                PropertyDescriptor ICustomTypeDescriptor.GetDefaultProperty() => 
                    this._handler.GetDefaultProperty(this._instance);

                object ICustomTypeDescriptor.GetEditor(Type editorBaseType) => 
                    this._handler.GetEditor(this._instance, editorBaseType);

                EventDescriptorCollection ICustomTypeDescriptor.GetEvents() => 
                    this._handler.GetEvents(this._instance);

                EventDescriptorCollection ICustomTypeDescriptor.GetEvents(Attribute[] attributes) => 
                    this._handler.GetEvents(this._instance, attributes);

                PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties() => 
                    this._handler.GetProperties(this._instance, null);

                PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes) => 
                    this._handler.GetProperties(this._instance, attributes);
        ...
        private sealed class MemberDescriptorComparer : IComparer
        {
            ...
            public int Compare(object left, object right) => 
                string.Compare(((MemberDescriptor) left).Name, ((MemberDescriptor) right).Name, false, CultureInfo.InvariantCulture);
        }
        ...
        private sealed class TypeDescriptionNode : TypeDescriptionProvider
        {
            ...
            private struct DefaultExtendedTypeDescriptor : ICustomTypeDescriptor
            {
                ...
                string ICustomTypeDescriptor.GetComponentName()
                {
                    ...
                    return provider.GetExtendedTypeDescriptor(this._instance)?.GetComponentName();
                }
                ...
                EventDescriptor ICustomTypeDescriptor.GetDefaultEvent()
                {
                    ...
                    return provider.GetExtendedTypeDescriptor(this._instance)?.GetDefaultEvent();
                }
                ...
                PropertyDescriptor ICustomTypeDescriptor.GetDefaultProperty()
                {
                    ...
                    return provider.GetExtendedTypeDescriptor(this._instance)?.GetDefaultProperty();
                }
                ...
                object ICustomTypeDescriptor.GetEditor(Type editorBaseType)
                {
                    ...
                    return provider.GetExtendedTypeDescriptor(this._instance)?.GetEditor(editorBaseType);
                }
            ...
            private struct DefaultTypeDescriptor : ICustomTypeDescriptor
            {
                ...
                string ICustomTypeDescriptor.GetComponentName()
                {
                    ...
                    return provider.GetTypeDescriptor(this._objectType, this._instance)?.GetComponentName();
                }
                ...
                EventDescriptor ICustomTypeDescriptor.GetDefaultEvent()
                {
                    ...
                    return provider.GetTypeDescriptor(this._objectType, this._instance)?.GetDefaultEvent();
                }
                ...
                PropertyDescriptor ICustomTypeDescriptor.GetDefaultProperty()
                {
                    ...
                    return provider.GetTypeDescriptor(this._objectType, this._instance)?.GetDefaultProperty();
                }
                ...
                object ICustomTypeDescriptor.GetEditor(Type editorBaseType)
                {
                    ...
                    return provider.GetTypeDescriptor(this._objectType, this._instance)?.GetEditor(editorBaseType);
                }
