namespace System.ComponentModel
{
    ...
    public sealed class LicenseManager
    {
        ...
        public static object CreateWithContext(Type type, LicenseContext creationContext) => 
            CreateWithContext(type, creationContext, new object[0]);
        ...
        private static bool GetCachedNoLicenseProvider(Type type) => 
            ((providers != null) && providers.ContainsKey(type));
        ...
        private static RuntimeTypeHandle GetLicenseInteropHelperType() => 
            typeof(LicenseInteropHelper).TypeHandle;
        ...
        public static bool IsValid(Type type, object instance, out License license) => 
            ValidateInternal(type, instance, false, out license);
