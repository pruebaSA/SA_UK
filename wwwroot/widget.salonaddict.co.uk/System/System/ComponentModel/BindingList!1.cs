namespace System.ComponentModel
{
    ...
    public class BindingList<T> : Collection<T>, IBindingList, IList, ICollection, IEnumerable, ICancelAddNew, IRaiseItemChangedEvents
    {
        ...
        private bool AddingNewHandled =>
            ((this.onAddingNew != null) && (this.onAddingNew.GetInvocationList().Length > 0));
        ...
        ListSortDirection IBindingList.SortDirection =>
            this.SortDirectionCore;

        PropertyDescriptor IBindingList.SortProperty =>
            this.SortPropertyCore;

        bool IBindingList.SupportsChangeNotification =>
            this.SupportsChangeNotificationCore;

        bool IBindingList.SupportsSearching =>
            this.SupportsSearchingCore;

        bool IBindingList.SupportsSorting =>
            this.SupportsSortingCore;

        bool IRaiseItemChangedEvents.RaisesItemChangedEvents =>
            this.raiseItemChangedEvents;
    }
}
