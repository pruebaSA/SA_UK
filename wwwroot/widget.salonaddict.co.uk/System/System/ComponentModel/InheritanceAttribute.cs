namespace System.ComponentModel
{
    ...
    public sealed class InheritanceAttribute : Attribute
    {
        ...
        public override bool Equals(object value) => 
            ((value == this) || ((value is InheritanceAttribute) && (((InheritanceAttribute) value).InheritanceLevel == this.inheritanceLevel)));
        ...
        public override string ToString() => 
            TypeDescriptor.GetConverter(typeof(System.ComponentModel.InheritanceLevel)).ConvertToString(this.InheritanceLevel);
