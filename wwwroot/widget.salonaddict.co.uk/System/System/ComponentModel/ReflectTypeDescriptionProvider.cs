namespace System.ComponentModel
{
    ...
    internal sealed class ReflectTypeDescriptionProvider : TypeDescriptionProvider
    {
        ...
        internal AttributeCollection GetAttributes(Type type) => 
            this.GetTypeData(type, true).GetAttributes();
        ...
        internal EventDescriptorCollection GetEvents(Type type) => 
            this.GetTypeData(type, true).GetEvents();
        ...
        internal string GetExtendedClassName(object instance) => 
            this.GetClassName(instance.GetType());

        internal string GetExtendedComponentName(object instance) => 
            this.GetComponentName(instance.GetType(), instance);

        internal TypeConverter GetExtendedConverter(object instance) => 
            this.GetConverter(instance.GetType(), instance);
        ...
        internal object GetExtendedEditor(object instance, Type editorBaseType) => 
            this.GetEditor(instance.GetType(), instance, editorBaseType);
        ...
        internal PropertyDescriptorCollection GetExtendedProperties(object instance)
        {
            ...
            if (service != null)
            {
                providerArray = GetExtenders(service.GetExtenderProviders(), instance, cache);
            }
            else
            {
                ...
                if (container != null)
                {
                    providerArray = GetExtenders(container.Components, instance, cache);
                }
            }
            ...
            if (empty == null)
            {
                ...
                {
                    PropertyDescriptor[] descriptorArray = ReflectGetExtendedProperties(providerArray[i]);
                    if (list == null)
                    {
                        list = new ArrayList(descriptorArray.Length * providerArray.Length);
                    }
        ...
        internal object GetExtendedPropertyOwner(object instance, PropertyDescriptor pd) => 
            this.GetPropertyOwner(instance.GetType(), instance, pd);
        ...
        internal PropertyDescriptorCollection GetProperties(Type type) => 
            this.GetTypeData(type, true).GetProperties();

        internal object GetPropertyOwner(Type type, object instance, PropertyDescriptor pd) => 
            TypeDescriptor.GetAssociation(type, instance);
        ...
        private class ReflectedTypeData
        {
            ...
            internal AttributeCollection GetAttributes()
            {
                if (this._attributes == null)
                {
                    ...
                    Hashtable hashtable = new Hashtable(sourceArray.Length);
                    for (int i = sourceArray.Length - 1; i >= 0; i--)
                    {
                        ...
                        if (flag)
                        {
                            hashtable[sourceArray[i].TypeId] = sourceArray[i];
                        }
                    }
                    sourceArray = new Attribute[hashtable.Count];
                    hashtable.Values.CopyTo(sourceArray, 0);
            ...
            internal bool IsPopulated =>
                (((this._attributes != null) | (this._events != null)) | (this._properties != null));
        }
    }
}
