namespace System.Threading
{
    ...
    public sealed class Semaphore : WaitHandle
    {
        ...
        public unsafe Semaphore(int initialCount, int maximumCount, string name, out bool createdNew, SemaphoreSecurity semaphoreSecurity)
        {
            ...
            {
                NativeMethods.SECURITY_ATTRIBUTES structure = null;
                structure = new NativeMethods.SECURITY_ATTRIBUTES();
        ...
        public SemaphoreSecurity GetAccessControl() => 
            new SemaphoreSecurity(base.SafeWaitHandle, AccessControlSections.Group | AccessControlSections.Owner | AccessControlSections.Access);

        [SecurityPermission(SecurityAction.LinkDemand, Flags=SecurityPermissionFlag.UnmanagedCode)]
        public static Semaphore OpenExisting(string name) => 
            OpenExisting(name, SemaphoreRights.Synchronize | SemaphoreRights.Modify);
