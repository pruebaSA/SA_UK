namespace System.Configuration
{
    ...
    internal sealed class ClientSettingsStore
    {
        ...
        internal ConnectionStringSettingsCollection ReadConnectionStrings() => 
            System.Configuration.PrivilegedConfigurationManager.ConnectionStrings;
        ...
        private sealed class ClientSettingsConfigurationHost : DelegatingConfigHost
        {
            ...
            public override void InitForConfiguration(ref string locationSubPath, out string configPath, out string locationConfigPath, IInternalConfigRoot configRoot, params object[] hostInitConfigurationParams)
            {
                ...
                base.Host = (IInternalConfigHost) System.Configuration.TypeUtil.CreateInstanceWithReflectionPermission("System.Configuration.ClientConfigurationHost,System.Configuration, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a");
            ...
            internal static System.Configuration.Configuration OpenExeConfiguration(ConfigurationUserLevel userLevel) => 
                ConfigFactory.Create(typeof(ClientSettingsStore.ClientSettingsConfigurationHost), new object[] { userLevel });
            ...
            private IInternalConfigClientHost ClientHost =>
                ((IInternalConfigClientHost) base.Host);
            ...
            internal static IInternalConfigConfigurationFactory ConfigFactory
            {
                get
                {
                    ...
                    {
                        s_configFactory = (IInternalConfigConfigurationFactory) System.Configuration.TypeUtil.CreateInstanceWithReflectionPermission("System.Configuration.Internal.InternalConfigConfigurationFactory,System.Configuration, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a");
                    }
        ...
        private sealed class QuotaEnforcedStream : Stream
        {
            ...
            public override IAsyncResult BeginRead(byte[] buffer, int offset, int numBytes, AsyncCallback userCallback, object stateObject) => 
                this._originalStream.BeginRead(buffer, offset, numBytes, userCallback, stateObject);
            ...
            public override int EndRead(IAsyncResult asyncResult) => 
                this._originalStream.EndRead(asyncResult);
            ...
            public override int Read(byte[] buffer, int offset, int count) => 
                this._originalStream.Read(buffer, offset, count);

            public override int ReadByte() => 
                this._originalStream.ReadByte();
            ...
            public override bool CanRead =>
                this._originalStream.CanRead;

            public override bool CanSeek =>
                this._originalStream.CanSeek;

            public override bool CanWrite =>
                this._originalStream.CanWrite;

            public override long Length =>
                this._originalStream.Length;

            public override long Position
            {
                get => 
                    this._originalStream.Position;
                set
                {
                    if (value < 0L)
                    {
