    ...
    public class SettingsPropertyValue
    {
        ...
        private object Deserialize()
        {
                ...
                catch (Exception exception)
                {
                    try
                    {
                        if (this.IsHostedInAspnet())
                        {
                            ...
                            Type.GetType("System.Web.Management.WebBaseEvent, System.Web, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", true).InvokeMember("RaisePropertyDeserializationWebErrorEvent", BindingFlags.InvokeMethod | BindingFlags.NonPublic | BindingFlags.Static, null, null, args, CultureInfo.InvariantCulture);
                        }
                    }
                    catch
                    {
            ...
            if (defaultValue == null)
            {
                ...
                try
                {
                    defaultValue = Activator.CreateInstance(this.Property.PropertyType);
                }
                catch
                {
                }
