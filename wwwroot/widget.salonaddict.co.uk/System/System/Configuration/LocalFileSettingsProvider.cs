namespace System.Configuration
{
    ...
    public class LocalFileSettingsProvider : SettingsProvider, IApplicationSettingsProvider
    {
        ...
        [PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust"), PermissionSet(SecurityAction.LinkDemand, Name="FullTrust"), FileIOPermission(SecurityAction.Assert, AllFiles=FileIOPermissionAccess.PathDiscovery | FileIOPermissionAccess.Read)]
