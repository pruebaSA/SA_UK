namespace System.Timers
{
    ...
    [DefaultProperty("Interval"), DefaultEvent("Elapsed"), HostProtection(SecurityAction.LinkDemand, Synchronization=true, ExternalThreading=true)]
    public class Timer : Component, ISupportInitialize
    {
        ...
        [TimersDescription("TimerEnabled"), DefaultValue(false), Category("Behavior")]
        public bool Enabled
        {
            get => 
                this.enabled;
        ...
        [RecommendedAsConfigurable(true), DefaultValue((double) 100.0), Category("Behavior"), TimersDescription("TimerInterval")]
        ...
        [DefaultValue((string) null), TimersDescription("TimerSynchronizingObject"), Browsable(false)]
