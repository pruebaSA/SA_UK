namespace System.Collections.Generic
{
    ...
    [Serializable, ComVisible(false), DebuggerDisplay("Count = {Count}"), DebuggerTypeProxy(typeof(System_QueueDebugView<>))]
    public class Queue<T> : IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        internal T GetElement(int i) => 
            this._array[(this._head + i) % this._array.Length];

        public Enumerator<T> GetEnumerator() => 
            new Enumerator<T>((Queue<T>) this);
