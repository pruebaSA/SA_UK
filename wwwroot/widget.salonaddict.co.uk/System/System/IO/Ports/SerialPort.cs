namespace System.IO.Ports
{
    ...
    public class SerialPort : Component
    {
        ...
        [Browsable(true), DefaultValue(0x2580), MonitoringDescription("BaudRate")]
        public int BaudRate
        {
            get => 
                this.baudRate;
        ...
        [MonitoringDescription("DataBits"), Browsable(true), DefaultValue(8)]
        public int DataBits
        {
            get => 
                this.dataBits;
        ...
        [DefaultValue(false), MonitoringDescription("DiscardNull"), Browsable(true)]
        ...
        [MonitoringDescription("DtrEnable"), Browsable(true), DefaultValue(false)]
        ...
        [MonitoringDescription("Encoding"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [MonitoringDescription("Handshake"), Browsable(true), DefaultValue(0)]
        ...
        [Browsable(false)]
        public bool IsOpen =>
            ((this.internalSerialStream != null) && this.internalSerialStream.IsOpen);

        [MonitoringDescription("NewLine"), DefaultValue("\n"), Browsable(false)]
        ...
        [Browsable(true), DefaultValue(0), MonitoringDescription("Parity")]
        ...
        [DefaultValue((byte) 0x3f), Browsable(true), MonitoringDescription("ParityReplace")]
        ...
        [DefaultValue(0x1000), MonitoringDescription("ReadBufferSize"), Browsable(true)]
        ...
        [MonitoringDescription("ReadTimeout"), DefaultValue(-1), Browsable(true)]
        ...
        [Browsable(true), MonitoringDescription("ReceivedBytesThreshold"), DefaultValue(1)]
        ...
        [MonitoringDescription("RtsEnable"), Browsable(true), DefaultValue(false)]
        ...
        [MonitoringDescription("StopBits"), DefaultValue(1), Browsable(true)]
        ...
        [MonitoringDescription("WriteBufferSize"), DefaultValue(0x800), Browsable(true)]
