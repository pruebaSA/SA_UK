namespace System.IO.Ports
{
    ...
    internal sealed class SerialStream : Stream
    {
        ...
        private unsafe SerialStreamAsyncResult BeginReadCore(byte[] array, int offset, int numBytes, AsyncCallback userCallback, object stateObject)
        {
            ...
            NativeOverlapped* overlapped = new Overlapped(0, 0, IntPtr.Zero, ar).Pack(IOCallback, null);
        ...
        public override int Read([In, Out] byte[] array, int offset, int count) => 
            this.Read(array, offset, count, this.ReadTimeout);
        ...
        public override int ReadByte() => 
            this.ReadByte(this.ReadTimeout);
        ...
        internal bool IsOpen =>
            ((this._handle != null) && !this.eventRunner.ShutdownLoop);
