namespace System.Diagnostics
{
    ...
    internal static class DiagnosticsConfiguration
    {
        ...
        private static System.Diagnostics.InitState initState;

        internal static bool CanInitialize() => 
            ((initState != System.Diagnostics.InitState.Initializing) && !ConfigurationManagerInternalFactory.Instance.SetConfigurationSystemInProgress);

        private static System.Diagnostics.SystemDiagnosticsSection GetConfigSection() => 
            ((System.Diagnostics.SystemDiagnosticsSection) System.Configuration.PrivilegedConfigurationManager.GetSection("system.diagnostics"));
