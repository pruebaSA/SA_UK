namespace System.Diagnostics
{
    ...
    [Designer("System.Diagnostics.Design.ProcessModuleDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), PermissionSet(SecurityAction.LinkDemand, Name="FullTrust"), PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust")]
    public class ProcessModule : Component
    {
        ...
        public override string ToString() => 
            string.Format(CultureInfo.CurrentCulture, "{0} ({1})", new object[] { base.ToString(), this.ModuleName });

        [MonitoringDescription("ProcModBaseAddress")]
        public IntPtr BaseAddress =>
            this.moduleInfo.baseOfDll;
        ...
        public int ModuleMemorySize =>
            this.moduleInfo.sizeOfImage;

        [MonitoringDescription("ProcModModuleName")]
        public string ModuleName =>
            this.moduleInfo.baseName;
    }
}
