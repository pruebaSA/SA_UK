namespace System.Diagnostics
{
    ...
    internal sealed class SharedPerformanceCounter
    {
        ...
        private unsafe int CreateCategory(CategoryEntry* lastCategoryPointer, int instanceNameHashCode, string instanceName, PerformanceCounterInstanceLifetime lifetime)
        {
            ...
            Marshal.Copy(this.categoryName.ToCharArray(), 0, (IntPtr) num8, this.categoryName.Length);
            num8 += num;
            ...
            Marshal.Copy(instanceName.ToCharArray(), 0, (IntPtr) num8, instanceName.Length);
            num8 += num2;
            ...
            Marshal.Copy(wstr.ToCharArray(), 0, (IntPtr) num8, wstr.Length);
        ...
        private unsafe int CreateInstance(CategoryEntry* categoryPointer, int instanceNameHashCode, string instanceName, PerformanceCounterInstanceLifetime lifetime)
        {
            ...
            else
            {
                ...
                for (int k = 0; k < this.categoryData.CounterNames.Count; k++)
                {
                    ...
                    Marshal.Copy(wstr.ToCharArray(), 0, (IntPtr) num7, wstr.Length);
        ...
        private static int GetFileMappingSizeFromConfig() => 
            DiagnosticsConfiguration.PerfomanceCountersFileMappingSize;
            ...
            if (entryPtr->RefCount == 0)
            {
                ...
                if (flag)
                {
                    ...
                    if (flag3)
                    {
                        try
                        {
                            char[] destination = new char[instanceName.Length + 1];
                            instanceName.CopyTo(0, destination, 0, instanceName.Length);
                            destination[instanceName.Length] = '\0';
                            Marshal.Copy(destination, 0, (IntPtr) num, destination.Length);
                            entryPtr->InstanceNameHashCode = instanceNameHashCode;
                    ...
                    if (processId != 0)
                    {
                        ...
                        else
                        {
                            using (Microsoft.Win32.SafeHandles.SafeProcessHandle handle = Microsoft.Win32.SafeHandles.SafeProcessHandle.OpenProcess(0x400, false, processId))
                            {
                                ...
                                if ((!handle.IsInvalid && (startupTime != -1L)) && (NativeMethods.GetProcessTimes(handle, out num3, out num5, out num5, out num5) && (num3 != startupTime)))
                                {
                                    currentInstancePointer.RefCount = 0;
                                    return;
                                }
                ...
                if (procData == null)
                {
                    ...
                    try
                    {
                        ...
                        using (Microsoft.Win32.SafeHandles.SafeProcessHandle handle = Microsoft.Win32.SafeHandles.SafeProcessHandle.OpenProcess(0x400, false, currentProcessId))
                        {
                            ...
                            {
                                long num3;
                                NativeMethods.GetProcessTimes(handle, out creation, out num3, out num3, out num3);
                            }
                        }
        ...
        private class FileMapping
        {
            ...
            private void Initialize(string fileMappingName, int fileMappingSize, int initialOffset)
            {
                ...
                try
                {
                    ...
                    NativeMethods.SECURITY_ATTRIBUTES lpFileMappingAttributes = new NativeMethods.SECURITY_ATTRIBUTES {
                    ...
                    while (!flag)
                    {
                        this.fileMappingHandle = NativeMethods.CreateFileMapping((IntPtr) (-1), lpFileMappingAttributes, 4, 0, fileMappingSize, lpName);
                        ...
                        else
                        {
                            ...
                            this.fileMappingHandle = NativeMethods.OpenFileMapping(2, false, lpName);
                    ...
                    NativeMethods.MEMORY_BASIC_INFORMATION buffer = new NativeMethods.MEMORY_BASIC_INFORMATION();
                    if (NativeMethods.VirtualQuery(this.fileViewAddress, ref buffer, (IntPtr) sizeof(NativeMethods.MEMORY_BASIC_INFORMATION)) == IntPtr.Zero)
                    {
