namespace System.Diagnostics
{
    ...
    [DefaultEvent("Exited"), DefaultProperty("StartInfo"), Designer("System.Diagnostics.Design.ProcessDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), MonitoringDescription("ProcessDesc"), PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust"), HostProtection(SecurityAction.LinkDemand, SharedState=true, Synchronization=true, ExternalProcessMgmt=true, SelfAffectingProcessMgmt=true), PermissionSet(SecurityAction.LinkDemand, Name="FullTrust")]
    public class Process : Component
    {
        ...
        private void EnsureWorkingSetLimits()
        {
            ...
            if (!this.haveWorkingSetLimits)
            {
                ...
                try
                {
                    ...
                    if (!NativeMethods.GetProcessWorkingSetSize(processHandle, out ptr, out ptr2))
                    {
                        throw new Win32Exception();
                    }
        ...
        public static Process GetCurrentProcess() => 
            new Process(".", false, NativeMethods.GetCurrentProcessId(), null);
        ...
        private Microsoft.Win32.SafeHandles.SafeProcessHandle GetProcessHandle(int access) => 
            this.GetProcessHandle(access, true);
        ...
        private Microsoft.Win32.SafeHandles.SafeProcessHandle GetProcessHandle(int access, bool throwIfExited)
        {
            ...
            if ((throwIfExited && ((access & 0x400) != 0)) && (NativeMethods.GetExitCodeProcess(invalidHandle, out this.exitCode) && (this.exitCode != 0x103)))
            {
                throw new InvalidOperationException(SR.GetString("ProcessHasExited", new object[] { this.processId.ToString(CultureInfo.CurrentCulture) }));
            }
        ...
        private ProcessThreadTimes GetProcessTimes()
        {
            ...
            try
            {
                ...
                if (!NativeMethods.GetProcessTimes(processHandle, out times.create, out times.exit, out times.kernel, out times.user))
                {
                    throw new Win32Exception();
                }
            }
        ...
        private Microsoft.Win32.SafeHandles.SafeProcessHandle OpenProcessHandle()
        {
            if (!this.haveProcessHandle)
            {
                ...
                this.SetProcessHandle(this.GetProcessHandle(0x1f0fff));
            }
            return this.m_processHandle;
        }
        ...
        private static void SetPrivilege(string privilegeName, int attrib)
        {
            ...
            if (!NativeMethods.OpenProcessToken(new HandleRef(null, currentProcess), 0x20, out zero))
            {
                throw new Win32Exception();
            }
            try
            {
                ...
                NativeMethods.AdjustTokenPrivileges(new HandleRef(null, zero), false, newState, 0, IntPtr.Zero, IntPtr.Zero);
        ...
        private void SetWorkingSetLimits(object newMin, object newMax)
        {
            ...
            try
            {
                ...
                if (!NativeMethods.SetProcessWorkingSetSize(processHandle, ptr, ptr2))
                {
                    throw new Win32Exception();
                }
                if (!NativeMethods.GetProcessWorkingSetSize(processHandle, out ptr, out ptr2))
        ...
        private bool StartWithCreateProcess(ProcessStartInfo startInfo)
        {
            ...
            try
            {
                ...
                if ((startInfo.RedirectStandardInput || startInfo.RedirectStandardOutput) || startInfo.RedirectStandardError)
                {
                    ...
                    {
                        lpStartupInfo.hStdError = new SafeFileHandle(NativeMethods.GetStdHandle(-12), false);
                    }
                ...
                {
                    NativeMethods.LogonFlags logonFlags = 0;
                    ...
                    try
                    {
                        ...
                        {
                            flag = NativeMethods.CreateProcessWithLogonW(startInfo.UserName, startInfo.Domain, password, logonFlags, null, cmdLine, creationFlags, zero, workingDirectory, lpStartupInfo, lpProcessInformation);
                            if (!flag)
                            {
                ...
                {
                    flag = NativeMethods.CreateProcess(null, cmdLine, null, null, true, creationFlags, zero, workingDirectory, lpStartupInfo, lpProcessInformation);
                    if (!flag)
                    {
                        error = Marshal.GetLastWin32Error();
                    }
        ...
        private bool StartWithShellExecuteEx(ProcessStartInfo startInfo)
        {
            ...
            NativeMethods.ShellExecuteInfo executeInfo = new NativeMethods.ShellExecuteInfo {
                fMask = 0x40
            };
        ...
        public bool WaitForExit(int milliseconds)
        {
            ...
            finally
            {
                ...
                if ((this.output != null) && (milliseconds == 0x7fffffff))
                {
                    this.output.WaitUtilEOF();
                }
                if ((this.error != null) && (milliseconds == 0x7fffffff))
                {
        ...
        public bool WaitForInputIdle() => 
            this.WaitForInputIdle(0x7fffffff);
        ...
        public bool WaitForInputIdle(int milliseconds)
        {
            ...
            try
            {
                ...
                switch (NativeMethods.WaitForInputIdle(processHandle, milliseconds))
                {
                    case 0:
                        return true;
        ...
        [MonitoringDescription("ProcessAssociated"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue(false), MonitoringDescription("ProcessEnableRaisingEvents"), Browsable(false)]
        ...
        [Browsable(false), MonitoringDescription("ProcessExitTime"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("ProcessTerminated"), Browsable(false)]
            ...
            get
            {
                if (!this.exited)
                {
                    ...
                    try
                    {
                        ...
                        {
                            int num;
                            if (NativeMethods.GetExitCodeProcess(processHandle, out num) && (num != 0x103))
                            {
                                this.exited = true;
                                this.exitCode = num;
                            }
                            else
                            {
                                ...
                                if (this.signaled)
                                {
                                    if (!NativeMethods.GetExitCodeProcess(processHandle, out num))
                                    {
                                        throw new Win32Exception();
                                    }
                                    this.exited = true;
        ...
        public IntPtr MainWindowHandle
        {
            get
            {
                ...
                {
                    this.EnsureState(State.HaveProcessInfo | State.IsLocal);
        ...
        public string MainWindowTitle
        {
            get
            {
                if (this.mainWindowTitle == null)
                {
                    ...
                    {
                        int capacity = NativeMethods.GetWindowTextLength(new HandleRef(this, mainWindowHandle)) * 2;
                        StringBuilder lpString = new StringBuilder(capacity);
                        NativeMethods.GetWindowText(new HandleRef(this, mainWindowHandle), lpString, lpString.Capacity);
        ...
        [MonitoringDescription("ProcessModules"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Obsolete("This property has been deprecated.  Please use System.Diagnostics.Process.NonpagedSystemMemorySize64 instead.  http://go.microsoft.com/fwlink/?linkid=14202"), MonitoringDescription("ProcessNonpagedSystemMemorySize"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [ComVisible(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("ProcessNonpagedSystemMemorySize")]
        ...
        [Obsolete("This property has been deprecated.  Please use System.Diagnostics.Process.PagedMemorySize64 instead.  http://go.microsoft.com/fwlink/?linkid=14202"), MonitoringDescription("ProcessPagedMemorySize"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Obsolete("This property has been deprecated.  Please use System.Diagnostics.Process.PagedSystemMemorySize64 instead.  http://go.microsoft.com/fwlink/?linkid=14202"), MonitoringDescription("ProcessPagedSystemMemorySize"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [ComVisible(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("ProcessPagedSystemMemorySize")]
        ...
        [Obsolete("This property has been deprecated.  Please use System.Diagnostics.Process.PeakPagedMemorySize64 instead.  http://go.microsoft.com/fwlink/?linkid=14202"), MonitoringDescription("ProcessPeakPagedMemorySize"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [MonitoringDescription("ProcessPeakVirtualMemorySize"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ComVisible(false)]
        ...
        public bool PriorityBoostEnabled
        {
            get
            {
                ...
                if (!this.havePriorityBoostEnabled)
                {
                    ...
                    try
                    {
                        processHandle = this.GetProcessHandle(0x400);
                        bool disabled = false;
                        if (!NativeMethods.GetProcessPriorityBoost(processHandle, out disabled))
                        {
                            throw new Win32Exception();
                        }
            ...
            set
            {
                ...
                try
                {
                    ...
                    if (!NativeMethods.SetProcessPriorityBoost(processHandle, !value))
                    {
                        throw new Win32Exception();
                    }
        ...
        [MonitoringDescription("ProcessPriorityClass"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public ProcessPriorityClass PriorityClass
        {
            get
            {
                if (!this.havePriorityClass)
                {
                    ...
                    {
                        processHandle = this.GetProcessHandle(0x400);
                        int priorityClass = NativeMethods.GetPriorityClass(processHandle);
                        if (priorityClass == 0)
                        {
                            throw new Win32Exception();
                        }
            ...
            set
            {
                ...
                {
                    processHandle = this.GetProcessHandle(0x200);
                    if (!NativeMethods.SetPriorityClass(processHandle, (int) value))
                    {
                        throw new Win32Exception();
                    }
        ...
        [Obsolete("This property has been deprecated.  Please use System.Diagnostics.Process.PrivateMemorySize64 instead.  http://go.microsoft.com/fwlink/?linkid=14202"), MonitoringDescription("ProcessPrivateMemorySize"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [ComVisible(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("ProcessPrivateMemorySize")]
        ...
        [MonitoringDescription("ProcessPrivilegedProcessorTime"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("ProcessProcessName")]
        ...
        public IntPtr ProcessorAffinity
        {
            get
            {
                if (!this.haveProcessorAffinity)
                {
                    ...
                    try
                    {
                        ...
                        IntPtr ptr2;
                        processHandle = this.GetProcessHandle(0x400);
                        if (!NativeMethods.GetProcessAffinityMask(processHandle, out ptr, out ptr2))
                        {
                            throw new Win32Exception();
                        }
            ...
            set
            {
                ...
                {
                    processHandle = this.GetProcessHandle(0x200);
                    if (!NativeMethods.SetProcessAffinityMask(processHandle, value))
                    {
                        throw new Win32Exception();
                    }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), MonitoringDescription("ProcessResponding")]
        ...
        [MonitoringDescription("ProcessSessionId"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [MonitoringDescription("ProcessStandardInput"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), MonitoringDescription("ProcessStartInfo"), Browsable(false)]
        ...
        [MonitoringDescription("ProcessVirtualMemorySize"), Obsolete("This property has been deprecated.  Please use System.Diagnostics.Process.VirtualMemorySize64 instead.  http://go.microsoft.com/fwlink/?linkid=14202"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ComVisible(false), MonitoringDescription("ProcessVirtualMemorySize")]
        ...
        [MonitoringDescription("ProcessWorkingSet"), Obsolete("This property has been deprecated.  Please use System.Diagnostics.Process.WorkingSet64 instead.  http://go.microsoft.com/fwlink/?linkid=14202"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
