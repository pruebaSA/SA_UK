namespace System.Diagnostics
{
    ...
    public sealed class PerformanceCounterCategory
    {
        ...
        internal const int MaxHelpLength = 0xff;
        ...
        internal static void CheckValidHelp(string help)
        {
            ...
            if (help.Length > 0xff)
            {
                throw new ArgumentException(SR.GetString("PerfInvalidHelp", new object[] { 0, 0xff }));
            }
        }
        ...
        public static PerformanceCounterCategory Create(string categoryName, string categoryHelp, CounterCreationDataCollection counterData) => 
            Create(categoryName, categoryHelp, PerformanceCounterCategoryType.Unknown, counterData);
