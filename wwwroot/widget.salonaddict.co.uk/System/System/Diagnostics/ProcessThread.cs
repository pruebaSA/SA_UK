namespace System.Diagnostics
{
    ...
    [Designer("System.Diagnostics.Design.ProcessThreadDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), HostProtection(SecurityAction.LinkDemand, SelfAffectingProcessMgmt=true, SelfAffectingThreading=true)]
    public class ProcessThread : Component
    {
        ...
        private ProcessThreadTimes GetThreadTimes()
        {
            ...
            try
            {
                ...
                if (!NativeMethods.GetThreadTimes(handle, out times.create, out times.exit, out times.kernel, out times.user))
                {
        ...
        public int BasePriority =>
            this.threadInfo.basePriority;

        [MonitoringDescription("ThreadCurrentPriority")]
        public int CurrentPriority =>
            this.threadInfo.currentPriority;
