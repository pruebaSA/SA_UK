namespace System
{
    ...
    public abstract class UriParser
    {
        ...
        internal string InternalGetComponents(Uri thisUri, UriComponents uriComponents, UriFormat uriFormat) => 
            this.GetComponents(thisUri, uriComponents, uriFormat);

        internal bool InternalIsBaseOf(Uri thisBaseUri, Uri uriLink) => 
            this.IsBaseOf(thisBaseUri, uriLink);

        internal bool InternalIsWellFormedOriginalString(Uri thisUri) => 
            this.IsWellFormedOriginalString(thisUri);
        ...
        internal string InternalResolve(Uri thisBaseUri, Uri uriLink, out UriFormatException parsingError) => 
            this.Resolve(thisBaseUri, uriLink, out parsingError);
        ...
        protected virtual bool IsBaseOf(Uri baseUri, Uri relativeUri) => 
            baseUri.IsBaseOfHelper(relativeUri);
        ...
        protected virtual bool IsWellFormedOriginalString(Uri uri) => 
            uri.InternalIsWellFormedOriginalString();
        ...
        internal bool IsSimple =>
            this.InFact(UriSyntaxFlags.SimpleUserSyntax);
