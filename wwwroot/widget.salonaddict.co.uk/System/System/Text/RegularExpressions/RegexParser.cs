    ...
    internal sealed class RegexParser
    {
        ...
        internal void AssignNameSlots()
        {
            ...
            if (this._capcount < this._captop)
            {
                ...
                Array.Sort(this._capnumlist, System.InvariantComparer.Default);
            }
            if ((this._capnames != null) || (this._capnumlist != null))
            {
                ...
                for (int j = 0; j < this._capcount; j++)
                {
                    ...
                    {
                        string str2 = Convert.ToString(num7, this._culture);
        ...
        internal int CaptureSlotFromName(string capname) => 
            ((int) this._capnames[capname]);

        internal char CharAt(int i) => 
            this._pattern[i];

        internal int CharsRight() => 
            (this._pattern.Length - this._currentPos);
        ...
        internal bool IsCaptureName(string capname) => 
            this._capnames?.ContainsKey(capname);
        ...
        internal ArgumentException MakeException(string message) => 
            new ArgumentException(SR.GetString("MakeException", new object[] { this._pattern, message }));
        ...
        internal char MoveRightGetChar() => 
            this._pattern[this._currentPos++];
        ...
        internal static RegexTree Parse(string re, RegexOptions op)
        {
            ...
            {
                strArray = (string[]) parser._capnamelist.ToArray(typeof(string));
            }
        ...
        internal char RightChar(int i) => 
            this._pattern[this._currentPos + i];
        ...
        internal RegexCharClass ScanCharClass(bool caseInsensitive) => 
            this.ScanCharClass(caseInsensitive, false);
        ...
        internal bool UseOptionE() => 
            ((this._options & RegexOptions.ECMAScript) != RegexOptions.None);

        internal bool UseOptionI() => 
            ((this._options & RegexOptions.IgnoreCase) != RegexOptions.None);

        internal bool UseOptionM() => 
            ((this._options & RegexOptions.Multiline) != RegexOptions.None);

        internal bool UseOptionN() => 
            ((this._options & RegexOptions.ExplicitCapture) != RegexOptions.None);

        internal bool UseOptionS() => 
            ((this._options & RegexOptions.Singleline) != RegexOptions.None);

        internal bool UseOptionX() => 
            ((this._options & RegexOptions.IgnorePatternWhitespace) != RegexOptions.None);
    }
}
