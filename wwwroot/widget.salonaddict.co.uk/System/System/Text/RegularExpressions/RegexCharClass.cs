namespace System.Text.RegularExpressions
{
    ...
    internal sealed class RegexCharClass
    {
        ...
        private static Hashtable _definedCategories = new Hashtable(0x1f);
        ...
        static RegexCharClass()
        {
            ...
            chArray[6] = '\x0018';
            _definedCategories["Pf"] = chArray[6].ToString();
            chArray[7] = '\x0017';
            _definedCategories["Pi"] = chArray[7].ToString();
            chArray[8] = '\0';
        ...
        private static bool IsSubtraction(string charClass) => 
            (charClass.Length > (('\x0003' + charClass[1]) + charClass[2]));

        internal static bool IsWordChar(char ch) => 
            CharInClass(ch, WordClass);
        ...
        private static RegexCharClass ParseRecursive(string charClass, int start)
        {
            ...
            ArrayList ranges = new ArrayList(capacity);
            int num4 = start + 3;
        ...
        internal string ToStringClass()
        {
            ...
            {
                SingleRange range = (SingleRange) this._rangelist[i];
        ...
        internal bool CanMerge =>
            (!this._negate && (this._subtractor == null));
