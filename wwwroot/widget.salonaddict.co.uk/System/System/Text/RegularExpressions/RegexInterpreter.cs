namespace System.Text.RegularExpressions
{
    ...
    internal sealed class RegexInterpreter : RegexRunner
    {
        ...
        private int Operand(int i) => 
            this.runcodes[(this.runcodepos + i) + 1];
        ...
        private int Rightchars() => 
            (base.runtextend - base.runtextpos);
        ...
        private int StackPeek() => 
            base.runstack[base.runstackpos - 1];

        private int StackPeek(int i) => 
            base.runstack[(base.runstackpos - i) - 1];
        ...
        private int TrackPeek() => 
            base.runtrack[base.runtrackpos - 1];

        private int TrackPeek(int i) => 
            base.runtrack[(base.runtrackpos - i) - 1];
        ...
        private int Trackpos() => 
            (base.runtrack.Length - base.runtrackpos);
