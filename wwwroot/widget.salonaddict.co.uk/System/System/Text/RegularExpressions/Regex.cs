namespace System.Text.RegularExpressions
{
    ...
    public class Regex : ISerializable
    {
        ...
        private Regex(string pattern, RegexOptions options, bool useCache)
        {
            ...
            string threeLetterWindowsLanguageName = null;
            if (pattern == null)
            {
            ...
            string[] strArray = new string[] { ((int) options).ToString(NumberFormatInfo.InvariantInfo), ":", threeLetterWindowsLanguageName, ":", pattern };
        ...
        internal RegexRunnerFactory Compile(RegexCode code, RegexOptions roptions) => 
            RegexCompiler.Compile(code, roptions);
        ...
        public static bool IsMatch(string input, string pattern) => 
            new Regex(pattern, RegexOptions.None, true).IsMatch(input);

        public static bool IsMatch(string input, string pattern, RegexOptions options) => 
            new Regex(pattern, options, true).IsMatch(input);
        ...
        public static System.Text.RegularExpressions.Match Match(string input, string pattern) => 
            new Regex(pattern, RegexOptions.None, true).Match(input);
        ...
        public static System.Text.RegularExpressions.Match Match(string input, string pattern, RegexOptions options) => 
            new Regex(pattern, options, true).Match(input);
        ...
        public static MatchCollection Matches(string input, string pattern) => 
            new Regex(pattern, RegexOptions.None, true).Matches(input);

        public static MatchCollection Matches(string input, string pattern, RegexOptions options) => 
            new Regex(pattern, options, true).Matches(input);
        ...
        public static string Replace(string input, string pattern, string replacement) => 
            new Regex(pattern, RegexOptions.None, true).Replace(input, replacement);

        public static string Replace(string input, string pattern, MatchEvaluator evaluator) => 
            new Regex(pattern, RegexOptions.None, true).Replace(input, evaluator);
        ...
        public static string Replace(string input, string pattern, string replacement, RegexOptions options) => 
            new Regex(pattern, options, true).Replace(input, replacement);

        public static string Replace(string input, string pattern, MatchEvaluator evaluator, RegexOptions options) => 
            new Regex(pattern, options, true).Replace(input, evaluator);
        ...
        public static string[] Split(string input, string pattern) => 
            new Regex(pattern, RegexOptions.None, true).Split(input);
        ...
        public static string[] Split(string input, string pattern, RegexOptions options) => 
            new Regex(pattern, options, true).Split(input);
        ...
        protected bool UseOptionC() => 
            ((this.roptions & RegexOptions.Compiled) != RegexOptions.None);

        internal bool UseOptionInvariant() => 
            ((this.roptions & RegexOptions.CultureInvariant) != RegexOptions.None);

        protected bool UseOptionR() => 
            ((this.roptions & RegexOptions.RightToLeft) != RegexOptions.None);
