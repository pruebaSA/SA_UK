namespace System.Text.RegularExpressions
{
    ...
    public class Match : Group
    {
        ...
        internal virtual bool IsMatched(int cap) => 
            (((cap < this._matchcount.Length) && (this._matchcount[cap] > 0)) && (this._matches[cap][(this._matchcount[cap] * 2) - 1] != -2));

        internal string LastGroupToStringImpl() => 
            this.GroupToStringImpl(this._matchcount.Length - 1);
        ...
        public Match NextMatch() => 
            this._regex?.Run(false, base._length, base._text, this._textbeg, this._textend - this._textbeg, this._textpos);
