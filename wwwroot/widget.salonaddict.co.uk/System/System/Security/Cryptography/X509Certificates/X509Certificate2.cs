namespace System.Security.Cryptography.X509Certificates
{
    ...
    public class X509Certificate2 : X509Certificate
    {
        ...
        public X509Certificate2(X509Certificate certificate) : base(certificate)
        {
            ...
            {
                this.m_randomKeyContainer = certificate2.m_randomKeyContainer;
            }
        }
            ...
            get
            {
                ...
                if (this.m_privateKey == null)
                {
                    ...
                    if (algorithmId != 0x2200)
                    {
                        ...
                        {
                            new KeyContainerPermission(PermissionState.None) { AccessEntries = { new KeyContainerPermissionAccessEntry(parameters, KeyContainerPermissionFlags.Open) } }.Assert();
        ...
        private static uint RandomKeyContainerFlag
        {
            get
            {
                ...
                {
                    FieldInfo field = typeof(RSACryptoServiceProvider).GetField("RandomKeyContainerFlag", BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.DeclaredOnly);
                    if (field != null)
                    {
