namespace System.Security.AccessControl
{
    ...
    public sealed class SemaphoreSecurity : NativeObjectSecurity
    {
        ...
        public override AccessRule AccessRuleFactory(IdentityReference identityReference, int accessMask, bool isInherited, InheritanceFlags inheritanceFlags, PropagationFlags propagationFlags, AccessControlType type) => 
            new SemaphoreAccessRule(identityReference, accessMask, isInherited, inheritanceFlags, propagationFlags, type);
        ...
        public override AuditRule AuditRuleFactory(IdentityReference identityReference, int accessMask, bool isInherited, InheritanceFlags inheritanceFlags, PropagationFlags propagationFlags, AuditFlags flags) => 
            new SemaphoreAuditRule(identityReference, accessMask, isInherited, inheritanceFlags, propagationFlags, flags);
        ...
        public override Type AccessRightType =>
            typeof(SemaphoreRights);

        public override Type AccessRuleType =>
            typeof(SemaphoreAccessRule);

        public override Type AuditRuleType =>
            typeof(SemaphoreAuditRule);
    }
}
