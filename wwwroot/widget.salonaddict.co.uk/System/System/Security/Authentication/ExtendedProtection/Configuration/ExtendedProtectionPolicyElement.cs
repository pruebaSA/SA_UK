namespace System.Security.Authentication.ExtendedProtection.Configuration
{
    ...
    public sealed class ExtendedProtectionPolicyElement : ConfigurationElement
    {
        ...
        public ServiceNameElementCollection CustomServiceNames =>
            ((ServiceNameElementCollection) base[this.customServiceNames]);
        ...
        {
            get => 
                ((System.Security.Authentication.ExtendedProtection.PolicyEnforcement) base[this.policyEnforcement]);
            set
            {
        ...
        {
            get => 
                ((System.Security.Authentication.ExtendedProtection.ProtectionScenario) base[this.protectionScenario]);
            set
            {
