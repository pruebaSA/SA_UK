namespace System.CodeDom
{
    ...
    public class CodeTypeDeclaration : CodeTypeMember
    {
        ...
        {
            get => 
                ((((this.attributes & System.Reflection.TypeAttributes.ClassSemanticsMask) == System.Reflection.TypeAttributes.AnsiClass) && !this.isEnum) && !this.isStruct);
            set
            {
                if (value)
                {
        ...
        {
            get => 
                ((this.attributes & System.Reflection.TypeAttributes.ClassSemanticsMask) == System.Reflection.TypeAttributes.ClassSemanticsMask);
            set
            {
                if (value)
                {
