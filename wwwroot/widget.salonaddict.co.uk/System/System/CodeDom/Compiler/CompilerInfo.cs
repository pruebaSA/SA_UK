namespace System.CodeDom.Compiler
{
    ...
    public sealed class CompilerInfo
    {
        ...
        public string[] GetExtensions() => 
            this.CloneCompilerExtensions();

        public override int GetHashCode() => 
            this._codeDomProviderTypeName.GetHashCode();

        public string[] GetLanguages() => 
            this.CloneCompilerLanguages();
        ...
        internal CompilerParameters CompilerParams =>
            this._compilerParams;

        public bool IsCodeDomProviderTypeValid =>
            (Type.GetType(this._codeDomProviderTypeName) != null);
