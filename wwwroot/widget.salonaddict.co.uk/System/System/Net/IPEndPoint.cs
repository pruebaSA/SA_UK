namespace System.Net
{
    ...
    public class IPEndPoint : EndPoint
    {
        ...
        public override SocketAddress Serialize()
        {
            ...
            return new SocketAddress(this.m_Address.AddressFamily, 0x10) { 
                [2] = (byte) (this.Port >> 8),
                [3] = (byte) this.Port,
                [4] = (byte) this.Address.m_Address,
                [5] = (byte) (this.Address.m_Address >> 8),
                [6] = (byte) (this.Address.m_Address >> 0x10),
                [7] = (byte) (this.Address.m_Address >> 0x18)
            };
        }
        ...
        public override string ToString() => 
            (this.Address.ToString() + ":" + this.Port.ToString(NumberFormatInfo.InvariantInfo));
