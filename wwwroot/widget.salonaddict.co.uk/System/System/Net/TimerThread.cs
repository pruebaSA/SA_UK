namespace System.Net
{
    ...
    internal static class TimerThread
    {
        ...
        private static bool IsTickBetween(int start, int end, int comparand) => 
            (((start <= comparand) == (end <= comparand)) != (start <= end));
                    ...
                    while (flag)
                    {
                        ...
                        Label_003E:
                            ...
                            while (first != null)
                            {
                                ...
                                {
                                    int num3;
                                    if (target.Fire(out num3) && (!flag2 || IsTickBetween(tickCount, end, num3)))
                                    {
                                        end = num3;
                                        flag2 = true;
                                    }
                            ...
                            int millisecondsTimeout = flag2 ? (IsTickBetween(tickCount, end, comparand) ? (((int) Math.Min((uint) (end - comparand), 0x7ffffff0)) + 15) : 0) : 0x7530;
        ...
        private class InfiniteTimer : TimerThread.Timer
        {
            ...
            internal override bool Cancel() => 
                (Interlocked.Exchange(ref this.cancelled, 1) == 0);
        ...
        internal abstract class Timer : IDisposable
        {
            ...
            internal int Expiration =>
                (this.m_StartTimeMilliseconds + this.m_DurationMilliseconds);

            internal abstract bool HasExpired { get; }

            internal int StartTime =>
                this.m_StartTimeMilliseconds;
