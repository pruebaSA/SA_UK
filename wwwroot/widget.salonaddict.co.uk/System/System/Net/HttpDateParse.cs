namespace System.Net
{
    ...
    internal static class HttpDateParse
    {
        ...
        public static bool ParseCookieDate(string dateString, out DateTime dtOut)
        {
            ...
            if (lpszDay.Length < 0x12)
            {
                return false;
            }
            int index = 0;
            int day = 0;
            if (!char.IsDigit(ch = lpszDay[index++]))
            {
                return false;
            }
            day = ch - '0';
            ...
            index++;
            int month = MapDayMonthToDword(lpszDay, index);
            if (month == -999)
            {
                return false;
            }
            ...
            while (num5 < 4)
            {
                if (!char.IsDigit(ch = lpszDay[num5 + index]))
                {
                    if (num5 != 2)
                    {
                        return false;
            ...
            int hour = 0;
            if (!char.IsDigit(ch = lpszDay[num5++]))
            {
                return false;
            }
            hour = ch - '0';
            ...
            if ((minute > 60) || (lpszDay[num5++] != ':'))
            {
                return false;
            }
            if ((lpszDay.Length - num5) < 5)
            {
                return false;
            }
            int second = 0;
            ...
            if ((second > 60) || (lpszDay[num5++] != ' '))
            {
                return false;
            }
            if ((((lpszDay.Length - num5) < 3) || (lpszDay[num5++] != 'G')) || ((lpszDay[num5++] != 'M') || (lpszDay[num5++] != 'T')))
            {
                return false;
            }
            dtOut = new DateTime(year, month, day, hour, minute, second, 0).ToLocalTime();
            return true;
        }
