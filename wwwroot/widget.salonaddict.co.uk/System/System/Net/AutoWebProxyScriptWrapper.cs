namespace System.Net
{
    ...
    internal class AutoWebProxyScriptWrapper
    {
        ...
        [SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.ControlAppDomain | SecurityPermissionFlag.ControlEvidence)]
        private void CreateAppDomain()
        {
            ...
            try
            {
                ...
                finally
                {
                    ...
                    domainPolicy.RootCodeGroup = new UnionCodeGroup(new AllMembershipCondition(), new PolicyStatement(permSet, PolicyStatementAttribute.Exclusive));
                    Evidence securityInfo = new Evidence();
                    securityInfo.AddHost(new Zone(SecurityZone.Internet));
                    s_ExcessAppDomain = AppDomain.CreateDomain("WebProxyScript", securityInfo, s_AppDomainInfo);
                    s_ExcessAppDomain.SetAppDomainPolicy(domainPolicy);
                    try
                    {
