namespace System.Net
{
    ...
    internal class PooledStream : Stream
    {
        ...
        internal bool Activate(object owningObject, GeneralAsyncDelegate asyncCallback) => 
            this.Activate(owningObject, asyncCallback != null, -1, asyncCallback);
        ...
        internal IAsyncResult BeginMultipleWrite(BufferOffsetSize[] buffers, AsyncCallback callback, object state) => 
            this.m_NetworkStream.BeginMultipleWrite(buffers, callback, state);

        [HostProtection(SecurityAction.LinkDemand, ExternalThreading=true)]
        public override IAsyncResult BeginRead(byte[] buffer, int offset, int size, AsyncCallback callback, object state) => 
            this.m_NetworkStream.BeginRead(buffer, offset, size, callback, state);

        [HostProtection(SecurityAction.LinkDemand, ExternalThreading=true)]
        public override IAsyncResult BeginWrite(byte[] buffer, int offset, int size, AsyncCallback callback, object state) => 
            this.m_NetworkStream.BeginWrite(buffer, offset, size, callback, state);
        ...
        public override int EndRead(IAsyncResult asyncResult) => 
            this.m_NetworkStream.EndRead(asyncResult);
        ...
        internal bool Poll(int microSeconds, SelectMode mode) => 
            this.m_NetworkStream.Poll(microSeconds, mode);

        internal bool PollRead() => 
            this.m_NetworkStream.PollRead();
        ...
        public override int Read(byte[] buffer, int offset, int size) => 
            this.m_NetworkStream.Read(buffer, offset, size);

        public override long Seek(long offset, SeekOrigin origin) => 
            this.m_NetworkStream.Seek(offset, origin);
        ...
        internal virtual IAsyncResult UnsafeBeginRead(byte[] buffer, int offset, int size, AsyncCallback callback, object state) => 
            this.m_NetworkStream.UnsafeBeginRead(buffer, offset, size, callback, state);

        internal virtual IAsyncResult UnsafeBeginWrite(byte[] buffer, int offset, int size, AsyncCallback callback, object state) => 
            this.m_NetworkStream.UnsafeBeginWrite(buffer, offset, size, callback, state);
        ...
        public override bool CanRead =>
            this.m_NetworkStream.CanRead;

        public override bool CanSeek =>
            this.m_NetworkStream.CanSeek;

        public override bool CanTimeout =>
            this.m_NetworkStream.CanTimeout;

        public override bool CanWrite =>
            this.m_NetworkStream.CanWrite;
        ...
        internal ConnectionPool Pool =>
            this.m_ConnectionPool;

        public override long Position
        {
            get => 
                this.m_NetworkStream.Position;
            set
            {
        ...
        {
            get => 
                this.m_NetworkStream.ReadTimeout;
            set
            {
        ...
        internal virtual System.Net.ServicePoint ServicePoint =>
            this.Pool.ServicePoint;

        protected System.Net.Sockets.Socket Socket =>
            this.m_NetworkStream.InternalSocket;

        protected bool UsingSecureStream =>
            (this.m_NetworkStream is TlsStream);

        public override int WriteTimeout
        {
            get => 
                this.m_NetworkStream.WriteTimeout;
            set
            {
