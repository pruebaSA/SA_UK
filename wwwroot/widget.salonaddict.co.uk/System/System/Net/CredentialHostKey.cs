namespace System.Net
{
    ...
    internal class CredentialHostKey
    {
        ...
        public override string ToString() => 
            ("[" + this.Host.Length.ToString(NumberFormatInfo.InvariantInfo) + "]:" + this.Host + ":" + this.Port.ToString(NumberFormatInfo.InvariantInfo) + ":" + ValidationHelper.ToString(this.AuthenticationType));
    }
}
