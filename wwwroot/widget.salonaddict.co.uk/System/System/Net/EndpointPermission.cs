namespace System.Net
{
    ...
    public class EndpointPermission
    {
        ...
        internal EndpointPermission(string epname, int port, TransportType trtype)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(SR.GetString("net_perm_invalid_val", new object[] { "Port", port.ToString(NumberFormatInfo.InvariantInfo) }));
            }
        ...
        internal bool SubsetMatch(EndpointPermission e) => 
            ((((this.transport == e.transport) || (e.transport == TransportType.All)) && (((this.port == e.port) || (e.port == -1)) || (this.port == 0))) && this.MatchAddress(e));

        public override string ToString() => 
            string.Concat(new object[] { this.hostname, "#", this.port, "#", ((int) this.transport).ToString(NumberFormatInfo.InvariantInfo) });
