namespace System.Net
{
    ...
    public sealed class HttpListenerResponse : IDisposable
    {
        ...
        {
            get => 
                this.Headers[HttpResponseHeader.ContentType];
            set
            {
                this.CheckDisposed();
        ...
        {
            get => 
                ((System.Net.EntitySendFormat) this.m_BoundaryType);
            set
            {
                this.CheckDisposed();
                if (this.m_ResponseState >= ResponseState.SentHeaders)
        ...
        private System.Net.HttpListenerRequest HttpListenerRequest =>
            this.HttpListenerContext.Request;
        ...
        {
            get => 
                new Version(this.m_NativeResponse.Version.MajorVersion, this.m_NativeResponse.Version.MinorVersion);
            set
            {
                this.CheckDisposed();
                if (value == null)
        ...
        {
            get => 
                this.Headers[HttpResponseHeader.Location];
            set
            {
                this.CheckDisposed();
                if (string.IsNullOrEmpty(value))
        ...
        {
            get => 
                this.m_NativeResponse.StatusCode;
            set
            {
                this.CheckDisposed();
