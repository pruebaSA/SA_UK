namespace System.Net
{
    ...
    public class HttpWebRequest : WebRequest, ISerializable
    {
        ...
        protected HttpWebRequest(SerializationInfo serializationInfo, StreamingContext streamingContext) : base(serializationInfo, streamingContext)
        {
            ...
            this._CachedIfModifedSince = DateTime.MinValue;
        ...
        internal string AuthHeader(HttpResponseHeader header) => 
            this._HttpResponse?.Headers[header];
        ...
        public override IAsyncResult BeginGetResponse(AsyncCallback callback, object state)
        {
            ...
            if (((stream != null) && !stream.IsClosed) && (stream.BytesLeftToWrite == 0L))
            {
                stream.Close();
            }
            ContextAwareResult retObject = new ContextAwareResult(this.IdentityRequired, true, this, state, callback);
        ...
        private bool CheckCacheRetrieveBeforeSubmit()
        {
            ...
            try
            {
                ...
                base.CacheProtocol.GetRetrieveStatus(cacheUri, this);
                ...
                this._HttpResponse = new HttpWebResponse(this._Uri, this.CurrentMethod, coreData, this._MediaType, this.UsesProxySemantics, this.AutomaticDecompression);
        ...
        private void CheckProtocol(bool onRequestStream)
        {
            if (!this.CanGetRequestStream)
            {
                ...
                if ((this.HttpWriteMode != System.Net.HttpWriteMode.Unknown) && (this.HttpWriteMode != System.Net.HttpWriteMode.None))
                {
        ...
        private bool CheckResubmit(ref Exception e)
        {
            ...
            {
                e = new SecurityException(SR.GetString("net_redirect_perm"), new WebException(SR.GetString("net_resubmitcanceled"), exception3, WebExceptionStatus.ProtocolError, this._HttpResponse));
                return false;
            }
            this._Uri = uri;
            bool flag2 = false;
        ...
        {
            int destByteIndex = 0;
            HostHeaderString str = new HostHeaderString(this.HostAndPort(true));
        ...
        private int GenerateFtpProxyRequestLine(int headersSize)
        {
            ...
            HostHeaderString str3 = new HostHeaderString(this.HostAndPort(false));
        ...
        private int GenerateProxyRequestLine(int headersSize)
        {
            ...
            int byteIndex = 0;
            string components = this._Uri.GetComponents(UriComponents.KeepDelimiter | UriComponents.Scheme, UriFormat.UriEscaped);
            HostHeaderString str2 = new HostHeaderString(this.HostAndPort(false));
        ...
        internal string GetConnectionGroupLine()
        {
            ...
            if ((this._Uri.Scheme == Uri.UriSchemeHttps) || this.IsTunnelRequest)
            {
                if (this.UsesProxy)
                {
                    builder.Append(this.HostAndPort(true));
                    builder.Append("$");
                }
        ...
        internal string HostAndPort(bool addDefaultPort)
        {
            ...
            {
                dnsSafeHost = "[" + this.TrimScopeID(uri.DnsSafeHost) + "]";
            }
            else
            {
        ...
        {
            HostHeaderString str = new HostHeaderString(this.HostAndPort(false));
            string str2 = WebHeaderCollection.HeaderEncoding.GetString(str.Bytes, 0, str.ByteCount);
            this._HttpRequestHeaders.ChangeInternal("Host", str2);
            if (this._CookieContainer != null)
            {
        ...
        {
            get => 
                this._HttpRequestHeaders["Accept"];
            set
            {
        ...
        {
            get => 
                ((this._Booleans & Booleans.AllowAutoRedirect) != ((Booleans) 0));
            set
            {
                if (value)
                {
        ...
        {
            get => 
                ((this._Booleans & Booleans.AllowWriteStreamBuffering) != ((Booleans) 0));
            set
            {
                if (value)
                {
        ...
        {
            get => 
                (this._RequestIsAsync != System.Net.TriState.False);
            set
            {
        ...
        private bool CanGetRequestStream =>
            !this.CurrentMethod.ContentBodyNotAllowed;

        internal bool CanGetResponseStream =>
            !this.CurrentMethod.ExpectNoContentResponse;

        internal Uri ChallengedUri =>
            this.CurrentAuthenticationState.ChallengedUri;
        ...
        {
            get => 
                this._HttpRequestHeaders["Connection"];
            set
            {
        ...
        {
            get => 
                this._HttpRequestHeaders["Content-Type"];
            set
            {
        ...
        {
            get => 
                SettingsSectionInternal.Section.MaximumErrorResponseLength;
            set
            {
                ExceptionHelper.WebPermissionUnrestricted.Demand();
                if ((value < 0) && (value != -1))
        ...
        {
            get => 
                SettingsSectionInternal.Section.MaximumResponseHeadersLength;
            set
            {
                ExceptionHelper.WebPermissionUnrestricted.Demand();
                if ((value < 0) && (value != -1))
        ...
        {
            get => 
                this._HttpRequestHeaders["Expect"];
            set
            {
                if (ValidationHelper.IsBlankString(value))
                {
        ...
        {
            get => 
                ((this._Booleans & Booleans.ExpectContinue) != ((Booleans) 0));
            set
            {
                if (value)
                {
        ...
        private bool HasEntityBody =>
            (((this.HttpWriteMode == System.Net.HttpWriteMode.Chunked) || (this.HttpWriteMode == System.Net.HttpWriteMode.Buffer)) || ((this.HttpWriteMode == System.Net.HttpWriteMode.ContentLength) && (this.ContentLength > 0L)));

        public bool HaveResponse =>
            ((this._ReadAResult != null) && this._ReadAResult.InternalPeekCompleted);
        ...
        public DateTime IfModifiedSince
        {
            get
            {
                string s = this._HttpRequestHeaders["If-Modified-Since"];
                if (s == null)
                {
                    return DateTime.Now;
                }
        ...
        {
            get => 
                ((this._Booleans & Booleans.IsTunnelRequest) != ((Booleans) 0));
            set
            {
                if (value)
                {
        ...
        {
            get => 
                ((this._Booleans & Booleans.IsVersionHttp10) != ((Booleans) 0));
            set
            {
                if (value)
                {
        ...
        {
            get => 
                this._MaximumAllowedRedirections;
            set
            {
                if (value <= 0)
                {
        ...
        {
            get => 
                this._MaximumResponseHeadersLength;
            set
            {
                if (this.RequestSubmitted)
                {
        ...
        {
            get => 
                ((this._Booleans & Booleans.ProxySet) != ((Booleans) 0));
            set
            {
                if (value)
                {
        ...
        {
            get => 
                this._HttpRequestHeaders["Referer"];
            set
            {
        ...
        internal bool RequireBody =>
            this.CurrentMethod.RequireContentBody;
        ...
        {
            get => 
                ((this._Booleans & Booleans.SendChunked) != ((Booleans) 0));
            set
            {
                if (this.RequestSubmitted)
                {
        ...
        {
            get => 
                this._HttpRequestHeaders["Transfer-Encoding"];
            set
            {
                if (ValidationHelper.IsBlankString(value))
                {
        ...
        private static string UniqueGroupId =>
            Interlocked.Increment(ref s_UniqueGroupId).ToString(NumberFormatInfo.InvariantInfo);

        internal System.Net.UnlockConnectionDelegate UnlockConnectionDelegate
        {
            get => 
                this._UnlockDelegate;
            set
            {
        ...
        {
            get => 
                ((this._Booleans & Booleans.UnsafeAuthenticatedConnectionSharing) != ((Booleans) 0));
            set
            {
                ExceptionHelper.WebPermissionUnrestricted.Demand();
                if (value)
        ...
        {
            get => 
                (this.Credentials is SystemNetworkCredential);
            set
            {
                if (this.RequestSubmitted)
                {
        ...
        {
            get => 
                this._HttpRequestHeaders["User-Agent"];
            set
            {
        ...
        private bool UserRetrievedWriteStream =>
            ((this._WriteAResult != null) && this._WriteAResult.InternalPeekCompleted);
