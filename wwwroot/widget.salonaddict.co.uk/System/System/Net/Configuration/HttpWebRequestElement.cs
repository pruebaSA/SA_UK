namespace System.Net.Configuration
{
    ...
    public sealed class HttpWebRequestElement : ConfigurationElement
    {
        ...
        {
            get => 
                ((int) base[this.maximumErrorResponseLength]);
            set
            {
        ...
        {
            get => 
                ((int) base[this.maximumResponseHeadersLength]);
            set
            {
        ...
        {
            get => 
                ((int) base[this.maximumUnauthorizedUploadLength]);
            set
            {
        ...
        {
            get => 
                ((bool) base[this.useUnsafeHeaderParsing]);
            set
            {
