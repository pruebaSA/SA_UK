namespace System.Net.Configuration
{
    ...
    public sealed class SmtpSection : ConfigurationSection
    {
        ...
        {
            get => 
                ((SmtpDeliveryMethod) base[this.deliveryMethod]);
            set
            {
        ...
        public SmtpNetworkElement Network =>
            ((SmtpNetworkElement) base[this.network]);
        ...
        public SmtpSpecifiedPickupDirectoryElement SpecifiedPickupDirectory =>
            ((SmtpSpecifiedPickupDirectoryElement) base[this.specifiedPickupDirectory]);
