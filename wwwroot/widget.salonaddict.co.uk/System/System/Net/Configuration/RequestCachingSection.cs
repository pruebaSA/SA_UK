namespace System.Net.Configuration
{
    ...
    public sealed class RequestCachingSection : ConfigurationSection
    {
        ...
        {
            get => 
                ((bool) base[this.disableAllCaching]);
            set
            {
        ...
        {
            get => 
                ((TimeSpan) base[this.unspecifiedMaximumAge]);
            set
            {
