namespace System.Net.Configuration
{
    ...
    public sealed class HttpCachePolicyElement : ConfigurationElement
    {
        ...
        {
            get => 
                ((TimeSpan) base[this.maximumStale]);
            set
            {
        ...
        {
            get => 
                ((TimeSpan) base[this.minimumFresh]);
            set
            {
        ...
        {
            get => 
                ((HttpRequestCacheLevel) base[this.policyLevel]);
            set
            {
