        ...
        internal static RequestCachingSectionInternal GetSection()
        {
            ...
            lock (ClassSyncObject)
            {
                ...
                else
                {
                    ...
                    {
                        throw new ConfigurationErrorsException(System.SR.GetString("net_config_requestcaching"), new Exception(System.SR.GetString("net_nonClsCompliantException")));
                    }
                }
            }
            return internal2;
