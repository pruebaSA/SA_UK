    ...
    internal class AcceptOverlappedAsyncResult : BaseOverlappedAsyncResult
    {
        ...
        internal override object PostCompletion(int numBytes)
        {
            ...
            if (errorCode == SocketError.Success)
            {
                ...
                UnsafeNclNativeMethods.OSSOCK.GetAcceptExSockaddrs(Marshal.UnsafeAddrOfPinnedArrayElement(this.m_Buffer, 0), this.m_Buffer.Length - (this.m_AddressBufferLength * 2), this.m_AddressBufferLength, this.m_AddressBufferLength, out ptr, out num, out ptr2, out socketAddress.m_Size);
