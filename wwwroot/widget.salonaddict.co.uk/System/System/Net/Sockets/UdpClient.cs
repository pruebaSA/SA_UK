namespace System.Net.Sockets
{
    ...
    public class UdpClient : IDisposable
    {
        ...
        public IAsyncResult BeginSend(byte[] datagram, int bytes, AsyncCallback requestCallback, object state) => 
            this.BeginSend(datagram, bytes, null, requestCallback, state);
        ...
        {
            get => 
                this.m_ClientSocket.DontFragment;
            set
            {
        ...
        {
            get => 
                this.m_ClientSocket.EnableBroadcast;
            set
            {
        ...
        {
            get => 
                this.m_ClientSocket.MulticastLoopback;
            set
            {
