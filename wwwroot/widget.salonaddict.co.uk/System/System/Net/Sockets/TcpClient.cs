namespace System.Net.Sockets
{
    ...
    public class TcpClient : IDisposable
    {
        ...
        private int numericOption(SocketOptionLevel optionLevel, SocketOptionName optionName) => 
            ((int) this.Client.GetSocketOption(optionLevel, optionName));
        ...
        public bool Connected =>
            this.m_ClientSocket.Connected;

        public bool ExclusiveAddressUse
        {
            get => 
                this.m_ClientSocket.ExclusiveAddressUse;
            set
            {
        ...
        {
            get => 
                ((LingerOption) this.Client.GetSocketOption(SocketOptionLevel.Socket, SocketOptionName.Linger));
            set
            {
        ...
        {
            get => 
                this.numericOption(SocketOptionLevel.Socket, SocketOptionName.ReceiveBuffer);
            set
            {
        ...
        {
            get => 
                this.numericOption(SocketOptionLevel.Socket, SocketOptionName.ReceiveTimeout);
            set
            {
        ...
        {
            get => 
                this.numericOption(SocketOptionLevel.Socket, SocketOptionName.SendBuffer);
            set
            {
        ...
        {
            get => 
                this.numericOption(SocketOptionLevel.Socket, SocketOptionName.SendTimeout);
            set
            {
