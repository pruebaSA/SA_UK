namespace System.Net.Sockets
{
    ...
    public class Socket : IDisposable
    {
        ...
        public Socket Accept()
        {
            ...
            Socket retObject = this.CreateAcceptSocket(fd, this.m_RightEndPoint.Create(socketAddress), false);
            if (s_LoggingEnabled)
            {
                Logging.Exit(Logging.Sockets, this, "Accept", retObject);
            }
            return retObject;
        }
        ...
        public IAsyncResult BeginAccept(int receiveSize, AsyncCallback callback, object state) => 
            this.BeginAccept(null, receiveSize, callback, state);
        ...
        public IAsyncResult BeginConnect(EndPoint remoteEP, AsyncCallback callback, object state)
        {
            ...
            SocketAddress socketAddress = this.CheckCacheRemote(ref point, true);
        ...
        public IAsyncResult BeginReceiveMessageFrom(byte[] buffer, int offset, int size, SocketFlags socketFlags, ref EndPoint remoteEP, AsyncCallback callback, object state)
        {
            ...
            SocketAddress socketAddress = this.CheckCacheRemote(ref point2, false);
        ...
        private SocketAddress CheckCacheRemote(ref EndPoint remoteEP, bool isOverwrite)
        {
            ...
            SocketAddress address = remoteEP.Serialize();
        ...
        public void Connect(EndPoint remoteEP)
        {
            ...
            if (!this.Blocking)
            {
                this.m_NonBlockingConnectRightEndPoint = point;
        ...
        private static void DnsCallback(IAsyncResult result)
        {
            if (!result.CompletedSynchronously)
            {
                ...
                try
                {
                    DoDnsCallback(result, asyncState);
                }
                catch (Exception exception)
                {
        ...
        private void DoBeginAccept(Socket acceptSocket, int receiveSize, AcceptOverlappedAsyncResult asyncResult)
        {
            ...
            SocketError success = SocketError.Success;
            if (!UnsafeNclNativeMethods.OSSOCK.AcceptEx(this.m_Handle, acceptSocket.m_Handle, Marshal.UnsafeAddrOfPinnedArrayElement(asyncResult.Buffer, 0), receiveSize, addressBufferLength, addressBufferLength, out num2, asyncResult.OverlappedHandle))
            {
                success = (SocketError) Marshal.GetLastWin32Error();
            }
        ...
        public Socket EndAccept(out byte[] buffer, out int bytesTransferred, IAsyncResult asyncResult)
        {
            ...
            Socket retObject = (Socket) result.InternalWaitForCompletion();
        ...
        internal int EndMultipleSend(IAsyncResult asyncResult)
        {
            ...
            int increment = (int) result.InternalWaitForCompletion();
            result.EndCalled = true;
            result.ExtractCache(ref this.Caches.SendOverlappedCache);
            if (s_PerfCountersEnabled && (increment > 0))
            {
                NetworkingPerfCounters.AddBytesSent(increment);
            ...
            if (s_LoggingEnabled)
            {
                Logging.Exit(Logging.Sockets, this, "EndMultipleSend", increment);
            }
            return increment;
        }
        ...
        public int EndReceive(IAsyncResult asyncResult, out SocketError errorCode)
        {
            ...
            if (s_PerfCountersEnabled && (increment > 0))
            {
                NetworkingPerfCounters.AddBytesReceived(increment);
                if (this.Transport == TransportType.Udp)
                {
            ...
            if (s_LoggingEnabled)
            {
                Logging.Exit(Logging.Sockets, this, "EndReceive", increment);
            }
            return increment;
        }
        ...
        public int EndReceiveFrom(IAsyncResult asyncResult, ref EndPoint endPoint)
        {
            ...
            if (!endPoint.Serialize().Equals(result.SocketAddress))
            {
                try
                {
            ...
            if (s_LoggingEnabled)
            {
                Logging.Exit(Logging.Sockets, this, "EndReceiveFrom", increment);
            }
            return increment;
        }
        ...
        public int EndReceiveMessageFrom(IAsyncResult asyncResult, ref SocketFlags socketFlags, ref EndPoint endPoint, out IPPacketInformation ipPacketInformation)
        {
            ...
            if (s_LoggingEnabled)
            {
                Logging.Exit(Logging.Sockets, this, "EndReceiveMessageFrom", increment);
            }
            return increment;
        }
        ...
        public int EndSend(IAsyncResult asyncResult, out SocketError errorCode)
        {
            ...
            if (s_LoggingEnabled)
            {
                Logging.Exit(Logging.Sockets, this, "EndSend", increment);
            }
            return increment;
        }
        ...
        public int EndSendTo(IAsyncResult asyncResult)
        {
            ...
            if (s_LoggingEnabled)
            {
                Logging.Exit(Logging.Sockets, this, "EndSendTo", increment);
            }
            return increment;
        }
        ...
        public int IOControl(IOControlCode ioControlCode, byte[] optionInValue, byte[] optionOutValue) => 
            this.IOControl((int) ioControlCode, optionInValue, optionOutValue);
        ...
        private void LoadDisconnectEx()
        {
            ...
            if (UnsafeNclNativeMethods.OSSOCK.WSAIoctl(this.m_Handle, -939524090, ref guid, sizeof(Guid), out zero, sizeof(IntPtr), out num, IntPtr.Zero, IntPtr.Zero) != SocketError.Success)
            {
                throw new SocketException();
            }
            s_DisconnectEx = (DisconnectExDelegate) Marshal.GetDelegateForFunctionPointer(zero, typeof(DisconnectExDelegate));
            s_DisconnectEx_Blocking = (DisconnectExDelegate_Blocking) Marshal.GetDelegateForFunctionPointer(zero, typeof(DisconnectExDelegate_Blocking));
        }
        ...
        private void LoadTransmitPackets()
        {
            ...
            s_TransmitPackets = (TransmitPacketsDelegate) Marshal.GetDelegateForFunctionPointer(zero, typeof(TransmitPacketsDelegate));
        }
        ...
        private void LoadWSARecvMsg()
        {
            ...
            s_WSARecvMsg = (WSARecvMsgDelegate) Marshal.GetDelegateForFunctionPointer(zero, typeof(WSARecvMsgDelegate));
            s_WSARecvMsg_Blocking = (WSARecvMsgDelegate_Blocking) Marshal.GetDelegateForFunctionPointer(zero, typeof(WSARecvMsgDelegate_Blocking));
        }
        ...
        private static void MultipleAddressConnectCallback(IAsyncResult result)
        {
            if (!result.CompletedSynchronously)
            {
                ...
                try
                {
                    DoMultipleAddressConnectCallback(result, asyncState);
                }
                catch (Exception exception)
                {
                    if (((exception is ThreadAbortException) || (exception is StackOverflowException)) || (exception is OutOfMemoryException))
        ...
        public int Receive(IList<ArraySegment<byte>> buffers) => 
            this.Receive(buffers, SocketFlags.None);

        public int Receive(byte[] buffer) => 
            this.Receive(buffer, 0, (buffer != null) ? buffer.Length : 0, SocketFlags.None);
        ...
        public int Receive(byte[] buffer, SocketFlags socketFlags) => 
            this.Receive(buffer, 0, (buffer != null) ? buffer.Length : 0, socketFlags);
        ...
        public int Receive(IList<ArraySegment<byte>> buffers, SocketFlags socketFlags, out SocketError errorCode)
        {
            ...
            if (s_PerfCountersEnabled)
            {
                ...
                if ((num2 > 0) && !flag)
                {
                    NetworkingPerfCounters.AddBytesReceived(num2);
                    if (this.Transport == TransportType.Udp)
                    {
                        NetworkingPerfCounters.IncrementDatagramsReceived();
                    }
        ...
        public int Receive(byte[] buffer, int size, SocketFlags socketFlags) => 
            this.Receive(buffer, 0, size, socketFlags);
        ...
        public int ReceiveFrom(byte[] buffer, SocketFlags socketFlags, ref EndPoint remoteEP) => 
            this.ReceiveFrom(buffer, 0, (buffer != null) ? buffer.Length : 0, socketFlags, ref remoteEP);

        public int ReceiveFrom(byte[] buffer, int size, SocketFlags socketFlags, ref EndPoint remoteEP) => 
            this.ReceiveFrom(buffer, 0, size, socketFlags, ref remoteEP);
        ...
        public static void Select(IList checkRead, IList checkWrite, IList checkError, int microSeconds)
        {
            ...
            if ((checkRead != null) && (checkRead.Count > 0x10000))
            {
                ...
                throw new ArgumentOutOfRangeException(SR.GetString("net_sockets_toolarge_select", args));
            }
            if ((checkWrite != null) && (checkWrite.Count > 0x10000))
            {
                ...
                throw new ArgumentOutOfRangeException(SR.GetString("net_sockets_toolarge_select", objArray2));
            }
            if ((checkError != null) && (checkError.Count > 0x10000))
            {
                ...
                throw new ArgumentOutOfRangeException(SR.GetString("net_sockets_toolarge_select", objArray3));
            }
            ...
            if (UnsafeNclNativeMethods.OSSOCK.select(0, readfds, writefds, exceptfds, ref socketTime) == -1)
            {
                throw new SocketException();
            }
        ...
        public int Send(IList<ArraySegment<byte>> buffers) => 
            this.Send(buffers, SocketFlags.None);

        public int Send(byte[] buffer) => 
            this.Send(buffer, 0, (buffer != null) ? buffer.Length : 0, SocketFlags.None);
        ...
        public int Send(byte[] buffer, SocketFlags socketFlags) => 
            this.Send(buffer, 0, (buffer != null) ? buffer.Length : 0, socketFlags);
        ...
        public int Send(IList<ArraySegment<byte>> buffers, SocketFlags socketFlags, out SocketError errorCode)
        {
            ...
            {
                NetworkingPerfCounters.AddBytesSent(num2);
                if (this.Transport == TransportType.Udp)
                {
                    NetworkingPerfCounters.IncrementDatagramsSent();
                }
        ...
        public int Send(byte[] buffer, int size, SocketFlags socketFlags) => 
            this.Send(buffer, 0, size, socketFlags);
        ...
        public int SendTo(byte[] buffer, EndPoint remoteEP) => 
            this.SendTo(buffer, 0, (buffer != null) ? buffer.Length : 0, SocketFlags.None, remoteEP);

        public int SendTo(byte[] buffer, SocketFlags socketFlags, EndPoint remoteEP) => 
            this.SendTo(buffer, 0, (buffer != null) ? buffer.Length : 0, socketFlags, remoteEP);

        public int SendTo(byte[] buffer, int size, SocketFlags socketFlags, EndPoint remoteEP) => 
            this.SendTo(buffer, 0, size, socketFlags, remoteEP);
        ...
        private void setLingerOption(LingerOption lref)
        {
            Linger linger = new Linger {
                OnOff = lref.Enabled ? ((short) 1) : ((short) 0),
                Time = (short) lref.LingerTime
            };
                ...
                if (s_ConnectEx == null)
                {
                    lock (InternalSyncObject)
                    {
                        if (s_ConnectEx == null)
                        {
                            ...
                            s_ConnectEx = (ConnectExDelegate) Marshal.GetDelegateForFunctionPointer(zero, typeof(ConnectExDelegate));
                        }
                    }
                }
                return s_ConnectEx;
        ...
        {
            get => 
                ((LingerOption) this.GetSocketOption(SocketOptionLevel.Socket, SocketOptionName.Linger));
            set
            {
        ...
        {
            get => 
                ((int) this.GetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReceiveBuffer));
            set
            {
                if (value < 0)
                {
        ...
        {
            get => 
                ((int) this.GetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReceiveTimeout));
            set
            {
                if (value < -1)
                {
        ...
        {
            get => 
                ((int) this.GetSocketOption(SocketOptionLevel.Socket, SocketOptionName.SendBuffer));
            set
            {
                if (value < 0)
                {
        ...
        {
            get => 
                ((int) this.GetSocketOption(SocketOptionLevel.Socket, SocketOptionName.SendTimeout));
            set
            {
                if (value < -1)
                {
        ...
        public short Ttl
        {
            ...
            set
            {
                if ((value < -1) || ((value == -1) && (this.addressFamily != System.Net.Sockets.AddressFamily.InterNetworkV6)))
                {
                    throw new ArgumentOutOfRangeException("value");
                }
                if (this.addressFamily == System.Net.Sockets.AddressFamily.InterNetwork)
