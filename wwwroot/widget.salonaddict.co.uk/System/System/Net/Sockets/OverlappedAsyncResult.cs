namespace System.Net.Sockets
{
    ...
    internal class OverlappedAsyncResult : BaseOverlappedAsyncResult
    {
        ...
        internal IntPtr GetSocketAddressPtr() => 
            Marshal.UnsafeAddrOfPinnedArrayElement(this.m_SocketAddress.m_Buffer, 0);

        internal IntPtr GetSocketAddressSizePtr() => 
            Marshal.UnsafeAddrOfPinnedArrayElement(this.m_SocketAddress.m_Buffer, this.m_SocketAddress.GetAddressSizeOffset());
