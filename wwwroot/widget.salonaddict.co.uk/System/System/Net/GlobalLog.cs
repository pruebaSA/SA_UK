namespace System.Net
{
    ...
    internal static class GlobalLog
    {
        ...
        [Conditional("DEBUG"), Conditional("_FORCE_ASSERTS"), ReliabilityContract(Consistency.MayCorruptAppDomain, Cer.None)]
        public static void Assert(string message)
        {
        }

        [Conditional("DEBUG"), ReliabilityContract(Consistency.MayCorruptAppDomain, Cer.None), Conditional("_FORCE_ASSERTS")]
