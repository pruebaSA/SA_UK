namespace System.Net
{
    ...
    public class WebHeaderCollection : NameValueCollection, ISerializable
    {
        ...
        internal static bool IsValidToken(string token) => 
            (((token.Length > 0) && (token.IndexOfAny(ValidationHelper.InvalidParamChars) == -1)) && !ContainsNonAsciiChars(token));
        ...
        public byte[] ToByteArray() => 
            HeaderEncoding.GetBytes(this.ToString());

        public override string ToString() => 
            GetAsString(this, false, false);

        internal string ToString(bool forTrace) => 
            GetAsString(this, false, true);
        ...
        public override int Count =>
            (((this.m_InnerCollection == null) ? 0 : this.m_InnerCollection.Count) + this.m_NumCommonHeaders);
