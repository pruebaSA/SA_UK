namespace System.Net.NetworkInformation
{
    ...
    internal class SystemNetworkInterface : NetworkInterface
    {
        ...
        public override IPv4InterfaceStatistics GetIPv4Statistics() => 
            new SystemIPv4InterfaceStatistics((long) this.index);

        internal static NetworkInterface[] GetNetworkInterfaces() => 
            GetNetworkInterfaces(AddressFamily.Unspecified);
        ...
        public override bool Supports(NetworkInterfaceComponent networkInterfaceComponent) => 
            (((networkInterfaceComponent == NetworkInterfaceComponent.IPv6) && (this.ipv6Index > 0)) || ((networkInterfaceComponent == NetworkInterfaceComponent.IPv4) && (this.index > 0)));
