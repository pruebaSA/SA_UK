namespace System.Net
{
    ...
    internal class CommandStream : PooledStream
    {
        ...
        protected Exception GenerateException(WebExceptionStatus status, Exception innerException) => 
            new WebException(NetRes.GetWebStatusString("net_connclosed", status), innerException, status, null);

        protected Exception GenerateException(FtpStatusCode code, string statusDescription, Exception innerException) => 
            new WebException(SR.GetString("net_servererror", new object[] { NetRes.GetWebStatusCodeString(code, statusDescription) }), innerException, WebExceptionStatus.ProtocolError, null);
