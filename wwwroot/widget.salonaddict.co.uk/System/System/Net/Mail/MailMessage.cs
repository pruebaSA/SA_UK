namespace System.Net.Mail
{
    ...
    public class MailMessage : IDisposable
    {
                    ...
                    if (view != null)
                    {
                        ...
                        if (view.LinkedResources.Count > 0)
                        {
                            MimeMultiPart item = new MimeMultiPart(MimeMultiPartType.Related) {
                                ContentType = { Parameters = { ["type"] = view.ContentType.MediaType } },
                                ContentLocation = view.MimePart.ContentLocation,
                                Parts = { view.MimePart }
                            };
        ...
        {
            get => 
                this.deliveryStatusNotification;
            set
            {
