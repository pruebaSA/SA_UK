namespace System.Net.Mail
{
    ...
    internal class MailWriter : BaseWriter
    {
        ...
        internal override IAsyncResult BeginGetContentStream(AsyncCallback callback, object state) => 
            this.BeginGetContentStream(ContentTransferEncoding.SevenBit, callback, state);
        ...
        internal override Stream GetContentStream() => 
            this.GetContentStream(ContentTransferEncoding.SevenBit);

        internal Stream GetContentStream(ContentTransferEncoding contentTransferEncoding) => 
            this.GetContentStream(contentTransferEncoding, null);
        ...
        private static void OnWrite(IAsyncResult result)
        {
            if (!result.CompletedSynchronously)
            {
                ...
                {
                    asyncState.Leave(new Exception(SR.GetString("net_nonClsCompliantException")));
                }
            }
        }
