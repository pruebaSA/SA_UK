namespace System.Net.Cache
{
    ...
    internal class HttpRequestCacheValidator : RequestCacheValidator
    {
        ...
        internal override RequestCacheValidator CreateValidator() => 
            new HttpRequestCacheValidator(base.StrictCacheErrors, base.UnspecifiedMaxAge);
        ...
        {
            get => 
                this.m_RequestVars.IsCacheRange;
            set
            {
        ...
        {
            get => 
                this.m_RequestVars.IsUserRange;
            set
            {
        ...
        {
            get => 
                this.m_ResponseVars.CacheControl;
            set
            {
        ...
        {
            get => 
                this.m_ResponseVars.EntityLength;
            set
            {
        ...
        {
            get => 
                this.m_ResponseVars.LastModified;
            set
            {
        ...
        {
            get => 
                this.m_ResponseVars.RangeStart;
            set
            {
