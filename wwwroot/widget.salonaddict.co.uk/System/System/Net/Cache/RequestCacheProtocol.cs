    ...
    internal class RequestCacheProtocol
    {
        ...
        internal CacheValidationStatus GetRevalidateStatus(WebResponse response, Stream responseStream)
        {
            ...
            try
            {
                if (Logging.On)
                {
                    Logging.Enter(Logging.RequestCache, this, "GetRevalidateStatus", this._Validator?.Request);
                }
        ...
        internal bool IsCacheFresh =>
            ((this._Validator != null) && (this._Validator.CacheFreshnessStatus == CacheFreshnessStatus.Fresh));

        internal Exception ProtocolException =>
            this._ProtocolException;
