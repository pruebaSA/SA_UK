namespace System.Net
{
    ...
    internal class CredentialKey
    {
        ...
        public override string ToString() => 
            ("[" + this.UriPrefixLength.ToString(NumberFormatInfo.InvariantInfo) + "]:" + ValidationHelper.ToString(this.UriPrefix) + ":" + ValidationHelper.ToString(this.AuthenticationType));
    }
}
