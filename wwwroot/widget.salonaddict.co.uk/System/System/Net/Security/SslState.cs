    ...
    internal class SslState
    {
        ...
        private void AsyncResumeHandshakeRead(object state)
        {
            ...
            catch
            {
                ...
                this.FinishHandshake(new Exception(SR.GetString("net_nonClsCompliantException")), asyncRequest);
            }
        }
        ...
        private static void PartialFrameCallback(AsyncProtocolRequest asyncRequest)
        {
            ...
            catch
            {
                ...
                asyncObject.FinishHandshake(new Exception(SR.GetString("net_nonClsCompliantException")), asyncRequest);
            }
        }

        private SecurityStatus PrivateDecryptData(byte[] buffer, ref int offset, ref int count) => 
            this.Context.Decrypt(buffer, ref offset, ref count);
        ...
        internal void ValidateCreateContext(bool isServer, string targetHost, SslProtocols enabledSslProtocols, X509Certificate serverCertificate, X509CertificateCollection clientCertificates, bool remoteCertRequired, bool checkCertRevocationStatus, bool checkCertName)
        {
            ...
            if (isServer)
            {
                enabledSslProtocols &= 0x40000555;
            ...
            {
                enabledSslProtocols &= -2147480918;
            }
        ...
        private static void WriteCallback(IAsyncResult transportResult)
        {
            if (!transportResult.CompletedSynchronously)
            {
                ...
                catch
                {
                    ...
                    asyncObject.FinishHandshake(new Exception(SR.GetString("net_nonClsCompliantException")), asyncState);
                }
            }
        }

        internal bool CheckCertRevocationStatus =>
            ((this.Context != null) && this.Context.CheckCertRevocationStatus);
        ...
        internal bool IsAuthenticated =>
            ((((this._Context != null) && this._Context.IsValidContext) && (this._Exception == null)) && this.HandshakeCompleted);

        internal bool IsCertValidationFailed =>
            this._CertValidationFailed;

        internal bool IsMutuallyAuthenticated =>
            ((this.IsAuthenticated && ((this.Context.IsServer ? this.Context.LocalServerCertificate : this.Context.LocalClientCertificate) != null)) && this.Context.IsRemoteCertificateAvailable);

        internal bool IsServer =>
            ((this.Context != null) && this.Context.IsServer);
        ...
        internal SslProtocols SslProtocol
        {
            get
            {
                ...
                if ((protocol & 0x300) != SslProtocols.None)
                {
                    protocol |= 0x300;
                }
                if ((protocol & 0xc00) != SslProtocols.None)
                {
                    protocol |= 0xc00;
                }
                return protocol;
