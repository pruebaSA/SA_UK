namespace System.Net.Security
{
    ...
    internal class NegoState
    {
        ...
        internal void ProcessAuthentication(LazyAsyncResult lazyResult)
        {
            ...
            {
                throw this.SetException(exception);
            }
            catch
            {
        ...
        private bool HandshakeComplete =>
            (this._Context.IsCompleted && this._Context.IsValidContext);

        internal bool IsAuthenticated =>
            ((((this._Context != null) && this.HandshakeComplete) && (this._Exception == null)) && this._RemoteOk);

        internal bool IsEncrypted =>
            (this.IsAuthenticated && this._Context.IsConfidentialityFlag);
        ...
        internal bool IsServer =>
            ((this._Context != null) && this._Context.IsServer);
