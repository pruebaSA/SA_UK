namespace System.Net.Security
{
    ...
    public class NegotiateStream : AuthenticatedStream
    {
        ...
        public virtual IAsyncResult BeginAuthenticateAsClient(AsyncCallback asyncCallback, object asyncState) => 
            this.BeginAuthenticateAsClient((NetworkCredential) CredentialCache.DefaultCredentials, null, string.Empty, ProtectionLevel.EncryptAndSign, TokenImpersonationLevel.Identification, asyncCallback, asyncState);

        [HostProtection(SecurityAction.LinkDemand, ExternalThreading=true)]
        public virtual IAsyncResult BeginAuthenticateAsClient(NetworkCredential credential, string targetName, AsyncCallback asyncCallback, object asyncState) => 
            this.BeginAuthenticateAsClient(credential, null, targetName, ProtectionLevel.EncryptAndSign, TokenImpersonationLevel.Identification, asyncCallback, asyncState);
        ...
        public virtual IAsyncResult BeginAuthenticateAsClient(NetworkCredential credential, ChannelBinding binding, string targetName, AsyncCallback asyncCallback, object asyncState) => 
            this.BeginAuthenticateAsClient(credential, binding, targetName, ProtectionLevel.EncryptAndSign, TokenImpersonationLevel.Identification, asyncCallback, asyncState);
        ...
        public virtual IAsyncResult BeginAuthenticateAsClient(NetworkCredential credential, string targetName, ProtectionLevel requiredProtectionLevel, TokenImpersonationLevel allowedImpersonationLevel, AsyncCallback asyncCallback, object asyncState) => 
            this.BeginAuthenticateAsClient(credential, null, targetName, requiredProtectionLevel, allowedImpersonationLevel, asyncCallback, asyncState);
        ...
        public virtual IAsyncResult BeginAuthenticateAsServer(AsyncCallback asyncCallback, object asyncState) => 
            this.BeginAuthenticateAsServer((NetworkCredential) CredentialCache.DefaultCredentials, null, ProtectionLevel.EncryptAndSign, TokenImpersonationLevel.Identification, asyncCallback, asyncState);

        [HostProtection(SecurityAction.LinkDemand, ExternalThreading=true)]
        public virtual IAsyncResult BeginAuthenticateAsServer(ExtendedProtectionPolicy policy, AsyncCallback asyncCallback, object asyncState) => 
            this.BeginAuthenticateAsServer((NetworkCredential) CredentialCache.DefaultCredentials, policy, ProtectionLevel.EncryptAndSign, TokenImpersonationLevel.Identification, asyncCallback, asyncState);
        ...
        public virtual IAsyncResult BeginAuthenticateAsServer(NetworkCredential credential, ProtectionLevel requiredProtectionLevel, TokenImpersonationLevel requiredImpersonationLevel, AsyncCallback asyncCallback, object asyncState) => 
            this.BeginAuthenticateAsServer(credential, null, requiredProtectionLevel, requiredImpersonationLevel, asyncCallback, asyncState);
        ...
        private static void WriteCallback(IAsyncResult transportResult)
        {
            if (!transportResult.CompletedSynchronously)
            {
                ...
                catch
                {
                    ...
                    asyncState.CompleteWithError(new Exception(SR.GetString("net_nonClsCompliantException")));
                }
            }
        }

        public override bool CanRead =>
            (this.IsAuthenticated && base.InnerStream.CanRead);
        ...
        public override bool CanWrite =>
            (this.IsAuthenticated && base.InnerStream.CanWrite);

        public virtual TokenImpersonationLevel ImpersonationLevel =>
            this._NegoState.AllowedImpersonation;

        private byte[] InternalBuffer =>
            this._InternalBuffer;

        private int InternalBufferCount =>
            this._InternalBufferCount;

        private int InternalOffset =>
            this._InternalOffset;

        public override bool IsAuthenticated =>
            this._NegoState.IsAuthenticated;

        public override bool IsEncrypted =>
            this._NegoState.IsEncrypted;

        public override bool IsMutuallyAuthenticated =>
            this._NegoState.IsMutuallyAuthenticated;

        public override bool IsServer =>
            this._NegoState.IsServer;

        public override bool IsSigned =>
            this._NegoState.IsSigned;
