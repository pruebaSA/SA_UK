namespace System.Net
{
    ...
    internal class WebProxyScriptHelper : IReflect
    {
        ...
        private static bool isGMT(string gmt) => 
            (string.Compare(gmt, "GMT", StringComparison.OrdinalIgnoreCase) == 0);
        ...
        MemberInfo[] IReflect.GetMember(string name, BindingFlags bindingAttr) => 
            new MemberInfo[] { new MyMethodInfo(name) };
        ...
        private class MyMethodInfo : MethodInfo
        {
            ...
            public override ParameterInfo[] GetParameters() => 
                typeof(WebProxyScriptHelper).GetMethod(this.name, ~BindingFlags.Default).GetParameters();

            public override object Invoke(object target, BindingFlags bindingAttr, Binder binder, object[] args, CultureInfo culture) => 
                typeof(WebProxyScriptHelper).GetMethod(this.name, ~BindingFlags.Default).Invoke(target, ~BindingFlags.Default, binder, args, culture);

            public override bool IsDefined(Type type, bool inherit) => 
                type.Equals(typeof(WebProxyScriptHelper));

            public override MethodAttributes Attributes =>
                MethodAttributes.Public;

            public override Type DeclaringType =>
                typeof(WebProxyScriptHelper.MyMethodInfo);
