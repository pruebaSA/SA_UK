namespace System.Net
{
    ...
    public sealed class HttpListenerContext
    {
        ...
        internal static unsafe void CancelRequest(SafeCloseHandle requestQueueHandle, ulong requestId)
        {
            UnsafeNclNativeMethods.HttpApi.HTTP_DATA_CHUNK pEntityChunks = new UnsafeNclNativeMethods.HttpApi.HTTP_DATA_CHUNK {
                DataChunkType = UnsafeNclNativeMethods.HttpApi.HTTP_DATA_CHUNK_TYPE.HttpDataChunkFromMemory
            };
            pEntityChunks.pBuffer = (byte*) &pEntityChunks;
            UnsafeNclNativeMethods.HttpApi.HttpSendResponseEntityBody(requestQueueHandle, requestId, 1, 1, &pEntityChunks, null, SafeLocalFree.Zero, 0, null, null);
        }
        ...
        internal UnsafeNclNativeMethods.HttpApi.HTTP_VERB GetKnownMethod() => 
            UnsafeNclNativeMethods.HttpApi.GetKnownVerb(this.Request.RequestBuffer, this.Request.OriginalBlobAddress);
        ...
        internal string MutualAuthentication =>
            this.m_MutualAuthentication;

        internal bool PromoteCookiesToRfc2965 =>
            this.m_PromoteCookiesToRfc2965;
        ...
        internal SafeCloseHandle RequestQueueHandle =>
            this.m_Listener.RequestQueueHandle;
