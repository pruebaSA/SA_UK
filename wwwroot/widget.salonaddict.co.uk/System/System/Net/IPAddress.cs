namespace System.Net
{
    ...
    public class IPAddress
    {
        ...
        internal const long LoopbackMask = 0x7fL;
        ...
        public static bool IsLoopback(IPAddress address)
        {
            ...
            return ((address.m_Address & 0x7fL) == (Loopback.m_Address & 0x7fL));
        }
        ...
        public override unsafe string ToString()
        {
            if (this.m_ToString == null)
            {
                ...
                {
                    int startIndex = 15;
                    char* chPtr = (char*) stackalloc byte[(2 * 15)];
        ...
        public bool IsIPv6LinkLocal =>
            ((this.m_Family == System.Net.Sockets.AddressFamily.InterNetworkV6) && ((this.m_Numbers[0] & 0xffc0) == 0xfe80));

        public bool IsIPv6Multicast =>
            ((this.m_Family == System.Net.Sockets.AddressFamily.InterNetworkV6) && ((this.m_Numbers[0] & 0xff00) == 0xff00));

        public bool IsIPv6SiteLocal =>
            ((this.m_Family == System.Net.Sockets.AddressFamily.InterNetworkV6) && ((this.m_Numbers[0] & 0xffc0) == 0xfec0));
