namespace System.Net
{
    ...
    public class HttpWebResponse : WebResponse, ISerializable
    {
        ...
        internal bool CanGetResponseStream() => 
            !this.m_Verb.ExpectNoContentResponse;
        ...
        public override bool IsMutuallyAuthenticated =>
            this.m_IsMutuallyAuthenticated;
        ...
        internal bool KeepAlive
        {
            get
            {
                ...
                {
                    string str2 = this.Headers["Keep-Alive"];
                    return (str2 != null);
                }
                ...
                string str3 = this.Headers["Connection"];
                if ((str3 != null) && (str3.ToLower(CultureInfo.InvariantCulture).IndexOf("close") >= 0))
                {
                    return (str3.ToLower(CultureInfo.InvariantCulture).IndexOf("keep-alive") >= 0);
                }
                return true;
            }
        }
