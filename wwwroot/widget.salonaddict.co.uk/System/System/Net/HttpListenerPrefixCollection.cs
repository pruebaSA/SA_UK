namespace System.Net
{
    ...
    public class HttpListenerPrefixCollection : ICollection<string>, IEnumerable<string>, IEnumerable
    {
        ...
        public bool Contains(string uriPrefix) => 
            this.m_HttpListener.m_UriPrefixes.Contains(uriPrefix);
        ...
        public IEnumerator<string> GetEnumerator() => 
            new ListenerPrefixEnumerator(this.m_HttpListener.m_UriPrefixes.Keys.GetEnumerator());

        public bool Remove(string uriPrefix) => 
            this.m_HttpListener.RemovePrefix(uriPrefix);

        IEnumerator IEnumerable.GetEnumerator() => 
            null;

        public int Count =>
            this.m_HttpListener.m_UriPrefixes.Count;
