namespace Microsoft.VisualBasic
{
    ...
    internal class VBCodeGenerator : CodeCompiler
    {
        ...
        protected override string CmdArgsFromParameters(CompilerParameters options)
        {
            ...
            foreach (string str3 in options.EmbeddedResources)
            {
                builder.Append("/res:\"");
                builder.Append(str3);
                builder.Append("\" ");
            }
            foreach (string str4 in options.LinkedResources)
            {
        ...
        protected override void GenerateEvent(CodeMemberEvent e, CodeTypeDeclaration c)
        {
            if (!base.IsCurrentDelegate && !base.IsCurrentEnum)
            {
                ...
                {
                    string str2 = e.PrivateImplementationType.BaseType.Replace('.', '_');
        ...
        protected override string GetResponseFileCmdArgs(CompilerParameters options, string cmdArgs) => 
            ("/noconfig " + base.GetResponseFileCmdArgs(options, cmdArgs));
        ...
        private bool IsDocComment(CodeCommentStatement comment) => 
            (((comment != null) && (comment.Comment != null)) && comment.Comment.DocComment);

        private bool IsGeneratingStatements() => 
            (this.statementDepth > 0);

        public static bool IsKeyword(string value) => 
            FixedStringLookup.Contains(keywords, value, true);
        ...
        private bool IsCurrentModule =>
            (base.IsCurrentClass && this.GetUserData(base.CurrentClass, "Module", false));
