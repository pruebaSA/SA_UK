namespace Microsoft.Win32
{
    ...
    public sealed class SystemEvents
    {
        ...
        [Obsolete("This event has been deprecated. http://go.microsoft.com/fwlink/?linkid=14202"), Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        private IntPtr CreateBroadcastWindow()
        {
            ...
            return Microsoft.Win32.UnsafeNativeMethods.CreateWindowEx(0, this.WndClass.lpszClassName, this.WndClass.lpszClassName, -2147483648, 0, 0, 0, 0, NativeMethods.NullHandleRef, NativeMethods.NullHandleRef, new HandleRef(this, moduleHandle), null);
        }
        ...
        private IntPtr OnCreateTimer(IntPtr wParam)
        {
            ...
            if (!(Microsoft.Win32.UnsafeNativeMethods.SetTimer(new HandleRef(this, this.windowHandle), new HandleRef(this, handle), (int) wParam, NativeMethods.NullHandleRef) == IntPtr.Zero))
            {
                return handle;
            }
            return IntPtr.Zero;
        ...
        private bool OnKillTimer(IntPtr wParam) => 
            Microsoft.Win32.UnsafeNativeMethods.KillTimer(new HandleRef(this, this.windowHandle), new HandleRef(this, wParam));
        ...
        private void WindowThreadProc()
        {
            try
            {
                ...
                if (this.windowHandle != IntPtr.Zero)
                {
                    ...
                    Label_0072:
                        if (Microsoft.Win32.UnsafeNativeMethods.PeekMessage(ref msg, NativeMethods.NullHandleRef, 0, 0, 1))
                        {
                            goto Label_0053;
                        }
                    }
            ...
            get
            {
                if (executablePath == null)
                {
                    ...
                    if (entryAssembly == null)
                    {
                        ...
                        Microsoft.Win32.UnsafeNativeMethods.GetModuleFileName(NativeMethods.NullHandleRef, buffer, buffer.Capacity);
        ...
        private NativeMethods.WNDCLASS WndClass
        {
            get
            {
                ...
                {
                    IntPtr moduleHandle = Microsoft.Win32.UnsafeNativeMethods.GetModuleHandle(null);
                    className = string.Format(CultureInfo.InvariantCulture, ".NET-BroadcastEventWindow.{0}.{1}.{2}", new object[] { "2.0.0.0", Convert.ToString(AppDomain.CurrentDomain.GetHashCode(), 0x10), domainQualifier });
