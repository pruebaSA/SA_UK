namespace Microsoft.CSharp
{
    ...
    internal class CSharpCodeGenerator : ICodeCompiler, ICodeGenerator
    {
        ...
        static CSharpCodeGenerator()
        {
            ...
            strArray[4] = new string[] { "break", "catch", "class", "const", "event", "false", "fixed", "float", "sbyte", "short", "throw", "ulong", "using", "where", "while", "yield" };
            ...
            strArray[6] = new string[] { "checked", "decimal", "default", "finally", "foreach", "partial", "private", "virtual" };
        ...
        private static bool IsKeyword(string value) => 
            FixedStringLookup.Contains(keywords, value, false);
        ...
        private bool IsCurrentClass =>
            (((this.currentClass != null) && !(this.currentClass is CodeTypeDelegate)) && this.currentClass.IsClass);

        private bool IsCurrentDelegate =>
            ((this.currentClass != null) && (this.currentClass is CodeTypeDelegate));

        private bool IsCurrentEnum =>
            (((this.currentClass != null) && !(this.currentClass is CodeTypeDelegate)) && this.currentClass.IsEnum);

        private bool IsCurrentInterface =>
            (((this.currentClass != null) && !(this.currentClass is CodeTypeDelegate)) && this.currentClass.IsInterface);

        private bool IsCurrentStruct =>
            (((this.currentClass != null) && !(this.currentClass is CodeTypeDelegate)) && this.currentClass.IsStruct);
