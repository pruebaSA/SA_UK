namespace MS.Internal
{
    ...
    internal class TokenizerHelper
    {
        ...
        internal void LastTokenRequired()
        {
            ...
            {
                throw new InvalidOperationException(System.Windows.SR.Get("TokenizerHelperExtraDataEncountered"));
            }
        }
        ...
        internal bool NextToken(bool allowQuotedToken, char separator)
        {
            ...
            if (num > 0)
            {
                throw new InvalidOperationException(System.Windows.SR.Get("TokenizerHelperMissingEndQuote"));
            }
            ...
            {
                throw new InvalidOperationException(System.Windows.SR.Get("TokenizerHelperEmptyToken"));
            }
            return true;
        }
        ...
        internal string NextTokenRequired()
        {
            ...
            {
                throw new InvalidOperationException(System.Windows.SR.Get("TokenizerHelperPrematureStringTermination"));
            }
