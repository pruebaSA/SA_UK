namespace MS.Internal.IO.Zip
{
    ...
    internal class ProgressiveCrcCalculatingStream : Stream
    {
        ...
        internal ProgressiveCrcCalculatingStream(ZipIOBlockManager blockManager, Stream underlyingStream) : this(blockManager, underlyingStream, 0)
        {
        ...
        private bool CanValidateCrcWithoutRead() => 
            (this._underlyingStream.CanSeek && (this._highWaterMark == this._underlyingStream.Length));
        ...
        public override bool CanRead =>
            ((this._underlyingStream != null) && this._underlyingStream.CanRead);

        public override bool CanSeek =>
            ((this._underlyingStream != null) && this._underlyingStream.CanSeek);

        public override bool CanWrite =>
            ((this._underlyingStream != null) && this._underlyingStream.CanWrite);
