    ...
    internal class CompressStream : Stream
    {
        ...
        private void UpdateUncompressedDataLength(long dataLength)
        {
            if ((this._cachedLength >= 0L) && !this._lengthVerified)
            {
                ...
                {
                    throw new FileFormatException(System.Windows.SR.Get("CompressLengthMismatch"));
                }
                this._lengthVerified = true;
            }
        ...
        public override bool CanRead =>
            ((this._mode != Mode.Disposed) && this._baseStream.CanRead);

        public override bool CanSeek =>
            ((this._mode != Mode.Disposed) && this._baseStream.CanSeek);

        public override bool CanWrite =>
            ((this._mode != Mode.Disposed) && this._baseStream.CanWrite);

        internal bool IsDisposed =>
            (this._mode == Mode.Disposed);
