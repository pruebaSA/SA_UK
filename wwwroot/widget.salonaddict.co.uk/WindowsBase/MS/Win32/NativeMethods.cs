namespace MS.Win32
{
    ...
    internal class NativeMethods
    {
        ...
        internal const uint ACCESS_SYSTEM_SECURITY = 0x1000000;
        ...
        {
            public int cbSize = SecurityHelper.SizeOf(typeof(NativeMethods.ANIMATIONINFO));
        ...
        internal class BitmapHandle : SafeHandle
        {
            ...
            {
                MS.Win32.HandleCollector.Add(base.handle, this.HandleCollectorType);
            }

            public HandleRef MakeHandleRef(object wrapper) => 
                new HandleRef(wrapper, base.handle);

            [SecurityCritical]
            protected override bool ReleaseHandle()
            {
                MS.Win32.HandleCollector.Remove(base.handle, NativeMethods.CommonHandles.GDI);
        ...
        public struct BITMAPINFO
        {
            ...
            {
                this.bmiHeader_biSize = SecurityHelper.SizeOf(typeof(NativeMethods.BITMAPINFO));
        ...
        {
            public static readonly int Accelerator = MS.Win32.HandleCollector.RegisterType("Accelerator", 80, 50);
            public static readonly int Cursor = MS.Win32.HandleCollector.RegisterType("Cursor", 20, 500);
            public static readonly int EMF = MS.Win32.HandleCollector.RegisterType("EnhancedMetaFile", 20, 500);
            public static readonly int Find = MS.Win32.HandleCollector.RegisterType("Find", 0, 0x3e8);
            public static readonly int GDI = MS.Win32.HandleCollector.RegisterType("GDI", 50, 500);
            public static readonly int HDC = MS.Win32.HandleCollector.RegisterType("HDC", 100, 2);
            public static readonly int Icon = MS.Win32.HandleCollector.RegisterType("Icon", 20, 500);
            public static readonly int Kernel = MS.Win32.HandleCollector.RegisterType("Kernel", 0, 0x3e8);
            public static readonly int Menu = MS.Win32.HandleCollector.RegisterType("Menu", 30, 0x3e8);
            public static readonly int Window = MS.Win32.HandleCollector.RegisterType("Window", 5, 0x3e8);
        }
        ...
        internal sealed class CursorHandle : NativeMethods.IconHandle
        {
            ...
            protected override bool ReleaseHandle()
            {
                MS.Win32.HandleCollector.Remove(base.handle, this.HandleCollectorType);
                return UnsafeNativeMethods.DestroyCursor(base.handle);
            }

            internal override int HandleCollectorType =>
                NativeMethods.CommonHandles.Cursor;
        }
        ...
        internal class DOCHOSTUIINFO
        {
            ...
            internal int cbSize = SecurityHelper.SizeOf(typeof(NativeMethods.DOCHOSTUIINFO));
        ...
        public struct HDC
        {
            ...
            public static NativeMethods.HDC Cast(IntPtr h) => 
                new NativeMethods.HDC { h = h };

            public HandleRef MakeHandleRef(object wrapper) => 
                new HandleRef(wrapper, this.h);

            public static NativeMethods.HDC NULL =>
                new NativeMethods.HDC { h=IntPtr.Zero };
        }
        ...
        internal class IconHandle : SafeHandle
        {
            ...
            protected override bool ReleaseHandle()
            {
                MS.Win32.HandleCollector.Remove(base.handle, NativeMethods.CommonHandles.Icon);
                return UnsafeNativeMethods.DestroyIcon(base.handle);
            }

            internal virtual int HandleCollectorType =>
                NativeMethods.CommonHandles.Icon;
        ...
        {
            public int cbSize = SecurityHelper.SizeOf(typeof(NativeMethods.ICONMETRICS));
        ...
        {
            public int cbSize = SecurityHelper.SizeOf(typeof(NativeMethods.MENUITEMINFO_T));
            public int fMask;
            public int fType;
            public int fState;
            public int wID;
        ...
        {
            internal int cbSize = SecurityHelper.SizeOf(typeof(NativeMethods.MONITORINFOEX));
        ...
        {
            public int cbSize = SecurityHelper.SizeOf(typeof(NativeMethods.NONCLIENTMETRICS));
        ...
        {
            public int lStructSize = SecurityHelper.SizeOf(typeof(NativeMethods.OPENFILENAME_I));
        ...
        internal sealed class OSVERSIONINFOEX
        {
            ...
            {
                this.osVersionInfoSize = SecurityHelper.SizeOf(this);
            }
        }
        ...
        {
            public int nLength = SecurityHelper.SizeOf(typeof(NativeMethods.SECURITY_ATTRIBUTES));
        ...
        {
            [MarshalAs(UnmanagedType.U4)]
            public uint cb = ((uint) SecurityHelper.SizeOf(typeof(NativeMethods.tagCONTROLINFO)));
            public IntPtr hAccel;
        ...
        {
            public int cbSize = SecurityHelper.SizeOf(typeof(NativeMethods.TRACKMOUSEEVENT));
            public int dwFlags;
        ...
        public class XFORM
        {
            ...
            public override string ToString() => 
                string.Format(CultureInfo.CurrentCulture, "[{0}, {1}, {2}, {3}, {4}, {5}]", new object[] { this.eM11, this.eM12, this.eM21, this.eM22, this.eDx, this.eDy });
