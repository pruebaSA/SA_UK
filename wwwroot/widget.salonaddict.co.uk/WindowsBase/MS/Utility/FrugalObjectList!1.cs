namespace MS.Utility
{
    ...
    internal class FrugalObjectList<T>
    {
            ...
            if (state != FrugalListStoreState.Success)
            {
                if (FrugalListStoreState.ThreeItemList != state)
                {
                    if (FrugalListStoreState.SixItemList != state)
                    {
                        ...
                        {
                            throw new InvalidOperationException(System.Windows.SR.Get("FrugalList_CannotPromoteBeyondArray"));
                        }
        ...
        public bool Contains(T value) => 
            (((this._listStore != null) && (this._listStore.Count > 0)) && this._listStore.Contains(value));
        ...
        public bool Remove(T value) => 
            (((this._listStore != null) && (this._listStore.Count > 0)) && this._listStore.Remove(value));
        ...
        protected class Compacter
        {
            ...
            {
                this._list = list;
                this._storeCompacter = this._list._listStore?.NewCompacter(newCount);
            }
