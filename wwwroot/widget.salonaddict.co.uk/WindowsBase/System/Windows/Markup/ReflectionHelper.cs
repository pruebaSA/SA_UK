namespace System.Windows.Markup
{
    ...
    internal static class ReflectionHelper
    {
        ...
        internal static Assembly GetAlreadyLoadedAssembly(string assemblyNameLookup) => 
            ((Assembly) _loadedAssembliesHash[assemblyNameLookup]);
        ...
        private static string GetCustomAttributeData(CustomAttributeData cad, Type attrType, out Type typeValue, bool allowTypeAlso, bool noArgs, bool zeroArgsAllowed)
        {
            ...
            if ((constructorArguments.Count == 1) && !noArgs)
            {
                ...
                {
                    throw new ArgumentException(System.Windows.SR.Get("ParserAttributeArgsLow", new object[] { attrType.Name }));
                }
                return assemblyQualifiedName;
            }
            if (constructorArguments.Count != 0)
            {
                throw new ArgumentException(System.Windows.SR.Get("ParserAttributeArgsHigh", new object[] { attrType.Name }));
            }
        ...
        internal static Type GetQualifiedType(string typeName)
        {
            ...
            {
                throw new InvalidOperationException(System.Windows.SR.Get("QualifiedNameHasWrongFormat", new object[] { typeName }));
            }
        ...
        internal static string GetTypeConverterAttributeData(MemberInfo mi, out Type converterType) => 
            GetCustomAttributeData(mi, GetSystemType(typeof(TypeConverterAttribute)), out converterType);
        ...
        internal static Assembly LoadAssembly(string assemblyName, string assemblyPath) => 
            LoadAssemblyHelper(assemblyName, assemblyPath);
            ...
            if (loadedAssembly != null)
            {
                if (reference.Version != null)
                {
                    ...
                    if (!AssemblyName.ReferenceMatchesDefinition(reference, definition))
                    {
                        ...
                        throw new InvalidOperationException(System.Windows.SR.Get("ParserAssemblyLoadVersionMismatch", new object[] { str2, str3 }));
                    }
                }
