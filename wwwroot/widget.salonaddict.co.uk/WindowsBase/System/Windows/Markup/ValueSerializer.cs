namespace System.Windows.Markup
{
    ...
    public abstract class ValueSerializer
    {
        ...
        protected Exception GetConvertFromException(object value)
        {
            ...
            if (value == null)
            {
                fullName = System.Windows.SR.Get("ToStringNull");
            }
            else
            {
                fullName = value.GetType().FullName;
            }
            return new NotSupportedException(System.Windows.SR.Get("ConvertFromException", new object[] { base.GetType().Name, fullName }));
        }
        ...
        protected Exception GetConvertToException(object value, Type destinationType)
        {
            ...
            return new NotSupportedException(System.Windows.SR.Get("ConvertToException", new object[] { base.GetType().Name, fullName, destinationType.FullName }));
        }
