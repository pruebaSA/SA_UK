namespace System.Windows
{
    ...
    [Serializable, StructLayout(LayoutKind.Sequential), TypeConverter(typeof(RectConverter)), ValueSerializer(typeof(RectValueSerializer))]
    public struct Rect : IFormattable
    {
        ...
        public static Rect Parse(string source)
        {
            ...
            {
                empty = new Rect(Convert.ToDouble(str, englishUSCulture), Convert.ToDouble(helper.NextTokenRequired(), englishUSCulture), Convert.ToDouble(helper.NextTokenRequired(), englishUSCulture), Convert.ToDouble(helper.NextTokenRequired(), englishUSCulture));
            }
        ...
        public Rect(Point location, System.Windows.Size size)
        {
            if (size.IsEmpty)
            {
                this = s_empty;
        ...
        public Point Location
        {
            ...
            set
            {
                if (this.IsEmpty)
                {
                    throw new InvalidOperationException(System.Windows.SR.Get("Rect_CannotModifyEmptyRect"));
                }
                this._x = value._x;
                this._y = value._y;
            }
        ...
        public System.Windows.Size Size
        {
            get
            {
                ...
                return new System.Windows.Size(this._width, this._height);
            }
            set
            {
                if (value.IsEmpty)
        ...
        public bool Contains(Point point) => 
            this.Contains(point._x, point._y);
        ...
        public void Intersect(Rect rect)
        {
            ...
            else
            {
                ...
                this._width = Math.Max((double) (Math.Min(this.Right, rect.Right) - num), (double) 0.0);
                this._height = Math.Max((double) (Math.Min(this.Bottom, rect.Bottom) - num2), (double) 0.0);
                this._x = num;
                this._y = num2;
            }
        }
        ...
        public void Union(Rect rect)
        {
            ...
            else if (!rect.IsEmpty)
            {
                ...
                else
                {
                    ...
                    this._width = Math.Max((double) (num3 - num), (double) 0.0);
                }
                ...
                else
                {
                    ...
                    this._height = Math.Max((double) (num4 - num2), (double) 0.0);
                }
                this._x = num;
                this._y = num2;
            }
        ...
        public void Offset(Vector offsetVector)
        {
            if (this.IsEmpty)
            {
                throw new InvalidOperationException(System.Windows.SR.Get("Rect_CannotCallMethod"));
            }
        ...
        public static Rect Inflate(Rect rect, System.Windows.Size size)
        {
        ...
        private bool ContainsInternal(double x, double y) => 
            ((((x >= this._x) && ((x - this._width) <= this._x)) && (y >= this._y)) && ((y - this._height) <= this._y));
