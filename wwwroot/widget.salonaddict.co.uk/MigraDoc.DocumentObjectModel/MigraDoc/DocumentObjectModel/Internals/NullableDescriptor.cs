namespace MigraDoc.DocumentObjectModel.Internals
{
    ...
    {
        internal NullableDescriptor(string valueName, Type valueType, Type fieldType, MemberInfo memberInfo, VDFlags flags) : base(valueName, valueType, fieldType, memberInfo, flags)
        {
        }
        ...
        public override object GetValue(DocumentObject dom, GV flags)
        {
            ...
            INullableValue value2 = (INullableValue) obj2;
            if (value2.IsNull && (flags == GV.GetNull))
            {
                return null;
            }
        ...
        public override bool IsNull(DocumentObject dom)
        {
            ...
            return ((INullableValue) obj2).IsNull;
        }
