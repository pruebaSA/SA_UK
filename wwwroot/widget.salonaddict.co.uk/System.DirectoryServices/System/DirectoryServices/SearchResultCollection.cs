namespace System.DirectoryServices
{
    ...
    public class SearchResultCollection : MarshalByRefObject, ICollection, IEnumerable, IDisposable
    {
        ...
        public bool Contains(SearchResult result) => 
            this.InnerList.Contains(result);
        ...
        public IEnumerator GetEnumerator() => 
            new ResultsEnumerator(this, this.rootEntry.GetUsername(), this.rootEntry.GetPassword(), this.rootEntry.AuthenticationType);

        public int IndexOf(SearchResult result) => 
            this.InnerList.IndexOf(result);
        ...
        internal byte[] DirsyncCookie =>
            this.RetrieveDirectorySynchronizationCookie();
        ...
        public SearchResult this[int index] =>
            ((SearchResult) this.InnerList[index]);
