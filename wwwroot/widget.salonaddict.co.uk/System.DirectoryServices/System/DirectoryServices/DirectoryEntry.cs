namespace System.DirectoryServices
{
    ...
    [DSDescription("DirectoryEntryDesc"), TypeConverter(typeof(DirectoryEntryConverter)), SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.UnmanagedCode), EnvironmentPermission(SecurityAction.Assert, Unrestricted=true), DirectoryServicesPermission(SecurityAction.LinkDemand, Unrestricted=true)]
    public class DirectoryEntry : System.ComponentModel.Component
    {
        ...
        internal DirectoryEntry CloneBrowsable() => 
            new DirectoryEntry(this.Path, this.UsePropertyCache, this.GetUsername(), this.GetPassword(), this.AuthenticationType);
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DSDescription("DSChildren"), Browsable(false)]
        public DirectoryEntries Children =>
            new DirectoryEntries(this);
        ...
        [DSDescription("DSGuid"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DSDescription("DSName"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string Name
        {
            get
            {
        ...
        [DSDescription("DSNativeObject"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), DSDescription("DSObjectSecurity")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ComVisible(false), DSDescription("DSOptions"), Browsable(false)]
        ...
        [DSDescription("DSParent"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [DefaultValue((string) null), Browsable(false), DSDescription("DSPassword")]
        ...
        [SettingsBindable(true), DefaultValue(""), TypeConverter("System.Diagnostics.Design.StringValueConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DSDescription("DSPath")]
        public string Path
        {
            get => 
                this.path;
        ...
        [DSDescription("DSProperties"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [DSDescription("DSSchemaClassName"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Browsable(false), DSDescription("DSSchemaEntry"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DSDescription("DSUsername"), DefaultValue((string) null), Browsable(false), TypeConverter("System.Diagnostics.Design.StringValueConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
