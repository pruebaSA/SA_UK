namespace System.DirectoryServices.ActiveDirectory
{
    ...
    public class DomainController : DirectoryServer
    {
        ...
        private void GetDomainControllerInfo()
        {
            ...
            finally
            {
                if (zero != IntPtr.Zero)
                {
                    ...
                    NativeMethods.DsFreeDomainControllerInfo info4 = (NativeMethods.DsFreeDomainControllerInfo) Marshal.GetDelegateForFunctionPointer(procAddress, typeof(NativeMethods.DsFreeDomainControllerInfo));
        ...
        public override ReplicationFailureCollection GetReplicationConnectionFailures() => 
            this.GetReplicationFailures(DS_REPL_INFO_TYPE.DS_REPL_INFO_KCC_DSA_CONNECT_FAILURES);
        ...
        public override ReplicationConnectionCollection InboundConnections =>
            base.GetInboundConnectionsHelper();
        ...
        public override ReplicationConnectionCollection OutboundConnections =>
            base.GetOutboundConnectionsHelper();
