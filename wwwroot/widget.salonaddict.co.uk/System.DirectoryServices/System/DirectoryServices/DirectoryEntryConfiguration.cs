namespace System.DirectoryServices
{
    ...
    public class DirectoryEntryConfiguration
    {
        ...
        public string GetCurrentServerName() => 
            ((string) ((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions) this.entry.AdsObject).GetOption(0));
        ...
        {
            get => 
                ((int) ((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions) this.entry.AdsObject).GetOption(2));
            set
            {
                if (value < 0)
                {
        ...
        {
            get => 
                ((PasswordEncodingMethod) ((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions) this.entry.AdsObject).GetOption(7));
            set
            {
        ...
        {
            get => 
                ((int) ((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions) this.entry.AdsObject).GetOption(6));
            set
            {
        ...
        {
            get => 
                ((ReferralChasingOption) ((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions) this.entry.AdsObject).GetOption(1));
            set
            {
        ...
        {
            get => 
                ((System.DirectoryServices.SecurityMasks) ((System.DirectoryServices.Interop.UnsafeNativeMethods.IAdsObjectOptions) this.entry.AdsObject).GetOption(3));
            set
            {
