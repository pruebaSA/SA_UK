namespace System.Data.Linq.SqlClient
{
    ...
    internal class SqlFormatter : DbFormatter
    {
        ...
        internal string[] FormatBlock(SqlBlock block, bool isDebug)
        {
            ...
            while (num < count)
            {
                SqlStatement node = block.Statements[num];
        ...
        internal class Visitor : SqlVisitor
        {
            ...
            internal virtual void FormatValue(object value)
            {
                ...
                else
                {
                    ...
                    if (!this.isDebugMode)
                    {
                        throw System.Data.Linq.SqlClient.Error.ValueHasNoLiteralInSql(value);
                    }
                    this.sb.Append("value(");
            ...
            internal virtual string GetOperator(SqlNodeType nt)
            {
                ...
                throw System.Data.Linq.SqlClient.Error.InvalidFormatNode(nt);
            }
            ...
            internal virtual bool IsSimpleCrossJoinList(SqlNode node)
            {
                ...
                if (join != null)
                {
                    return (((join.JoinType == SqlJoinType.Cross) && this.IsSimpleCrossJoinList(join.Left)) && this.IsSimpleCrossJoinList(join.Right));
                }
            ...
            internal bool RequiresOnCondition(SqlJoinType joinType)
            {
                ...
                throw System.Data.Linq.SqlClient.Error.InvalidFormatNode(joinType);
            }
            ...
            internal override SqlBlock VisitBlock(SqlBlock block)
            {
                ...
                while (num < count)
                {
                    ...
                    if (num < (count - 1))
                    {
                        SqlSelect select = block.Statements[num + 1] as SqlSelect;
                        if ((select == null) || !select.DoNotOutput)
                        {
                            this.NewLine();
                            this.NewLine();
            ...
            internal override SqlExpression VisitClientArray(SqlClientArray scar)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("ClientArray");
                }
                this.sb.Append("new []{");
                int num = 0;
            ...
            internal override SqlExpression VisitClientCase(SqlClientCase c)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("ClientCase");
                }
                this.depth++;
                this.NewLine();
                this.sb.Append("(CASE");
            ...
            internal override SqlExpression VisitClientParameter(SqlClientParameter cp)
            {
                ...
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("ClientParameter");
                }
            ...
            internal override SqlExpression VisitClientQuery(SqlClientQuery cq)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("ClientQuery");
                }
            ...
            internal override SqlExpression VisitColumn(SqlColumn c)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("Column");
                }
            ...
            internal override SqlExpression VisitElement(SqlSubSelect elem)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("Element");
                }
                int depth = this.depth;
                this.depth++;
            ...
            internal override SqlExpression VisitGrouping(SqlGrouping g)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("Grouping");
                }
            ...
            internal override SqlSource VisitJoin(SqlJoin join)
            {
                ...
                if ((right == null) || (((right.JoinType == SqlJoinType.Cross) && (join.JoinType != SqlJoinType.CrossApply)) && (join.JoinType != SqlJoinType.OuterApply)))
                {
            ...
            internal override SqlExpression VisitJoinedCollection(SqlJoinedCollection jc)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("JoinedCollection");
                }
            ...
            internal override SqlNode VisitLink(SqlLink link)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("Link");
                }
            ...
            {
                throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("MemberAssign");
            }
            ...
            internal override SqlExpression VisitMethodCall(SqlMethodCall mc)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("MethodCall");
                }
            ...
            internal override SqlExpression VisitMultiset(SqlSubSelect sms)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("Multiset");
                }
                int depth = this.depth;
                this.depth++;
            ...
            internal override SqlExpression VisitNew(SqlNew sox)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("New");
                }
                this.sb.Append("new ");
            ...
            internal override SqlExpression VisitNop(SqlNop nop)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("NOP");
                }
                this.sb.Append("NOP()");
                return nop;
            }
            ...
            internal override SqlExpression VisitObjectType(SqlObjectType ot)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("ObjectType");
                }
                this.sb.Append("(");
            ...
            internal override SqlExpression VisitOptionalValue(SqlOptionalValue sov)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("OptionalValue");
                }
                this.sb.Append("opt(");
            ...
            internal override SqlExpression VisitSharedExpression(SqlSharedExpression shared)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("Shared");
                }
            ...
            internal override SqlExpression VisitSharedExpressionRef(SqlSharedExpressionRef sref)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("SharedRef");
                }
            ...
            internal override SqlExpression VisitSimpleExpression(SqlSimpleExpression simple)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("SIMPLE");
                }
            ...
            internal override SqlStoredProcedureCall VisitStoredProcedureCall(SqlStoredProcedureCall spc)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    this.WriteVariableName(parameter.MappedName);
                    this.sb.Append(" = ");
            ...
            internal override SqlExpression VisitTypeCase(SqlTypeCase c)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("TypeCase");
                }
                this.depth++;
                this.NewLine();
                this.sb.Append("(CASE");
            ...
            internal override SqlExpression VisitUnaryOperator(SqlUnary uo)
            {
                switch (uo.NodeType)
                {
                    ...
                    case SqlNodeType.Convert:
                    {
                        ...
                        this.sb.Append(uo.SqlType.ToQueryString(none));
                        this.sb.Append(",");
                        this.Visit(uo.Operand);
                        this.sb.Append(")");
                        return uo;
                ...
                throw System.Data.Linq.SqlClient.Error.InvalidFormatNode(uo.NodeType);
            }
            ...
            internal override SqlExpression VisitUserRow(SqlUserRow row)
            {
                if (!this.isDebugMode)
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("UserRow");
                }
                return row;
            }
            ...
            internal override SqlExpression VisitValue(SqlValue value)
            {
                ...
                {
                    throw System.Data.Linq.SqlClient.Error.InvalidFormatNode("Value");
                }
