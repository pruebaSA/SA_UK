            ...
            if ((node1 != null) && (node2 != null))
            {
                ...
                switch (node1.NodeType)
                {
                    ...
                    case SqlNodeType.Between:
                    {
                        ...
                        if (!AreEqual(between.Expression, between2.Expression) || !AreEqual(between.Start, between2.Start))
                        {
                            return false;
                        }
                    ...
                    case SqlNodeType.ClientCase:
                    {
                        ...
                        if (case5.Whens.Count == case6.Whens.Count)
                        {
                            ...
                            while (num9 < num10)
                            {
                                if (!AreEqual(case5.Whens[num9].Match, case6.Whens[num9].Match) || !AreEqual(case5.Whens[num9].Value, case6.Whens[num9].Value))
                                {
                                    return false;
                                }
                                num9++;
                    ...
                    case SqlNodeType.Column:
                    {
                        ...
                        if ((column.Expression == null) || (column2.Expression == null))
                        {
                            return false;
                        }
                        return AreEqual(column.Expression, column2.Expression);
                    }
                    ...
                    case SqlNodeType.SearchedCase:
                    {
                        ...
                        if (case3.Whens.Count == case4.Whens.Count)
                        {
                            ...
                            while (num7 < num8)
                            {
                                if (!AreEqual(case3.Whens[num7].Match, case4.Whens[num7].Match) || !AreEqual(case3.Whens[num7].Value, case4.Whens[num7].Value))
                                {
                                    return false;
                                }
                                num7++;
                    ...
                    case SqlNodeType.SimpleCase:
                    {
                        ...
                        if (case7.Whens.Count == case8.Whens.Count)
                        {
                            ...
                            while (num11 < num12)
                            {
                                if (!AreEqual(case7.Whens[num11].Match, case8.Whens[num11].Match) || !AreEqual(case7.Whens[num11].Value, case8.Whens[num11].Value))
                                {
                                    return false;
                                }
                                num11++;
