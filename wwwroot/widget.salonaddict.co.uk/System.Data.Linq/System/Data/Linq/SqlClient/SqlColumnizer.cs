namespace System.Data.Linq.SqlClient
{
    ...
    internal class SqlColumnizer
    {
        ...
        internal SqlExpression ColumnizeSelection(SqlExpression selection) => 
            this.declarer.Declare(selection, this.nominator.Nominate(selection));
        ...
        private class ColumnNominator : SqlVisitor
        {
            ...
            internal override SqlNode Visit(SqlNode node)
            {
                ...
                if (expr != null)
                {
                    ...
                    if (!this.isBlocked)
                    {
                        if (((!IsClientOnly(expr) && (expr.NodeType != SqlNodeType.Column)) && expr.SqlType.CanBeColumn) && ((this.fnCanBeColumn == null) || this.fnCanBeColumn(expr)))
                        {
