namespace System.Data.Linq.SqlClient
{
    ...
    internal class SqlExpander
    {
        ...
        internal SqlExpression Expand(SqlExpression exp) => 
            new Visitor(this.factory).VisitExpression(exp);
        ...
        private class Visitor : SqlDuplicator.DuplicatingVisitor
        {
            ...
            internal Visitor(SqlFactory factory) : base(true)
            {
                this.factory = factory;
            }
            ...
            private SqlExpression ExpandTogether(List<SqlExpression> exprs)
            {
                switch (exprs[0].NodeType)
                {
                    ...
                    case SqlNodeType.Multiset:
                        throw System.Data.Linq.SqlClient.Error.UnionWithHierarchy();
                    ...
                    case SqlNodeType.Link:
                    {
                        ...
                        while (index < count)
                        {
                            ...
                            {
                                throw System.Data.Linq.SqlClient.Error.UnionIncompatibleConstruction();
                            }
                            linkArray[index] = (SqlLink) exprs[index];
                            if (((linkArray[index].KeyExpressions.Count != linkArray[0].KeyExpressions.Count) || (linkArray[index].Member != linkArray[0].Member)) || ((linkArray[index].Expansion != null) != (linkArray[0].Expansion != null)))
                            {
                                throw System.Data.Linq.SqlClient.Error.UnionIncompatibleConstruction();
                            }
                            index++;
                        ...
                        return new SqlLink(linkArray[0].Id, linkArray[0].RowType, linkArray[0].ClrType, linkArray[0].SqlType, linkArray[0].Expression, linkArray[0].Member, keyExpressions, expansion, linkArray[0].SourceExpression);
                    }
                    ...
                    case SqlNodeType.DiscriminatedType:
                    {
                        ...
                        return this.factory.DiscriminatedType(this.ExpandTogether(list15), ((SqlDiscriminatedType) exprs[0]).TargetType);
                    }
                    case SqlNodeType.MethodCall:
                    {
                        ...
                        return this.factory.MethodCall(callArray[0].Method, callArray[0].Object, list.ToArray(), callArray[0].SourceExpression);
                    }
                    case SqlNodeType.New:
                    {
                        ...
                        while (num13 < num14)
                        {
                            ...
                            {
                                throw System.Data.Linq.SqlClient.Error.UnionDifferentMembers();
                            }
                            int num15 = 0;
                            ...
                            while (num15 < num16)
                            {
                                ...
                                {
                                    throw System.Data.Linq.SqlClient.Error.UnionDifferentMemberOrder();
                                }
                                num15++;
                            }
                            num13++;
                        ...
                        while (num17 < length)
                        {
                            ...
                            bindings[num17] = new SqlMemberAssign(newArray[0].Members[num17].Member, this.ExpandTogether(list9));
                            int num21 = 0;
                        ...
                        return this.factory.New(newArray[0].MetaType, newArray[0].Constructor, args, newArray[0].ArgMembers, bindings, exprs[0].SourceExpression);
                    }
                    ...
                    case SqlNodeType.TypeCase:
                    {
                        ...
                        return this.factory.TypeCase(caseArray2[0].ClrType, caseArray2[0].RowType, discriminator, list7, caseArray2[0].SourceExpression);
                    }
            ...
            internal override SqlExpression VisitAliasRef(SqlAliasRef aref)
            {
                ...
                if (exp == null)
                {
                    throw System.Data.Linq.SqlClient.Error.CouldNotHandleAliasRef(node.NodeType);
                }
                return this.VisitExpression(exp);
            }

            internal override SqlExpression VisitColumn(SqlColumn col) => 
                new SqlColumnRef(col);
            ...
            internal override SqlNode VisitLink(SqlLink link)
            {
                ...
                return new SqlLink(link.Id, link.RowType, link.ClrType, link.SqlType, link.Expression, link.Member, keyExpressions, expansion, link.SourceExpression);
            }

            internal override SqlExpression VisitSharedExpression(SqlSharedExpression shared) => 
                this.VisitExpression(shared.Expression);

            internal override SqlExpression VisitSharedExpressionRef(SqlSharedExpressionRef sref) => 
                this.VisitExpression(sref.SharedExpression.Expression);

            internal override SqlExpression VisitSubSelect(SqlSubSelect ss) => 
                ((SqlExpression) new SqlDuplicator().Duplicate(ss));
        }
    }
}
