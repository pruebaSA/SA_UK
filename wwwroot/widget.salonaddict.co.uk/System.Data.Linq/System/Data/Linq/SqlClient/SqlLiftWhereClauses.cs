namespace System.Data.Linq.SqlClient
{
    ...
    internal class SqlLiftWhereClauses
    {
        internal static SqlNode Lift(SqlNode node, TypeSystemProvider typeProvider, MetaModel model) => 
            new Lifter(typeProvider, model).Visit(node);
        ...
        private class Lifter : SqlVisitor
        {
            ...
            internal override SqlSelect VisitSelect(SqlSelect select)
            {
                ...
                bool flag = ((select.IsDistinct || (select.GroupBy.Count > 0)) || (this.aggregateChecker.HasAggregates(select) || (select.Top != null))) || this.rowNumberChecker.HasRowNumber(select);
