namespace System.Data.Linq.SqlClient
{
    ...
    internal sealed class SR
    {
        ...
        private static System.Data.Linq.SqlClient.SR loader;
        ...
        private static System.Data.Linq.SqlClient.SR GetLoader()
        {
            if (loader == null)
            {
                System.Data.Linq.SqlClient.SR sr = new System.Data.Linq.SqlClient.SR();
                Interlocked.CompareExchange<System.Data.Linq.SqlClient.SR>(ref loader, sr, null);
            }
            return loader;
        }
        ...
        {
            System.Data.Linq.SqlClient.SR loader = GetLoader();
            if (loader == null)
            {
                return null;
            }
