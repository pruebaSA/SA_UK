    ...
    public class LdapSessionOptions
    {
        ...
        public unsafe void StartTransportLayerSecurity(DirectoryControlCollection controls)
        {
            ...
            try
            {
                ...
                {
                    zero = Utility.AllocHGlobalIntPtrArray(controlArray.Length + 1);
                ...
                {
                    clientControls = Utility.AllocHGlobalIntPtrArray(controlArray2.Length + 1);
        ...
        {
            get => 
                (this.GetIntValueHelper(LdapOption.LDAP_OPT_AUTO_RECONNECT) == 1);
            set
            {
                int num;
                if (value)
        ...
        {
            get => 
                ((DereferenceAlias) this.GetIntValueHelper(LdapOption.LDAP_OPT_DEREF));
            set
            {
        ...
        {
            get => 
                this.GetStringValueHelper(LdapOption.LDAP_OPT_DNSDOMAIN_NAME, true);
            set
            {
        ...
        {
            get => 
                this.GetStringValueHelper(LdapOption.LDAP_OPT_HOST_NAME, false);
            set
            {
        ...
        public bool HostReachable =>
            (this.GetIntValueHelper(LdapOption.LDAP_OPT_HOST_REACHABLE) == 1);

        public LocatorFlags LocatorFlag
        {
            get => 
                ((LocatorFlags) this.GetIntValueHelper(LdapOption.LDAP_OPT_GETDSNAME_FLAGS));
            set
            {
        ...
        {
            get => 
                new TimeSpan(this.GetIntValueHelper(LdapOption.LDAP_OPT_PING_KEEP_ALIVE) * 0x989680L);
            set
            {
        ...
        {
            get => 
                this.GetIntValueHelper(LdapOption.LDAP_OPT_PING_LIMIT);
            set
            {
                if (value < 0)
                {
        ...
        {
            get => 
                new TimeSpan(this.GetIntValueHelper(LdapOption.LDAP_OPT_PING_WAIT_TIME) * 0x2710L);
            set
            {
                if (value < TimeSpan.Zero)
                {
        ...
        {
            get => 
                this.GetIntValueHelper(LdapOption.LDAP_OPT_VERSION);
            set
            {
        ...
        {
            get => 
                this.GetIntValueHelper(LdapOption.LDAP_OPT_REFERRAL_HOP_LIMIT);
            set
            {
                if (value < 0)
                {
        ...
        {
            get => 
                (this.GetIntValueHelper(LdapOption.LDAP_OPT_ROOTDSE_CACHE) == 1);
            set
            {
                int num;
                if (value)
        ...
        {
            get => 
                this.GetStringValueHelper(LdapOption.LDAP_OPT_SASL_METHOD, true);
            set
            {
        ...
        {
            get => 
                (this.GetIntValueHelper(LdapOption.LDAP_OPT_ENCRYPT) == 1);
            set
            {
                int num;
                if (value)
        ...
        {
            get => 
                (this.GetIntValueHelper(LdapOption.LDAP_OPT_SSL) == 1);
            set
            {
                int num;
                if (value)
        ...
        {
            get => 
                new TimeSpan(this.GetIntValueHelper(LdapOption.LDAP_OPT_SEND_TIMEOUT) * 0x989680L);
            set
            {
                if (value < TimeSpan.Zero)
                {
        ...
        internal string ServerErrorMessage =>
            this.GetStringValueHelper(LdapOption.LDAP_OPT_SERVER_ERROR, true);

        public bool Signing
        {
            get => 
                (this.GetIntValueHelper(LdapOption.LDAP_OPT_SIGN) == 1);
            set
            {
                int num;
                if (value)
        ...
        {
            get => 
                this.GetIntValueHelper(LdapOption.LDAP_OPT_SSPI_FLAGS);
            set
            {
        ...
        {
            get => 
                (this.GetIntValueHelper(LdapOption.LDAP_OPT_TCP_KEEPALIVE) == 1);
            set
            {
                int num;
                if (value)
