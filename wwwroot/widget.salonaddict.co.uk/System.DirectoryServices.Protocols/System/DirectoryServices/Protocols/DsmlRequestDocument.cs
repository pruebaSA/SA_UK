namespace System.DirectoryServices.Protocols
{
    ...
    public class DsmlRequestDocument : DsmlDocument, IList, ICollection, IEnumerable
    {
        ...
        public bool Contains(DirectoryRequest value) => 
            this.dsmlRequests.Contains(value);
        ...
        public IEnumerator GetEnumerator() => 
            this.dsmlRequests.GetEnumerator();
        ...
        bool IList.Contains(object value) => 
            this.Contains((DirectoryRequest) value);
        ...
        protected bool IsSynchronized =>
            this.dsmlRequests.IsSynchronized;

        public DirectoryRequest this[int index]
        {
            get => 
                ((DirectoryRequest) this.dsmlRequests[index]);
            set
            {
                if (value == null)
                {
