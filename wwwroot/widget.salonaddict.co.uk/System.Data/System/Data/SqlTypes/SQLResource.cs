namespace System.Data.SqlTypes
{
    ...
    internal sealed class SQLResource
    {
        ...
        internal static string InvalidOpStreamClosed(string method) => 
            Res.GetString("SqlMisc_InvalidOpStreamClosed", new object[] { method });

        internal static string InvalidOpStreamNonReadable(string method) => 
            Res.GetString("SqlMisc_InvalidOpStreamNonReadable", new object[] { method });

        internal static string InvalidOpStreamNonSeekable(string method) => 
            Res.GetString("SqlMisc_InvalidOpStreamNonSeekable", new object[] { method });

        internal static string InvalidOpStreamNonWritable(string method) => 
            Res.GetString("SqlMisc_InvalidOpStreamNonWritable", new object[] { method });
    }
}
