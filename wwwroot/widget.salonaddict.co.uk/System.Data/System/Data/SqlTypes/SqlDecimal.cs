namespace System.Data.SqlTypes
{
    ...
    public struct SqlDecimal : INullable, IComparable, IXmlSerializable
    {
        ...
        public bool IsNull =>
            ((this.m_bStatus & x_bNullMask) == x_bIsNull);
        ...
        private static byte CLenFromPrec(byte bPrec) => 
            rgCLenFromPrec[bPrec - 1];

        private bool FZero() => 
            ((this.m_data1 == 0) && (this.m_bLen <= 1));
        ...
        public static SqlDecimal Round(SqlDecimal n, int position) => 
            Round(n, position, false);

        public static SqlDecimal Truncate(SqlDecimal n, int position) => 
            Round(n, position, true);
        ...
        public static XmlQualifiedName GetXsdType(XmlSchemaSet schemaSet) => 
            new XmlQualifiedName("decimal", "http://www.w3.org/2001/XMLSchema");
