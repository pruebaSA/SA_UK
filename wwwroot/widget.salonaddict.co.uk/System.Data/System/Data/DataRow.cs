namespace System.Data
{
    ...
    public class DataRow
    {
        ...
        public DataRow[] GetChildRows(DataRelation relation) => 
            this.GetChildRows(relation, DataRowVersion.Default);

        public DataRow[] GetChildRows(string relationName) => 
            this.GetChildRows(this._table.ChildRelations[relationName], DataRowVersion.Default);
        ...
        public DataRow[] GetChildRows(string relationName, DataRowVersion version) => 
            this.GetChildRows(this._table.ChildRelations[relationName], version);
        ...
        public DataColumn[] GetColumnsInError() => 
            this.error?.GetColumnsInError();

        internal object[] GetColumnValues(DataColumn[] columns) => 
            this.GetColumnValues(columns, DataRowVersion.Default);
        ...
        public DataRow GetParentRow(DataRelation relation) => 
            this.GetParentRow(relation, DataRowVersion.Default);

        public DataRow GetParentRow(string relationName) => 
            this.GetParentRow(this._table.ParentRelations[relationName], DataRowVersion.Default);
        ...
        public DataRow GetParentRow(string relationName, DataRowVersion version) => 
            this.GetParentRow(this._table.ParentRelations[relationName], version);

        public DataRow[] GetParentRows(DataRelation relation) => 
            this.GetParentRows(relation, DataRowVersion.Default);

        public DataRow[] GetParentRows(string relationName) => 
            this.GetParentRows(this._table.ParentRelations[relationName], DataRowVersion.Default);
        ...
        public DataRow[] GetParentRows(string relationName, DataRowVersion version) => 
            this.GetParentRows(this._table.ParentRelations[relationName], version);
        ...
        internal bool HasKeyChanged(DataKey key) => 
            this.HasKeyChanged(key, DataRowVersion.Current, DataRowVersion.Proposed);
        ...
        internal bool HaveValuesChanged(DataColumn[] columns) => 
            this.HaveValuesChanged(columns, DataRowVersion.Current, DataRowVersion.Proposed);
        ...
        public bool HasErrors =>
            ((this.error != null) && this.error.HasErrors);

        internal bool HasPropertyChanged =>
            (0 < this._countColumnChange);
