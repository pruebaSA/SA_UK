namespace System.Data.Common
{
    ...
    internal static class ADP
    {
        ...
        internal static Exception AmbigousCollectionName(string collectionName) => 
            Argument(System.Data.Res.GetString("MDF_AmbigousCollectionName", new object[] { collectionName }));
        ...
        internal static Exception ClosedConnectionError() => 
            InvalidOperation(System.Data.Res.GetString("ADP_ClosedConnectionError"));

        internal static IndexOutOfRangeException CollectionIndexInt32(int index, Type collection, int count) => 
            IndexOutOfRange(System.Data.Res.GetString("ADP_CollectionIndexInt32", new object[] { index.ToString(CultureInfo.InvariantCulture), collection.Name, count.ToString(CultureInfo.InvariantCulture) }));
        ...
        internal static IndexOutOfRangeException CollectionIndexString(Type itemType, string propertyName, string propertyValue, Type collection) => 
            IndexOutOfRange(System.Data.Res.GetString("ADP_CollectionIndexString", new object[] { itemType.Name, propertyName, propertyValue, collection.Name }));

        internal static InvalidCastException CollectionInvalidType(Type collection, Type itemType, object invalidValue) => 
            InvalidCast(System.Data.Res.GetString("ADP_CollectionInvalidType", new object[] { collection.Name, itemType.Name, invalidValue.GetType().Name }));

        internal static Exception CollectionNameIsNotUnique(string collectionName) => 
            Argument(System.Data.Res.GetString("MDF_CollectionNameISNotUnique", new object[] { collectionName }));

        internal static ArgumentNullException CollectionNullValue(string parameter, Type collection, Type itemType) => 
            ArgumentNull(parameter, System.Data.Res.GetString("ADP_CollectionNullValue", new object[] { collection.Name, itemType.Name }));

        internal static ArgumentException CollectionRemoveInvalidObject(Type itemType, ICollection collection) => 
            Argument(System.Data.Res.GetString("ADP_CollectionRemoveInvalidObject", new object[] { itemType.Name, collection.GetType().Name }));

        internal static Exception CollectionUniqueValue(Type itemType, string propertyName, string propertyValue) => 
            Argument(System.Data.Res.GetString("ADP_CollectionUniqueValue", new object[] { itemType.Name, propertyName, propertyValue }));

        internal static Exception ColumnsAddNullAttempt(string parameter) => 
            CollectionNullValue(parameter, typeof(DataColumnMappingCollection), typeof(DataColumnMapping));

        internal static InvalidOperationException ColumnSchemaExpression(string srcColumn, string cacheColumn) => 
            DataMapping(System.Data.Res.GetString("ADP_ColumnSchemaExpression", new object[] { srcColumn, cacheColumn }));

        internal static InvalidOperationException ColumnSchemaMismatch(string srcColumn, Type srcType, DataColumn column) => 
            DataMapping(System.Data.Res.GetString("ADP_ColumnSchemaMismatch", new object[] { srcColumn, srcType.Name, column.ColumnName, column.DataType.Name }));
        ...
        internal static Exception ColumnsDataSetColumn(string cacheColumn) => 
            CollectionIndexString(typeof(DataColumnMapping), "DataSetColumn", cacheColumn, typeof(DataColumnMappingCollection));
        ...
        internal static Exception ColumnsIndexSource(string srcColumn) => 
            CollectionIndexString(typeof(DataColumnMapping), "SourceColumn", srcColumn, typeof(DataColumnMappingCollection));

        internal static Exception ColumnsIsNotParent(ICollection collection) => 
            ParametersIsNotParent(typeof(DataColumnMapping), collection);

        internal static Exception ColumnsIsParent(ICollection collection) => 
            ParametersIsParent(typeof(DataColumnMapping), collection);

        internal static Exception ColumnsUniqueSourceColumn(string srcColumn) => 
            CollectionUniqueValue(typeof(DataColumnMapping), "SourceColumn", srcColumn);

        internal static InvalidOperationException CommandAsyncOperationCompleted() => 
            InvalidOperation(System.Data.Res.GetString("SQL_AsyncOperationCompleted"));

        internal static Exception CommandTextRequired(string method) => 
            InvalidOperation(System.Data.Res.GetString("ADP_CommandTextRequired", new object[] { method }));
        ...
        internal static InvalidOperationException ComputerNameEx(int lastError) => 
            InvalidOperation(System.Data.Res.GetString("ADP_ComputerNameEx", new object[] { lastError }));

        internal static ConfigurationException ConfigBaseElementsOnly(XmlNode node) => 
            Configuration(System.Data.Res.GetString("ConfigBaseElementsOnly"), node);

        internal static ConfigurationException ConfigBaseNoChildNodes(XmlNode node) => 
            Configuration(System.Data.Res.GetString("ConfigBaseNoChildNodes"), node);

        internal static InvalidOperationException ConfigProviderInvalid() => 
            InvalidOperation(System.Data.Res.GetString("ConfigProviderInvalid"));

        internal static ConfigurationException ConfigProviderMissing() => 
            Configuration(System.Data.Res.GetString("ConfigProviderMissing"));

        internal static ArgumentException ConfigProviderNotFound() => 
            Argument(System.Data.Res.GetString("ConfigProviderNotFound"));

        internal static ConfigurationException ConfigProviderNotInstalled() => 
            Configuration(System.Data.Res.GetString("ConfigProviderNotInstalled"));

        internal static ConfigurationException ConfigRequiredAttributeEmpty(string name, XmlNode node) => 
            Configuration(System.Data.Res.GetString("ConfigRequiredAttributeEmpty", new object[] { name }), node);

        internal static ConfigurationException ConfigRequiredAttributeMissing(string name, XmlNode node) => 
            Configuration(System.Data.Res.GetString("ConfigRequiredAttributeMissing", new object[] { name }), node);

        internal static ConfigurationException ConfigSectionsUnique(string sectionName) => 
            Configuration(System.Data.Res.GetString("ConfigSectionsUnique", new object[] { sectionName }));

        internal static ConfigurationException ConfigUnableToLoadXmlMetaDataFile(string settingName) => 
            Configuration(System.Data.Res.GetString("OleDb_ConfigUnableToLoadXmlMetaDataFile", new object[] { settingName }));

        internal static ConfigurationException ConfigUnrecognizedAttributes(XmlNode node) => 
            Configuration(System.Data.Res.GetString("ConfigUnrecognizedAttributes", new object[] { node.Attributes[0].Name }), node);

        internal static ConfigurationException ConfigUnrecognizedElement(XmlNode node) => 
            Configuration(System.Data.Res.GetString("ConfigUnrecognizedElement"), node);
        ...
        internal static ConfigurationException ConfigWrongNumberOfValues(string settingName) => 
            Configuration(System.Data.Res.GetString("OleDb_ConfigWrongNumberOfValues", new object[] { settingName }));

        internal static Exception ConnectionAlreadyOpen(ConnectionState state) => 
            InvalidOperation(System.Data.Res.GetString("ADP_ConnectionAlreadyOpen", new object[] { ConnectionStateMsg(state) }));

        internal static Exception ConnectionIsDisabled(Exception InnerException) => 
            InvalidOperation(System.Data.Res.GetString("ADP_ConnectionIsDisabled"), InnerException);

        internal static InvalidOperationException ConnectionRequired(string method) => 
            InvalidOperation(System.Data.Res.GetString("ADP_ConnectionRequired", new object[] { method }));

        internal static InvalidOperationException ConnectionRequired_Res(string method) => 
            InvalidOperation(System.Data.Res.GetString("ADP_ConnectionRequired_" + method));
        ...
        internal static ArgumentException ConnectionStringSyntax(int index) => 
            Argument(System.Data.Res.GetString("ADP_ConnectionStringSyntax", new object[] { index }));

        internal static ArgumentException ConvertFailed(Type fromType, Type toType, Exception innerException) => 
            Argument(System.Data.Res.GetString("SqlConvert_ConvertFailed", new object[] { fromType.FullName, toType.FullName }), innerException);
        ...
        internal static InvalidOperationException DataAdapter(string error, Exception inner) => 
            InvalidOperation(error, inner);

        internal static Exception DatabaseNameTooLong() => 
            Argument(System.Data.Res.GetString("ADP_DatabaseNameTooLong"));
        ...
        internal static Exception DataReaderClosed(string method) => 
            InvalidOperation(System.Data.Res.GetString("ADP_DataReaderClosed", new object[] { method }));

        internal static Exception DataReaderNoData() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DataReaderNoData"));

        internal static Exception DataTableDoesNotExist(string collectionName) => 
            Argument(System.Data.Res.GetString("MDF_DataTableDoesNotExist", new object[] { collectionName }));

        internal static Exception DbRecordReadOnly(string methodname) => 
            InvalidOperation(System.Data.Res.GetString("ADP_DbRecordReadOnly", new object[] { methodname }));

        internal static ArgumentException DbTypeNotSupported(DbType type, Type enumtype) => 
            Argument(System.Data.Res.GetString("ADP_DbTypeNotSupported", new object[] { type.ToString(), enumtype.Name }));

        internal static Exception DelegatedTransactionPresent() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DelegatedTransactionPresent"));

        internal static Exception DeriveParametersNotSupported(IDbCommand value) => 
            DataAdapter(System.Data.Res.GetString("ADP_DeriveParametersNotSupported", new object[] { value.GetType().Name, value.CommandType.ToString() }));
        ...
        internal static InvalidOperationException DynamicSQLJoinUnsupported() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DynamicSQLJoinUnsupported"));

        internal static InvalidOperationException DynamicSQLNestedQuote(string name, string quote) => 
            InvalidOperation(System.Data.Res.GetString("ADP_DynamicSQLNestedQuote", new object[] { name, quote }));

        internal static InvalidOperationException DynamicSQLNoKeyInfoDelete() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DynamicSQLNoKeyInfoDelete"));

        internal static InvalidOperationException DynamicSQLNoKeyInfoRowVersionDelete() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DynamicSQLNoKeyInfoRowVersionDelete"));

        internal static InvalidOperationException DynamicSQLNoKeyInfoRowVersionUpdate() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DynamicSQLNoKeyInfoRowVersionUpdate"));

        internal static InvalidOperationException DynamicSQLNoKeyInfoUpdate() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DynamicSQLNoKeyInfoUpdate"));

        internal static InvalidOperationException DynamicSQLNoTableInfo() => 
            InvalidOperation(System.Data.Res.GetString("ADP_DynamicSQLNoTableInfo"));

        internal static Exception EmptyDatabaseName() => 
            Argument(System.Data.Res.GetString("ADP_EmptyDatabaseName"));
        ...
        internal static Exception EvenLengthLiteralValue(string argumentName) => 
            Argument(System.Data.Res.GetString("ADP_EvenLengthLiteralValue"), argumentName);

        internal static Exception ExceedsMaxDataLength(long specifiedLength, long maxLength) => 
            IndexOutOfRange(System.Data.Res.GetString("SQL_ExceedsMaxDataLength", new object[] { specifiedLength.ToString(CultureInfo.InvariantCulture), maxLength.ToString(CultureInfo.InvariantCulture) }));

        internal static Exception FillChapterAutoIncrement() => 
            InvalidOperation(System.Data.Res.GetString("ADP_FillChapterAutoIncrement"));
        ...
        internal static Exception FillRequiresSourceTableName(string parameter) => 
            Argument(System.Data.Res.GetString("ADP_FillRequiresSourceTableName"), parameter);

        internal static Exception FillSchemaRequiresSourceTableName(string parameter) => 
            Argument(System.Data.Res.GetString("ADP_FillSchemaRequiresSourceTableName"), parameter);
        ...
        internal static string GetComputerNameDnsFullyQualified()
        {
            ...
            if (IsPlatformNT5)
            {
                System.Data.Common.SafeNativeMethods.GetComputerNameEx(3, null, ref bufferSize);
        ...
        internal static Exception HexDigitLiteralValue(string argumentName) => 
            Argument(System.Data.Res.GetString("ADP_HexDigitLiteralValue"), argumentName);
        ...
        internal static Exception IncorrectNumberOfDataSourceInformationRows() => 
            Argument(System.Data.Res.GetString("MDF_IncorrectNumberOfDataSourceInformationRows"));
        ...
        internal static Exception InternalConnectionError(ConnectionError internalError) => 
            InvalidOperation(System.Data.Res.GetString("ADP_InternalConnectionError", new object[] { (int) internalError }));

        internal static Exception InternalError(InternalErrorCode internalError) => 
            InvalidOperation(System.Data.Res.GetString("ADP_InternalProviderError", new object[] { (int) internalError }));
        ...
        internal static ArgumentOutOfRangeException InvalidAcceptRejectRule(AcceptRejectRule value) => 
            InvalidEnumerationValue(typeof(AcceptRejectRule), (int) value);

        internal static ArgumentException InvalidArgumentLength(string argumentName, int limit) => 
            Argument(System.Data.Res.GetString("ADP_InvalidArgumentLength", new object[] { argumentName, limit }));

        internal static Exception InvalidArgumentValue(string methodName) => 
            Argument(System.Data.Res.GetString("ADP_InvalidArgumentValue", new object[] { methodName }));

        internal static IndexOutOfRangeException InvalidBufferSizeOrIndex(int numBytes, int bufferIndex) => 
            IndexOutOfRange(System.Data.Res.GetString("SQL_InvalidBufferSizeOrIndex", new object[] { numBytes.ToString(CultureInfo.InvariantCulture), bufferIndex.ToString(CultureInfo.InvariantCulture) }));
        ...
        internal static ArgumentOutOfRangeException InvalidCatalogLocation(CatalogLocation value) => 
            InvalidEnumerationValue(typeof(CatalogLocation), (int) value);

        internal static ArgumentOutOfRangeException InvalidCommandBehavior(CommandBehavior value) => 
            InvalidEnumerationValue(typeof(CommandBehavior), (int) value);

        internal static Exception InvalidCommandTimeout(int value) => 
            Argument(System.Data.Res.GetString("ADP_InvalidCommandTimeout", new object[] { value.ToString(CultureInfo.InvariantCulture) }), "CommandTimeout");

        internal static ArgumentOutOfRangeException InvalidCommandType(CommandType value) => 
            InvalidEnumerationValue(typeof(CommandType), (int) value);

        internal static ArgumentOutOfRangeException InvalidConflictOptions(ConflictOption value) => 
            InvalidEnumerationValue(typeof(ConflictOption), (int) value);

        internal static Exception InvalidConnectionOptionValue(string key) => 
            InvalidConnectionOptionValue(key, null);

        internal static Exception InvalidConnectionOptionValue(string key, Exception inner) => 
            Argument(System.Data.Res.GetString("ADP_InvalidConnectionOptionValue", new object[] { key }), inner);

        internal static Exception InvalidConnectionOptionValueLength(string key, int limit) => 
            Argument(System.Data.Res.GetString("ADP_InvalidConnectionOptionValueLength", new object[] { key, limit }));

        internal static Exception InvalidConnectTimeoutValue() => 
            Argument(System.Data.Res.GetString("ADP_InvalidConnectTimeoutValue"));

        internal static InvalidOperationException InvalidDataDirectory() => 
            InvalidOperation(System.Data.Res.GetString("ADP_InvalidDataDirectory"));

        internal static Exception InvalidDataLength(long length) => 
            IndexOutOfRange(System.Data.Res.GetString("SQL_InvalidDataLength", new object[] { length.ToString(CultureInfo.InvariantCulture) }));

        internal static ArgumentOutOfRangeException InvalidDataRowState(DataRowState value) => 
            InvalidEnumerationValue(typeof(DataRowState), (int) value);
        ...
        internal static ArgumentException InvalidDataType(TypeCode typecode) => 
            Argument(System.Data.Res.GetString("ADP_InvalidDataType", new object[] { typecode.ToString() }));

        internal static InvalidOperationException InvalidDateTimeDigits(string dataTypeName) => 
            InvalidOperation(System.Data.Res.GetString("ADP_InvalidDateTimeDigits", new object[] { dataTypeName }));

        internal static ArgumentOutOfRangeException InvalidDestinationBufferIndex(int maxLen, int dstOffset, string parameterName) => 
            ArgumentOutOfRange(System.Data.Res.GetString("ADP_InvalidDestinationBufferIndex", new object[] { maxLen.ToString(CultureInfo.InvariantCulture), dstOffset.ToString(CultureInfo.InvariantCulture) }), parameterName);

        internal static ArgumentOutOfRangeException InvalidEnumerationValue(Type type, int value) => 
            ArgumentOutOfRange(System.Data.Res.GetString("ADP_InvalidEnumerationValue", new object[] { type.Name, value.ToString(CultureInfo.InvariantCulture) }), type.Name);

        internal static Exception InvalidFormatValue() => 
            Argument(System.Data.Res.GetString("ADP_InvalidFormatValue"));

        internal static Exception InvalidImplicitConversion(Type fromtype, string totype) => 
            InvalidCast(System.Data.Res.GetString("ADP_InvalidImplicitConversion", new object[] { fromtype.Name, totype }));

        internal static ArgumentOutOfRangeException InvalidIsolationLevel(System.Data.IsolationLevel value) => 
            InvalidEnumerationValue(typeof(System.Data.IsolationLevel), (int) value);

        internal static ArgumentException InvalidKeyname(string parameterName) => 
            Argument(System.Data.Res.GetString("ADP_InvalidKey"), parameterName);
        ...
        internal static ArgumentOutOfRangeException InvalidLoadOption(LoadOption value) => 
            InvalidEnumerationValue(typeof(LoadOption), (int) value);

        internal static InvalidOperationException InvalidMaximumScale(string dataTypeName) => 
            InvalidOperation(System.Data.Res.GetString("ADP_InvalidMaximumScale", new object[] { dataTypeName }));

        internal static Exception InvalidMaxRecords(string parameter, int max) => 
            Argument(System.Data.Res.GetString("ADP_InvalidMaxRecords", new object[] { max.ToString(CultureInfo.InvariantCulture) }), parameter);

        internal static Exception InvalidMetaDataValue() => 
            Argument(System.Data.Res.GetString("ADP_InvalidMetaDataValue"));

        internal static ArgumentException InvalidMinMaxPoolSizeValues() => 
            Argument(System.Data.Res.GetString("ADP_InvalidMinMaxPoolSizeValues"));

        internal static ArgumentOutOfRangeException InvalidMissingMappingAction(MissingMappingAction value) => 
            InvalidEnumerationValue(typeof(MissingMappingAction), (int) value);

        internal static ArgumentOutOfRangeException InvalidMissingSchemaAction(MissingSchemaAction value) => 
            InvalidEnumerationValue(typeof(MissingSchemaAction), (int) value);
        ...
        internal static ArgumentException InvalidOffsetValue(int value) => 
            Argument(System.Data.Res.GetString("ADP_InvalidOffsetValue", new object[] { value.ToString(CultureInfo.InvariantCulture) }));
        ...
        internal static ArgumentException InvalidRestrictionValue(string collectionName, string restrictionName, string restrictionValue) => 
            Argument(System.Data.Res.GetString("MDF_InvalidRestrictionValue", new object[] { collectionName, restrictionName, restrictionValue }));

        internal static ArgumentOutOfRangeException InvalidRule(Rule value) => 
            InvalidEnumerationValue(typeof(Rule), (int) value);

        internal static ArgumentOutOfRangeException InvalidSchemaType(SchemaType value) => 
            InvalidEnumerationValue(typeof(SchemaType), (int) value);

        internal static Exception InvalidSeekOrigin(string parameterName) => 
            ArgumentOutOfRange(System.Data.Res.GetString("ADP_InvalidSeekOrigin"), parameterName);

        internal static ArgumentException InvalidSizeValue(int value) => 
            Argument(System.Data.Res.GetString("ADP_InvalidSizeValue", new object[] { value.ToString(CultureInfo.InvariantCulture) }));

        internal static ArgumentOutOfRangeException InvalidSourceBufferIndex(int maxLen, long srcOffset, string parameterName) => 
            ArgumentOutOfRange(System.Data.Res.GetString("ADP_InvalidSourceBufferIndex", new object[] { maxLen.ToString(CultureInfo.InvariantCulture), srcOffset.ToString(CultureInfo.InvariantCulture) }), parameterName);

        internal static Exception InvalidSourceColumn(string parameter) => 
            Argument(System.Data.Res.GetString("ADP_InvalidSourceColumn"), parameter);

        internal static Exception InvalidSourceTable(string parameter) => 
            Argument(System.Data.Res.GetString("ADP_InvalidSourceTable"), parameter);

        internal static Exception InvalidStartRecord(string parameter, int start) => 
            Argument(System.Data.Res.GetString("ADP_InvalidStartRecord", new object[] { start.ToString(CultureInfo.InvariantCulture) }), parameter);

        internal static ArgumentOutOfRangeException InvalidStatementType(StatementType value) => 
            InvalidEnumerationValue(typeof(StatementType), (int) value);

        internal static ArgumentException InvalidUDL() => 
            Argument(System.Data.Res.GetString("ADP_InvalidUDL"));
        ...
        internal static ArgumentOutOfRangeException InvalidUpdateStatus(UpdateStatus value) => 
            InvalidEnumerationValue(typeof(UpdateStatus), (int) value);

        internal static ArgumentOutOfRangeException InvalidUserDefinedTypeSerializationFormat(Format value) => 
            InvalidEnumerationValue(typeof(Format), (int) value);

        internal static ArgumentException InvalidValue(string parameterName) => 
            Argument(System.Data.Res.GetString("ADP_InvalidValue"), parameterName);

        internal static Exception InvalidXml() => 
            Argument(System.Data.Res.GetString("MDF_InvalidXml"));

        internal static Exception InvalidXMLBadVersion() => 
            Argument(System.Data.Res.GetString("ADP_InvalidXMLBadVersion"));

        internal static Exception InvalidXmlInvalidValue(string collectionName, string columnName) => 
            Argument(System.Data.Res.GetString("MDF_InvalidXmlInvalidValue", new object[] { collectionName, columnName }));

        internal static Exception InvalidXmlMissingColumn(string collectionName, string columnName) => 
            Argument(System.Data.Res.GetString("MDF_InvalidXmlMissingColumn", new object[] { collectionName, columnName }));
        ...
        internal static bool IsSysTxEqualSysEsTransaction() => 
            ((!ContextUtil.IsInTransaction && (null == Transaction.Current)) || (ContextUtil.IsInTransaction && (Transaction.Current == ContextUtil.SystemTransaction)));

        internal static ArgumentException KeywordNotSupported(string keyword) => 
            Argument(System.Data.Res.GetString("ADP_KeywordNotSupported", new object[] { keyword }));

        internal static Exception LiteralValueIsInvalid(string dataTypeName) => 
            Argument(System.Data.Res.GetString("ADP_LiteralValueIsInvalid", new object[] { dataTypeName }));
        ...
        internal static Exception LocalTransactionPresent() => 
            InvalidOperation(System.Data.Res.GetString("ADP_LocalTransactionPresent"));
        ...
        internal static Exception MismatchedAsyncResult(string expectedMethod, string gotMethod) => 
            InvalidOperation(System.Data.Res.GetString("ADP_MismatchedAsyncResult", new object[] { expectedMethod, gotMethod }));

        internal static InvalidOperationException MissingColumnMapping(string srcColumn) => 
            DataMapping(System.Data.Res.GetString("ADP_MissingColumnMapping", new object[] { srcColumn }));

        internal static Exception MissingConnectionOptionValue(string key, string requiredAdditionalKey) => 
            Argument(System.Data.Res.GetString("ADP_MissingConnectionOptionValue", new object[] { key, requiredAdditionalKey }));

        internal static InvalidOperationException MissingDataReaderFieldType(int index) => 
            DataAdapter(System.Data.Res.GetString("ADP_MissingDataReaderFieldType", new object[] { index }));

        internal static Exception MissingDataSourceInformationColumn() => 
            Argument(System.Data.Res.GetString("MDF_MissingDataSourceInformationColumn"));

        internal static Exception MissingRestrictionColumn() => 
            Argument(System.Data.Res.GetString("MDF_MissingRestrictionColumn"));

        internal static Exception MissingRestrictionRow() => 
            Argument(System.Data.Res.GetString("MDF_MissingRestrictionRow"));

        internal static InvalidOperationException MissingSelectCommand(string method) => 
            Provider(System.Data.Res.GetString("ADP_MissingSelectCommand", new object[] { method }));

        internal static InvalidOperationException MissingSourceCommand() => 
            InvalidOperation(System.Data.Res.GetString("ADP_MissingSourceCommand"));

        internal static InvalidOperationException MissingSourceCommandConnection() => 
            InvalidOperation(System.Data.Res.GetString("ADP_MissingSourceCommandConnection"));

        internal static InvalidOperationException MissingTableMapping(string srcTable) => 
            DataMapping(System.Data.Res.GetString("ADP_MissingTableMapping", new object[] { srcTable }));

        internal static InvalidOperationException MissingTableMappingDestination(string dstTable) => 
            DataMapping(System.Data.Res.GetString("ADP_MissingTableMappingDestination", new object[] { dstTable }));

        internal static InvalidOperationException MissingTableSchema(string cacheTable, string srcTable) => 
            DataMapping(System.Data.Res.GetString("ADP_MissingTableSchema", new object[] { cacheTable, srcTable }));
        ...
        internal static Exception NegativeParameter(string parameterName) => 
            InvalidOperation(System.Data.Res.GetString("ADP_NegativeParameter", new object[] { parameterName }));

        internal static Exception NoColumns() => 
            Argument(System.Data.Res.GetString("MDF_NoColumns"));

        internal static InvalidOperationException NoConnectionString() => 
            InvalidOperation(System.Data.Res.GetString("ADP_NoConnectionString"));

        internal static Exception NonSeqByteAccess(long badIndex, long currIndex, string method) => 
            InvalidOperation(System.Data.Res.GetString("ADP_NonSeqByteAccess", new object[] { badIndex.ToString(CultureInfo.InvariantCulture), currIndex.ToString(CultureInfo.InvariantCulture), method }));

        internal static InvalidOperationException NonSequentialColumnAccess(int badCol, int currCol) => 
            InvalidOperation(System.Data.Res.GetString("ADP_NonSequentialColumnAccess", new object[] { badCol.ToString(CultureInfo.InvariantCulture), currCol.ToString(CultureInfo.InvariantCulture) }));

        internal static InvalidOperationException NoQuoteChange() => 
            InvalidOperation(System.Data.Res.GetString("ADP_NoQuoteChange"));

        internal static Exception NoStoredProcedureExists(string sproc) => 
            InvalidOperation(System.Data.Res.GetString("ADP_NoStoredProcedureExists", new object[] { sproc }));

        internal static Exception NotADataColumnMapping(object value) => 
            CollectionInvalidType(typeof(DataColumnMappingCollection), typeof(DataColumnMapping), value);

        internal static Exception NotADataTableMapping(object value) => 
            CollectionInvalidType(typeof(DataTableMappingCollection), typeof(DataTableMapping), value);

        internal static Exception NotAPermissionElement() => 
            Argument(System.Data.Res.GetString("ADP_NotAPermissionElement"));
        ...
        internal static Exception NotRowType() => 
            InvalidOperation(System.Data.Res.GetString("ADP_NotRowType"));
        ...
        internal static ArgumentOutOfRangeException NotSupportedEnumerationValue(Type type, string value, string method) => 
            ArgumentOutOfRange(System.Data.Res.GetString("ADP_NotSupportedEnumerationValue", new object[] { type.Name, value, method }), type.Name);

        internal static ArgumentOutOfRangeException NotSupportedStatementType(StatementType value, string method) => 
            NotSupportedEnumerationValue(typeof(StatementType), value.ToString(), method);
        ...
        internal static Exception NumericToDecimalOverflow() => 
            InvalidCast(System.Data.Res.GetString("ADP_NumericToDecimalOverflow"));
        ...
        internal static Exception OffsetOutOfRangeException() => 
            InvalidOperation(System.Data.Res.GetString("ADP_OffsetOutOfRangeException"));

        internal static InvalidOperationException OnlyOneTableForStartRecordOrMaxRecords() => 
            DataAdapter(System.Data.Res.GetString("ADP_OnlyOneTableForStartRecordOrMaxRecords"));

        internal static Exception OpenConnectionPropertySet(string property, ConnectionState state) => 
            InvalidOperation(System.Data.Res.GetString("ADP_OpenConnectionPropertySet", new object[] { property, ConnectionStateMsg(state) }));

        internal static InvalidOperationException OpenConnectionRequired(string method, ConnectionState state) => 
            InvalidOperation(System.Data.Res.GetString("ADP_OpenConnectionRequired", new object[] { method, ConnectionStateMsg(state) }));

        internal static Exception OpenReaderExists() => 
            OpenReaderExists(null);

        internal static Exception OpenReaderExists(Exception e) => 
            InvalidOperation(System.Data.Res.GetString("ADP_OpenReaderExists"), e);
        ...
        internal static Exception ParallelTransactionsNotSupported(IDbConnection obj) => 
            InvalidOperation(System.Data.Res.GetString("ADP_ParallelTransactionsNotSupported", new object[] { obj.GetType().Name }));
        ...
        internal static ArgumentException ParametersIsNotParent(Type parameterType, ICollection collection) => 
            Argument(System.Data.Res.GetString("ADP_CollectionIsNotParent", new object[] { parameterType.Name, collection.GetType().Name }));
        ...
        internal static ArgumentException ParameterValueOutOfRange(SqlDecimal value) => 
            Argument(System.Data.Res.GetString("ADP_ParameterValueOutOfRange", new object[] { value.ToString() }));

        internal static ArgumentException ParameterValueOutOfRange(decimal value) => 
            Argument(System.Data.Res.GetString("ADP_ParameterValueOutOfRange", new object[] { value.ToString((IFormatProvider) null) }));

        internal static Exception PermissionTypeMismatch() => 
            Argument(System.Data.Res.GetString("ADP_PermissionTypeMismatch"));

        internal static Exception PooledOpenTimeout() => 
            InvalidOperation(System.Data.Res.GetString("ADP_PooledOpenTimeout"));

        internal static Exception PrepareParameterScale(IDbCommand cmd, string type) => 
            InvalidOperation(System.Data.Res.GetString("ADP_PrepareParameterScale", new object[] { cmd.GetType().Name, type }));

        internal static Exception PrepareParameterSize(IDbCommand cmd) => 
            InvalidOperation(System.Data.Res.GetString("ADP_PrepareParameterSize", new object[] { cmd.GetType().Name }));

        internal static Exception PrepareParameterType(IDbCommand cmd) => 
            InvalidOperation(System.Data.Res.GetString("ADP_PrepareParameterType", new object[] { cmd.GetType().Name }));
        ...
        internal static Exception QueryFailed(string collectionName, Exception e) => 
            InvalidOperation(System.Data.Res.GetString("MDF_QueryFailed", new object[] { collectionName }), e);

        internal static InvalidOperationException QuotePrefixNotSet(string method) => 
            InvalidOperation(System.Data.Res.GetString("ADP_QuotePrefixNotSet", new object[] { method }));
        ...
        internal static InvalidOperationException ResultsNotAllowedDuringBatch() => 
            DataAdapter(System.Data.Res.GetString("ADP_ResultsNotAllowedDuringBatch"));

        internal static DataException RowUpdatedErrors() => 
            Data(System.Data.Res.GetString("ADP_RowUpdatedErrors"));

        internal static DataException RowUpdatingErrors() => 
            Data(System.Data.Res.GetString("ADP_RowUpdatingErrors"));
        ...
        internal static Exception StreamClosed(string method) => 
            InvalidOperation(System.Data.Res.GetString("ADP_StreamClosed", new object[] { method }));

        internal static int StringLength(string inputString) => 
            inputString?.Length;

        internal static Exception TablesAddNullAttempt(string parameter) => 
            CollectionNullValue(parameter, typeof(DataTableMappingCollection), typeof(DataTableMapping));

        internal static Exception TablesDataSetTable(string cacheTable) => 
            CollectionIndexString(typeof(DataTableMapping), "DataSetTable", cacheTable, typeof(DataTableMappingCollection));
        ...
        internal static Exception TablesIsNotParent(ICollection collection) => 
            ParametersIsNotParent(typeof(DataTableMapping), collection);

        internal static Exception TablesIsParent(ICollection collection) => 
            ParametersIsParent(typeof(DataTableMapping), collection);

        internal static Exception TablesSourceIndex(string srcTable) => 
            CollectionIndexString(typeof(DataTableMapping), "SourceTable", srcTable, typeof(DataTableMappingCollection));

        internal static Exception TablesUniqueSourceTable(string srcTable) => 
            CollectionUniqueValue(typeof(DataTableMapping), "SourceTable", srcTable);
        ...
        internal static Exception TransactionCompleted() => 
            DataAdapter(System.Data.Res.GetString("ADP_TransactionCompleted"));

        internal static InvalidOperationException TransactionConnectionMismatch() => 
            Provider(System.Data.Res.GetString("ADP_TransactionConnectionMismatch"));

        internal static Exception TransactionPresent() => 
            InvalidOperation(System.Data.Res.GetString("ADP_TransactionPresent"));

        internal static InvalidOperationException TransactionRequired(string method) => 
            Provider(System.Data.Res.GetString("ADP_TransactionRequired", new object[] { method }));

        internal static Exception TransactionZombied(IDbTransaction obj) => 
            InvalidOperation(System.Data.Res.GetString("ADP_TransactionZombied", new object[] { obj.GetType().Name }));
        ...
        internal static ArgumentException UdlFileError(Exception inner) => 
            Argument(System.Data.Res.GetString("ADP_UdlFileError"), inner);

        internal static Exception UnableToBuildCollection(string collectionName) => 
            Argument(System.Data.Res.GetString("MDF_UnableToBuildCollection", new object[] { collectionName }));

        internal static InvalidOperationException UnableToCreateBooleanLiteral() => 
            InvalidOperation(System.Data.Res.GetString("ADP_UnableToCreateBooleanLiteral"));

        internal static Exception UndefinedCollection(string collectionName) => 
            Argument(System.Data.Res.GetString("MDF_UndefinedCollection", new object[] { collectionName }));

        internal static Exception UndefinedPopulationMechanism(string populationMechanism) => 
            Argument(System.Data.Res.GetString("MDF_UndefinedPopulationMechanism", new object[] { populationMechanism }));

        internal static Exception UninitializedParameterSize(int index, Type dataType) => 
            InvalidOperation(System.Data.Res.GetString("ADP_UninitializedParameterSize", new object[] { index.ToString(CultureInfo.InvariantCulture), dataType.Name }));

        internal static ArgumentException UnknownDataType(Type dataType) => 
            Argument(System.Data.Res.GetString("ADP_UnknownDataType", new object[] { dataType.FullName }));
        ...
        internal static Exception UnsupportedNativeDataTypeOleDb(string dataTypeName) => 
            Argument(System.Data.Res.GetString("ADP_UnsupportedNativeDataTypeOleDb", new object[] { dataTypeName }));

        internal static Exception UnsupportedVersion(string collectionName) => 
            Argument(System.Data.Res.GetString("MDF_UnsupportedVersion", new object[] { collectionName }));

        internal static ArgumentException UnwantedStatementType(StatementType statementType) => 
            Argument(System.Data.Res.GetString("ADP_UnwantedStatementType", new object[] { statementType.ToString() }));
        ...
        internal static ArgumentException UpdateMismatchRowTable(int i) => 
            Argument(System.Data.Res.GetString("ADP_UpdateMismatchRowTable", new object[] { i.ToString(CultureInfo.InvariantCulture) }));
        ...
        internal static InvalidOperationException UpdateRequiresSourceTable(string defaultSrcTableName) => 
            InvalidOperation(System.Data.Res.GetString("ADP_UpdateRequiresSourceTable", new object[] { defaultSrcTableName }));

        internal static InvalidOperationException UpdateRequiresSourceTableName(string srcTable) => 
            InvalidOperation(System.Data.Res.GetString("ADP_UpdateRequiresSourceTableName", new object[] { srcTable }));
        ...
        internal static ArgumentException VersionDoesNotSupportDataType(string typeName) => 
            Argument(System.Data.Res.GetString("ADP_VersionDoesNotSupportDataType", new object[] { typeName }));

        internal static Exception WrongType(Type got, Type expected) => 
            Argument(System.Data.Res.GetString("SQL_WrongType", new object[] { got.ToString(), expected.ToString() }));
