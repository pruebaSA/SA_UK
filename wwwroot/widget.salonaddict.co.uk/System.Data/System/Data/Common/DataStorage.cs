namespace System.Data.Common
{
    ...
    internal abstract class DataStorage
    {
        ...
        static DataStorage()
        {
            ...
            typeArray[0x18] = typeof(Uri);
            typeArray[0x19] = typeof(SqlBinary);
            typeArray[0x1a] = typeof(SqlBoolean);
            typeArray[0x1b] = typeof(SqlByte);
            typeArray[0x1c] = typeof(SqlBytes);
            typeArray[0x1d] = typeof(SqlChars);
            typeArray[30] = typeof(SqlDateTime);
            typeArray[0x1f] = typeof(SqlDecimal);
            typeArray[0x20] = typeof(SqlDouble);
            typeArray[0x21] = typeof(SqlGuid);
            typeArray[0x22] = typeof(SqlInt16);
            typeArray[0x23] = typeof(SqlInt32);
            typeArray[0x24] = typeof(SqlInt64);
            typeArray[0x25] = typeof(SqlMoney);
            typeArray[0x26] = typeof(SqlSingle);
            typeArray[0x27] = typeof(SqlString);
        ...
        public virtual int Compare(int recordNo1, int recordNo2)
        {
            ...
            {
                object obj3 = this.Get(recordNo2);
                if (obj3.GetType() == obj2.GetType())
                {
        ...
        public virtual object ConvertXmlToObject(XmlReader xmlReader, XmlRootAttribute xmlAttrib) => 
            this.ConvertXmlToObject(xmlReader.Value);
        ...
        internal object GetEmptyStorageInternal(int recordCount) => 
            this.GetEmptyStorage(recordCount);
        ...
        internal static Type GetTypeStorage(StorageType storageType) => 
            StorageClassType[(int) storageType];

        protected bool HasValue(int recordNo) => 
            !this.dbNullBits.Get(recordNo);
        ...
        internal static bool ImplementsINullableValue(StorageType typeCode, Type dataType) => 
            (((typeCode == StorageType.Empty) && dataType.IsGenericType) && (dataType.GetGenericTypeDefinition() == typeof(Nullable<>)));
        ...
        internal static bool IsSqlType(StorageType storageType) => 
            (StorageType.SqlBinary <= storageType);

        public static bool IsSqlType(Type dataType)
        {
            for (int i = 0x19; i < StorageClassType.Length; i++)
            {
                if (dataType == StorageClassType[i])
                {
                    return true;
        ...
        internal static bool IsTypeCustomType(Type type) => 
            IsTypeCustomType(GetStorageType(type));
