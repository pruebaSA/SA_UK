namespace System.Data.Common
{
    ...
    internal class DbConnectionOptions
    {
        ...
        public bool ContainsKey(string keyword) => 
            this._parsetable.ContainsKey(keyword);
        ...
        public string UsersConnectionString(bool hidePassword) => 
            this.UsersConnectionString(hidePassword, false);
        ...
        internal string UsersConnectionStringForTrace() => 
            this.UsersConnectionString(true, true);
        ...
        public string this[string keyword] =>
            ((string) this._parsetable[keyword]);

        public ICollection Keys =>
            this._parsetable.Keys;
