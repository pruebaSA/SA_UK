namespace System.Data.Common
{
    ...
    [ListBindable(false), Editor("Microsoft.VSDesigner.Data.Design.DataTableMappingCollectionEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public sealed class DataTableMappingCollection : MarshalByRefObject, ITableMappingCollection, IList, ICollection, IEnumerable
    {
        ...
        public DataTableMapping Add(string sourceTable, string dataSetTable) => 
            this.Add(new DataTableMapping(sourceTable, dataSetTable));
        ...
        ITableMapping ITableMappingCollection.Add(string sourceTableName, string dataSetTableName) => 
            this.Add(sourceTableName, dataSetTableName);

        ITableMapping ITableMappingCollection.GetByDataSetTable(string dataSetTableName) => 
            this.GetByDataSetTable(dataSetTableName);
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ResDescription("DataTableMappings_Count")]
        public int Count =>
            this.items?.Count;

        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ResDescription("DataTableMappings_Item")]
