namespace System.Data.Common
{
    ...
    public abstract class DbDataAdapter : DataAdapter, IDbDataAdapter, IDataAdapter, ICloneable
    {
        ...
        private IDbCommand CloneCommand(IDbCommand command) => 
            ((command is ICloneable) ? ((IDbCommand) ((ICloneable) command).Clone()) : null);
        ...
        {
            get => 
                (this._fillCommandBehavior | CommandBehavior.SequentialAccess);
            set
            {
        ...
        {
            get => 
                ((DbCommand) this._IDbDataAdapter.SelectCommand);
            set
            {
        ...
        [ResCategory("DataCategory_Update"), DefaultValue(1), ResDescription("DbDataAdapter_UpdateBatchSize")]
