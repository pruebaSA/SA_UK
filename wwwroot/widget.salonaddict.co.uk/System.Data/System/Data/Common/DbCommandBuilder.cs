namespace System.Data.Common
{
    ...
    public abstract class DbCommandBuilder : Component
    {
        ...
        private object GetColumnValue(DataRow row, string columnName, DataTableMapping mappings, DataRowVersion version) => 
            this.GetColumnValue(row, this.GetDataColumn(columnName, mappings, row), version);
        ...
        public DbCommand GetDeleteCommand() => 
            this.GetDeleteCommand(null, false);

        public DbCommand GetDeleteCommand(bool useColumnsForParameterNames) => 
            this.GetDeleteCommand(null, useColumnsForParameterNames);
        ...
        public DbCommand GetInsertCommand() => 
            this.GetInsertCommand(null, false);

        public DbCommand GetInsertCommand(bool useColumnsForParameterNames) => 
            this.GetInsertCommand(null, useColumnsForParameterNames);
        ...
        public DbCommand GetUpdateCommand() => 
            this.GetUpdateCommand(null, false);

        public DbCommand GetUpdateCommand(bool useColumnsForParameterNames) => 
            this.GetUpdateCommand(null, useColumnsForParameterNames);
        ...
        private bool IncludeInInsertValues(DbSchemaRow row) => 
            (((!row.IsAutoIncrement && !row.IsHidden) && !row.IsExpression) && !row.IsRowVersion);

        private bool IncludeInUpdateSet(DbSchemaRow row) => 
            ((!row.IsAutoIncrement && !row.IsRowVersion) && !row.IsHidden);
        ...
        private string QuotedColumn(string column) => 
            ADP.BuildQuotedString(this.QuotePrefix, this.QuoteSuffix, column);
                    ...
                    if (insertCommand != null)
                    {
                        ...
                        if (insertCommand != rowUpdatingEvent.Command)
                        {
                            ...
                            if ((insertCommand != null) && (insertCommand.Connection == null))
                            {
                                ...
                                if (selectCommand != null)
                                {
                                    insertCommand.Connection = selectCommand.Connection;
                                }
                            }
                        }
                        else
        ...
        [ResCategory("DataCategory_Update"), ResDescription("DbCommandBuilder_ConflictOption"), DefaultValue(1)]
        ...
        [ResDescription("DbCommandBuilder_DataAdapter"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        internal int ParameterNameMaxLength =>
            this._parameterNameMaxLength;

        internal string ParameterNamePattern =>
            this._parameterNamePattern;

        private string QuotedBaseTableName =>
            this._quotedBaseTableName;

        [ResCategory("DataCategory_Schema"), DefaultValue(""), ResDescription("DbCommandBuilder_QuotePrefix")]
        ...
        [DefaultValue(""), ResCategory("DataCategory_Schema"), ResDescription("DbCommandBuilder_QuoteSuffix")]
        ...
        [ResDescription("DbCommandBuilder_SchemaSeparator"), ResCategory("DataCategory_Schema"), DefaultValue(".")]
        ...
        [DefaultValue(false), ResCategory("DataCategory_Schema"), ResDescription("DbCommandBuilder_SetAllValues")]
        ...
        private class ParameterNames
        {
            ...
            internal string GetBaseParameterName(int index) => 
                this._baseParameterNames[index];
            ...
            internal string GetNullParameterName(int index) => 
                this._nullParameterNames[index];

            internal string GetOriginalParameterName(int index) => 
                this._originalParameterNames[index];
