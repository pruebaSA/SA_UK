namespace System.Data.Common
{
    ...
    public class DataAdapter : Component, IDataAdapter
    {
        ...
        [ResCategory("DataCategory_Fill"), ResDescription("DataAdapter_FillError")]
        ...
        internal DataTableMapping GetTableMappingBySchemaAction(string sourceTableName, string dataSetTableName, System.Data.MissingMappingAction mappingAction) => 
            DataTableMappingCollection.GetTableMappingBySchemaAction(this._tableMappings, sourceTableName, dataSetTableName, mappingAction);

        protected bool HasTableMappings() => 
            ((this._tableMappings != null) && (0 < this.TableMappings.Count));
        ...
        public virtual bool ShouldSerializeAcceptChangesDuringFill() => 
            (((LoadOption) 0) == this._fillLoadOption);
        ...
        [DefaultValue(true), ResDescription("DataAdapter_AcceptChangesDuringFill"), ResCategory("DataCategory_Fill")]
        public bool AcceptChangesDuringFill
        {
            get => 
                this._acceptChangesDuringFill;
            set
            {
        ...
        [ResDescription("DataAdapter_AcceptChangesDuringUpdate"), DefaultValue(true), ResCategory("DataCategory_Update")]
        ...
        [ResCategory("DataCategory_Update"), ResDescription("DataAdapter_ContinueUpdateOnError"), DefaultValue(false)]
        public bool ContinueUpdateOnError
        {
            get => 
                this._continueUpdateOnError;
            set
            {
        ...
        [ResCategory("DataCategory_Fill"), ResDescription("DataAdapter_FillLoadOption"), RefreshProperties(RefreshProperties.All)]
        ...
        [DefaultValue(1), ResDescription("DataAdapter_MissingMappingAction"), ResCategory("DataCategory_Mapping")]
        public System.Data.MissingMappingAction MissingMappingAction
        {
            get => 
                this._missingMappingAction;
            set
            {
                switch (value)
                {
        ...
        [ResCategory("DataCategory_Fill"), ResDescription("DataAdapter_ReturnProviderSpecificTypes"), DefaultValue(false)]
        public virtual bool ReturnProviderSpecificTypes
        {
            get => 
                this._returnProviderSpecificTypes;
            set
            {
        ...
        [ResDescription("DataAdapter_TableMappings"), ResCategory("DataCategory_Mapping"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
