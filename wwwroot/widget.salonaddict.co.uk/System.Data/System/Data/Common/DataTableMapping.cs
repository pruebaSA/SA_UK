namespace System.Data.Common
{
    ...
    public sealed class DataTableMapping : MarshalByRefObject, ITableMapping, ICloneable
    {
        ...
        public DataColumnMapping GetColumnMappingBySchemaAction(string sourceColumn, MissingMappingAction mappingAction) => 
            DataColumnMappingCollection.GetColumnMappingBySchemaAction(this._columnMappings, sourceColumn, mappingAction);

        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public DataColumn GetDataColumn(string sourceColumn, Type dataType, DataTable dataTable, MissingMappingAction mappingAction, MissingSchemaAction schemaAction) => 
            DataColumnMappingCollection.GetDataColumn(this._columnMappings, sourceColumn, dataType, dataTable, mappingAction, schemaAction);
        ...
        [ResDescription("DataTableMapping_ColumnMappings"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), ResCategory("DataCategory_Mapping")]
        ...
        [DefaultValue(""), ResCategory("DataCategory_Mapping"), ResDescription("DataTableMapping_SourceTable")]
