namespace System.Data.Common
{
    ...
    public class DbConnectionStringBuilder : IDictionary, ICollection, IEnumerable, ICustomTypeDescriptor
    {
        ...
        bool IDictionary.Contains(object keyword) => 
            this.ContainsKey(this.ObjectToString(keyword));
        ...
        [DesignOnly(true), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), EditorBrowsable(EditorBrowsableState.Never)]
        public bool BrowsableConnectionString
        {
            get => 
                this._browsableConnectionString;
            set
            {
        ...
        [ResDescription("DbConnectionString_ConnectionString"), ResCategory("DataCategory_Data"), RefreshProperties(RefreshProperties.All)]
        ...
        {
            get => 
                this[this.ObjectToString(keyword)];
            set
            {
