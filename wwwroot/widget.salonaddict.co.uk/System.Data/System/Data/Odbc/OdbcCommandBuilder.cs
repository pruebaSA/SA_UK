namespace System.Data.Odbc
{
    ...
    public sealed class OdbcCommandBuilder : DbCommandBuilder
    {
        ...
        public OdbcCommand GetDeleteCommand() => 
            ((OdbcCommand) base.GetDeleteCommand());

        public OdbcCommand GetDeleteCommand(bool useColumnsForParameterNames) => 
            ((OdbcCommand) base.GetDeleteCommand(useColumnsForParameterNames));

        public OdbcCommand GetInsertCommand() => 
            ((OdbcCommand) base.GetInsertCommand());

        public OdbcCommand GetInsertCommand(bool useColumnsForParameterNames) => 
            ((OdbcCommand) base.GetInsertCommand(useColumnsForParameterNames));
        ...
        public OdbcCommand GetUpdateCommand() => 
            ((OdbcCommand) base.GetUpdateCommand());

        public OdbcCommand GetUpdateCommand(bool useColumnsForParameterNames) => 
            ((OdbcCommand) base.GetUpdateCommand(useColumnsForParameterNames));
        ...
        [ResDescription("OdbcCommandBuilder_DataAdapter"), DefaultValue((string) null), ResCategory("DataCategory_Update")]
        public OdbcDataAdapter DataAdapter
        {
            get => 
                (base.DataAdapter as OdbcDataAdapter);
            set
            {
