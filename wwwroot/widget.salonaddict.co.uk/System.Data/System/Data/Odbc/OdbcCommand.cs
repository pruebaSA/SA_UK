namespace System.Data.Odbc
{
    ...
    [Designer("Microsoft.VSDesigner.Data.VS.OdbcCommandDesigner, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultEvent("RecordsAffected"), ToolboxItem(true)]
    public sealed class OdbcCommand : DbCommand, ICloneable
    {
        ...
        internal OdbcDataReader ExecuteReaderFromSQLMethod(object[] methodArguments, ODBC32.SQL_API method) => 
            this.ExecuteReaderObject(CommandBehavior.Default, method.ToString(), true, methodArguments, method);
                ...
                if ((needReader && this.Connection.IsV3Driver) && (!this.Connection.ProviderInfo.NoSqlSoptSSNoBrowseTable && !this.Connection.ProviderInfo.NoSqlSoptSSHiddenColumns))
                {
                    if (target.IsBehavior(CommandBehavior.KeyInfo))
                    {
                        if (!this._cmdWrapper._ssKeyInfoModeOn)
                        {
                            ...
                            this.TrySetStatementAttribute(statementHandle, (ODBC32.SQL_ATTR) 0x4cb, (IntPtr) 1L);
                    ...
                    else if (!this._cmdWrapper._ssKeyInfoModeOff)
                    {
                        ...
                        this.TrySetStatementAttribute(statementHandle, (ODBC32.SQL_ATTR) 0x4cb, (IntPtr) 0L);
        ...
        internal OdbcDescriptorHandle GetDescriptorHandle(ODBC32.SQL_ATTR attribute) => 
            this._cmdWrapper.GetDescriptorHandle(attribute);

        internal string GetDiagSqlState() => 
            this._cmdWrapper.GetDiagSqlState();
        ...
        internal bool Canceling =>
            this._cmdWrapper.Canceling;

        [ResDescription("DbCommand_CommandText"), ResCategory("DataCategory_Data"), RefreshProperties(RefreshProperties.All), DefaultValue(""), Editor("Microsoft.VSDesigner.Data.Odbc.Design.OdbcCommandTextEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
        ...
        [ResCategory("DataCategory_Data"), DefaultValue(1), RefreshProperties(RefreshProperties.All), ResDescription("DbCommand_CommandType")]
        ...
        [ResDescription("DbCommand_Connection"), ResCategory("DataCategory_Behavior"), DefaultValue((string) null), Editor("Microsoft.VSDesigner.Data.Design.DbConnectionEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
        ...
        internal bool HasParameters =>
            (null != this._parameterCollection);
