    ...
    public sealed class OdbcDataReader : DbDataReader
    {
        ...
        private void BuildMetaDataInfo()
        {
            ...
            for (int i = 0; i < fieldCount; i++)
            {
                ...
                TypeMap typeMap = TypeMap.FromSqlType((ODBC32.SQL_TYPE) ((short) this.GetColAttribute(i, ODBC32.SQL_DESC.CONCISE_TYPE, ODBC32.SQL_COLUMN.TYPE, ODBC32.HANDLER.THROW)._value));
                if (typeMap._signType)
                {
                    bool unsigned = this.GetColAttribute(i, ODBC32.SQL_DESC.UNSIGNED, ODBC32.SQL_COLUMN.UNSIGNED, ODBC32.HANDLER.THROW)._value != 0;
                ...
                ODBC32.SQL_NULLABILITY sql_nullability = (ODBC32.SQL_NULLABILITY) ((ushort) this.GetColAttribute(i, ODBC32.SQL_DESC.NULLABLE, ODBC32.SQL_COLUMN.NULLABLE, ODBC32.HANDLER.IGNORE)._value);
        ...
        internal ODBC32.RetCode FieldCountNoThrow(out short cColsAffected)
        {
            ...
            if ((this.IsCommandBehavior(CommandBehavior.KeyInfo) && !this.Connection.ProviderInfo.NoSqlSoptSSNoBrowseTable) && !this.Connection.ProviderInfo.NoSqlSoptSSHiddenColumns)
            {
                ...
                {
                    if (this.GetColAttribute(i, (ODBC32.SQL_DESC) 0x4bb, ~ODBC32.SQL_COLUMN.COUNT, ODBC32.HANDLER.IGNORE)._value == 1)
                    {
        ...
        public override bool GetBoolean(int i) => 
            ((bool) this.internalGetBoolean(i));

        public override byte GetByte(int i) => 
            ((byte) this.internalGetByte(i));

        public override long GetBytes(int i, long dataIndex, byte[] buffer, int bufferIndex, int length) => 
            this.GetBytesOrChars(i, dataIndex, buffer, false, bufferIndex, length);
        ...
        public override char GetChar(int i) => 
            ((char) this.internalGetChar(i));

        public override long GetChars(int i, long dataIndex, char[] buffer, int bufferIndex, int length) => 
            this.GetBytesOrChars(i, dataIndex, buffer, true, bufferIndex, length);
        ...
        public DateTime GetDate(int i) => 
            ((DateTime) this.internalGetDate(i));

        public override DateTime GetDateTime(int i) => 
            ((DateTime) this.internalGetDateTime(i));

        public override decimal GetDecimal(int i) => 
            ((decimal) this.internalGetDecimal(i));
        ...
        public override double GetDouble(int i) => 
            ((double) this.internalGetDouble(i));

        public override IEnumerator GetEnumerator() => 
            new DbEnumerator(this, this.IsCommandBehavior(CommandBehavior.CloseConnection));
        ...
        public override float GetFloat(int i) => 
            ((float) this.internalGetFloat(i));

        public override Guid GetGuid(int i) => 
            ((Guid) this.internalGetGuid(i));

        public override short GetInt16(int i) => 
            ((short) this.internalGetInt16(i));

        public override int GetInt32(int i) => 
            ((int) this.internalGetInt32(i));

        public override long GetInt64(int i) => 
            ((long) this.internalGetInt64(i));
        ...
        public override int GetOrdinal(string value) => 
            this._fieldNameLookup?.GetOrdinal(value);

        internal int GetOrdinalFromBaseColName(string columnname) => 
            this.GetOrdinalFromBaseColName(columnname, null);
        ...
        public override DataTable GetSchemaTable()
        {
            ...
            if (this.FieldCount != 0)
            {
                ...
                for (int i = 0; i < fieldCount; i++)
                {
                    ...
                    row[column17] = i;
                    row[column16] = Math.Min(Math.Max(-2147483648, this.metadata[i].size._value), 0x7fffffff);
        ...
        private TypeMap GetSqlType(int i)
        {
            ...
            {
                schema._dbtype = new ODBC32.SQL_TYPE?((ODBC32.SQL_TYPE) ((short) this.GetColAttribute(i, ODBC32.SQL_DESC.CONCISE_TYPE, ODBC32.SQL_COLUMN.TYPE, ODBC32.HANDLER.THROW)._value));
        ...
        public override string GetString(int i) => 
            ((string) this.internalGetString(i));
        ...
        public TimeSpan GetTime(int i) => 
            ((TimeSpan) this.internalGetTime(i));
        ...
        internal object GetValue(int i, TypeMap typemap)
        {
            switch (typemap._sql_type)
            {
                ...
                case ODBC32.SQL_TYPE.SS_VARIANT:
                    ...
                    {
                        ODBC32.SQL_TYPE sqltype = (ODBC32.SQL_TYPE) ((short) this.GetColAttribute(i, (ODBC32.SQL_DESC) 0x4c0, ~ODBC32.SQL_COLUMN.COUNT, ODBC32.HANDLER.THROW)._value);
        ...
        private int IndexOf(string value) => 
            this._fieldNameLookup?.IndexOf(value);
        ...
        internal bool IsBehavior(CommandBehavior behavior) => 
            this.IsCommandBehavior(behavior);

        private bool IsCommandBehavior(CommandBehavior condition) => 
            (condition == (condition & this._commandBehavior));
        ...
        private int readBytesOrCharsSequentialAccess(int i, Array buffer, bool isCharsBuffer, int bufferIndex, long bytesOrCharsLength)
        {
            ...
            while (num3 > 0L)
            {
                ...
                if (!flag2)
                {
                    if (isCharsBuffer)
                    {
                        string text1 = (string) this.dataCache[i];
                    }
                    else
                    {
                        byte[] buffer1 = (byte[]) this.dataCache[i];
                    }
                }
                bool flag = false;
                if (num5 == 0)
        ...
        internal bool IsCancelingCommand =>
            ((this.command != null) && this.command.Canceling);
        ...
        public override object this[string value] =>
            this.GetValue(this.GetOrdinal(value));

        private OdbcStatementHandle KeyInfoStatementHandle =>
            this._cmdWrapper.KeyInfoStatement;

        public override int RecordsAffected =>
            this.recordAffected;

        private OdbcStatementHandle StatementHandle =>
            this._cmdWrapper.StatementHandle;
