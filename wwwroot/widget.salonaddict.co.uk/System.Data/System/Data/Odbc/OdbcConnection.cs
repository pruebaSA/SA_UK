namespace System.Data.Odbc
{
    ...
    public sealed class OdbcConnection : DbConnection, ICloneable
    {
        ...
        public OdbcTransaction BeginTransaction(System.Data.IsolationLevel isolevel) => 
            ((OdbcTransaction) this.InnerConnection.BeginTransaction(isolevel));
        ...
        public OdbcCommand CreateCommand() => 
            new OdbcCommand(string.Empty, this);
        ...
        internal OdbcStatementHandle CreateStatementHandle() => 
            new OdbcStatementHandle(this.ConnectionHandle);
        ...
        internal string GetInfoStringUnhandled(ODBC32.SQL_INFO info) => 
            this.GetInfoStringUnhandled(info, false);
        ...
        internal string Open_GetServerVersion() => 
            this.GetInfoStringUnhandled(ODBC32.SQL_INFO.DBMS_VER, true);
        ...
        [Editor("Microsoft.VSDesigner.Data.Odbc.Design.OdbcConnectionStringEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), RefreshProperties(RefreshProperties.All), ResDescription("OdbcConnection_ConnectionString"), DefaultValue(""), ResCategory("DataCategory_Data"), RecommendedAsConfigurable(true)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ResDescription("OdbcConnection_ConnectionTimeout"), ResCategory("DataCategory_Data"), DefaultValue(15)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), ResDescription("OdbcConnection_DataSource")]
        ...
        [ResDescription("OdbcConnection_Driver"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        internal ConnectionState InternalState =>
            (this.State | this._extraState);

        internal bool IsOpen =>
            (this.InnerConnection is OdbcConnectionOpen);
        ...
        internal OdbcConnectionPoolGroupProviderInfo ProviderInfo =>
            ((OdbcConnectionPoolGroupProviderInfo) this.PoolGroup.ProviderInfo);

        [ResDescription("OdbcConnection_ServerVersion"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
