namespace System.Data
{
    ...
    internal sealed class FunctionNode : ExpressionNode
    {
        ...
        internal bool IsAggregate =>
            (((((funcs[this.info].id == FunctionId.Sum) || (funcs[this.info].id == FunctionId.Avg)) || ((funcs[this.info].id == FunctionId.Min) || (funcs[this.info].id == FunctionId.Max))) || ((funcs[this.info].id == FunctionId.Count) || (funcs[this.info].id == FunctionId.StDev))) || (funcs[this.info].id == FunctionId.Var));
    }
}
