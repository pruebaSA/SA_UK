namespace System.Data
{
    ...
    [DefaultEvent("PositionChanged"), Editor("Microsoft.VSDesigner.Data.Design.DataSourceEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), Designer("Microsoft.VSDesigner.Data.VS.DataViewDesigner, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultProperty("Table")]
    public class DataView : MarshalByValueComponent, IBindingListView, IBindingList, IList, ICollection, IEnumerable, ITypedList, ISupportInitializeNotification, ISupportInitialize
    {
        ...
        internal virtual int FindByKey(object key) => 
            this.index.FindRecordByKey(key);
        ...
        internal System.Data.Range FindRecords<TKey, TRow>(Index.ComparisonBySelector<TKey, TRow> comparison, TKey key) where TRow: DataRow => 
            this.index.FindRecords<TKey, TRow>(comparison, key);

        public DataRowView[] FindRows(object key) => 
            this.FindRowsByKey(new object[] { key });

        public DataRowView[] FindRows(object[] key) => 
            this.FindRowsByKey(key);
        ...
        private DataRowView GetRowView(DataRow dr) => 
            this.rowViewCache[dr];

        private DataRowView GetRowView(int record) => 
            this.GetRowView(this.table.recordManager[record]);
        ...
        private int IndexOfDataRowView(DataRowView rowview) => 
            this.index.GetIndex(rowview.GetRecord());
        ...
        bool IList.Contains(object value) => 
            (0 <= this.IndexOf(value as DataRowView));

        int IList.IndexOf(object value) => 
            this.IndexOf(value as DataRowView);
        ...
        public DataTable ToTable() => 
            this.ToTable(null, false, new string[0]);

        public DataTable ToTable(string tableName) => 
            this.ToTable(tableName, false, new string[0]);

        public DataTable ToTable(bool distinct, params string[] columnNames) => 
            this.ToTable(null, distinct, columnNames);
        ...
        [ResCategory("DataCategory_Data"), ResDescription("DataViewAllowDeleteDescr"), DefaultValue(true)]
        ...
        [ResDescription("DataViewAllowEditDescr"), DefaultValue(true), ResCategory("DataCategory_Data")]
        ...
        [DefaultValue(true), ResCategory("DataCategory_Data"), ResDescription("DataViewAllowNewDescr")]
        ...
        [ResCategory("DataCategory_Data"), DefaultValue(false), RefreshProperties(RefreshProperties.All), ResDescription("DataViewApplyDefaultSortDescr")]
        ...
        [Browsable(false), ResDescription("DataViewCountDescr")]
        public int Count =>
            this.rowViewCache.Count;

        private int CountFromIndex =>
            (((this.index != null) ? this.index.RecordCount : 0) + ((this.addNewRow != null) ? 1 : 0));
        ...
        public DataRowView this[int recordIndex] =>
            this.GetRowView(this.GetRow(recordIndex));

        internal int ObjectID =>
            this._objectID;

        [ResCategory("DataCategory_Data"), ResDescription("DataViewRowFilterDescr"), DefaultValue("")]
        ...
        [DefaultValue(0x16), ResCategory("DataCategory_Data"), ResDescription("DataViewRowStateFilterDescr")]
        ...
        [DefaultValue(""), ResCategory("DataCategory_Data"), ResDescription("DataViewSortDescr")]
        public string Sort
        {
            get
            {
        ...
        [TypeConverter(typeof(DataTableTypeConverter)), ResCategory("DataCategory_Data"), DefaultValue((string) null), RefreshProperties(RefreshProperties.All), ResDescription("DataViewTableDescr")]
