namespace System.Data
{
    ...
    internal sealed class XmlDataLoader
    {
        ...
        private bool FExcludedNamespace(string ns) => 
            (ns.Equals("http://www.w3.org/2000/xmlns/") || this.htableExcludedNS?.Contains(ns));
        ...
        private bool FIgnoreNamespace(XmlReader node) => 
            (this.fIsXdr && node.NamespaceURI.StartsWith("x-schema:#", StringComparison.Ordinal));
        ...
        private void LoadColumn(DataColumn column, object[] foundColumns)
        {
            ...
            if (column.IsCustomType)
            {
                ...
                if (this.dataReader.AttributeCount > 0)
                {
                    ...
                    typeName = this.dataReader.GetAttribute("InstanceType", "urn:schemas-microsoft-com:xml-msdata");
                }
                bool flag2 = !column.ImplementsIXMLSerializable && (((column.DataType != typeof(object)) && (typeName == null)) && (attribute == null));
                if ((str3 != null) && XmlConvert.ToBoolean(str3))
                {
                    if ((!flag2 && (typeName != null)) && (typeName.Length > 0))
                    {
                        staticNullForUdtType = SqlUdtStorage.GetStaticNullForUdtType(Type.GetType(typeName));
                    }
