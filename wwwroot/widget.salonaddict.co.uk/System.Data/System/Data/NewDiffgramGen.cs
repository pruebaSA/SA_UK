            ...
            else
            {
                ...
                switch (col.ColumnMapping)
                {
                    case MappingType.Element:
                    {
                        ...
                        if (col.IsCustomType)
                        {
                            if ((obj2 != DBNull.Value) && (!col.ImplementsINullable || !DataStorage.IsObjectSqlNull(obj2)))
                            {
                                if (col.IsValueCustomTypeInstance(obj2))
                                {
                                    ...
                                    {
                                        this._xmlw.WriteAttributeString("msdata", "InstanceType", "urn:schemas-microsoft-com:xml-msdata", dataType.AssemblyQualifiedName);
                                    }
                                    if (!flag)
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            throw ExceptionBuilder.PolymorphismNotSupported(dataType.AssemblyQualifiedName);
                                        }
                                ...
                                {
                                    if (((dataType == typeof(Type)) || (dataType == typeof(Guid))) || ((dataType == typeof(char)) || DataStorage.IsSqlType(dataType)))
                                    {
                                        this._xmlw.WriteAttributeString("msdata", "InstanceType", "urn:schemas-microsoft-com:xml-msdata", dataType.FullName);
                                    }
                                    ...
                                    {
                                        string str3 = "xs:" + XmlTreeGen.XmlDataTypeName(dataType);
                                    ...
                                    if (!DataStorage.IsSqlType(dataType))
                                    {
                        ...
                        if (((dataType == typeof(char)) || (dataType == typeof(string))) && XmlDataTreeWriter.PreserveSpace(columnValueAsString))
                        {
