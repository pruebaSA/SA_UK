namespace System.Data
{
    ...
    internal sealed class DataExpression : IFilter
    {
        ...
        internal bool DependsOn(DataColumn column) => 
            ((this.expr != null) && this.expr.DependsOn(column));

        internal object Evaluate() => 
            this.Evaluate((DataRow) null, DataRowVersion.Default);

        internal object Evaluate(DataRow[] rows) => 
            this.Evaluate(rows, DataRowVersion.Default);
        ...
        internal bool HasLocalAggregate() => 
            ((this.expr != null) && this.expr.HasLocalAggregate());

        internal bool HasRemoteAggregate() => 
            ((this.expr != null) && this.expr.HasRemoteAggregate());
        ...
        internal bool IsTableAggregate() => 
            ((this.expr != null) && this.expr.IsTableConstant());
