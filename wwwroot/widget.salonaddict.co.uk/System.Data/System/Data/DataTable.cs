namespace System.Data
{
    ...
    [Serializable, ToolboxItem(false), XmlSchemaProvider("GetDataTableSchema"), DesignTimeVisible(false), Editor("Microsoft.VSDesigner.Data.Design.DataTableEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultEvent("RowChanging"), DefaultProperty("TableName")]
    public class DataTable : MarshalByValueComponent, IListSource, ISupportInitializeNotification, ISupportInitialize, ISerializable, IXmlSerializable
    {
        ...
        [System.Data.ResCategory("DataCategory_Data"), System.Data.ResDescription("DataTableColumnChangedDescr")]
        ...
        [System.Data.ResDescription("DataTableColumnChangingDescr"), System.Data.ResCategory("DataCategory_Data")]
        ...
        [System.Data.ResDescription("DataTableRowChangingDescr"), System.Data.ResCategory("DataCategory_Data")]
        ...
        [System.Data.ResDescription("DataTableRowDeletingDescr"), System.Data.ResCategory("DataCategory_Data")]
        ...
        [System.Data.ResDescription("DataTableRowsClearingDescr"), System.Data.ResCategory("DataCategory_Data")]
        ...
        internal int Compare(string s1, string s2) => 
            this.Compare(s1, s2, null);

        internal int Compare(string s1, string s2, System.Globalization.CompareInfo comparer)
        {
            object obj3 = s1;
            object obj2 = s2;
            if (obj3 == obj2)
            ...
            return (comparer ?? this.CompareInfo).Compare(s1, 0, length, s2, 0, num, this._compareFlags);
        }
        ...
        protected virtual DataTable CreateInstance() => 
            ((DataTable) Activator.CreateInstance(base.GetType(), true));
        ...
        internal void DeserializeTableSchema(SerializationInfo info, StreamingContext context, bool isSingleTable)
        {
            ...
            for (int i = 0; i < num3; i++)
            {
                DataColumn column = new DataColumn {
                    ...
                    autoIncrementCurrent = info.GetInt64(string.Format(invariantCulture, "DataTable.DataColumn_{0}.AutoIncrementCurrent", new object[] { i }))
                };
                if (isSingleTable)
                {
        ...
        internal Index GetIndex(IndexField[] indexDesc) => 
            this.GetIndex(indexDesc, DataViewRowState.CurrentRows, null);

        internal Index GetIndex(string sort, DataViewRowState recordStates, IFilter rowFilter) => 
            this.GetIndex(this.ParseSortString(sort), recordStates, rowFilter);
        ...
        internal int IndexOf(string s1, string s2) => 
            this.CompareInfo.IndexOf(s1, s2, this._compareFlags);
        ...
        internal bool IsSuffix(string s1, string s2) => 
            this.CompareInfo.IsSuffix(s1, s2, this._compareFlags);
                ...
                if (this.inDataLoad)
                {
                    ...
                    if (this.loadIndex != null)
                    {
                        ...
                        if (recordIndex != -1)
                        {
                            ...
                            this.SetNewRecord(row, record, DataRowAction.Change, false, true);
                            if (fAcceptChanges)
                            {
                                row.AcceptChanges();
                            }
        ...
        internal int NewUninitializedRecord() => 
            this.recordManager.NewRecordBase();

        private DataRow NewUninitializedRow() => 
            this.NewRow(this.NewUninitializedRecord());
        ...
        public XmlReadMode ReadXml(TextReader reader)
        {
            ...
            return this.ReadXml(reader2, false);
        }
            ...
            for (int i = 0; i < this.Constraints.Count; i++)
            {
                ...
                if (constraint2 != null)
                {
                    ...
                    ArrayList list2 = new ArrayList {
                        ...
                        numArray4,
                        constraint2.IsPrimaryKey,
                        constraint2.ExtendedProperties
                    };
                    list3.Add(list2);
                }
                else
        ...
        internal bool ShouldSerializeCaseSensitive() => 
            this._caseSensitiveUserSet;

        internal bool ShouldSerializeLocale() => 
            this._cultureUserSet;
        ...
        [System.Data.ResDescription("DataTableChildRelationsDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), System.Data.ResCategory("DataCategory_Data"), System.Data.ResDescription("DataTableColumnsDescr")]
        ...
        [System.Data.ResDescription("DataTableConstraintsDescr"), System.Data.ResCategory("DataCategory_Data"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public ConstraintCollection Constraints =>
            this.constraintCollection;

        [System.Data.ResDescription("DataTableDataSetDescr"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public System.Data.DataSet DataSet =>
            this.dataSet;

        [Browsable(false), System.Data.ResDescription("DataTableDefaultViewDescr")]
        ...
        [DefaultValue(""), System.Data.ResCategory("DataCategory_Data"), System.Data.ResDescription("DataTableDisplayExpressionDescr")]
        ...
        [System.Data.ResCategory("DataCategory_Data"), DefaultValue(50), System.Data.ResDescription("DataTableMinimumCapacityDescr")]
        public int MinimumCapacity
        {
            get => 
                this.recordManager.MinimumCapacity;
            set
            {
        ...
        [Browsable(false), System.Data.ResDescription("DataTableParentRelationsDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Data.ResDescription("DataTablePrefixDescr"), DefaultValue(""), System.Data.ResCategory("DataCategory_Data")]
        ...
        [TypeConverter(typeof(PrimaryKeyTypeConverter)), System.Data.ResDescription("DataTablePrimaryKeyDescr"), Editor("Microsoft.VSDesigner.Data.Design.PrimaryKeyEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), System.Data.ResCategory("DataCategory_Data")]
        ...
        internal int RecordCapacity =>
            this.recordManager.RecordCapacity;

        [DefaultValue(0)]
        public SerializationFormat RemotingFormat
        {
            get => 
                this._remotingFormat;
            set
            {
        ...
        [Browsable(false), System.Data.ResDescription("DataTableRowsDescr")]
        ...
        {
            get => 
                this._suspendEnforceConstraints;
            set
            {
        ...
        {
            get => 
                this.ukColumnPositionForInference;
            set
            {
