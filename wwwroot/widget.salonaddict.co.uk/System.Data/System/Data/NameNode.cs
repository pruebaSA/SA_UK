namespace System.Data
{
    ...
    internal sealed class NameNode : ExpressionNode
    {
        ...
        internal override bool DependsOn(DataColumn column) => 
            ((this.column == column) || (this.column.Computed && this.column.DataExpression.DependsOn(column)));
        ...
        internal override bool HasLocalAggregate() => 
            (((this.column != null) && this.column.Computed) && this.column.DataExpression.HasLocalAggregate());

        internal override bool HasRemoteAggregate() => 
            (((this.column != null) && this.column.Computed) && this.column.DataExpression.HasRemoteAggregate());

        internal override bool IsConstant() => 
            false;

        internal override bool IsTableConstant() => 
            (((this.column != null) && this.column.Computed) && this.column.DataExpression.IsTableAggregate());
