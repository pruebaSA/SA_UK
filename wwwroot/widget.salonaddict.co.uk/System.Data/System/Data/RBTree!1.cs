namespace System.Data
{
    ...
    internal abstract class RBTree<K> : IEnumerable
    {
        ...
        private NodeColor<K> color(int nodeId) => 
            this._pageTable[nodeId >> 0x10].Slots[nodeId & 0xffff].nodeColor;
        ...
        public IEnumerator GetEnumerator() => 
            new RBTreeEnumerator<K>((RBTree<K>) this);
        ...
        public int Insert(int position, K item) => 
            this.InsertAt(position, item, false);
        ...
        public K Key(int nodeId) => 
            this._pageTable[nodeId >> 0x10].Slots[nodeId & 0xffff].keyOfNode;

        public int Left(int nodeId) => 
            this._pageTable[nodeId >> 0x10].Slots[nodeId & 0xffff].leftId;
        ...
        public int Next(int nodeId) => 
            this._pageTable[nodeId >> 0x10].Slots[nodeId & 0xffff].nextId;

        public int Parent(int nodeId) => 
            this._pageTable[nodeId >> 0x10].Slots[nodeId & 0xffff].parentId;

        public int RBDelete(int z_id) => 
            this.RBDeleteX(0, z_id, 0);
        ...
        public int Right(int nodeId) => 
            this._pageTable[nodeId >> 0x10].Slots[nodeId & 0xffff].rightId;
        ...
        public bool HasDuplicates =>
            (0 != this._inUseSatelliteTreeCount);

        public K this[int index] =>
            this.Key(this.GetNodeByIndex(index).NodeID);
