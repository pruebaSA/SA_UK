namespace System.Data
{
    ...
    internal sealed class Index
    {
        ...
        private bool AcceptRecord(int record) => 
            this.AcceptRecord(record, this.RowFilter);
        ...
        private int CompareDataRows(int record1, int record2) => 
            this._comparison(this.table.recordManager[record1], this.table.recordManager[record2]);
        ...
        internal static bool ContainsReference<T>(List<T> list, T item) where T: class => 
            (0 <= IndexOfReference<T>(list, item));
        ...
        public RBTree<int>.RBTreeEnumerator GetEnumerator(int startIndex) => 
            new RBTree<int>.RBTreeEnumerator(this.records, startIndex);

        public int GetIndex(int record) => 
            this.records.GetIndexByKey(record);
        ...
        public DataRow GetRow(int i) => 
            this.table.recordManager[this.GetRecord(i)];

        public DataRow[] GetRows(object[] values) => 
            this.GetRows(this.FindRecords(values));
        ...
        private bool DoListChanged =>
            ((!this.suspendEvents && this._listeners.HasListeners) && !this.table.AreIndexEventsSuspended);

        public bool HasDuplicates =>
            this.records.HasDuplicates;

        internal bool HasRemoteAggregate =>
            this._hasRemoteAggregate;
        ...
        public IFilter RowFilter =>
            ((this.rowFilter != null) ? ((IFilter) this.rowFilter.Target) : null);
        ...
        private sealed class IndexTree : RBTree<int>
        {
            ...
            protected override int CompareNode(int record1, int record2) => 
                this._index.CompareRecords(record1, record2);

            protected override int CompareSateliteTreeNode(int record1, int record2) => 
                this._index.CompareDuplicateRecords(record1, record2);
        }
    }
}
