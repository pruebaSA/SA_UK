namespace System.Data.ProviderBase
{
    ...
    internal sealed class DbConnectionPool
    {
        ...
        private bool UsingIntegrateSecurity =>
            ((this._identity != null) && (DbConnectionPoolIdentity.NoIdentity != this._identity));
        ...
        private sealed class TransactedConnectionPool : Hashtable
        {
            ...
            {
                DbConnectionInternal internal2 = null;
                DbConnectionPool.TransactedConnectionList list = (DbConnectionPool.TransactedConnectionList) this[transaction];
                if (list != null)
                {
                    lock (list)
                    {
            ...
            internal void TransactionBegin(Transaction transaction)
            {
                ...
                if (((DbConnectionPool.TransactedConnectionList) this[transaction]) == null)
                {
                    ...
                    try
                    {
                        ...
                        DbConnectionPool.TransactedConnectionList list2 = new DbConnectionPool.TransactedConnectionList(2, tx);
                        ...
                        lock (this)
                        {
                            if (((DbConnectionPool.TransactedConnectionList) this[tx]) == null)
                            {
                                DbConnectionPool.TransactedConnectionList list = list2;
                                this.Add(tx, list);
                                tx = null;
                            }
                        }
