namespace System.Data.ProviderBase
{
    ...
    internal abstract class DbReferenceCollection
    {
        ...
        internal IEnumerable Filter(int tag) => 
            new DbFilteredReferenceCollection(this._items, tag);
        ...
        private struct CollectionEntry
        {
            ...
            public bool HasTarget =>
                (((this._tag != 0) && (this._weak != null)) && this._weak.IsAlive);
            public bool InUse =>
                (null != this._weak);
            public int Tag
            {
        ...
        private struct DbFilteredReferenceCollection : IEnumerable
        {
            ...
            IEnumerator IEnumerable.GetEnumerator() => 
                new DbFilteredReferenceCollectionedEnumerator(this._items, this._filterTag);
            [StructLayout(LayoutKind.Sequential)]
            private struct DbFilteredReferenceCollectionedEnumerator : IEnumerator
            {
                ...
                object IEnumerator.Current =>
                    this._items[this._current].Target;
