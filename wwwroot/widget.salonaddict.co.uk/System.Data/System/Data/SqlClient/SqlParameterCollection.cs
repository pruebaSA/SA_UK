namespace System.Data.SqlClient
{
    ...
    public sealed class SqlParameterCollection : DbParameterCollection
    {
        ...
        public SqlParameter Add(string parameterName, SqlDbType sqlDbType) => 
            this.Add(new SqlParameter(parameterName, sqlDbType));
        ...
        public SqlParameter Add(string parameterName, SqlDbType sqlDbType, int size) => 
            this.Add(new SqlParameter(parameterName, sqlDbType, size));

        public SqlParameter Add(string parameterName, SqlDbType sqlDbType, int size, string sourceColumn) => 
            this.Add(new SqlParameter(parameterName, sqlDbType, size, sourceColumn));
        ...
        {
            get => 
                ((SqlParameter) this.GetParameter(index));
            set
            {
        ...
        {
            get => 
                ((SqlParameter) this.GetParameter(parameterName));
            set
            {
