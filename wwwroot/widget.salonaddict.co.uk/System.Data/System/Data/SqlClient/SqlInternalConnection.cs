namespace System.Data.SqlClient
{
    ...
    internal abstract class SqlInternalConnection : DbConnectionInternal
    {
        ...
        public override DbTransaction BeginTransaction(System.Data.IsolationLevel iso) => 
            this.BeginSqlTransaction(iso, null);
        ...
        private void EnlistNonNull(Transaction tx)
        {
            ...
            if (this.IsYukonOrNewer)
            {
                ...
                try
                {
                    ...
                    {
                        flag = true;
                        this._delegatedTransaction = promotableSinglePhaseNotification;
                        if (Bid.AdvancedOn)
                        {
                ...
                catch (SqlException exception)
                {
                    ...
                    if ((tds != null) && (tds.Parser.State != TdsParserState.OpenLoggedIn))
                    {
                        throw;
                    }
                    ADP.TraceExceptionWithoutRethrow(exception);
        ...
        internal void ValidateTransaction()
        {
            if (this.RequireExplicitTransactionUnbind && (null != this.InternalEnlistedTransaction))
            {
                ...
                if (((this.InternalEnlistedTransaction.TransactionInformation.Status != TransactionStatus.Active) || (null == current)) || !this.InternalEnlistedTransaction.Equals(current))
                {
        ...
        internal override bool IsTransactionRoot
        {
            get
            {
                ...
                lock (this)
                {
                    return ((this._delegatedTransaction != null) && this._delegatedTransaction.IsActive);
                }
            }
        }
        ...
        internal override bool RequireExplicitTransactionUnbind =>
            (this._connectionOptions.TransactionBinding == SqlConnectionString.TransactionBindingEnum.ExplicitUnbind);
