namespace System.Data.SqlClient
{
    ...
    public class SqlDataReader : DbDataReader, IDataReader, IDisposable, IDataRecord
    {
        ...
        internal object GetSqlValueWithNoConvert(int i)
        {
            ...
            if (this._metaData[i].type == SqlDbType.Xml)
            {
                return this._data[i].SqlCachedBuffer;
            }
            return this._data[i].SqlValue;
        }
                    ...
                    if (this.HasMoreResults())
                    {
                        ...
                        switch (this._altRowStatus)
                        {
                            case ALTROWSTATUS.AltRow:
                            {
                                ...
                                _SqlMetaDataSet set = this._altMetaDataSetCollection[altRowId];
                                if (set != null)
                                {
                                    this._metaData = set;
                                    this._metaData.indexMap = set.indexMap;
                                }
                                break;
                            }
                            case ALTROWSTATUS.Done:
