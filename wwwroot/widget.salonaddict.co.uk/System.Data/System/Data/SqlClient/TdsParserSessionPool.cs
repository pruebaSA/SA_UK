namespace System.Data.SqlClient
{
    ...
    internal class TdsParserSessionPool
    {
        ...
        internal string TraceString() => 
            string.Format(null, "(ObjID={0}, free={1}, cached={2}, total={3})", new object[] { this._objectID, (this._freeStack == null) ? "(null)" : this._freeStack.CountDebugOnly.ToString((IFormatProvider) null), this._cachedCount, this._cache.Count });

        private bool IsDisposed =>
            (null == this._freeStack);
