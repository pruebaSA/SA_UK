namespace System.Data.SqlClient
{
    ...
    public sealed class SqlParameter : DbParameter, IDbDataParameter, IDataParameter, ICloneable
    {
        ...
        internal void Validate(int index, bool isCommandProc)
        {
            ...
            if ((((ADP.IsDirection(this, ParameterDirection.Output) && !ADP.IsDirection(this, ParameterDirection.ReturnValue)) && (!metaTypeOnly.IsFixed && !this.ShouldSerializeSize())) && ((this._value == null) || Convert.IsDBNull(this._value))) && (((this.SqlDbType != System.Data.SqlDbType.Timestamp) && (this.SqlDbType != System.Data.SqlDbType.Udt)) && !metaTypeOnly.IsVarTime))
            {
        ...
        internal MetaType ValidateTypeLengths(bool yukonOrNewer)
        {
            ...
            if (((System.Data.SqlDbType.Udt != internalMetaType.SqlDbType) && !internalMetaType.IsFixed) && !internalMetaType.IsLong)
            {
                ...
                int size = this.Size;
                int num3 = (size > actualSize) ? size : actualSize;
                if (((num3 <= 0x1f40) && (size != -1)) && (actualSize != -1))
                {
        ...
        [RefreshProperties(RefreshProperties.All), System.Data.ResCategory("DataCategory_Data"), System.Data.ResDescription("DbParameter_Direction")]
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced), System.Data.ResDescription("DbParameter_Offset"), System.Data.ResCategory("DataCategory_Data"), Browsable(false)]
        public int Offset
        {
            get => 
                this._offset;
        ...
        public override string ParameterName
        {
            ...
            set
            {
                if ((!ADP.IsEmpty(value) && (value.Length >= 0x7f)) && (('@' != value[0]) || (value.Length > 0x7f)))
                {
        ...
        [DefaultValue((byte) 0), System.Data.ResCategory("DataCategory_Data"), System.Data.ResDescription("DbDataParameter_Precision")]
        public byte Precision
        {
            get => 
                this.PrecisionInternal;
            set
            {
        ...
        internal byte PrecisionInternal
        {
            ...
            set
            {
                ...
                if (System.Data.SqlDbType.Float == sqlDbType)
                {
                    if (value > 0x35)
                    {
                ...
                else if (System.Data.SqlDbType.Real == sqlDbType)
                {
                    if (value > 0x18)
                    {
                        throw SQL.PrecisionValueOutOfRange(value);
        ...
        [System.Data.ResDescription("DbDataParameter_Scale"), System.Data.ResCategory("DataCategory_Data"), DefaultValue((byte) 0)]
        public byte Scale
        {
            get => 
                this.ScaleInternal;
        ...
        [System.Data.ResCategory("DataCategory_Update"), System.Data.ResDescription("DbParameter_SourceColumn")]
        ...
        [System.Data.ResCategory("DataCategory_Update"), System.Data.ResDescription("DbParameter_SourceVersion")]
        ...
        [System.Data.ResCategory("DataCategory_Data"), DbProviderSpecificTypeProperty(true), System.Data.ResDescription("SqlParameter_SqlDbType"), RefreshProperties(RefreshProperties.All)]
        public System.Data.SqlDbType SqlDbType
        {
            get => 
                this.GetMetaTypeOnly().SqlDbType;
            set
            {
                MetaType type = this._metaType;
        ...
        [System.Data.ResDescription("DbParameter_Value"), TypeConverter(typeof(StringConverter)), System.Data.ResCategory("DataCategory_Data"), RefreshProperties(RefreshProperties.All)]
        ...
        [System.Data.ResCategory("DataCategory_Xml"), System.Data.ResDescription("SqlParameter_XmlSchemaCollectionOwningSchema")]
