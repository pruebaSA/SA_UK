namespace System.Data.SqlClient
{
    ...
    public sealed class SqlDependency
    {
        ...
        [System.Data.ResDescription("SqlDependency_OnChange"), System.Data.ResCategory("DataCategory_Data")]
        ...
        private static ObjectHandle CreateProcessDispatcher(_AppDomain masterDomain) => 
            masterDomain.CreateInstance(_assemblyName, _typeName);
        ...
        private static SqlDependencyProcessDispatcher GetDeserializedObject(BinaryFormatter formatter, MemoryStream stream) => 
            ((SqlDependencyProcessDispatcher) formatter.Deserialize(stream));
        ...
        private static ObjRef GetObjRef(SqlDependencyProcessDispatcher _processDispatcher) => 
            RemotingServices.Marshal(_processDispatcher);
        ...
        public static bool Start(string connectionString) => 
            Start(connectionString, null, true);

        [HostProtection(SecurityAction.LinkDemand, ExternalThreading=true)]
        public static bool Start(string connectionString, string queue) => 
            Start(connectionString, queue, false);
        ...
        internal static bool Start(string connectionString, string queue, bool useDefaults)
        {
            ...
            try
            {
                ...
                SqlConnectionString str4 = new SqlConnectionString(connectionString);
                str4.DemandPermission();
                if (str4.LocalDBInstance != null)
                {
                    LocalDBAPI.DemandLocalDBPermissions();
                }
                bool errorOccurred = false;
                bool flag = false;
                Monitor.Enter(obj2 = _startStopLock);
                try
                {
        ...
        public static bool Stop(string connectionString) => 
            Stop(connectionString, null, true, false);

        [HostProtection(SecurityAction.LinkDemand, ExternalThreading=true)]
        public static bool Stop(string connectionString, string queue) => 
            Stop(connectionString, queue, false, false);
        ...
        internal static bool Stop(string connectionString, string queue, bool useDefaults, bool startFailed)
        {
            ...
            try
            {
                ...
                SqlConnectionString str = new SqlConnectionString(connectionString);
                str.DemandPermission();
                if (str.LocalDBInstance != null)
                {
                    LocalDBAPI.DemandLocalDBPermissions();
                }
                bool flag = false;
        ...
        public bool HasChanges =>
            this._dependencyFired;

        [System.Data.ResDescription("SqlDependency_Id"), System.Data.ResCategory("DataCategory_Data")]
        public string Id =>
            this._id;
        ...
        internal class EventContextPair
        {
            ...
            public override int GetHashCode() => 
                this._eventHandler.GetHashCode();
