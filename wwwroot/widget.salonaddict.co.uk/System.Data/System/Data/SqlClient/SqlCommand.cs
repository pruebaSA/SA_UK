namespace System.Data.SqlClient
{
    ...
    [ToolboxItem(true), DefaultEvent("RecordsAffected"), Designer("Microsoft.VSDesigner.Data.VS.SqlCommandDesigner, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public sealed class SqlCommand : DbCommand, ICloneable
    {
        ...
        [System.Data.ResDescription("DbCommand_StatementCompleted"), System.Data.ResCategory("DataCategory_StatementCompleted")]
        ...
        public IAsyncResult BeginExecuteXmlReader() => 
            this.BeginExecuteXmlReader(null, null);
        ...
        public XmlReader EndExecuteXmlReader(IAsyncResult asyncResult) => 
            this.CompleteXmlReader(this.InternalEndExecuteReader(asyncResult, "EndExecuteXmlReader"));
        ...
        protected override DbDataReader ExecuteDbDataReader(CommandBehavior behavior) => 
            this.ExecuteReader(behavior, "ExecuteReader");
        ...
        private string GetCommandText(CommandBehavior behavior) => 
            (this.GetSetOptionsString(behavior) + this.CommandText);
        ...
        internal int? GetRecordsAffected(int commandIndex) => 
            this._SqlRPCBatchArray[commandIndex].recordsAffected;
        ...
        internal SqlDataReader RunExecuteReader(CommandBehavior cmdBehavior, RunBehavior runBehavior, bool returnStream, string method) => 
            this.RunExecuteReader(cmdBehavior, runBehavior, returnStream, method, null);
        ...
        [System.Data.ResDescription("DbCommand_CommandText"), Editor("Microsoft.VSDesigner.Data.SQL.Design.SqlCommandTextEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultValue(""), System.Data.ResCategory("DataCategory_Data"), RefreshProperties(RefreshProperties.All)]
        ...
        [System.Data.ResDescription("DbCommand_CommandTimeout"), System.Data.ResCategory("DataCategory_Data")]
        ...
        [DefaultValue(1), System.Data.ResCategory("DataCategory_Data"), RefreshProperties(RefreshProperties.All), System.Data.ResDescription("DbCommand_CommandType")]
        ...
        [System.Data.ResDescription("DbCommand_Connection"), System.Data.ResCategory("DataCategory_Data"), DefaultValue((string) null), Editor("Microsoft.VSDesigner.Data.Design.DbConnectionEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
        ...
        private SqlInternalConnectionSmi InternalSmiConnection =>
            ((SqlInternalConnectionSmi) this._activeConnection.InnerConnection);

        private SqlInternalConnectionTds InternalTdsConnection =>
            ((SqlInternalConnectionTds) this._activeConnection.InnerConnection);
        ...
        private bool IsShiloh =>
            this._activeConnection?.IsShiloh;

        private bool IsUserPrepared =>
            ((this.IsPrepared && !this._hiddenPrepare) && !this.IsDirty);

        internal _SqlMetaDataSet MetaData =>
            this._cachedMetaData;

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Data.ResDescription("SqlCommand_Notification"), Browsable(false), System.Data.ResCategory("DataCategory_Notification")]
        ...
        [System.Data.ResDescription("SqlCommand_NotificationAutoEnlist"), DefaultValue(true), System.Data.ResCategory("DataCategory_Notification")]
        public bool NotificationAutoEnlist
        {
            get => 
                this._notificationAutoEnlist;
            set
            {
        ...
        [System.Data.ResDescription("DbCommand_Parameters"), System.Data.ResCategory("DataCategory_Data"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [Browsable(false), System.Data.ResDescription("DbCommand_Transaction"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue(3), System.Data.ResCategory("DataCategory_Update"), System.Data.ResDescription("DbCommand_UpdatedRowSource")]
        ...
        private class CachedAsyncState
        {
            ...
            internal bool IsActiveConnectionValid(SqlConnection activeConnection) => 
                ((this._cachedAsyncConnection == activeConnection) && (this._cachedAsyncCloseCount == activeConnection.CloseCount));
