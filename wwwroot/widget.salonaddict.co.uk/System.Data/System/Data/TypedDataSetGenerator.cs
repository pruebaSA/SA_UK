namespace System.Data
{
    ...
    public class TypedDataSetGenerator
    {
        ...
        private static CodeAttributeDeclaration AttributeDecl(string name, CodeExpression value) => 
            new CodeAttributeDeclaration(name, new CodeAttributeArgument[] { new CodeAttributeArgument(value) });
        ...
        private CodeTypeDeclaration CreateTypedDataSet(DataSet dataSet)
        {
            ...
            ArrayList list = new ArrayList {
                VariableDecl(typeof(DataSet), "ds", New(typeof(DataSet), new CodeExpression[0])),
                Stm(MethodCall(Variable("ds"), "ReadXmlSchema", new CodeExpression[] { New(typeof(XmlTextReader), new CodeExpression[] { New("System.IO.StringReader", new CodeExpression[] { Variable("strSchema") }) }) }))
            };
        ...
        private CodeTypeDelegate CreateTypedRowEventHandler(DataTable table)
        {
            ...
            CodeTypeDelegate delegate2 = new CodeTypeDelegate(str + "ChangeEventHandler");
            delegate2.TypeAttributes |= TypeAttributes.Public;
        ...
        private static CodeMemberMethod MethodDecl(string type, string name, MemberAttributes attributes) => 
            Method(Type(type), name, attributes);
        ...
        private string RelationFieldName(DataRelation relation) => 
            this.FixIdName("relation" + relation.RelationName);
        ...
        private string TableColumnPropertyName(DataColumn column) => 
            (this.RowColumnPropertyName(column) + "Column");

        private string TableFieldName(DataTable table) => 
            ("table" + this.TablePropertyName(table));
        ...
        private static CodeStatement Throw(System.Type exception, string arg, string inner) => 
            new CodeThrowExceptionStatement(New(exception, new CodeExpression[] { Str(System.Data.Res.GetString(arg)), Variable(inner) }));
