namespace System.Data
{
    ...
    [DefaultProperty("ConstraintName"), Editor("Microsoft.VSDesigner.Data.Design.UniqueConstraintEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public class UniqueConstraint : Constraint
    {
        ...
        internal override bool ContainsColumn(DataColumn column) => 
            this.key.ContainsColumn(column);
        ...
        public override bool Equals(object key2) => 
            ((key2 is UniqueConstraint) && this.Key.ColumnsEqual(((UniqueConstraint) key2).Key));
        ...
        internal string[] ColumnNames =>
            this.key.GetColumnNames();

        [ReadOnly(true), ResDescription("KeyConstraintColumnsDescr"), ResCategory("DataCategory_Data")]
        public virtual DataColumn[] Columns =>
            this.key.ToArray();

        internal DataColumn[] ColumnsReference =>
            this.key.ColumnsReference;

        internal Index ConstraintIndex =>
            this._constraintIndex;
        ...
        [ResCategory("DataCategory_Data"), ResDescription("KeyConstraintIsPrimaryKeyDescr")]
        ...
        [ResCategory("DataCategory_Data"), ReadOnly(true), ResDescription("ConstraintTableDescr")]
