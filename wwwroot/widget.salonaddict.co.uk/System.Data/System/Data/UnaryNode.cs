namespace System.Data
{
    ...
    internal sealed class UnaryNode : ExpressionNode
    {
        ...
        internal override bool DependsOn(DataColumn column) => 
            this.right.DependsOn(column);

        internal override object Eval() => 
            this.Eval(null, DataRowVersion.Default);

        internal override object Eval(int[] recordNos) => 
            this.right.Eval(recordNos);

        internal override object Eval(DataRow row, DataRowVersion version) => 
            this.EvalUnaryOp(this.op, this.right.Eval(row, version));
        ...
        internal override bool HasLocalAggregate() => 
            this.right.HasLocalAggregate();

        internal override bool HasRemoteAggregate() => 
            this.right.HasRemoteAggregate();

        internal override bool IsConstant() => 
            this.right.IsConstant();

        internal override bool IsTableConstant() => 
            this.right.IsTableConstant();
