namespace System.Data.OleDb
{
    ...
    internal static class ODB
    {
        ...
        internal static ArgumentException AsynchronousNotSupported() => 
            ADP.Argument(Res.GetString("OleDb_AsynchronousNotSupported"));

        internal static InvalidOperationException BadAccessor() => 
            ADP.DataAdapter(Res.GetString("OleDb_BadAccessor"));

        internal static Exception BadStatus_ParamAcc(int index, DBBindStatus status) => 
            ADP.DataAdapter(Res.GetString("OleDb_BadStatus_ParamAcc", new object[] { index.ToString(CultureInfo.InvariantCulture), status.ToString() }));

        internal static InvalidOperationException BadStatusRowAccessor(int i, DBBindStatus rowStatus) => 
            ADP.DataAdapter(Res.GetString("OleDb_BadStatusRowAccessor", new object[] { i.ToString(CultureInfo.InvariantCulture), rowStatus.ToString() }));

        internal static InvalidCastException CantConvertValue() => 
            ADP.InvalidCast(Res.GetString("OleDb_CantConvertValue"));

        internal static InvalidOperationException CantCreate(Type type) => 
            ADP.DataAdapter(Res.GetString("OleDb_CantCreate", new object[] { type.Name }));
        ...
        internal static InvalidOperationException CommandTextNotSupported(string provider, Exception inner) => 
            ADP.DataAdapter(Res.GetString("OleDb_CommandTextNotSupported", new object[] { provider }), inner);

        internal static InvalidCastException ConversionRequired() => 
            ADP.InvalidCast();

        internal static InvalidOperationException DataOverflow(Type type) => 
            ADP.DataAdapter(Res.GetString("OleDb_DataOverflow", new object[] { type.Name }));

        internal static InvalidOperationException DBBindingGetVector() => 
            ADP.InvalidOperation(Res.GetString("OleDb_DBBindingGetVector"));
        ...
        internal static string FailedGetDescription(OleDbHResult errorcode) => 
            Res.GetString("OleDb_FailedGetDescription", new object[] { ELookup(errorcode) });

        internal static string FailedGetSource(OleDbHResult errorcode) => 
            Res.GetString("OleDb_FailedGetSource", new object[] { ELookup(errorcode) });

        internal static ArgumentException Fill_EmptyRecord(string parameter, Exception innerException) => 
            ADP.Argument(Res.GetString("OleDb_Fill_EmptyRecord"), parameter, innerException);

        internal static ArgumentException Fill_EmptyRecordSet(string parameter, Exception innerException) => 
            ADP.Argument(Res.GetString("OleDb_Fill_EmptyRecordSet", new object[] { "IRowset" }), parameter, innerException);

        internal static ArgumentException Fill_NotADODB(string parameter) => 
            ADP.Argument(Res.GetString("OleDb_Fill_NotADODB"), parameter);
        ...
        internal static InvalidOperationException GVtUnknown(int wType) => 
            ADP.DataAdapter(Res.GetString("OleDb_GVtUnknown", new object[] { wType.ToString("X4", CultureInfo.InvariantCulture), wType.ToString(CultureInfo.InvariantCulture) }));

        internal static InvalidOperationException IDBInfoNotSupported() => 
            ADP.InvalidOperation(Res.GetString("OleDb_IDBInfoNotSupported"));

        internal static Exception InvalidOleDbType(OleDbType value) => 
            ADP.InvalidEnumerationValue(typeof(OleDbType), (int) value);

        internal static ArgumentException InvalidProviderSpecified() => 
            ADP.Argument(Res.GetString("OleDb_InvalidProviderSpecified"));

        internal static ArgumentException InvalidRestrictionsDbInfoKeywords(string parameter) => 
            ADP.Argument(Res.GetString("OleDb_InvalidRestrictionsDbInfoKeywords"), parameter);

        internal static ArgumentException InvalidRestrictionsDbInfoLiteral(string parameter) => 
            ADP.Argument(Res.GetString("OleDb_InvalidRestrictionsDbInfoLiteral"), parameter);

        internal static ArgumentException InvalidRestrictionsSchemaGuids(string parameter) => 
            ADP.Argument(Res.GetString("OleDb_InvalidRestrictionsSchemaGuids"), parameter);
        ...
        internal static InvalidOperationException MDACNotAvailable(Exception inner) => 
            ADP.DataAdapter(Res.GetString("OleDb_MDACNotAvailable"), inner);

        internal static ArgumentException MSDASQLNotSupported() => 
            ADP.Argument(Res.GetString("OleDb_MSDASQLNotSupported"));
        ...
        internal static string NoErrorMessage(OleDbHResult errorcode) => 
            Res.GetString("OleDb_NoErrorMessage", new object[] { ELookup(errorcode) });

        internal static ArgumentException NoProviderSpecified() => 
            ADP.Argument(Res.GetString("OleDb_NoProviderSpecified"));

        internal static Exception NoProviderSupportForParameters(string provider, Exception inner) => 
            ADP.DataAdapter(Res.GetString("OleDb_NoProviderSupportForParameters", new object[] { provider }), inner);

        internal static Exception NoProviderSupportForSProcResetParameters(string provider) => 
            ADP.DataAdapter(Res.GetString("OleDb_NoProviderSupportForSProcResetParameters", new object[] { provider }));

        internal static ArgumentException NotSupportedSchemaTable(Guid schema, OleDbConnection connection) => 
            ADP.Argument(Res.GetString("OleDb_NotSupportedSchemaTable", new object[] { OleDbSchemaGuid.GetTextFromValue(schema), connection.Provider }));

        internal static InvalidOperationException PossiblePromptNotUserInteractive() => 
            ADP.DataAdapter(Res.GetString("OleDb_PossiblePromptNotUserInteractive"));
        ...
        internal static InvalidOperationException ProviderUnavailable(string provider, Exception inner) => 
            ADP.DataAdapter(Res.GetString("OleDb_ProviderUnavailable", new object[] { provider }), inner);

        internal static ArgumentException SchemaRowsetsNotSupported(string provider) => 
            ADP.Argument(Res.GetString("OleDb_SchemaRowsetsNotSupported", new object[] { "IDBSchemaRowset", provider }));

        internal static InvalidOperationException SignMismatch(Type type) => 
            ADP.DataAdapter(Res.GetString("OleDb_SignMismatch", new object[] { type.Name }));

        internal static InvalidOperationException SVtUnknown(int wType) => 
            ADP.DataAdapter(Res.GetString("OleDb_SVtUnknown", new object[] { wType.ToString("X4", CultureInfo.InvariantCulture), wType.ToString(CultureInfo.InvariantCulture) }));

        internal static InvalidOperationException ThreadApartmentState(Exception innerException) => 
            ADP.InvalidOperation(Res.GetString("OleDb_ThreadApartmentState"), innerException);

        internal static InvalidOperationException TransactionsNotSupported(string provider, Exception inner) => 
            ADP.DataAdapter(Res.GetString("OleDb_TransactionsNotSupported", new object[] { provider }), inner);

        internal static InvalidOperationException Unavailable(Type type) => 
            ADP.DataAdapter(Res.GetString("OleDb_Unavailable", new object[] { type.Name }));

        internal static InvalidOperationException UnexpectedStatusValue(DBStatus status) => 
            ADP.DataAdapter(Res.GetString("OleDb_UnexpectedStatusValue", new object[] { status.ToString() }));

        internal static Exception UninitializedParameters(int index, OleDbType dbtype) => 
            ADP.InvalidOperation(Res.GetString("OleDb_UninitializedParameters", new object[] { index.ToString(CultureInfo.InvariantCulture), dbtype.ToString() }));
    }
}
