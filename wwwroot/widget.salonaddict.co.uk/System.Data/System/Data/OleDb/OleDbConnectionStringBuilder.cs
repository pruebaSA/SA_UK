namespace System.Data.OleDb
{
    ...
    public sealed class OleDbConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        [DisplayName("Data Source"), ResCategory("DataCategory_Source"), ResDescription("DbConnectionString_DataSource"), RefreshProperties(RefreshProperties.All)]
        ...
        [ResDescription("DbConnectionString_FileName"), RefreshProperties(RefreshProperties.All), ResCategory("DataCategory_NamedConnectionString"), DisplayName("File Name"), Editor("System.Windows.Forms.Design.FileNameEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
        ...
        [ResCategory("DataCategory_Pooling"), TypeConverter(typeof(OleDbServicesConverter)), RefreshProperties(RefreshProperties.All), DisplayName("OLE DB Services"), ResDescription("DbConnectionString_OleDbServices")]
        ...
        [ResDescription("DbConnectionString_PersistSecurityInfo"), RefreshProperties(RefreshProperties.All), DisplayName("Persist Security Info"), ResCategory("DataCategory_Security")]
        ...
        [RefreshProperties(RefreshProperties.All), TypeConverter(typeof(OleDbProviderConverter)), ResCategory("DataCategory_Source"), DisplayName("Provider"), ResDescription("DbConnectionString_Provider")]
