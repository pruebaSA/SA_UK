    ...
    public sealed class OleDbDataReader : DbDataReader
    {
        ...
        internal void DumpToSchemaTable(System.Data.Common.UnsafeNativeMethods.IRowset rowset)
        {
            ...
            for (int i = list.Count - 1; count <= i; i--)
            {
                ...
                data3.isHidden = true;
                if (data3.guid.Equals(ODB.DBCOL_SPECIALCOL))
                {
        ...
        public override bool GetBoolean(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueBoolean();

        public override byte GetByte(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueByte();
        ...
        public OleDbDataReader GetData(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueChapter();
        ...
        public override DateTime GetDateTime(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueDateTime();

        protected override DbDataReader GetDbDataReader(int ordinal) => 
            this.GetData(ordinal);

        public override decimal GetDecimal(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueDecimal();

        public override double GetDouble(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueDouble();
        ...
        public override float GetFloat(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueSingle();

        public override Guid GetGuid(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueGuid();

        public override short GetInt16(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueInt16();

        public override int GetInt32(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueInt32();

        public override long GetInt64(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueInt64();
        ...
        public override string GetString(int ordinal) => 
            this.GetColumnBinding(ordinal).ValueString();

        public TimeSpan GetTimeSpan(int ordinal) => 
            ((TimeSpan) this.GetValue(ordinal));

        public override object GetValue(int ordinal) => 
            this.GetColumnBinding(ordinal).Value();
        ...
        public override bool IsDBNull(int ordinal) => 
            this.GetColumnBinding(ordinal).IsValueNull();
        ...
        internal OleDbDataReader ResetChapter(int bindingIndex, int index, RowBinding rowbinding, int valueOffset) => 
            this.GetDataForReader(this._metadata[bindingIndex + index].ordinal, rowbinding, valueOffset);
