namespace System.Data.OleDb
{
    ...
    public sealed class OleDbConnection : DbConnection, ICloneable, IDbConnection, IDisposable
    {
        ...
        public OleDbTransaction BeginTransaction(System.Data.IsolationLevel isolationLevel) => 
            ((OleDbTransaction) this.InnerConnection.BeginTransaction(isolationLevel));
        ...
        internal object GetDataSourcePropertyValue(Guid propertySet, int propertyID) => 
            this.GetOpenConnection().GetDataSourcePropertyValue(propertySet, propertyID);
        ...
        private OleDbConnectionInternal GetOpenConnection() => 
            (this.InnerConnection as OleDbConnectionInternal);
        ...
        internal DataTable GetSchemaRowset(Guid schema, object[] restrictions) => 
            this.GetOpenConnection().GetSchemaRowset(schema, restrictions);
        ...
        internal System.Data.Common.UnsafeNativeMethods.ICommandText ICommandText() => 
            this.GetOpenConnection().ICommandText();

        private IDBPropertiesWrapper IDBProperties() => 
            this.GetOpenConnection().IDBProperties();

        internal IOpenRowsetWrapper IOpenRowset() => 
            this.GetOpenConnection().IOpenRowset();
        ...
        internal static Exception ProcessResults(OleDbHResult hresult, OleDbConnection connection, object src)
        {
            ...
            {
                e = ODB.NoErrorInformation(connection?.Provider, hresult, null);
                ResetState(connection);
            }
            if (e != null)
            {
        ...
        internal int SqlSupport() => 
            this.OleDbConnectionStringValue.GetSqlSupport(this);

        internal bool SupportIRow(OleDbCommand cmd) => 
            this.OleDbConnectionStringValue.GetSupportIRow(this, cmd);

        internal bool SupportMultipleResults() => 
            this.OleDbConnectionStringValue.GetSupportMultipleResults(this);

        internal bool SupportSchemaRowset(Guid schema) => 
            this.GetOpenConnection().SupportSchemaRowset(schema);
        ...
        internal OleDbTransaction ValidateTransaction(OleDbTransaction transaction, string method) => 
            this.GetOpenConnection().ValidateTransaction(transaction, method);
        ...
        [RefreshProperties(RefreshProperties.All), DefaultValue(""), RecommendedAsConfigurable(true), Editor("Microsoft.VSDesigner.Data.ADO.Design.OleDbConnectionStringEditor, Microsoft.VSDesigner, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "System.Drawing.Design.UITypeEditor, System.Drawing, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ResDescription("OleDbConnection_ConnectionString"), ResCategory("DataCategory_Data")]
        ...
        private OleDbConnectionString OleDbConnectionStringValue =>
            ((OleDbConnectionString) this.ConnectionOptions);
        ...
        [ResDescription("OleDbConnection_Provider"), Browsable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ResCategory("DataCategory_Data")]
        public string Provider
        {
            get
            {
                Bid.Trace("<oledb.OleDbConnection.get_Provider|API> %d#\n", this.ObjectID);
                string str = this.OleDbConnectionStringValue?.ConvertValueToString("provider", null);
                if (str == null)
                {
                    return ADP.StrEmpty;
                }
        ...
        internal OleDbConnectionPoolGroupProviderInfo ProviderInfo =>
            ((OleDbConnectionPoolGroupProviderInfo) this.PoolGroup.ProviderInfo);

        [ResDescription("OleDbConnection_ServerVersion")]
        public override string ServerVersion =>
            this.InnerConnection.ServerVersion;
