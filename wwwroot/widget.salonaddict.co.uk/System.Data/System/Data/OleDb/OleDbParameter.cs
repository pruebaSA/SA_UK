namespace System.Data.OleDb
{
    ...
    public sealed class OleDbParameter : DbParameter, ICloneable, IDbDataParameter, IDataParameter
    {
        ...
        private static int GetBindDirection(ParameterDirection direction) => 
            ((int) (ParameterDirection.InputOutput & direction));
        ...
        private bool ShouldSerializeScale() => 
            this.ShouldSerializeScale(this._scale);
        ...
        object ICloneable.Clone() => 
            new OleDbParameter(this);

        public override string ToString() => 
            this.ParameterName;

        private byte ValuePrecision(object value) => 
            this.ValuePrecisionCore(value);
        ...
        {
            get => 
                this.GetBindType(this.Value).enumDbType;
            set
            {
                NativeDBType type = this._metaType;
        ...
        [ResCategory("DataCategory_Data"), ResDescription("DbParameter_Direction"), RefreshProperties(RefreshProperties.All)]
        ...
        [RefreshProperties(RefreshProperties.All), DbProviderSpecificTypeProperty(true), ResDescription("OleDbParameter_OleDbType"), ResCategory("DataCategory_Data")]
        public System.Data.OleDb.OleDbType OleDbType
        {
            get => 
                this.GetBindType(this.Value).enumOleDbType;
            set
            {
                NativeDBType type = this._metaType;
        ...
        [DefaultValue((byte) 0), ResCategory("DataCategory_Data"), ResDescription("DbDataParameter_Precision")]
        ...
        [TypeConverter(typeof(StringConverter)), RefreshProperties(RefreshProperties.All), ResDescription("DbParameter_Value"), ResCategory("DataCategory_Data")]
