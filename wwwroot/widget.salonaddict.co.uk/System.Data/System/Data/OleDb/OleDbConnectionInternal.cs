namespace System.Data.OleDb
{
    ...
    internal sealed class OleDbConnectionInternal : DbConnectionInternal, IDisposable
    {
        ...
        private static object CreateInstanceDataLinks() => 
            Activator.CreateInstance(Type.GetTypeFromCLSID(ODB.CLSID_DataLinks, true), BindingFlags.Public | BindingFlags.Instance, null, null, CultureInfo.InvariantCulture, null);

        protected override DbReferenceCollection CreateReferenceCollection() => 
            new OleDbReferenceCollection();
        ...
        internal DataTable GetSchemaRowset(Guid schema, object[] restrictions)
        {
            DataTable table2;
            IntPtr ptr;
            Bid.ScopeEnter(out ptr, "<oledb.OleDbConnectionInternal.GetSchemaRowset|INFO> %d#, schema=%p{GUID}, restrictions\n", base.ObjectID, schema);
            try
            {
        ...
        internal OleDbConnection Connection =>
            ((OleDbConnection) base.Owner);

        internal bool HasSession =>
            (null != this._sessionwrp);
        ...
        public override string ServerVersion =>
            Convert.ToString(this.GetDataSourceValue(OleDbPropertySetGuid.DataSourceInfo, 0x29), CultureInfo.InvariantCulture);
    }
}
