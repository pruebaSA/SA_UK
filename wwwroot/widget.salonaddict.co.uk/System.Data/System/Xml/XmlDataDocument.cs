namespace System.Xml
{
    ...
    public class XmlDataDocument : XmlDocument
    {
        ...
        public DataRow GetRowFromElement(XmlElement e) => 
            this.mapper.GetRowFromElement(e);
        ...
        internal bool IsNotMapped(DataColumn c) => 
            DataSetMapper.IsNotMapped(c);

        private bool IsRowLive(DataRow row) => 
            ((row.RowState & (DataRowState.Modified | DataRowState.Added | DataRowState.Unchanged)) != 0);

        private bool IsSame(DataColumn c, int recNo1, int recNo2) => 
            (c.Compare(recNo1, recNo2) == 0);
