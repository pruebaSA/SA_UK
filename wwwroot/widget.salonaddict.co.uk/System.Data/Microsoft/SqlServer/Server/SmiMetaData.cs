namespace Microsoft.SqlServer.Server
{
    ...
    internal class SmiMetaData
    {
        ...
        internal static SmiMetaData GetDefaultForType(System.Data.SqlDbType dbType) => 
            __defaultValues[(int) dbType];

        internal static bool IsSupportedDbType(System.Data.SqlDbType dbType) => 
            (((System.Data.SqlDbType.BigInt <= dbType) && (System.Data.SqlDbType.Xml >= dbType)) || ((System.Data.SqlDbType.Udt <= dbType) && (System.Data.SqlDbType.DateTimeOffset >= dbType)));
        ...
        internal virtual string TraceString(int indent)
        {
            ...
            return string.Format(CultureInfo.InvariantCulture, "\n\t{0}            SqlDbType={1:g}\n\t{0}            MaxLength={2:d}\n\t{0}            Precision={3:d}\n\t{0}                Scale={4:d}\n\t{0}             LocaleId={5:x}\n\t{0}       CompareOptions={6:g}\n\t{0}                 Type={7}\n\t{0}          MultiValued={8}\n\t{0}               fields=\n\t{9}{0}           properties=\n\t{10}", new object[] { str3, this.SqlDbType, this.MaxLength, this.Precision, this.Scale, this.LocaleId, this.CompareOptions, (this.Type != null) ? this.Type.ToString() : "<null>", this.IsMultiValued, str2, str });
        }
        ...
        internal static SmiMetaData DefaultChar =>
            new SmiMetaData(DefaultChar_NoCollation.SqlDbType, DefaultChar_NoCollation.MaxLength, DefaultChar_NoCollation.Precision, DefaultChar_NoCollation.Scale, (long) CultureInfo.CurrentCulture.LCID, SqlCompareOptions.IgnoreWidth | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreCase, null);

        internal static SmiMetaData DefaultNChar =>
            new SmiMetaData(DefaultNChar_NoCollation.SqlDbType, DefaultNChar_NoCollation.MaxLength, DefaultNChar_NoCollation.Precision, DefaultNChar_NoCollation.Scale, (long) CultureInfo.CurrentCulture.LCID, SqlCompareOptions.IgnoreWidth | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreCase, null);

        internal static SmiMetaData DefaultNText =>
            new SmiMetaData(DefaultNText_NoCollation.SqlDbType, DefaultNText_NoCollation.MaxLength, DefaultNText_NoCollation.Precision, DefaultNText_NoCollation.Scale, (long) CultureInfo.CurrentCulture.LCID, SqlCompareOptions.IgnoreWidth | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreCase, null);

        internal static SmiMetaData DefaultNVarChar =>
            new SmiMetaData(DefaultNVarChar_NoCollation.SqlDbType, DefaultNVarChar_NoCollation.MaxLength, DefaultNVarChar_NoCollation.Precision, DefaultNVarChar_NoCollation.Scale, (long) CultureInfo.CurrentCulture.LCID, SqlCompareOptions.IgnoreWidth | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreCase, null);

        internal static SmiMetaData DefaultText =>
            new SmiMetaData(DefaultText_NoCollation.SqlDbType, DefaultText_NoCollation.MaxLength, DefaultText_NoCollation.Precision, DefaultText_NoCollation.Scale, (long) CultureInfo.CurrentCulture.LCID, SqlCompareOptions.IgnoreWidth | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreCase, null);

        internal static SmiMetaData DefaultVarChar =>
            new SmiMetaData(DefaultVarChar_NoCollation.SqlDbType, DefaultVarChar_NoCollation.MaxLength, DefaultVarChar_NoCollation.Precision, DefaultVarChar_NoCollation.Scale, (long) CultureInfo.CurrentCulture.LCID, SqlCompareOptions.IgnoreWidth | SqlCompareOptions.IgnoreKanaType | SqlCompareOptions.IgnoreCase, null);
        ...
        internal System.Type Type
        {
            get
            {
                if (((this._clrType == null) && (System.Data.SqlDbType.Udt == this._databaseType)) && (this._udtAssemblyQualifiedName != null))
                {
