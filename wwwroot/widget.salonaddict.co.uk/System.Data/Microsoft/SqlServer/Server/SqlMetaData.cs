namespace Microsoft.SqlServer.Server
{
    ...
    public sealed class SqlMetaData
    {
        ...
        private long InternalAdjustTimeTicks(long ticks) => 
            ((ticks / __unitTicksFromScale[this.Scale]) * __unitTicksFromScale[this.Scale]);
        ...
        public SqlCompareOptions CompareOptions =>
            this.m_eCompareOptions;

        public System.Data.DbType DbType =>
            sxm_rgSqlDbTypeToDbType[(int) this.m_sqlDbType];

        internal bool IsPartialLength =>
            this.m_bPartialLength;
        ...
        public bool UseServerDefault =>
            this.m_useServerDefault;

        public string XmlSchemaCollectionDatabase =>
            this.m_XmlSchemaCollectionDatabase;

        public string XmlSchemaCollectionName =>
            this.m_XmlSchemaCollectionName;

        public string XmlSchemaCollectionOwningSchema =>
            this.m_XmlSchemaCollectionOwningSchema;
    }
}
