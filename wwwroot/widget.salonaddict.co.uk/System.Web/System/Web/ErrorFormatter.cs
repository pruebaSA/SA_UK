namespace System.Web
{
    ...
    internal abstract class ErrorFormatter
    {
        ...
        internal string GetErrorMessage() => 
            this.GetErrorMessage(HttpContext.Current, true);
        ...
        internal string GetHtmlErrorMessage(bool dontShowSensitiveInfo)
        {
            ...
            {
                for (System.Exception exception3 = this.Exception; exception3 != null; exception3 = exception3.InnerException)
                {
                    string fusionLog = null;
                    string fileName = null;
                    FileNotFoundException exception4 = exception3 as FileNotFoundException;
                    if (exception4 != null)
                    {
                        fusionLog = exception4.FusionLog;
                        fileName = exception4.FileName;
                    }
                    FileLoadException exception5 = exception3 as FileLoadException;
                    if (exception5 != null)
                    {
                        fusionLog = exception5.FusionLog;
                        fileName = exception5.FileName;
                    }
                    BadImageFormatException exception6 = exception3 as BadImageFormatException;
                    if (exception6 != null)
                    {
                        fusionLog = exception6.FusionLog;
                        fileName = exception6.FileName;
                    }
        ...
        private string GetPreferredRenderingType(HttpContext context)
        {
            ...
            return browser?["preferredRenderingType"];
        }
        ...
        internal static bool RequiresAdaptiveErrorReporting(HttpContext context)
        {
            ...
            return ((browser != null) && (browser["requiresAdaptiveErrorReporting"] == "true"));
        }
