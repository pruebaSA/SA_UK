    ...
    public abstract class TemplateControl : Control, INamingContainer, IFilterResolutionService
    {
        ...
        private void AddStackContextToHashCode(HashCodeCombiner combinedHashCode)
        {
            ...
            for (int i = index; i < (index + 2); i++)
            {
                ...
                combinedHashCode.AddObject(frame.GetMethod());
        ...
        protected LiteralControl CreateResourceBasedLiteralControl(int offset, int size, bool fAsciiOnly) => 
            new ResourceBasedLiteralControl(this, offset, size, fAsciiOnly);
        ...
        protected object GetGlobalResourceObject(string className, string resourceKey) => 
            ResourceExpressionBuilder.GetGlobalResourceObject(className, resourceKey, null, null, null);

        protected object GetGlobalResourceObject(string className, string resourceKey, Type objType, string propName) => 
            ResourceExpressionBuilder.GetGlobalResourceObject(className, resourceKey, objType, propName, null);
        ...
        public Control LoadControl(string virtualPath) => 
            this.LoadControl(System.Web.VirtualPath.Create(virtualPath));
        ...
        public Control LoadControl(Type t, object[] parameters) => 
            this.LoadControl(null, null, t, parameters);
        ...
        public ITemplate LoadTemplate(string virtualPath) => 
            this.LoadTemplate(System.Web.VirtualPath.Create(virtualPath));
        ...
        public Control ParseControl(string content) => 
            this.ParseControl(content, true);

        public Control ParseControl(string content, bool ignoreParserFilter) => 
            TemplateParser.ParseControl(content, System.Web.VirtualPath.Create(this.AppRelativeVirtualPath), ignoreParserFilter);

        [EditorBrowsable(EditorBrowsableState.Never)]
        public object ReadStringResource() => 
            StringResourceManager.ReadSafeStringResource(base.GetType());

        [EditorBrowsable(EditorBrowsableState.Never)]
        public static object ReadStringResource(Type t) => 
            StringResourceManager.ReadSafeStringResource(t);
        ...
        int IFilterResolutionService.CompareFilters(string filter1, string filter2) => 
            BrowserCapabilitiesCompiler.BrowserCapabilitiesFactory.CompareFilters(filter1, filter2);

        bool IFilterResolutionService.EvaluateFilter(string filterName) => 
            this.TestDeviceFilter(filterName);

        public virtual bool TestDeviceFilter(string filterName) => 
            this.Context.Request.Browser.IsBrowser(filterName);
        ...
        {
            get => 
                System.Web.VirtualPath.GetAppRelativeVirtualPathString(this.TemplateControlVirtualPath);
            set
            {
        ...
        internal int MaxResourceOffset =>
            this._maxResourceOffset;

        internal bool NoCompile =>
            (this._noCompileBuildResult != null);
