namespace System.Web.UI.HtmlControls
{
    ...
    [SupportsEventValidation, DefaultEvent("ServerClick"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class HtmlAnchor : HtmlContainerControl, IPostBackEventHandler
    {
        ...
        [DefaultValue(""), UrlProperty, WebCategory("Navigation"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public string HRef
        {
            get
            {
        ...
        [WebCategory("Appearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Localizable(true), DefaultValue("")]
        public string Title
        {
            get
            {
