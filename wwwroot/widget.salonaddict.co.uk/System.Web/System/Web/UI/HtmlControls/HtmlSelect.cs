namespace System.Web.UI.HtmlControls
{
    ...
    public class HtmlSelect : HtmlContainerControl, IPostBackDataHandler, IParserAccessor
    {
        ...
        [WebSysDescription("HtmlSelect_OnServerChange"), WebCategory("Action")]
        ...
        [WebSysDescription("HtmlSelect_DataMember"), WebCategory("Data"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue("")]
        ...
        [WebCategory("Data"), DefaultValue((string) null), WebSysDescription("BaseDataBoundControl_DataSource"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [WebCategory("Data"), DefaultValue(""), WebSysDescription("BaseDataBoundControl_DataSourceID")]
        ...
        [WebCategory("Data"), WebSysDescription("HtmlSelect_DataTextField"), DefaultValue("")]
        ...
        [WebSysDescription("HtmlSelect_DataValueField"), DefaultValue(""), WebCategory("Data")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), HtmlControlPersistable(false)]
