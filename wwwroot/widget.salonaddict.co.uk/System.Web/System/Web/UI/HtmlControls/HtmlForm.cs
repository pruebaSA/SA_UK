namespace System.Web.UI.HtmlControls
{
    ...
    public class HtmlForm : HtmlContainerControl
    {
        ...
        protected override ControlCollection CreateControlCollection() => 
            new ControlCollection(this, 100, 2);
        ...
        private string GetActionAttribute()
        {
            ...
            if ((((this.Context.WorkerRequest != null) && this.Context.WorkerRequest.IsRewriteModuleEnabled) && (this.Context.ServerExecuteDepth == 0)) || object.ReferenceEquals(currentExecutionFilePathObject, clientFilePath))
            {
        ...
        protected internal override void Render(HtmlTextWriter output)
        {
            ...
            if (page.SmartNavigation)
            {
                ...
                builder.Append(HttpUtility.UrlEncodeSpaces(HttpUtility.HtmlAttributeEncode(this.Page.ClientScript.GetWebResourceUrl(typeof(HtmlForm), "SmartNav.htm"))));
