namespace System.Web.UI.WebControls
{
    ...
    [SupportsEventValidation, DefaultEvent("CheckedChanged"), Designer("System.Web.UI.Design.WebControls.CheckBoxDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ControlValueProperty("Checked"), DataBindingHandler("System.Web.UI.Design.TextDataBindingHandler, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultProperty("Text"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class CheckBox : WebControl, IPostBackDataHandler, ICheckBoxControl
    {
        ...
        [DefaultValue(false), WebSysDescription("CheckBox_AutoPostBack"), Themeable(false), WebCategory("Behavior")]
        ...
        [DefaultValue(false), Bindable(true, BindingDirection.TwoWay), Themeable(false), WebSysDescription("CheckBox_Checked")]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("CheckBox_InputAttributes")]
        ...
        [WebSysDescription("CheckBox_LabelAttributes"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Localizable(true), Bindable(true), WebCategory("Appearance"), DefaultValue(""), WebSysDescription("CheckBox_Text")]
        ...
        [Themeable(false), DefaultValue(""), WebSysDescription("PostBackControl_ValidationGroup"), WebCategory("Behavior")]
