namespace System.Web.UI.WebControls.WebParts
{
    ...
    [WebPartTransformer(typeof(IWebPartRow), typeof(IWebPartParameters)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class RowToParametersTransformer : WebPartTransformer, IWebPartParameters
    {
        ...
        public override Control CreateConfigurationControl() => 
            new RowToParametersConfigurationWizard(this);
            ...
            protected override void CreateWizardSteps()
            {
                ...
                if (num > 0)
                {
                    ...
                    for (int i = 0; i < (num / 2); i++)
                    {
                        WizardStep wizardStep = new WizardStep {
                            Controls = { new LiteralControl(System.Web.SR.GetString("RowToParametersTransformer_ProviderFieldName") + " ") }
                        };
                ...
                else
                {
                    WizardStep step2 = new WizardStep {
                        Controls = { new LiteralControl(System.Web.SR.GetString("RowToParametersTransformer_NoProviderSchema")) }
                    };
