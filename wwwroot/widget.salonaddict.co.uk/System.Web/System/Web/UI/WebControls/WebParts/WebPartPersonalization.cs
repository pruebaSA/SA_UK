namespace System.Web.UI.WebControls.WebParts
{
    ...
    [TypeConverter(typeof(EmptyStringExpandableObjectConverter)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class WebPartPersonalization
    {
        ...
        [NotifyParentProperty(true), WebSysDescription("WebPartPersonalization_InitialScope"), DefaultValue(0)]
        ...
        [DefaultValue(""), NotifyParentProperty(true), WebSysDescription("WebPartPersonalization_ProviderName")]
        ...
        {
            get => 
                this._shouldResetPersonalizationState;
            set
            {
