namespace System.Web.UI.WebControls.WebParts
{
    ...
    [Editor("System.ComponentModel.Design.CollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class ProxyWebPartConnectionCollection : CollectionBase
    {
        ...
        public bool IsReadOnly =>
            ((this._webPartManager != null) && this._webPartManager.StaticConnections.IsReadOnly);

        public WebPartConnection this[int index]
        {
            get => 
                ((WebPartConnection) base.List[index]);
            set
            {
