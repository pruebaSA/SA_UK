namespace System.Web.UI.WebControls.WebParts
{
    ...
    [WebPartTransformer(typeof(IWebPartRow), typeof(IWebPartField)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class RowToFieldTransformer : WebPartTransformer, IWebPartField
    {
        ...
        public override Control CreateConfigurationControl() => 
            new RowToFieldConfigurationWizard(this);
