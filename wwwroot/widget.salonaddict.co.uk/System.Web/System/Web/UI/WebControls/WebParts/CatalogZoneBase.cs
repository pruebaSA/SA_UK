namespace System.Web.UI.WebControls.WebParts
{
    ...
    public abstract class CatalogZoneBase : ToolZone, IPostBackDataHandler
    {
        ...
        protected virtual System.Web.UI.WebControls.WebParts.CatalogPartChrome CreateCatalogPartChrome() => 
            new System.Web.UI.WebControls.WebParts.CatalogPartChrome(this);
        ...
        internal string GetCheckBoxID(string value) => 
            string.Concat(new object[] { this.ClientID, base.ClientIDSeparator, "_checkbox", base.ClientIDSeparator, value });
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebSysDescription("CatalogZoneBase_AddVerb"), WebCategory("Verbs")]
        ...
        internal string CheckBoxName =>
            (this.UniqueID + '$' + "_checkbox");

        [DefaultValue((string) null), WebSysDescription("CatalogZoneBase_CloseVerb"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs")]
        ...
        [WebSysDescription("CatalogZoneBase_PartLinkStyle"), DefaultValue((string) null), NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [WebSysDescription("CatalogZoneBase_SelectedCatalogPartID"), Themeable(false), WebCategory("Behavior"), DefaultValue("")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), WebSysDescription("CatalogZoneBase_SelectedPartLinkStyle"), WebCategory("Styles"), NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebSysDescription("CatalogZoneBase_SelectTargetZoneText"), WebCategory("Behavior"), Localizable(true), WebSysDefaultValue("CatalogZoneBase_DefaultSelectTargetZoneText")]
        ...
        [WebCategory("Behavior"), WebSysDescription("CatalogZoneBase_ShowCatalogIcons"), DefaultValue(true)]
