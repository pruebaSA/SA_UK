namespace System.Web.UI.WebControls.WebParts
{
    ...
    public abstract class ToolZone : WebZone, IPostBackEventHandler
    {
        ...
        [WebSysDescription("ToolZone_EditUIStyle"), WebCategory("Styles"), DefaultValue((string) null), NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [NotifyParentProperty(true), WebCategory("Verbs"), WebSysDescription("ToolZone_HeaderCloseVerb"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DefaultValue((string) null), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), WebSysDescription("ToolZone_HeaderVerbStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Styles"), NotifyParentProperty(true), WebSysDescription("ToolZone_InstructionTextStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), WebSysDescription("ToolZone_LabelStyle"), NotifyParentProperty(true), DefaultValue((string) null)]
