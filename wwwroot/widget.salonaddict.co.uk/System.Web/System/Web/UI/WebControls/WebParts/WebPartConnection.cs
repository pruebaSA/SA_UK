namespace System.Web.UI.WebControls.WebParts
{
    ...
    [ParseChildren(true, "Transformers"), TypeConverter(typeof(ExpandableObjectConverter)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class WebPartConnection
    {
        ...
        internal bool ConflictsWithConsumer(WebPartConnection otherConnection) => 
            ((!this.ConsumerConnectionPoint.AllowsMultipleConnections && (this.Consumer == otherConnection.Consumer)) && (this.ConsumerConnectionPoint == otherConnection.ConsumerConnectionPoint));

        internal bool ConflictsWithProvider(WebPartConnection otherConnection) => 
            ((!this.ProviderConnectionPoint.AllowsMultipleConnections && (this.Provider == otherConnection.Provider)) && (this.ProviderConnectionPoint == otherConnection.ProviderConnectionPoint));
