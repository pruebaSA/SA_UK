namespace System.Web.UI.WebControls.WebParts
{
    ...
    public abstract class WebPartZoneBase : WebZone, IPostBackEventHandler, IWebPartMenuUser
    {
        ...
        protected virtual System.Web.UI.WebControls.WebParts.WebPartChrome CreateWebPartChrome() => 
            new System.Web.UI.WebControls.WebParts.WebPartChrome(this, base.WebPartManager);
        ...
        private bool IsDragEvent(string[] eventArguments) => 
            ((eventArguments.Length == 3) && string.Equals(eventArguments[0], "Drag", StringComparison.OrdinalIgnoreCase));

        private bool IsPartVerbEvent(string[] eventArguments) => 
            ((eventArguments.Length == 3) && string.Equals(eventArguments[0], "partverb", StringComparison.OrdinalIgnoreCase));

        private bool IsZoneVerbEvent(string[] eventArguments) => 
            ((eventArguments.Length == 3) && string.Equals(eventArguments[0], "zoneverb", StringComparison.OrdinalIgnoreCase));
        ...
        [Themeable(false), DefaultValue(true), WebCategory("Behavior"), WebSysDescription("WebPartZoneBase_AllowLayoutChange")]
        ...
        [DefaultValue((string) null), WebSysDescription("WebPartZoneBase_CloseVerb"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs")]
        ...
        [WebCategory("Verbs"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("WebPartZoneBase_ConnectVerb"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        [NotifyParentProperty(true), WebSysDescription("WebPartZoneBase_DeleteVerb"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs")]
        ...
        protected internal bool DragDropEnabled =>
            (((!base.DesignMode && base.RenderClientScript) && (this.AllowLayoutChange && (base.WebPartManager != null))) && base.WebPartManager.DisplayMode.AllowPageDesign);

        [TypeConverter(typeof(WebColorConverter)), WebSysDescription("WebPartZoneBase_DragHighlightColor"), WebCategory("Appearance"), DefaultValue(typeof(Color), "Blue")]
        ...
        [WebSysDescription("WebPartZoneBase_EditVerb"), WebCategory("Verbs"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs"), WebSysDescription("WebPartZoneBase_ExportVerb")]
        ...
        [NotifyParentProperty(true), WebCategory("Verbs"), WebSysDescription("WebPartZoneBase_HelpVerb"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DefaultValue(1), WebCategory("Layout"), WebSysDescription("WebPartZoneBase_LayoutOrientation")]
        ...
        [WebCategory("Styles"), WebSysDescription("WebPartZoneBase_MenuCheckImageStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null)]
        ...
        [WebCategory("Appearance"), DefaultValue(""), WebSysDescription("WebPartZoneBase_MenuCheckImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [WebSysDescription("WebPartZoneBase_MenuLabelHoverStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [WebSysDescription("WebPartZoneBase_MenuLabelStyle"), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        [Localizable(true), WebCategory("Appearance"), DefaultValue(""), WebSysDescription("WebPartZoneBase_MenuLabelText")]
        ...
        [WebCategory("Appearance"), DefaultValue(""), WebSysDescription("WebPartZoneBase_MenuPopupImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("WebPartZoneBase_MenuPopupStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), DefaultValue((string) null), WebCategory("Styles")]
        ...
        [WebSysDescription("WebPartZoneBase_MenuVerbHoverStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), WebCategory("Styles"), WebSysDescription("WebPartZoneBase_MenuVerbStyle"), PersistenceMode(PersistenceMode.InnerProperty), NotifyParentProperty(true)]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), NotifyParentProperty(true), WebCategory("Verbs"), WebSysDescription("WebPartZoneBase_MinimizeVerb"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Verbs"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), WebSysDescription("WebPartZoneBase_RestoreVerb")]
        ...
        [NotifyParentProperty(true), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("WebPart"), WebSysDescription("WebPartZoneBase_SelectedPartChromeStyle")]
        ...
        [WebCategory("WebPart"), DefaultValue(true), WebSysDescription("WebPartZoneBase_ShowTitleIcons")]
        ...
        [WebSysDescription("WebPartZoneBase_TitleBarVerbButtonType"), WebCategory("Appearance"), DefaultValue(1)]
        ...
        [WebCategory("Styles"), WebSysDescription("WebPartZoneBase_TitleBarVerbStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null)]
