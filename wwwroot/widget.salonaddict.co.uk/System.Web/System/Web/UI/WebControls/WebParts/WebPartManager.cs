namespace System.Web.UI.WebControls.WebParts
{
    ...
    [NonVisualControl, Bindable(false), Designer("System.Web.UI.Design.WebControls.WebParts.WebPartManagerDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ViewStateModeById, ParseChildren(true), PersistChildren(false), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class WebPartManager : Control, INamingContainer, IPersonalizable
    {
        ...
        [WebSysDescription("WebPartManager_AuthorizeWebPart"), WebCategory("Action")]
        ...
        [WebSysDescription("WebPartManager_ConnectionsActivating"), WebCategory("Action")]
        ...
        [WebCategory("Action"), WebSysDescription("WebPartManager_DisplayModeChanged")]
        ...
        [WebCategory("Action"), WebSysDescription("WebPartManager_WebPartAdded")]
        ...
        [WebCategory("Action"), WebSysDescription("WebPartManager_WebPartMoving")]
        ...
        [WebSysDescription("WebPartManager_WebPartsConnecting"), WebCategory("Action")]
        ...
        [WebCategory("Action"), WebSysDescription("WebPartManager_WebPartsDisconnected")]
        ...
        public bool CanConnectWebParts(WebPart provider, ProviderConnectionPoint providerConnectionPoint, WebPart consumer, ConsumerConnectionPoint consumerConnectionPoint) => 
            this.CanConnectWebParts(provider, providerConnectionPoint, consumer, consumerConnectionPoint, null);
        ...
        public virtual bool CanConnectWebParts(WebPart provider, ProviderConnectionPoint providerConnectionPoint, WebPart consumer, ConsumerConnectionPoint consumerConnectionPoint, WebPartTransformer transformer) => 
            this.CanConnectWebPartsCore(provider, providerConnectionPoint, consumer, consumerConnectionPoint, transformer, false);
        ...
        public WebPartConnection ConnectWebParts(WebPart provider, ProviderConnectionPoint providerConnectionPoint, WebPart consumer, ConsumerConnectionPoint consumerConnectionPoint) => 
            this.ConnectWebParts(provider, providerConnectionPoint, consumer, consumerConnectionPoint, null);
        ...
        protected sealed override ControlCollection CreateControlCollection() => 
            new WebPartManagerControlCollection(this);
        ...
        protected virtual ErrorWebPart CreateErrorWebPart(string originalID, string originalTypeName, string originalPath, string genericWebPartID, string errorMessage) => 
            new ErrorWebPart(originalID, originalTypeName, originalPath, genericWebPartID) { ErrorMessage = errorMessage };

        protected virtual WebPartPersonalization CreatePersonalization() => 
            new WebPartPersonalization(this);

        public virtual GenericWebPart CreateWebPart(Control control) => 
            CreateWebPartStatic(control);
        ...
        private static ConsumerConnectionPointCollection GetConsumerConnectionPoints(Type type) => 
            ((ConsumerConnectionPointCollection) GetConnectionPoints(type)[0]);
        ...
        internal ConsumerConnectionPointCollection GetEnabledConsumerConnectionPoints(WebPart webPart) => 
            new ConsumerConnectionPointCollection(GetEnabledConnectionPoints(this.GetConsumerConnectionPoints(webPart), webPart));

        internal ProviderConnectionPointCollection GetEnabledProviderConnectionPoints(WebPart webPart) => 
            new ProviderConnectionPointCollection(GetEnabledConnectionPoints(this.GetProviderConnectionPoints(webPart), webPart));
        ...
        private static ProviderConnectionPointCollection GetProviderConnectionPoints(Type type) => 
            ((ProviderConnectionPointCollection) GetConnectionPoints(type)[1]);
        ...
        internal bool IsConsumerConnected(WebPart consumer, ConsumerConnectionPoint connectionPoint) => 
            (this.GetConnectionForConsumer(consumer, connectionPoint) != null);

        internal bool IsProviderConnected(WebPart provider, ProviderConnectionPoint connectionPoint) => 
            (this.GetConnectionForProvider(provider, connectionPoint) != null);
        ...
        [WebSysDescription("WebPartManager_DeleteWarning"), WebCategory("Behavior"), WebSysDefaultValue("WebPartManager_DefaultDeleteWarning")]
        ...
        [WebSysDescription("WebPartManager_EnableClientScript"), WebCategory("Behavior"), DefaultValue(true)]
        ...
        [WebCategory("Behavior"), WebSysDefaultValue("WebPartChrome_ConfirmExportSensitive"), WebSysDescription("WebPartManager_ExportSensitiveDataWarning")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Behavior"), WebSysDescription("WebPartManager_Personalization"), NotifyParentProperty(true), DefaultValue((string) null)]
        ...
        [WebCategory("Behavior"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebSysDescription("WebPartManager_StaticConnections"), MergableProperty(false)]
        ...
        bool IPersonalizable.IsDirty =>
            this.IsCustomPersonalizationStateDirty;

        [EditorBrowsable(EditorBrowsableState.Never), Bindable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
