namespace System.Web.UI.WebControls.WebParts
{
    ...
    public abstract class EditorZoneBase : ToolZone
    {
        ...
        protected virtual System.Web.UI.WebControls.WebParts.EditorPartChrome CreateEditorPartChrome() => 
            new System.Web.UI.WebControls.WebParts.EditorPartChrome(this);
        ...
        [NotifyParentProperty(true), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebSysDescription("EditorZoneBase_ApplyVerb"), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs")]
        ...
        [WebSysDescription("EditorZoneBase_CancelVerb"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs")]
        ...
        protected override bool Display =>
            (base.Display && (this.WebPartToEdit != null));
        ...
        [WebSysDescription("EditorZoneBase_ErrorText"), WebCategory("Behavior"), Localizable(true), WebSysDefaultValue("EditorZoneBase_DefaultErrorText")]
        ...
        [DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("EditorZoneBase_OKVerb"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebCategory("Verbs")]
