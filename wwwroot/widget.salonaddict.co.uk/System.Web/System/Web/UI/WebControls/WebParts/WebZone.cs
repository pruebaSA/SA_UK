namespace System.Web.UI.WebControls.WebParts
{
    ...
    [Designer("System.Web.UI.Design.WebControls.WebParts.WebZoneDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), Bindable(false), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public abstract class WebZone : CompositeControl
    {
        ...
        [UrlProperty, DefaultValue(""), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebSysDescription("WebControl_BackImageUrl"), WebCategory("Appearance")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), NotifyParentProperty(true), WebSysDescription("Zone_ErrorStyle"), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [WebSysDescription("Zone_FooterStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [WebSysDescription("Zone_HeaderStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [WebSysDescription("Zone_HeaderText"), WebCategory("Appearance"), Localizable(true), WebSysDefaultValue("")]
        ...
        [WebCategory("Layout"), DefaultValue(2), WebSysDescription("Zone_Padding")]
        ...
        [WebSysDescription("Zone_PartChromePadding"), WebCategory("WebPart"), DefaultValue(typeof(Unit), "5px")]
        ...
        [WebCategory("WebPart"), WebSysDescription("Zone_PartChromeStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DefaultValue(0), WebSysDescription("Zone_PartChromeType"), WebCategory("WebPart")]
        ...
        [WebCategory("WebPart"), WebSysDescription("Zone_PartStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebCategory("WebPart"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), WebSysDescription("Zone_PartTitleStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Appearance"), WebSysDescription("Zone_VerbButtonType"), DefaultValue(0)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebSysDescription("Zone_VerbStyle"), DefaultValue((string) null), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
