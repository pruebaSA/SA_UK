namespace System.Web.UI.WebControls.WebParts
{
    ...
    [Designer("System.Web.UI.Design.WebControls.WebParts.ConnectionsZoneDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), SupportsEventValidation, AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class ConnectionsZone : ToolZone
    {
        ...
        private bool HasConfigurationControl(WebPartTransformer transformer) => 
            (transformer.CreateConfigurationControl() != null);
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs"), WebSysDescription("ConnectionsZone_CancelVerb"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), DefaultValue((string) null)]
        ...
        [WebSysDescription("ConnectionsZone_CloseVerb"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs")]
        ...
        [WebSysDefaultValue("ConnectionsZone_ConfigureConnectionTitle"), WebSysDescription("ConnectionsZone_ConfigureConnectionTitleDescription"), WebCategory("Appearance")]
        ...
        [NotifyParentProperty(true), WebCategory("Verbs"), DefaultValue((string) null), WebSysDescription("ConnectionsZone_ConfigureVerb"), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebSysDefaultValue("ConnectionsZone_ConnectToConsumerInstructionText"), WebCategory("Appearance"), WebSysDescription("ConnectionsZone_ConnectToConsumerInstructionTextDescription")]
        ...
        [WebSysDescription("ConnectionsZone_ConnectToConsumerTextDescription"), WebSysDefaultValue("ConnectionsZone_ConnectToConsumerText"), WebCategory("Appearance")]
        ...
        [WebCategory("Appearance"), WebSysDescription("ConnectionsZone_ConnectToProviderTextDescription"), WebSysDefaultValue("ConnectionsZone_ConnectToProviderText")]
        ...
        [WebCategory("Appearance"), WebSysDescription("ConnectionsZone_ConnectToProviderTitleDescription"), WebSysDefaultValue("ConnectionsZone_ConnectToProviderTitle")]
        ...
        [DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Verbs"), WebSysDescription("ConnectionsZone_ConnectVerb")]
        ...
        [WebCategory("Appearance"), WebSysDescription("ConnectionsZone_ConsumersInstructionTextDescription"), WebSysDefaultValue("ConnectionsZone_ConsumersInstructionText")]
        ...
        [WebCategory("Appearance"), WebSysDescription("ConnectionsZone_ConsumersTitleDescription"), WebSysDefaultValue("ConnectionsZone_ConsumersTitle")]
        ...
        [WebSysDescription("ConnectionsZone_DisconnectVerb"), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), DefaultValue((string) null), WebCategory("Verbs")]
        ...
        protected override bool Display =>
            (base.Display && (this.WebPartToConnect != null));
        ...
        [WebCategory("Appearance"), WebSysDefaultValue("ConnectionsZone_WarningConnectionDisabled"), WebSysDescription("ConnectionsZone_WarningMessage")]
        ...
        [WebSysDefaultValue("ConnectionsZone_GetFromText"), WebCategory("Appearance"), WebSysDescription("ConnectionsZone_GetFromTextDescription")]
        ...
        [WebCategory("Appearance"), WebSysDefaultValue("ConnectionsZone_Get"), WebSysDescription("ConnectionsZone_GetDescription")]
        ...
        [WebCategory("Appearance"), WebSysDescription("ConnectionsZone_HeaderTextDescription"), WebSysDefaultValue("ConnectionsZone_HeaderText")]
        ...
        [WebSysDefaultValue("ConnectionsZone_InstructionText"), WebSysDescription("ConnectionsZone_InstructionTextDescription"), WebCategory("Appearance")]
        ...
        [WebCategory("Appearance"), WebSysDefaultValue("ConnectionsZone_InstructionTitle"), WebSysDescription("ConnectionsZone_InstructionTitleDescription")]
        ...
        [WebSysDescription("ConnectionsZone_ErrorMessage"), WebSysDefaultValue("ConnectionsZone_ErrorCantContinueConnectionCreation"), WebCategory("Appearance")]
        ...
        [WebSysDescription("ConnectionsZone_NoExistingConnectionInstructionTextDescription"), WebCategory("Appearance"), WebSysDefaultValue("ConnectionsZone_NoExistingConnectionInstructionText")]
        ...
        [WebCategory("Appearance"), WebSysDescription("ConnectionsZone_NoExistingConnectionTitleDescription"), WebSysDefaultValue("ConnectionsZone_NoExistingConnectionTitle")]
        ...
        [WebCategory("Appearance"), WebSysDefaultValue("ConnectionsZone_ProvidersInstructionText"), WebSysDescription("ConnectionsZone_ProvidersInstructionTextDescription")]
        ...
        [WebSysDefaultValue("ConnectionsZone_SendText"), WebCategory("Appearance"), WebSysDescription("ConnectionsZone_SendTextDescription")]
        ...
        [WebCategory("Appearance"), WebSysDefaultValue("ConnectionsZone_SendToText"), WebSysDescription("ConnectionsZone_SendToTextDescription")]
