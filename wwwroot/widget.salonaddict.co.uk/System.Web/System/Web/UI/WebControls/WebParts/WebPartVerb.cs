namespace System.Web.UI.WebControls.WebParts
{
    ...
    [TypeConverter(typeof(EmptyStringExpandableObjectConverter)), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class WebPartVerb : IStateManager
    {
        ...
        [WebSysDescription("WebPartVerb_Description"), Localizable(true), NotifyParentProperty(true), WebSysDefaultValue("")]
        ...
        [DefaultValue(true), Themeable(false), WebSysDescription("WebPartVerb_Enabled"), NotifyParentProperty(true)]
        ...
        [Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(""), NotifyParentProperty(true), UrlProperty, WebSysDescription("WebPartVerb_ImageUrl")]
        ...
        [DefaultValue(true), NotifyParentProperty(true), Themeable(false), WebSysDescription("WebPartVerb_Visible")]
