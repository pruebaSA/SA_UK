namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.PanelContainerDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ParseChildren(false), PersistChildren(true), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class Panel : WebControl
    {
        ...
        [WebCategory("Appearance"), WebSysDescription("Panel_BackImageUrl"), DefaultValue(""), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [WebCategory("Behavior"), WebSysDescription("Panel_DefaultButton"), DefaultValue(""), Themeable(false)]
        ...
        [Localizable(true), DefaultValue(""), WebSysDescription("Panel_GroupingText"), WebCategory("Appearance")]
        ...
        [WebCategory("Layout"), WebSysDescription("Panel_HorizontalAlign"), DefaultValue(0)]
        ...
        [DefaultValue(true), WebSysDescription("Panel_Wrap"), WebCategory("Layout")]
