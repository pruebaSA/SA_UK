namespace System.Web.UI.WebControls
{
    ...
    public struct Unit
    {
        ...
        public override int GetHashCode() => 
            HashCodeCombiner.CombineHashCodes(this.type.GetHashCode(), this.value.GetHashCode());
