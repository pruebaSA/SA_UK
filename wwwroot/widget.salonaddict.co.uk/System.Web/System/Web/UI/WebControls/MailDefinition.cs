namespace System.Web.UI.WebControls
{
    ...
    [TypeConverter(typeof(EmptyStringExpandableObjectConverter)), ParseChildren(true, ""), Bindable(false), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class MailDefinition : IStateManager
    {
        ...
        [UrlProperty("*.*"), NotifyParentProperty(true), WebCategory("Behavior"), WebSysDescription("MailDefinition_BodyFileName"), Editor("System.Web.UI.Design.WebControls.MailDefinitionBodyFileNameEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue("")]
        ...
        [WebCategory("Behavior"), WebSysDescription("MailDefinition_CC"), NotifyParentProperty(true), DefaultValue("")]
        public string CC
        {
            get
            {
        ...
        [WebCategory("Behavior"), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), WebSysDescription("MailDefinition_EmbeddedObjects"), NotifyParentProperty(true)]
        ...
        [DefaultValue(""), WebCategory("Behavior"), WebSysDescription("MailDefinition_From"), NotifyParentProperty(true)]
        public string From
        {
            get
            {
        ...
        [WebSysDescription("MailDefinition_IsBodyHtml"), DefaultValue(false), NotifyParentProperty(true), WebCategory("Behavior")]
        ...
        [WebCategory("Behavior"), NotifyParentProperty(true), DefaultValue(0), WebSysDescription("MailDefinition_Priority")]
        ...
        [NotifyParentProperty(true), DefaultValue(""), WebCategory("Behavior"), WebSysDescription("MailDefinition_Subject")]
