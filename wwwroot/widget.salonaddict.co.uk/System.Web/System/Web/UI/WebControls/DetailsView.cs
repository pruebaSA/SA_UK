namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.DetailsViewDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultEvent("PageIndexChanging"), SupportsEventValidation, ControlValueProperty("SelectedValue"), ToolboxData("<{0}:DetailsView runat=\"server\" Width=\"125px\" Height=\"50px\"></{0}:DetailsView>"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class DetailsView : CompositeDataBoundControl, IDataItemContainer, INamingContainer, ICallbackContainer, ICallbackEventHandler, IPostBackEventHandler, IPostBackContainer
    {
        ...
        [WebCategory("Action"), WebSysDescription("DetailsView_OnItemCommand")]
        ...
        [WebSysDescription("DetailsView_OnItemCreated"), WebCategory("Behavior")]
        ...
        [WebCategory("Action"), WebSysDescription("DataControls_OnItemInserting")]
        ...
        [WebCategory("Action"), WebSysDescription("DetailsView_OnModeChanged")]
        ...
        [WebCategory("Action"), WebSysDescription("DetailsView_OnPageIndexChanged")]
        ...
        [WebCategory("Action"), WebSysDescription("DetailsView_OnPageIndexChanging")]
        ...
        private string BuildCallbackArgument(int pageIndex) => 
            ("\"" + Convert.ToString(pageIndex, CultureInfo.InvariantCulture) + "|\"");
        ...
        protected override void EnsureDataBound()
        {
            if ((base.RequiresDataBinding && (this.Mode == DetailsViewMode.Insert)) && !this.AutoGenerateRows)
            {
                ...
                {
                    DataBoundControlAdapter adapter = base._adapter as DataBoundControlAdapter;
                    if (adapter != null)
                    {
                        adapter.PerformDataBinding(null);
                    }
                    else
                    {
        ...
        protected virtual void ExtractRowValues(IOrderedDictionary fieldValues, bool includeReadOnlyFields, bool includeKeys)
        {
            if (fieldValues != null)
            {
                ...
                {
                    int num = 0;
                    if (((DataControlField) array[i]).ShowHeader)
                    {
                        num = 1;
                    }
                    if (((DataControlField) array[i]).Visible)
                    {
                        ...
                        ((DataControlField) array[i]).ExtractValuesFromCell(dictionary, rows[i].Cells[num] as DataControlFieldCell, rows[i].RowState, includeReadOnlyFields);
        ...
        [WebSysDescription("DetailsView_AllowPaging"), WebCategory("Paging"), DefaultValue(false)]
        ...
        [NotifyParentProperty(true), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DetailsView_AlternatingRowStyle")]
        ...
        [WebCategory("Behavior"), DefaultValue(false), WebSysDescription("DetailsView_AutoGenerateDeleteButton")]
        ...
        [WebCategory("Behavior"), DefaultValue(false), WebSysDescription("DetailsView_AutoGenerateEditButton")]
        ...
        [DefaultValue(false), WebCategory("Behavior"), WebSysDescription("DetailsView_AutoGenerateInsertButton")]
        ...
        [WebCategory("Behavior"), DefaultValue(true), WebSysDescription("DetailsView_AutoGenerateRows")]
        ...
        [DefaultValue(""), WebCategory("Appearance"), WebSysDescription("WebControl_BackImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [WebCategory("Layout"), WebSysDescription("DetailsView_CellPadding"), DefaultValue(-1)]
        ...
        [WebSysDescription("DetailsView_CellSpacing"), WebCategory("Layout"), DefaultValue(0)]
        ...
        [DefaultValue((string) null), WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DetailsView_CommandRowStyle")]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("DetailsView_DataKey")]
        ...
        [Editor("System.Web.UI.Design.WebControls.DataFieldEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue((string) null), TypeConverter(typeof(StringArrayConverter)), WebCategory("Data"), WebSysDescription("DataControls_DataKeyNames")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), DefaultValue((string) null), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("View_EditRowStyle")]
        ...
        [DefaultValue((string) null), WebCategory("Styles"), WebSysDescription("View_EmptyDataRowStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [Localizable(true), WebSysDescription("View_EmptyDataText"), WebCategory("Appearance"), DefaultValue("")]
        ...
        [WebCategory("Behavior"), WebSysDescription("DataBoundControl_EnableModelValidation"), DefaultValue(false)]
        ...
        [WebSysDescription("DetailsView_EnablePagingCallbacks"), WebCategory("Behavior"), DefaultValue(false)]
        ...
        [DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DetailsView_Fields"), MergableProperty(false), Editor("System.Web.UI.Design.WebControls.DataControlFieldTypeEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebCategory("Default")]
        ...
        [WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebSysDescription("DetailsView_FooterStyle")]
        ...
        [Browsable(false), WebSysDescription("DetailsView_FooterTemplate"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(DetailsView))]
        ...
        [WebCategory("Appearance"), Localizable(true), DefaultValue(""), WebSysDescription("View_FooterText")]
        ...
        [WebSysDescription("DataControls_GridLines"), WebCategory("Appearance"), DefaultValue(3)]
        ...
        [DefaultValue((string) null), WebCategory("Styles"), WebSysDescription("WebControl_HeaderStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [Browsable(false), TemplateContainer(typeof(DetailsView)), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("WebControl_HeaderTemplate")]
        ...
        [WebSysDescription("View_HeaderText"), Localizable(true), WebCategory("Appearance"), DefaultValue("")]
        ...
        [NotifyParentProperty(true), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("View_InsertRowStyle")]
        ...
        [WebSysDescription("DetailsView_PageIndex"), Bindable(true), DefaultValue(0), WebCategory("Data")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Paging"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DetailsView_PagerSettings")]
        ...
        [TemplateContainer(typeof(DetailsView)), Browsable(false), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("View_PagerTemplate")]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("DetailsView_Rows")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("View_RowStyle"), NotifyParentProperty(true)]
