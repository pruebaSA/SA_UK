namespace System.Web.UI.WebControls
{
    ...
    public class SiteMapPath : CompositeControl
    {
        ...
        [WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("SiteMapPath_CurrentNodeStyle")]
        ...
        [Browsable(false), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(SiteMapNodeItem)), WebSysDescription("SiteMapPath_CurrentNodeTemplate")]
        public virtual ITemplate CurrentNodeTemplate
        {
            get => 
                this._currentNodeTemplate;
            set
            {
        ...
        [NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), WebSysDescription("SiteMapPath_NodeStyle")]
        ...
        [DefaultValue((string) null), Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(SiteMapNodeItem)), WebSysDescription("SiteMapPath_NodeTemplate")]
        ...
        [DefaultValue(-1), Themeable(false), WebCategory("Behavior"), WebSysDescription("SiteMapPath_ParentLevelsDisplayed")]
        ...
        [WebCategory("Appearance"), DefaultValue(0), WebSysDescription("SiteMapPath_PathDirection")]
        ...
        [WebSysDescription("SiteMapPath_PathSeparator"), Localizable(true), WebCategory("Appearance"), DefaultValue(" > ")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), DefaultValue((string) null), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), WebSysDescription("SiteMapPath_PathSeparatorStyle")]
        ...
        [DefaultValue((string) null), Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(SiteMapNodeItem)), WebSysDescription("SiteMapPath_PathSeparatorTemplate")]
        public virtual ITemplate PathSeparatorTemplate
        {
            get => 
                this._pathSeparatorTemplate;
            set
            {
        ...
        [WebSysDescription("SiteMapPath_Provider"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue((string) null), WebSysDescription("SiteMapPath_RootNodeStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [TemplateContainer(typeof(SiteMapNodeItem)), Browsable(false), WebSysDescription("SiteMapPath_RootNodeTemplate"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty)]
        public virtual ITemplate RootNodeTemplate
        {
            get => 
                this._rootNodeTemplate;
            set
            {
        ...
        [WebSysDescription("SiteMapPath_ShowToolTips"), Themeable(false), WebCategory("Behavior"), DefaultValue(true)]
        ...
        [Themeable(false), DefaultValue(""), WebCategory("Behavior"), WebSysDescription("SiteMapPath_SiteMapProvider")]
        ...
        [WebCategory("Accessibility"), Localizable(true), WebSysDescription("SiteMapPath_SkipToContentText"), WebSysDefaultValue("SiteMapPath_Default_SkipToContentText")]
