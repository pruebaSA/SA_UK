namespace System.Web.UI.WebControls
{
    ...
    public sealed class MenuItemStyle : Style
    {
        ...
        [WebSysDescription("MenuItemStyle_HorizontalPadding"), NotifyParentProperty(true), WebCategory("Layout"), DefaultValue(typeof(Unit), "")]
        ...
        [WebCategory("Layout"), WebSysDescription("MenuItemStyle_ItemSpacing"), NotifyParentProperty(true), DefaultValue(typeof(Unit), "")]
        ...
        [WebSysDescription("MenuItemStyle_VerticalPadding"), DefaultValue(typeof(Unit), ""), WebCategory("Layout"), NotifyParentProperty(true)]
