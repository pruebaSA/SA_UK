namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.LoginStatusDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), Bindable(false), DefaultEvent("LoggingOut"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class LoginStatus : CompositeControl
    {
        ...
        [WebCategory("Action"), WebSysDescription("LoginStatus_LoggingOut")]
        ...
        [DefaultValue(""), WebCategory("Appearance"), UrlProperty, WebSysDescription("LoginStatus_LoginImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [WebSysDescription("LoginStatus_LoginText"), Localizable(true), WebCategory("Appearance"), WebSysDefaultValue("LoginStatus_DefaultLoginText")]
        ...
        [WebCategory("Appearance"), UrlProperty, DefaultValue(""), WebSysDescription("LoginStatus_LogoutImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [DefaultValue(""), UrlProperty, WebCategory("Behavior"), WebSysDescription("LoginStatus_LogoutPageUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), Themeable(false)]
        ...
        [Localizable(true), WebSysDefaultValue("LoginStatus_DefaultLogoutText"), WebSysDescription("LoginStatus_LogoutText"), WebCategory("Appearance")]
