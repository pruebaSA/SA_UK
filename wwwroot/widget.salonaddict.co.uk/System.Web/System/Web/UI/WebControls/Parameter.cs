namespace System.Web.UI.WebControls
{
    ...
    [DefaultProperty("DefaultValue"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class Parameter : ICloneable, IStateManager
    {
        ...
        [DefaultValue(true), WebSysDescription("Parameter_ConvertEmptyStringToNull"), WebCategory("Parameter")]
        ...
        [DefaultValue(13), WebCategory("Parameter"), WebSysDescription("Parameter_DbType")]
        ...
        [DefaultValue((string) null), WebCategory("Parameter"), WebSysDescription("Parameter_DefaultValue")]
        ...
        [WebCategory("Parameter"), DefaultValue(1), WebSysDescription("Parameter_Direction")]
        ...
        [WebSysDescription("Parameter_Name"), WebCategory("Parameter"), DefaultValue("")]
        public string Name
        {
            get
            {
        ...
        internal object ParameterValue =>
            this.GetValue(this.ViewState["ParameterValue"], false);

        [WebSysDescription("Parameter_Size"), DefaultValue(0), WebCategory("Parameter")]
        public int Size
        {
            get
            {
