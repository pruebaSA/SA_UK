namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.LoginDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), Bindable(false), DefaultEvent("Authenticate"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class Login : CompositeControl
    {
        ...
        private bool OnLoginPage() => 
            AuthenticationConfig.AccessingLoginPage(this.Context, FormsAuthentication.LoginUrl);
        ...
        private bool RedirectedFromFailedLogin() => 
            ((!base.DesignMode && (this.Page != null)) && (!this.Page.IsPostBack && (this.Page.Request.QueryString["loginfailure"] != null)));
        ...
        [DefaultValue((string) null), WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("Login_CheckBoxStyle")]
        ...
        [UrlProperty, WebCategory("Links"), DefaultValue(""), WebSysDescription("Login_CreateUserIconUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [WebCategory("Links"), Localizable(true), DefaultValue(""), WebSysDescription("ChangePassword_CreateUserText")]
        ...
        [UrlProperty, WebCategory("Links"), DefaultValue(""), WebSysDescription("Login_CreateUserUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [DefaultValue(""), WebCategory("Behavior"), Themeable(false), WebSysDescription("Login_DestinationPageUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [WebSysDescription("Login_DisplayRememberMe"), WebCategory("Behavior"), DefaultValue(true), Themeable(false)]
        ...
        [Localizable(true), WebCategory("Appearance"), WebSysDefaultValue("Login_DefaultFailureText"), WebSysDescription("Login_FailureText")]
        ...
        [WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebSysDescription("WebControl_FailureTextStyle")]
        ...
        [UrlProperty, WebCategory("Links"), DefaultValue(""), WebSysDescription("Login_HelpPageIconUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [Localizable(true), WebSysDescription("ChangePassword_HelpPageText"), WebCategory("Links"), DefaultValue("")]
        ...
        [WebCategory("Links"), UrlProperty, DefaultValue(""), WebSysDescription("LoginControls_HelpPageUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [DefaultValue((string) null), WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("LoginControls_LabelStyle")]
        ...
        [WebCategory("Appearance"), UrlProperty, DefaultValue(""), WebSysDescription("Login_LoginButtonImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [DefaultValue((string) null), WebSysDescription("Login_LoginButtonStyle"), WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebCategory("Data"), DefaultValue(""), Themeable(false), WebSysDescription("MembershipProvider_Name")]
        ...
        [WebSysDefaultValue("LoginControls_DefaultPasswordLabelText"), Localizable(true), WebCategory("Appearance"), WebSysDescription("LoginControls_PasswordLabelText")]
        ...
        [DefaultValue(""), WebCategory("Links"), UrlProperty, WebSysDescription("Login_PasswordRecoveryIconUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [WebSysDescription("ChangePassword_PasswordRecoveryText"), Localizable(true), WebCategory("Links"), DefaultValue("")]
        ...
        [WebCategory("Links"), UrlProperty, DefaultValue(""), WebSysDescription("Login_PasswordRecoveryUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [Localizable(true), WebCategory("Appearance"), WebSysDefaultValue("Login_DefaultRememberMeText"), WebSysDescription("Login_RememberMeText")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), NotifyParentProperty(true), WebSysDescription("LoginControls_TextBoxStyle")]
        ...
        [DefaultValue((string) null), WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("LoginControls_TitleTextStyle"), NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Appearance"), Localizable(true), WebSysDefaultValue("Login_DefaultUserNameLabelText"), WebSysDescription("LoginControls_UserNameLabelText")]
        ...
        [Localizable(true), WebCategory("Validation"), WebSysDefaultValue("Login_DefaultUserNameRequiredErrorMessage"), WebSysDescription("ChangePassword_UserNameRequiredErrorMessage")]
        ...
        [WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("Login_ValidatorTextStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), DefaultValue((string) null)]
        ...
        internal sealed class LoginContainer : LoginUtil.GenericContainer<Login>
        {
            ...
            {
                get => 
                    this._passwordRecoveryLinkSeparator;
                set
                {
        ...
        private sealed class LoginTemplate : ITemplate
        {
            ...
            private void LayoutHorizontalTextOnLeft(Login.LoginContainer loginContainer)
            {
                ...
                cell = new TableCell {
                    ColumnSpan = 6,
                    HorizontalAlign = HorizontalAlign.Center,
                    Controls = { loginContainer.Instruction }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                row = new LoginUtil.DisappearingTableRow();
                ...
                row.Cells.Add(cell);
                cell = new TableCell {
                    Controls = { loginContainer.RememberMeCheckBox }
                };
                row.Cells.Add(cell);
                cell = new TableCell {
                    Controls = { 
                ...
                cell = new TableCell {
                    ColumnSpan = 6,
                    Controls = { loginContainer.FailureTextLabel }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                row = new LoginUtil.DisappearingTableRow();
                ...
                loginContainer.BorderTable = child;
                loginContainer.Controls.Add(child);
            }
