namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.BaseDataBoundControlDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultProperty("DataSourceID"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public abstract class BaseDataBoundControl : WebControl
    {
        ...
        [Bindable(true), Themeable(false), DefaultValue((string) null), WebSysDescription("BaseDataBoundControl_DataSource"), WebCategory("Data"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Themeable(false), WebSysDescription("BaseDataBoundControl_DataSourceID"), DefaultValue(""), WebCategory("Data")]
