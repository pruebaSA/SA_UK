namespace System.Web.UI.WebControls
{
    ...
    [ToolboxItem(false), TypeConverter(typeof(EmptyStringExpandableObjectConverter)), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class Style : Component, IStateManager
    {
        ...
        [NotifyParentProperty(true), TypeConverter(typeof(WebColorConverter)), WebCategory("Appearance"), DefaultValue(typeof(Color), ""), WebSysDescription("Style_BackColor")]
        ...
        [WebCategory("Appearance"), WebSysDescription("Style_BorderColor"), NotifyParentProperty(true), TypeConverter(typeof(WebColorConverter)), DefaultValue(typeof(Color), "")]
        ...
        [DefaultValue(0), WebSysDescription("Style_BorderStyle"), NotifyParentProperty(true), WebCategory("Appearance")]
        ...
        [NotifyParentProperty(true), WebSysDescription("Style_CSSClass"), CssClassProperty, DefaultValue(""), WebCategory("Appearance")]
        ...
        [NotifyParentProperty(true), WebCategory("Appearance"), WebSysDescription("Style_Font"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [NotifyParentProperty(true), WebSysDescription("Style_ForeColor"), WebCategory("Appearance"), TypeConverter(typeof(WebColorConverter)), DefaultValue(typeof(Color), "")]
        ...
        [WebCategory("Layout"), NotifyParentProperty(true), DefaultValue(typeof(Unit), ""), WebSysDescription("Style_Height")]
        public Unit Height
        {
            get
            {
        ...
        [NotifyParentProperty(true), WebCategory("Layout"), DefaultValue(typeof(Unit), ""), WebSysDescription("Style_Width")]
        public Unit Width
        {
            get
            {
