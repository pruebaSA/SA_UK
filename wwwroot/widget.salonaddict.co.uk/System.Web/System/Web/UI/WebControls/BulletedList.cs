namespace System.Web.UI.WebControls
{
    ...
    [SupportsEventValidation, DefaultEvent("Click"), Designer("System.Web.UI.Design.WebControls.BulletedListDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultProperty("BulletStyle"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class BulletedList : ListControl, IPostBackEventHandler
    {
        ...
        [WebSysDescription("BulletedList_BulletImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(""), UrlProperty, WebCategory("Appearance")]
        ...
        [WebSysDescription("BulletedList_BulletStyle"), DefaultValue(0), WebCategory("Appearance")]
        ...
        [WebSysDescription("BulletedList_BulletedListDisplayMode"), DefaultValue(0), WebCategory("Behavior")]
        ...
        [DefaultValue(""), WebCategory("Behavior"), WebSysDescription("BulletedList_Target"), TypeConverter(typeof(TargetConverter))]
