namespace System.Web.UI.WebControls
{
    ...
    [ParseChildren(true, "ChildNodes"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class TreeNode : IStateManager, ICloneable
    {
        ...
        internal bool GetEffectiveShowCheckBox() => 
            this.GetEffectiveShowCheckBox(this.GetTreeNodeType());
        ...
        internal bool CheckedSet =>
            (this.ViewState["Checked"] != null);

        [MergableProperty(false), PersistenceMode(PersistenceMode.InnerDefaultProperty), Browsable(false), DefaultValue((string) null)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(""), Browsable(false)]
        ...
        [DefaultValue(""), Localizable(true), WebSysDescription("TreeNode_ImageToolTip")]
        ...
        [Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebSysDescription("TreeNode_ImageUrl"), DefaultValue(""), UrlProperty]
        ...
        [DefaultValue(""), UrlProperty, WebSysDescription("TreeNode_NavigateUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [WebSysDescription("TreeNode_SelectAction"), DefaultValue(0)]
        ...
        [WebSysDescription("TreeNode_Selected"), DefaultValue(false)]
        ...
        [Localizable(true), WebSysDescription("TreeNode_Text"), DefaultValue("")]
        public string Text
        {
            get
            {
        ...
        [Localizable(true), WebSysDescription("TreeNode_ToolTip"), DefaultValue("")]
        ...
        [DefaultValue(""), Localizable(true), WebSysDescription("TreeNode_Value")]
        public string Value
        {
            get
            {
