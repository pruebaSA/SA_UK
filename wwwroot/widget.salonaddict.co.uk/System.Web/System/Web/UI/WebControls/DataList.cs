namespace System.Web.UI.WebControls
{
    ...
    [Editor("System.Web.UI.Design.WebControls.DataListComponentEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(ComponentEditor)), Designer("System.Web.UI.Design.WebControls.DataListDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ControlValueProperty("SelectedValue"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class DataList : BaseDataList, INamingContainer, IRepeatInfoUser
    {
        ...
        [WebSysDescription("DataList_OnEditCommand"), WebCategory("Action")]
        ...
        [WebSysDescription("DataList_OnItemCommand"), WebCategory("Action")]
        ...
        [WebCategory("Action"), WebSysDescription("DataList_OnUpdateCommand")]
        ...
        protected virtual DataListItem CreateItem(int itemIndex, ListItemType itemType) => 
            new DataListItem(itemIndex, itemType);
        ...
        [WebSysDescription("DataList_EditItemStyle"), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [TemplateContainer(typeof(DataListItem)), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DataList_EditItemTemplate"), DefaultValue((string) null), Browsable(false)]
        ...
        [WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DataControls_FooterStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DataControls_HeaderStyle"), NotifyParentProperty(true), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [TemplateContainer(typeof(DataListItem)), Browsable(false), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DataList_HeaderTemplate")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), WebSysDescription("DataList_Items")]
        ...
        [WebCategory("Styles"), WebSysDescription("DataList_ItemStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebSysDescription("DataList_ItemTemplate"), Browsable(false), TemplateContainer(typeof(DataListItem)), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DefaultValue(0), WebCategory("Layout"), WebSysDescription("DataList_RepeatColumns")]
        ...
        [WebCategory("Layout"), DefaultValue(0), WebSysDescription("WebControl_RepeatLayout")]
        ...
        [DefaultValue(-1), WebSysDescription("WebControl_SelectedIndex"), Bindable(true)]
        ...
        [WebSysDescription("DataList_SelectedItem"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebSysDescription("DataList_SelectedItemStyle"), WebCategory("Styles"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebSysDescription("DataList_SelectedItemTemplate"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), Browsable(false), TemplateContainer(typeof(DataListItem))]
        ...
        [TemplateContainer(typeof(DataListItem)), Browsable(false), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DataList_SeparatorTemplate")]
        ...
        [DefaultValue(true), WebCategory("Appearance"), WebSysDescription("DataControls_ShowFooter")]
        ...
        bool IRepeatInfoUser.HasFooter =>
            (this.ShowFooter && (this.footerTemplate != null));
