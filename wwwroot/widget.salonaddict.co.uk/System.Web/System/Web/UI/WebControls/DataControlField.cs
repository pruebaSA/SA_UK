namespace System.Web.UI.WebControls
{
    ...
    [TypeConverter(typeof(ExpandableObjectConverter)), DefaultProperty("HeaderText"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public abstract class DataControlField : IStateManager, IDataSourceViewSchemaAccessor
    {
        ...
        [WebCategory("Accessibility"), Localizable(true), WebSysDescription("DataControlField_AccessibleHeaderText"), DefaultValue("")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), DefaultValue((string) null), WebSysDescription("DataControlField_ControlStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        protected bool DesignMode =>
            ((this._control != null) && this._control.DesignMode);

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), WebSysDescription("DataControlField_FooterStyle"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DefaultValue(""), Localizable(true), WebCategory("Appearance"), WebSysDescription("DataControlField_FooterText")]
        ...
        [DefaultValue(""), WebSysDescription("DataControlField_HeaderImageUrl"), WebCategory("Appearance"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), WebSysDescription("DataControlField_HeaderStyle")]
        ...
        [Localizable(true), WebCategory("Appearance"), DefaultValue(""), WebSysDescription("DataControlField_HeaderText")]
        ...
        [WebSysDescription("DataControlField_InsertVisible"), WebCategory("Behavior"), DefaultValue(true)]
        ...
        [DefaultValue((string) null), WebCategory("Styles"), WebSysDescription("DataControlField_ItemStyle"), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Behavior"), DefaultValue(true), WebSysDescription("DataControlField_ShowHeader")]
        ...
        [WebSysDescription("DataControlField_SortExpression"), WebCategory("Behavior"), DefaultValue(""), TypeConverter("System.Web.UI.Design.DataSourceViewSchemaConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
        ...
        [DefaultValue(true), WebSysDescription("DataControlField_Visible"), WebCategory("Behavior")]
        public bool Visible
        {
            get
            {
