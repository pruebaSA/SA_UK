namespace System.Web.UI.WebControls
{
    ...
    [ToolboxData("<{0}:RangeValidator runat=\"server\" ErrorMessage=\"RangeValidator\"></{0}:RangeValidator>"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class RangeValidator : BaseCompareValidator
    {
        ...
        [WebCategory("Behavior"), DefaultValue(""), WebSysDescription("RangeValidator_MaximumValue"), Themeable(false)]
        ...
        [Themeable(false), WebCategory("Behavior"), WebSysDescription("RangeValidator_MinmumValue"), DefaultValue("")]
