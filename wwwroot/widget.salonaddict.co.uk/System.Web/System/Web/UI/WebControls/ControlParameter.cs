namespace System.Web.UI.WebControls
{
    ...
    [DefaultProperty("ControlID"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class ControlParameter : Parameter
    {
        ...
        [WebCategory("Control"), WebSysDescription("ControlParameter_ControlID"), RefreshProperties(RefreshProperties.All), TypeConverter(typeof(ControlIDConverter)), DefaultValue(""), IDReferenceProperty]
        ...
        [DefaultValue(""), WebCategory("Control"), WebSysDescription("ControlParameter_PropertyName"), TypeConverter(typeof(ControlPropertyNameConverter))]
