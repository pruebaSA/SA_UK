namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.HierarchicalDataBoundControlDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public abstract class HierarchicalDataBoundControl : BaseDataBoundControl
    {
        ...
        protected override void PerformSelect()
        {
            ...
            {
                HierarchicalDataBoundControlAdapter adapter = base._adapter as HierarchicalDataBoundControlAdapter;
                if (adapter != null)
                {
