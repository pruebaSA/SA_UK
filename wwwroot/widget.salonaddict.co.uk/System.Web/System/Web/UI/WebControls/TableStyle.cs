namespace System.Web.UI.WebControls
{
    ...
    public class TableStyle : Style
    {
        ...
        [WebSysDescription("TableStyle_BackImageUrl"), NotifyParentProperty(true), UrlProperty, WebCategory("Appearance"), DefaultValue("")]
        ...
        [WebCategory("Appearance"), DefaultValue(-1), WebSysDescription("TableStyle_CellPadding"), NotifyParentProperty(true)]
        ...
        [WebSysDescription("TableStyle_CellSpacing"), WebCategory("Appearance"), NotifyParentProperty(true), DefaultValue(-1)]
        ...
        [NotifyParentProperty(true), WebCategory("Appearance"), WebSysDescription("TableStyle_GridLines"), DefaultValue(0)]
        ...
        [DefaultValue(0), WebCategory("Layout"), WebSysDescription("TableStyle_HorizontalAlign"), NotifyParentProperty(true)]
