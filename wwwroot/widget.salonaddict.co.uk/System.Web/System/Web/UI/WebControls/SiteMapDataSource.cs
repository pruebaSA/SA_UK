namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.SiteMapDataSourceDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ParseChildren(true), WebSysDescription("SiteMapDataSource_Description"), WebSysDisplayName("SiteMapDataSource_DisplayName"), PersistChildren(false), ToolboxBitmap(typeof(SiteMapDataSource)), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class SiteMapDataSource : HierarchicalDataSourceControl, IDataSource, IListSource
    {
        ...
        [WebSysDescription("SiteMapDataSource_ContainsListCollection"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual bool ContainsListCollection =>
            ListSourceHelper.ContainsListCollection(this);

        [WebSysDescription("SiteMapDataSource_Provider"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [DefaultValue(""), WebCategory("Behavior"), WebSysDescription("SiteMapDataSource_SiteMapProvider")]
        ...
        [WebSysDescription("SiteMapDataSource_StartFromCurrentNode"), DefaultValue(false), WebCategory("Behavior")]
        ...
        [WebCategory("Behavior"), DefaultValue(0), WebSysDescription("SiteMapDataSource_StartingNodeOffset")]
        ...
        [Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebCategory("Behavior"), WebSysDescription("SiteMapDataSource_StartingNodeUrl"), DefaultValue(""), UrlProperty]
