namespace System.Web.UI.WebControls
{
    ...
    [ParseChildren(true, "ChildItems"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class MenuItem : IStateManager, ICloneable
    {
        ...
        [Browsable(false), PersistenceMode(PersistenceMode.InnerDefaultProperty), MergableProperty(false)]
        ...
        [WebSysDescription("MenuItem_Enabled"), Browsable(true), DefaultValue(true)]
        public bool Enabled
        {
            get
            {
        ...
        [DefaultValue(""), WebSysDescription("MenuItem_ImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        internal bool IsEnabled =>
            (this.IsEnabledNoOwner && this.Owner.IsEnabled);
        ...
        [DefaultValue(""), UrlProperty, WebSysDescription("MenuItem_NavigateUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [DefaultValue(""), UrlProperty, Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebSysDescription("MenuItem_PopOutImageUrl")]
        ...
        [WebSysDescription("MenuItem_Selectable"), Browsable(true), DefaultValue(true)]
        ...
        [DefaultValue(false), WebSysDescription("MenuItem_Selected"), Browsable(true)]
        ...
        [UrlProperty, WebSysDescription("MenuItem_SeparatorImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue("")]
        ...
        [DefaultValue(""), WebSysDescription("MenuItem_Text"), Localizable(true)]
        public string Text
        {
            get
            {
        ...
        [WebSysDescription("MenuItem_ToolTip"), DefaultValue(""), Localizable(true)]
        ...
        [DefaultValue(""), Localizable(true), WebSysDescription("MenuItem_Value")]
        public string Value
        {
            get
            {
