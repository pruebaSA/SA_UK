namespace System.Web.UI.WebControls
{
    ...
    [Editor("System.Web.UI.Design.WebControls.ParameterCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class ParameterCollection : StateManagedCollection
    {
        ...
        public int Add(Parameter parameter) => 
            ((IList) this).Add(parameter);

        public int Add(string name, string value) => 
            ((IList) this).Add(new Parameter(name, TypeCode.Empty, value));

        public int Add(string name, DbType dbType, string value) => 
            ((IList) this).Add(new Parameter(name, dbType, value));

        public int Add(string name, TypeCode type, string value) => 
            ((IList) this).Add(new Parameter(name, type, value));
