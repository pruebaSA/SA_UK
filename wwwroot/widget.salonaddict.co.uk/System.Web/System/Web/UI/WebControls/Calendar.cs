namespace System.Web.UI.WebControls
{
    ...
    [ControlValueProperty("SelectedDate", typeof(DateTime), "1/1/0001"), Designer("System.Web.UI.Design.WebControls.CalendarDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultProperty("SelectedDate"), SupportsEventValidation, DefaultEvent("SelectionChanged"), DataBindingHandler("System.Web.UI.Design.WebControls.CalendarDataBindingHandler, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class Calendar : WebControl, IPostBackEventHandler
    {
        ...
        protected override ControlCollection CreateControlCollection() => 
            new InternalControlCollection(this);
        ...
        private bool IsMaxSupportedYearMonth(DateTime date) => 
            this.IsTheSameYearMonth(this.maxSupportedDate, date);

        private bool IsMinSupportedYearMonth(DateTime date) => 
            this.IsTheSameYearMonth(this.minSupportedDate, date);

        private bool IsTheSameYearMonth(DateTime date1, DateTime date2) => 
            (((this.threadCalendar.GetEra(date1) == this.threadCalendar.GetEra(date2)) && (this.threadCalendar.GetYear(date1) == this.threadCalendar.GetYear(date2))) && (this.threadCalendar.GetMonth(date1) == this.threadCalendar.GetMonth(date2)));
        ...
        [Localizable(true), WebCategory("Accessibility"), DefaultValue(""), WebSysDescription("Calendar_Caption")]
        ...
        [WebCategory("Layout"), WebSysDescription("Calendar_CellPadding"), DefaultValue(2)]
        ...
        [WebSysDescription("Calendar_CellSpacing"), WebCategory("Layout"), DefaultValue(0)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), WebSysDescription("Calendar_DayHeaderStyle"), NotifyParentProperty(true)]
        ...
        [WebCategory("Appearance"), WebSysDescription("Calendar_DayNameFormat"), DefaultValue(1)]
        ...
        [WebCategory("Styles"), DefaultValue((string) null), WebSysDescription("Calendar_DayStyle"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebSysDescription("Calendar_FirstDayOfWeek"), WebCategory("Appearance"), DefaultValue(7)]
        ...
        [Localizable(true), WebSysDescription("Calendar_NextMonthText"), DefaultValue("&gt;"), WebCategory("Appearance")]
        ...
        [DefaultValue(0), WebCategory("Appearance"), WebSysDescription("Calendar_NextPrevFormat")]
        ...
        [WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("Calendar_NextPrevStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        [DefaultValue((string) null), NotifyParentProperty(true), WebSysDescription("Calendar_OtherMonthDayStyle"), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Appearance"), WebSysDescription("Calendar_PrevMonthText"), DefaultValue("&lt;"), Localizable(true)]
        ...
        [DefaultValue(typeof(DateTime), "1/1/0001"), WebSysDescription("Calendar_SelectedDate"), Bindable(true, BindingDirection.TwoWay)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("Calendar_SelectedDates"), Browsable(false)]
        ...
        [NotifyParentProperty(true), DefaultValue((string) null), WebSysDescription("Calendar_SelectedDayStyle"), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles")]
        ...
        [WebSysDescription("Calendar_SelectionMode"), DefaultValue(1), WebCategory("Behavior")]
        ...
        [Localizable(true), DefaultValue("&gt;&gt;"), WebCategory("Appearance"), WebSysDescription("Calendar_SelectMonthText")]
        ...
        [WebCategory("Styles"), WebSysDescription("Calendar_SelectorStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebCategory("Appearance"), WebSysDescription("Calendar_SelectWeekText"), Localizable(true), DefaultValue("&gt;")]
        ...
        [WebCategory("Appearance"), DefaultValue(true), WebSysDescription("Calendar_ShowDayHeader")]
        ...
        [WebSysDescription("Calendar_ShowNextPrevMonth"), WebCategory("Appearance"), DefaultValue(true)]
        ...
        [WebCategory("Appearance"), DefaultValue(true), WebSysDescription("Calendar_ShowTitle")]
        ...
        [WebCategory("Appearance"), WebSysDescription("Calendar_TitleFormat"), DefaultValue(1)]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), NotifyParentProperty(true), WebCategory("Styles"), WebSysDescription("Calendar_TitleStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Styles"), WebSysDescription("Calendar_TodayDayStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), NotifyParentProperty(true)]
        ...
        [DefaultValue(typeof(DateTime), "1/1/0001"), WebSysDescription("Calendar_VisibleDate"), Bindable(true)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebSysDescription("Calendar_WeekendDayStyle"), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), NotifyParentProperty(true)]
