namespace System.Web.UI.WebControls
{
    ...
    [Bindable(false), DefaultEvent("ChangedPassword"), Designer("System.Web.UI.Design.WebControls.ChangePasswordDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class ChangePassword : CompositeControl, INamingContainer
    {
        ...
        [WebSysDescription("ChangePassword_ChangingPassword"), WebCategory("Action")]
        ...
        [WebCategory("Action"), WebSysDescription("ChangePassword_ContinueButtonClick")]
        ...
        [WebCategory("Action"), WebSysDescription("ChangePassword_SendMailError")]
        ...
        [DefaultValue(1), WebSysDescription("Login_BorderPadding"), WebCategory("Appearance")]
        ...
        [WebSysDescription("ChangePassword_CancelButtonImageUrl"), UrlProperty, DefaultValue(""), WebCategory("Appearance"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("ChangePassword_CancelButtonStyle"), WebCategory("Styles")]
        ...
        [Localizable(true), WebSysDescription("ChangePassword_CancelButtonText"), WebCategory("Appearance"), WebSysDefaultValue("ChangePassword_DefaultCancelButtonText")]
        ...
        [DefaultValue(0), WebCategory("Appearance"), WebSysDescription("ChangePassword_CancelButtonType")]
        ...
        [WebCategory("Behavior"), UrlProperty, DefaultValue(""), WebSysDescription("ChangePassword_CancelDestinationPageUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), Themeable(false)]
        ...
        [Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebCategory("Appearance"), DefaultValue(""), WebSysDescription("ChangePassword_ChangePasswordButtonImageUrl"), UrlProperty]
        ...
        [WebSysDescription("ChangePassword_ChangePasswordButtonStyle"), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebCategory("Appearance"), Localizable(true), WebSysDefaultValue("ChangePassword_DefaultChangePasswordButtonText"), WebSysDescription("ChangePassword_ChangePasswordButtonText")]
        ...
        [WebCategory("Appearance"), WebSysDescription("ChangePassword_ChangePasswordButtonType"), DefaultValue(0)]
        ...
        [Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(ChangePassword))]
        public virtual ITemplate ChangePasswordTemplate
        {
            get => 
                this._changePasswordTemplate;
            set
            {
        ...
        [WebSysDefaultValue("ChangePassword_DefaultChangePasswordTitleText"), Localizable(true), WebCategory("Appearance"), WebSysDescription("LoginControls_TitleText")]
        ...
        [Themeable(false), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Filterable(false)]
        ...
        [Localizable(true), WebSysDescription("ChangePassword_ConfirmNewPasswordLabelText"), WebCategory("Appearance"), WebSysDefaultValue("ChangePassword_DefaultConfirmNewPasswordLabelText")]
        ...
        [DefaultValue(""), UrlProperty, WebCategory("Appearance"), WebSysDescription("ChangePassword_ContinueButtonImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [WebCategory("Styles"), NotifyParentProperty(true), WebSysDescription("ChangePassword_ContinueButtonStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebSysDescription("ChangePassword_ContinueButtonText"), WebSysDefaultValue("ChangePassword_DefaultContinueButtonText"), Localizable(true), WebCategory("Appearance")]
        ...
        [WebCategory("Behavior"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(""), WebSysDescription("LoginControls_ContinueDestinationPageUrl"), Themeable(false), UrlProperty]
        ...
        [WebCategory("Links"), DefaultValue(""), WebSysDescription("ChangePassword_CreateUserIconUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [Localizable(true), WebCategory("Links"), DefaultValue(""), WebSysDescription("ChangePassword_CreateUserText")]
        ...
        [DefaultValue(""), WebCategory("Links"), WebSysDescription("ChangePassword_CreateUserUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [Browsable(false), Themeable(false), Filterable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(""), WebSysDescription("LoginControls_EditProfileIconUrl"), WebCategory("Links"), UrlProperty]
        ...
        [Localizable(true), WebCategory("Links"), DefaultValue(""), WebSysDescription("ChangePassword_EditProfileText")]
        ...
        [DefaultValue(""), WebCategory("Links"), WebSysDescription("ChangePassword_EditProfileUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [WebSysDescription("WebControl_FailureTextStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [DefaultValue(""), WebCategory("Links"), WebSysDescription("LoginControls_HelpPageIconUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [WebCategory("Links"), DefaultValue(""), WebSysDescription("LoginControls_HelpPageUrl"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("LoginControls_LabelStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebCategory("Styles")]
        ...
        [Themeable(false), WebSysDescription("ChangePassword_MailDefinition"), WebCategory("Behavior"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [Themeable(false), WebCategory("Data"), WebSysDescription("MembershipProvider_Name"), DefaultValue("")]
        ...
        [WebCategory("Appearance"), WebSysDefaultValue("ChangePassword_DefaultNewPasswordLabelText"), WebSysDescription("ChangePassword_NewPasswordLabelText"), Localizable(true)]
        ...
        [WebSysDefaultValue(""), WebCategory("Validation"), WebSysDescription("ChangePassword_NewPasswordRegularExpression")]
        ...
        [WebSysDefaultValue("Password_InvalidPasswordErrorMessage"), WebSysDescription("ChangePassword_NewPasswordRegularExpressionErrorMessage"), WebCategory("Validation")]
        ...
        [WebCategory("Validation"), WebSysDefaultValue("ChangePassword_DefaultNewPasswordRequiredErrorMessage"), WebSysDescription("ChangePassword_NewPasswordRequiredErrorMessage"), Localizable(true)]
        ...
        [DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("ChangePassword_PasswordHintStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebCategory("Styles")]
        ...
        [WebSysDescription("ChangePassword_PasswordHintText"), Localizable(true), WebCategory("Appearance"), DefaultValue("")]
        ...
        [Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty, WebCategory("Links"), DefaultValue(""), WebSysDescription("ChangePassword_PasswordRecoveryIconUrl")]
        ...
        [Localizable(true), DefaultValue(""), WebSysDescription("ChangePassword_PasswordRecoveryText"), WebCategory("Links")]
        ...
        [Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty, WebCategory("Links"), DefaultValue(""), WebSysDescription("ChangePassword_PasswordRecoveryUrl")]
        ...
        [WebSysDefaultValue("ChangePassword_DefaultPasswordRequiredErrorMessage"), WebSysDescription("ChangePassword_PasswordRequiredErrorMessage"), WebCategory("Validation"), Localizable(true)]
        ...
        private bool RegExpEnabled =>
            (this.NewPasswordRegularExpression.Length > 0);

        [WebCategory("Behavior"), Editor("System.Web.UI.Design.UrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), Themeable(false), DefaultValue(""), WebSysDescription("LoginControls_SuccessPageUrl"), UrlProperty]
        ...
        [TemplateContainer(typeof(ChangePassword)), Browsable(false), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebCategory("Appearance"), WebSysDescription("ChangePassword_SuccessText"), WebSysDefaultValue("ChangePassword_DefaultSuccessText"), Localizable(true)]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), WebSysDescription("ChangePassword_SuccessTextStyle"), WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        [WebSysDescription("ChangePassword_SuccessTitleText"), Localizable(true), WebCategory("Appearance"), WebSysDefaultValue("ChangePassword_DefaultSuccessTitleText")]
        ...
        [WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("LoginControls_TextBoxStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), NotifyParentProperty(true), WebCategory("Styles"), WebSysDescription("LoginControls_TitleTextStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebCategory("Appearance"), DefaultValue(""), WebSysDescription("UserName_InitialValue")]
        ...
        [WebCategory("Validation"), WebSysDefaultValue("ChangePassword_DefaultUserNameRequiredErrorMessage"), WebSysDescription("ChangePassword_UserNameRequiredErrorMessage"), Localizable(true)]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("ChangePassword_ValidatorTextStyle"), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        internal sealed class ChangePasswordContainer : LoginUtil.GenericContainer<ChangePassword>, INonBindingContainer, INamingContainer
        {
            ...
            {
                get => 
                    this._changePasswordImageButton;
                set
                {
            ...
            {
                get => 
                    this._changePasswordLinkButton;
                set
                {
            ...
            {
                get => 
                    this._changePasswordPushButton;
                set
                {
            ...
            {
                get => 
                    this._confirmNewPasswordRequired;
                set
                {
            ...
            protected override bool ConvertingToTemplate =>
                base.Owner.ConvertingToTemplate;
            ...
            {
                get => 
                    this._editProfileLinkSeparator;
                set
                {
            ...
            {
                get => 
                    this._newPasswordCompareValidator;
                set
                {
        ...
        private sealed class DefaultChangePasswordTemplate : ITemplate
        {
            ...
            private void LayoutControls(ChangePassword.ChangePasswordContainer container)
            {
                ...
                cell = new TableCell {
                    ColumnSpan = 2,
                    HorizontalAlign = HorizontalAlign.Center,
                    Controls = { container.Instruction }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                row = new LoginUtil.DisappearingTableRow();
                ...
                cell = new TableCell {
                    HorizontalAlign = HorizontalAlign.Right,
                    Controls = { container.CurrentPasswordLabel }
                };
                if (this._owner.ConvertingToTemplate)
                {
                ...
                cell = new TableCell {
                    HorizontalAlign = HorizontalAlign.Right,
                    Controls = { container.NewPasswordLabel }
                };
                if (this._owner.ConvertingToTemplate)
                {
                ...
                row.Cells.Add(cell);
                cell = new TableCell {
                    Controls = { container.PasswordHintLabel }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                ...
                cell = new TableCell {
                    HorizontalAlign = HorizontalAlign.Right,
                    Controls = { container.ConfirmNewPasswordLabel }
                };
                if (this._owner.ConvertingToTemplate)
                {
                ...
                cell = new TableCell {
                    HorizontalAlign = HorizontalAlign.Center,
                    ColumnSpan = 2,
                    Controls = { container.NewPasswordCompareValidator }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                if (this._owner.RegExpEnabled)
                {
                    ...
                    cell = new TableCell {
                        HorizontalAlign = HorizontalAlign.Center,
                        ColumnSpan = 2,
                        Controls = { container.RegExpValidator }
                    };
                    row.Cells.Add(cell);
                    table.Rows.Add(row);
                }
                ...
                cell = new TableCell {
                    HorizontalAlign = HorizontalAlign.Center,
                    ColumnSpan = 2,
                    Controls = { container.FailureTextLabel }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                row = new LoginUtil.DisappearingTableRow();
                ...
                row.Cells.Add(cell);
                table.Rows.Add(row);
                Table child = LoginUtil.CreateChildTable(this._owner.ConvertingToTemplate);
                row = new TableRow();
                cell = new TableCell {
                    Controls = { table }
                };
        ...
        private sealed class DefaultSuccessTemplate : ITemplate
        {
            ...
            private void LayoutControls(ChangePassword.SuccessContainer successContainer)
            {
                ...
                TableCell cell = new TableCell {
                    ColumnSpan = 2,
                    HorizontalAlign = HorizontalAlign.Center,
                    Controls = { successContainer.Title }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                row = new LoginUtil.DisappearingTableRow();
                cell = new TableCell {
                    Controls = { successContainer.SuccessTextLabel }
                };
                row.Cells.Add(cell);
                table.Rows.Add(row);
                row = new LoginUtil.DisappearingTableRow();
                ...
                successContainer.BorderTable = child;
                successContainer.Controls.Add(child);
            }
