namespace System.Web.UI.WebControls
{
    ...
    [ParseChildren(true, "Text"), ControlBuilder(typeof(ListItemControlBuilder)), TypeConverter(typeof(ExpandableObjectConverter)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class ListItem : IStateManager, IParserAccessor, IAttributeAccessor
    {
        ...
        public override int GetHashCode() => 
            HashCodeCombiner.CombineHashCodes(this.Value.GetHashCode(), this.Text.GetHashCode());
        ...
        [TypeConverter(typeof(MinimizableAttributeTypeConverter)), DefaultValue(false)]
        ...
        [DefaultValue(""), Localizable(true), PersistenceMode(PersistenceMode.EncodedInnerDefaultProperty)]
        public string Text
        {
            get
            {
