namespace System.Web.UI.WebControls
{
    ...
    [ParseChildren(true, "Items"), Designer("System.Web.UI.Design.WebControls.ListControlDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ControlValueProperty("SelectedValue"), DataBindingHandler("System.Web.UI.Design.WebControls.ListControlDataBindingHandler, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultEvent("SelectedIndexChanged"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public abstract class ListControl : DataBoundControl, IEditableTextControl, ITextControl
    {
        ...
        [DefaultValue(false), WebSysDescription("ListControl_AppendDataBoundItems"), WebCategory("Behavior"), Themeable(false)]
        ...
        [WebCategory("Behavior"), DefaultValue(false), Themeable(false), WebSysDescription("ListControl_AutoPostBack")]
        ...
        [WebSysDescription("AutoPostBackControl_CausesValidation"), DefaultValue(false), Themeable(false), WebCategory("Behavior")]
        ...
        [WebSysDescription("ListControl_DataTextFormatString"), DefaultValue(""), WebCategory("Data"), Themeable(false)]
        ...
        [Themeable(false), DefaultValue(""), WebCategory("Data"), WebSysDescription("ListControl_DataValueField")]
        ...
        [DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerDefaultProperty), WebCategory("Default"), Editor("System.Web.UI.Design.WebControls.ListItemsCollectionEditor,System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), MergableProperty(false), WebSysDescription("ListControl_Items")]
        ...
        [Browsable(false), Themeable(false), WebCategory("Behavior"), WebSysDescription("WebControl_SelectedIndex"), Bindable(true), DefaultValue(0), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [WebCategory("Behavior"), DefaultValue((string) null), WebSysDescription("ListControl_SelectedItem"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [Themeable(false), WebCategory("Behavior"), WebSysDescription("ListControl_SelectedValue"), Bindable(true, BindingDirection.TwoWay), Browsable(false), DefaultValue(""), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(""), WebSysDescription("ListControl_Text"), WebCategory("Behavior"), Themeable(false)]
