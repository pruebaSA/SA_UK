namespace System.Web.UI.WebControls
{
    ...
    public class ObjectDataSourceView : DataSourceView, IStateManager
    {
        ...
        protected internal override IEnumerable ExecuteSelect(DataSourceSelectArguments arguments)
        {
            ...
            if (this.EnablePaging)
            {
                ...
                IDictionary source = new OrderedDictionary(StringComparer.OrdinalIgnoreCase) {
                    [maximumRowsParameterName] = arguments.MaximumRows,
                    [startRowIndexParameterName] = arguments.StartRowIndex
                };
        ...
        public override bool CanDelete =>
            (this.DeleteMethod.Length != 0);

        public override bool CanInsert =>
            (this.InsertMethod.Length != 0);
