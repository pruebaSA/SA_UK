namespace System.Web.UI.WebControls
{
    ...
    public sealed class DataGridPagerStyle : TableItemStyle
    {
        ...
        [DefaultValue(0), WebSysDescription("DataGridPagerStyle_Mode"), WebCategory("Appearance"), NotifyParentProperty(true)]
        ...
        [WebCategory("Appearance"), Localizable(true), DefaultValue("&gt;"), WebSysDescription("PagerSettings_NextPageText"), NotifyParentProperty(true)]
        ...
        [WebSysDescription("DataGridPagerStyle_PageButtonCount"), DefaultValue(10), NotifyParentProperty(true), WebCategory("Behavior")]
        ...
        [WebSysDescription("DataGridPagerStyle_Position"), NotifyParentProperty(true), WebCategory("Layout"), DefaultValue(0)]
        ...
        [Localizable(true), WebSysDescription("PagerSettings_PreviousPageText"), WebCategory("Appearance"), DefaultValue("&lt;"), NotifyParentProperty(true)]
        ...
        [NotifyParentProperty(true), WebCategory("Appearance"), DefaultValue(true), WebSysDescription("DataGridPagerStyle_Visible")]
        public bool Visible
        {
            get
            {
