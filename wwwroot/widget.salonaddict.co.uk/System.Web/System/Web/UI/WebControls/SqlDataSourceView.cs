namespace System.Web.UI.WebControls
{
    ...
    public class SqlDataSourceView : DataSourceView, IStateManager
    {
        ...
        {
            get => 
                this._cancelSelectOnNullParameter;
            set
            {
        ...
        public override bool CanDelete =>
            (this.DeleteCommand.Length != 0);

        public override bool CanInsert =>
            (this.InsertCommand.Length != 0);
        ...
        public override bool CanUpdate =>
            (this.UpdateCommand.Length != 0);

        public ConflictOptions ConflictDetection
        {
            get => 
                this._conflictDetection;
            set
            {
        ...
        [Editor("System.Web.UI.Design.WebControls.ParameterCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("SqlDataSource_DeleteParameters")]
        ...
        [WebSysDescription("SqlDataSource_FilterParameters"), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), Editor("System.Web.UI.Design.WebControls.ParameterCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [DefaultValue((string) null), Editor("System.Web.UI.Design.WebControls.ParameterCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("SqlDataSource_InsertParameters")]
        ...
        [WebCategory("Data"), WebSysDescription("DataSource_OldValuesParameterFormatString"), DefaultValue("{0}")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), Editor("System.Web.UI.Design.WebControls.ParameterCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue((string) null), WebSysDescription("SqlDataSource_UpdateParameters")]
