namespace System.Web.UI.WebControls
{
    ...
    internal class ContentPlaceHolderBuilder : ControlBuilder
    {
        ...
        {
            MasterPage templateControl = base.TemplateControl as MasterPage;
            ContentPlaceHolder container = (ContentPlaceHolder) base.BuildObject();
            if (this.PageProvidesMatchingContent(templateControl))
            {
                ...
                current.TemplateControl = templateControl._ownerControl;
                try
                {
        ...
        private bool PageProvidesMatchingContent(MasterPage masterPage) => 
            (((masterPage != null) && (masterPage.ContentTemplates != null)) && masterPage.ContentTemplates.Contains(this._contentPlaceHolderID));
