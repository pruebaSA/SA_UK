namespace System.Web.UI.WebControls
{
    ...
    [Editor("System.Web.UI.Design.WebControls.ListItemsCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class ListItemCollection : IList, ICollection, IEnumerable, IStateManager
    {
        ...
        public IEnumerator GetEnumerator() => 
            this.listItems.GetEnumerator();

        public int IndexOf(ListItem item) => 
            this.listItems.IndexOf(item);
        ...
        bool IList.Contains(object item) => 
            this.Contains((ListItem) item);

        int IList.IndexOf(object item) => 
            this.IndexOf((ListItem) item);
        ...
        public int Count =>
            this.listItems.Count;

        public bool IsReadOnly =>
            this.listItems.IsReadOnly;

        public bool IsSynchronized =>
            this.listItems.IsSynchronized;
