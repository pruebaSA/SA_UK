namespace System.Web.UI.WebControls
{
    ...
    [DefaultEvent("ItemCommand"), PersistChildren(false), DefaultProperty("DataSource"), Designer("System.Web.UI.Design.WebControls.RepeaterDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ParseChildren(true), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class Repeater : Control, INamingContainer
    {
        ...
        protected virtual RepeaterItem CreateItem(int itemIndex, ListItemType itemType) => 
            new RepeaterItem(itemIndex, itemType);
        ...
        [DefaultValue(""), WebCategory("Data"), IDReferenceProperty(typeof(DataSourceControl)), WebSysDescription("BaseDataBoundControl_DataSourceID")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(RepeaterItem)), WebSysDescription("Repeater_FooterTemplate"), DefaultValue((string) null), Browsable(false)]
        ...
        [DefaultValue((string) null), Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(RepeaterItem)), WebSysDescription("WebControl_HeaderTemplate")]
        ...
        [WebSysDescription("Repeater_ItemTemplate"), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(RepeaterItem)), Browsable(false), DefaultValue((string) null)]
        ...
        [Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), WebSysDescription("Repeater_SeparatorTemplate"), TemplateContainer(typeof(RepeaterItem))]
