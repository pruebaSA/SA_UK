namespace System.Web.UI.WebControls
{
    ...
    [ParseChildren(true), SupportsEventValidation, NonVisualControl, ControlValueProperty("Value"), DefaultEvent("ValueChanged"), DefaultProperty("Value"), Designer("System.Web.UI.Design.WebControls.HiddenFieldDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), PersistChildren(false), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class HiddenField : Control, IPostBackDataHandler
    {
        ...
        [WebCategory("Behavior"), Bindable(true), DefaultValue(""), WebSysDescription("HiddenField_Value")]
