namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.FormViewDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ControlValueProperty("SelectedValue"), DefaultEvent("PageIndexChanging"), SupportsEventValidation, AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class FormView : CompositeDataBoundControl, IDataItemContainer, INamingContainer, IPostBackEventHandler, IPostBackContainer
    {
        ...
        [WebSysDescription("FormView_OnItemCommand"), WebCategory("Action")]
        ...
        [WebCategory("Behavior"), WebSysDescription("FormView_OnItemCreated")]
        ...
        [WebSysDescription("DataControls_OnItemDeleted"), WebCategory("Action")]
        ...
        [WebSysDescription("FormView_OnPageIndexChanged"), WebCategory("Action")]
        ...
        [WebSysDescription("FormView_AllowPaging"), WebCategory("Paging"), DefaultValue(false)]
        ...
        [Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebCategory("Appearance"), DefaultValue(""), UrlProperty, WebSysDescription("WebControl_BackImageUrl")]
        ...
        [Localizable(true), DefaultValue(""), WebCategory("Accessibility"), WebSysDescription("DataControls_Caption")]
        ...
        [DefaultValue(-1), WebCategory("Layout"), WebSysDescription("FormView_CellPadding")]
        ...
        [WebSysDescription("FormView_DataKey"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        ...
        [WebSysDescription("DataControls_DataKeyNames"), DefaultValue((string) null), Editor("System.Web.UI.Design.WebControls.DataFieldEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), TypeConverter(typeof(StringArrayConverter)), WebCategory("Data")]
        ...
        [DefaultValue(0), WebCategory("Behavior"), WebSysDescription("View_DefaultMode")]
        ...
        [Browsable(false), WebSysDescription("FormView_EditItemTemplate"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(FormView), BindingDirection.TwoWay)]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebSysDescription("View_EditRowStyle")]
        ...
        [NotifyParentProperty(true), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("View_EmptyDataRowStyle")]
        ...
        [Browsable(false), TemplateContainer(typeof(FormView)), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("View_EmptyDataTemplate")]
        ...
        [WebCategory("Behavior"), DefaultValue(false), WebSysDescription("DataBoundControl_EnableModelValidation")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), DefaultValue((string) null), WebSysDescription("FormView_FooterStyle"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [Browsable(false), WebSysDescription("FormView_FooterTemplate"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(FormView))]
        ...
        [Localizable(true), DefaultValue(""), WebCategory("Appearance"), WebSysDescription("View_FooterText")]
        ...
        [NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("WebControl_HeaderStyle"), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [WebSysDescription("WebControl_HeaderTemplate"), Browsable(false), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(FormView))]
        ...
        [DefaultValue((string) null), Browsable(false), WebSysDescription("FormView_InsertItemTemplate"), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(FormView), BindingDirection.TwoWay)]
        ...
        [WebSysDescription("View_InsertRowStyle"), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [Browsable(false), WebSysDescription("View_InsertRowStyle"), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(FormView), BindingDirection.TwoWay)]
        ...
        [WebSysDescription("FormView_PageIndex"), Bindable(true), DefaultValue(0), WebCategory("Data")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("GridView_PagerSettings"), WebCategory("Paging"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true)]
        ...
        [DefaultValue((string) null), TemplateContainer(typeof(FormView)), WebSysDescription("View_PagerTemplate"), PersistenceMode(PersistenceMode.InnerProperty), Browsable(false)]
        ...
        [WebSysDescription("FormView_Rows"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [WebCategory("Styles"), WebSysDescription("View_RowStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
