namespace System.Web.UI.WebControls
{
    ...
    [DefaultProperty("DataSource"), DefaultEvent("SelectedIndexChanged"), Designer("System.Web.UI.Design.WebControls.BaseDataListDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public abstract class BaseDataList : WebControl
    {
        ...
        [WebCategory("Accessibility"), DefaultValue(""), WebSysDescription("DataControls_Caption"), Localizable(true)]
        ...
        [WebSysDescription("BaseDataList_CellPadding"), DefaultValue(-1), WebCategory("Layout")]
        ...
        [WebCategory("Layout"), WebSysDescription("BaseDataList_CellSpacing"), DefaultValue(0)]
        ...
        [WebSysDescription("BaseDataList_DataKeyField"), Themeable(false), WebCategory("Data"), DefaultValue("")]
        ...
        [WebSysDescription("BaseDataList_DataKeys"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Themeable(false), DefaultValue(""), WebCategory("Data"), WebSysDescription("BaseDataList_DataMember")]
        ...
        [Themeable(false), WebCategory("Data"), WebSysDescription("BaseDataBoundControl_DataSource"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Bindable(true)]
        ...
        [IDReferenceProperty(typeof(DataSourceControl)), WebCategory("Data"), WebSysDescription("BaseDataBoundControl_DataSourceID"), Themeable(false), DefaultValue("")]
        ...
        [Category("Layout"), WebSysDescription("WebControl_HorizontalAlign"), DefaultValue(0)]
        ...
        [WebCategory("Accessibility"), WebSysDescription("Table_UseAccessibleHeader"), DefaultValue(false)]
