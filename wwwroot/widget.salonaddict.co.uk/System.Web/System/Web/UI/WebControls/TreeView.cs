namespace System.Web.UI.WebControls
{
    ...
    [ControlValueProperty("SelectedValue"), DefaultEvent("SelectedNodeChanged"), Designer("System.Web.UI.Design.WebControls.TreeViewDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), SupportsEventValidation, AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class TreeView : HierarchicalDataBoundControl, IPostBackEventHandler, IPostBackDataHandler, ICallbackEventHandler
    {
        ...
        [WebCategory("Behavior"), WebSysDescription("TreeView_CheckChanged")]
        ...
        [WebCategory("Behavior"), WebSysDescription("TreeView_TreeNodePopulate")]
        ...
        private bool GetRenderClientScript(HttpBrowserCapabilities caps) => 
            (((this.EnableClientScript && this.Enabled) && ((caps.EcmaScriptVersion.Major > 0) && (caps.W3CDomVersion.Major > 0))) && !StringUtil.EqualsIgnoreCase(caps["tagwriter"], typeof(Html32TextWriter).FullName));
        ...
        [WebCategory("Behavior"), WebSysDescription("TreeView_AutoGenerateDataBindings"), DefaultValue(true)]
        ...
        [WebSysDescription("TreeView_CollapseImageToolTip"), WebSysDefaultValue("TreeView_CollapseImageToolTipDefaultValue"), WebCategory("Appearance"), Localizable(true)]
        ...
        [Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(""), WebSysDescription("TreeView_CollapseImageUrl"), UrlProperty, WebCategory("Appearance")]
        ...
        [WebCategory("Data"), MergableProperty(false), Editor("System.Web.UI.Design.WebControls.TreeViewBindingsEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("TreeView_DataBindings")]
        ...
        [WebSysDescription("TreeView_EnableClientScript"), Themeable(false), DefaultValue(true), WebCategory("Behavior")]
        ...
        internal bool EnableHover =>
            ((((this.Page != null) && ((this.Page.SupportsStyleSheets || this.Page.IsCallback) || ((this.Page.ScriptManager != null) && this.Page.ScriptManager.IsInAsyncPostBack))) && this.RenderClientScript) && (this._hoverNodeStyle != null));

        [TypeConverter(typeof(TreeViewExpandDepthConverter)), WebSysDescription("TreeView_ExpandDepth"), DefaultValue(-1), WebCategory("Behavior")]
        ...
        [WebSysDefaultValue("TreeView_ExpandImageToolTipDefaultValue"), Localizable(true), WebSysDescription("TreeView_ExpandImageToolTip"), WebCategory("Appearance")]
        ...
        [WebSysDescription("TreeView_ExpandImageUrl"), DefaultValue(""), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty, WebCategory("Appearance")]
        ...
        [DefaultValue((string) null), WebSysDescription("TreeView_HoverNodeStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles")]
        ...
        [DefaultValue(0), WebSysDescription("TreeView_ImageSet"), WebCategory("Appearance")]
        ...
        [WebSysDescription("TreeView_LeafNodeStyle"), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [Editor("System.Web.UI.Design.WebControls.TreeNodeStyleCollectionEditor,System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Styles"), WebSysDescription("TreeView_LevelStyles")]
        ...
        [DefaultValue(""), WebCategory("Appearance"), WebSysDescription("TreeView_LineImagesFolderUrl")]
        ...
        internal bool LoadingNodeState =>
            this._loadingNodeState;

        [WebCategory("Behavior"), DefaultValue(-1), WebSysDescription("TreeView_MaxDataBindDepth")]
        ...
        [DefaultValue(20), WebCategory("Appearance"), WebSysDescription("TreeView_NodeIndent")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), DefaultValue((string) null), MergableProperty(false), Editor("System.Web.UI.Design.WebControls.TreeNodeCollectionEditor,System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebSysDescription("TreeView_Nodes")]
        public TreeNodeCollection Nodes =>
            this.RootNode.ChildNodes;

        [WebCategory("Styles"), WebSysDescription("TreeView_NodeStyle"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebSysDescription("TreeView_NodeWrap"), DefaultValue(false), WebCategory("Appearance")]
        ...
        [WebSysDescription("TreeView_NoExpandImageUrl"), DefaultValue(""), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), UrlProperty, WebCategory("Appearance")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), NotifyParentProperty(true), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebSysDescription("TreeView_ParentNodeStyle")]
        ...
        [WebSysDescription("TreeView_PopulateNodesFromClient"), DefaultValue(true), WebCategory("Behavior")]
        ...
        [WebSysDescription("TreeView_RootNodeStyle"), WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), DefaultValue((string) null), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("TreeView_SelectedNodeStyle")]
        ...
        [DefaultValue(0), WebSysDescription("TreeView_ShowCheckBoxes"), WebCategory("Behavior")]
        ...
        [WebSysDescription("TreeView_ShowExpandCollapse"), DefaultValue(true), WebCategory("Appearance")]
        ...
        [WebCategory("Appearance"), WebSysDescription("TreeView_ShowLines"), DefaultValue(false)]
        ...
        [Localizable(true), WebSysDescription("TreeView_SkipLinkText"), WebCategory("Accessibility"), WebSysDefaultValue("TreeView_Default_SkipLinkText")]
        ...
        private class TreeViewExpandDepthConverter : Int32Converter
        {
            ...
            public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType) => 
                ((destinationType == typeof(int)) || ((destinationType == typeof(string)) || base.CanConvertTo(context, destinationType)));
            ...
            public override TypeConverter.StandardValuesCollection GetStandardValues(ITypeDescriptorContext context) => 
                new TypeConverter.StandardValuesCollection(expandDepthValues);
