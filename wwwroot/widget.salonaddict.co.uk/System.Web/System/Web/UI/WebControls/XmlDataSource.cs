namespace System.Web.UI.WebControls
{
    ...
    [PersistChildren(false), DefaultProperty("DataFile"), WebSysDescription("XmlDataSource_Description"), WebSysDisplayName("XmlDataSource_DisplayName"), Designer("System.Web.UI.Design.WebControls.XmlDataSourceDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ParseChildren(true), ToolboxBitmap(typeof(XmlDataSource)), DefaultEvent("Transforming"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class XmlDataSource : HierarchicalDataSourceControl, IDataSource, IListSource
    {
        ...
        protected override HierarchicalDataSourceView GetHierarchicalView(string viewPath) => 
            new XmlHierarchicalDataSourceView(this, viewPath);
        ...
        private void PopulateXmlDocument(XmlDocument document, out CacheDependency dataCacheDependency, out CacheDependency transformCacheDependency)
        {
            ...
            try
            {
                ...
                if (stylesheet != null)
                {
                    ...
                    if (AppSettings.RestrictXmlControls)
                    {
                        ((XmlTextReader) stylesheet).ProhibitDtd = false;
        ...
        [TypeConverter(typeof(DataSourceCacheDurationConverter)), DefaultValue(0), WebSysDescription("DataSourceCache_Duration"), WebCategory("Cache")]
        ...
        [WebSysDescription("XmlDataSource_Data"), Editor("System.ComponentModel.Design.MultilineStringEditor,System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), PersistenceMode(PersistenceMode.InnerProperty), TypeConverter("System.ComponentModel.MultilineStringConverter,System, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"), WebCategory("Data"), DefaultValue("")]
        ...
        [DefaultValue(""), Editor("System.Web.UI.Design.XmlDataFileEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebCategory("Data"), WebSysDescription("XmlDataSource_DataFile")]
        ...
        internal bool IsModifiable =>
            ((string.IsNullOrEmpty(this.TransformFile) && string.IsNullOrEmpty(this.Transform)) && !string.IsNullOrEmpty(this.WriteableDataFile));
        ...
        [Editor("System.ComponentModel.Design.MultilineStringEditor,System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(""), PersistenceMode(PersistenceMode.InnerProperty), TypeConverter("System.ComponentModel.MultilineStringConverter,System, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"), WebCategory("Data"), WebSysDescription("XmlDataSource_Transform")]
        ...
        [WebCategory("Data"), DefaultValue(""), Editor("System.Web.UI.Design.XslTransformFileEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebSysDescription("XmlDataSource_TransformFile")]
