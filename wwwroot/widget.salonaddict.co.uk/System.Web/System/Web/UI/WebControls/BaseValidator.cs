namespace System.Web.UI.WebControls
{
    ...
    [Designer("System.Web.UI.Design.WebControls.BaseValidatorDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultProperty("ErrorMessage"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public abstract class BaseValidator : Label, IValidator
    {
        ...
        [TypeConverter(typeof(ValidatedControlConverter)), WebSysDescription("BaseValidator_ControlToValidate"), WebCategory("Behavior"), Themeable(false), DefaultValue(""), IDReferenceProperty]
        ...
        [DefaultValue(1), Themeable(true), WebCategory("Appearance"), WebSysDescription("BaseValidator_Display")]
        ...
        [Localizable(true), WebSysDescription("BaseValidator_ErrorMessage"), WebCategory("Appearance"), DefaultValue("")]
        ...
        [WebCategory("Behavior"), Browsable(false), Themeable(false), DefaultValue(true), WebSysDescription("BaseValidator_IsValid"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool IsValid
        {
            get => 
                this.isValid;
        ...
        [WebSysDescription("BaseValidator_SetFocusOnError"), Themeable(false), DefaultValue(false), WebCategory("Behavior")]
        ...
        [PersistenceMode(PersistenceMode.InnerDefaultProperty), DefaultValue(""), WebSysDescription("BaseValidator_Text"), WebCategory("Appearance")]
        ...
        [Themeable(false), WebCategory("Behavior"), DefaultValue(""), WebSysDescription("BaseValidator_ValidationGroup")]
