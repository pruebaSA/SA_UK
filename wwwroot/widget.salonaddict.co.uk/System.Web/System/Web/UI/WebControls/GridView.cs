namespace System.Web.UI.WebControls
{
    ...
    [DefaultEvent("SelectedIndexChanged"), ControlValueProperty("SelectedValue"), SupportsEventValidation, Designer("System.Web.UI.Design.WebControls.GridViewDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class GridView : CompositeDataBoundControl, IPostBackContainer, IPostBackEventHandler, ICallbackContainer, ICallbackEventHandler, IPersistedSelector
    {
        ...
        [WebSysDescription("DataControls_OnRowDeleted"), WebCategory("Action")]
        ...
        [WebSysDescription("GridView_OnSelectedIndexChanged"), WebCategory("Action")]
        ...
        [WebCategory("Action"), WebSysDescription("GridView_OnSelectedIndexChanging")]
        ...
        private string BuildCallbackArgument(string sortExpression, System.Web.UI.WebControls.SortDirection sortDirection) => 
            string.Concat(new object[] { "\"", this.PageIndex, "|", (int) sortDirection, "|", this.StateFormatter.Serialize(sortExpression), "|\"" });
        ...
        protected override int CreateChildControls(IEnumerable dataSource, bool dataBinding)
        {
            ...
            if (num8 > 0)
            {
                ...
                if (this._storedDataValid)
                {
                    ...
                    if (this._firstDataRow != null)
                    {
                        if (flag4)
                        {
                            ...
                            if (dataKeysArrayList.Count == rowIndex)
                            {
                                dataKeysArrayList.Add(new DataKey(keyTable, dataKeyNamesInternal));
                            }
                            else
                            {
                                dataKeysArrayList[rowIndex] = new DataKey(keyTable, dataKeyNamesInternal);
                            }
                        }
                ...
                while (enumerator.MoveNext())
                {
                    ...
                    if (flag4)
                    {
                        OrderedDictionary dictionary2 = new OrderedDictionary(dataKeyNamesInternal.Length);
                        foreach (string str2 in dataKeyNamesInternal)
                        {
                            object obj5 = DataBinder.GetPropertyValue(container, str2);
                            dictionary2.Add(str2, obj5);
                        }
                        if (dataKeysArrayList.Count == rowIndex)
                        {
                            dataKeysArrayList.Add(new DataKey(dictionary2, dataKeyNamesInternal));
                        }
                        else
                        {
                            dataKeysArrayList[rowIndex] = new DataKey(dictionary2, dataKeyNamesInternal);
                        }
                    }
                    normal = DataControlRowState.Normal;
                    if (rowIndex == editIndex)
                    ...
                    row = this.CreateRow(rowIndex, dataSourceIndex, dataRow, normal, dataBinding, container, array, rows, null);
                    this._rowsArray.Add(row);
                    num2++;
                    dataSourceIndex++;
                    rowIndex++;
        ...
        protected virtual Table CreateChildTable() => 
            new ChildTable(string.IsNullOrEmpty(this.ID) ? null : this.ClientID);
        ...
        protected virtual GridViewRow CreateRow(int rowIndex, int dataSourceIndex, DataControlRowType rowType, DataControlRowState rowState) => 
            new GridViewRow(rowIndex, dataSourceIndex, rowType, rowState);
        ...
        private bool HandleDeleteCallback(int affectedRows, Exception ex)
        {
            ...
            if (affectedRows > 0)
            {
                ...
                int num2 = this._deletedRowIndex;
                int pageSize = this.PageSize;
                int pageIndex = this.PageIndex;
                int num5 = num2 + (pageSize * pageIndex);
                bool flag = num2 == 0;
                if (num2 == pageSize)
                {
                    int pageCount = this.PageCount;
                }
                bool flag2 = num5 == (num - 1);
                int num6 = (num - 1) - affectedRows;
                if (this.AllowPaging)
                {
                    num6 /= pageSize;
                    if (num6 < pageIndex)
                    {
                        ...
                        this._pageIndex = num6;
                    }
                }
                if ((this.PageIndex == (this.PageCount - 1)) && (this.SelectedIndex >= num6))
                {
                    this.SelectedIndex = num6;
                }
            }
        ...
        public virtual bool IsBindableType(Type type) => 
            DataBoundControlHelper.IsBindableType(type);
        ...
        protected override object SaveViewState()
        {
            ...
            return new object[] { obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj12, obj11, obj13, obj14 };
        }
        ...
        string ICallbackContainer.GetCallbackScript(IButtonControl buttonControl, string argument) => 
            this.GetCallbackScript(buttonControl, argument);
        ...
        [WebCategory("Paging"), WebSysDescription("GridView_AllowPaging"), DefaultValue(false)]
        ...
        [WebSysDescription("GridView_AlternatingRowStyle"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty)]
        ...
        [WebSysDescription("DataControls_AutoGenerateColumns"), DefaultValue(true), WebCategory("Behavior")]
        ...
        [WebCategory("Behavior"), WebSysDescription("GridView_AutoGenerateDeleteButton"), DefaultValue(false)]
        ...
        [DefaultValue(false), WebSysDescription("GridView_AutoGenerateEditButton"), WebCategory("Behavior")]
        ...
        [WebCategory("Behavior"), DefaultValue(false), WebSysDescription("GridView_AutoGenerateSelectButton")]
        ...
        [WebCategory("Appearance"), DefaultValue(""), UrlProperty, WebSysDescription("WebControl_BackImageUrl"), Editor("System.Web.UI.Design.ImageUrlEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [WebSysDescription("GridView_CellPadding"), DefaultValue(-1), WebCategory("Layout")]
        ...
        [DefaultValue(0), WebCategory("Layout"), WebSysDescription("GridView_CellSpacing")]
        ...
        [WebSysDescription("DataControls_Columns"), Editor("System.Web.UI.Design.WebControls.DataControlFieldTypeEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), PersistenceMode(PersistenceMode.InnerProperty), WebCategory("Default"), MergableProperty(false), DefaultValue((string) null)]
        ...
        [TypeConverter(typeof(StringArrayConverter)), DefaultValue((string) null), Editor("System.Web.UI.Design.WebControls.DataFieldEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), WebCategory("Data"), WebSysDescription("DataControls_DataKeyNames")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("GridView_DataKeys"), Browsable(false)]
        ...
        [WebSysDescription("GridView_EditIndex"), DefaultValue(-1), WebCategory("Default")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("GridView_EditRowStyle")]
        ...
        [NotifyParentProperty(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("GridView_EmptyDataRowStyle")]
        ...
        [Browsable(false), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(GridViewRow)), WebSysDescription("View_EmptyDataTemplate")]
        ...
        [Localizable(true), WebCategory("Appearance"), DefaultValue(""), WebSysDescription("View_EmptyDataText")]
        ...
        [WebSysDescription("DataBoundControl_EnableModelValidation"), DefaultValue(false), WebCategory("Behavior")]
        ...
        [WebCategory("Behavior"), DefaultValue(false), WebSysDescription("GridView_EnableSortingAndPagingCallbacks")]
        ...
        [WebCategory("Styles"), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DataControls_FooterStyle")]
        ...
        [WebSysDescription("DataControls_GridLines"), DefaultValue(3), WebCategory("Appearance")]
        ...
        [NotifyParentProperty(true), DefaultValue((string) null), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("DataControls_HeaderStyle")]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("GridView_PageCount")]
        ...
        [WebCategory("Paging"), DefaultValue(0), Browsable(true), WebSysDescription("GridView_PageIndex")]
        ...
        [PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), WebCategory("Paging"), WebSysDescription("GridView_PagerSettings")]
        ...
        [WebCategory("Styles"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("WebControl_PagerStyle")]
        ...
        [Browsable(false), DefaultValue((string) null), PersistenceMode(PersistenceMode.InnerProperty), TemplateContainer(typeof(GridViewRow)), WebSysDescription("View_PagerTemplate")]
        ...
        [WebSysDescription("GridView_PageSize"), DefaultValue(10), WebCategory("Paging")]
        ...
        [WebCategory("Accessibility"), TypeConverter("System.Web.UI.Design.DataColumnSelectionConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultValue(""), WebSysDescription("GridView_RowHeaderColumn")]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("GridView_Rows")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("View_RowStyle")]
        ...
        [Bindable(true), DefaultValue(-1), WebSysDescription("GridView_SelectedIndex")]
        ...
        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("GridView_SelectedRow")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), WebCategory("Styles"), NotifyParentProperty(true), PersistenceMode(PersistenceMode.InnerProperty), WebSysDescription("GridView_SelectedRowStyle")]
        ...
        [WebCategory("Appearance"), DefaultValue(false), WebSysDescription("DataControls_ShowFooter")]
        ...
        [DefaultValue(0), Browsable(false), PersistenceMode(PersistenceMode.InnerProperty), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), WebSysDescription("GridView_SortDirection")]
        ...
        [WebSysDescription("GridView_SortExpression"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [WebSysDescription("Table_UseAccessibleHeader"), DefaultValue(true), WebCategory("Accessibility")]
