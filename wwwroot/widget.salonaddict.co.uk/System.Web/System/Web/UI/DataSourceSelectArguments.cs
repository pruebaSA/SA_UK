namespace System.Web.UI
{
    ...
    public sealed class DataSourceSelectArguments
    {
        ...
        public override int GetHashCode() => 
            HashCodeCombiner.CombineHashCodes(this._maximumRows.GetHashCode(), this._retrieveTotalRowCount.GetHashCode(), this._sortExpression.GetHashCode(), this._startRowIndex.GetHashCode(), this._totalRowCount.GetHashCode());
