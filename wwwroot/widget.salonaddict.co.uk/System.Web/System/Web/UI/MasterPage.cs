namespace System.Web.UI
{
    ...
    [Designer("Microsoft.VisualStudio.Web.WebForms.MasterPageWebFormDesigner, Microsoft.VisualStudio.Web, Version=8.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(IRootDesigner)), ControlBuilder(typeof(MasterPageControlBuilder)), ParseChildren(false), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class MasterPage : UserControl
    {
        ...
        [WebCategory("Behavior"), DefaultValue(""), WebSysDescription("MasterPage_MasterPageFile")]
