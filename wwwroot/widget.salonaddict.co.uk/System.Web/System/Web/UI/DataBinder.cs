namespace System.Web.UI
{
    ...
    public sealed class DataBinder
    {
        ...
        public static object GetIndexedPropertyValue(object container, string expr)
        {
            ...
            return propertyValue.GetType().GetProperty("Item", BindingFlags.Public | BindingFlags.Instance, null, null, new Type[] { obj3.GetType() }, null)?.GetValue(propertyValue, new object[] { obj3 });
        }
        ...
        public static object GetPropertyValue(object container, string propName)
        {
            ...
            return TypeDescriptor.GetProperties(container).Find(propName, true)?.GetValue(container);
        }
