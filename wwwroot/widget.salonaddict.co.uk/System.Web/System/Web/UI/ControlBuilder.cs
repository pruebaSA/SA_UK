    ...
    public class ControlBuilder
    {
        ...
        private void AddBoundProperty(string filter, string name, string expressionPrefix, string expression, ExpressionBuilder expressionBuilder, object parsedExpressionData, bool generated, string fieldName, string formatString, bool twoWayBound)
        {
            ...
            if (string.IsNullOrEmpty(expressionPrefix))
            {
                ...
                if (!this.flags[0x2000] && (this.ControlType.GetEvent("DataBinding") == null))
                {
                    ...
                    if (codeBlockBuilder.BlockType == CodeBlockType.DataBinding)
                    {
                        ...
                        if (this.InDesigner)
                        {
                            IDictionary attribs = new ParsedAttributeCollection {
                                { 
                                    "Text",
                                    "<%#" + codeBlockBuilder.Content + "%>"
                                }
                            };
                            subBuilder = CreateBuilderFromType(this.Parser, this, typeof(DesignerDataBoundLiteralControl), null, null, attribs, codeBlockBuilder.Line, codeBlockBuilder.VirtualPathString);
                        }
                        else
                        {
        ...
        private void BindFieldToControl(Control control)
        {
            if (!this.flags[0x800] || this.flags[0x1000])
            {
                ...
                if (templateControl != null)
                {
                    ...
                    FieldInfo field = templateControl.GetType().GetField(control.ID, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase);
        ...
        internal virtual void BuildChildren(object parentObj)
        {
            if (this._subBuilders != null)
            {
                ...
                for (int i = 0; enumerator.MoveNext(); i++)
                {
                    ...
                    if (!(current is CodeBlockBuilder))
                    {
                        goto Label_00D3;
                    }
                    if (this.InDesigner)
                ...
                Label_00C9:
                    ...
                    goto Label_0135;
                Label_00D3:
                    builder2 = (ControlBuilder) current;
        ...
        internal object BuildObjectInternal()
        {
            ...
            if (!this.flags[2])
            {
                ConstructorNeedsTagAttribute attribute = (ConstructorNeedsTagAttribute) TypeDescriptor.GetAttributes(this.ControlType)[typeof(ConstructorNeedsTagAttribute)];
        ...
        internal ControlBuilder CreateChildBuilder(string filter, string tagName, IDictionary attribs, TemplateParser parser, ControlBuilder parentBuilder, string id, int line, System.Web.VirtualPath virtualPath, ref Type childType, bool defaultProperty)
        {
            ...
            if (this.FChildrenAsProperties)
            {
                if (this.DefaultPropertyBuilder != null)
                {
                    if (this._controlType.GetProperty(tagName, BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance | BindingFlags.IgnoreCase) != null)
                    {
                        ...
                        if (this.DefaultPropertyBuilder.SubBuilders.Count > 0)
                        {
                            ...
                            attribute = (ParseChildrenAttribute) this.ControlType.GetCustomAttributes(typeof(ParseChildrenAttribute), true)[0];
            ...
            else
            {
                ...
                builder = CreateBuilderFromType(parser, parentBuilder, childType, str, id, attribs, line, this.VirtualPathString);
            }
            if (builder == null)
            {
                return null;
        ...
        {
            PropertyInfo property = this._controlType.GetProperty(tagName, BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance | BindingFlags.IgnoreCase);
            if (property == null)
            {
            ...
            {
                IgnoreUnknownContentAttribute attribute = (IgnoreUnknownContentAttribute) Attribute.GetCustomAttribute(property, typeof(IgnoreUnknownContentAttribute), true);
            ...
            else if (typeof(ITemplate).IsAssignableFrom(childType))
            {
                ...
                object[] objArray2 = property.GetCustomAttributes(typeof(TemplateInstanceAttribute), false);
                if ((objArray2 != null) && (objArray2.Length > 0))
                {
                    flag2 = ((TemplateInstanceAttribute) objArray2[0]).Instances == TemplateInstance.Multiple;
                }
                if (flag)
                {
            ...
            {
                PersistenceModeAttribute attribute2 = (PersistenceModeAttribute) Attribute.GetCustomAttribute(property, typeof(PersistenceModeAttribute), true);
            ...
            return CreateBuilderFromType(this.Parser, this, childType, tagName, null, attribs, this.Line, this.VirtualPathString);
        }
        ...
        private static ControlBuilderAttribute GetControlBuilderAttribute(Type controlType)
        {
            ...
            if ((customAttributes != null) && (customAttributes.Length > 0))
            {
                attribute = (ControlBuilderAttribute) customAttributes[0];
            }
            return attribute;
        }
        ...
        public ObjectPersistData GetObjectPersistData() => 
            new ObjectPersistData(this, this.Parser.RootBuilder.BuiltObjects);
        ...
        private static ParseChildrenAttribute GetParseChildrenAttribute(Type controlType)
        {
            ...
            if (attribute == null)
            {
                ...
                if ((customAttributes != null) && (customAttributes.Length > 0))
                {
                    attribute = (ParseChildrenAttribute) customAttributes[0];
                }
                if (attribute == null)
                {
        ...
        public string GetResourceKey() => 
            this.ParseTimeData.ResourceKeyPrefix;
        ...
        private ControlBuilder DefaultPropertyBuilder =>
            this.ParseTimeData.DefaultPropertyBuilder;
        ...
        protected bool FChildrenAsProperties =>
            this.ParseTimeData.ChildrenAsProperties;

        internal string Filter
        {
            get => 
                this.ParseTimeData.Filter;
            set
            {
        ...
        protected bool FIsNonParserAccessor =>
            this.ParseTimeData.IsNonParserAccessor;

        public bool HasAspCode =>
            this.ParseTimeData.HasAspCode;
        ...
        private bool IgnoreControlProperty =>
            this.ParseTimeData.IgnoreControlProperties;
        ...
        protected bool InPageTheme =>
            (this.Parser is PageThemeParser);

        internal bool IsControlSkin =>
            (this.ParentBuilder is FileLevelPageThemeBuilder);

        internal bool IsGeneratedID
        {
            get => 
                this.ParseTimeData.IsGeneratedID;
            set
            {
        ...
        private bool IsHtmlControl =>
            this.ParseTimeData.IsHtmlControl;
        ...
        public Type NamingContainerType =>
            this.NamingContainerBuilder?.ControlType;

        internal ControlBuilder ParentBuilder =>
            this.ParseTimeData.ParentBuilder;

        protected internal TemplateParser Parser =>
            this.ParseTimeData.Parser;
        ...
        private bool SupportsAttributes =>
            this.ParseTimeData.SupportsAttributes;
        ...
        {
            get => 
                this.ParseTimeData.VirtualPath;
            set
            {
        ...
        internal string VirtualPathString =>
            System.Web.VirtualPath.GetVirtualPathString(this.VirtualPath);
        ...
        private class ReflectionBasedControlBuilderFactory : IWebObjectFactory
        {
            ...
            object IWebObjectFactory.CreateInstance() => 
                ((ControlBuilder) HttpRuntime.CreateNonPublicInstance(this._builderType));
        }
    }
}
