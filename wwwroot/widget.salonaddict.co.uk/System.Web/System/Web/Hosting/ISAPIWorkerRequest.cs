namespace System.Web.Hosting
{
    ...
    internal abstract class ISAPIWorkerRequest : HttpWorkerRequest
    {
        ...
        public override int GetLocalPort() => 
            int.Parse(this.GetServerVariable("SERVER_PORT"));
        ...
        public override bool IsClientConnected() => 
            (this.IsClientConnectedCore() != 0);

        internal abstract int IsClientConnectedCore();
        public override bool IsEntireEntityBodyIsPreloaded() => 
            (this._contentAvailLength == this._contentTotalLength);
        ...
        public override int ReadEntityBody(byte[] buffer, int size) => 
            this.ReadEntityBody(buffer, 0, size);
