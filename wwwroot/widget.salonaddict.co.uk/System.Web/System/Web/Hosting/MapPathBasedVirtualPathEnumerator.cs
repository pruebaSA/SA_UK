            ...
            if (flag)
            {
                ...
                if (current.IsDirectory)
                {
                    if (this._requestedEntryType != RequestedEntryType.Files)
                    {
                        ...
                        if ((((this._virtualPaths == null) || !this._virtualPaths.Contains(name)) && ((this._exclude == null) || !this._exclude.Contains(name))) && ((this._processHostServerConfig == null) || this._processHostServerConfig.IsWithinApp(UrlPath.SimpleCombine(this._virtualPath.VirtualPathString, name))))
                        {
                            return flag;
                        }
                    }
