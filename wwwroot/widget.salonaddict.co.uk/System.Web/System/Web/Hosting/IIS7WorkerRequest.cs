namespace System.Web.Hosting
{
    ...
    internal sealed class IIS7WorkerRequest : HttpWorkerRequest
    {
        ...
        public override string GetLocalAddress() => 
            this.GetServerVariable("LOCAL_ADDR");

        public override int GetLocalPort() => 
            UnsafeIISMethods.MgdGetLocalPort(this._context);

        internal override string GetLocalPortAsString() => 
            this.GetServerVariable("SERVER_PORT");
        ...
        public override string GetRemoteName() => 
            this.GetServerVariable("REMOTE_HOST");

        public override int GetRemotePort() => 
            UnsafeIISMethods.MgdGetRemotePort(this._context);
        ...
        public override string GetServerName() => 
            this.GetServerVariable("SERVER_NAME");
        ...
        public override bool IsClientConnected() => 
            (!this._connectionClosed && UnsafeIISMethods.MgdIsClientConnected(this._context));

        public override bool IsEntireEntityBodyIsPreloaded() => 
            (this.GetTotalEntityBodyLength() == this.GetPreloadedEntityBodyLength());

        internal bool IsHandlerExecutionDenied() => 
            UnsafeIISMethods.MgdIsHandlerExecutionDenied(this._context);
        ...
        private static bool IsValidUsername(string username) => 
            (AppSettings.AllowRelaxedHttpUserName || (username.IndexOf('\0') == -1));
        ...
        internal string MapHandlerAndGetHandlerTypeString(string method, string path, bool convertNativeStaticFileModule, bool ignoreWildcardMappings)
        {
            ...
            int num;
            string str = null;
            Misc.ThrowIfFailedHr(UnsafeIISMethods.MgdMapHandler(this._context, method, path, out ptr, out num, convertNativeStaticFileModule, ignoreWildcardMappings));
            if (num > 0)
            {
                str = StringUtil.StringFromWCharPtr(ptr, num);
            }
        ...
        public override string MapPath(string path) => 
            HostingEnvironment.MapPathInternal(path);
        ...
        public override int ReadEntityBody(byte[] buffer, int size) => 
            this.ReadEntityBodyWithTimeout(buffer, size, 0x7fffffffffffffffL);
        ...
        public override int ReadEntityBody(byte[] buffer, int offset, int size)
        {
            ...
            return this.ReadEntityCoreSync(buffer, offset, size, 0x7fffffffffffffffL);
        }
        ...
        private int ReadEntityCoreSync(byte[] buffer, int offset, int size, long timeout)
        {
            ...
            try
            {
                ...
                result = UnsafeIISMethods.MgdSyncReadRequest(this._context, buffer, offset, size, out pBytesRead, num3);
                if (result == -2147023436)
                {
        ...
        internal void ReadRequestBasics()
        {
            IntPtr ptr;
            int num;
            Misc.ThrowIfFailedHr(UnsafeIISMethods.MgdGetRequestBasics(this._context, out this._contentType, out this._contentTotalLength, out ptr, out num));
            ...
            if (num3 > 0)
            {
                ...
                int length = this._pathTranslated.Length - num3;
                if (length > 0)
                {
        ...
        internal void ScheduleExecuteUrl(string url, string queryString, string method, bool preserveForm, byte[] entity, NameValueCollection headers)
        {
            ...
            int hresult = UnsafeIISMethods.MgdExecuteUrl(this._context, url, resetQuerystring, preserveForm, entity, (entity == null) ? 0 : ((uint) entity.Length), method, numHeaders, headersNames, headersValues);
        ...
        internal void SetPrincipal(IPrincipal user, IntPtr pManagedPrincipal)
        {
            ...
            if (user != null)
            {
                if (user.Identity != null)
                {
                    ...
                    {
                        UnsafeIISMethods.MgdGetAnonymousUserToken(this._context, out zero);
                    }
                }
                if (username == null)
                {
