namespace System.Web.Util
{
    ...
    internal struct FileTimeInfo
    {
        ...
        public static bool operator ==(FileTimeInfo value1, FileTimeInfo value2) => 
            ((value1.LastWriteTime == value2.LastWriteTime) && (value1.Size == value2.Size));

        public static bool operator !=(FileTimeInfo value1, FileTimeInfo value2) => 
            !(value1 == value2);

        public override int GetHashCode() => 
            HashCodeCombiner.CombineHashCodes(this.LastWriteTime.GetHashCode(), this.Size.GetHashCode());
