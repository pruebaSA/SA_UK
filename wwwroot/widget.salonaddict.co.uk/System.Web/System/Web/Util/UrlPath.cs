namespace System.Web.Util
{
    ...
    internal static class UrlPath
    {
        ...
        internal static string Combine(string basepath, string relative) => 
            Combine(HttpRuntime.AppDomainAppVirtualPathString, basepath, relative);
        ...
        internal static string MakeVirtualPathAppAbsolute(string virtualPath) => 
            MakeVirtualPathAppAbsolute(virtualPath, HttpRuntime.AppDomainAppVirtualPathString);
        ...
        internal static string MakeVirtualPathAppRelative(string virtualPath) => 
            MakeVirtualPathAppRelative(virtualPath, HttpRuntime.AppDomainAppVirtualPathString, false);
        ...
        internal static string MakeVirtualPathAppRelativeOrNull(string virtualPath) => 
            MakeVirtualPathAppRelative(virtualPath, HttpRuntime.AppDomainAppVirtualPathString, true);
        ...
        internal static bool PathIsDriveRoot(string path) => 
            (((path != null) && (path.Length == 3)) && ((path[1] == ':') && (path[2] == '\\')));
        ...
        internal static bool VirtualPathStartsWithAppPath(string virtualPath) => 
            VirtualPathStartsWithVirtualPath(virtualPath, HttpRuntime.AppDomainAppVirtualPathString);
