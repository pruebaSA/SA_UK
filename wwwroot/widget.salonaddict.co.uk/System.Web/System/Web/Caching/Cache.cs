namespace System.Web.Caching
{
    ...
    public sealed class Cache : IEnumerable
    {
        ...
        public object Get(string key) => 
            this._cacheInternal.DoGet(true, key, CacheGetOptions.None);

        internal object Get(string key, CacheGetOptions getOptions) => 
            this._cacheInternal.DoGet(true, key, getOptions);

        public IDictionaryEnumerator GetEnumerator() => 
            this._cacheInternal.GetEnumerator();
        ...
        IEnumerator IEnumerable.GetEnumerator() => 
            ((IEnumerable) this._cacheInternal).GetEnumerator();

        public int Count =>
            this._cacheInternal.PublicCount;

        public long EffectivePercentagePhysicalMemoryLimit =>
            this._cacheInternal.EffectivePercentagePhysicalMemoryLimit;

        public long EffectivePrivateBytesLimit =>
            this._cacheInternal.EffectivePrivateBytesLimit;
        ...
        private class SentinelEntry
        {
            ...
            public System.Web.Caching.CacheItemUpdateCallback CacheItemUpdateCallback =>
                this._cacheItemUpdateCallback;

            public CacheDependency ExpensiveObjectDependency =>
                this._expensiveObjectDependency;
