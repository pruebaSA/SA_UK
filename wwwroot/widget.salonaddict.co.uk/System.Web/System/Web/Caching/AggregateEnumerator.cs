namespace System.Web.Caching
{
    ...
    internal class AggregateEnumerator : IDictionaryEnumerator, IEnumerator
    {
        ...
        public object Current =>
            this._enumerators[this._iCurrent].Current;

        public DictionaryEntry Entry =>
            this._enumerators[this._iCurrent].Entry;

        public object Key =>
            this._enumerators[this._iCurrent].Key;

        public object Value =>
            this._enumerators[this._iCurrent].Value;
    }
}
