namespace System.Web.Compilation
{
    ...
    [ExpressionPrefix("Resources"), ExpressionEditor("System.Web.UI.Design.ResourceExpressionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class ResourceExpressionBuilder : System.Web.Compilation.ExpressionBuilder
    {
        ...
        internal static object GetGlobalResourceObject(string classKey, string resourceKey) => 
            GetGlobalResourceObject(classKey, resourceKey, null, null, null);
        ...
        internal static object GetGlobalResourceObject(string classKey, string resourceKey, Type objType, string propName, CultureInfo culture) => 
            GetResourceObject(GetGlobalResourceProvider(classKey), resourceKey, culture, objType, propName);
        ...
        internal static IResourceProvider GetLocalResourceProvider(TemplateControl templateControl) => 
            GetLocalResourceProvider(templateControl.VirtualPath);
        ...
        internal static object GetParsedData(string resourceKey) => 
            new ResourceExpressionFields(string.Empty, resourceKey);

        internal static object GetResourceObject(IResourceProvider resourceProvider, string resourceKey, CultureInfo culture) => 
            GetResourceObject(resourceProvider, resourceKey, culture, null, null);
        ...
        public static ResourceExpressionFields ParseExpression(string expression) => 
            ParseExpressionInternal(expression);
