namespace System.Web.Compilation
{
    ...
    internal static class CodeDomUtility
    {
        ...
        internal static CodeCastExpression BuildJSharpCastExpression(Type castType, CodeExpression expression) => 
            new CodeCastExpression(castType, expression) { UserData = { { 
                "CastIsBoxing",
                true
            } } };
        ...
        internal static CodeExpression GenerateConvertToString(CodeExpression value)
        {
            ...
            expression.Parameters.Add(new CodePropertyReferenceExpression(new CodeTypeReferenceExpression(typeof(CultureInfo)), "CurrentCulture"));
            return expression;
        }
        ...
        internal static CodeExpression GenerateExpressionForValue(PropertyInfo propertyInfo, object value, Type valueType)
        {
            ...
            if (converter != null)
            {
                ...
                if (descriptor2 != null)
                {
                    ...
                    if (descriptor2.MemberInfo is FieldInfo)
                    {
                        ...
                        CodeFieldReferenceExpression expression3 = new CodeFieldReferenceExpression(new CodeTypeReferenceExpression(descriptor2.MemberInfo.DeclaringType.FullName), descriptor2.MemberInfo.Name);
                    ...
                    else if (descriptor2.MemberInfo is PropertyInfo)
                    {
                        ...
                        CodePropertyReferenceExpression expression4 = new CodePropertyReferenceExpression(new CodeTypeReferenceExpression(descriptor2.MemberInfo.DeclaringType.FullName), descriptor2.MemberInfo.Name);
                    ...
                    else
                    {
                        ...
                        if (descriptor2.MemberInfo is MethodInfo)
                        {
                            ...
                            CodeMethodInvokeExpression expression5 = new CodeMethodInvokeExpression(new CodeTypeReferenceExpression(descriptor2.MemberInfo.DeclaringType.FullName), descriptor2.MemberInfo.Name, new CodeExpression[0]);
            ...
            {
                string str;
                CodeMethodInvokeExpression expression9 = new CodeMethodInvokeExpression(new CodeTypeReferenceExpression(valueType.FullName), "Parse", new CodeExpression[0]);
                if (converter != null)
                {
                ...
                expression9.Parameters.Add(new CodePropertyReferenceExpression(new CodeTypeReferenceExpression(typeof(CultureInfo)), "InvariantCulture"));
                return expression9;
            }
            ...
            CodeMethodInvokeExpression expression10 = new CodeMethodInvokeExpression(new CodeTypeReferenceExpression(valueType.FullName), "Parse", new CodeExpression[0]);
