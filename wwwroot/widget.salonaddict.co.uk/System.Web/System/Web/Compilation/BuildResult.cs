namespace System.Web.Compilation
{
    ...
    internal abstract class BuildResult
    {
        ...
        internal long ComputeHashCode(long hashCode) => 
            this.ComputeHashCode(hashCode, 0L);
        ...
        internal bool IsUpToDate(System.Web.VirtualPath virtualPath)
        {
            if (this._lock < 0)
            {
                return false;
        ...
        internal bool DependenciesHashComputed =>
            this._flags[0x100000];

        internal int Flags
        {
            get => 
                this._flags.IntegerValue;
            set
            {
