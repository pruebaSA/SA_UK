namespace System.Web.Compilation
{
    ...
    internal abstract class BaseCodeDomTreeGenerator
    {
        ...
        private static bool _urlLinePragmas = RuntimeConfig.GetAppConfig().Compilation.UrlLinePragmas;
        ...
        protected virtual void BuildDefaultConstructor()
        {
            ...
            CodeMemberField field = new CodeMemberField(typeof(bool), "__initialized");
        ...
        private void BuildProfileProperty()
        {
            if (ProfileManager.Enabled)
            {
                ...
                {
                    this.ApplyEditorBrowsableCustomAttribute(member);
                }
                member.Type = new CodeTypeReference(profileClassName);
                ...
                member.GetStatements.Add(new CodeMethodReturnStatement(new CodeCastExpression(profileClassName, targetObject)));
                this._intermediateClass.Members.Add(member);
            }
        }
        ...
        private bool BuildSourceDataTree()
        {
            ...
            if (this._sourceDataClass != null)
            {
                CodeTypeReference type = new CodeTypeReference(Util.MakeFullTypeName(this._sourceDataNamespace.Name, this._sourceDataClass.Name), CodeTypeReferenceOptions.GlobalReference);
        ...
        protected CodeLinePragma CreateCodeLinePragma(ControlBuilder builder)
        {
            ...
            return this.CreateCodeLinePragma(virtualPathString, line, column, generatedColumn, codeLength);
        }

        protected CodeLinePragma CreateCodeLinePragma(string virtualPath, int lineNumber) => 
            this.CreateCodeLinePragma(virtualPath, lineNumber, 1, 1, -1, true);
        ...
        protected CodeLinePragma CreateCodeLinePragma(string virtualPath, int lineNumber, int column, int generatedColumn, int codeLength) => 
            this.CreateCodeLinePragma(virtualPath, lineNumber, column, generatedColumn, codeLength, true);
        ...
        internal string GetIntermediateFullTypeName() => 
            Util.MakeFullTypeName(this.Parser.BaseTypeNamespace, this._intermediateClass.Name);
