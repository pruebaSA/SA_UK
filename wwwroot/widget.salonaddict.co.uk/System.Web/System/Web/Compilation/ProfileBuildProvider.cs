    ...
    internal class ProfileBuildProvider : System.Web.Compilation.BuildProvider
    {
        ...
        private void AddCodeForGetProfileForUser(CodeTypeDeclaration type)
        {
            ...
            CodeMethodInvokeExpression expression = new CodeMethodInvokeExpression {
                Method = { 
                    TargetObject = new CodeTypeReferenceExpression("ProfileBase"),
                    MethodName = "Create"
                }
            };
        ...
        public override void GenerateCode(AssemblyBuilder assemblyBuilder)
        {
            ...
            CodeNamespace ns = new CodeNamespace {
                Imports = { 
                    ...
                    new CodeNamespaceImport("System.Web.Profile")
                }
            };
            CodeTypeDeclaration declaration = new CodeTypeDeclaration {
                Name = "ProfileCommon"
            ...
            else
            {
                ...
                if (profile != null)
                {
                    PropertyInformation information = profile.ElementInformation.Properties["inherits"];
