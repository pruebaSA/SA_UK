namespace System.Web.Security
{
    ...
    public sealed class PassportIdentity : IIdentity, IDisposable
    {
        ...
        public string AuthUrl() => 
            this.AuthUrl(null, -1, -1, null, -1, null, -1, -1);

        public string AuthUrl(string strReturnUrl) => 
            this.AuthUrl(strReturnUrl, -1, -1, null, -1, null, -1, -1);
        ...
        public string AuthUrl2() => 
            this.AuthUrl2(null, -1, -1, null, -1, null, -1, -1);

        public string AuthUrl2(string strReturnUrl) => 
            this.AuthUrl2(strReturnUrl, -1, -1, null, -1, null, -1, -1);
        ...
        public static string Compress(string strData) => 
            CallPassportCryptFunction(2, strData);
        ...
        public static string Decompress(string strData) => 
            CallPassportCryptFunction(3, strData);

        public static string Decrypt(string strData) => 
            CallPassportCryptFunction(1, strData);

        public static string Encrypt(string strData) => 
            CallPassportCryptFunction(0, strData);
        ...
        public bool GetIsAuthenticated(int iTimeWindow, bool bForceLogin, bool bCheckSecure) => 
            this.GetIsAuthenticated(iTimeWindow, bForceLogin ? 1 : 0, bCheckSecure ? 10 : 0);
        ...
        public string GetLoginChallenge() => 
            this.GetLoginChallenge(null, -1, -1, null, -1, null, -1, -1, null);

        public string GetLoginChallenge(string strReturnUrl) => 
            this.GetLoginChallenge(strReturnUrl, -1, -1, null, -1, null, -1, -1, null);
        ...
        public int LoginUser() => 
            this.LoginUser(null, -1, -1, null, -1, null, -1, -1, null);

        public int LoginUser(string strReturnUrl) => 
            this.LoginUser(strReturnUrl, -1, -1, null, -1, null, -1, -1, null);
        ...
        public int LoginUser(string szRetURL, int iTimeWindow, bool fForceLogin, string szCOBrandArgs, int iLangID, string strNameSpace, int iKPP, bool fUseSecureAuth, object oExtraParams) => 
            this.LoginUser(szRetURL, iTimeWindow, fForceLogin ? 1 : 0, szCOBrandArgs, iLangID, strNameSpace, iKPP, fUseSecureAuth ? 10 : 0, oExtraParams);
        ...
        public string LogoTag() => 
            this.LogoTag(null, -1, -1, null, -1, -1, null, -1, -1);

        public string LogoTag(string strReturnUrl) => 
            this.LogoTag(strReturnUrl, -1, -1, null, -1, -1, null, -1, -1);
        ...
        public string LogoTag(string strReturnUrl, int iTimeWindow, bool fForceLogin, string strCoBrandedArgs, int iLangID, bool fSecure, string strNameSpace, int iKPP, bool bUseSecureAuth) => 
            this.LogoTag(strReturnUrl, iTimeWindow, fForceLogin ? 1 : 0, strCoBrandedArgs, iLangID, fSecure ? 1 : 0, strNameSpace, iKPP, bUseSecureAuth ? 10 : 0);
        ...
        public string LogoTag2() => 
            this.LogoTag2(null, -1, -1, null, -1, -1, null, -1, -1);

        public string LogoTag2(string strReturnUrl) => 
            this.LogoTag2(strReturnUrl, -1, -1, null, -1, -1, null, -1, -1);
        ...
        public string LogoTag2(string strReturnUrl, int iTimeWindow, bool fForceLogin, string strCoBrandedArgs, int iLangID, bool fSecure, string strNameSpace, int iKPP, bool bUseSecureAuth) => 
            this.LogoTag2(strReturnUrl, iTimeWindow, fForceLogin ? 1 : 0, strCoBrandedArgs, iLangID, fSecure ? 1 : 0, strNameSpace, iKPP, bUseSecureAuth ? 10 : 0);
        ...
        public string LogoutURL() => 
            this.LogoutURL(null, null, -1, null, -1);
        ...
        public int Error =>
            System.Web.UnsafeNativeMethods.PassportGetError(this._iPassport);
