namespace System.Web.Security
{
    ...
    internal sealed class DirectoryInformation
    {
        ...
        private int clientSearchTimeout;
        ...
        private System.Web.Security.DirectoryType directoryType;
        ...
        internal DirectoryInformation(string adspath, NetworkCredential credentials, string connProtection, int clientSearchTimeout, int serverSearchTimeout, bool enablePasswordReset)
        {
            ...
            this.port = 0x185;
            this.directoryType = System.Web.Security.DirectoryType.Unknown;
            this.clientSearchTimeout = -1;
            this.serverSearchTimeout = -1;
            this.ldapAuthType = AuthType.Basic;
        ...
        Label_05DE:
            connection = new LdapConnection(new LdapDirectoryIdentifier(this.serverName + ":" + this.port), GetCredentialsWithDomain(credentials), this.ldapAuthType);
        ...
        internal System.DirectoryServices.AuthenticationTypes GetAuthenticationTypes(ActiveDirectoryConnectionProtection connectionProtection, CredentialsType type) => 
            this.authTypes[(int) connectionProtection, (int) type];
        ...
        internal AuthType GetLdapAuthenticationTypes(ActiveDirectoryConnectionProtection connectionProtection, CredentialsType type) => 
            this.ldapAuthTypes[(int) connectionProtection, (int) type];
        ...
        internal bool IsDefaultCredential() => 
            (((this.credentials.UserName == null) || (this.credentials.UserName.Length == 0)) && ((this.credentials.Password == null) || (this.credentials.Password.Length == 0)));
