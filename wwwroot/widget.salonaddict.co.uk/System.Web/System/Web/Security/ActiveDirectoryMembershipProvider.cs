namespace System.Web.Security
{
    ...
    [DirectoryServicesPermission(SecurityAction.LinkDemand, Unrestricted=true), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), DirectoryServicesPermission(SecurityAction.InheritanceDemand, Unrestricted=true), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class ActiveDirectoryMembershipProvider : MembershipProvider
    {
        ...
        private string Encrypt(string clearTextString)
        {
            ...
            return Convert.ToBase64String(this.EncryptPassword(dst));
        }
        ...
        private MembershipUser FindUserAndSAMAccountName(DirectoryEntry containerEntry, string filter, out DirectoryEntry userEntry, out bool resetBadPasswordAnswerAttributes, out string sAMAccountName) => 
            this.FindUser(containerEntry, filter, System.DirectoryServices.SearchScope.Subtree, true, out userEntry, out resetBadPasswordAnswerAttributes, out sAMAccountName);
        ...
        private DirectoryEntry FindUserEntryAndSAMAccountName(DirectoryEntry containerEntry, string filter, out string sAMAccountName) => 
            this.FindUserEntry(containerEntry, filter, System.DirectoryServices.SearchScope.Subtree, true, out sAMAccountName);
        ...
        public virtual string GeneratePassword() => 
            Membership.GeneratePassword((this.MinRequiredPasswordLength < 14) ? 14 : this.MinRequiredPasswordLength, this.MinRequiredNonAlphanumericCharacters);
        ...
        public override MembershipUserCollection GetAllUsers(int pageIndex, int pageSize, out int totalRecords) => 
            this.FindUsersByName("*", pageIndex, pageSize, out totalRecords);
        ...
        internal string GetEscapedFilterValue(string filterValue) => 
            this.GetEscapedFilterValue(filterValue, true);
