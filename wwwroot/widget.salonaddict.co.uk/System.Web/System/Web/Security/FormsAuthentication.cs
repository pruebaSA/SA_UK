namespace System.Web.Security
{
    ...
    public sealed class FormsAuthentication
    {
        ...
        public static FormsAuthenticationTicket Decrypt(string encryptedTicket)
        {
            ...
            {
                buf = MachineKeySection.EncryptOrDecryptData(false, buf, null, 0, buf.Length, IVType.Random);
                if (buf == null)
                {
                    return null;
                }
        ...
        public static HttpCookie GetAuthCookie(string userName, bool createPersistentCookie, string strCookiePath) => 
            GetAuthCookie(userName, createPersistentCookie, strCookiePath, true);
        ...
        internal static string GetLoginPage(string extraQueryString) => 
            GetLoginPage(extraQueryString, false);
        ...
        internal static string GetLoginPage(string extraQueryString, bool reuseReturnUrl)
        {
            ...
            if (str2 == null)
            {
                str2 = HttpUtility.UrlEncode(current.Request.PathWithQueryString, current.Request.ContentEncoding);
            }
            loginUrl = loginUrl + ReturnUrlVar + "=" + str2;
        ...
        internal static string GetReturnUrl(bool useDefaultIfAbsent)
        {
            Initialize();
            HttpContext current = HttpContext.Current;
            string str = current.Request.QueryString[ReturnUrlVar];
            if (str == null)
            {
                str = current.Request.Form[ReturnUrlVar];
