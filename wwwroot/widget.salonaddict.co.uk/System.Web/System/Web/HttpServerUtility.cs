namespace System.Web
{
    ...
    public sealed class HttpServerUtility
    {
        ...
        public void TransferRequest(string path, bool preserveForm, string method, NameValueCollection headers)
        {
            ...
            InternalSecurityPermissions.FileReadAccess(request.MapPath(path)).Demand();
            workerRequest.ScheduleExecuteUrl(path2.VirtualPathString, queryString, method, preserveForm, preserveForm ? request.EntityBody : null, headers);
