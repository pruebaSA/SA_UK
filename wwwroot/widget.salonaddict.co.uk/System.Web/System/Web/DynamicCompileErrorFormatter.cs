namespace System.Web
{
    ...
    internal class DynamicCompileErrorFormatter : ErrorFormatter
    {
        ...
        protected override string Description =>
            System.Web.SR.GetString("TmplCompilerErrorDesc");

        protected override string ErrorTitle =>
            System.Web.SR.GetString("TmplCompilerErrorTitle");
        ...
        protected override string MiscSectionContent
        {
            get
            {
                ...
                {
                    string str = System.Web.SR.GetString("TmplCompilerFatalError", new object[] { results.NativeCompilerReturnValue.ToString("G", CultureInfo.CurrentCulture) });
                ...
                if (results.Errors.HasErrors)
                {
                    ...
                    if (firstCompileError != null)
                    {
                        ...
                        builder.Append(FormatterWithFileInfo.GetSourceFileLines(firstCompileError.FileName, Encoding.Default, this._excep.SourceCode, firstCompileError.Line));
                ...
                if (results.Errors.HasWarnings)
                {
                    ...
                    foreach (CompilerError error2 in results.Errors)
                    {
                        if (error2.IsWarning)
                        {
                            ...
                            builder.Append("                  <td>\r\n");
                            builder.Append("                      <code><pre>\r\n\r\n");
                            builder.Append(FormatterWithFileInfo.GetSourceFileLines(error2.FileName, Encoding.Default, this._excep.SourceCode, error2.Line));
                            builder.Append("</pre></code>\r\n\r\n");
                            builder.Append("                  </td>\r\n");
                            builder.Append("               </tr>\r\n");
                            builder.Append("            </table>\r\n\r\n");
                ...
                if (!this._hideDetailedCompilerOutput)
                {
                    if ((results.Output.Count > 0) && HttpRuntime.HasAspNetHostingPermission(AspNetHostingPermissionLevel.Medium))
                    {
                        ...
                        foreach (string str4 in results.Output)
                        {
                    ...
                    if ((this._excep.SourceCode != null) && HttpRuntime.HasAspNetHostingPermission(AspNetHostingPermissionLevel.Medium))
                    {
                        ...
                        string[] strArray = this._excep.SourceCode.Split(new char[] { '\n' });
                        int num = 1;
        ...
        protected override string MiscSectionTitle =>
            System.Web.SR.GetString("TmplCompilerErrorSecTitle");
