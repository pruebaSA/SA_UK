namespace System.Web.Mail
{
    ...
    [Obsolete("The recommended alternative is System.Net.Mail.SmtpClient. http://go.microsoft.com/fwlink/?linkid=14202"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public class SmtpMail
    {
        ...
        internal class LateBoundAccessHelper
        {
            ...
            private static object CallMethod(Type type, object obj, string methodName, object[] args) => 
                type.InvokeMember(methodName, BindingFlags.InvokeMethod, null, obj, args, CultureInfo.InvariantCulture);
            ...
            internal object CreateInstance() => 
                Activator.CreateInstance(this.LateBoundType);
            ...
            internal static object GetPropStatic(object obj, string propName) => 
                GetProp(obj.GetType(), obj, propName);
