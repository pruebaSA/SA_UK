namespace System.Web.Management
{
    ...
    {
        private void FillBasicWmiDataFields(ref System.Web.UnsafeNativeMethods.WmiData wmiData, WebBaseEvent eventRaised)
        {
        ...
        private void FillErrorWmiDataFields(ref System.Web.UnsafeNativeMethods.WmiData wmiData, WebThreadInformation threadInfo)
        {
        ...
        private void FillRequestWmiDataFields(ref System.Web.UnsafeNativeMethods.WmiData wmiData, WebRequestInformation reqInfo)
        {
            string name;
        ...
        {
            int num = System.Web.UnsafeNativeMethods.InitializeWmiManager();
            if (num != 0)
            {
        ...
        {
            System.Web.UnsafeNativeMethods.WmiData wmiData = new System.Web.UnsafeNativeMethods.WmiData();
            ...
            int num = System.Web.UnsafeNativeMethods.RaiseWmiEvent(ref wmiData, AspCompatApplicationStep.IsInAspCompatMode);
            if (num != 0)
            {
