namespace System.Web.Management
{
    ...
    {
        [SecurityPermission(SecurityAction.Demand, Unrestricted=true), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
