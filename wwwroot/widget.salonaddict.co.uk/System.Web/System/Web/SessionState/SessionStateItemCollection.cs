namespace System.Web.SessionState
{
    ...
    public sealed class SessionStateItemCollection : NameObjectCollectionBase, ISessionStateItemCollection, ICollection, IEnumerable
    {
        ...
        internal static bool IsImmutable(object o) => 
            (s_immutableTypes[o.GetType()] != null);
        ...
        [SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.SerializationFormatter), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal)]
        private object ReadValueFromStreamWithAssert() => 
            AltSerialization.ReadValueFromStream(new BinaryReader(this._stream));
        ...
        [AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), SecurityPermission(SecurityAction.Assert, Flags=SecurityPermissionFlag.SerializationFormatter)]
