namespace System.Web.SessionState
{
    ...
    internal class SqlSessionStateStore : SessionStateStoreProviderBase
    {
        ...
        private const int SQL_SHUTDOWN_IN_PROGRESS = 0x1775;
        ...
        {
            if ((ex == null) || (((ex.Class < 20) && (ex.Number != 0xfdc)) && ((ex.Number != -2) && (ex.Number != 0x1775))))
            {
                return false;
            }
            return true;
        ...
        public override void CreateUninitializedItem(HttpContext context, string id, int timeout)
        {
            ...
            try
            {
                ...
                SessionStateUtility.SerializeStoreData(this.CreateNewStoreData(context, timeout), 0x1b58, out buffer, out num);
                ...
                {
                    this.HandleInsertException(conn.Connection, exception, true, id);
                }
            }
            finally
            {
        ...
        private SessionStateStoreData DoGet(HttpContext context, string id, bool getExclusive, out bool locked, out TimeSpan lockAge, out object lockId, out SessionStateActions actionFlags)
        {
            ...
            try
            {
                ...
                try
                {
                    if (IsRetryEnabled)
                    {
                        reader = SqlExecuteReaderWithRetry(cmd, CommandBehavior.Default);
                    }
                    else
                    {
        ...
        private SqlStateConnection GetConnection(string id, ref bool usePooling)
        {
            ...
            if (IsRetryEnabled)
            {
                return new SqlStateConnection(this._partitionInfo, AppSettings.SqlSessionRetryInterval);
            }
            return new SqlStateConnection(this._partitionInfo);
        }
        ...
        private void HandleInsertException(SqlConnection conn, Exception e, bool newItem, string id)
        {
            ...
            if (((exception == null) || (exception.Number != 0xa43)) || !newItem)
            {
        ...
        private static bool IsInsertPKException(SqlException ex, bool ignoreInsertPKException, string id) => 
            (((ex != null) && (ex.Number == 0xa43)) && ignoreInsertPKException);
        ...
        public override void ReleaseItemExclusive(HttpContext context, string id, object lockId)
        {
            ...
            try
            {
                ...
                {
                    ThrowSqlConnectionException(conn.Connection, exception);
                }
            }
            finally
            {
        ...
        public override void SetAndReleaseItemExclusive(HttpContext context, string id, SessionStateStoreData item, object lockId, bool newItem)
        {
            ...
            try
            {
                ...
                try
                {
                    SessionStateUtility.SerializeStoreData(item, 0x1b58, out buffer, out num);
                }
                catch
                {
                    if (!newItem)
                ...
                try
                {
                    ...
                    {
                        tempUpdateShort.ExecuteNonQuery();
                    }
                }
                catch (Exception exception)
                {
                    this.HandleInsertException(conn.Connection, exception, newItem, id);
                }
            }
            finally
            {
        ...
        private static bool IsRetryEnabled =>
            (AppSettings.SqlSessionRetryInterval.TotalSeconds >= 1.0);
        ...
        internal class SqlPartitionInfo : PartitionInfo
        {
            ...
            private void GetServerSupportOptions(SqlConnection sqlConnection)
            {
                ...
                try
                {
                    ...
                    {
                        reader = SqlSessionStateStore.SqlExecuteReaderWithRetry(cmd, CommandBehavior.SingleRow);
                    }
                    else
                    {
                ...
                {
                    SqlSessionStateStore.ThrowSqlConnectionException(sqlConnection, exception2);
                }
            }
        ...
        private class SqlStateConnection : IDisposable
        {
            ...
            internal SqlStateConnection(SqlSessionStateStore.SqlPartitionInfo sqlPartitionInfo)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    if ((exception2 != null) && (((exception2.Number == 0x4818) || (exception2.Number == 0x4814)) || (exception2.Number == 0x4812)))
                    {
                        string name;
                    ...
                    SqlSessionStateStore.ThrowSqlConnectionException(conn, exception);
                }
                try
                {
