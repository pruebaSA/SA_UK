namespace System.Web.SessionState
{
    ...
    internal sealed class InProcSessionStateStore : SessionStateStoreProviderBase
    {
        ...
        public override SessionStateStoreData GetItem(HttpContext context, string id, out bool locked, out TimeSpan lockAge, out object lockId, out SessionStateActions actionFlags) => 
            this.DoGet(context, id, false, out locked, out lockAge, out lockId, out actionFlags);

        public override SessionStateStoreData GetItemExclusive(HttpContext context, string id, out bool locked, out TimeSpan lockAge, out object lockId, out SessionStateActions actionFlags) => 
            this.DoGet(context, id, true, out locked, out lockAge, out lockId, out actionFlags);
