namespace System.Web.SessionState
{
    ...
    public sealed class StateRuntime : IStateRuntime
    {
        ...
        {
            StateHttpWorkerRequest wr = new StateHttpWorkerRequest(tracker, (System.Web.UnsafeNativeMethods.StateProtocolVerb) verb, uri, (System.Web.UnsafeNativeMethods.StateProtocolExclusive) exclusive, extraFlags, timeout, lockCookieExists, lockCookie, contentLength, content);
