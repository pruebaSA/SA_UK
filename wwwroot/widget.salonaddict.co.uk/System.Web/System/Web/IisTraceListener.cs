namespace System.Web
{
    ...
    [AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), HostProtection(SecurityAction.LinkDemand, Synchronization=true)]
