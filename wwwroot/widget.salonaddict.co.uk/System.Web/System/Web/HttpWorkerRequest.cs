namespace System.Web
{
    ...
    public abstract class HttpWorkerRequest
    {
        ...
        internal VirtualPath GetFilePathObject() => 
            VirtualPath.Create(this.GetFilePath(), VirtualPathOptions.AllowAbsolutePath | VirtualPathOptions.AllowNull);
        ...
        public static string GetKnownResponseHeaderName(int index) => 
            s_responseHeaderNames[index];

        public abstract string GetLocalAddress();
        public abstract int GetLocalPort();
        internal virtual string GetLocalPortAsString() => 
            this.GetLocalPort().ToString(NumberFormatInfo.InvariantInfo);
        ...
        internal static string GetServerVariableNameFromKnownRequestHeaderIndex(int index) => 
            s_serverVarFromRequestHeaderNames[index];
