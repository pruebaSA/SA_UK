namespace System.Web.Configuration
{
    ...
    [ConfigurationCollection(typeof(ProfileGroupSettings), AddItemName="group"), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class ProfileGroupSettingsCollection : ConfigurationElementCollection
    {
        ...
        protected override bool IsModified() => 
            (this.bModified || base.IsModified());
