namespace System.Web.Configuration
{
    ...
    public sealed class CodeSubDirectory : ConfigurationElement
    {
        ...
        [TypeConverter(typeof(WhiteSpaceTrimStringConverter)), ConfigurationProperty("directoryName", IsRequired=true, IsKey=true, DefaultValue="")]
        public string DirectoryName
        {
            get => 
                ((string) base[_propDirectoryName]);
            set
            {
