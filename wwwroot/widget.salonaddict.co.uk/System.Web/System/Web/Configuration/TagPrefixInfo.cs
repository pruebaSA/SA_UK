namespace System.Web.Configuration
{
    ...
    public sealed class TagPrefixInfo : ConfigurationElement
    {
        ...
        public override int GetHashCode() => 
            ((((this.TagPrefix.GetHashCode() ^ this.TagName.GetHashCode()) ^ this.Namespace.GetHashCode()) ^ this.Assembly.GetHashCode()) ^ this.Source.GetHashCode());
        ...
        [ConfigurationProperty("tagPrefix", IsRequired=true, DefaultValue="/"), StringValidator(MinLength=1)]
        public string TagPrefix
        {
            get => 
                ((string) base[_propTagPrefix]);
            set
            {
