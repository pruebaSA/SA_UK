namespace System.Web.Configuration
{
    ...
    [ConfigurationCollection(typeof(ProfilePropertySettings)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class RootProfilePropertySettingsCollection : ProfilePropertySettingsCollection
    {
        ...
        public override int GetHashCode() => 
            HashCodeCombiner.CombineHashCodes(base.GetHashCode(), this.GroupSettings.GetHashCode());
        ...
        protected override void Unmerge(ConfigurationElement sourceElement, ConfigurationElement parentElement, ConfigurationSaveMode saveMode)
        {
            ...
            this.GroupSettings.InternalUnMerge(settingss2.GroupSettings, settingss?.GroupSettings, saveMode);
        }
