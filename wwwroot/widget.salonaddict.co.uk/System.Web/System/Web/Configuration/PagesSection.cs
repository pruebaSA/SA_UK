namespace System.Web.Configuration
{
    ...
    public sealed class PagesSection : ConfigurationSection
    {
        ...
        [TypeConverter(typeof(TimeSpanSecondsConverter)), TimeSpanValidator(MinValueString="00:00:00", MaxValueString="10675199.02:48:05.4775807"), ConfigurationProperty("asyncTimeout", DefaultValue="00:00:45")]
        public TimeSpan AsyncTimeout
        {
            get => 
                ((TimeSpan) base[_propAsyncTimeout]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propAutoEventWireup]);
            set
            {
        ...
        {
            get => 
                ((System.Web.UI.CompilationMode) base[_propCompilationMode]);
            set
            {
        ...
        public TagPrefixCollection Controls =>
            ((TagPrefixCollection) base[_propControls]);

        internal static ICollection DefaultTagNamespaceRegisterEntries
        {
            get
            {
                TagNamespaceRegisterEntry entry = new TagNamespaceRegisterEntry("asp", "System.Web.UI.WebControls", "System.Web, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a");
                TagNamespaceRegisterEntry entry2 = new TagNamespaceRegisterEntry("mobile", "System.Web.UI.MobileControls", "System.Web.Mobile, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a");
        ...
        {
            get => 
                ((bool) base[_propEnableEventValidation]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propEnableViewState]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propEnableViewStateMac]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propMaintainScrollPosition]);
            set
            {
        ...
        {
            get => 
                ((string) base[_propMasterPageFile]);
            set
            {
        ...
        {
            get => 
                ((int) base[_propMaxPageStateFieldLength]);
            set
            {
        ...
        {
            get => 
                ((string) base[_propPageParserFilterType]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propRenderAllHiddenFieldsAtTopOfForm]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propSmartNavigation]);
            set
            {
        ...
        {
            get => 
                ((string) base[_propStyleSheetTheme]);
            set
            {
        ...
        public TagMapCollection TagMapping =>
            ((TagMapCollection) base[_propTagMapping]);
        ...
        {
            get => 
                ((string) base[_propUserControlBaseType]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propValidateRequest]);
            set
            {
        ...
        {
            get => 
                ((System.Web.UI.ViewStateEncryptionMode) base[_propViewStateEncryptionMode]);
            set
            {
