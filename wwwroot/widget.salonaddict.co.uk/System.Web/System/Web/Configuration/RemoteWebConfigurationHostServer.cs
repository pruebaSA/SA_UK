namespace System.Web.Configuration
{
    ...
    [ClassInterface(ClassInterfaceType.AutoDual), Guid("8DEC0FA2-CC19-494F-8613-1F6221C0C5AB"), ComVisible(true), ProgId("System.Web.Configuration.RemoteWebConfigurationHostServer_32"), AspNetHostingPermission(SecurityAction.InheritanceDemand, Level=AspNetHostingPermissionLevel.Minimal), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal), SecurityPermission(SecurityAction.Demand, Unrestricted=true)]
    public class RemoteWebConfigurationHostServer : IRemoteWebConfigurationHostServer
    {
        ...
        public string GetFilePaths(int webLevelAsInt, string path, string site, string locationSubPath)
        {
            ...
            ArrayList list = new ArrayList {
                VirtualPath.GetVirtualPathString(path3),
                str,
                str2,
                str3,
                str4
