namespace System.Web.Configuration
{
    ...
    public sealed class CustomErrorsSection : ConfigurationSection
    {
        ...
        {
            get => 
                ((string) base[_propDefaultRedirect]);
            set
            {
        ...
        public CustomErrorCollection Errors =>
            ((CustomErrorCollection) base[_propErrors]);

        [ConfigurationProperty("mode", DefaultValue=0)]
        public CustomErrorsMode Mode
        {
            get => 
                ((CustomErrorsMode) base[_propMode]);
            set
            {
        ...
        {
            get => 
                ((CustomErrorsRedirectMode) base[_propRedirectMode]);
            set
            {
