namespace System.Web.Configuration
{
    ...
    public sealed class CompilationSection : ConfigurationSection
    {
        ...
        private AssemblyCollection GetAssembliesCollection() => 
            ((AssemblyCollection) base[_propAssemblies]);
        ...
        internal Assembly[] LoadAssembly(AssemblyInfo ai)
        {
            ...
            if (assembly != null)
            {
                assemblyArray = new Assembly[] { assembly };
            }
            return assemblyArray;
        }
                ...
                if (((publicKeyToken == null) || (publicKeyToken.Length == 0)) && (name.Version == null))
                {
                    ...
                    foreach (AssemblyInfo info in this.GetAssembliesCollection())
                    {
                        ...
                        if (assemblyInternal != null)
                        {
                            ...
                            {
                                if (System.Web.Util.StringUtil.EqualsIgnoreCase(name.Name, assemblyInternal[i].GetName().Name))
                                {
        ...
        {
            get => 
                ((string) base[_propAssemblyPreprocessorType]);
            set
            {
        ...
        {
            get => 
                ((TimeSpan) base[_propBatchTimeout]);
            set
            {
        ...
        {
            get => 
                ((string) base[_propDefaultLanguage]);
            set
            {
        ...
        {
            get => 
                ((int) base[_propNumRecompilesBeforeAppRestart]);
            set
            {
        ...
        {
            get => 
                ((bool) base[_propOptimizeCompilations]);
            set
            {
        ...
        {
            get => 
                ((string) base[_propTempDirectory]);
            set
            {
