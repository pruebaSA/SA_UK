namespace System.Web.Configuration
{
    ...
    [ConfigurationCollection(typeof(TransformerInfo)), AspNetHostingPermission(SecurityAction.LinkDemand, Level=AspNetHostingPermissionLevel.Minimal)]
    public sealed class TransformerInfoCollection : ConfigurationElementCollection
    {
        ...
        {
            get => 
                ((TransformerInfo) base.BaseGet(index));
            set
            {
