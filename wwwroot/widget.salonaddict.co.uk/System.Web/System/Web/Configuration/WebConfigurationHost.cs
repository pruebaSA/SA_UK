namespace System.Web.Configuration
{
    ...
    internal sealed class WebConfigurationHost : DelegatingConfigHost, IInternalConfigWebHost
    {
        ...
        public override object CreateConfigurationContext(string configPath, string locationSubPath) => 
            new WebContext(this.GetPathLevel(configPath), this._appSiteName, VirtualPath.GetVirtualPathString(this._appPath), VPathFromConfigPath(configPath), locationSubPath, this._appConfigPath);

        public override object CreateDeprecatedConfigContext(string configPath) => 
            new HttpConfigurationContext(VPathFromConfigPath(configPath));
        ...
        public override Type GetConfigType(string typeName, bool throwOnError) => 
            BuildManager.GetType(typeName, throwOnError);

        public override string GetConfigTypeName(Type t) => 
            BuildManager.GetNormalizedTypeName(t);
        ...
        public override bool IsAboveApplication(string configPath) => 
            (this.GetPathLevel(configPath) == WebApplicationLevel.AboveApplication);
        ...
        internal static bool IsMachineConfigPath(string configPath) => 
            (configPath.Length == "machine".Length);

        internal static bool IsRootWebConfigPath(string configPath) => 
            (configPath.Length == "machine/webroot".Length);
        ...
        public override bool PrefetchSection(string sectionGroupName, string sectionName) => 
            ((System.Web.Util.StringUtil.StringStartsWith(sectionGroupName, "system.web") && ((sectionGroupName.Length == "system.web".Length) || (sectionGroupName["system.web".Length] == '/'))) || (string.IsNullOrEmpty(sectionGroupName) && (sectionName == "system.codedom")));
        ...
        string IInternalConfigWebHost.GetConfigPathFromSiteIDAndVPath(string siteID, string vpath) => 
            GetConfigPathFromSiteIDAndVPath(siteID, VirtualPath.CreateAbsoluteAllowNull(vpath));
        ...
        internal static IInternalConfigConfigurationFactory ConfigurationFactory
        {
            ...
            get
            {
                ...
                {
                    s_configurationFactory = (IInternalConfigConfigurationFactory) Activator.CreateInstance(Type.GetType("System.Configuration.Internal.InternalConfigConfigurationFactory, System.Configuration, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", true), true);
                }
