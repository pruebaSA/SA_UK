namespace System.Web.Configuration
{
    ...
    internal class FileDetails
    {
        ...
        public override int GetHashCode() => 
            HashCodeCombiner.CombineHashCodes(this._exists.GetHashCode(), this._fileSize.GetHashCode(), this._utcCreationTime.GetHashCode(), this._utcLastWriteTime.GetHashCode());
    }
}
