namespace System.Web
{
    ...
    public sealed class HttpResponse
    {
        ...
        {
            AggregateCacheDependency dependency2;
            CacheDependency dependency = this._cacheItemDependencyList.CreateCacheDependency(CacheDependencyType.CacheItems, dependencyVary);
            ...
            if (this._aggDependency != null)
            {
                dependency2 = this._aggDependency;
            }
            else
            {
        ...
        internal string[] GetCacheItemDependencies() => 
            this._cacheItemDependencyList.GetDependencies();
        ...
        internal ErrorFormatter GetErrorFormatter(Exception e)
        {
            ...
            if (errorFormatter == null)
            {
                ...
                else if (this._statusCode == 0x193)
                {
            ...
            ConfigErrorFormatter formatter2 = errorFormatter as ConfigErrorFormatter;
            if (formatter2 != null)
            {
                formatter2.AllowSourceCode = this.Request.IsLocal;
            }
            return errorFormatter;
        }

        internal string[] GetFileDependencies() => 
            this._fileDependencyList.GetDependencies();
        ...
        internal CacheDependency GetVirtualPathDependency() => 
            this._virtualPathDependencyList.CreateCacheDependency(CacheDependencyType.VirtualPaths, null);

        internal bool HasCacheItemDependencies() => 
            this._cacheItemDependencyList.HasDependencies();

        internal bool HasFileDependencies() => 
            this._fileDependencyList.HasDependencies();
        ...
        internal bool IsBuffered() => 
            (!this._headersWritten && this.UsingHttpWriter);
        ...
        public void Redirect(string url, bool endResponse)
        {
            ...
            this.Clear();
            if (((handler != null) && handler.IsPostBack) && (handler.SmartNavigation && (this.Request["__smartNavPostBack"] == "true")))
            {
        ...
        internal void ReportRuntimeError(Exception e, bool canThrow, bool localExecute)
        {
            ...
            if (!this._completed)
            {
                ...
                if (!this._headersWritten)
                {
                    ...
                    {
                        string redirectString = settings?.GetRedirectString(code);
                        if ((redirectString == null) || !this.RedirectToErrorPage(redirectString, settings.RedirectMode))
                        {
                            this.ClearAll();
                            this.StatusCode = code;
        ...
        private string UrlEncodeRedirect(string url)
        {
            ...
            if (index >= 0)
            {
                ...
                url = HttpUtility.UrlEncodeSpaces(HttpUtility.UrlEncodeNonAscii(url.Substring(0, index), Encoding.UTF8)) + HttpUtility.UrlEncodeNonAscii(url.Substring(index), e);
                return url;
            }
        ...
        public bool IsRequestBeingRedirected =>
            this._isRequestBeingRedirected;
        ...
        {
            get => 
                (this.StatusCode.ToString(NumberFormatInfo.InvariantInfo) + " " + this.StatusDescription);
            set
            {
                int num = 200;
                string str = "OK";
        ...
        {
            get => 
                ((this._wr != null) && this._wr.TrySkipIisCustomErrors);
            set
            {
                if (this._wr != null)
                {
        ...
        private bool UsingHttpWriter =>
            ((this._httpWriter != null) && (this._writer == this._httpWriter));
    }
}
