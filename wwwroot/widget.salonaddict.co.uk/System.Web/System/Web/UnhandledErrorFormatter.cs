namespace System.Web
{
    ...
    internal class UnhandledErrorFormatter : ErrorFormatter
    {
                    ...
                    for (int i = this._exStack.Count - 1; i >= 0; i--)
                    {
                        ...
                        for (int j = 0; j < trace.FrameCount; j++)
                        {
                            ...
                            if (declaringType != null)
                            {
                                ...
                                if (((path != null) && (string.Compare(Path.GetDirectoryName(path), HttpRuntime.CodegenDirInternal, StringComparison.OrdinalIgnoreCase) == 0)) && (frame.GetNativeOffset() > 0))
                                {
                            ...
                            if (fileName != null)
                            {
                                ...
                                if (fileName != null)
                                {
                                    ...
                                    builder.Append(string.Concat(new object[] { " in ", HttpRuntime.GetSafePath(fileName), ":", frame.GetFileLineNumber() }));
                                }
                            }
                            else
                            {
                                builder.Append(" +" + frame.GetNativeOffset());
                            }
                            if (flag)
                            {
        ...
        protected override string ColoredSquare2Title =>
            System.Web.SR.GetString("Unhandled_Err_Stack_Trace");
        ...
        protected override string ColoredSquareTitle =>
            System.Web.SR.GetString("TmplCompilerSourceSecTitle");
        ...
        protected override string MiscSectionTitle =>
            System.Web.SR.GetString("Unhandled_Err_Exception_Details");
