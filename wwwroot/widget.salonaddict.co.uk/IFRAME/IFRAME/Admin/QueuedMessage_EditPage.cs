namespace IFRAME.Admin
{
    ...
    public class QueuedMessage_EditPage : IFRMAdminPage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (!IFRMHelper.InitiateDelivery(queuedMessageById, base.Request.Url.IsLoopback))
            {
                queuedMessageById.SendTries++;
                IoC.Resolve<IMessageManager>().UpdateQueuedMessage(queuedMessageById);
            }
            else
            {
