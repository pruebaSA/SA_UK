namespace IFRAME.Admin.SalonManagement
{
    ...
    public class Opening_HoursPage : IFRMAdminPage
    {
        ...
        private void BindOpeningHours(SalonDB salon)
        {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (this.Page.IsValid)
            {
                ...
                OpeningHoursDB openingHoursBySalonId = IoC.Resolve<ISalonManager>().GetOpeningHoursBySalonId(salonById.SalonId);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                this.BindOpeningHours(salonById);
            }
        }
