namespace IFRAME.SecureArea
{
    ...
    public class Employee_EditPage : IFRMSecurePage
    {
        ...
        private void BindEmployeeServiceMappings(EmployeeDB employee)
        {
            ...
            IEnumerable<Employee_Service_MappingDB> source = from item in IoC.Resolve<IEmployeeManager>().GetEmployeeServiceMappingBySalonId(salon.SalonId)
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack)
            {
                ...
                this.BindEmployeeAvailability(salon, employee);
                this.BindServices(salon);
