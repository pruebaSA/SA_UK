namespace System
{
    ...
    public sealed class TimeZoneInfo : IEquatable<TimeZoneInfo>, ISerializable, IDeserializationCallback
    {
        ...
        public static DateTime ConvertTime(DateTime dateTime, TimeZoneInfo sourceTimeZone, TimeZoneInfo destinationTimeZone) => 
            ConvertTime(dateTime, sourceTimeZone, destinationTimeZone, TimeZoneInfoOptions.None);
        ...
        internal static DateTime ConvertTime(DateTime dateTime, TimeZoneInfo sourceTimeZone, TimeZoneInfo destinationTimeZone, TimeZoneInfoOptions flags)
        {
            ...
            {
                throw new ArgumentException(System.SR.GetString("Argument_ConvertMismatch"), "sourceTimeZone");
            }
            ...
            if (adjustmentRuleForTime != null)
            {
                ...
                {
                    throw new ArgumentException(System.SR.GetString("Argument_DateTimeIsInvalid"), "dateTime");
                }
        ...
        private static AdjustmentRule CreateAdjustmentRuleFromTimeZoneInformation(Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation timeZoneInformation, DateTime startDate, DateTime endDate)
        {
        ...
        public static TimeZoneInfo CreateCustomTimeZone(string id, TimeSpan baseUtcOffset, string displayName, string standardDisplayName) => 
            new TimeZoneInfo(id, baseUtcOffset, displayName, standardDisplayName, standardDisplayName, null, false);
        ...
        public static TimeZoneInfo CreateCustomTimeZone(string id, TimeSpan baseUtcOffset, string displayName, string standardDisplayName, string daylightDisplayName, AdjustmentRule[] adjustmentRules) => 
            new TimeZoneInfo(id, baseUtcOffset, displayName, standardDisplayName, daylightDisplayName, adjustmentRules, false);
        ...
        public static TimeZoneInfo CreateCustomTimeZone(string id, TimeSpan baseUtcOffset, string displayName, string standardDisplayName, string daylightDisplayName, AdjustmentRule[] adjustmentRules, bool disableDaylightSavingTime) => 
            new TimeZoneInfo(id, baseUtcOffset, displayName, standardDisplayName, daylightDisplayName, adjustmentRules, disableDaylightSavingTime);

        public bool Equals(TimeZoneInfo other) => 
            (((other != null) && (string.Compare(this.m_id, other.m_id, StringComparison.OrdinalIgnoreCase) == 0)) && this.HasSameRules(other));
        ...
        public static TimeZoneInfo FromSerializedString(string source)
        {
            ...
            if (source.Length == 0)
            {
                throw new ArgumentException(System.SR.GetString("Argument_InvalidSerializedString", new object[] { source }), "source");
            }
        ...
        public TimeSpan[] GetAmbiguousTimeOffsets(DateTime dateTime)
        {
            ...
            {
                throw new ArgumentException(System.SR.GetString("Argument_DateTimeIsNotAmbiguous"), "dateTime");
            }
        ...
        public TimeSpan[] GetAmbiguousTimeOffsets(DateTimeOffset dateTimeOffset)
        {
            if (!this.m_supportsDaylightSavingTime)
            {
                throw new ArgumentException(System.SR.GetString("Argument_DateTimeOffsetIsNotAmbiguous"), "dateTimeOffset");
            }
        ...
        public override int GetHashCode() => 
            this.m_id.ToUpperInvariant().GetHashCode();
        ...
        private static TimeZoneInfo GetLocalTimeZone()
        {
            ...
            try
            {
                ...
                Microsoft.Win32.NativeMethods.DynamicTimeZoneInformation lpDynamicTimeZoneInformation = new Microsoft.Win32.NativeMethods.DynamicTimeZoneInformation();
                long dynamicTimeZoneInformation = Microsoft.Win32.UnsafeNativeMethods.GetDynamicTimeZoneInformation(out lpDynamicTimeZoneInformation);
                if (dynamicTimeZoneInformation == -1L)
                {
                    return CreateCustomTimeZone("Local", TimeSpan.Zero, "Local", "Local");
                }
                Microsoft.Win32.NativeMethods.TimeZoneInformation timeZone = new Microsoft.Win32.NativeMethods.TimeZoneInformation(lpDynamicTimeZoneInformation);
            ...
            catch (EntryPointNotFoundException)
            {
                ...
                Microsoft.Win32.NativeMethods.TimeZoneInformation lpTimeZoneInformation = new Microsoft.Win32.NativeMethods.TimeZoneInformation();
                long timeZoneInformation = Microsoft.Win32.UnsafeNativeMethods.GetTimeZoneInformation(out lpTimeZoneInformation);
        ...
        private static TimeZoneInfo GetTimeZone(string id)
        {
            ...
            {
                throw new TimeZoneNotFoundException(System.SR.GetString("TimeZoneNotFound_MissingRegistryData", new object[] { id }));
            }
            switch (TryGetTimeZone(id, false, out info, out exception))
            {
                ...
                case TimeZoneInfoResult.InvalidTimeZoneException:
                    throw new InvalidTimeZoneException(System.SR.GetString("InvalidTimeZone_InvalidRegistryData", new object[] { id }), exception);

                case TimeZoneInfoResult.SecurityException:
                    throw new SecurityException(System.SR.GetString("Security_CannotReadRegistryData", new object[] { id }), exception);
            }
            throw new TimeZoneNotFoundException(System.SR.GetString("TimeZoneNotFound_MissingRegistryData", new object[] { id }), exception);
        }
        ...
        void IDeserializationCallback.OnDeserialization(object sender)
        {
            try
            {
                ...
                {
                    throw new SerializationException(System.SR.GetString("Serialization_CorruptField", new object[] { "SupportsDaylightSavingTime" }));
                }
            }
            catch (ArgumentException exception)
            {
                throw new SerializationException(System.SR.GetString("Serialization_InvalidData"), exception);
            }
            catch (InvalidTimeZoneException exception2)
            {
                throw new SerializationException(System.SR.GetString("Serialization_InvalidData"), exception2);
            }
        }
        ...
        public string ToSerializedString() => 
            StringSerializer.GetSerializedString(this);
        ...
        private static bool TryCompareTimeZoneInformationToRegistry(Microsoft.Win32.NativeMethods.TimeZoneInformation timeZone, string id, out bool dstDisabled)
        {
            ...
            try
            {
                ...
                {
                    Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation information;
                    if (key == null)
                    {
                        return false;
                    }
                    try
                    {
                        information = new Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation((byte[]) key.GetValue("TZI", null, RegistryValueOptions.None));
                    }
                    catch (InvalidCastException)
                    {
                        return false;
        ...
        private static bool TryCreateAdjustmentRules(string id, Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation defaultTimeZoneInformation, out AdjustmentRule[] rules, out Exception e)
        {
            e = null;
            try
            {
                using (RegistryKey key = Registry.LocalMachine.OpenSubKey(string.Format(CultureInfo.InvariantCulture, @"{0}\{1}\Dynamic DST", new object[] { @"SOFTWARE\Microsoft\Windows NT\CurrentVersion\Time Zones", id }), RegistryKeyPermissionCheck.Default, RegistryRights.ExecuteKey))
                {
                    ...
                    Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation timeZoneInformation = new Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation((byte[]) key.GetValue(year.ToString(CultureInfo.InvariantCulture), null, RegistryValueOptions.None));
                    if (year == num2)
                    {
                    ...
                    {
                        timeZoneInformation = new Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation((byte[]) key.GetValue(i.ToString(CultureInfo.InvariantCulture), null, RegistryValueOptions.None));
                    ...
                    timeZoneInformation = new Microsoft.Win32.NativeMethods.RegistryTimeZoneInformation((byte[]) key.GetValue(num2.ToString(CultureInfo.InvariantCulture), null, RegistryValueOptions.None));
        ...
        private static string TryGetLocalizedNameByMuiNativeResource(string resource)
        {
            ...
            try
            {
                ...
                long enumerator = 0L;
                if (!Microsoft.Win32.UnsafeNativeMethods.GetFileMUIPath(0x10, str, null, ref languageLength, fileMuiPath, ref fileMuiPathLength, ref enumerator))
                {
                    return string.Empty;
                }
        ...
        private static string TryGetLocalizedNameByNativeResource(string filePath, int resource)
        {
            ...
            {
                using (SafeLibraryHandle handle = Microsoft.Win32.UnsafeNativeMethods.LoadLibraryEx(filePath, IntPtr.Zero, 2))
                {
                    if (!handle.IsInvalid)
                    {
                        ...
                        if (Microsoft.Win32.UnsafeNativeMethods.LoadString(handle, resource, buffer, buffer.Length) != 0)
                        {
        ...
        private static void ValidateTimeZoneInfo(string id, TimeSpan baseUtcOffset, AdjustmentRule[] adjustmentRules, out bool adjustmentRulesSupportDst)
        {
            ...
            if (id.Length == 0)
            {
                throw new ArgumentException(System.SR.GetString("Argument_InvalidId", new object[] { id }), "id");
            }
            if (UtcOffsetOutOfRange(baseUtcOffset))
            {
                throw new ArgumentOutOfRangeException("baseUtcOffset", System.SR.GetString("ArgumentOutOfRange_UtcOffset"));
            }
            if ((baseUtcOffset.Ticks % 0x23c34600L) != 0L)
            {
                throw new ArgumentException(System.SR.GetString("Argument_TimeSpanHasSeconds"), "baseUtcOffset");
            }
            if ((adjustmentRules != null) && (adjustmentRules.Length != 0))
            {
                ...
                for (int i = 0; i < adjustmentRules.Length; i++)
                {
                    ...
                    if (rule2 == null)
                    {
                        throw new InvalidTimeZoneException(System.SR.GetString("Argument_AdjustmentRulesNoNulls"));
                    }
                    if (UtcOffsetOutOfRange(baseUtcOffset + rule2.DaylightDelta))
                    {
                        throw new InvalidTimeZoneException(System.SR.GetString("ArgumentOutOfRange_UtcOffsetAndDaylightDelta"));
                    }
                    if ((rule != null) && (rule2.DateStart <= rule.DateEnd))
                    {
                        throw new InvalidTimeZoneException(System.SR.GetString("Argument_AdjustmentRulesOutOfOrder"));
                    }
                }
            }
        }
        ...
        public bool SupportsDaylightSavingTime =>
            this.m_supportsDaylightSavingTime;
        ...
        public sealed class AdjustmentRule : IEquatable<TimeZoneInfo.AdjustmentRule>, ISerializable, IDeserializationCallback
        {
            ...
            public bool Equals(TimeZoneInfo.AdjustmentRule other) => 
                ((((((other != null) && (this.m_dateStart == other.m_dateStart)) && (this.m_dateEnd == other.m_dateEnd)) && (this.m_daylightDelta == other.m_daylightDelta)) && this.m_daylightTransitionEnd.Equals(other.m_daylightTransitionEnd)) && this.m_daylightTransitionStart.Equals(other.m_daylightTransitionStart));

            public override int GetHashCode() => 
                this.m_dateStart.GetHashCode();
            ...
            private static void ValidateAdjustmentRule(DateTime dateStart, DateTime dateEnd, TimeSpan daylightDelta, TimeZoneInfo.TransitionTime daylightTransitionStart, TimeZoneInfo.TransitionTime daylightTransitionEnd)
            {
                ...
                {
                    throw new ArgumentException(System.SR.GetString("Argument_DateTimeKindMustBeUnspecified"), "dateStart");
                }
                if (dateEnd.Kind != DateTimeKind.Unspecified)
                {
                    throw new ArgumentException(System.SR.GetString("Argument_DateTimeKindMustBeUnspecified"), "dateEnd");
                }
                if (daylightTransitionStart.Equals(daylightTransitionEnd))
                {
                    throw new ArgumentException(System.SR.GetString("Argument_TransitionTimesAreIdentical"), "daylightTransitionEnd");
                }
                if (dateStart > dateEnd)
                {
                    throw new ArgumentException(System.SR.GetString("Argument_OutOfOrderDateTimes"), "dateStart");
                }
                if (TimeZoneInfo.UtcOffsetOutOfRange(daylightDelta))
                {
                    throw new ArgumentOutOfRangeException("daylightDelta", daylightDelta, System.SR.GetString("ArgumentOutOfRange_UtcOffset"));
                }
                if ((daylightDelta.Ticks % 0x23c34600L) != 0L)
                {
                    throw new ArgumentException(System.SR.GetString("Argument_TimeSpanHasSeconds"), "daylightDelta");
                }
                if (dateStart.TimeOfDay != TimeSpan.Zero)
                {
                    throw new ArgumentException(System.SR.GetString("Argument_DateTimeHasTimeOfDay"), "dateStart");
                }
                if (dateEnd.TimeOfDay != TimeSpan.Zero)
                {
                    throw new ArgumentException(System.SR.GetString("Argument_DateTimeHasTimeOfDay"), "dateEnd");
                }
            }
        ...
        private sealed class StringSerializer
        {
            ...
            private TimeZoneInfo.AdjustmentRule[] GetNextAdjustmentRuleArrayValue(bool canEndWithoutSeparator)
            {
                ...
                if (!canEndWithoutSeparator)
                {
                    ...
                    {
                        throw new SerializationException(System.SR.GetString("Serialization_InvalidData"));
                    }
            ...
            private string GetNextStringValue(bool canEndWithoutSeparator)
            {
                ...
                if (notEscaped == State.Escaped)
                {
                    throw new SerializationException(System.SR.GetString("Serialization_InvalidEscapeSequence", new object[] { string.Empty }));
                }
                if (!canEndWithoutSeparator)
                {
                    throw new SerializationException(System.SR.GetString("Serialization_InvalidData"));
            ...
            private static void VerifyIsEscapableCharacter(char c)
            {
                if (((c != '\\') && (c != ';')) && ((c != '[') && (c != ']')))
                {
                    throw new SerializationException(System.SR.GetString("Serialization_InvalidEscapeSequence", new object[] { c }));
                }
            }
        ...
        public struct TransitionTime : IEquatable<TimeZoneInfo.TransitionTime>, ISerializable, IDeserializationCallback
        {
            ...
            public bool IsFixedDateRule =>
                this.m_isFixedDateRule;
            public override bool Equals(object obj) => 
                ((obj is TimeZoneInfo.TransitionTime) && this.Equals((TimeZoneInfo.TransitionTime) obj));
            ...
            public static TimeZoneInfo.TransitionTime CreateFloatingDateRule(DateTime timeOfDay, int month, int week, System.DayOfWeek dayOfWeek) => 
                CreateTransitionTime(timeOfDay, month, week, 1, dayOfWeek, false);
            ...
            private static void ValidateTransitionTime(DateTime timeOfDay, int month, int week, int day, System.DayOfWeek dayOfWeek)
            {
                ...
                {
                    throw new ArgumentException(System.SR.GetString("Argument_DateTimeKindMustBeUnspecified"), "timeOfDay");
                }
                if ((month < 1) || (month > 12))
                {
                    throw new ArgumentOutOfRangeException("month", System.SR.GetString("ArgumentOutOfRange_Month"));
                }
                if ((day < 1) || (day > 0x1f))
                {
                    throw new ArgumentOutOfRangeException("day", System.SR.GetString("ArgumentOutOfRange_Day"));
                }
                if ((week < 1) || (week > 5))
                {
                    throw new ArgumentOutOfRangeException("week", System.SR.GetString("ArgumentOutOfRange_Week"));
                }
                if ((dayOfWeek < System.DayOfWeek.Sunday) || (dayOfWeek > System.DayOfWeek.Saturday))
                {
                    throw new ArgumentOutOfRangeException("dayOfWeek", System.SR.GetString("ArgumentOutOfRange_DayOfWeek"));
                }
                if (((timeOfDay.Year != 1) || (timeOfDay.Month != 1)) || ((timeOfDay.Day != 1) || ((timeOfDay.Ticks % 0x2710L) != 0L)))
                {
                    throw new ArgumentException(System.SR.GetString("Argument_DateTimeHasTicks"), "timeOfDay");
                }
            }
