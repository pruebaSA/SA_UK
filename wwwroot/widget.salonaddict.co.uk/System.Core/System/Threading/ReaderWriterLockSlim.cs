namespace System.Threading
{
    ...
    public class ReaderWriterLockSlim : IDisposable
    {
        ...
        private static bool IsRWEntryEmpty(ReaderWriterCount rwc) => 
            ((rwc.threadid == -1) || (((rwc.readercount == 0) && (rwc.rc == null)) || (((rwc.readercount == 0) && (rwc.rc.writercount == 0)) && (rwc.rc.upgradecount == 0))));

        private static bool IsRwHashEntryChanged(ReaderWriterCount lrwc, int id) => 
            (lrwc.threadid != id);

        private bool IsWriterAcquired() => 
            ((this.owners & 0xbfffffff) == 0);
        ...
        public bool IsUpgradeableReadLockHeld =>
            (this.RecursiveUpgradeCount > 0);

        public bool IsWriteLockHeld =>
            (this.RecursiveWriteCount > 0);
        ...
        public int WaitingReadCount =>
            ((int) this.numReadWaiters);

        public int WaitingUpgradeCount =>
            ((int) this.numUpgradeWaiters);

        public int WaitingWriteCount =>
            ((int) this.numWriteWaiters);
    }
}
