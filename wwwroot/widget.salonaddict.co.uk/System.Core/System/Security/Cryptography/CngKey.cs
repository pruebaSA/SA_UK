namespace System.Security.Cryptography
{
    ...
    public sealed class CngKey : IDisposable
    {
        ...
        internal KeyContainerPermission BuildKeyContainerPermission(KeyContainerPermissionFlags flags)
        {
            ...
            {
                KeyContainerPermissionAccessEntry entry = new KeyContainerPermissionAccessEntry(keyContainerName, flags) {
                    ProviderName = str2
                };
                return new KeyContainerPermission(KeyContainerPermissionFlags.NoFlags) { AccessEntries = { entry } };
            }
            return new KeyContainerPermission(flags);
        }

        public static CngKey Create(CngAlgorithm algorithm) => 
            Create(algorithm, null);

        public static CngKey Create(CngAlgorithm algorithm, string keyName) => 
            Create(algorithm, keyName, null);
        ...
        public static CngKey Create(CngAlgorithm algorithm, string keyName, CngKeyCreationParameters creationParameters)
        {
            ...
            if (keyName != null)
            {
                KeyContainerPermissionAccessEntry entry = new KeyContainerPermissionAccessEntry(keyName, KeyContainerPermissionFlags.Create) {
                    ProviderName = creationParameters.Provider.Provider
                };
                new KeyContainerPermission(KeyContainerPermissionFlags.NoFlags) { AccessEntries = { entry } }.Demand();
            }
        ...
        public static bool Exists(string keyName) => 
            Exists(keyName, CngProvider.MicrosoftSoftwareKeyStorageProvider);

        public static bool Exists(string keyName, CngProvider provider) => 
            Exists(keyName, provider, CngKeyOpenOptions.None);
        ...
        public static CngKey Import(byte[] keyBlob, CngKeyBlobFormat format) => 
            Import(keyBlob, format, CngProvider.MicrosoftSoftwareKeyStorageProvider);
        ...
        public static CngKey Open(string keyName) => 
            Open(keyName, CngProvider.MicrosoftSoftwareKeyStorageProvider);
        ...
        public static CngKey Open(string keyName, CngProvider provider) => 
            Open(keyName, provider, CngKeyOpenOptions.None);
        ...
        public static CngKey Open(string keyName, CngProvider provider, CngKeyOpenOptions openOptions)
        {
            ...
            KeyContainerPermissionAccessEntry entry = new KeyContainerPermissionAccessEntry(keyName, KeyContainerPermissionFlags.Open) {
        ...
        public CngAlgorithm Algorithm =>
            new CngAlgorithm(NCryptNative.GetPropertyAsString(this.m_keyHandle, "Algorithm Name", CngPropertyOptions.None));

        public CngAlgorithmGroup AlgorithmGroup
        {
            [SecurityCritical, Pure]
            get
            {
        ...
        public CngExportPolicies ExportPolicy =>
            ((CngExportPolicies) NCryptNative.GetPropertyAsDWord(this.m_keyHandle, "Export Policy", CngPropertyOptions.None));

        public SafeNCryptKeyHandle Handle =>
            this.m_keyHandle.Duplicate();
        ...
        public bool IsMachineKey =>
            ((NCryptNative.GetPropertyAsDWord(this.m_keyHandle, "Key Type", CngPropertyOptions.None) & 0x20) == 0x20);
        ...
        public int KeySize =>
            NCryptNative.GetPropertyAsDWord(this.m_keyHandle, "Length", CngPropertyOptions.None);

        public CngKeyUsages KeyUsage =>
            ((CngKeyUsages) NCryptNative.GetPropertyAsDWord(this.m_keyHandle, "Key Usage", CngPropertyOptions.None));

        public IntPtr ParentWindowHandle
        {
            [SecurityCritical]
            get => 
                NCryptNative.GetPropertyAsIntPtr(this.m_keyHandle, "HWND Handle", CngPropertyOptions.None);
            [SecurityCritical, SecurityPermission(SecurityAction.Demand, UnmanagedCode=true)]
            set
            {
