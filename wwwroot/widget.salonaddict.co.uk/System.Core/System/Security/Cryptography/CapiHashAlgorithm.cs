namespace System.Security.Cryptography
{
    ...
    internal sealed class CapiHashAlgorithm : IDisposable
    {
        ...
        public CapiHashAlgorithm(string provider, CapiNative.ProviderType providerType, CapiNative.AlgorithmId algorithm)
        {
            ...
            Contract.Requires((algorithm & ((CapiNative.AlgorithmId) 0x8000)) == ((CapiNative.AlgorithmId) 0x8000));
        ...
        public byte[] HashFinal() => 
            CapiNative.GetHashParameter(this.m_hashHandle, CapiNative.HashParameter.HashValue);
