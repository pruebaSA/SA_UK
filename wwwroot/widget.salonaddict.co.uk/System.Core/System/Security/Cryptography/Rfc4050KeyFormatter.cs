namespace System.Security.Cryptography
{
    ...
    internal static class Rfc4050KeyFormatter
    {
        ...
        private static void WritePublicKeyValue(XmlWriter writer, CngKey key)
        {
            ...
            writer.WriteAttributeString("Value", integer.ToString(CultureInfo.InvariantCulture));
            writer.WriteEndElement();
            writer.WriteStartElement("Y");
            writer.WriteAttributeString("Value", integer2.ToString(CultureInfo.InvariantCulture));
            writer.WriteEndElement();
            writer.WriteEndElement();
        }
    }
