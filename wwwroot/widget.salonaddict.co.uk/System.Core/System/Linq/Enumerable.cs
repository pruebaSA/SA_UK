namespace System.Linq
{
    ...
    public static class Enumerable
    {
        ...
        public static decimal Average<TSource>(this IEnumerable<TSource> source, Func<TSource, decimal> selector) => 
            source.Select<TSource, decimal>(selector).Average();

        public static double Average<TSource>(this IEnumerable<TSource> source, Func<TSource, double> selector) => 
            source.Select<TSource, double>(selector).Average();

        public static double Average<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) => 
            source.Select<TSource, int>(selector).Average();

        public static double Average<TSource>(this IEnumerable<TSource> source, Func<TSource, long> selector) => 
            source.Select<TSource, long>(selector).Average();
        ...
        public static float? Average<TSource>(this IEnumerable<TSource> source, Func<TSource, float?> selector) => 
            source.Select<TSource, float?>(selector).Average();
        ...
        public static IEnumerable<TSource> DefaultIfEmpty<TSource>(this IEnumerable<TSource> source) => 
            source.DefaultIfEmpty<TSource>(default(TSource));
        ...
        public static IEnumerable<IGrouping<TKey, TSource>> GroupBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => 
            new GroupedEnumerable<TSource, TKey, TSource>(source, keySelector, IdentityFunction<TSource>.Instance, null);

        public static IEnumerable<IGrouping<TKey, TSource>> GroupBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) => 
            new GroupedEnumerable<TSource, TKey, TSource>(source, keySelector, IdentityFunction<TSource>.Instance, comparer);
        ...
        public static IEnumerable<TResult> GroupBy<TSource, TKey, TResult>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TKey, IEnumerable<TSource>, TResult> resultSelector) => 
            new GroupedEnumerable<TSource, TKey, TSource, TResult>(source, keySelector, IdentityFunction<TSource>.Instance, resultSelector, null);
        ...
        public static IEnumerable<TResult> GroupBy<TSource, TKey, TElement, TResult>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, Func<TKey, IEnumerable<TElement>, TResult> resultSelector) => 
            new GroupedEnumerable<TSource, TKey, TElement, TResult>(source, keySelector, elementSelector, resultSelector, null);

        public static IEnumerable<TResult> GroupBy<TSource, TKey, TResult>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TKey, IEnumerable<TSource>, TResult> resultSelector, IEqualityComparer<TKey> comparer) => 
            new GroupedEnumerable<TSource, TKey, TSource, TResult>(source, keySelector, IdentityFunction<TSource>.Instance, resultSelector, comparer);

        public static IEnumerable<TResult> GroupBy<TSource, TKey, TElement, TResult>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, Func<TKey, IEnumerable<TElement>, TResult> resultSelector, IEqualityComparer<TKey> comparer) => 
            new GroupedEnumerable<TSource, TKey, TElement, TResult>(source, keySelector, elementSelector, resultSelector, comparer);
        ...
        public static decimal Max<TSource>(this IEnumerable<TSource> source, Func<TSource, decimal> selector) => 
            source.Select<TSource, decimal>(selector).Max();

        public static double Max<TSource>(this IEnumerable<TSource> source, Func<TSource, double> selector) => 
            source.Select<TSource, double>(selector).Max();

        public static int Max<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) => 
            source.Select<TSource, int>(selector).Max();

        public static long Max<TSource>(this IEnumerable<TSource> source, Func<TSource, long> selector) => 
            source.Select<TSource, long>(selector).Max();
        ...
        public static float? Max<TSource>(this IEnumerable<TSource> source, Func<TSource, float?> selector) => 
            source.Select<TSource, float?>(selector).Max();

        public static float Max<TSource>(this IEnumerable<TSource> source, Func<TSource, float> selector) => 
            source.Select<TSource, float>(selector).Max();

        public static TResult Max<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, TResult> selector) => 
            source.Select<TSource, TResult>(selector).Max<TResult>();
        ...
        public static decimal Min<TSource>(this IEnumerable<TSource> source, Func<TSource, decimal> selector) => 
            source.Select<TSource, decimal>(selector).Min();

        public static double Min<TSource>(this IEnumerable<TSource> source, Func<TSource, double> selector) => 
            source.Select<TSource, double>(selector).Min();

        public static int Min<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) => 
            source.Select<TSource, int>(selector).Min();

        public static long Min<TSource>(this IEnumerable<TSource> source, Func<TSource, long> selector) => 
            source.Select<TSource, long>(selector).Min();
        ...
        public static float? Min<TSource>(this IEnumerable<TSource> source, Func<TSource, float?> selector) => 
            source.Select<TSource, float?>(selector).Min();

        public static float Min<TSource>(this IEnumerable<TSource> source, Func<TSource, float> selector) => 
            source.Select<TSource, float>(selector).Min();

        public static TResult Min<TSource, TResult>(this IEnumerable<TSource> source, Func<TSource, TResult> selector) => 
            source.Select<TSource, TResult>(selector).Min<TResult>();
        ...
        public static IOrderedEnumerable<TSource> OrderBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => 
            new OrderedEnumerable<TSource, TKey>(source, keySelector, null, false);

        public static IOrderedEnumerable<TSource> OrderBy<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) => 
            new OrderedEnumerable<TSource, TKey>(source, keySelector, comparer, false);

        public static IOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => 
            new OrderedEnumerable<TSource, TKey>(source, keySelector, null, true);

        public static IOrderedEnumerable<TSource> OrderByDescending<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) => 
            new OrderedEnumerable<TSource, TKey>(source, keySelector, comparer, true);
        ...
        public static bool SequenceEqual<TSource>(this IEnumerable<TSource> first, IEnumerable<TSource> second) => 
            first.SequenceEqual<TSource>(second, null);
        ...
        public static decimal Sum<TSource>(this IEnumerable<TSource> source, Func<TSource, decimal> selector) => 
            source.Select<TSource, decimal>(selector).Sum();

        public static double Sum<TSource>(this IEnumerable<TSource> source, Func<TSource, double> selector) => 
            source.Select<TSource, double>(selector).Sum();

        public static int Sum<TSource>(this IEnumerable<TSource> source, Func<TSource, int> selector) => 
            source.Select<TSource, int>(selector).Sum();

        public static long Sum<TSource>(this IEnumerable<TSource> source, Func<TSource, long> selector) => 
            source.Select<TSource, long>(selector).Sum();
        ...
        public static float? Sum<TSource>(this IEnumerable<TSource> source, Func<TSource, float?> selector) => 
            source.Select<TSource, float?>(selector).Sum();
        ...
        public static IOrderedEnumerable<TSource> ThenBy<TSource, TKey>(this IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector) => 
            source?.CreateOrderedEnumerable<TKey>(keySelector, null, false);

        public static IOrderedEnumerable<TSource> ThenBy<TSource, TKey>(this IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) => 
            source?.CreateOrderedEnumerable<TKey>(keySelector, comparer, false);

        public static IOrderedEnumerable<TSource> ThenByDescending<TSource, TKey>(this IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector) => 
            source?.CreateOrderedEnumerable<TKey>(keySelector, null, true);

        public static IOrderedEnumerable<TSource> ThenByDescending<TSource, TKey>(this IOrderedEnumerable<TSource> source, Func<TSource, TKey> keySelector, IComparer<TKey> comparer) => 
            source?.CreateOrderedEnumerable<TKey>(keySelector, comparer, true);
        ...
        public static Dictionary<TKey, TSource> ToDictionary<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => 
            source.ToDictionary<TSource, TKey, TSource>(keySelector, IdentityFunction<TSource>.Instance, null);

        public static Dictionary<TKey, TSource> ToDictionary<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) => 
            source.ToDictionary<TSource, TKey, TSource>(keySelector, IdentityFunction<TSource>.Instance, comparer);

        public static Dictionary<TKey, TElement> ToDictionary<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector) => 
            source.ToDictionary<TSource, TKey, TElement>(keySelector, elementSelector, null);
        ...
        public static ILookup<TKey, TSource> ToLookup<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector) => 
            ((ILookup<TKey, TSource>) Lookup<TKey, TSource>.Create<TSource>(source, keySelector, IdentityFunction<TSource>.Instance, null));

        public static ILookup<TKey, TSource> ToLookup<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer) => 
            ((ILookup<TKey, TSource>) Lookup<TKey, TSource>.Create<TSource>(source, keySelector, IdentityFunction<TSource>.Instance, comparer));

        public static ILookup<TKey, TElement> ToLookup<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector) => 
            ((ILookup<TKey, TElement>) Lookup<TKey, TElement>.Create<TSource>(source, keySelector, elementSelector, null));

        public static ILookup<TKey, TElement> ToLookup<TSource, TKey, TElement>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, Func<TSource, TElement> elementSelector, IEqualityComparer<TKey> comparer) => 
            ((ILookup<TKey, TElement>) Lookup<TKey, TElement>.Create<TSource>(source, keySelector, elementSelector, comparer));
        ...
        [CompilerGenerated]
        private sealed class <CastIterator>d__aa<TResult> : IEnumerable<TResult>, IEnumerable, IEnumerator<TResult>, IEnumerator, IDisposable
        {
            ...
            [DebuggerHidden]
            public <CastIterator>d__aa(int <>1__state)
            {
        ...
        [CompilerGenerated]
        private sealed class <DefaultIfEmptyIterator>d__9e<TSource> : IEnumerable<TSource>, IEnumerable, IEnumerator<TSource>, IEnumerator, IDisposable
        {
            private int <>1__state;
            private TSource <>2__current;
            ...
            private int <>l__initialThreadId;
            public IEnumerator<TSource> <e>5__9f;
            public TSource defaultValue;
            public IEnumerable<TSource> source;

            [DebuggerHidden]
            public <DefaultIfEmptyIterator>d__9e(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }

            private void <>m__Finallya0()
            {
                this.<>1__state = -1;
                if (this.<e>5__9f != null)
                {
                    this.<e>5__9f.Dispose();
                }
            }
            ...
            private bool MoveNext()
            {
                ...
                try
                {
                    ...
                    this.<>1__state = -1;
                    this.<e>5__9f = this.source.GetEnumerator();
                    this.<>1__state = 1;
                    if (!this.<e>5__9f.MoveNext())
                    {
                        goto Label_0080;
                ...
                Label_004E:
                    this.<>2__current = this.<e>5__9f.Current;
                    this.<>1__state = 2;
                    return true;
                Label_0080:
            ...
            IEnumerator<TSource> IEnumerable<TSource>.GetEnumerator()
            {
                Enumerable.<DefaultIfEmptyIterator>d__9e<TSource> d__e;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    d__e = (Enumerable.<DefaultIfEmptyIterator>d__9e<TSource>) this;
                }
                else
                {
                    d__e = new Enumerable.<DefaultIfEmptyIterator>d__9e<TSource>(0);
                }
        ...
        [CompilerGenerated]
        private sealed class <DistinctIterator>d__7a<TSource> : IEnumerable<TSource>, IEnumerable, IEnumerator<TSource>, IEnumerator, IDisposable
        {
            private int <>1__state;
            private TSource <>2__current;
            public IEqualityComparer<TSource> <>3__comparer;
            public IEnumerable<TSource> <>3__source;
            public IEnumerator<TSource> <>7__wrap7d;
            private int <>l__initialThreadId;
            public TSource <element>5__7c;
            public Set<TSource> <set>5__7b;
            public IEqualityComparer<TSource> comparer;
            public IEnumerable<TSource> source;

            [DebuggerHidden]
            public <DistinctIterator>d__7a(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }
            ...
            {
                this.<>1__state = -1;
                if (this.<>7__wrap7d != null)
                {
                    this.<>7__wrap7d.Dispose();
                }
            }
            ...
            IEnumerator<TSource> IEnumerable<TSource>.GetEnumerator()
            {
                Enumerable.<DistinctIterator>d__7a<TSource> d__a;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    d__a = (Enumerable.<DistinctIterator>d__7a<TSource>) this;
                }
                else
                {
                    d__a = new Enumerable.<DistinctIterator>d__7a<TSource>(0);
                }
        ...
        private sealed class <ExceptIterator>d__92<TSource> : IEnumerable<TSource>, IEnumerable, IEnumerator<TSource>, IEnumerator, IDisposable
        {
            ...
            [DebuggerHidden]
            public <ExceptIterator>d__92(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }
            ...
            IEnumerator<TSource> IEnumerable<TSource>.GetEnumerator()
            {
                Enumerable.<ExceptIterator>d__92<TSource> d__;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    d__ = (Enumerable.<ExceptIterator>d__92<TSource>) this;
                }
                else
                {
                    d__ = new Enumerable.<ExceptIterator>d__92<TSource>(0);
                }
                d__.first = this.<>3__first;
                d__.second = this.<>3__second;
        ...
        [CompilerGenerated]
        private sealed class <IntersectIterator>d__8b<TSource> : IEnumerable<TSource>, IEnumerable, IEnumerator<TSource>, IEnumerator, IDisposable
        {
            private int <>1__state;
            private TSource <>2__current;
            public IEqualityComparer<TSource> <>3__comparer;
            ...
            private int <>l__initialThreadId;
            public TSource <element>5__8d;
            public Set<TSource> <set>5__8c;
            public IEqualityComparer<TSource> comparer;
            public IEnumerable<TSource> first;
            public IEnumerable<TSource> second;

            [DebuggerHidden]
            public <IntersectIterator>d__8b(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }
            ...
            private bool MoveNext()
            {
                try
                {
                    switch (this.<>1__state)
                    {
                        case 0:
                            this.<>1__state = -1;
                            this.<set>5__8c = new Set<TSource>(this.comparer);
                            foreach (TSource local in this.second)
                            {
                                this.<set>5__8c.Add(local);
                            }
                            this.<>7__wrap8e = this.first.GetEnumerator();
                            this.<>1__state = 2;
                            while (this.<>7__wrap8e.MoveNext())
                            {
                                this.<element>5__8d = this.<>7__wrap8e.Current;
                                if (!this.<set>5__8c.Remove(this.<element>5__8d))
                                {
                                    continue;
                                }
                                this.<>2__current = this.<element>5__8d;
                                this.<>1__state = 3;
                                return true;
                            Label_00BA:
                                this.<>1__state = 2;
            ...
            IEnumerator<TSource> IEnumerable<TSource>.GetEnumerator()
            {
                Enumerable.<IntersectIterator>d__8b<TSource> d__b;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    d__b = (Enumerable.<IntersectIterator>d__8b<TSource>) this;
                }
                else
                {
                    d__b = new Enumerable.<IntersectIterator>d__8b<TSource>(0);
                }
                d__b.first = this.<>3__first;
                d__b.second = this.<>3__second;
                d__b.comparer = this.<>3__comparer;
                return d__b;
            }
        ...
        [CompilerGenerated]
        private sealed class <OfTypeIterator>d__a3<TResult> : IEnumerable<TResult>, IEnumerable, IEnumerator<TResult>, IEnumerator, IDisposable
        {
            private int <>1__state;
            private TResult <>2__current;
            public IEnumerable <>3__source;
            public IEnumerator <>7__wrapa5;
            public IDisposable <>7__wrapa6;
            private int <>l__initialThreadId;
            public object <obj>5__a4;
            public IEnumerable source;

            [DebuggerHidden]
            public <OfTypeIterator>d__a3(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }
            ...
            {
                this.<>1__state = -1;
                this.<>7__wrapa6 = this.<>7__wrapa5 as IDisposable;
                if (this.<>7__wrapa6 != null)
                {
                    this.<>7__wrapa6.Dispose();
                }
            }
            ...
            private bool MoveNext()
            {
                ...
                try
                {
                    switch (this.<>1__state)
                    {
                        case 0:
                            this.<>1__state = -1;
                            this.<>7__wrapa5 = this.source.GetEnumerator();
                            this.<>1__state = 1;
                            goto Label_007D;
                ...
                Label_003C:
                    this.<obj>5__a4 = this.<>7__wrapa5.Current;
                    if (this.<obj>5__a4 is TResult)
                    {
                        this.<>2__current = (TResult) this.<obj>5__a4;
                        this.<>1__state = 2;
                        return true;
                    }
                Label_007D:
                    if (this.<>7__wrapa5.MoveNext())
                    {
                        goto Label_003C;
                    }
                    this.<>m__Finallya7();
            ...
            IEnumerator<TResult> IEnumerable<TResult>.GetEnumerator()
            {
                Enumerable.<OfTypeIterator>d__a3<TResult> _a;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    _a = (Enumerable.<OfTypeIterator>d__a3<TResult>) this;
                }
                else
                {
                    _a = new Enumerable.<OfTypeIterator>d__a3<TResult>(0);
                }
        ...
        [CompilerGenerated]
        private sealed class <RepeatIterator>d__b5<TResult> : IEnumerable<TResult>, IEnumerable, IEnumerator<TResult>, IEnumerator, IDisposable
        {
            private int <>1__state;
            private TResult <>2__current;
            public int <>3__count;
            ...
            [DebuggerHidden]
            public <RepeatIterator>d__b5(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }
            ...
            IEnumerator<TResult> IEnumerable<TResult>.GetEnumerator()
            {
                Enumerable.<RepeatIterator>d__b5<TResult> _b;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    _b = (Enumerable.<RepeatIterator>d__b5<TResult>) this;
                }
                else
                {
                    _b = new Enumerable.<RepeatIterator>d__b5<TResult>(0);
                }
                _b.element = this.<>3__element;
                _b.count = this.<>3__count;
                return _b;
            }
        ...
        [CompilerGenerated]
        private sealed class <ReverseIterator>d__99<TSource> : IEnumerable<TSource>, IEnumerable, IEnumerator<TSource>, IEnumerator, IDisposable
        {
            private int <>1__state;
            private TSource <>2__current;
            public IEnumerable<TSource> <>3__source;
            private int <>l__initialThreadId;
            public Buffer<TSource> <buffer>5__9a;
            public int <i>5__9b;
            public IEnumerable<TSource> source;

            [DebuggerHidden]
            public <ReverseIterator>d__99(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }
            ...
            private bool MoveNext()
            {
                switch (this.<>1__state)
                {
                    case 0:
                        this.<>1__state = -1;
                        this.<buffer>5__9a = new Buffer<TSource>(this.source);
                        this.<i>5__9b = this.<buffer>5__9a.count - 1;
                        break;
                ...
                if (this.<i>5__9b >= 0)
                {
                    this.<>2__current = this.<buffer>5__9a.items[this.<i>5__9b];
                    this.<>1__state = 1;
                    return true;
                }
            Label_008C:
            ...
            IEnumerator<TSource> IEnumerable<TSource>.GetEnumerator()
            {
                Enumerable.<ReverseIterator>d__99<TSource> d__;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    d__ = (Enumerable.<ReverseIterator>d__99<TSource>) this;
                }
                else
                {
                    d__ = new Enumerable.<ReverseIterator>d__99<TSource>(0);
                }
        ...
        [CompilerGenerated]
        private sealed class <UnionIterator>d__81<TSource> : IEnumerable<TSource>, IEnumerable, IEnumerator<TSource>, IEnumerator, IDisposable
        {
            private int <>1__state;
            private TSource <>2__current;
            public IEqualityComparer<TSource> <>3__comparer;
            public IEnumerable<TSource> <>3__first;
            public IEnumerable<TSource> <>3__second;
            public IEnumerator<TSource> <>7__wrap85;
            public IEnumerator<TSource> <>7__wrap87;
            private int <>l__initialThreadId;
            public TSource <element>5__83;
            public TSource <element>5__84;
            ...
            [DebuggerHidden]
            public <UnionIterator>d__81(int <>1__state)
            {
                this.<>1__state = <>1__state;
                this.<>l__initialThreadId = Thread.CurrentThread.ManagedThreadId;
            }

            private void <>m__Finally86()
            {
                this.<>1__state = -1;
                if (this.<>7__wrap85 != null)
                {
                    this.<>7__wrap85.Dispose();
                }
            }

            private void <>m__Finally88()
            {
                this.<>1__state = -1;
                if (this.<>7__wrap87 != null)
                {
                    this.<>7__wrap87.Dispose();
                }
            }
            ...
            private bool MoveNext()
            {
                ...
                try
                {
                    switch (this.<>1__state)
                    {
                        case 0:
                            ...
                            this.<>7__wrap85 = this.first.GetEnumerator();
                            this.<>1__state = 1;
                            goto Label_009D;
                ...
                Label_0058:
                    this.<element>5__83 = this.<>7__wrap85.Current;
                ...
                Label_009D:
                    if (this.<>7__wrap85.MoveNext())
                    {
                        goto Label_0058;
                    }
                    this.<>m__Finally86();
                    this.<>7__wrap87 = this.second.GetEnumerator();
                    this.<>1__state = 3;
                    while (this.<>7__wrap87.MoveNext())
                    {
                        this.<element>5__84 = this.<>7__wrap87.Current;
                        if (!this.<set>5__82.Add(this.<element>5__84))
                        {
                            continue;
                        }
                        this.<>2__current = this.<element>5__84;
                        this.<>1__state = 4;
                        return true;
                    Label_0105:
                        this.<>1__state = 3;
            ...
            IEnumerator<TSource> IEnumerable<TSource>.GetEnumerator()
            {
                Enumerable.<UnionIterator>d__81<TSource> d__;
                if ((Thread.CurrentThread.ManagedThreadId == this.<>l__initialThreadId) && (this.<>1__state == -2))
                {
                    this.<>1__state = 0;
                    d__ = (Enumerable.<UnionIterator>d__81<TSource>) this;
                }
                else
                {
                    d__ = new Enumerable.<UnionIterator>d__81<TSource>(0);
                }
                d__.first = this.<>3__first;
                d__.second = this.<>3__second;
                d__.comparer = this.<>3__comparer;
        ...
        private class WhereArrayIterator<TSource> : Enumerable.Iterator<TSource>
        {
            ...
            public override Enumerable.Iterator<TSource> Clone() => 
                new Enumerable.WhereArrayIterator<TSource>(this.source, this.predicate);
            ...
            public override IEnumerable<TResult> Select<TResult>(Func<TSource, TResult> selector) => 
                new Enumerable.WhereSelectArrayIterator<TSource, TResult>(this.source, this.predicate, selector);

            public override IEnumerable<TSource> Where(Func<TSource, bool> predicate) => 
                new Enumerable.WhereArrayIterator<TSource>(this.source, Enumerable.CombinePredicates<TSource>(this.predicate, predicate));
        }
        ...
        private class WhereEnumerableIterator<TSource> : Enumerable.Iterator<TSource>
        {
            ...
            public override Enumerable.Iterator<TSource> Clone() => 
                new Enumerable.WhereEnumerableIterator<TSource>(this.source, this.predicate);
            ...
            public override IEnumerable<TResult> Select<TResult>(Func<TSource, TResult> selector) => 
                new Enumerable.WhereSelectEnumerableIterator<TSource, TResult>(this.source, this.predicate, selector);

            public override IEnumerable<TSource> Where(Func<TSource, bool> predicate) => 
                new Enumerable.WhereEnumerableIterator<TSource>(this.source, Enumerable.CombinePredicates<TSource>(this.predicate, predicate));
        }
        ...
        private class WhereListIterator<TSource> : Enumerable.Iterator<TSource>
        {
            ...
            public override Enumerable.Iterator<TSource> Clone() => 
                new Enumerable.WhereListIterator<TSource>(this.source, this.predicate);
            ...
            public override IEnumerable<TResult> Select<TResult>(Func<TSource, TResult> selector) => 
                new Enumerable.WhereSelectListIterator<TSource, TResult>(this.source, this.predicate, selector);

            public override IEnumerable<TSource> Where(Func<TSource, bool> predicate) => 
                new Enumerable.WhereListIterator<TSource>(this.source, Enumerable.CombinePredicates<TSource>(this.predicate, predicate));
        }
        ...
        private class WhereSelectArrayIterator<TSource, TResult> : Enumerable.Iterator<TResult>
        {
            ...
            public override Enumerable.Iterator<TResult> Clone() => 
                new Enumerable.WhereSelectArrayIterator<TSource, TResult>(this.source, this.predicate, this.selector);
            ...
            public override IEnumerable<TResult2> Select<TResult2>(Func<TResult, TResult2> selector) => 
                new Enumerable.WhereSelectArrayIterator<TSource, TResult2>(this.source, this.predicate, Enumerable.CombineSelectors<TSource, TResult, TResult2>(this.selector, selector));

            public override IEnumerable<TResult> Where(Func<TResult, bool> predicate) => 
                ((IEnumerable<TResult>) new Enumerable.WhereEnumerableIterator<TResult>(this, predicate));
        }
        ...
        private class WhereSelectEnumerableIterator<TSource, TResult> : Enumerable.Iterator<TResult>
        {
            ...
            public override Enumerable.Iterator<TResult> Clone() => 
                new Enumerable.WhereSelectEnumerableIterator<TSource, TResult>(this.source, this.predicate, this.selector);
            ...
            public override IEnumerable<TResult2> Select<TResult2>(Func<TResult, TResult2> selector) => 
                new Enumerable.WhereSelectEnumerableIterator<TSource, TResult2>(this.source, this.predicate, Enumerable.CombineSelectors<TSource, TResult, TResult2>(this.selector, selector));
        ...
        private class WhereSelectListIterator<TSource, TResult> : Enumerable.Iterator<TResult>
        {
            ...
            public override Enumerable.Iterator<TResult> Clone() => 
                new Enumerable.WhereSelectListIterator<TSource, TResult>(this.source, this.predicate, this.selector);
            ...
            public override IEnumerable<TResult2> Select<TResult2>(Func<TResult, TResult2> selector) => 
                new Enumerable.WhereSelectListIterator<TSource, TResult2>(this.source, this.predicate, Enumerable.CombineSelectors<TSource, TResult, TResult2>(this.selector, selector));
