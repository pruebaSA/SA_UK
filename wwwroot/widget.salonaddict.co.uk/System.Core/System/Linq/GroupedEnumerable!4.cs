namespace System.Linq
{
    ...
    internal class GroupedEnumerable<TSource, TKey, TElement, TResult> : IEnumerable<TResult>, IEnumerable
    {
        ...
        public IEnumerator<TResult> GetEnumerator() => 
            Lookup<TKey, TElement>.Create<TSource>(this.source, this.keySelector, this.elementSelector, this.comparer).ApplyResultSelector<TResult>(this.resultSelector).GetEnumerator();
