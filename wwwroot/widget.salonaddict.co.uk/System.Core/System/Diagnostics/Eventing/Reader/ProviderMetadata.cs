namespace System.Diagnostics.Eventing.Reader
{
    ...
    public class ProviderMetadata : IDisposable
    {
        ...
        public Guid Id =>
            ((Guid) NativeWrapper.EvtGetPublisherMetadataProperty(this.handle, Microsoft.Win32.UnsafeNativeMethods.EvtPublisherMetadataPropertyId.EvtPublisherMetadataPublisherGuid));
        ...
        public string MessageFilePath =>
            ((string) NativeWrapper.EvtGetPublisherMetadataProperty(this.handle, Microsoft.Win32.UnsafeNativeMethods.EvtPublisherMetadataPropertyId.EvtPublisherMetadataMessageFilePath));
        ...
        public string ParameterFilePath =>
            ((string) NativeWrapper.EvtGetPublisherMetadataProperty(this.handle, Microsoft.Win32.UnsafeNativeMethods.EvtPublisherMetadataPropertyId.EvtPublisherMetadataParameterFilePath));

        private uint ProviderMessageID =>
            ((uint) NativeWrapper.EvtGetPublisherMetadataProperty(this.handle, Microsoft.Win32.UnsafeNativeMethods.EvtPublisherMetadataPropertyId.EvtPublisherMetadataPublisherMessageID));

        public string ResourceFilePath =>
            ((string) NativeWrapper.EvtGetPublisherMetadataProperty(this.handle, Microsoft.Win32.UnsafeNativeMethods.EvtPublisherMetadataPropertyId.EvtPublisherMetadataResourceFilePath));
