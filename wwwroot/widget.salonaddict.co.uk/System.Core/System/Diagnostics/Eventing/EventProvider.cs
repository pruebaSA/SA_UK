namespace System.Diagnostics.Eventing
{
    ...
    public class EventProvider : IDisposable
    {
        ...
        [SecurityCritical]
        public unsafe bool WriteEvent(ref System.Diagnostics.Eventing.EventDescriptor eventDescriptor, params object[] eventPayload)
        {
            uint num = 0;
            if (this.IsEnabled(eventDescriptor.Level, eventDescriptor.Keywords))
            {
                ...
                if (((eventPayload == null) || (eventPayload.Length == 0)) || (eventPayload.Length == 1))
                {
                    ...
                    if (str != null)
                    {
                        fixed (char* str3 = ((char*) str))
                        {
                            ...
                            num = Microsoft.Win32.UnsafeNativeMethods.EventWrite(this.m_regHandle, ref eventDescriptor, (uint) length, (void*) &data);
                        }
                    }
                    else if (length == 0)
                    {
                        num = Microsoft.Win32.UnsafeNativeMethods.EventWrite(this.m_regHandle, ref eventDescriptor, 0, null);
                    }
                    else
                    {
                        num = Microsoft.Win32.UnsafeNativeMethods.EventWrite(this.m_regHandle, ref eventDescriptor, (uint) length, (void*) &data);
                ...
                else
                {
                    ...
                    EventData* dataPtr = (EventData*) stackalloc byte[(sizeof(EventData) * length)];
                    EventData* dataDescriptor = dataPtr;
                    byte* numPtr3 = stackalloc byte[0x10 * length];
                                        ...
                                        fixed (char* str9 = ((char*) strArray[5]))
                                        {
                                            ...
                                            fixed (char* str10 = ((char*) strArray[6]))
                                            {
                                                ...
                                                fixed (char* str11 = ((char*) strArray[7]))
                                                {
                                                    ...
                                                    num = Microsoft.Win32.UnsafeNativeMethods.EventWrite(this.m_regHandle, ref eventDescriptor, (uint) length, (void*) dataPtr);
                                                }
                                            }
                                        }
                                    }
        ...
        public bool WriteMessageEvent(string eventMessage) => 
            this.WriteMessageEvent(eventMessage, 0, 0L);
        ...
        public unsafe bool WriteTransferEvent(ref System.Diagnostics.Eventing.EventDescriptor eventDescriptor, Guid relatedActivityId, params object[] eventPayload)
        {
            ...
            if (this.IsEnabled(eventDescriptor.Level, eventDescriptor.Keywords))
            {
                                        ...
                                        fixed (char* str7 = ((char*) strArray[5]))
                                        {
                                            ...
                                            fixed (char* str8 = ((char*) strArray[6]))
                                            {
                                                ...
                                                fixed (char* str9 = ((char*) strArray[7]))
                                                {
                                                    ...
                                                    num = Microsoft.Win32.UnsafeNativeMethods.EventWriteTransfer(this.m_regHandle, ref eventDescriptor, ref activityId, ref relatedActivityId, (uint) length, (void*) dataPtr);
                                                }
                                            }
                                        }
                                    }
                ...
                {
                    num = Microsoft.Win32.UnsafeNativeMethods.EventWriteTransfer(this.m_regHandle, ref eventDescriptor, ref activityId, ref relatedActivityId, 0, null);
                }
            }
            if (num != 0)
            {
        ...
        protected unsafe bool WriteTransferEvent(ref System.Diagnostics.Eventing.EventDescriptor eventDescriptor, Guid relatedActivityId, int dataCount, IntPtr data)
        {
            uint num = 0;
            Guid activityId = GetActivityId();
            num = Microsoft.Win32.UnsafeNativeMethods.EventWriteTransfer(this.m_regHandle, ref eventDescriptor, ref activityId, ref relatedActivityId, (uint) dataCount, (void*) data);
            if (num != 0)
            {
                SetLastError((int) num);
                return false;
