namespace Microsoft.Win32
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        [DllImport("advapi32.dll", CharSet=CharSet.Unicode, ExactSpelling=true)]
        internal static extern unsafe uint EventWriteTransfer([In] long registrationHandle, [In] ref EventDescriptor eventDescriptor, [In] ref Guid activityId, [In] ref Guid relatedActivityId, [In] uint userDataCount, [In] void* userData);
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        internal static extern int GetDynamicTimeZoneInformation(out Microsoft.Win32.NativeMethods.DynamicTimeZoneInformation lpDynamicTimeZoneInformation);
        [return: MarshalAs(UnmanagedType.Bool)]
        [DllImport("kernel32.dll", SetLastError=true, ExactSpelling=true)]
        ...
        [DllImport("kernel32.dll", SetLastError=true, ExactSpelling=true)]
        internal static extern int GetTimeZoneInformation(out Microsoft.Win32.NativeMethods.TimeZoneInformation lpTimeZoneInformation);
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        internal static extern int LoadString(Microsoft.Win32.SafeLibraryHandle handle, int id, StringBuilder buffer, int bufferLength);
