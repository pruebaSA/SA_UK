namespace Microsoft.Win32.SafeHandles
{
    ...
    public abstract class SafeNCryptHandle : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        private SafeNCryptHandle Holder
        {
            ...
            get
            {
                Contract.Requires(((this.m_ownershipState == OwnershipState.Duplicate) && (this.m_holder != null)) || ((this.m_ownershipState != OwnershipState.Duplicate) && (this.m_holder == null)));
                Contract.Requires((this.m_holder == null) || (this.m_holder.m_ownershipState == OwnershipState.Holder));
