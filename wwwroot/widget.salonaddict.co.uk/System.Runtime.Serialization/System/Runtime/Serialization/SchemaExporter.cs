namespace System.Runtime.Serialization
{
    ...
    internal class SchemaExporter
    {
        ...
        private XmlElement ExportActualType(XmlQualifiedName typeName) => 
            ExportActualType(typeName, this.XmlDoc);
        ...
        private void ExportXmlDataContract(XmlDataContract dataContract)
        {
            ...
            if (flag)
            {
                ...
                {
                    DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Verbose, TraceCode.XsdExportAnnotationFailed, System.Runtime.Serialization.SR.GetString("TraceCodeXsdExportAnnotationFailed"), new StringTraceRecord("Type", name.Namespace + ":" + name.Name));
                }
            }
        }
        ...
        private XmlSchema GetSchema(string ns) => 
            SchemaHelper.GetSchema(ns, this.Schemas);
                ...
                for (int j = 0; j < array.Length; j++)
                {
                    ...
                    if (hashtable3[name] != null)
                    {
                        if (DiagnosticUtility.ShouldTraceWarning)
                        {
                            ...
                            DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Warning, TraceCode.XsdExportDupItems, System.Runtime.Serialization.SR.GetString("TraceCodeXsdExportDupItems"), new DictionaryTraceRecord(dictionary));
                        }
        ...
        internal static XmlSchemaAttribute IdAttribute =>
            new XmlSchemaAttribute { RefName=Globals.IdQualifiedName };
        ...
        internal static XmlSchemaAttribute ISerializableFactoryTypeAttribute =>
            new XmlSchemaAttribute { RefName=new XmlQualifiedName("FactoryType", "http://schemas.microsoft.com/2003/10/Serialization/") };
        ...
        internal static XmlSchemaAttribute RefAttribute =>
            new XmlSchemaAttribute { RefName=Globals.RefQualifiedName };
