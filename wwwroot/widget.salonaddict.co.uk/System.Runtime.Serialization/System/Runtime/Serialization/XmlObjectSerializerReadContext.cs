namespace System.Runtime.Serialization
{
    ...
    internal class XmlObjectSerializerReadContext : XmlObjectSerializerContext
    {
        ...
        internal XmlObjectSerializerReadContext(DataContractSerializer serializer, DataContract rootTypeDataContract) : base(serializer, rootTypeDataContract)
        {
            this.attributes = new Attributes();
        }
        ...
        internal static XmlObjectSerializerReadContext CreateContext(NetDataContractSerializer serializer) => 
            new XmlObjectSerializerReadContextComplex(serializer);
        ...
        internal static XmlObjectSerializerReadContext CreateContext(DataContractSerializer serializer, DataContract rootTypeDataContract)
        {
            ...
            {
                return new XmlObjectSerializerReadContext(serializer, rootTypeDataContract);
            }
            return new XmlObjectSerializerReadContextComplex(serializer, rootTypeDataContract);
        }

        protected virtual XmlReaderDelegator CreateReaderDelegatorForReader(XmlReader xmlReader) => 
            new XmlReaderDelegator(xmlReader);
        ...
        internal static Exception CreateUnexpectedStateException(XmlNodeType expectedState, XmlReaderDelegator xmlReader) => 
            XmlObjectSerializer.CreateSerializationExceptionWithReaderDetails(System.Runtime.Serialization.SR.GetString("ExpectingState", new object[] { expectedState }), xmlReader);
        ...
        {
            object realObject = obj.GetRealObject(base.GetStreamingContext());
            if (realObject == null)
            {
        ...
        protected object InternalDeserialize(XmlReaderDelegator reader, string name, string ns, ref DataContract dataContract)
        {
            ...
            {
                dataContract = base.ResolveDataContractFromKnownTypes(this.attributes.XsiTypeName, this.attributes.XsiTypeNamespace, dataContract);
            ...
            {
                DataContract contract = base.ResolveDataContractFromKnownTypes(this.attributes.FactoryTypeName, this.attributes.FactoryTypeNamespace, dataContract);
                if (contract != null)
                {
                ...
                else if (DiagnosticUtility.ShouldTraceWarning)
                {
                    Dictionary<string, string> dictionary = new Dictionary<string, string>(2) {
                        ["FactoryType"] = this.attributes.FactoryTypeNamespace + ":" + this.attributes.FactoryTypeName,
                        ["ISerializableType"] = dataContract.StableName.Namespace + ":" + dataContract.StableName.Name
                    };
                    DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Warning, TraceCode.FactoryTypeNotFound, System.Runtime.Serialization.SR.GetString("TraceCodeFactoryTypeNotFound"), new DictionaryTraceRecord(dictionary));
                }
            }
        ...
        internal virtual object InternalDeserialize(XmlReaderDelegator xmlReader, Type declaredType, string name, string ns)
        {
            ...
            return this.InternalDeserialize(xmlReader, name, ns, ref dataContract);
        }
        ...
        protected virtual bool IsReadingCollectionExtensionData(XmlReaderDelegator xmlReader) => 
            (this.attributes.ArraySZSize != -1);

        internal static bool MoveToNextElement(XmlReaderDelegator xmlReader) => 
            (xmlReader.MoveToContent() != XmlNodeType.EndElement);
        ...
        protected virtual object ReadDataContractValue(DataContract dataContract, XmlReaderDelegator reader) => 
            dataContract.ReadXmlValue(reader, this);
        ...
        private IDataNode ReadExtensionDataValue(XmlReaderDelegator xmlReader)
        {
        ...
        internal static object ReadRootIXmlSerializable(XmlReaderDelegator xmlReader, XmlDataContract xmlDataContract, bool isMemberType) => 
            ReadIXmlSerializable(new XmlSerializableReader(), xmlReader, xmlDataContract, isMemberType);
        ...
        protected virtual DataContract ResolveDataContractFromTypeName()
        {
            if (this.attributes.XsiTypeName != null)
            {
                return base.ResolveDataContractFromKnownTypes(this.attributes.XsiTypeName, this.attributes.XsiTypeNamespace, null);
            }
            return null;
        }
        ...
        internal void SkipUnknownElement(XmlReaderDelegator xmlReader)
        {
            ...
            {
                DiagnosticUtility.DiagnosticTrace.TraceEvent(TraceEventType.Verbose, TraceCode.ElementIgnored, System.Runtime.Serialization.SR.GetString("TraceCodeElementIgnored"), new StringTraceRecord("Element", xmlReader.NamespaceURI + ":" + xmlReader.LocalName));
            }
            xmlReader.Skip();
        }
        ...
        protected bool TryHandleNullOrRef(XmlReaderDelegator reader, Type declaredType, string name, string ns, ref object retObj)
        {
            ...
            if (this.attributes.Ref != Globals.NewObjectId)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlObjectSerializer.CreateSerializationException(System.Runtime.Serialization.SR.GetString("ErrorDeserializing", new object[] { System.Runtime.Serialization.SR.GetString("ErrorTypeInfo", new object[] { DataContract.GetClrTypeFullName(declaredType) }), System.Runtime.Serialization.SR.GetString("XmlStartElementExpected", new object[] { "Ref" }) })));
                }
