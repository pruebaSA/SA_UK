namespace System.Runtime.Serialization
{
    ...
    internal class ExtensionDataReader : XmlReader
    {
        ...
        public override bool MoveToAttribute(string name) => 
            (this.IsXmlDataNode && this.xmlNodeReader.MoveToAttribute(name));
        ...
        public override bool ReadAttributeValue() => 
            (this.IsXmlDataNode && this.xmlNodeReader.ReadAttributeValue());
        ...
        public override bool HasValue =>
            (this.IsXmlDataNode && this.xmlNodeReader.HasValue);
