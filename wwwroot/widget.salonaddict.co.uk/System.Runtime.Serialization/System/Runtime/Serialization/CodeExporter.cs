namespace System.Runtime.Serialization
{
    ...
    internal class CodeExporter
    {
        ...
        private bool CanDeclareAssemblyAttribute(ContractCodeDomInfo contractCodeDomInfo) => 
            (this.SupportsAssemblyAttributes && !contractCodeDomInfo.UsesWildcardNamespace);
        ...
        private void ExportClassDataContract(ClassDataContract classDataContract, ContractCodeDomInfo contractCodeDomInfo)
        {
            ...
            if (!contractCodeDomInfo.ReferencedTypeExists)
            {
                ...
                else
                {
                    ...
                    bool isProcessed = baseContractCodeDomInfo.IsProcessed;
        ...
        private void ExportXmlDataContract(XmlDataContract xmlDataContract, ContractCodeDomInfo contractCodeDomInfo)
        {
            ...
            if (!contractCodeDomInfo.ReferencedTypeExists)
            {
                ...
                else
                {
                    ...
                    CodeMemberField field = new CodeMemberField(Globals.TypeOfXmlQualifiedName, typeNameFieldName);
        ...
        private bool GlobalTypeNameConflicts(string clrNamespace, string typeName) => 
            (string.IsNullOrEmpty(clrNamespace) && this.clrNamespaces.ContainsKey(typeName));
        ...
        private bool NeedsExplicitNamespace(string dataContractNamespace, string clrNamespace) => 
            (DataContract.GetDefaultStableNamespace(clrNamespace) != dataContractNamespace);
        ...
        private CodeTypeReference CodeTypeIPropertyChange =>
            this.GetCodeTypeReference(typeof(INotifyPropertyChanged));

        private bool EnableDataBinding =>
            ((this.options != null) && this.options.EnableDataBinding);
        ...
        private bool GenerateInternalTypes =>
            ((this.options != null) && this.options.GenerateInternal);

        private bool GenerateSerializableTypes =>
            ((this.options != null) && this.options.GenerateSerializable);

        private CollectionDataContract GenericDictionaryContract =>
            (this.dataContractSet.GetDataContract(Globals.TypeOfDictionaryGeneric) as CollectionDataContract);

        private XmlQualifiedName GenericDictionaryName =>
            DataContract.GetStableName(Globals.TypeOfDictionaryGeneric);

        private CollectionDataContract GenericListContract =>
            (this.dataContractSet.GetDataContract(Globals.TypeOfListGeneric) as CollectionDataContract);

        private XmlQualifiedName GenericListName =>
            DataContract.GetStableName(Globals.TypeOfListGeneric);
        ...
        private CodeMemberMethod GetObjectDataMethod
        {
            get
            {
                ...
                CodeIterationStatement statement5 = new CodeIterationStatement {
                ...
                statement5.InitStatement = statement5.IncrementStatement = new CodeSnippetStatement(string.Empty);
        ...
        private CodeMemberProperty NodeArrayProperty =>
            this.CreateProperty(this.GetCodeTypeReference(Globals.TypeOfXmlNodeArray), "Nodes", "nodesField", false);
        ...
        private CodeAttributeDeclaration SerializableAttribute =>
            new CodeAttributeDeclaration(this.GetCodeTypeReference(Globals.TypeOfSerializableAttribute));
        ...
        private CodeParameterDeclarationExpression SerializationInfoParameter =>
            new CodeParameterDeclarationExpression(this.GetCodeTypeReference(Globals.TypeOfSerializationInfo), "info");

        private CodeMemberProperty SerializationInfoProperty =>
            this.CreateProperty(this.GetCodeTypeReference(Globals.TypeOfSerializationInfo), "SerializationInfo", "info", false);

        private CodeParameterDeclarationExpression StreamingContextParameter =>
            new CodeParameterDeclarationExpression(this.GetCodeTypeReference(Globals.TypeOfStreamingContext), "context");
