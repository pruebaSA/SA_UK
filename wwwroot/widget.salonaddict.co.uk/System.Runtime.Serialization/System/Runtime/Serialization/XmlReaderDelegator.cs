namespace System.Runtime.Serialization
{
    ...
    internal class XmlReaderDelegator
    {
        ...
        private Exception CreateInvalidPrimitiveTypeException(Type type) => 
            new InvalidDataContractException(System.Runtime.Serialization.SR.GetString(type.IsInterface ? "InterfaceTypeCannotBeCreated" : "InvalidPrimitiveType", new object[] { DataContract.GetClrTypeFullName(type) }));
        ...
        internal bool MoveToAttribute(string name) => 
            (!this.isEndOfEmptyElement && this.reader.MoveToAttribute(name));

        internal bool MoveToAttribute(string name, string ns) => 
            (!this.isEndOfEmptyElement && this.reader.MoveToAttribute(name, ns));
        ...
        internal bool MoveToElement() => 
            (!this.isEndOfEmptyElement && this.reader.MoveToElement());

        internal bool MoveToFirstAttribute() => 
            (!this.isEndOfEmptyElement && this.reader.MoveToFirstAttribute());

        internal bool MoveToNextAttribute() => 
            (!this.isEndOfEmptyElement && this.reader.MoveToNextAttribute());
        ...
        internal bool ReadAttributeValue() => 
            (!this.isEndOfEmptyElement && this.reader.ReadAttributeValue());
        ...
        internal virtual char ReadContentAsChar() => 
            this.ToChar(this.ReadContentAsInt());
        ...
        {
            Guid guid;
            string g = this.reader.ReadContentAsString();
            try
            {
                guid = new Guid(g);
            }
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(g, "Guid", exception));
            }
            catch (FormatException exception2)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(g, "Guid", exception2));
            }
            catch (OverflowException exception3)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(XmlExceptionHelper.CreateConversionException(g, "Guid", exception3));
            }
            return guid;
        }
        ...
        internal virtual XmlQualifiedName ReadContentAsQName() => 
            this.ParseQualifiedName(this.ReadContentAsString());

        internal short ReadContentAsShort() => 
            this.ToShort(this.ReadContentAsInt());

        internal sbyte ReadContentAsSignedByte() => 
            this.ToSByte(this.ReadContentAsInt());
        ...
        internal TimeSpan ReadContentAsTimeSpan() => 
            XmlConverter.ToTimeSpan(this.reader.ReadContentAsString());

        internal byte ReadContentAsUnsignedByte() => 
            this.ToByte(this.ReadContentAsInt());

        internal uint ReadContentAsUnsignedInt() => 
            this.ToUInt32(this.ReadContentAsLong());
        ...
        internal ushort ReadContentAsUnsignedShort() => 
            this.ToUInt16(this.ReadContentAsInt());
        ...
        internal virtual char ReadElementContentAsChar() => 
            this.ToChar(this.ReadElementContentAsInt());
        ...
        internal Guid ReadElementContentAsGuid()
        {
            ...
            string g = this.reader.ReadElementContentAsString();
            try
            {
                guid = new Guid(g);
            }
        ...
        internal short ReadElementContentAsShort() => 
            this.ToShort(this.ReadElementContentAsInt());

        internal sbyte ReadElementContentAsSignedByte() => 
            this.ToSByte(this.ReadElementContentAsInt());
        ...
        internal byte ReadElementContentAsUnsignedByte() => 
            this.ToByte(this.ReadElementContentAsInt());

        internal uint ReadElementContentAsUnsignedInt() => 
            this.ToUInt32(this.ReadElementContentAsLong());
        ...
        internal ushort ReadElementContentAsUnsignedShort() => 
            this.ToUInt16(this.ReadElementContentAsInt());
        ...
        internal ExtensionDataReader UnderlyingExtensionDataReader =>
            (this.reader as ExtensionDataReader);
