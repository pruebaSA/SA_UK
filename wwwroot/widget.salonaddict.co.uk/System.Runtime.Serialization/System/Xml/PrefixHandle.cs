namespace System.Xml
{
    ...
    internal class PrefixHandle
    {
        ...
        public int CompareTo(PrefixHandle that) => 
            this.GetString().CompareTo(that.GetString());
        ...
        public bool IsEmpty =>
            (this.type == PrefixHandleType.Empty);
