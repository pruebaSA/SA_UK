    ...
    internal class BufferedReadStream : Stream
    {
        ...
        public void Push(byte[] buffer, int offset, int count)
        {
            if (count != 0)
            {
                ...
                {
                    System.Buffer.BlockCopy(this.storedBuffer, this.storedOffset, this.storedBuffer, count, this.storedLength - this.storedOffset);
                ...
                else
                {
                    ...
                    System.Buffer.BlockCopy(this.storedBuffer, this.storedOffset, dst, count, this.storedLength - this.storedOffset);
                    this.storedLength += count - this.storedOffset;
                    this.storedOffset = 0;
                    this.storedBuffer = dst;
                }
                System.Buffer.BlockCopy(buffer, offset, this.storedBuffer, this.storedOffset, count);
            }
        }
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (this.storedOffset < this.storedLength)
            {
                ...
                System.Buffer.BlockCopy(this.storedBuffer, this.storedOffset, buffer, offset, num);
