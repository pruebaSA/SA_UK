namespace System.Xml
{
    ...
    internal class XmlBufferReader
    {
        ...
        public bool Equals2(int key1, int key2, XmlBufferReader bufferReader2) => 
            ((key1 == key2) || (this.GetDictionaryString(key1).Value == bufferReader2.GetDictionaryString(key2).Value));
        ...
        public XmlBinaryNodeType GetNodeType() => 
            ((XmlBinaryNodeType) this.GetByte());
        ...
        public ulong GetUInt64(int offset) => 
            ((ulong) this.GetInt64(offset));

        public string GetUnicodeString(int offset, int length) => 
            XmlConverter.ToStringUnicode(this.buffer, offset, length);

        public UniqueId GetUniqueId(int offset) => 
            new UniqueId(this.buffer, offset);
        ...
        public bool EndOfFile =>
            ((this.offset == this.offsetMax) && !this.TryEnsureByte());
