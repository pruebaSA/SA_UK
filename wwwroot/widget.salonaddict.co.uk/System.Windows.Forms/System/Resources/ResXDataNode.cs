namespace System.Resources
{
    ...
    public sealed class ResXDataNode : ISerializable
    {
        ...
        public object GetValue(AssemblyName[] names) => 
            this.GetValue(new AssemblyNamesTypeResolutionService(names));
                ...
                if ((fileRefType == null) || (fileRefType.Length == 0))
                {
                    if ((this.nodeInfo.MimeType != null) && (this.nodeInfo.MimeType.Length > 0))
                    {
                        ...
                        catch (Exception exception)
                        {
                            ...
                            fileRefType = typeof(object).AssemblyQualifiedName;
                        }
                        catch
                        {
                            throw;
                        ...
                        if (obj2 != null)
                        {
                            fileRefType = obj2.GetType().AssemblyQualifiedName;
                        }
                    }
                    else
                    {
                        fileRefType = typeof(string).AssemblyQualifiedName;
                    }
                }
                else
                {
        ...
        public string GetValueTypeName(AssemblyName[] names) => 
            this.GetValueTypeName(new AssemblyNamesTypeResolutionService(names));
        ...
        private string FileRefFullPath
        {
            get
            {
                string fileName = this.fileRef?.FileName;
                if (fileName == null)
                {
                    fileName = this.fileRefFullPath;
                }
                return fileName;
            }
        }
        ...
        private string FileRefTextEncoding
        {
            get
            {
                string bodyName = this.fileRef?.TextFileEncoding?.BodyName;
                if (bodyName == null)
                {
                    bodyName = this.fileRefTextEncoding;
                }
                return bodyName;
            }
        }
        ...
        private string FileRefType
        {
            get
            {
                string typeName = this.fileRef?.TypeName;
                if (typeName == null)
                {
                    typeName = this.fileRefType;
                }
                return typeName;
            }
        }
