namespace System.Security.Policy
{
    ...
    internal class TrustManagerPromptUI : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tableLayoutPanelInfo.ColumnStyles.Add(new ColumnStyle());
            this.tableLayoutPanelInfo.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 100f));
            ...
            this.lblName.Margin = new Padding(0, 0, 3, 8);
            this.lblName.Name = "lblName";
            manager.ApplyResources(this.lblFrom, "lblFrom");
            this.lblFrom.Margin = new Padding(0, 8, 3, 8);
            ...
            this.linkLblFromUrl.Margin = new Padding(3, 8, 3, 8);
            ...
            this.linkLblPublisher.Margin = new Padding(3, 8, 3, 0);
