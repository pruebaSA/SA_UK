namespace System.Windows.Forms
{
    ...
    public abstract class TableLayoutStyleCollection : IList, ICollection, IEnumerable
    {
        ...
        bool IList.Contains(object style) => 
            this._innerList.Contains(style);

        int IList.IndexOf(object style) => 
            this._innerList.IndexOf(style);
        ...
        {
            get => 
                ((TableLayoutStyle) ((IList) this)[index]);
            set
            {
        ...
        bool ICollection.IsSynchronized =>
            this._innerList.IsSynchronized;

        object ICollection.SyncRoot =>
            this._innerList.SyncRoot;

        bool IList.IsFixedSize =>
            this._innerList.IsFixedSize;

        bool IList.IsReadOnly =>
            this._innerList.IsReadOnly;

        object IList.this[int index]
        {
            get => 
                this._innerList[index];
            set
            {
