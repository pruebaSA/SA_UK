namespace System.Windows.Forms.ComponentModel.Com2Interop
{
    ...
    internal class Com2PropertyDescriptor : PropertyDescriptor, ICloneable
    {
        ...
        public object Clone() => 
            new Com2PropertyDescriptor(this.dispid, this.Name, (Attribute[]) this.baseAttrs.Clone(), this.readOnly, this.propertyType, this.typeData, this.hrHidden);

        protected override AttributeCollection CreateAttributeCollection() => 
            new AttributeCollection(this.AttributeArray);
        ...
        public object GetNativeValue(object component)
        {
            ...
            int errorCode = dispatch.Invoke(this.dispid, ref empty, SafeNativeMethods.GetThreadLCID(), 2, new NativeMethods.tagDISPPARAMS(), pVarResult, pExcepInfo, null);
            switch (errorCode)
            {
                case 0:
                case 1:
        ...
        public bool IsCurrentValue(object value) => 
            ((value == this.lastValue) || ((this.lastValue != null) && this.lastValue.Equals(value)));
        ...
        public override void SetValue(object component, object value)
        {
            ...
            if (((component != null) && Marshal.IsComObject(component)) && (component is UnsafeNativeMethods.IDispatch))
            {
                ...
                UnsafeNativeMethods.IDispatch dispatch = (UnsafeNativeMethods.IDispatch) component;
                NativeMethods.tagDISPPARAMS pDispParams = new NativeMethods.tagDISPPARAMS();
                NativeMethods.tagEXCEPINFO pExcepInfo = new NativeMethods.tagEXCEPINFO();
                pDispParams.cArgs = 1;
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        if (dispatch is UnsafeNativeMethods.ISupportErrorInfo)
                        {
                            ...
                            if (NativeMethods.Succeeded(((UnsafeNativeMethods.ISupportErrorInfo) dispatch).InterfaceSupportsErrorInfo(ref empty)))
                            {
                                UnsafeNativeMethods.IErrorInfo errorInfo = null;
                                UnsafeNativeMethods.GetErrorInfo(0, ref errorInfo);
                                if ((errorInfo != null) && NativeMethods.Succeeded(errorInfo.GetDescription(null)))
                                {
                        ...
                        else if (message == null)
                        {
                            ...
                            if (SafeNativeMethods.FormatMessage(0x1200, NativeMethods.NullHandleRef, dwMessageId, CultureInfo.CurrentCulture.LCID, lpBuffer, 0xff, NativeMethods.NullHandleRef) == 0)
                            {
            ...
            get
            {
                if (!this.AttributesValid && !this.InAttrQuery)
                {
                    ...
                    else if (this.hrHidden)
                    {
                        ...
                        if ((targetObject != null) && NativeMethods.Succeeded(new ComNativeDescriptor().GetPropertyValue(targetObject, this.dispid, new object[1])))
                        {
                            if (list == null)
                            {
                                list = new ArrayList(this.AttributeArray);
