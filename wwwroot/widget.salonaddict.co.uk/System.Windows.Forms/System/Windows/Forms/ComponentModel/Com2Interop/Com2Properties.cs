namespace System.Windows.Forms.ComponentModel.Com2Interop
{
    ...
    internal class Com2Properties
    {
        ...
        private static System.Type[] extendedInterfaces = new System.Type[] { typeof(NativeMethods.ICategorizeProperties), typeof(NativeMethods.IProvidePropertyBuilder), typeof(NativeMethods.IPerPropertyBrowsing), typeof(NativeMethods.IVsPerPropertyBrowsing), typeof(NativeMethods.IManagedPerPropertyBrowsing) };
        ...
        public bool CheckValid(bool checkVersions) => 
            this.CheckValid(checkVersions, true);
        ...
        private unsafe long GetTypeInfoVersion(UnsafeNativeMethods.ITypeInfo pTypeInfo)
        {
            ...
            if (!NativeMethods.Succeeded(pTypeInfo.GetTypeAttr(ref zero)))
            {
                return 0L;
            }
            try
