namespace System.Windows.Forms.ComponentModel.Com2Interop
{
    ...
    internal class ComNativeDescriptor : TypeDescriptionProvider
    {
        ...
        internal string GetClassName(object component)
        {
            ...
            if (((component is NativeMethods.IVsPerPropertyBrowsing) && NativeMethods.Succeeded(((NativeMethods.IVsPerPropertyBrowsing) component).GetClassName(ref pbstrClassName))) && (pbstrClassName != null))
            {
        ...
        internal TypeConverter GetConverter(object component) => 
            TypeDescriptor.GetConverter(typeof(IComponent));
        ...
        public static object GetNativePropertyValue(object component, string propertyName, ref bool succeeded) => 
            Instance.GetPropertyValue(component, propertyName, ref succeeded);
        ...
        internal int GetPropertyValue(object component, int dispid, object[] retval)
        {
            ...
            try
            {
                ...
                try
                {
                    scode = dispatch.Invoke(dispid, ref empty, SafeNativeMethods.GetThreadLCID(), 2, new NativeMethods.tagDISPPARAMS(), retval, pExcepInfo, null);
                    if (scode == -2147352567)
                    {
        ...
        internal object GetPropertyValue(object component, string propertyName, ref bool succeeded)
        {
            ...
            try
            {
                ...
                if ((rgDispId[0] == -1) || NativeMethods.Failed(hr))
                {
                    return null;
                }
            }
        ...
        internal bool IsNameDispId(object obj, int dispid) => 
            (((obj != null) && obj.GetType().IsCOMObject) && (dispid == Com2TypeInfoProcessor.GetNameDispId((UnsafeNativeMethods.IDispatch) obj)));
        ...
        private sealed class ComTypeDescriptor : ICustomTypeDescriptor
        {
            ...
            string ICustomTypeDescriptor.GetComponentName() => 
                this._handler.GetName(this._instance);
