    ...
    internal class Com2PropertyBuilderUITypeEditor : Com2ExtendedUITypeEditor
    {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            try
            {
                ...
                NativeMethods.IProvidePropertyBuilder builder = (NativeMethods.IProvidePropertyBuilder) targetObject;
                if (NativeMethods.Failed(builder.ExecuteBuilder(this.propDesc.DISPID, this.guidString, null, new HandleRef(null, focus), ref pvarValue, ref actionCommitted)))
                {
