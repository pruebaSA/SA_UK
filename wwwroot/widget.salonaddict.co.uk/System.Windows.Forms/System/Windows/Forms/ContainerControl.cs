namespace System.Windows.Forms
{
    ...
    public class ContainerControl : ScrollableControl, IContainerControl
    {
        ...
        [Browsable(false), System.Windows.Forms.SRDescription("ContainerControlOnAutoValidateChangedDescr"), EditorBrowsable(EditorBrowsableState.Never), System.Windows.Forms.SRCategory("CatPropertyChanged")]
        ...
        internal bool ActivateControlInternal(Control control) => 
            this.ActivateControlInternal(control, true);
        ...
        internal override bool CanProcessMnemonic() => 
            (this.state[stateProcessingMnemonic] || base.CanProcessMnemonic());
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData) => 
            (base.ProcessCmdKey(ref msg, keyData) || ((this.ParentInternal == null) && ToolStripManager.ProcessCmdKey(ref msg, keyData)));
        ...
        protected override bool ProcessDialogChar(char charCode) => 
            ((((base.GetContainerControlInternal() is ContainerControl) && (charCode != ' ')) && this.ProcessMnemonic(charCode)) || base.ProcessDialogChar(charCode));
        ...
        protected virtual bool ProcessTabKey(bool forward) => 
            base.SelectNextControl(this.activeControl, forward, true, true, false);
        ...
        internal virtual bool ShouldSerializeAutoValidate() => 
            (this.autoValidate != System.Windows.Forms.AutoValidate.Inherit);
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ContainerControlActiveControlDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), Localizable(true), EditorBrowsable(EditorBrowsableState.Advanced), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), EditorBrowsable(EditorBrowsableState.Advanced), Browsable(false), System.Windows.Forms.SRDescription("ContainerControlAutoScaleModeDescr")]
        ...
        [Browsable(false), System.Windows.Forms.SRCategory("CatBehavior"), EditorBrowsable(EditorBrowsableState.Never), AmbientValue(-1), System.Windows.Forms.SRDescription("ContainerControlAutoValidate")]
        ...
        [System.Windows.Forms.SRDescription("ContainerControlParentFormDescr"), Browsable(false), System.Windows.Forms.SRCategory("CatAppearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
