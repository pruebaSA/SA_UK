namespace System.Windows.Forms.Layout
{
    ...
    internal class TableLayout : LayoutEngine
    {
        ...
        private bool IsAbsolutelySized(int index, IList styles) => 
            ((index < styles.Count) && (((TableLayoutStyle) styles[index]).SizeType == SizeType.Absolute));

        private bool IsCursorPastInsertionPoint(LayoutInfo fixedLayoutInfo, int insertionRow, int insertionCol) => 
            ((fixedLayoutInfo.RowPosition < insertionRow) || ((fixedLayoutInfo.RowPosition == insertionRow) && (fixedLayoutInfo.ColumnPosition < insertionCol)));
        ...
        internal sealed class ContainerInfo
        {
            ...
            {
                get => 
                    this._state[stateChildHasColumnSpan];
                set
                {
            ...
            {
                get => 
                    this._state[stateChildHasRowSpan];
                set
                {
            ...
            public bool ChildInfoValid =>
                this._state[stateChildInfoValid];
