namespace System.Windows.Forms.Layout
{
    ...
    internal class FlowLayout : LayoutEngine
    {
        ...
        public static FlowDirection GetFlowDirection(IArrangedElement container) => 
            ((FlowDirection) container.Properties.GetInteger(_flowDirectionProperty));
        ...
        public static bool GetWrapContents(IArrangedElement container) => 
            (container.Properties.GetInteger(_wrapContentsProperty) == 0);
        ...
        private Size MeasureRow(ContainerProxy containerProxy, ElementProxy elementProxy, int startIndex, Rectangle displayRectangle, out int breakIndex) => 
            this.xLayoutRow(containerProxy, elementProxy, startIndex, containerProxy.Container.Children.Count, displayRectangle, out breakIndex, true);
        ...
        private class ElementProxy
        {
            ...
            public virtual Size GetPreferredSize(Size proposedSize) => 
                this._element.GetPreferredSize(proposedSize);
            ...
            public bool AutoSize =>
                CommonProperties.GetAutoSize(this._element);
            ...
            public virtual Padding Margin =>
                CommonProperties.GetMargin(this.Element);

            public virtual Size MinimumSize =>
                CommonProperties.GetMinimumSize(this.Element, Size.Empty);

            public bool ParticipatesInLayout =>
                this._element.ParticipatesInLayout;

            public virtual Size SpecifiedSize =>
                CommonProperties.GetSpecifiedBounds(this._element).Size;
        ...
        private class VerticalElementProxy : FlowLayout.ElementProxy
        {
            public override Size GetPreferredSize(Size proposedSize) => 
                LayoutUtils.FlipSize(base.GetPreferredSize(LayoutUtils.FlipSize(proposedSize)));
