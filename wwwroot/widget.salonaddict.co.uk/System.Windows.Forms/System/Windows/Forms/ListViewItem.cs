namespace System.Windows.Forms
{
    ...
    [Serializable, DefaultProperty("Text"), TypeConverter(typeof(ListViewItemConverter)), DesignTimeVisible(false), ToolboxItem(false)]
    public class ListViewItem : ICloneable, ISerializable
    {
        ...
        private bool ShouldSerializePosition() => 
            !this.position.Equals(new Point(-1, -1));
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), RefreshProperties(RefreshProperties.Repaint), DefaultValue(false)]
        public bool Checked
        {
            get => 
        ...
        {
            get => 
                (((this.listView != null) && this.listView.IsHandleCreated) && (this.listView.GetItemState(this.Index, 1) != 0));
            set
            {
                if ((this.listView != null) && this.listView.IsHandleCreated)
                {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), Localizable(true), DefaultValue((string) null)]
        ...
        [TypeConverter(typeof(NoneExcludedImageIndexConverter)), Localizable(true), System.Windows.Forms.SRDescription("ListViewItemImageIndexDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(-1), RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [DefaultValue(""), TypeConverter(typeof(ImageKeyConverter)), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), RefreshProperties(RefreshProperties.Repaint), Localizable(true), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [System.Windows.Forms.SRDescription("ListViewItemIndentCountDescr"), System.Windows.Forms.SRCategory("CatDisplay"), DefaultValue(0)]
        ...
        internal int RawStateImageIndex =>
            ((this.SavedStateImageIndex + 1) << 12);

        private int SavedStateImageIndex
        {
            get => 
                (this.state[SavedStateImageIndexSection] - 1);
            set
            {
        ...
        [Localizable(true), System.Windows.Forms.SRDescription("ListViewItemStateImageIndexDescr"), RelatedImageList("ListView.StateImageList"), TypeConverter(typeof(NoneExcludedImageIndexConverter)), DefaultValue(-1), System.Windows.Forms.SRCategory("CatBehavior"), RefreshProperties(RefreshProperties.Repaint), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        internal bool StateImageSet =>
            (this.state[StateImageMaskSet] != 0);

        internal bool StateSelected
        {
            get => 
                (this.state[StateSelectedSection] == 1);
            set
            {
        ...
        {
            get => 
                this.state[SubItemCountSection];
            set
            {
        ...
        [Editor("System.Windows.Forms.Design.ListViewSubItemCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("ListViewItemSubItemsDescr"), System.Windows.Forms.SRCategory("CatData")]
        ...
        [Bindable(true), DefaultValue((string) null), Localizable(false), System.Windows.Forms.SRCategory("CatData"), TypeConverter(typeof(StringConverter)), System.Windows.Forms.SRDescription("ControlTagDescr")]
        public object Tag
        {
            get => 
                this.userData;
        ...
        [Localizable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRCategory("CatAppearance")]
        public string Text
        {
            get
            {
        ...
        [DefaultValue(""), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(true)]
        public bool UseItemStyleForSubItems
        {
            get => 
                (this.state[StateWholeRowOneStyleSection] == 1);
            set
            {
        ...
        [Serializable, TypeConverter(typeof(ListViewSubItemConverter)), ToolboxItem(false), DesignTimeVisible(false), DefaultProperty("Text")]
        public class ListViewSubItem
        {
            ...
            internal bool CustomBackColor =>
                ((this.style != null) && !this.style.backColor.IsEmpty);

            internal bool CustomFont =>
                ((this.style != null) && (this.style.font != null));

            internal bool CustomForeColor =>
                ((this.style != null) && !this.style.foreColor.IsEmpty);
            ...
            [System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("ControlTagDescr"), DefaultValue((string) null), TypeConverter(typeof(StringConverter)), Localizable(false), Bindable(true)]
            public object Tag
            {
                get => 
                    this.userData;
        ...
        public class ListViewSubItemCollection : IList, ICollection, IEnumerable
        {
            ...
            bool IList.Contains(object subItem) => 
                ((subItem is ListViewItem.ListViewSubItem) && this.Contains((ListViewItem.ListViewSubItem) subItem));
