namespace System.Windows.Forms
{
    ...
    public class DataGridViewTextBoxCell : DataGridViewCell
    {
        ...
        private Rectangle GetAdjustedEditingControlBounds(Rectangle editingControlBounds, DataGridViewCellStyle cellStyle)
        {
            ...
            if (editingControl != null)
            {
                ...
                else
                {
                    ...
                    height = DataGridViewCell.MeasureTextHeight(base.DataGridView.CachedGraphics, editingControlFormattedValue, cellStyle.Font, width, flags);
                }
        ...
        public override bool KeyEntersEditMode(KeyEventArgs e) => 
            (((((char.IsLetterOrDigit((char) ((ushort) e.KeyCode)) && ((e.KeyCode < Keys.F1) || (e.KeyCode > Keys.F24))) || ((e.KeyCode >= Keys.NumPad0) && (e.KeyCode <= Keys.Divide))) || (((e.KeyCode >= Keys.Oem1) && (e.KeyCode <= Keys.Oem102)) || ((e.KeyCode == Keys.Space) && !e.Shift))) && (!e.Alt && !e.Control)) || base.KeyEntersEditMode(e));
        ...
        private bool OwnsEditingTextBox(int rowIndex) => 
            (((rowIndex != -1) && (this.EditingTextBox != null)) && (rowIndex == this.EditingTextBox.EditingControlRowIndex));
        ...
        public override string ToString() => 
            ("DataGridViewTextBoxCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + base.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");

        private DataGridViewTextBoxEditingControl EditingTextBox
        {
            get => 
                ((DataGridViewTextBoxEditingControl) base.Properties.GetObject(PropTextBoxCellEditingTextBox));
            set
            {
