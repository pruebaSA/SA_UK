namespace System.Windows.Forms
{
    ...
    [ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch), ToolboxItem(false), Designer("System.Windows.Forms.Design.AxHostDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DesignTimeVisible(false), DefaultEvent("Enter"), PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust"), PermissionSet(SecurityAction.LinkDemand, Name="FullTrust")]
    public abstract class AxHost : Control, ISupportInitialize, ICustomTypeDescriptor
    {
        ...
        internal override bool CanSelectCore() => 
            ((this.GetControlEnabled() && !this.axState[rejectSelection]) && base.CanSelectCore());
        ...
        private bool CheckSubclassing()
        {
            ...
            if (((int) base.SendMessage(this.REGMSG_MSG, 0, 0)) == 0x7b)
            {
        ...
        private void EnsureWindowPresent()
        {
            ...
            {
                throw new InvalidOperationException(System.Windows.Forms.SR.GetString("AXNohWnd", new object[] { base.GetType().Name }));
            }
        }
        ...
        protected static Color GetColorFromOleColor(uint color) => 
            ColorTranslator.FromOle((int) color);
        ...
        protected static uint GetOleColorFromColor(Color color) => 
            ((uint) ColorTranslator.ToOle(color));
        ...
        {
            ContainerControl containingControl = this.ContainingControl;
            Control activeControl = containingControl?.ActiveControl;
            try
            {
                this.DoVerb(-1);
            }
            ...
            if ((containingControl != null) && (containingControl.ActiveControl != activeControl))
            {
                containingControl.ActiveControl = activeControl;
            }
        }
        ...
        protected override bool ProcessDialogKey(Keys keyData) => 
            (!this.ignoreDialogKeys && base.ProcessDialogKey(keyData));
        ...
        private bool ShouldSerializeContainingControl() => 
            (this.ContainingControl != this.ParentInternal);
        ...
        [RefreshProperties(RefreshProperties.All), EditorBrowsable(EditorBrowsableState.Advanced), DefaultValue((string) null), Browsable(false)]
        ...
        {
            get => 
                this.axState[refreshProperties];
            set
            {
        ...
        internal class AxContainer : System.Windows.Forms.UnsafeNativeMethods.IOleContainer, System.Windows.Forms.UnsafeNativeMethods.IOleInPlaceFrame, IReflect
        {
            ...
            private Hashtable GetComponents() => 
                this.GetComponents(this.GetParentsContainer());
            ...
            private class ExtenderProxy : System.Windows.Forms.UnsafeNativeMethods.IExtender, System.Windows.Forms.UnsafeNativeMethods.IVBGetControl, System.Windows.Forms.UnsafeNativeMethods.IGetVBAObject, System.Windows.Forms.UnsafeNativeMethods.IGetOleObject, IReflect
            {
                ...
                private AxHost.AxContainer GetC() => 
                    ((AxHost.AxContainer) this.pContainer.Target);

                private Control GetP() => 
                    ((Control) this.pRef.Target);
                ...
                MethodInfo[] IReflect.GetMethods(BindingFlags bindingAttr) => 
                    new MethodInfo[] { base.GetType().GetMethod("Move") };
                ...
                {
                    get => 
                        AxHost.GetOleColorFromColor(this.GetP().BackColor);
                    set
                    {
                ...
                public object Container =>
                    this.GetC().GetProxyForContainer();
                ...
                {
                    get => 
                        AxHost.GetOleColorFromColor(this.GetP().ForeColor);
                    set
                    {
                ...
                {
                    get => 
                        AxHost.Pixel2Twip(this.GetP().Height, false);
                    set
                    {
                ...
                {
                    get => 
                        AxHost.Pixel2Twip(this.GetP().Left, true);
                    set
                    {
                ...
                public string Name =>
                    this.GetC().GetNameForControl(this.GetP());

                public object Parent =>
                    this.GetC().GetProxyForControl(this.GetC().parent);
                ...
                {
                    get => 
                        AxHost.Pixel2Twip(this.GetP().Top, false);
                    set
                    {
                ...
                {
                    get => 
                        AxHost.Pixel2Twip(this.GetP().Width, true);
                    set
                    {
        ...
        internal class AxPropertyDescriptor : PropertyDescriptor
        {
            ...
            private bool GetFlag(int flagValue) => 
                ((this.flags & flagValue) == flagValue);
            ...
            public override bool ShouldSerializeValue(object o) => 
                this.baseProp.ShouldSerializeValue(o);
            ...
            public override bool IsReadOnly =>
                this.baseProp.IsReadOnly;

            public override System.Type PropertyType =>
                this.baseProp.PropertyType;
        ...
        public class ConnectionPointCookie
        {
            ...
            internal bool Connected =>
                ((this.connectionPoint != null) && (this.cookie != 0));
        }
        ...
        private class OleInterfaces : System.Windows.Forms.UnsafeNativeMethods.IOleControlSite, System.Windows.Forms.UnsafeNativeMethods.IOleClientSite, System.Windows.Forms.UnsafeNativeMethods.IOleInPlaceSite, System.Windows.Forms.UnsafeNativeMethods.ISimpleFrameSite, System.Windows.Forms.UnsafeNativeMethods.IVBGetControl, System.Windows.Forms.UnsafeNativeMethods.IGetVBAObject, System.Windows.Forms.UnsafeNativeMethods.IPropertyNotifySink, IReflect
        {
            ...
            int System.Windows.Forms.UnsafeNativeMethods.IOleInPlaceSite.DeactivateAndUndo() => 
                this.host.GetInPlaceObject().UIDeactivate();
                    ...
                    try
                    {
                        ...
                        if (site != null)
                        {
                            ...
                            if (service != null)
                            {
                                ...
                                service.OnComponentChanged(this.host, member, null, member?.GetValue(this.host));
                            }
                        }
                    }
                    catch (Exception exception2)
