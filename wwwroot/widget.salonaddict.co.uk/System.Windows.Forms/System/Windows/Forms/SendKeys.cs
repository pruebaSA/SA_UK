    ...
    public class SendKeys
    {
        ...
        private static void InstallHook()
        {
            if (hhook == IntPtr.Zero)
            {
                ...
                hook = new NativeMethods.HookProc(proc1.Callback);
                stopHook = false;
        ...
        private static void ResetKeyboardUsingSendInput(int INPUTSize)
        {
            ...
            {
                NativeMethods.INPUT[] pInputs = new NativeMethods.INPUT[2];
                pInputs[0].type = 1;
        ...
        private class SendKeysHookProc
        {
            ...
            {
                NativeMethods.EVENTMSG structure = (NativeMethods.EVENTMSG) UnsafeNativeMethods.PtrToStructure(lparam, typeof(NativeMethods.EVENTMSG));
