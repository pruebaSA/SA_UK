namespace System.Windows.Forms
{
    ...
    internal class ToolStripPanelCell : ArrangedElement
    {
        ...
        public System.Windows.Forms.Control Control =>
            this._wrappedToolStrip;

        public bool ControlInDesignMode =>
            ((this._wrappedToolStrip != null) && this._wrappedToolStrip.IsInDesignMode);
        ...
        {
            get => 
                (((this.Control != null) && (this.Control.ParentInternal == this.ToolStripPanelRow.ToolStripPanel)) && this.InnerElement.ParticipatesInLayout);
            set
            {
