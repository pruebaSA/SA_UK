namespace System.Windows.Forms
{
    ...
    public class DataGridViewComboBoxCell : DataGridViewCell
    {
        ...
        private void CheckDropDownList(int x, int y, int rowIndex)
        {
            ...
            int num = Math.Min(this.GetDropDownButtonHeight(base.DataGridView.CachedGraphics, cellStyle), size2.Height - 2);
        ...
        protected override void OnMouseMove(DataGridViewCellMouseEventArgs e)
        {
            if (base.DataGridView != null)
            {
                if (((this.FlatStyle == System.Windows.Forms.FlatStyle.Standard) || (this.FlatStyle == System.Windows.Forms.FlatStyle.System)) && base.DataGridView.ApplyVisualStylesToInnerCells)
                {
                    ...
                    this.PaintPrivate(base.DataGridView.CachedGraphics, clipBounds, clipBounds, rowIndex, elementState, null, null, cellStyle, advancedBorderStyle, out rectangle2, DataGridViewPaintParts.ContentForeground, false, false, true, false);
        ...
        private bool OwnsEditingComboBox(int rowIndex) => 
            (((rowIndex != -1) && (this.EditingComboBox != null)) && (rowIndex == this.EditingComboBox.EditingControlRowIndex));
        ...
        public override string ToString() => 
            ("DataGridViewComboBoxCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + base.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");
        ...
        {
            get => 
                this.GetDataManager(base.DataGridView);
            set
            {
        ...
        {
            get => 
                base.Properties.GetObject(PropComboBoxCellDataSource);
            set
            {
        ...
        {
            get => 
                ((PropertyDescriptor) base.Properties.GetObject(PropComboBoxCellDisplayMemberProp));
            set
            {
        ...
        {
            get => 
                ((DataGridViewComboBoxEditingControl) base.Properties.GetObject(PropComboBoxCellEditingComboBox));
            set
            {
        ...
        public override System.Type FormattedValueType =>
            defaultFormattedValueType;

        internal bool HasItems =>
            (base.Properties.ContainsObject(PropComboBoxCellItems) && (base.Properties.GetObject(PropComboBoxCellItems) != null));

        [Browsable(false)]
        public virtual ObjectCollection Items =>
            this.GetItems(base.DataGridView);
        ...
        private bool PaintXPThemes =>
            (((this.FlatStyle != System.Windows.Forms.FlatStyle.Flat) && (this.FlatStyle != System.Windows.Forms.FlatStyle.Popup)) && base.DataGridView.ApplyVisualStylesToInnerCells);
        ...
        {
            get => 
                ((DataGridViewComboBoxColumn) base.Properties.GetObject(PropComboBoxCellColumnTemplate));
            set
            {
        ...
        {
            get => 
                ((PropertyDescriptor) base.Properties.GetObject(PropComboBoxCellValueMemberProp));
            set
            {
