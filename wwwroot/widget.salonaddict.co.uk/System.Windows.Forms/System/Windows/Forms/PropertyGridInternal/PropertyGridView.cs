namespace System.Windows.Forms.PropertyGridInternal
{
    ...
    internal class PropertyGridView : Control, IWin32Window, IWindowsFormsEditorService, IServiceProvider
    {
        ...
        private GridEntry GetGridEntryFromRow(int row) => 
            this.GetGridEntryFromOffset(row + this.GetScrollOffset());
        ...
        private int GetIPELabelIndent(GridEntry gridEntry) => 
            (gridEntry.PropertyLabelIndent + 1);
        ...
        protected virtual bool GetScrollbarHidden() => 
            ((this.scrollBar == null) || !this.ScrollBar.Visible);
        ...
        public virtual int GetTotalWidth() => 
            ((this.GetLabelWidth() + this.GetSplitterWidth()) + this.GetValueWidth());
        ...
        public virtual int GetValueWidth() => 
            ((int) (this.InternalLabelWidth * (this.labelRatio - 1.0)));
        ...
        private bool IsScrollValueValid(int newValue) => 
            (((newValue != this.ScrollBar.Value) && (newValue >= 0)) && ((newValue <= this.ScrollBar.Maximum) && ((newValue + (this.ScrollBar.LargeChange - 1)) < this.totalProps)));
        ...
        internal ArrayList SaveHierarchyState(GridEntryCollection entries) => 
            this.SaveHierarchyState(entries, null);
        ...
        private bool SplitterInside(int x, int y) => 
            (Math.Abs((int) (x - this.InternalLabelWidth)) < 4);
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced), Browsable(false)]
        public bool CanCut =>
            (this.CanCopy && this.selectedGridEntry.IsTextEditable);

        [Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced)]
        public bool CanPaste =>
            ((this.selectedGridEntry != null) && this.selectedGridEntry.IsTextEditable);

        [EditorBrowsable(EditorBrowsableState.Advanced), Browsable(false)]
        public bool CanUndo =>
            ((this.Edit.Visible && this.Edit.Focused) && (0 != ((int) this.Edit.SendMessage(0xc6, 0, 0))));
        ...
        public bool FocusInside =>
            (base.ContainsFocus || ((this.dropDownHolder != null) && this.dropDownHolder.ContainsFocus));
        ...
        private bool HasEntries =>
            ((this.topLevelGridEntries != null) && (this.topLevelGridEntries.Count > 0));
