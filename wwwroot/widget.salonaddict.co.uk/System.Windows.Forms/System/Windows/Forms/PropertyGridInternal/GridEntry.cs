namespace System.Windows.Forms.PropertyGridInternal
{
    ...
    internal abstract class GridEntry : GridItem, ITypeDescriptorContext, IServiceProvider
    {
        ...
        public override bool Equals(object obj) => 
            (this.NonParentEquals(obj) && (((GridEntry) obj).ParentGridEntry == this.ParentGridEntry));
        ...
        protected virtual Brush GetBackgroundBrush(Graphics g) => 
            this.GridEntryHost.GetBackgroundBrush(g);

        internal virtual int GetChildIndex(GridEntry pe) => 
            this.Children.GetEntry(pe);
        ...
        public virtual string GetPropertyTextValue() => 
            this.GetPropertyTextValue(this.PropertyValue);
        ...
        public virtual object GetValueOwner() => 
            this.parentPE?.GetChildValueOwner(this);
        ...
        internal virtual bool NotifyChildValue(GridEntry pe, int type) => 
            pe.NotifyValueGivenParent(pe.GetValueOwner(), type);

        internal virtual bool NotifyValue(int type) => 
            ((this.parentPE == null) || this.parentPE.NotifyChildValue(this, type));
        ...
        public override string ToString() => 
            (base.GetType().FullName + " " + this.PropertyLabel);
        ...
        internal virtual AttributeCollection Attributes =>
            TypeDescriptor.GetAttributes(this.PropertyType);
        ...
        protected virtual IComponentChangeService ComponentChangeService =>
            this.parentPE.ComponentChangeService;
        ...
        public override System.Windows.Forms.GridItemType GridItemType =>
            System.Windows.Forms.GridItemType.Property;
        ...
        {
            get => 
                (((this.childCollection != null) && (this.childCollection.Count != 0)) && this.GetFlagSet(0x10000));
            set
            {
        ...
        public virtual bool IsTextEditable =>
            (this.IsValueEditable && ((this.Flags & 1) != 0));

        public virtual bool IsValueEditable =>
            (!this.ForceReadOnly && (0 != (this.Flags & 0x33)));
        ...
        public virtual string PropertyCategory =>
            CategoryAttribute.Default.Category;
        ...
        public virtual bool ShouldRenderReadOnly =>
            (this.ForceReadOnly || (((this.Flags & 0x100) != 0) || (!this.IsValueEditable && (0 == (this.Flags & 0x80)))));
        ...
        public class DisplayNameSortComparer : IComparer
        {
            public int Compare(object left, object right) => 
                string.Compare(((PropertyDescriptor) left).DisplayName, ((PropertyDescriptor) right).DisplayName, true, CultureInfo.CurrentCulture);
        }
        ...
        public class GridEntryAccessibleObject : AccessibleObject
        {
            ...
            public override Rectangle Bounds =>
                this.PropertyGridView.AccessibilityGetGridEntryBounds(this.owner);
            ...
            public override string Description =>
                this.owner.PropertyDescription;

            public override string Name =>
                this.owner.PropertyLabel;
            ...
            private System.Windows.Forms.PropertyGridInternal.PropertyGridView PropertyGridView =>
                ((System.Windows.Forms.PropertyGridInternal.PropertyGridView) ((System.Windows.Forms.PropertyGridInternal.PropertyGridView.PropertyGridViewAccessibleObject) this.Parent).Owner);
            ...
            public override string Value
            {
                [SecurityPermission(SecurityAction.Demand, Flags=SecurityPermissionFlag.UnmanagedCode)]
                get => 
                    this.owner.GetPropertyTextValue();
                [SecurityPermission(SecurityAction.Demand, Flags=SecurityPermissionFlag.UnmanagedCode)]
                set
                {
