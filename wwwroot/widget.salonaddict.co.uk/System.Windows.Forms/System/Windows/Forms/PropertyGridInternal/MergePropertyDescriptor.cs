namespace System.Windows.Forms.PropertyGridInternal
{
    ...
    internal class MergePropertyDescriptor : PropertyDescriptor
    {
        ...
        public override object GetEditor(Type editorBaseType) => 
            this.descriptors[0].GetEditor(editorBaseType);
        ...
        public override Type ComponentType =>
            this.descriptors[0].ComponentType;

        public override TypeConverter Converter =>
            this.descriptors[0].Converter;

        public override string DisplayName =>
            this.descriptors[0].DisplayName;
        ...
        public override Type PropertyType =>
            this.descriptors[0].PropertyType;
        ...
        private class MergedAttributeCollection : AttributeCollection
        {
            ...
            public override Attribute this[Type attributeType] =>
                this.GetCommonAttribute(attributeType);
        }
