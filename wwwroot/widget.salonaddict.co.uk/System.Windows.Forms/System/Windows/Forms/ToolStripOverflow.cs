namespace System.Windows.Forms
{
    ...
    public class ToolStripOverflow : ToolStripDropDown, IArrangedElement, IComponent, IDisposable
    {
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new ToolStripOverflowAccessibleObject(this);
        ...
        public override ToolStripItemCollection Items =>
            new ToolStripItemCollection(null, false, true);
        ...
        private class ToolStripOverflowAccessibleObject : ToolStrip.ToolStripAccessibleObject
        {
            ...
            public override AccessibleObject GetChild(int index) => 
                ((ToolStripOverflow) base.Owner).DisplayedItems[index].AccessibilityObject;

            public override int GetChildCount() => 
                ((ToolStripOverflow) base.Owner).DisplayedItems.Count;
        }
    }
}
