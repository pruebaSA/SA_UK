namespace System.Windows.Forms
{
    ...
    [DefaultProperty("DataSource"), ClassInterface(ClassInterfaceType.AutoDispatch), ComVisible(true), DefaultEvent("Navigate"), ComplexBindingProperties("DataSource", "DataMember"), Designer("System.Windows.Forms.Design.DataGridDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public class DataGrid : Control, ISupportInitialize, IDataGridEditingService
    {
        ...
        [System.Windows.Forms.SRDescription("DataGridOnNavigationModeChangedDescr"), System.Windows.Forms.SRCategory("CatPropertyChanged")]
        ...
        [System.Windows.Forms.SRCategory("CatPropertyChanged"), System.Windows.Forms.SRDescription("DataGridOnBorderStyleChangedDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatPropertyChanged"), System.Windows.Forms.SRDescription("DataGridOnCaptionVisibleChangedDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatAction"), System.Windows.Forms.SRDescription("DataGridNavigateEventDescr")]
        ...
        [System.Windows.Forms.SRDescription("DataGridOnParentRowsVisibleChangedDescr"), System.Windows.Forms.SRCategory("CatPropertyChanged")]
        ...
        [System.Windows.Forms.SRDescription("DataGridOnReadOnlyChangedDescr"), System.Windows.Forms.SRCategory("CatPropertyChanged")]
        ...
        [System.Windows.Forms.SRDescription("DataGridScrollEventDescr"), System.Windows.Forms.SRCategory("CatAction")]
        ...
        [System.Windows.Forms.SRDescription("DataGridDownButtonClickDescr"), System.Windows.Forms.SRCategory("CatAction")]
        ...
        private Rectangle CalcColResizeFeedbackRect(MouseEventArgs e)
        {
            ...
            Rectangle rectangle2 = new Rectangle(e.X, data.Y, 3, data.Height);
        ...
        {
            Rectangle data = this.layout.Data;
            Rectangle rectangle2 = new Rectangle(data.X, e.Y, data.Width, 3);
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new DataGridAccessibleObject(this);
        ...
        public Rectangle GetCellBounds(DataGridCell dgc) => 
            this.GetCellBounds(dgc.RowNumber, dgc.ColumnNumber);
        ...
        public HitTestInfo HitTest(Point position) => 
            this.HitTest(position.X, position.Y);
        ...
        public bool IsSelected(int row) => 
            this.DataGridRows[row].Selected;
            ...
            switch ((keyData & Keys.KeyCode))
            {
                ...
                case Keys.C:
                    if ((((keyData & Keys.Control) != Keys.None) && ((keyData & Keys.Alt) == Keys.None)) && this.Bound)
                    {
                        ...
                        {
                            DataGridColumnStyle style = this.myGridTable.GridColumnStyles[this.currentCol];
        ...
        protected virtual bool ShouldSerializeAlternatingBackColor() => 
            !this.AlternatingBackBrush.Equals(DefaultAlternatingBackBrush);

        internal override bool ShouldSerializeBackColor() => 
            !DefaultBackBrush.Color.Equals(this.BackColor);

        protected virtual bool ShouldSerializeBackgroundColor() => 
            !this.BackgroundBrush.Equals(DefaultBackgroundBrush);

        protected virtual bool ShouldSerializeCaptionBackColor() => 
            this.Caption.ShouldSerializeBackColor();

        private bool ShouldSerializeCaptionFont() => 
            this.Caption.ShouldSerializeFont();

        protected virtual bool ShouldSerializeCaptionForeColor() => 
            this.Caption.ShouldSerializeForeColor();

        internal override bool ShouldSerializeForeColor() => 
            !DefaultForeBrush.Color.Equals(this.ForeColor);

        protected virtual bool ShouldSerializeGridLineColor() => 
            !this.GridLineBrush.Equals(DefaultGridLineBrush);

        protected virtual bool ShouldSerializeHeaderBackColor() => 
            !this.HeaderBackBrush.Equals(DefaultHeaderBackBrush);

        protected bool ShouldSerializeHeaderFont() => 
            (this.headerFont != null);

        protected virtual bool ShouldSerializeHeaderForeColor() => 
            !this.HeaderForePen.Equals(DefaultHeaderForePen);

        internal virtual bool ShouldSerializeLinkColor() => 
            !this.LinkBrush.Equals(DefaultLinkBrush);

        protected virtual bool ShouldSerializeLinkHoverColor() => 
            false;

        protected virtual bool ShouldSerializeParentRowsBackColor() => 
            !this.ParentRowsBackBrush.Equals(DefaultParentRowsBackBrush);

        protected virtual bool ShouldSerializeParentRowsForeColor() => 
            !this.ParentRowsForeBrush.Equals(DefaultParentRowsForeBrush);

        protected bool ShouldSerializePreferredRowHeight() => 
            (this.prefferedRowHeight != (defaultFontHeight + 3));

        protected bool ShouldSerializeSelectionBackColor() => 
            !DefaultSelectionBackBrush.Equals(this.selectionBackBrush);

        protected virtual bool ShouldSerializeSelectionForeColor() => 
            !this.SelectionForeBrush.Equals(DefaultSelectionForeBrush);
        ...
        [System.Windows.Forms.SRDescription("DataGridBorderStyleDescr"), System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(2), DispId(-504)]
        ...
        private bool Bound =>
            ((this.listManager != null) && (this.myGridTable != null));
        ...
        [Localizable(true), System.Windows.Forms.SRDescription("DataGridCaptionFontDescr"), AmbientValue((string) null), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [System.Windows.Forms.SRCategory("CatColors"), System.Windows.Forms.SRDescription("DataGridCaptionForeColorDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(""), Localizable(true), System.Windows.Forms.SRDescription("DataGridCaptionTextDescr")]
        ...
        [System.Windows.Forms.SRDescription("DataGridCaptionVisibleDescr"), System.Windows.Forms.SRCategory("CatDisplay"), DefaultValue(true)]
        public bool CaptionVisible
        {
            get => 
                this.layout.CaptionVisible;
            set
            {
        ...
        [System.Windows.Forms.SRDescription("DataGridColumnHeadersVisibleDescr"), System.Windows.Forms.SRCategory("CatDisplay"), DefaultValue(true)]
        ...
        {
            get => 
                new DataGridCell(this.currentRow, this.currentCol);
            set
            {
                if (this.layout.dirty)
                {
        ...
        [System.Windows.Forms.SRDescription("DataGridSelectedIndexDescr"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue((string) null), System.Windows.Forms.SRDescription("DataGridDataMemberDescr"), System.Windows.Forms.SRCategory("CatData"), Editor("System.Windows.Forms.Design.DataMemberListEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [System.Windows.Forms.SRCategory("CatData"), DefaultValue((string) null), RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRDescription("DataGridDataSourceDescr"), AttributeProvider(typeof(IListSource))]
        ...
        private static SolidBrush DefaultSelectionForeBrush =>
            ((SolidBrush) SystemBrushes.ActiveCaptionText);

        protected override Size DefaultSize =>
            new Size(130, 80);

        [System.Windows.Forms.SRDescription("DataGridFirstVisibleColumnDescr"), Browsable(false)]
        public int FirstVisibleColumn =>
            this.firstVisibleCol;

        [System.Windows.Forms.SRDescription("DataGridFlatModeDescr"), System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(false)]
        ...
        [System.Windows.Forms.SRCategory("CatColors"), System.Windows.Forms.SRDescription("DataGridGridLineColorDescr")]
        public Color GridLineColor
        {
            get => 
                this.gridLineBrush.Color;
            set
            {
        ...
        [DefaultValue(1), System.Windows.Forms.SRDescription("DataGridGridLineStyleDescr"), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [System.Windows.Forms.SRDescription("DataGridHeaderFontDescr"), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        {
            get => 
                this[cell.RowNumber, cell.ColumnNumber];
            set
            {
        ...
        [System.Windows.Forms.SRDescription("DataGridLinkHoverColorDescr"), EditorBrowsable(EditorBrowsableState.Never), System.Windows.Forms.SRCategory("CatColors"), Browsable(false)]
        ...
        [Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced), System.Windows.Forms.SRDescription("DataGridListManagerDescr")]
        ...
        internal AccessibleObject ParentRowsAccessibleObject =>
            this.parentRows.AccessibleObject;

        internal SolidBrush ParentRowsBackBrush =>
            this.parentRows.BackBrush;
        ...
        internal Rectangle ParentRowsBounds =>
            this.layout.ParentRows;

        internal SolidBrush ParentRowsForeBrush =>
            this.parentRows.ForeBrush;
        ...
        [System.Windows.Forms.SRCategory("CatDisplay"), System.Windows.Forms.SRDescription("DataGridParentRowsLabelStyleDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(3)]
        public DataGridParentRowsLabelStyle ParentRowsLabelStyle
        {
            get => 
                this.parentRowsLabels;
            set
            {
        ...
        [DefaultValue(0x4b), TypeConverter(typeof(DataGridPreferredColumnWidthTypeConverter)), System.Windows.Forms.SRCategory("CatLayout"), System.Windows.Forms.SRDescription("DataGridPreferredColumnWidthDescr")]
        ...
        [System.Windows.Forms.SRDescription("DataGridPreferredRowHeightDescr"), System.Windows.Forms.SRCategory("CatLayout")]
        public int PreferredRowHeight
        {
            get => 
                this.prefferedRowHeight;
            set
            {
                if (value < 0)
                {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(false), System.Windows.Forms.SRDescription("DataGridReadOnlyDescr")]
        public bool ReadOnly
        {
            get => 
                this.gridState[0x1000];
            set
            {
        ...
        [System.Windows.Forms.SRCategory("CatDisplay"), DefaultValue(true), System.Windows.Forms.SRDescription("DataGridRowHeadersVisibleDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), DefaultValue(0x23), System.Windows.Forms.SRDescription("DataGridRowHeaderWidthDescr")]
        ...
        [System.Windows.Forms.SRDescription("DataGridGridTablesDescr"), System.Windows.Forms.SRCategory("CatData"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Localizable(true)]
        ...
        [Browsable(false), System.Windows.Forms.SRDescription("DataGridVertScrollBarDescr"), EditorBrowsable(EditorBrowsableState.Advanced)]
        protected ScrollBar VertScrollBar =>
            this.vertScrollBar;

        [Browsable(false), System.Windows.Forms.SRDescription("DataGridVisibleColumnCountDescr")]
        public int VisibleColumnCount =>
            Math.Min(this.numVisibleCols, (this.myGridTable == null) ? 0 : this.myGridTable.GridColumnStyles.Count);

        [System.Windows.Forms.SRDescription("DataGridVisibleRowCountDescr"), Browsable(false)]
        ...
        internal class DataGridAccessibleObject : Control.ControlAccessibleObject
        {
            ...
            public override AccessibleObject GetChild(int index)
            {
                ...
                int length = owner.dataGridRows.Length;
            ...
            private int ColumnCount =>
                ((System.Windows.Forms.DataGrid) base.Owner).myGridTable.GridColumnStyles.Count;

            internal System.Windows.Forms.DataGrid DataGrid =>
                ((System.Windows.Forms.DataGrid) base.Owner);
            ...
            private int RowCount =>
                ((System.Windows.Forms.DataGrid) base.Owner).dataGridRows.Length;
        }
        ...
        public sealed class HitTestInfo
        {
            ...
            public override int GetHashCode() => 
                ((((int) this.type) + (this.row << 8)) + (this.col << 0x10));

            public override string ToString() => 
                ("{ " + this.type.ToString() + "," + this.row.ToString(CultureInfo.InvariantCulture) + "," + this.col.ToString(CultureInfo.InvariantCulture) + "}");
