namespace System.Windows.Forms
{
    ...
    [ClassInterface(ClassInterfaceType.AutoDispatch), ComVisible(true), LookupBindingProperties("DataSource", "DisplayMember", "ValueMember", "SelectedValue")]
    public abstract class ListControl : Control
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced), Browsable(false), System.Windows.Forms.SRCategory("CatPropertyChanged"), System.Windows.Forms.SRDescription("ListControlFormatInfoChangedDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatPropertyChanged"), System.Windows.Forms.SRDescription("ListControlOnSelectedValueChangedDescr")]
        ...
        protected object FilterItemOnProperty(object item) => 
            this.FilterItemOnProperty(item, this.displayMember.BindingField);
        ...
        internal int FindStringInternal(string str, IList items, int startIndex, bool exact) => 
            this.FindStringInternal(str, items, startIndex, exact, true);
        ...
        internal bool BindingFieldEmpty =>
            (this.displayMember.BindingField.Length <= 0);

        protected CurrencyManager DataManager =>
            this.dataManager;

        [AttributeProvider(typeof(IListSource)), System.Windows.Forms.SRDescription("ListControlDataSourceDescr"), System.Windows.Forms.SRCategory("CatData"), DefaultValue((string) null), RefreshProperties(RefreshProperties.Repaint)]
        ...
        [TypeConverter("System.Windows.Forms.Design.DataMemberFieldConverter, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultValue(""), System.Windows.Forms.SRDescription("ListControlDisplayMemberDescr"), System.Windows.Forms.SRCategory("CatData"), Editor("System.Windows.Forms.Design.DataMemberFieldEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        public string DisplayMember
        {
            get => 
                this.displayMember.BindingMember;
            set
            {
        ...
        [MergableProperty(false), Editor("System.Windows.Forms.Design.FormatStringEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), DefaultValue(""), System.Windows.Forms.SRDescription("ListControlFormatStringDescr")]
        ...
        [Browsable(false), DefaultValue((string) null), Bindable(true), System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("ListControlSelectedValueDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRCategory("CatData"), DefaultValue(""), Editor("System.Windows.Forms.Design.DataMemberFieldEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), System.Windows.Forms.SRDescription("ListControlValueMemberDescr")]
        public string ValueMember
        {
            get => 
                this.valueMember.BindingMember;
            set
            {
                if (value == null)
                {
