namespace System.Windows.Forms
{
    ...
    [System.Windows.Forms.SRDescription("DescriptionPrintPreviewControl"), ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch), DefaultProperty("Document")]
    public class PrintPreviewControl : Control
    {
        ...
        [System.Windows.Forms.SRDescription("RadioButtonOnStartPageChangedDescr"), System.Windows.Forms.SRCategory("CatPropertyChanged")]
        ...
        private static Point PhysicalToPixels(Point physical, Point dpi) => 
            new Point(PhysicalToPixels(physical.X, dpi.X), PhysicalToPixels(physical.Y, dpi.Y));

        private static Size PhysicalToPixels(Size physicalSize, Point dpi) => 
            new Size(PhysicalToPixels(physicalSize.Width, dpi.X), PhysicalToPixels(physicalSize.Height, dpi.Y));

        private static int PhysicalToPixels(int physicalSize, int dpi) => 
            ((int) (((double) (physicalSize * dpi)) / 100.0));

        private static Point PixelsToPhysical(Point pixels, Point dpi) => 
            new Point(PixelsToPhysical(pixels.X, dpi.X), PixelsToPhysical(pixels.Y, dpi.Y));

        private static Size PixelsToPhysical(Size pixels, Point dpi) => 
            new Size(PixelsToPhysical(pixels.Width, dpi.X), PixelsToPhysical(pixels.Height, dpi.Y));

        private static int PixelsToPhysical(int pixels, int dpi) => 
            ((int) ((pixels * 100.0) / ((double) dpi)));
        ...
        internal override bool ShouldSerializeBackColor() => 
            !this.BackColor.Equals(SystemColors.AppWorkspace);

        internal override bool ShouldSerializeForeColor() => 
            !this.ForeColor.Equals(Color.White);
        ...
        [DefaultValue(true), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("PrintPreviewAutoZoomDescr")]
        ...
        [DefaultValue(1), System.Windows.Forms.SRCategory("CatLayout"), System.Windows.Forms.SRDescription("PrintPreviewColumnsDescr")]
        public int Columns
        {
            get => 
                this.columns;
        ...
        [System.Windows.Forms.SRDescription("ControlWithScrollbarsPositionDescr"), System.Windows.Forms.SRCategory("CatLayout"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Localizable(true), System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("ControlRightToLeftDescr"), AmbientValue(2)]
        ...
        [DefaultValue(1), System.Windows.Forms.SRDescription("PrintPreviewRowsDescr"), System.Windows.Forms.SRCategory("CatBehavior")]
        public int Rows
        {
            get => 
                this.rows;
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("PrintPreviewStartPageDescr"), DefaultValue(0)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("PrintPreviewAntiAliasDescr"), DefaultValue(false)]
        ...
        [Browsable(false), System.Windows.Forms.SRDescription("ControlWithScrollbarsVirtualSizeDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), EditorBrowsable(EditorBrowsableState.Never), System.Windows.Forms.SRCategory("CatLayout")]
