namespace System.Windows.Forms
{
    ...
    public class DataGridViewButtonCell : DataGridViewCell
    {
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new DataGridViewButtonCellAccessibleObject(this);
        ...
        public override string ToString() => 
            ("DataGridViewButtonCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + base.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");
        ...
        protected class DataGridViewButtonCellAccessibleObject : DataGridViewCell.DataGridViewCellAccessibleObject
        {
            ...
            public override string DefaultAction =>
                System.Windows.Forms.SR.GetString("DataGridView_AccButtonCellDefaultAction");
        }
