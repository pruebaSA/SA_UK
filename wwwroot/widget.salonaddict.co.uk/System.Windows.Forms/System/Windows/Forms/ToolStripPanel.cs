namespace System.Windows.Forms
{
    ...
    [ToolboxBitmap(typeof(ToolStripPanel), "ToolStripPanel_standalone.bmp"), ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch), Designer("System.Windows.Forms.Design.ToolStripPanelDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public class ToolStripPanel : ContainerControl, IArrangedElement, IComponent, IDisposable
    {
        ...
        protected override Control.ControlCollection CreateControlsInstance() => 
            new ToolStripPanelControlCollection(this);

        private ToolStripPanelRowCollection CreateToolStripPanelRowCollection() => 
            new ToolStripPanelRowCollection(this);
        ...
        private bool ShouldSerializeDock() => 
            ((this.owner == null) && (this.Dock != DockStyle.None));
        ...
        internal Rectangle DragBounds =>
            LayoutUtils.InflateRect(base.ClientRectangle, DragMargin);
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced), DefaultValue(false), Browsable(false)]
        public bool Locked
        {
            get => 
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("ToolStripPanelRowsDescr"), Browsable(false)]
        ...
        [System.Windows.Forms.SRDescription("ToolStripPanelRowsDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Browsable(false)]
        ...
        private class FeedbackRectangle : IDisposable
        {
            ...
            {
                get => 
                    (((this.dropDown != null) && !this.dropDown.IsDisposed) && this.dropDown.Visible);
                set
                {
        ...
        public class ToolStripPanelRowCollection : ArrangedElementCollection, IList, ICollection, IEnumerable
        {
            ...
            int IList.Add(object value) => 
                this.Add(value as ToolStripPanelRow);
            ...
            int IList.IndexOf(object value) => 
                this.IndexOf(value as ToolStripPanelRow);
            ...
            public virtual ToolStripPanelRow this[int index] =>
                ((ToolStripPanelRow) base.InnerList[index]);

            bool IList.IsFixedSize =>
                base.InnerList.IsFixedSize;

            bool IList.IsReadOnly =>
                base.InnerList.IsReadOnly;
