namespace System.Windows.Forms
{
    ...
    {
        internal static object SecureConstructorInvoke(System.Type type, System.Type[] argTypes, object[] args, bool allowNonPublic) => 
            SecureConstructorInvoke(type, argTypes, args, allowNonPublic, BindingFlags.Default);

        internal static object SecureConstructorInvoke(System.Type type, System.Type[] argTypes, object[] args, bool allowNonPublic, BindingFlags extraFlags)
        {
            if (type == null)
            {
            ...
            if (type.Assembly == typeof(System.Windows.Forms.SecurityUtils).Assembly)
            {
        ...
        internal static object SecureCreateInstance(System.Type type, object[] args)
        {
            if (type == null)
            {
                throw new ArgumentNullException("type");
            }
            if (((type.Assembly == typeof(System.Windows.Forms.SecurityUtils).Assembly) && !type.IsPublic) && !type.IsNestedPublic)
            {
                new ReflectionPermission(PermissionState.Unrestricted).Demand();
            }
