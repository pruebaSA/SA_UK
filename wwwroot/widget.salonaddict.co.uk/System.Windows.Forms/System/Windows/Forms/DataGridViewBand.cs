namespace System.Windows.Forms
{
    ...
    public class DataGridViewBand : DataGridViewElement, ICloneable, IDisposable
    {
        ...
        internal bool ShouldSerializeResizable() => 
            ((this.State & DataGridViewElementStates.ResizableSet) != DataGridViewElementStates.None);
        ...
        public virtual bool Displayed =>
            ((this.State & DataGridViewElementStates.Displayed) != DataGridViewElementStates.None);
        ...
        {
            get => 
                ((this.State & DataGridViewElementStates.Frozen) != DataGridViewElementStates.None);
            set
            {
        ...
        public bool HasDefaultCellStyle =>
            (this.Properties.ContainsObject(PropDefaultCellStyle) && (this.Properties.GetObject(PropDefaultCellStyle) != null));

        internal bool HasDefaultHeaderCellType =>
            (this.Properties.ContainsObject(PropDefaultHeaderCellType) && (this.Properties.GetObject(PropDefaultHeaderCellType) != null));

        internal bool HasHeaderCell =>
            (this.Properties.ContainsObject(PropHeaderCell) && (this.Properties.GetObject(PropHeaderCell) != null));
        ...
        {
            get => 
                (((this.State & DataGridViewElementStates.ReadOnly) != DataGridViewElementStates.None) || ((base.DataGridView != null) && base.DataGridView.ReadOnly));
            set
            {
                if (base.DataGridView != null)
                {
        ...
        {
            get => 
                ((this.State & DataGridViewElementStates.Selected) != DataGridViewElementStates.None);
            set
            {
                if (base.DataGridView != null)
                {
        ...
        {
            get => 
                ((this.State & DataGridViewElementStates.Visible) != DataGridViewElementStates.None);
            set
            {
