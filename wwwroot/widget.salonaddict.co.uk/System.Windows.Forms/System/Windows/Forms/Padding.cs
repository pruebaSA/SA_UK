namespace System.Windows.Forms
{
    ...
    public struct Padding
    {
        ...
        public override string ToString() => 
            ("{Left=" + this.Left.ToString(CultureInfo.CurrentCulture) + ",Top=" + this.Top.ToString(CultureInfo.CurrentCulture) + ",Right=" + this.Right.ToString(CultureInfo.CurrentCulture) + ",Bottom=" + this.Bottom.ToString(CultureInfo.CurrentCulture) + "}");
