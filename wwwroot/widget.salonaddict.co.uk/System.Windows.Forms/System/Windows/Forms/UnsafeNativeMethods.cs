namespace System.Windows.Forms
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        public static IntPtr BeginPaint(HandleRef hWnd, [In, Out, MarshalAs(UnmanagedType.LPStruct)] ref System.Windows.Forms.NativeMethods.PAINTSTRUCT lpPaint) => 
            System.Internal.HandleCollector.Add(IntBeginPaint(hWnd, ref lpPaint), System.Windows.Forms.NativeMethods.CommonHandles.HDC);
        ...
        public static IntPtr CreateAcceleratorTable(HandleRef pentries, int cCount) => 
            System.Internal.HandleCollector.Add(IntCreateAcceleratorTable(pentries, cCount), System.Windows.Forms.NativeMethods.CommonHandles.Accelerator);

        public static IntPtr CreateCompatibleDC(HandleRef hDC) => 
            System.Internal.HandleCollector.Add(IntCreateCompatibleDC(hDC), System.Windows.Forms.NativeMethods.CommonHandles.CompatibleHDC);

        public static IntPtr CreateDC(string lpszDriver) => 
            System.Internal.HandleCollector.Add(IntCreateDC(lpszDriver, null, null, System.Windows.Forms.NativeMethods.NullHandleRef), System.Windows.Forms.NativeMethods.CommonHandles.HDC);

        public static IntPtr CreateDC(string lpszDriverName, string lpszDeviceName, string lpszOutput, HandleRef lpInitData) => 
            System.Internal.HandleCollector.Add(IntCreateDC(lpszDriverName, lpszDeviceName, lpszOutput, lpInitData), System.Windows.Forms.NativeMethods.CommonHandles.HDC);

        public static IntPtr CreateIC(string lpszDriverName, string lpszDeviceName, string lpszOutput, HandleRef lpInitData) => 
            System.Internal.HandleCollector.Add(IntCreateIC(lpszDriverName, lpszDeviceName, lpszOutput, lpInitData), System.Windows.Forms.NativeMethods.CommonHandles.HDC);
        ...
        public static IntPtr CreateMenu() => 
            System.Internal.HandleCollector.Add(IntCreateMenu(), System.Windows.Forms.NativeMethods.CommonHandles.Menu);

        public static IntPtr CreatePopupMenu() => 
            System.Internal.HandleCollector.Add(IntCreatePopupMenu(), System.Windows.Forms.NativeMethods.CommonHandles.Menu);
        ...
        public static IntPtr CreateWindowEx(int dwExStyle, string lpszClassName, string lpszWindowName, int style, int x, int y, int width, int height, HandleRef hWndParent, HandleRef hMenu, HandleRef hInst, [MarshalAs(UnmanagedType.AsAny)] object pvParam) => 
            IntCreateWindowEx(dwExStyle, lpszClassName, lpszWindowName, style, x, y, width, height, hWndParent, hMenu, hInst, pvParam);
        ...
        public static IntPtr GetDC(HandleRef hWnd) => 
            System.Internal.HandleCollector.Add(IntGetDC(hWnd), System.Windows.Forms.NativeMethods.CommonHandles.HDC);

        public static IntPtr GetDCEx(HandleRef hWnd, HandleRef hrgnClip, int flags) => 
            System.Internal.HandleCollector.Add(IntGetDCEx(hWnd, hrgnClip, flags), System.Windows.Forms.NativeMethods.CommonHandles.HDC);
        ...
        public static int GetObject(HandleRef hObject, System.Windows.Forms.NativeMethods.LOGBRUSH lb) => 
            GetObject(hObject, Marshal.SizeOf(typeof(System.Windows.Forms.NativeMethods.LOGBRUSH)), lb);

        public static int GetObject(HandleRef hObject, System.Windows.Forms.NativeMethods.LOGFONT lp) => 
            GetObject(hObject, Marshal.SizeOf(typeof(System.Windows.Forms.NativeMethods.LOGFONT)), lp);

        public static int GetObject(HandleRef hObject, System.Windows.Forms.NativeMethods.LOGPEN lp) => 
            GetObject(hObject, Marshal.SizeOf(typeof(System.Windows.Forms.NativeMethods.LOGPEN)), lp);
        ...
        public static IntPtr GetWindowDC(HandleRef hWnd) => 
            System.Internal.HandleCollector.Add(IntGetWindowDC(hWnd), System.Windows.Forms.NativeMethods.CommonHandles.HDC);
        ...
        public static IntPtr MapViewOfFile(HandleRef hFileMapping, int dwDesiredAccess, int dwFileOffsetHigh, int dwFileOffsetLow, int dwNumberOfBytesToMap) => 
            System.Internal.HandleCollector.Add(IntMapViewOfFile(hFileMapping, dwDesiredAccess, dwFileOffsetHigh, dwFileOffsetLow, dwNumberOfBytesToMap), System.Windows.Forms.NativeMethods.CommonHandles.Kernel);
        ...
        internal static int ReleaseComObject(object objToRelease) => 
            Marshal.ReleaseComObject(objToRelease);
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden), Guid("3050f611-98b5-11cf-bb82-00aa00bdce0b")]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f617-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f612-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f613-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, Guid("3050f60f-98b5-11cf-bb82-00aa00bdce0b"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, Guid("3050f7ff-98b5-11cf-bb82-00aa00bdce0b"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, Guid("3050f616-98b5-11cf-bb82-00aa00bdce0b"), InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden), Guid("3050f61b-98b5-11cf-bb82-00aa00bdce0b")]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f618-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f61c-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden), Guid("3050f61e-98b5-11cf-bb82-00aa00bdce0b")]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f61f-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden), Guid("3050f619-98b5-11cf-bb82-00aa00bdce0b")]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f622-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f615-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f623-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), TypeLibType(TypeLibTypeFlags.FHidden), Guid("3050f624-98b5-11cf-bb82-00aa00bdce0b")]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIDispatch), Guid("3050f625-98b5-11cf-bb82-00aa00bdce0b"), TypeLibType(TypeLibTypeFlags.FHidden)]
        ...
        public interface IAccessibleInternal
        {
            ...
            [return: MarshalAs(UnmanagedType.Struct)]
            [TypeLibFunc((short) 0x40), DispId(-5011)]
            object get_accFocus();
            [return: MarshalAs(UnmanagedType.Struct)]
        ...
        [ComImport, Guid("00bb2762-6a77-11d0-a535-00c04fd7d062"), SuppressUnmanagedCodeSecurity, InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        ...
        [ComImport, Guid("EAC04BC0-3791-11d2-BB95-0060977B464C"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown), SuppressUnmanagedCodeSecurity]
        ...
        [ComImport, SuppressUnmanagedCodeSecurity, Guid("B196B286-BAB4-101A-B69C-00AA00341D07"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("CB2F6722-AB3A-11d2-9C40-00C04FA30A3E")]
        ...
        [ComImport, Guid("8A701DA0-4FEB-101B-A82E-08002B2B2337"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
        ...
        [SuppressUnmanagedCodeSecurity, InterfaceType(ComInterfaceType.InterfaceIsDual), ComVisible(true), Guid("626FC520-A41E-11cf-A731-00A0C9082637")]
        ...
        [Guid("3050F485-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity, ComVisible(true)]
        ...
        [InterfaceType(ComInterfaceType.InterfaceIsDual), Guid("3050F69A-98B5-11CF-BB82-00AA00BDCE0B"), SuppressUnmanagedCodeSecurity, ComVisible(true)]
        ...
        [SuppressUnmanagedCodeSecurity, InterfaceType(ComInterfaceType.InterfaceIsDual), Guid("3050f5da-98b5-11cf-bb82-00aa00bdce0b"), ComVisible(true)]
        ...
        [ComVisible(true), Guid("3050F1FF-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity]
        ...
        [Guid("3050f434-98b5-11cf-bb82-00aa00bdce0b"), ComVisible(true), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity]
        ...
        [SuppressUnmanagedCodeSecurity, Guid("3050F21F-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsDual), ComVisible(true)]
        ...
        [SuppressUnmanagedCodeSecurity, Guid("3050F32D-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType(ComInterfaceType.InterfaceIsDual), ComVisible(true)]
        ...
        [SuppressUnmanagedCodeSecurity, ComVisible(true), InterfaceType(ComInterfaceType.InterfaceIsDual), Guid("3050f48B-98b5-11cf-bb82-00aa00bdce0b")]
        ...
        [SuppressUnmanagedCodeSecurity, Guid("3050f814-98b5-11cf-bb82-00aa00bdce0b"), InterfaceType(ComInterfaceType.InterfaceIsDual), ComVisible(true)]
        internal interface IHTMLEventObj4
        {
            int GetWheelDelta();
        }

        [Guid("332C4426-26CB-11D0-B483-00C04FD90119"), SuppressUnmanagedCodeSecurity, ComVisible(true), InterfaceType(ComInterfaceType.InterfaceIsDual)]
        ...
        [ComVisible(true), Guid("3050f35c-98b5-11cf-bb82-00aa00bdce0b"), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity]
        ...
        [ComVisible(true), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity, Guid("3050F25E-98B5-11CF-BB82-00AA00BDCE0B")]
        ...
        [ComVisible(true), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity, Guid("332C4427-26CB-11D0-B483-00C04FD90119")]
        ...
        [InterfaceType(ComInterfaceType.InterfaceIsDual), Guid("3050f4ae-98b5-11cf-bb82-00aa00bdce0b"), ComVisible(true), SuppressUnmanagedCodeSecurity]
        ...
        [SuppressUnmanagedCodeSecurity, InterfaceType(ComInterfaceType.InterfaceIsDual), ComVisible(true), Guid("3050f6cf-98b5-11cf-bb82-00aa00bdce0b")]
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("b722bcc5-4e68-101b-a2bc-00aa00404770")]
        ...
        [ComVisible(true), Guid("FECEAAA2-8405-11CF-8BA1-00AA00476DA6"), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity]
        ...
        [ComVisible(true), Guid("FECEAAA5-8405-11CF-8BA1-00AA00476DA6"), InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity]
        ...
        [InterfaceType(ComInterfaceType.InterfaceIsDual), SuppressUnmanagedCodeSecurity, Guid("8CC497C2-A1DF-11ce-8098-00AA0047BE5D"), ComVisible(true)]
