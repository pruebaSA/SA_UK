namespace System.Windows.Forms
{
    ...
    public sealed class HtmlWindow
    {
        ...
        public bool Confirm(string message) => 
            this.NativeHtmlWindow.Confirm(message);
        ...
        public HtmlWindow Open(Uri url, string target, string windowOptions, bool replaceEntry) => 
            this.Open(url.ToString(), target, windowOptions, replaceEntry);
        ...
        public HtmlWindow OpenNew(Uri url, string windowOptions) => 
            this.OpenNew(url.ToString(), windowOptions);

        public string Prompt(string message, string defaultInputValue) => 
            this.NativeHtmlWindow.Prompt(message, defaultInputValue).ToString();
        ...
        public bool IsClosed =>
            this.NativeHtmlWindow.GetClosed();

        public string Name
        {
            get => 
                this.NativeHtmlWindow.GetName();
            set
            {
        ...
        public Point Position =>
            new Point(((System.Windows.Forms.UnsafeNativeMethods.IHTMLWindow3) this.NativeHtmlWindow).GetScreenLeft(), ((System.Windows.Forms.UnsafeNativeMethods.IHTMLWindow3) this.NativeHtmlWindow).GetScreenTop());
        ...
        {
            get => 
                this.NativeHtmlWindow.GetStatus();
            set
            {
        ...
        internal class HtmlWindowShim : HtmlShim
        {
            ...
            public override System.Windows.Forms.UnsafeNativeMethods.IHTMLWindow2 AssociatedWindow =>
                this.htmlWindow.NativeHtmlWindow;
