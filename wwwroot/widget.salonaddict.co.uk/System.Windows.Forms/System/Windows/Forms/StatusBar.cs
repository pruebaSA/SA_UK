namespace System.Windows.Forms
{
    ...
    [Designer("System.Windows.Forms.Design.StatusBarDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ClassInterface(ClassInterfaceType.AutoDispatch), DefaultEvent("PanelClick"), ComVisible(true), DefaultProperty("Text")]
    public class StatusBar : Control
    {
        ...
        internal bool ArePanelsRealized() => 
            (this.showPanels && base.IsHandleCreated);
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), MergableProperty(false), Localizable(true), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), System.Windows.Forms.SRDescription("StatusBarPanelsDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(true), System.Windows.Forms.SRDescription("StatusBarSizingGripDescr")]
        ...
        public class StatusBarPanelCollection : IList, ICollection, IEnumerable
        {
            ...
            bool IList.Contains(object panel) => 
                ((panel is StatusBarPanel) && this.Contains((StatusBarPanel) panel));
            ...
            {
                get => 
                    ((StatusBarPanel) this.owner.panels[index]);
                set
                {
                    if (value == null)
                    {
