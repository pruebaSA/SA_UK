namespace System.Windows.Forms
{
    ...
    public sealed class HtmlDocument
    {
        ...
        public object InvokeScript(string scriptName) => 
            this.InvokeScript(scriptName, null);
        ...
        {
            get => 
                this.NativeHtmlDocument2.GetCookie();
            set
            {
        ...
        public string DefaultEncoding =>
            this.NativeHtmlDocument2.GetDefaultCharset();
        ...
        {
            get => 
                this.NativeHtmlDocument2.GetDomain();
            set
            {
                try
                {
        ...
        {
            get => 
                this.NativeHtmlDocument2.GetCharset();
            set
            {
        ...
        public bool Focused =>
            ((System.Windows.Forms.UnsafeNativeMethods.IHTMLDocument4) this.NativeHtmlDocument2).HasFocus();
        ...
        {
            get => 
                (((System.Windows.Forms.UnsafeNativeMethods.IHTMLDocument3) this.NativeHtmlDocument2).GetDir() == "rtl");
            set
            {
        ...
        {
            get => 
                this.NativeHtmlDocument2.GetTitle();
            set
            {
        ...
        internal class HtmlDocumentShim : HtmlShim
        {
            ...
            public System.Windows.Forms.UnsafeNativeMethods.IHTMLDocument2 NativeHtmlDocument2 =>
                this.htmlDocument.NativeHtmlDocument2;
        }
    }
}
