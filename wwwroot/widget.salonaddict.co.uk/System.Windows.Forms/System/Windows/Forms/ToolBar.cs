namespace System.Windows.Forms
{
    ...
    [DefaultEvent("ButtonClick"), DefaultProperty("Buttons"), ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch), Designer("System.Windows.Forms.Design.ToolBarDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public class ToolBar : Control
    {
        ...
        [EditorBrowsable(EditorBrowsableState.Always), System.Windows.Forms.SRDescription("ControlOnAutoSizeChangedDescr"), Browsable(true), System.Windows.Forms.SRCategory("CatPropertyChanged")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ToolBarButtonDropDownDescr")]
        ...
        [System.Windows.Forms.SRDescription("ToolBarAppearanceDescr"), Localizable(true), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(0)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), Localizable(true), System.Windows.Forms.SRDescription("ToolBarAutoSizeDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), DefaultValue(true), Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        public override bool AutoSize
        {
            get => 
                this.toolBarState[0x10];
            set
            {
        ...
        [DispId(-504), System.Windows.Forms.SRDescription("ToolBarBorderStyleDescr"), DefaultValue(0), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [MergableProperty(false), System.Windows.Forms.SRCategory("CatBehavior"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Localizable(true), System.Windows.Forms.SRDescription("ToolBarButtonsDescr")]
        public ToolBarButtonCollection Buttons =>
            this.buttonsCollection;

        [RefreshProperties(RefreshProperties.All), System.Windows.Forms.SRCategory("CatAppearance"), Localizable(true), System.Windows.Forms.SRDescription("ToolBarButtonSizeDescr")]
        public Size ButtonSize
        {
            get
            {
                ...
                {
                    int n = (int) base.SendMessage(0x43a, 0, 0);
                    if (n > 0)
                    {
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("ToolBarDropDownArrowsDescr"), DefaultValue(false), Localizable(true)]
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced), System.Windows.Forms.SRDescription("ToolBarImageSizeDescr"), System.Windows.Forms.SRCategory("CatBehavior"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        internal int PreferredHeight
        {
            get
            {
                ...
                {
                    height *= (int) base.SendMessage(0x428, 0, 0);
                }
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), Localizable(true), System.Windows.Forms.SRDescription("ToolBarShowToolTipsDescr"), DefaultValue(false)]
        ...
        [System.Windows.Forms.SRDescription("ToolBarTextAlignDescr"), Localizable(true), System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(0)]
        ...
        [System.Windows.Forms.SRDescription("ToolBarWrappableDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(true), Localizable(true)]
        ...
        public class ToolBarButtonCollection : IList, ICollection, IEnumerable
        {
            ...
            public bool Contains(ToolBarButton button) => 
                (this.IndexOf(button) != -1);

            public virtual bool ContainsKey(string key) => 
                this.IsValidIndex(this.IndexOfKey(key));

            public IEnumerator GetEnumerator() => 
                new WindowsFormsUtils.ArraySubsetEnumerator(this.owner.buttons, this.owner.buttonCount);
            ...
            bool IList.Contains(object button) => 
                ((button is ToolBarButton) && this.Contains((ToolBarButton) button));
