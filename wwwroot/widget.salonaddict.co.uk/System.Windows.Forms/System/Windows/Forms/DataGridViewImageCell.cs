namespace System.Windows.Forms
{
    ...
    public class DataGridViewImageCell : DataGridViewCell
    {
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new DataGridViewImageCellAccessibleObject(this);
        ...
        public override string ToString() => 
            ("DataGridViewImageCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + base.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");
