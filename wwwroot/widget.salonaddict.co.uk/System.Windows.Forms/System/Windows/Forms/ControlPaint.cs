namespace System.Windows.Forms
{
    ...
    public sealed class ControlPaint
    {
        ...
        {
            System.Windows.Forms.NativeMethods.BITMAPINFOHEADER structure = new System.Windows.Forms.NativeMethods.BITMAPINFOHEADER();
            structure.biSize = Marshal.SizeOf(structure);
            structure.biWidth = bitmap.Width;
            structure.biHeight = bitmap.Height;
            structure.biPlanes = 1;
            structure.biBitCount = 0x10;
            ...
            IntPtr ptr = Marshal.AllocCoTaskMem(Marshal.SizeOf(structure) + (nEntries * 4));
            Marshal.StructureToPtr(structure, ptr, false);
            Marshal.Copy(source, 0, (IntPtr) (((long) ptr) + Marshal.SizeOf(structure)), nEntries);
            return ptr;
        }
        ...
        internal static Font FontInPoints(Font font) => 
            new Font(font.FontFamily, font.SizeInPoints, font.Style, GraphicsUnit.Point, font.GdiCharSet, font.GdiVerticalFont);
        ...
        private struct HLSColor
        {
            ...
            public override int GetHashCode() => 
                (((this.hue << 6) | (this.saturation << 2)) | this.luminosity);
            ...
            private int NewLuma(int n, bool scale) => 
                this.NewLuma(this.luminosity, n, scale);
