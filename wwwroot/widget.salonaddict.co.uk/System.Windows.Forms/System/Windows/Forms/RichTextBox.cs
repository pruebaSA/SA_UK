namespace System.Windows.Forms
{
    ...
    [Docking(DockingBehavior.Ask), System.Windows.Forms.SRDescription("DescriptionRichTextBox"), ClassInterface(ClassInterfaceType.AutoDispatch), Designer("System.Windows.Forms.Design.RichTextBoxDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ComVisible(true)]
    public class RichTextBox : TextBoxBase
    {
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxContentsResized"), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxHScroll"), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxIMEChange"), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("RichTextBoxLinkClick")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("RichTextBoxProtected")]
        ...
        public bool CanPaste(DataFormats.Format clipFormat) => 
            (((int) base.SendMessage(0x432, clipFormat.Id, 0)) != 0);
        ...
        public int Find(string str) => 
            this.Find(str, 0, 0, RichTextBoxFinds.None);

        public int Find(char[] characterSet) => 
            this.Find(characterSet, 0, -1);

        public int Find(char[] characterSet, int start) => 
            this.Find(characterSet, start, -1);

        public int Find(string str, RichTextBoxFinds options) => 
            this.Find(str, 0, 0, options);
        ...
        public override int GetLineFromCharIndex(int index) => 
            ((int) base.SendMessage(0x436, 0, index));
        ...
        private bool SetCharFormat(int charRange, System.Windows.Forms.NativeMethods.CHARFORMATA cf) => 
            (IntPtr.Zero != System.Windows.Forms.UnsafeNativeMethods.SendMessage(new HandleRef(this, base.Handle), 0x444, charRange, cf));
        ...
        private void UpdateOleCallback()
        {
            if (base.IsHandleCreated)
            {
                if (this.oleCallback == null)
                {
                    ...
                    {
                        this.AllowOleObjects = 0 != ((int) base.SendMessage(0x50e, 0, 1));
                    }
        ...
        internal void WmReflectNotify(ref Message m)
        {
            ...
            else
            {
                ...
                switch (enprotected.msg)
                {
                    ...
                    case 0x449:
                        if ((((int) enprotected.wParam) & 0x8000) != 0)
                        {
                            break;
                        }
                        m.Result = IntPtr.Zero;
        ...
        private void WmSelectionChange(System.Windows.Forms.NativeMethods.SELCHANGE selChange)
        {
            ...
            if (((base.ImeMode == ImeMode.Hangul) || (base.ImeMode == ImeMode.HangulFull)) && (((int) base.SendMessage(0x47a, 0, 0)) != 0))
            {
                int windowTextLength = System.Windows.Forms.SafeNativeMethods.GetWindowTextLength(new HandleRef(this, base.Handle));
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            switch (m.Msg)
            {
                ...
                case 0x87:
                    base.WndProc(ref m);
                    m.Result = base.AcceptsTab ? ((IntPtr) (((int) m.Result) | 2)) : ((IntPtr) (((int) m.Result) & -3));
                    return;
        ...
        {
            get => 
                (this.richTextBoxFlags[allowOleDropSection] != 0);
            set
            {
                if (value)
                {
        ...
        {
            get => 
                (this.richTextBoxFlags[allowOleObjectsSection] != 0);
            set
            {
        ...
        [DefaultValue(false), EditorBrowsable(EditorBrowsableState.Never), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible), RefreshProperties(RefreshProperties.Repaint)]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxAutoWordSelection"), DefaultValue(false), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [DefaultValue(0), Localizable(true), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("RichTextBoxBulletIndent")]
        ...
        {
            get => 
                (this.richTextBoxFlags[callOnContentsResizedSection] != 0);
            set
            {
        ...
        internal override bool CanRaiseTextChangedEvent =>
            !this.SuppressTextChangedEvent;

        [System.Windows.Forms.SRDescription("RichTextBoxCanRedoDescr"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool CanRedo =>
            (base.IsHandleCreated && (((int) base.SendMessage(0x455, 0, 0)) != 0));
        ...
        [DefaultValue(true), System.Windows.Forms.SRDescription("RichTextBoxDetectURLs"), System.Windows.Forms.SRCategory("CatBehavior")]
        public bool DetectUrls
        {
            get => 
                (this.richTextBoxFlags[autoUrlDetectSection] != 0);
            set
            {
        ...
        {
            get => 
                (this.richTextBoxFlags[enableAutoDragDropSection] != 0);
            set
            {
                if (value)
                {
        ...
        {
            get => 
                (this.richTextBoxFlags[fInCtorSection] != 0);
            set
            {
        ...
        {
            get => 
                (this.richTextBoxFlags[linkcursorSection] != 0);
            set
            {
        ...
        {
            get => 
                (this.richTextBoxFlags[protectedErrorSection] != 0);
            set
            {
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxRedoActionNameDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRCategory("CatBehavior"), Browsable(false)]
        public string RedoActionName
        {
            get
            {
                ...
                int actionID = (int) base.SendMessage(0x457, 0, 0);
        ...
        {
            get => 
                (this.richTextBoxFlags[richTextShortcutsEnabledSection] != 0);
            set
            {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("RichTextBoxRightMargin"), DefaultValue(0), Localizable(true)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), System.Windows.Forms.SRDescription("RichTextBoxRTF"), RefreshProperties(RefreshProperties.All)]
        public string Rtf
        {
            get
            {
        ...
        {
            get => 
                ((RichTextBoxScrollBars) this.richTextBoxFlags[scrollBarsSection]);
            set
            {
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxSelRTF"), DefaultValue(""), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue(""), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("RichTextBoxSelText")]
        ...
        [Browsable(false), DefaultValue(0), System.Windows.Forms.SRDescription("RichTextBoxSelAlignment"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Browsable(false), System.Windows.Forms.SRDescription("RichTextBoxSelBackColor"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue(false), System.Windows.Forms.SRDescription("RichTextBoxSelBullet"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxSelCharOffset"), DefaultValue(0), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), System.Windows.Forms.SRDescription("RichTextBoxSelColor")]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxSelFont"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public System.Drawing.Font SelectionFont
        {
            get => 
                this.GetCharFormatFont(true);
            set
            {
        ...
        [DefaultValue(0), System.Windows.Forms.SRDescription("RichTextBoxSelHangingIndent"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxSelIndent"), DefaultValue(0), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [Browsable(false), System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("TextBoxSelectionLengthDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("RichTextBoxSelProtected"), Browsable(false)]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxSelRightIndent"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), DefaultValue(0)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), System.Windows.Forms.SRDescription("RichTextBoxSelTabs")]
        ...
        [System.Windows.Forms.SRDescription("RichTextBoxSelTypeDescr"), System.Windows.Forms.SRCategory("CatBehavior"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public RichTextBoxSelectionTypes SelectionType
        {
            get
            {
                ...
                {
                    int num = (int) base.SendMessage(0x442, 0, 0);
        ...
        [DefaultValue(false), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("RichTextBoxSelMargin")]
        public bool ShowSelectionMargin
        {
            get => 
                (this.richTextBoxFlags[showSelBarSection] != 0);
            set
            {
        ...
        {
            get => 
                (this.richTextBoxFlags[suppressTextChangedEventSection] != 0);
            set
            {
        ...
        public override int TextLength
        {
            get
            {
                ...
                return (int) System.Windows.Forms.UnsafeNativeMethods.SendMessage(new HandleRef(this, base.Handle), 0x45f, wParam, 0);
            }
        }

        [Browsable(false), System.Windows.Forms.SRCategory("CatBehavior"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("RichTextBoxUndoActionNameDescr")]
        public string UndoActionName
        {
            get
            {
                ...
                int actionID = (int) base.SendMessage(0x456, 0, 0);
                return this.GetEditorActionName(actionID);
            }
        }

        [Localizable(true), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue((float) 1f), System.Windows.Forms.SRDescription("RichTextBoxZoomFactor")]
