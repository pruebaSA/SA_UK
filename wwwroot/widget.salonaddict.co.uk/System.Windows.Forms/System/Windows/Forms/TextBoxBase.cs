namespace System.Windows.Forms
{
    ...
    [DefaultEvent("TextChanged"), DefaultBindingProperty("Text"), Designer("System.Windows.Forms.Design.TextBoxBaseDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch)]
    public abstract class TextBoxBase : Control
    {
        ...
        [System.Windows.Forms.SRDescription("TextBoxBaseOnMultilineChangedDescr"), System.Windows.Forms.SRCategory("CatPropertyChanged")]
        ...
        public int GetFirstCharIndexOfCurrentLine() => 
            ((int) base.SendMessage(0xbb, -1, 0));

        public virtual int GetLineFromCharIndex(int index) => 
            ((int) base.SendMessage(0xc9, index, 0));
        ...
        internal override Size GetPreferredSizeCore(Size proposedConstraints)
        {
            ...
            TextFormatFlags singleLine = TextFormatFlags.Default;
            if (!this.Multiline)
            {
                singleLine = TextFormatFlags.SingleLine;
            }
            else if (this.WordWrap)
            {
                singleLine = TextFormatFlags.WordBreak;
            }
            Size size2 = TextRenderer.MeasureText(this.Text, this.Font, proposedConstraints, singleLine);
        ...
        protected override bool IsInputKey(Keys keyData)
        {
            if ((keyData & Keys.Alt) != Keys.Alt)
            {
                switch ((keyData & Keys.KeyCode))
                {
                    ...
                    case Keys.Tab:
                        return ((this.Multiline && this.textBoxFlags[acceptsTab]) && ((keyData & Keys.Control) == Keys.None));
                }
            }
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("TextBoxAcceptsTabDescr"), DefaultValue(false)]
        public bool AcceptsTab
        {
            get => 
                this.textBoxFlags[acceptsTab];
            set
            {
        ...
        [Localizable(true), DefaultValue(true), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("TextBoxAutoSizeDescr"), RefreshProperties(RefreshProperties.Repaint), Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        public override bool AutoSize
        {
            get => 
                this.textBoxFlags[autoSize];
            set
            {
        ...
        [DispId(-504), System.Windows.Forms.SRDescription("TextBoxBorderDescr"), System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(2)]
        ...
        protected override bool CanEnableIme =>
            ((!this.ReadOnly && !this.PasswordProtect) && base.CanEnableIme);

        internal virtual bool CanRaiseTextChangedEvent =>
            true;

        [System.Windows.Forms.SRDescription("TextBoxCanUndoDescr"), System.Windows.Forms.SRCategory("CatBehavior"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool CanUndo =>
            (base.IsHandleCreated && (((int) base.SendMessage(0xc6, 0, 0)) != 0));
        ...
        protected override Size DefaultSize =>
            new Size(100, this.PreferredHeight);
        ...
        {
            get => 
                this.textBoxFlags[hideSelection];
            set
            {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("TextBoxMaxLengthDescr"), DefaultValue(0x7fff), Localizable(true)]
        ...
        [System.Windows.Forms.SRDescription("TextBoxModifiedDescr"), System.Windows.Forms.SRCategory("CatBehavior"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("TextBoxMultilineDescr"), RefreshProperties(RefreshProperties.All), Localizable(true), DefaultValue(false)]
        public virtual bool Multiline
        {
            get => 
                this.textBoxFlags[multiline];
            set
            {
        ...
        [Browsable(false), System.Windows.Forms.SRDescription("TextBoxPreferredHeightDescr"), System.Windows.Forms.SRCategory("CatLayout"), EditorBrowsable(EditorBrowsableState.Advanced), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRDescription("TextBoxReadOnlyDescr"), DefaultValue(false)]
        public bool ReadOnly
        {
            get => 
                this.textBoxFlags[readOnly];
            set
            {
        ...
        [System.Windows.Forms.SRDescription("TextBoxSelectedTextDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRCategory("CatAppearance"), Browsable(false)]
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("TextBoxSelectionLengthDescr"), Browsable(false)]
        ...
        [System.Windows.Forms.SRDescription("TextBoxSelectionStartDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRCategory("CatAppearance"), Browsable(false)]
        ...
        {
            get => 
                this.textBoxFlags[shortcutsEnabled];
            set
            {
        ...
        [Localizable(true), System.Windows.Forms.SRDescription("TextBoxWordWrapDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(true)]
        public bool WordWrap
        {
            get => 
                this.textBoxFlags[wordWrap];
            set
            {
