namespace System.Windows.Forms
{
    ...
    internal static class FileDialogNative
    {
        ...
        [ComImport, TypeLibType(TypeLibTypeFlags.FCanCreate), ClassInterface(ClassInterfaceType.None), Guid("DC1C5A9C-E88A-4dde-A5A1-60F82A20AEF7")]
        internal class FileOpenDialogRCW
        {
        }

        [ComImport, TypeLibType(TypeLibTypeFlags.FCanCreate), ClassInterface(ClassInterfaceType.None), Guid("C0B4E2F3-BA21-4773-8DBA-335EC946EB8B")]
