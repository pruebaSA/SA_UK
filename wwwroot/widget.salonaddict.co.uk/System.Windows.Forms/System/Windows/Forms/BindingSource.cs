namespace System.Windows.Forms
{
    ...
    [DefaultProperty("DataSource"), DefaultEvent("CurrentChanged"), ComplexBindingProperties("DataSource", "DataMember"), Designer("System.Windows.Forms.Design.BindingSourceDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), System.Windows.Forms.SRDescription("DescriptionBindingSource")]
    public class BindingSource : Component, IBindingListView, IBindingList, IList, ICollection, IEnumerable, ITypedList, ICancelAddNew, ISupportInitializeNotification, ISupportInitialize, ICurrencyManagerProvider
    {
        ...
        [System.Windows.Forms.SRDescription("BindingSourceAddingNewEventHandlerDescr"), System.Windows.Forms.SRCategory("CatData")]
        ...
        [System.Windows.Forms.SRDescription("BindingSourceCurrentChangedEventHandlerDescr"), System.Windows.Forms.SRCategory("CatData")]
        ...
        [System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("BindingSourceCurrentItemChangedEventHandlerDescr")]
        ...
        [System.Windows.Forms.SRDescription("BindingSourceListChangedEventHandlerDescr"), System.Windows.Forms.SRCategory("CatData")]
        ...
        [System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("BindingSourcePositionChangedEventHandlerDescr")]
        ...
        {
            PropertyDescriptor property = this.itemShape?.Find(propertyName, true);
            if (property == null)
            {
        ...
        public virtual string GetListName(PropertyDescriptor[] listAccessors) => 
            ListBindingHelper.GetListName(this.List, listAccessors);
        ...
        private bool IsDataMemberValid() => 
            (this.initializing || (string.IsNullOrEmpty(this.dataMember) || (ListBindingHelper.GetListItemProperties(this.dataSource)[this.dataMember] != null)));
        ...
        private void ResetList()
        {
            ...
            else
            {
                ...
                object list = ListBindingHelper.GetList(dataSource, this.dataMember);
                ...
                this.SetList(list as IList, true, true);
            }
        }
        ...
        public virtual System.Windows.Forms.CurrencyManager CurrencyManager =>
            this.GetRelatedCurrencyManager(null);
        ...
        [RefreshProperties(RefreshProperties.Repaint), Editor("System.Windows.Forms.Design.DataMemberListEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), System.Windows.Forms.SRDescription("BindingSourceDataMemberDescr"), System.Windows.Forms.SRCategory("CatData"), DefaultValue("")]
        ...
        [System.Windows.Forms.SRCategory("CatData"), DefaultValue((string) null), RefreshProperties(RefreshProperties.Repaint), AttributeProvider(typeof(IListSource)), System.Windows.Forms.SRDescription("BindingSourceDataSourceDescr")]
        ...
        public bool IsBindingSuspended =>
            this.currencyManager.IsBindingSuspended;
        ...
        public virtual bool IsSorted =>
            (this.isBindingList && ((IBindingList) this.List).IsSorted);
        ...
        public virtual bool SupportsSearching =>
            (this.isBindingList && ((IBindingList) this.List).SupportsSearching);

        [Browsable(false)]
        public virtual bool SupportsSorting =>
            (this.isBindingList && ((IBindingList) this.List).SupportsSorting);
