namespace System.Windows.Forms
{
    ...
    internal class ToolStripGrip : ToolStripButton
    {
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new ToolStripGripAccessibleObject(this);
        ...
        private bool LeftMouseButtonIsDown() => 
            ((Control.MouseButtons == MouseButtons.Left) && (Control.ModifierKeys == Keys.None));
        ...
        {
            get => 
                ((this.ToolStripPanelRow != null) && this.movingToolStrip);
            set
            {
