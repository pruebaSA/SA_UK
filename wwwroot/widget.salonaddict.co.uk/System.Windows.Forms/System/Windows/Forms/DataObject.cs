namespace System.Windows.Forms
{
    ...
    public class DataObject : System.Windows.Forms.IDataObject, System.Runtime.InteropServices.ComTypes.IDataObject
    {
        ...
        public virtual bool ContainsAudio() => 
            this.GetDataPresent(DataFormats.WaveAudio, false);

        public virtual bool ContainsFileDropList() => 
            this.GetDataPresent(DataFormats.FileDrop, true);

        public virtual bool ContainsImage() => 
            this.GetDataPresent(DataFormats.Bitmap, true);

        public virtual bool ContainsText() => 
            this.ContainsText(TextDataFormat.UnicodeText);
        ...
        public virtual Stream GetAudioStream() => 
            (this.GetData(DataFormats.WaveAudio, false) as Stream);
        ...
        public virtual object GetData(string format, bool autoConvert) => 
            this.innerData.GetData(format, autoConvert);
        ...
        public virtual bool GetDataPresent(string format) => 
            this.GetDataPresent(format, true);
        ...
        public virtual bool GetDataPresent(string format, bool autoConvert) => 
            this.innerData.GetDataPresent(format, autoConvert);
        ...
        public virtual string[] GetFormats() => 
            this.GetFormats(true);

        public virtual string[] GetFormats(bool autoConvert) => 
            this.innerData.GetFormats(autoConvert);

        public virtual Image GetImage() => 
            (this.GetData(DataFormats.Bitmap, true) as Image);
        ...
        public virtual string GetText() => 
            this.GetText(TextDataFormat.UnicodeText);
        ...
        private class DataStore : System.Windows.Forms.IDataObject
        {
            ...
            public virtual bool GetDataPresent(System.Type format) => 
                this.GetDataPresent(format.FullName);
        ...
        private class OleConverter : System.Windows.Forms.IDataObject
        {
            ...
            private int QueryGetDataInner(ref FORMATETC formatetc) => 
                this.innerData.QueryGetData(ref formatetc);
