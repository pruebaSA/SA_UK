namespace System.Windows.Forms
{
    ...
    public class DataGridViewCheckBoxCell : DataGridViewCell, IDataGridViewEditingCell
    {
        ...
        protected override bool MouseEnterUnsharesRow(int rowIndex) => 
            ((base.ColumnIndex == base.DataGridView.MouseDownCellAddress.X) && (rowIndex == base.DataGridView.MouseDownCellAddress.Y));

        protected override bool MouseLeaveUnsharesRow(int rowIndex) => 
            ((this.ButtonState & System.Windows.Forms.ButtonState.Pushed) != System.Windows.Forms.ButtonState.Normal);
        ...
        Label_03EF:
            if (((rectangle2.Width >= glyphSize.Width) && (rectangle2.Height >= glyphSize.Height)) && (paint || computeContentBounds))
            {
                ...
                else
                {
                    ...
                    {
                        ButtonBaseAdapter.LayoutOptions options2 = CheckBoxPopupAdapter.PaintPopupLayout(g, true, glyphSize.Width, clientRectangle, Padding.Empty, false, cellStyle.Font, string.Empty, base.DataGridView.Enabled, DataGridViewUtilities.ComputeDrawingContentAlignmentForCellStyleAlignment(cellStyle.Alignment), base.DataGridView.RightToLeft);
                    ...
                    {
                        ButtonBaseAdapter.LayoutOptions options3 = CheckBoxPopupAdapter.PaintPopupLayout(g, false, glyphSize.Width, clientRectangle, Padding.Empty, false, cellStyle.Font, string.Empty, base.DataGridView.Enabled, DataGridViewUtilities.ComputeDrawingContentAlignmentForCellStyleAlignment(cellStyle.Alignment), base.DataGridView.RightToLeft);
        ...
        public override string ToString() => 
            ("DataGridViewCheckBoxCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + base.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");
        ...
        {
            get => 
                this.GetEditingCellFormattedValue(DataGridViewDataErrorContexts.Formatting);
            set
            {
                if (this.FormattedValueType == null)
                {
        ...
        {
            get => 
                base.Properties.GetObject(PropFalseValue);
            set
            {
        ...
        {
            get => 
                base.Properties.GetObject(PropIndeterminateValue);
            set
            {
        ...
        {
            get => 
                base.Properties.GetObject(PropTrueValue);
            set
            {
                ...
                if ((!owner.ReadOnly && (owner.OwningColumn != null)) && (owner.OwningRow != null))
                {
                    ...
                    if (dataGridView.IsCurrentCellInEditMode)
                    {
                        if (owner.SwitchFormattedValue())
                        {
                            ...
                            int num = dataGridView.Rows.GetRowCount(DataGridViewElementStates.Visible, 0, owner.RowIndex);
                            int num2 = dataGridView.Columns.ColumnIndexToActualDisplayIndex(owner.ColumnIndex, DataGridViewElementStates.Visible);
                            ...
                            ((Control.ControlAccessibleObject) dataGridView.AccessibilityObject).NotifyClients(AccessibleEvents.DefaultActionChange, objectID, childID);
                        }
                        if (flag)
                        {
