namespace System.Windows.Forms
{
    ...
    public class DataGridViewColumnHeaderCell : DataGridViewHeaderCell
    {
        ...
        public override string ToString() => 
            ("DataGridViewColumnHeaderCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + " }");

        internal bool ContainsLocalValue =>
            base.Properties.ContainsObject(DataGridViewCell.PropCellValue);

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public SortOrder SortGlyphDirection
        {
            get => 
                this.sortGlyphDirection;
            set
            {
        ...
        protected class DataGridViewColumnHeaderCellAccessibleObject : DataGridViewCell.DataGridViewCellAccessibleObject
        {
            ...
            public override Rectangle Bounds =>
                base.GetAccessibleObjectBounds(this.ParentPrivate);
            ...
            private AccessibleObject ParentPrivate =>
                base.Owner.DataGridView.AccessibilityObject.GetChild(0);
