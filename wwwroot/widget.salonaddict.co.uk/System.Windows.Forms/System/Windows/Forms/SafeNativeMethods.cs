namespace System.Windows.Forms
{
    ...
    internal static class SafeNativeMethods
    {
        ...
        public static int ColorToCOLORREF(Color color) => 
            ((color.R | (color.G << 8)) | (color.B << 0x10));
        ...
        public static IntPtr CopyImage(HandleRef hImage, int uType, int cxDesired, int cyDesired, int fuFlags) => 
            System.Internal.HandleCollector.Add(IntCopyImage(hImage, uType, cxDesired, cyDesired, fuFlags), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CopyImageAsCursor(HandleRef hImage, int uType, int cxDesired, int cyDesired, int fuFlags) => 
            System.Internal.HandleCollector.Add(IntCopyImage(hImage, uType, cxDesired, cyDesired, fuFlags), System.Windows.Forms.NativeMethods.CommonHandles.Cursor);

        public static IntPtr CreateBitmap(int nWidth, int nHeight, int nPlanes, int nBitsPerPixel, IntPtr lpvBits) => 
            System.Internal.HandleCollector.Add(IntCreateBitmap(nWidth, nHeight, nPlanes, nBitsPerPixel, lpvBits), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateBitmap(int nWidth, int nHeight, int nPlanes, int nBitsPerPixel, byte[] lpvBits) => 
            System.Internal.HandleCollector.Add(IntCreateBitmapByte(nWidth, nHeight, nPlanes, nBitsPerPixel, lpvBits), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateBitmap(int nWidth, int nHeight, int nPlanes, int nBitsPerPixel, short[] lpvBits) => 
            System.Internal.HandleCollector.Add(IntCreateBitmapShort(nWidth, nHeight, nPlanes, nBitsPerPixel, lpvBits), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateBrushIndirect(System.Windows.Forms.NativeMethods.LOGBRUSH lb) => 
            System.Internal.HandleCollector.Add(IntCreateBrushIndirect(lb), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateCompatibleBitmap(HandleRef hDC, int width, int height) => 
            System.Internal.HandleCollector.Add(IntCreateCompatibleBitmap(hDC, width, height), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateDIBSection(HandleRef hdc, HandleRef pbmi, int iUsage, byte[] ppvBits, IntPtr hSection, int dwOffset) => 
            System.Internal.HandleCollector.Add(IntCreateDIBSection(hdc, pbmi, iUsage, ppvBits, hSection, dwOffset), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateHalftonePalette(HandleRef hdc) => 
            System.Internal.HandleCollector.Add(IntCreateHalftonePalette(hdc), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreatePatternBrush(HandleRef hbmp) => 
            System.Internal.HandleCollector.Add(IntCreatePatternBrush(hbmp), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreatePen(int nStyle, int nWidth, int crColor) => 
            System.Internal.HandleCollector.Add(IntCreatePen(nStyle, nWidth, crColor), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateRectRgn(int x1, int y1, int x2, int y2) => 
            System.Internal.HandleCollector.Add(IntCreateRectRgn(x1, y1, x2, y2), System.Windows.Forms.NativeMethods.CommonHandles.GDI);

        public static IntPtr CreateSolidBrush(int crColor) => 
            System.Internal.HandleCollector.Add(IntCreateSolidBrush(crColor), System.Windows.Forms.NativeMethods.CommonHandles.GDI);
