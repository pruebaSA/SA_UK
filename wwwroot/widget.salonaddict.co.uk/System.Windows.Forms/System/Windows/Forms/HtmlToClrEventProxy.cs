namespace System.Windows.Forms
{
    ...
    internal class HtmlToClrEventProxy : IReflect
    {
        ...
        FieldInfo IReflect.GetField(string name, BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetField(name, bindingAttr);

        FieldInfo[] IReflect.GetFields(BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetFields(bindingAttr);

        MemberInfo[] IReflect.GetMember(string name, BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetMember(name, bindingAttr);

        MemberInfo[] IReflect.GetMembers(BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetMembers(bindingAttr);

        MethodInfo IReflect.GetMethod(string name, BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetMethod(name, bindingAttr);
        ...
        MethodInfo IReflect.GetMethod(string name, BindingFlags bindingAttr, Binder binder, System.Type[] types, ParameterModifier[] modifiers) => 
            this.typeIReflectImplementation.GetMethod(name, bindingAttr, binder, types, modifiers);

        MethodInfo[] IReflect.GetMethods(BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetMethods(bindingAttr);

        PropertyInfo[] IReflect.GetProperties(BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetProperties(bindingAttr);

        PropertyInfo IReflect.GetProperty(string name, BindingFlags bindingAttr) => 
            this.typeIReflectImplementation.GetProperty(name, bindingAttr);
        ...
        PropertyInfo IReflect.GetProperty(string name, BindingFlags bindingAttr, Binder binder, System.Type returnType, System.Type[] types, ParameterModifier[] modifiers) => 
            this.typeIReflectImplementation.GetProperty(name, bindingAttr, binder, returnType, types, modifiers);
        ...
        System.Type IReflect.UnderlyingSystemType =>
            this.typeIReflectImplementation.UnderlyingSystemType;
    }
}
