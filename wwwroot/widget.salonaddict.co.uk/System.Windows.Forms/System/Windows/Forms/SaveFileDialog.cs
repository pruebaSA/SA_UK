namespace System.Windows.Forms
{
    ...
    [Designer("System.Windows.Forms.Design.SaveFileDialogDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), System.Windows.Forms.SRDescription("DescriptionSaveFileDialog")]
    public sealed class SaveFileDialog : FileDialog
    {
        internal override FileDialogNative.IFileDialog CreateVistaDialog() => 
            ((FileDialogNative.NativeFileSaveDialog) new FileDialogNative.FileSaveDialogRCW());
        ...
        private bool PromptFileCreate(string fileName) => 
            base.MessageBoxWithFocusRestore(System.Windows.Forms.SR.GetString("FileDialogCreatePrompt", new object[] { fileName }), base.DialogCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);

        private bool PromptFileOverwrite(string fileName) => 
            base.MessageBoxWithFocusRestore(System.Windows.Forms.SR.GetString("FileDialogOverwritePrompt", new object[] { fileName }), base.DialogCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("SaveFileDialogCreatePrompt"), DefaultValue(false)]
        public bool CreatePrompt
        {
            get => 
                base.GetOption(0x2000);
            set
            {
