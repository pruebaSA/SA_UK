namespace System.Windows.Forms
{
    ...
    [System.Windows.Forms.SRDescription("DescriptionListBox"), ClassInterface(ClassInterfaceType.AutoDispatch), Designer("System.Windows.Forms.Design.ListBoxDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), DefaultEvent("SelectedIndexChanged"), DefaultProperty("Items"), DefaultBindingProperty("SelectedValue"), ComVisible(true)]
    public class ListBox : ListControl
    {
        ...
        public int GetItemHeight(int index)
        {
            ...
            int num2 = (int) base.SendMessage(0x1a1, index, 0);
            if (num2 == -1)
            {
        ...
        private bool GetSelectedInternal(int index)
        {
            if (base.IsHandleCreated)
            {
                int num = (int) base.SendMessage(0x187, index, 0);
                if (num == -1)
                {
                    throw new Win32Exception();
                }
        ...
        public int IndexFromPoint(int x, int y)
        {
            ...
            {
                int n = (int) base.SendMessage(0x1a9, 0, (int) System.Windows.Forms.NativeMethods.Util.MAKELPARAM(x, y));
        ...
        {
            int num = (int) base.SendMessage(0x18a, index, 0);
        ...
        {
            int num = (int) base.SendMessage(0x181, index, base.GetItemText(item));
            switch (num)
            {
                case -2:
                    throw new OutOfMemoryException();
        ...
        {
            bool flag = ((int) base.SendMessage(0x187, (IntPtr) index, IntPtr.Zero)) > 0;
        ...
        private void NativeUpdateSelection()
        {
            ...
            switch (this.selectionMode)
            {
                ...
                {
                    int num3 = (int) base.SendMessage(0x188, 0, 0);
                    if (num3 >= 0)
                    {
                        lParam = new int[] { num3 };
                    }
                ...
                {
                    int wParam = (int) base.SendMessage(400, 0, 0);
                    if (wParam > 0)
                    {
        ...
        [DefaultValue(2), DispId(-504), System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("ListBoxBorderDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(0), Localizable(true), System.Windows.Forms.SRDescription("ListBoxColumnWidthDescr")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Browsable(false), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ListBoxCustomTabOffsetsDescr")]
        ...
        [System.Windows.Forms.SRDescription("ListBoxDrawModeDescr"), DefaultValue(0), System.Windows.Forms.SRCategory("CatBehavior"), RefreshProperties(RefreshProperties.Repaint)]
        ...
        internal int FocusedIndex
        {
            get
            {
                if (base.IsHandleCreated)
                {
                    return (int) base.SendMessage(0x19f, 0, 0);
                }
                return -1;
            }
        }
        ...
        [System.Windows.Forms.SRDescription("ListBoxHorizontalScrollbarDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(false), Localizable(true)]
        ...
        [System.Windows.Forms.SRDescription("ListBoxIntegralHeightDescr"), Localizable(true), DefaultValue(true), RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(13), Localizable(true), System.Windows.Forms.SRDescription("ListBoxItemHeightDescr")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Localizable(true), System.Windows.Forms.SRDescription("ListBoxItemsDescr"), Editor("System.Windows.Forms.Design.ListControlStringCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), MergableProperty(false), System.Windows.Forms.SRCategory("CatData")]
        ...
        [System.Windows.Forms.SRDescription("ListBoxMultiColumnDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(false)]
        ...
        [System.Windows.Forms.SRDescription("ListBoxPreferredHeightDescr"), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ListBoxScrollIsVisibleDescr"), DefaultValue(false), Localizable(true)]
        public bool ScrollAlwaysVisible
        {
            get => 
                this.scrollAlwaysVisible;
            set
            {
        ...
        public override int SelectedIndex
        {
            get
            {
                ...
                if (mode != System.Windows.Forms.SelectionMode.None)
                {
                    ...
                    {
                        return (int) base.SendMessage(0x188, 0, 0);
                    }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("ListBoxSelectedIndicesDescr"), Browsable(false)]
        ...
        [System.Windows.Forms.SRDescription("ListBoxSelectedItemsDescr"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DefaultValue(1), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ListBoxSelectionModeDescr")]
        ...
        [Bindable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced)]
        ...
        [System.Windows.Forms.SRDescription("ListBoxTopIndexDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false)]
        public int TopIndex
        {
            get
            {
                if (base.IsHandleCreated)
                {
                    return (int) base.SendMessage(0x18e, 0, 0);
                }
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(false), Browsable(false)]
        public bool UseCustomTabOffsets
        {
            get => 
                this.useCustomTabOffsets;
            set
            {
        ...
        [DefaultValue(true), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ListBoxUseTabStopsDescr")]
        ...
        public class IntegerCollection : IList, ICollection, IEnumerable
        {
            ...
            public int IndexOf(int item) => 
                Array.IndexOf<int>(this.innerArray, item);
            ...
            IEnumerator IEnumerable.GetEnumerator() => 
                new CustomTabOffsetsEnumerator(this);
            ...
            bool IList.Contains(object item) => 
                ((item is int) && this.Contains((int) item));
        ...
        internal class ItemArray : IComparer
        {
            ...
            public int BinarySearch(object element) => 
                Array.BinarySearch(this.entries, 0, this.count, element, this);
            ...
            public IEnumerator GetEnumerator(int stateMask) => 
                this.GetEnumerator(stateMask, false);

            public IEnumerator GetEnumerator(int stateMask, bool anyBit) => 
                new EntryEnumerator(this, stateMask, anyBit);
            ...
            public bool GetState(int index, int stateMask) => 
                ((this.entries[index].state & stateMask) == stateMask);
        ...
        public class ObjectCollection : IList, ICollection, IEnumerable
        {
            ...
            public IEnumerator GetEnumerator() => 
                this.InnerArray.GetEnumerator(0);
        ...
        public class SelectedIndexCollection : IList, ICollection, IEnumerable
        {
            ...
            public IEnumerator GetEnumerator() => 
                new SelectedIndexEnumerator(this);
            ...
            [Browsable(false)]
            public int Count =>
                this.owner.SelectedItems.Count;
        ...
        public class SelectedObjectCollection : IList, ICollection, IEnumerable
        {
            ...
            public IEnumerator GetEnumerator() => 
                this.InnerArray.GetEnumerator(SelectedObjectMask);

            internal object GetObjectAt(int index) => 
                this.InnerArray.GetEntryObject(index, SelectedObjectMask);

            internal bool GetSelected(int index) => 
                this.InnerArray.GetState(index, SelectedObjectMask);

            public int IndexOf(object selectedObject) => 
                this.InnerArray.IndexOf(selectedObject, SelectedObjectMask);
            ...
            {
                get => 
                    this.InnerArray.GetItem(index, SelectedObjectMask);
                set
                {
                    throw new NotSupportedException(System.Windows.Forms.SR.GetString("ListBoxSelectedObjectCollectionIsReadOnly"));
                }
