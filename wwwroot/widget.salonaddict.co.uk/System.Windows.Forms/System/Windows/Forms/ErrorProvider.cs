namespace System.Windows.Forms
{
    ...
    [ProvideProperty("Error", typeof(Control)), ToolboxItemFilter("System.Windows.Forms"), ComplexBindingProperties("DataSource", "DataMember"), ProvideProperty("IconAlignment", typeof(Control)), ProvideProperty("IconPadding", typeof(Control)), System.Windows.Forms.SRDescription("DescriptionErrorProvider")]
    public class ErrorProvider : Component, IExtenderProvider, ISupportInitialize
    {
        ...
        public bool CanExtend(object extendee) => 
            (((extendee is Control) && !(extendee is Form)) && !(extendee is ToolBar));
        ...
        [DefaultValue(""), System.Windows.Forms.SRDescription("ErrorProviderErrorDescr"), System.Windows.Forms.SRCategory("CatAppearance"), Localizable(true)]
        public string GetError(Control control) => 
            this.EnsureControlItem(control).Error;

        [System.Windows.Forms.SRCategory("CatAppearance"), Localizable(true), DefaultValue(3), System.Windows.Forms.SRDescription("ErrorProviderIconAlignmentDescr")]
        public ErrorIconAlignment GetIconAlignment(Control control) => 
            this.EnsureControlItem(control).IconAlignment;

        [Localizable(true), System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("ErrorProviderIconPaddingDescr"), DefaultValue(0)]
        public int GetIconPadding(Control control) => 
            this.EnsureControlItem(control).IconPadding;
        ...
        [RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(250), System.Windows.Forms.SRDescription("ErrorProviderBlinkRateDescr")]
        ...
        [System.Windows.Forms.SRDescription("ErrorProviderBlinkStyleDescr"), DefaultValue(0), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [DefaultValue((string) null), System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("ErrorProviderContainerControlDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatData"), Editor("System.Windows.Forms.Design.DataMemberListEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), System.Windows.Forms.SRDescription("ErrorProviderDataMemberDescr"), DefaultValue((string) null)]
        ...
        [System.Windows.Forms.SRDescription("ErrorProviderDataSourceDescr"), DefaultValue((string) null), System.Windows.Forms.SRCategory("CatData"), AttributeProvider(typeof(IListSource))]
        ...
        [System.Windows.Forms.SRDescription("ControlRightToLeftDescr"), System.Windows.Forms.SRCategory("CatAppearance"), Localizable(true), DefaultValue(false)]
        ...
        [TypeConverter(typeof(StringConverter)), Bindable(true), DefaultValue((string) null), System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("ControlTagDescr"), Localizable(false)]
        public object Tag
        {
            get => 
                this.userData;
        ...
        internal class ErrorWindow : NativeWindow
        {
            ...
            public void Add(ErrorProvider.ControlItem item)
            {
                ...
                if (this.EnsureCreated())
                {
                    ...
                    structure.uId = item.Id;
                    structure.lpszText = item.Error;
                ...
                try
                {
                    for (int j = 0; j < this.items.Count; j++)
                    {
                        ...
                        if (this.tipWindow != null)
                        {
                            ...
                            structure.cbSize = Marshal.SizeOf(structure);
                            structure.hwnd = base.Handle;
                            structure.uId = item2.Id;
                            structure.lpszText = item2.Error;
                            structure.rect = System.Windows.Forms.NativeMethods.RECT.FromXYWH(rectangle2.X, rectangle2.Y, rectangle2.Width, rectangle2.Height);
                            structure.uFlags = 0x10;
                            if (this.provider.RightToLeft)
                            {
                                structure.uFlags |= 4;
                            }
                            System.Windows.Forms.UnsafeNativeMethods.SendMessage(new HandleRef(this.tipWindow, this.tipWindow.Handle), System.Windows.Forms.NativeMethods.TTM_SETTOOLINFO, 0, structure);
                        }
