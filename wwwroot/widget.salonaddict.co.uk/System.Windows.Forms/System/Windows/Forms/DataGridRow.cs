namespace System.Windows.Forms
{
    ...
    internal abstract class DataGridRow : MarshalByRefObject
    {
        ...
        protected internal virtual int MinimumRowHeight(System.Windows.Forms.DataGridTableStyle dgTable) => 
            this.MinimumRowHeight(dgTable.GridColumnStyles);
        ...
        public virtual bool OnMouseDown(int x, int y, Rectangle rowHeaders) => 
            this.OnMouseDown(x, y, rowHeaders, false);
        ...
        public virtual int PaintData(Graphics g, Rectangle bounds, int firstVisibleColumn, int columnCount) => 
            this.PaintData(g, bounds, firstVisibleColumn, columnCount, false);
        ...
        protected Rectangle PaintIcon(Graphics g, Rectangle visualBounds, bool paintIcon, bool alignToRight, Bitmap bmp) => 
            this.PaintIcon(g, visualBounds, paintIcon, alignToRight, bmp, this.dgTable.IsDefault ? this.DataGrid.HeaderBackBrush : this.dgTable.HeaderBackBrush);
        ...
        protected class DataGridCellAccessibleObject : AccessibleObject
        {
            ...
            public override AccessibleObject GetFocused() => 
                this.DataGrid.AccessibilityObject.GetFocused();
            ...
            public override Rectangle Bounds =>
                this.DataGrid.RectangleToScreen(this.DataGrid.GetCellBounds(new DataGridCell(this.owner.RowNumber, this.column)));

            protected System.Windows.Forms.DataGrid DataGrid =>
                this.owner.DataGrid;

            public override string DefaultAction =>
                System.Windows.Forms.SR.GetString("AccDGEdit");

            public override string Name =>
                this.DataGrid.myGridTable.GridColumnStyles[this.column].HeaderText;

            public override AccessibleObject Parent =>
                this.owner.AccessibleObject;
        ...
        protected class DataGridRowAccessibleObject : AccessibleObject
        {
            ...
            protected virtual AccessibleObject CreateCellAccessibleObject(int column) => 
                new DataGridRow.DataGridCellAccessibleObject(this.owner, column);
            ...
            public override Rectangle Bounds =>
                this.DataGrid.RectangleToScreen(this.DataGrid.GetRowBounds(this.owner));
            ...
            public override AccessibleObject Parent =>
                this.DataGrid.AccessibilityObject;
