namespace System.Windows.Forms
{
    ...
    public class ToolStripPanelRow : Component, IArrangedElement, IComponent, IDisposable
    {
        ...
        public bool CanMove(ToolStrip toolStripToDrag) => 
            ((!this.ToolStripPanel.Locked && !this.Locked) && this.RowManager.CanMove(toolStripToDrag));

        private ToolStripPanelRowControlCollection CreateControlsInstance() => 
            new ToolStripPanelRowControlCollection(this);
        ...
        {
            get => 
                this.state[stateCachedBoundsMode];
            set
            {
        ...
        internal ArrangedElementCollection Cells =>
            this.ControlsInternal.Cells;

        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("ControlControlsDescr")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), System.Windows.Forms.SRDescription("ControlControlsDescr")]
        ...
        public Rectangle DisplayRectangle =>
            this.RowManager.DisplayRectangle;

        internal Rectangle DragBounds =>
            this.RowManager.DragBounds;
        ...
        public System.Windows.Forms.Orientation Orientation =>
            this.ToolStripPanel.Orientation;
        ...
        internal class ToolStripPanelRowControlCollection : ArrangedElementCollection, IList, ICollection, IEnumerable
        {
            ...
            public override IEnumerator GetEnumerator() => 
                new ToolStripPanelCellToControlEnumerator(base.InnerList);
            ...
            private class ToolStripPanelCellToControlEnumerator : IEnumerator, ICloneable
            {
                ...
                public virtual bool MoveNext() => 
                    this.arrayListEnumerator.MoveNext();
