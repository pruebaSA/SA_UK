namespace System.Windows.Forms
{
    ...
    [ComVisible(true), DefaultProperty("SelectionRange"), DefaultBindingProperty("SelectionRange"), Designer("System.Windows.Forms.Design.MonthCalendarDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), System.Windows.Forms.SRDescription("DescriptionMonthCalendar"), ClassInterface(ClassInterfaceType.AutoDispatch), DefaultEvent("DateChanged")]
    public class MonthCalendar : Control
    {
        ...
        [System.Windows.Forms.SRCategory("CatAction"), System.Windows.Forms.SRDescription("MonthCalendarOnDateChangedDescr")]
            ...
            if (!restrictUnmanagedCode.HasValue)
            {
                ...
                if (flag)
                {
                    ...
                    try
                    {
                        ...
                        if (key != null)
                        {
                            object obj2 = key.GetValue("AllowWindowsFormsReentrantDestroy");
                            if (((obj2 != null) && (obj2 is int)) && (((int) obj2) == 1))
                            {
                                restrictUnmanagedCode = false;
                            }
                            else
        ...
        private System.Drawing.Size GetMinReqRect() => 
            this.GetMinReqRect(0, false, false);
        ...
        private System.Drawing.Size GetMinReqRect(int newDimensionLength, bool updateRows, bool updateCols)
        {
            ...
            {
                int num5 = (int) base.SendMessage(0x1015, 0, 0);
        ...
        private int GetPreferredHeight(int height, bool updateRows) => 
            this.GetMinReqRect(height, updateRows, false).Height;

        private int GetPreferredWidth(int width, bool updateCols) => 
            this.GetMinReqRect(width, false, updateCols).Width;
        ...
        private bool ShouldSerializeAnnuallyBoldedDates() => 
            (this.annualArrayOfDates.Count > 0);

        private bool ShouldSerializeBoldedDates() => 
            (this.arrayOfDates.Count > 0);

        private bool ShouldSerializeCalendarDimensions() => 
            !this.dimensions.Equals(new System.Drawing.Size(1, 1));

        private bool ShouldSerializeMaxDate() => 
            ((this.maxDate != DateTimePicker.MaximumDateTime) && (this.maxDate != DateTime.MaxValue));

        private bool ShouldSerializeMinDate() => 
            ((this.minDate != DateTimePicker.MinimumDateTime) && (this.minDate != DateTime.MinValue));

        private bool ShouldSerializeMonthlyBoldedDates() => 
            (this.monthlyArrayOfDates.Count > 0);

        private bool ShouldSerializeSelectionRange() => 
            !DateTime.Equals(this.selectionEnd, this.selectionStart);

        private bool ShouldSerializeTitleBackColor() => 
            !this.TitleBackColor.Equals(DEFAULT_TITLE_BACK_COLOR);

        private bool ShouldSerializeTitleForeColor() => 
            !this.TitleForeColor.Equals(DEFAULT_TITLE_FORE_COLOR);

        private bool ShouldSerializeTodayDate() => 
            this.todayDateSet;

        private bool ShouldSerializeTrailingForeColor() => 
            !this.TrailingForeColor.Equals(DEFAULT_TRAILING_FORE_COLOR);

        public override string ToString() => 
            (base.ToString() + ", " + this.SelectionRange.ToString());
        ...
        protected override void WndProc(ref Message m)
        {
            switch (m.Msg)
            {
                ...
                case 2:
                    if ((restrictUnmanagedCode == true) && (this.nativeWndProcCount > 0))
                    {
        ...
        [System.Windows.Forms.SRDescription("MonthCalendarDimensionsDescr"), Localizable(true), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [System.Windows.Forms.SRDescription("MonthCalendarFirstDayOfWeekDescr"), Localizable(true), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(7)]
        ...
        {
            get => 
                DateTimePicker.EffectiveMaxDate(this.maxDate);
            set
            {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(7), System.Windows.Forms.SRDescription("MonthCalendarMaxSelectionCountDescr")]
        public int MaxSelectionCount
        {
            ...
            set
            {
                ...
                {
                    if (base.IsHandleCreated && (((int) base.SendMessage(0x1004, value, 0)) == 0))
                    {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("MonthCalendarMinDateDescr")]
        public DateTime MinDate
        {
            get => 
                DateTimePicker.EffectiveMinDate(this.minDate);
            set
            {
        ...
        [System.Windows.Forms.SRDescription("ControlRightToLeftLayoutDescr"), DefaultValue(false), System.Windows.Forms.SRCategory("CatAppearance"), Localizable(true)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("MonthCalendarSelectionEndDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), Bindable(true), System.Windows.Forms.SRDescription("MonthCalendarSelectionRangeDescr")]
        public System.Windows.Forms.SelectionRange SelectionRange
        {
            get => 
                new System.Windows.Forms.SelectionRange(this.SelectionStart, this.SelectionEnd);
            set
            {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("MonthCalendarSelectionStartDescr"), Browsable(false), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [DefaultValue(true), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("MonthCalendarShowTodayDescr")]
        ...
        [DefaultValue(false), System.Windows.Forms.SRDescription("MonthCalendarShowWeekNumbersDescr"), Localizable(true), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [Browsable(false), System.Windows.Forms.SRDescription("MonthCalendarSingleMonthSizeDescr"), System.Windows.Forms.SRCategory("CatAppearance"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public System.Drawing.Size SingleMonthSize
        {
            get
            {
                ...
                if (((int) base.SendMessage(0x1009, 0, ref lparam)) == 0)
                {
        ...
        [System.Windows.Forms.SRDescription("MonthCalendarTitleBackColorDescr"), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("MonthCalendarTodayDateSetDescr")]
