namespace System.Windows.Forms
{
    ...
    [ClassInterface(ClassInterfaceType.AutoDispatch), Designer("System.Windows.Forms.Design.ScrollableControlDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ComVisible(true)]
    public class ScrollableControl : Control, IArrangedElement, IComponent, IDisposable
    {
        ...
        private bool ShouldSerializeAutoScrollMargin() => 
            !this.AutoScrollMargin.Equals(new Size(0, 0));

        private bool ShouldSerializeAutoScrollMinSize() => 
            !this.AutoScrollMinSize.Equals(new Size(0, 0));
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), System.Windows.Forms.SRDescription("FormAutoScrollDescr"), DefaultValue(false), Localizable(true)]
        public virtual bool AutoScroll
        {
            get => 
                this.GetScrollState(1);
            set
            {
                if (value)
                {
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), Localizable(true), System.Windows.Forms.SRDescription("FormAutoScrollMarginDescr")]
        public Size AutoScrollMargin
        {
            get => 
                this.requestedScrollMargin;
            set
            {
        ...
        [System.Windows.Forms.SRDescription("FormAutoScrollMinSizeDescr"), Localizable(true), System.Windows.Forms.SRCategory("CatLayout")]
        public Size AutoScrollMinSize
        {
            get => 
                this.userAutoScrollMinSize;
            set
            {
        ...
        [System.Windows.Forms.SRDescription("FormAutoScrollPositionDescr"), Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRCategory("CatLayout")]
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), System.Windows.Forms.SRDescription("ScrollableControlHorizontalScrollDescr"), EditorBrowsable(EditorBrowsableState.Always), Browsable(false)]
        ...
        public class DockPaddingEdges : ICloneable
        {
            ...
            object ICloneable.Clone() => 
                new ScrollableControl.DockPaddingEdges(this.Left, this.Right, this.Top, this.Bottom);

            public override string ToString() => 
                "";

            [RefreshProperties(RefreshProperties.All), System.Windows.Forms.SRDescription("PaddingAllDescr")]
            public int All
            {
                get
                {
            ...
            [System.Windows.Forms.SRDescription("PaddingBottomDescr"), RefreshProperties(RefreshProperties.All)]
            public int Bottom
            {
                get => 
                    this.owner?.Padding.Bottom;
                set
                {
                    if (this.owner == null)
                    {
            ...
            [System.Windows.Forms.SRDescription("PaddingRightDescr"), RefreshProperties(RefreshProperties.All)]
            public int Right
            {
                get => 
                    this.owner?.Padding.Right;
                set
                {
                    if (this.owner == null)
                    {
            ...
            [System.Windows.Forms.SRDescription("PaddingTopDescr"), RefreshProperties(RefreshProperties.All)]
            public int Top
            {
                get => 
                    this.owner?.Padding.Top;
                set
                {
                    if (this.owner == null)
                    {
        ...
        public class DockPaddingEdgesConverter : TypeConverter
        {
            public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes) => 
                TypeDescriptor.GetProperties(typeof(ScrollableControl.DockPaddingEdges), attributes).Sort(new string[] { "All", "Left", "Top", "Right", "Bottom" });
