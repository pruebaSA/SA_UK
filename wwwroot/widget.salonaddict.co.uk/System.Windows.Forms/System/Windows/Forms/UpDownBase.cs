namespace System.Windows.Forms
{
    ...
    [Designer("System.Windows.Forms.Design.UpDownBaseDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch)]
    public abstract class UpDownBase : ContainerControl
    {
        ...
        [DefaultValue(2), System.Windows.Forms.SRDescription("UpDownBaseBorderStyleDescr"), System.Windows.Forms.SRCategory("CatAppearance"), DispId(-504)]
        ...
        protected override Size DefaultSize =>
            new Size(120, this.PreferredHeight);

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        public ScrollableControl.DockPaddingEdges DockPadding =>
            base.DockPadding;

        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("ControlFocusedDescr"), Browsable(false)]
        public override bool Focused =>
            this.upDownEdit.Focused;

        public override System.Drawing.Color ForeColor
        {
            get => 
                this.upDownEdit.ForeColor;
            set
            {
        ...
        [DefaultValue(true), System.Windows.Forms.SRDescription("UpDownBaseInterceptArrowKeysDescr"), System.Windows.Forms.SRCategory("CatBehavior")]
        public bool InterceptArrowKeys
        {
            get => 
                this.interceptArrowKeys;
            set
            {
        ...
        [System.Windows.Forms.SRDescription("UpDownBasePreferredHeightDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRCategory("CatLayout"), Browsable(false), EditorBrowsable(EditorBrowsableState.Advanced)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(false), System.Windows.Forms.SRDescription("UpDownBaseReadOnlyDescr")]
        public bool ReadOnly
        {
            get => 
                this.upDownEdit.ReadOnly;
            set
            {
        ...
        [System.Windows.Forms.SRDescription("UpDownBaseTextAlignDescr"), System.Windows.Forms.SRCategory("CatAppearance"), Localizable(true), DefaultValue(0)]
        public HorizontalAlignment TextAlign
        {
            get => 
                this.upDownEdit.TextAlign;
            set
            {
                if (!System.Windows.Forms.ClientUtils.IsEnumValid(value, (int) value, 0, 2))
                {
        ...
        [System.Windows.Forms.SRDescription("UpDownBaseAlignmentDescr"), System.Windows.Forms.SRCategory("CatAppearance"), DefaultValue(1), Localizable(true)]
        ...
        internal class UpDownButtons : Control
        {
            ...
            protected override void OnPaint(PaintEventArgs e)
            {
                ...
                if (Application.RenderWithVisualStyles)
                {
                    ...
                    {
                        renderer.SetParameters((this.mouseOver == UpDownBase.ButtonID.Up) ? VisualStyleElement.Spin.Down.Hot : VisualStyleElement.Spin.Down.Normal);
                    }
        ...
        internal class UpDownEdit : System.Windows.Forms.TextBox
        {
            ...
            protected override AccessibleObject CreateAccessibilityInstance() => 
                new UpDownEditAccessibleObject(this, this.parent);
            ...
            internal class UpDownEditAccessibleObject : Control.ControlAccessibleObject
            {
                ...
                public override string KeyboardShortcut =>
                    this.parent.AccessibilityObject.KeyboardShortcut;

                public override string Name
                {
                    get => 
                        this.parent.AccessibilityObject.Name;
                    set
                    {
