namespace System.Windows.Forms
{
    ...
    [DefaultProperty("Text"), DesignTimeVisible(false), DefaultEvent("Click"), ToolboxItem(false)]
    public class MenuItem : System.Windows.Forms.Menu
    {
        ...
        internal void UpdateItemRtl(bool setRightToLeftBit)
        {
            if (this.menuItemIsCreated)
            {
                ...
                lpmii.cch = lpmii.dwTypeData.Length - 1;
        ...
        [DefaultValue(false), System.Windows.Forms.SRDescription("MenuItemDefaultDescr")]
        public bool DefaultItem
        {
            get => 
                ((this.data.State & 0x1000) != 0);
            set
            {
                if (this.menu != null)
                {
        ...
        [Localizable(true), DefaultValue(true), System.Windows.Forms.SRDescription("MenuItemEnabledDescr")]
        public bool Enabled
        {
            get => 
                ((this.data.State & 3) == 0);
        ...
        [DefaultValue(false), System.Windows.Forms.SRDescription("MenuItemOwnerDrawDescr"), System.Windows.Forms.SRCategory("CatBehavior")]
        public bool OwnerDraw
        {
            get => 
                ((this.data.State & 0x100) != 0);
            set
            {
        ...
        [DefaultValue(false), System.Windows.Forms.SRDescription("MenuItemRadioCheckDescr")]
        public bool RadioCheck
        {
            get => 
                ((this.data.State & 0x200) != 0);
            set
            {
        ...
        internal override bool RenderIsRightToLeft =>
            this.Parent?.RenderIsRightToLeft;
        ...
        [Localizable(true), DefaultValue(0), System.Windows.Forms.SRDescription("MenuItemShortCutDescr")]
        ...
        [DefaultValue(true), Localizable(true), System.Windows.Forms.SRDescription("MenuItemShowShortCutDescr")]
        public bool ShowShortcut
        {
            get => 
                this.data.showShortcut;
            set
            {
        ...
        [Localizable(true), System.Windows.Forms.SRDescription("MenuItemTextDescr")]
        public string Text
        {
            get => 
                this.data.caption;
        ...
        [System.Windows.Forms.SRDescription("MenuItemVisibleDescr"), Localizable(true), DefaultValue(true)]
        public bool Visible
        {
            get => 
                ((this.data.State & 0x10000) == 0);
            set
            {
