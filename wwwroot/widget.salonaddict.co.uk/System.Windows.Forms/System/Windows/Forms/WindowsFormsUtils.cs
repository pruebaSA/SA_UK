namespace System.Windows.Forms
{
    ...
    internal sealed class WindowsFormsUtils
    {
        ...
        internal static Rectangle ConstrainToScreenBounds(Rectangle bounds) => 
            ConstrainToBounds(Screen.FromRectangle(bounds).Bounds, bounds);

        internal static Rectangle ConstrainToScreenWorkingAreaBounds(Rectangle bounds) => 
            ConstrainToBounds(Screen.GetWorkingArea(bounds), bounds);
        ...
        public static Graphics CreateMeasurementGraphics() => 
            Graphics.FromHdcInternal(WindowsGraphicsCacheManager.MeasurementGraphics.DeviceContext.Hdc);
        ...
        public static HandleRef GetRootHWnd(HandleRef hwnd) => 
            new HandleRef(hwnd.Wrapper, System.Windows.Forms.UnsafeNativeMethods.GetAncestor(new HandleRef(hwnd, hwnd.Handle), 2));

        public static HandleRef GetRootHWnd(Control control) => 
            GetRootHWnd(new HandleRef(control, control.Handle));
        ...
        public static class EnumValidator
        {
            ...
            public static bool IsValidTextImageRelation(TextImageRelation relation) => 
                System.Windows.Forms.ClientUtils.IsEnumValid(relation, (int) relation, 0, 8, 1);
        }
