namespace System.Windows.Forms
{
    ...
    [ClassInterface(ClassInterfaceType.AutoDispatch), System.Windows.Forms.SRDescription("DescriptionCheckedListBox"), ComVisible(true), LookupBindingProperties]
    public class CheckedListBox : ListBox
    {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("CheckedListBoxItemCheckDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("CheckedListBoxCheckOnClickDescr"), DefaultValue(false)]
        ...
        [System.Windows.Forms.SRDescription("ListBoxItemsDescr"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Editor("System.Windows.Forms.Design.ListControlStringCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), Localizable(true), System.Windows.Forms.SRCategory("CatData")]
        public ObjectCollection Items =>
            ((ObjectCollection) base.Items);

        internal override int MaxItemWidth =>
            ((base.MaxItemWidth + this.idealCheckSize) + 3);
        ...
        [DefaultValue(false), System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("CheckedListBoxThreeDCheckBoxesDescr")]
        ...
        public class CheckedIndexCollection : IList, ICollection, IEnumerable
        {
            ...
            bool IList.Contains(object index) => 
                ((index is int) && this.Contains((int) index));
            ...
            public int Count =>
                this.owner.CheckedItems.Count;

            private ListBox.ItemArray InnerArray =>
                this.owner.Items.InnerArray;
        ...
        public class CheckedItemCollection : IList, ICollection, IEnumerable
        {
            ...
            public IEnumerator GetEnumerator() => 
                this.InnerArray.GetEnumerator(AnyMask, true);

            public int IndexOf(object item) => 
                this.InnerArray.IndexOf(item, AnyMask);

            internal int IndexOfIdentifier(object item) => 
                this.InnerArray.IndexOfIdentifier(item, AnyMask);
            ...
            public int Count =>
                this.InnerArray.GetCount(AnyMask);
            ...
            {
                get => 
                    this.InnerArray.GetItem(index, AnyMask);
                set
                {
                    throw new NotSupportedException(System.Windows.Forms.SR.GetString("CheckedListBoxCheckedItemCollectionIsReadOnly"));
                }
        ...
        internal class CheckedListBoxAccessibleObject : Control.ControlAccessibleObject
        {
            ...
            public override int GetChildCount() => 
                this.CheckedListBox.Items.Count;
            ...
            private System.Windows.Forms.CheckedListBox CheckedListBox =>
                ((System.Windows.Forms.CheckedListBox) base.Owner);
        }
        ...
        internal class CheckedListBoxItemAccessibleObject : AccessibleObject
        {
            ...
            private CheckedListBox ParentCheckedListBox =>
                ((CheckedListBox) this.parent.Owner);
            ...
            public override string Value =>
                this.ParentCheckedListBox.GetItemChecked(this.index).ToString();
        }
        ...
        public class ObjectCollection : ListBox.ObjectCollection
        {
            ...
            public int Add(object item, bool isChecked) => 
                this.Add(item, isChecked ? CheckState.Checked : CheckState.Unchecked);
