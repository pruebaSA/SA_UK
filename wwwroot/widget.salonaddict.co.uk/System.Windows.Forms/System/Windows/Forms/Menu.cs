namespace System.Windows.Forms
{
    ...
    [ListBindable(false), ToolboxItemFilter("System.Windows.Forms")]
    public abstract class Menu : Component
    {
        ...
        private bool CheckOwnerDrawItemNoMnemonic(MenuItem mi, char key) => 
            (((mi.OwnerDraw && (mi.Mnemonic == '\0')) && (mi.Text.Length > 0)) && (char.ToUpper(mi.Text[0], CultureInfo.CurrentCulture) == key));

        private bool CheckOwnerDrawItemWithMnemonic(MenuItem mi, char key) => 
            (mi.OwnerDraw && (mi.Mnemonic == key));
        ...
        protected virtual IntPtr CreateMenuHandle() => 
            System.Windows.Forms.UnsafeNativeMethods.CreatePopupMenu();
        ...
        private IntPtr MatchKeyToMenuItem(int startItem, char key, MenuItemKeyComparer comparer)
        {
            ...
            int high = flag ? 3 : 2;
            return (IntPtr) NativeMethods.Util.MAKELONG(low, high);
        }
        ...
        protected internal virtual bool ProcessCmdKey(ref Message msg, Keys keyData) => 
            this.FindMenuItemInternal(1, (IntPtr) keyData)?.ShortcutClick();
        ...
        public override string ToString() => 
            (base.ToString() + ", Items.Count: " + this.ItemCount.ToString(CultureInfo.CurrentCulture));
        ...
        [Browsable(false), System.Windows.Forms.SRDescription("ControlHandleDescr"), EditorBrowsable(EditorBrowsableState.Advanced), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), System.Windows.Forms.SRDescription("MenuIsParentDescr")]
        public virtual bool IsParent =>
            ((this.items != null) && (this.ItemCount > 0));

        internal int ItemCount =>
            this._itemCount;

        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("MenuMDIListItemDescr")]
        ...
        [Browsable(false), MergableProperty(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), System.Windows.Forms.SRDescription("MenuMenuItemsDescr")]
        ...
        [Bindable(true), DefaultValue((string) null), System.Windows.Forms.SRDescription("ControlTagDescr"), System.Windows.Forms.SRCategory("CatData"), Localizable(false), TypeConverter(typeof(StringConverter))]
        public object Tag
        {
            get => 
                this.userData;
        ...
        public class MenuItemCollection : IList, ICollection, IEnumerable
        {
            ...
            public virtual int Add(MenuItem item) => 
                this.Add(this.owner.ItemCount, item);
            ...
            public IEnumerator GetEnumerator() => 
                new WindowsFormsUtils.ArraySubsetEnumerator(this.owner.items, this.owner.ItemCount);
            ...
            bool IList.Contains(object value) => 
                ((value is MenuItem) && this.Contains((MenuItem) value));
