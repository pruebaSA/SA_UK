namespace System.Windows.Forms
{
    ...
    public class SystemInformation
    {
        ...
        public static Size Border3DSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x2d), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x2e));
        ...
        public static Size BorderSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(5), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(6));

        public static Size CaptionButtonSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(30), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x1f));

        public static int CaptionHeight =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(4);

        public static int CaretBlinkTime =>
            ((int) System.Windows.Forms.SafeNativeMethods.GetCaretBlinkTime());
        ...
        public static Size CursorSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(13), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(14));

        public static bool DbcsEnabled =>
            (System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x2a) != 0);
        ...
        public static Size DoubleClickSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x24), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x25));

        public static int DoubleClickTime =>
            System.Windows.Forms.SafeNativeMethods.GetDoubleClickTime();
        ...
        public static Size DragSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x44), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x45));

        public static Size FixedFrameBorderSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(7), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(8));
        ...
        public static Size FrameBorderSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x20), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x21));
        ...
        public static bool HighContrast
        {
            get
            {
                ...
                {
                    System.Windows.Forms.NativeMethods.HIGHCONTRAST_I structure = new System.Windows.Forms.NativeMethods.HIGHCONTRAST_I();
                    structure.cbSize = Marshal.SizeOf(structure);
                    structure.dwFlags = 0;
                    structure.lpszDefaultScheme = IntPtr.Zero;
                    if (System.Windows.Forms.UnsafeNativeMethods.SystemParametersInfo(0x42, structure.cbSize, ref structure, 0))
                    {
                        highContrast = (structure.dwFlags & 1) != 0;
                    }
                    else
                    {
                        highContrast = false;
        ...
        public static int HorizontalResizeBorderThickness =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x20);

        public static int HorizontalScrollBarArrowWidth =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x15);

        public static int HorizontalScrollBarHeight =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(3);

        public static int HorizontalScrollBarThumbWidth =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(10);
        ...
        public static Size IconSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(11), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(12));

        public static Size IconSpacingSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x26), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x27));
        ...
        public static int KanjiWindowHeight =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x12);
        ...
        public static Size MaxWindowTrackSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x3b), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(60));
        ...
        public static Size MenuButtonSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x36), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x37));

        public static Size MenuCheckSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x47), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x48));
        ...
        public static int MenuHeight =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(15);
        ...
        public static bool MidEastEnabled =>
            (System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x4a) != 0);

        public static Size MinimizedWindowSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x39), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x3a));

        public static Size MinimizedWindowSpacingSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x2f), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x30));

        public static Size MinimumWindowSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x1c), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x1d));

        public static Size MinWindowTrackSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x22), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x23));
        ...
        public static int MouseButtons =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x2b);

        public static bool MouseButtonsSwapped =>
            (System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x17) != 0);
        ...
        public static bool MousePresent =>
            (System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x13) != 0);
        ...
        public static bool Network =>
            ((System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x3f) & 1) != 0);

        public static bool PenWindows =>
            (System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x29) != 0);
        ...
        public static Size PrimaryMonitorMaximizedWindowSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x3d), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x3e));

        public static Size PrimaryMonitorSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(1));

        public static bool RightAlignedMenus =>
            (System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(40) != 0);
        ...
        public static bool ShowSounds =>
            (System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(70) != 0);
        ...
        public static Size SmallIconSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x31), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(50));

        public static bool TerminalServerSession =>
            ((System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x1000) & 1) != 0);

        public static Size ToolWindowCaptionButtonSize =>
            new Size(System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x34), System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x35));

        public static int ToolWindowCaptionHeight =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x33);
        ...
        public static int VerticalResizeBorderThickness =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(0x21);

        public static int VerticalScrollBarArrowHeight =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(20);

        public static int VerticalScrollBarThumbHeight =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(9);

        public static int VerticalScrollBarWidth =>
            System.Windows.Forms.UnsafeNativeMethods.GetSystemMetrics(2);
