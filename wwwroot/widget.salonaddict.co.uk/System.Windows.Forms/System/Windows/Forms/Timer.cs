namespace System.Windows.Forms
{
    ...
    [DefaultEvent("Tick"), System.Windows.Forms.SRDescription("DescriptionTimer"), DefaultProperty("Interval"), ToolboxItemFilter("System.Windows.Forms")]
    public class Timer : Component
    {
        ...
        public override string ToString() => 
            (base.ToString() + ", Interval: " + this.Interval.ToString(CultureInfo.CurrentCulture));

        [System.Windows.Forms.SRDescription("TimerEnabledDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(false)]
        public virtual bool Enabled
        {
            get => 
                this.timerWindow?.IsTimerRunning;
            set
            {
                lock (this.syncObj)
                {
        ...
        [DefaultValue(100), System.Windows.Forms.SRDescription("TimerIntervalDescr"), System.Windows.Forms.SRCategory("CatBehavior")]
        public int Interval
        {
            get => 
                this.interval;
        ...
        [Localizable(false), System.Windows.Forms.SRDescription("ControlTagDescr"), System.Windows.Forms.SRCategory("CatData"), Bindable(true), TypeConverter(typeof(StringConverter)), DefaultValue((string) null)]
        public object Tag
        {
            get => 
                this.userData;
        ...
        private class TimerNativeWindow : NativeWindow
        {
            ...
            public bool IsTimerRunning =>
                ((this._timerID != 0) && (base.Handle != IntPtr.Zero));
        }
    }
}
