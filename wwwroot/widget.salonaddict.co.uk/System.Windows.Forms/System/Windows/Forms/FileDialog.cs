namespace System.Windows.Forms
{
    ...
    public abstract class FileDialog : CommonDialog
    {
        ...
        {
            NativeMethods.OPENFILENAME_I openfilename_i = (NativeMethods.OPENFILENAME_I) System.Windows.Forms.UnsafeNativeMethods.PtrToStructure(lpOFN, typeof(NativeMethods.OPENFILENAME_I));
            ...
            if (msg == 0x4e)
            {
                ...
                try
                {
                    ...
                    switch (structure.hdr_code)
                    {
                        ...
                        case -602:
                        {
                            NativeMethods.OPENFILENAME_I openfilename_i = (NativeMethods.OPENFILENAME_I) System.Windows.Forms.UnsafeNativeMethods.PtrToStructure(structure.lpOFN, typeof(NativeMethods.OPENFILENAME_I));
                    ...
                    this.ignoreSecondFileOkNotification = false;
                    System.Windows.Forms.UnsafeNativeMethods.SetWindowLong(new HandleRef(null, hWnd), 0, new HandleRef(null, NativeMethods.InvalidIntPtr));
        ...
        [System.Windows.Forms.SRDescription("FDaddExtensionDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(true)]
        public bool AddExtension
        {
            get => 
                this.GetOption(-2147483648);
            set
            {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("FDcheckFileExistsDescr"), DefaultValue(false)]
        ...
        [DefaultValue(true), System.Windows.Forms.SRDescription("FDdereferenceLinksDescr"), System.Windows.Forms.SRCategory("CatBehavior")]
        public bool DereferenceLinks
        {
            get => 
                !this.GetOption(0x100000);
            set
            {
                System.Windows.Forms.IntSecurity.FileDialogCustomization.Demand();
        ...
        [System.Windows.Forms.SRCategory("CatData"), DefaultValue(""), System.Windows.Forms.SRDescription("FDfileNameDescr")]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), Browsable(false), System.Windows.Forms.SRDescription("FDFileNamesDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(""), Localizable(true), System.Windows.Forms.SRDescription("FDfilterDescr")]
        ...
        private FileDialogNative.COMDLG_FILTERSPEC[] FilterItems =>
            GetFilterItems(this.filter);

        [System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("FDinitialDirDescr"), DefaultValue("")]
        ...
        [System.Windows.Forms.SRDescription("FDshowHelpDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(false)]
        ...
        [DefaultValue(false), System.Windows.Forms.SRDescription("FDsupportMultiDottedExtensionsDescr"), System.Windows.Forms.SRCategory("CatBehavior")]
        public bool SupportMultiDottedExtensions
        {
            get => 
                this.supportMultiDottedExtensions;
            set
            {
        ...
        [DefaultValue(""), Localizable(true), System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("FDtitleDescr")]
        public string Title
        {
            get
            {
        ...
        [System.Windows.Forms.SRDescription("FDvalidateNamesDescr"), System.Windows.Forms.SRCategory("CatBehavior"), DefaultValue(true)]
