namespace System.Windows.Forms
{
    ...
    [Serializable, DefaultProperty("Text"), TypeConverter(typeof(TreeNodeConverter))]
    public class TreeNode : MarshalByRefObject, ICloneable, ISerializable
    {
        ...
        public override string ToString() => 
            ("TreeNode: " + ((this.text == null) ? "" : this.text));
        ...
        [System.Windows.Forms.SRDescription("TreeNodeCheckedDescr"), DefaultValue(false), System.Windows.Forms.SRCategory("CatBehavior")]
        public bool Checked
        {
            get => 
                this.CheckedInternal;
            set
            {
                System.Windows.Forms.TreeView treeView = this.TreeView;
                if (treeView != null)
            ...
            set
            {
                ...
                if (this.handle != IntPtr.Zero)
                {
                    ...
                    if ((treeView != null) && treeView.IsHandleCreated)
                    {
                        ...
                        lParam.state |= value ? 0x2000 : 0x1000;
                        System.Windows.Forms.UnsafeNativeMethods.SendMessage(new HandleRef(treeView, treeView.Handle), System.Windows.Forms.NativeMethods.TVM_SETITEM, 0, ref lParam);
                    }
                }
            }
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ControlContextMenuDescr"), DefaultValue((string) null)]
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("TreeNodeForeColorDescr")]
        public Color ForeColor
        {
            get => 
                this.propBag?.ForeColor;
            set
            {
        ...
        [Localizable(true), System.Windows.Forms.SRDescription("TreeNodeImageIndexDescr"), TypeConverter(typeof(TreeViewImageIndexConverter)), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), RefreshProperties(RefreshProperties.Repaint), DefaultValue(-1), RelatedImageList("TreeView.ImageList"), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [DefaultValue(""), System.Windows.Forms.SRCategory("CatBehavior"), TypeConverter(typeof(TreeViewImageKeyConverter)), Localizable(true), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), RefreshProperties(RefreshProperties.Repaint), RelatedImageList("TreeView.ImageList"), System.Windows.Forms.SRDescription("TreeNodeImageKeyDescr")]
        ...
        [System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("TreeNodeNodeFontDescr"), DefaultValue((string) null), Localizable(true)]
        ...
        [DefaultValue(-1), System.Windows.Forms.SRCategory("CatBehavior"), TypeConverter(typeof(TreeViewImageIndexConverter)), Localizable(true), RefreshProperties(RefreshProperties.Repaint), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), RelatedImageList("TreeView.ImageList"), System.Windows.Forms.SRDescription("TreeNodeSelectedImageIndexDescr")]
        public int SelectedImageIndex
        {
            get => 
                this.SelectedImageIndexer.Index;
            set
            {
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("TreeNodeSelectedImageKeyDescr"), TypeConverter(typeof(TreeViewImageKeyConverter)), DefaultValue(""), RefreshProperties(RefreshProperties.Repaint), Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), RelatedImageList("TreeView.ImageList"), Localizable(true)]
        ...
        [Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), TypeConverter(typeof(NoneExcludedImageIndexConverter)), System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("TreeNodeStateImageIndexDescr"), Localizable(true), RefreshProperties(RefreshProperties.Repaint), RelatedImageList("TreeView.StateImageList"), DefaultValue(-1)]
        ...
        [Editor("System.Windows.Forms.Design.ImageIndexEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), System.Windows.Forms.SRCategory("CatBehavior"), TypeConverter(typeof(ImageKeyConverter)), DefaultValue(""), Localizable(true), RefreshProperties(RefreshProperties.Repaint), RelatedImageList("TreeView.StateImageList"), System.Windows.Forms.SRDescription("TreeNodeStateImageKeyDescr")]
        public string StateImageKey
        {
            get => 
                this.StateImageIndexer.Key;
            set
            {
        ...
        [Localizable(false), Bindable(true), System.Windows.Forms.SRCategory("CatData"), DefaultValue((string) null), TypeConverter(typeof(StringConverter)), System.Windows.Forms.SRDescription("ControlTagDescr")]
        public object Tag
        {
            get => 
                this.userData;
        ...
        [DefaultValue(""), System.Windows.Forms.SRCategory("CatAppearance"), Localizable(false), System.Windows.Forms.SRDescription("TreeNodeToolTipTextDescr")]
