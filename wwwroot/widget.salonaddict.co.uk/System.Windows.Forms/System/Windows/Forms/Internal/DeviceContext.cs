namespace System.Windows.Forms.Internal
{
    ...
    internal sealed class DeviceContext : MarshalByRefObject, IDeviceContext, IDisposable
    {
        ...
        public static DeviceContext CreateDC(string driverName, string deviceName, string fileName, HandleRef devMode) => 
            new DeviceContext(IntUnsafeNativeMethods.CreateDC(driverName, deviceName, fileName, devMode), System.Windows.Forms.Internal.DeviceContextType.NamedDevice);

        public static DeviceContext CreateIC(string driverName, string deviceName, string fileName, HandleRef devMode) => 
            new DeviceContext(IntUnsafeNativeMethods.CreateIC(driverName, deviceName, fileName, devMode), System.Windows.Forms.Internal.DeviceContextType.Information);
        ...
        public override bool Equals(object obj)
        {
            ...
            return ((context == this) || (context?.Hdc == this.Hdc));
        }
        ...
        public static DeviceContext FromCompatibleDC(IntPtr hdc) => 
            new DeviceContext(IntUnsafeNativeMethods.CreateCompatibleDC(new HandleRef(null, hdc)), System.Windows.Forms.Internal.DeviceContextType.Memory);

        public static DeviceContext FromHdc(IntPtr hdc) => 
            new DeviceContext(hdc, System.Windows.Forms.Internal.DeviceContextType.Unknown);
        ...
        public int GetDeviceCapabilities(DeviceCapabilities capabilityIndex) => 
            IntUnsafeNativeMethods.GetDeviceCaps(new HandleRef(this, this.Hdc), (int) capabilityIndex);

        public override int GetHashCode() => 
            this.Hdc.GetHashCode();
        ...
        public Color SetBackgroundColor(Color newColor) => 
            ColorTranslator.FromWin32(IntUnsafeNativeMethods.SetBkColor(new HandleRef(this, this.Hdc), ColorTranslator.ToWin32(newColor)));

        public DeviceContextBackgroundMode SetBackgroundMode(DeviceContextBackgroundMode newMode) => 
            ((DeviceContextBackgroundMode) IntUnsafeNativeMethods.SetBkMode(new HandleRef(this, this.Hdc), (int) newMode));
        ...
        public DeviceContextGraphicsMode SetGraphicsMode(DeviceContextGraphicsMode newMode) => 
            ((DeviceContextGraphicsMode) IntUnsafeNativeMethods.SetGraphicsMode(new HandleRef(this, this.Hdc), (int) newMode));

        public DeviceContextMapMode SetMapMode(DeviceContextMapMode newMode) => 
            ((DeviceContextMapMode) IntUnsafeNativeMethods.SetMapMode(new HandleRef(this, this.Hdc), (int) newMode));
        ...
        public DeviceContextBinaryRasterOperationFlags SetRasterOperation(DeviceContextBinaryRasterOperationFlags rasterOperation) => 
            ((DeviceContextBinaryRasterOperationFlags) IntUnsafeNativeMethods.SetROP2(new HandleRef(this, this.Hdc), (int) rasterOperation));

        public DeviceContextTextAlignment SetTextAlignment(DeviceContextTextAlignment newAligment) => 
            ((DeviceContextTextAlignment) IntUnsafeNativeMethods.SetTextAlign(new HandleRef(this, this.Hdc), (int) newAligment));

        public Color SetTextColor(Color newColor) => 
            ColorTranslator.FromWin32(IntUnsafeNativeMethods.SetTextColor(new HandleRef(this, this.Hdc), ColorTranslator.ToWin32(newColor)));
        ...
        public Color BackgroundColor =>
            ColorTranslator.FromWin32(IntUnsafeNativeMethods.GetBkColor(new HandleRef(this, this.Hdc)));

        public DeviceContextBackgroundMode BackgroundMode =>
            ((DeviceContextBackgroundMode) IntUnsafeNativeMethods.GetBkMode(new HandleRef(this, this.Hdc)));

        public DeviceContextBinaryRasterOperationFlags BinaryRasterOperation =>
            ((DeviceContextBinaryRasterOperationFlags) IntUnsafeNativeMethods.GetROP2(new HandleRef(this, this.Hdc)));

        public System.Windows.Forms.Internal.DeviceContextType DeviceContextType =>
            this.dcType;

        public Size Dpi =>
            new Size(this.GetDeviceCapabilities(DeviceCapabilities.LogicalPixelsX), this.GetDeviceCapabilities(DeviceCapabilities.LogicalPixelsY));
        ...
        public DeviceContextGraphicsMode GraphicsMode =>
            ((DeviceContextGraphicsMode) IntUnsafeNativeMethods.GetGraphicsMode(new HandleRef(this, this.Hdc)));
        ...
        public DeviceContextMapMode MapMode =>
            ((DeviceContextMapMode) IntUnsafeNativeMethods.GetMapMode(new HandleRef(this, this.Hdc)));

        public static DeviceContext ScreenDC =>
            FromHwnd(IntPtr.Zero);

        public DeviceContextTextAlignment TextAlignment =>
            ((DeviceContextTextAlignment) IntUnsafeNativeMethods.GetTextAlign(new HandleRef(this, this.Hdc)));

        public Color TextColor =>
            ColorTranslator.FromWin32(IntUnsafeNativeMethods.GetTextColor(new HandleRef(this, this.Hdc)));
