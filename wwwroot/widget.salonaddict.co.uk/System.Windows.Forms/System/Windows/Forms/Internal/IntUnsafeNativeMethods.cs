namespace System.Windows.Forms.Internal
{
    ...
    internal static class IntUnsafeNativeMethods
    {
        public static bool AngleArc(HandleRef hDC, int x, int y, int radius, float startAngle, float endAngle) => 
            IntAngleArc(hDC, x, y, radius, startAngle, endAngle);
        ...
        public static bool Arc(HandleRef hDC, int nLeftRect, int nTopRect, int nRightRect, int nBottomRect, int nXStartArc, int nYStartArc, int nXEndArc, int nYEndArc) => 
            IntArc(hDC, nLeftRect, nTopRect, nRightRect, nBottomRect, nXStartArc, nYStartArc, nXEndArc, nYEndArc);
        ...
        public static IntPtr CreateCompatibleDC(HandleRef hDC) => 
            System.Internal.HandleCollector.Add(IntCreateCompatibleDC(hDC), IntSafeNativeMethods.CommonHandles.GDI);

        public static IntPtr CreateDC(string lpszDriverName, string lpszDeviceName, string lpszOutput, HandleRef lpInitData) => 
            System.Internal.HandleCollector.Add(IntCreateDC(lpszDriverName, lpszDeviceName, lpszOutput, lpInitData), IntSafeNativeMethods.CommonHandles.HDC);

        public static IntPtr CreateFontIndirect(object lf) => 
            System.Internal.HandleCollector.Add(IntCreateFontIndirect(lf), IntSafeNativeMethods.CommonHandles.GDI);

        public static IntPtr CreateIC(string lpszDriverName, string lpszDeviceName, string lpszOutput, HandleRef lpInitData) => 
            System.Internal.HandleCollector.Add(IntCreateIC(lpszDriverName, lpszDeviceName, lpszOutput, lpInitData), IntSafeNativeMethods.CommonHandles.HDC);
        ...
        public static bool FillRect(HandleRef hDC, [In] ref IntNativeMethods.RECT rect, HandleRef hbrush) => 
            IntFillRect(hDC, ref rect, hbrush);
        ...
        public static int GetClipRgn(HandleRef hDC, HandleRef hRgn) => 
            IntGetClipRgn(hDC, hRgn);

        public static IntPtr GetCurrentObject(HandleRef hDC, int uObjectType) => 
            IntGetCurrentObject(hDC, uObjectType);

        public static IntPtr GetDC(HandleRef hWnd) => 
            System.Internal.HandleCollector.Add(IntGetDC(hWnd), IntSafeNativeMethods.CommonHandles.HDC);
