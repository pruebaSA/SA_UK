namespace System.Windows.Forms.Internal
{
    ...
    internal sealed class WindowsFont : MarshalByRefObject, ICloneable, IDisposable
    {
        ...
        public object Clone() => 
            new WindowsFont(this.logFont, true);
        ...
        public static WindowsFont FromFont(Font font) => 
            FromFont(font, WindowsFontQuality.Default);
        ...
        public static WindowsFont FromHdc(IntPtr hdc) => 
            FromHfont(IntUnsafeNativeMethods.GetCurrentObject(new HandleRef(null, hdc), 6));

        public static WindowsFont FromHfont(IntPtr hFont) => 
            FromHfont(hFont, false);
        ...
        public override int GetHashCode() => 
            ((((((int) this.Style) << 13) | (((int) this.Style) >> 0x13)) ^ ((this.CharSet << 0x1a) | (this.CharSet >> 6))) ^ ((int) ((((uint) this.Size) << 7) | (((uint) this.Size) >> 0x19))));

        public override string ToString() => 
            string.Format(CultureInfo.CurrentCulture, "[{0}: Name={1}, Size={2} points, Height={3} pixels, Sytle={4}]", new object[] { base.GetType().Name, this.logFont.lfFaceName, this.Size, this.Height, this.Style });
        ...
        public bool Italic =>
            (this.logFont.lfItalic == 1);

        public int LogFontHeight =>
            this.logFont.lfHeight;
        ...
        public WindowsFontQuality Quality =>
            ((WindowsFontQuality) this.logFont.lfQuality);
