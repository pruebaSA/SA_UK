namespace System.Windows.Forms.Internal
{
    ...
    internal sealed class WindowsPen : MarshalByRefObject, ICloneable, IDisposable
    {
        ...
        public override string ToString() => 
            string.Format(CultureInfo.InvariantCulture, "{0}: Style={1}, Color={2}, Width={3}, Brush={4}", new object[] { base.GetType().Name, this.style, this.color, this.width, (this.wndBrush != null) ? this.wndBrush.ToString() : "null" });
