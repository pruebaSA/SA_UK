namespace System.Windows.Forms.Internal
{
    ...
    internal sealed class WindowsGraphics : MarshalByRefObject, IDeviceContext, IDisposable
    {
        ...
        public static WindowsGraphics CreateMeasurementWindowsGraphics() => 
            new WindowsGraphics(System.Windows.Forms.Internal.DeviceContext.FromCompatibleDC(IntPtr.Zero)) { disposeDc = true };
        ...
        public static WindowsGraphics FromHdc(IntPtr hDc) => 
            new WindowsGraphics(System.Windows.Forms.Internal.DeviceContext.FromHdc(hDc)) { disposeDc = true };

        public static WindowsGraphics FromHwnd(IntPtr hWnd) => 
            new WindowsGraphics(System.Windows.Forms.Internal.DeviceContext.FromHwnd(hWnd)) { disposeDc = true };
        ...
        public Size MeasureText(string text, WindowsFont font) => 
            this.MeasureText(text, font, MaxSize, IntTextFormatFlags.Default);

        public Size MeasureText(string text, WindowsFont font, Size proposedSize) => 
            this.MeasureText(text, font, proposedSize, IntTextFormatFlags.Default);
