namespace System.Windows.Forms
{
    ...
    [System.Windows.Forms.SRDescription("DescriptionLinkLabel"), ComVisible(true), ClassInterface(ClassInterfaceType.AutoDispatch), DefaultEvent("LinkClicked"), ToolboxItem("System.Windows.Forms.Design.AutoSizeToolboxItem,System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a")]
    public class LinkLabel : Label, IButtonControl
    {
        ...
        [System.Windows.Forms.SRDescription("LinkLabelLinkClickedDescr"), WinCategory("Action")]
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new LinkLabelAccessibleObject(this);
        ...
        private bool LinkInText(int start, int length) => 
            (((0 <= start) && (start < this.Text.Length)) && (0 < length));
                        ...
                        try
                        {
                            if (this.IsOneLink())
                            {
                                ...
                                if ((regionScans != null) && (regionScans.Length > 0))
                                {
                                    ...
                                    e.Graphics.ExcludeClip(new Region(empty));
                                }
                            }
                            else
                            {
        ...
        internal bool ShouldSerializeActiveLinkColor() => 
            !this.activeLinkColor.IsEmpty;

        internal bool ShouldSerializeDisabledLinkColor() => 
            !this.disabledLinkColor.IsEmpty;
        ...
        internal override bool UseGDIMeasuring() => 
            !this.UseCompatibleTextRendering;
        ...
        [System.Windows.Forms.SRDescription("LinkLabelActiveLinkColorDescr"), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        private Rectangle ClientRectWithPadding =>
            LayoutUtils.DeflateRect(base.ClientRectangle, this.Padding);

        [System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("LinkLabelDisabledLinkColorDescr")]
        ...
        [Localizable(true), System.Windows.Forms.SRDescription("LinkLabelLinkAreaDescr"), RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRCategory("CatBehavior"), Editor("System.Windows.Forms.Design.LinkAreaEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor))]
        ...
        [System.Windows.Forms.SRDescription("LinkLabelLinkColorDescr"), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [System.Windows.Forms.SRDescription("LinkLabelLinkVisitedDescr"), DefaultValue(false), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        {
            get => 
                base.UseCompatibleTextRendering;
            set
            {
        ...
        public class Link
        {
            ...
            [System.Windows.Forms.SRDescription("ControlTagDescr"), DefaultValue((string) null), TypeConverter(typeof(StringConverter)), Bindable(true), System.Windows.Forms.SRCategory("CatData"), Localizable(false)]
            public object Tag
            {
                get => 
                    this.userData;
            ...
            {
                get => 
                    ((this.State & LinkState.Visited) == LinkState.Visited);
                set
                {
        ...
        internal class LinkAccessibleObject : AccessibleObject
        {
            ...
            public override string DefaultAction =>
                System.Windows.Forms.SR.GetString("AccessibleActionClick");
            ...
            public override AccessibleObject Parent =>
                this.link.Owner.AccessibilityObject;
        ...
        public class LinkCollection : IList, ICollection, IEnumerable
        {
            ...
            public bool Contains(LinkLabel.Link link) => 
                this.owner.links.Contains(link);
            ...
            bool IList.Contains(object link) => 
                ((link is LinkLabel.Link) && this.Contains((LinkLabel.Link) link));
            ...
            {
                get => 
                    ((LinkLabel.Link) this.owner.links[index]);
                set
                {
        ...
        internal class LinkLabelAccessibleObject : Label.LabelAccessibleObject
        {
            ...
            public override int GetChildCount() => 
                ((LinkLabel) base.Owner).Links.Count;
