namespace System.Windows.Forms.ButtonInternal
{
    ...
    internal abstract class ButtonBaseAdapter
    {
        ...
        private ColorOptions CommonRender(Graphics g) => 
            new ColorOptions(g, this.Control.ForeColor, this.Control.BackColor) { enabled = this.Control.Enabled };

        private static ColorOptions CommonRender(Graphics g, Color foreColor, Color backColor, bool enabled) => 
            new ColorOptions(g, foreColor, backColor) { enabled = enabled };
        ...
        internal virtual StringFormat CreateStringFormat() => 
            ControlPaint.CreateStringFormat(this.Control, this.Control.TextAlign, this.Control.ShowToolTip, this.Control.UseMnemonic);

        internal virtual TextFormatFlags CreateTextFormatFlags() => 
            ControlPaint.CreateTextFormatFlags(this.Control, this.Control.TextAlign, this.Control.ShowToolTip, this.Control.UseMnemonic);
        ...
        internal class LayoutOptions
        {
            ...
            private Composition GetHorizontalComposition()
            {
                BitVector32 vector = new BitVector32 {
                    [combineCheck] = (this.checkAlign == ContentAlignment.MiddleCenter) || !LayoutUtils.IsHorizontalAlignment(this.checkAlign),
                    [combineImageText] = !LayoutUtils.IsHorizontalRelation(this.textImageRelation)
                };
            ...
            {
                BitVector32 vector = new BitVector32 {
                    [combineCheck] = (this.checkAlign == ContentAlignment.MiddleCenter) || !LayoutUtils.IsVerticalAlignment(this.checkAlign),
                    [combineImageText] = !LayoutUtils.IsVerticalRelation(this.textImageRelation)
                };
                return (Composition) vector.Data;
            }
            ...
            private int FullCheckSize =>
                (this.checkSize + this.checkPaddingSize);

            private bool OnePixExtraBorder =>
                (this.growBorderBy1PxWhenDefault && this.isDefault);
