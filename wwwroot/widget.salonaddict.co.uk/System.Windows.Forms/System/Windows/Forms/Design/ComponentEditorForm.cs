namespace System.Windows.Forms.Design
{
    ...
    [ComVisible(true), ToolboxItem(false), ClassInterface(ClassInterfaceType.AutoDispatch), PermissionSet(SecurityAction.LinkDemand, Name="FullTrust"), PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust")]
    public class ComponentEditorForm : Form
    {
        ...
        public override bool PreProcessMessage(ref Message msg) => 
            (((this.pageSites != null) && this.pageSites[this.activePage].GetPageControl().IsPageMessage(ref msg)) || base.PreProcessMessage(ref msg));
        ...
        private sealed class ComponentEditorPageSite : IComponentEditorPageSite
        {
            ...
            internal bool AutoCommit =>
                this.pageControl.CommitOnDeactivate;
