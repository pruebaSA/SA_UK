namespace System.Windows.Forms
{
    ...
    [Editor("System.Windows.Forms.Design.DataGridViewCellStyleEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), TypeConverter(typeof(DataGridViewCellStyleConverter))]
    public class DataGridViewCellStyle : ICloneable
    {
        ...
        public virtual DataGridViewCellStyle Clone() => 
            new DataGridViewCellStyle(this);
        ...
        private bool ShouldSerializeFont() => 
            (this.Properties.GetObject(PropFont) != null);
        ...
        private bool ShouldSerializeFormatProvider() => 
            (this.Properties.GetObject(PropFormatProvider) != null);
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), DefaultValue(0), System.Windows.Forms.SRDescription("DataGridViewCellStyleAlignmentDescr")]
        ...
        {
            get => 
                ((System.Drawing.Font) this.Properties.GetObject(PropFont));
            set
            {
        ...
        {
            get => 
                this.Properties.GetColor(PropForeColor);
            set
            {
        ...
        [DefaultValue(""), Editor("System.Windows.Forms.Design.FormatStringEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), EditorBrowsable(EditorBrowsableState.Advanced), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        public bool IsDataSourceNullValueDefault =>
            (!this.Properties.ContainsObject(PropDataSourceNullValue) || (this.Properties.GetObject(PropDataSourceNullValue) == DBNull.Value));
        ...
        [System.Windows.Forms.SRCategory("CatData"), TypeConverter(typeof(StringConverter)), DefaultValue("")]
        ...
        {
            get => 
                this.Properties.GetPadding(PropPadding);
            set
            {
        ...
        {
            get => 
                this.Properties.GetColor(PropSelectionBackColor);
            set
            {
        ...
        {
            get => 
                this.Properties.GetColor(PropSelectionForeColor);
            set
            {
        ...
        {
            get => 
                this.Properties.GetObject(PropTag);
            set
            {
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), DefaultValue(0)]
