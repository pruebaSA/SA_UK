namespace System.Windows.Forms
{
    ...
    public class ComboBox : ListControl
    {
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new ComboBoxAccessibleObject(this);

        internal virtual FlatComboAdapter CreateFlatComboAdapterInstance() => 
            new FlatComboAdapter(this, false);
        ...
        public int FindStringExact(string s) => 
            this.FindStringExact(s, -1, true);

        public int FindStringExact(string s, int startIndex) => 
            this.FindStringExact(s, startIndex, true);
        ...
        protected override bool ProcessKeyEventArgs(ref Message m) => 
            ((((this.AutoCompleteMode != System.Windows.Forms.AutoCompleteMode.None) && (this.AutoCompleteSource == System.Windows.Forms.AutoCompleteSource.ListItems)) && ((this.DropDownStyle == ComboBoxStyle.DropDownList) && this.InterceptAutoCompleteKeystroke(m))) || base.ProcessKeyEventArgs(ref m));
        ...
        private bool ShouldSerializeAutoCompleteCustomSource() => 
            ((this.autoCompleteCustomSource != null) && (this.autoCompleteCustomSource.Count > 0));

        internal bool ShouldSerializeDropDownWidth() => 
            base.Properties.ContainsInteger(PropDropDownWidth);

        internal bool ShouldSerializeItemHeight() => 
            base.Properties.ContainsInteger(PropItemHeight);

        internal override bool ShouldSerializeText() => 
            ((this.SelectedIndex == -1) && base.ShouldSerializeText());

        public override string ToString() => 
            (base.ToString() + ", Items.Count: " + ((this.itemsCollection == null) ? 0.ToString(CultureInfo.CurrentCulture) : this.itemsCollection.Count.ToString(CultureInfo.CurrentCulture)));
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), EditorBrowsable(EditorBrowsableState.Always), Localizable(true), System.Windows.Forms.SRDescription("ComboBoxAutoCompleteCustomSourceDescr"), Editor("System.Windows.Forms.Design.ListControlStringCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), Browsable(true)]
        ...
        [EditorBrowsable(EditorBrowsableState.Always), Browsable(true), DefaultValue(0), System.Windows.Forms.SRDescription("ComboBoxAutoCompleteModeDescr")]
        ...
        [System.Windows.Forms.SRDescription("ComboBoxAutoCompleteSourceDescr"), DefaultValue(0x80), Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        ...
        [RefreshProperties(RefreshProperties.Repaint), AttributeProvider(typeof(IListSource)), System.Windows.Forms.SRCategory("CatData"), System.Windows.Forms.SRDescription("ListControlDataSourceDescr"), DefaultValue((string) null)]
        ...
        protected override Size DefaultSize =>
            new Size(0x79, this.PreferredHeight);

        [DefaultValue(0), System.Windows.Forms.SRCategory("CatBehavior"), RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRDescription("ComboBoxDrawModeDescr")]
        ...
        [System.Windows.Forms.SRDescription("ComboBoxDropDownHeightDescr"), DefaultValue(0x6a), System.Windows.Forms.SRCategory("CatBehavior"), Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        ...
        [RefreshProperties(RefreshProperties.Repaint), System.Windows.Forms.SRDescription("ComboBoxStyleDescr"), DefaultValue(1), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        {
            get => 
                (base.IsHandleCreated && (((int) base.SendMessage(0x157, 0, 0)) != 0));
            set
            {
                if (!base.IsHandleCreated)
                {
        ...
        [Localizable(true), DefaultValue(2), System.Windows.Forms.SRDescription("ComboBoxFlatStyleDescr"), System.Windows.Forms.SRCategory("CatAppearance")]
        ...
        [Localizable(true), DefaultValue(true), System.Windows.Forms.SRDescription("ComboBoxIntegralHeightDescr"), System.Windows.Forms.SRCategory("CatBehavior")]
        ...
        [Editor("System.Windows.Forms.Design.ListControlStringCollectionEditor, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", typeof(UITypeEditor)), System.Windows.Forms.SRDescription("ComboBoxItemsDescr"), MergableProperty(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Localizable(true), System.Windows.Forms.SRCategory("CatData")]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ComboBoxMaxLengthDescr"), Localizable(true), DefaultValue(0)]
        public int MaxLength
        {
            get => 
                base.Properties.GetInteger(PropMaxLength);
            set
            {
                if (value < 0)
                {
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("ComboBoxPreferredHeightDescr"), Browsable(false)]
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), System.Windows.Forms.SRDescription("ComboBoxSelectionLengthDescr"), Browsable(false)]
        ...
        [System.Windows.Forms.SRCategory("CatBehavior"), System.Windows.Forms.SRDescription("ComboBoxSortedDescr"), DefaultValue(false)]
        public bool Sorted
        {
            get => 
                this.sorted;
        ...
        private bool SystemAutoCompleteEnabled =>
            ((this.autoCompleteMode != System.Windows.Forms.AutoCompleteMode.None) && (this.DropDownStyle != ComboBoxStyle.DropDownList));
        ...
        private sealed class ACNativeWindow : NativeWindow
        {
            ...
            internal bool Visible =>
                System.Windows.Forms.SafeNativeMethods.IsWindowVisible(new HandleRef(this, base.Handle));
        }
        ...
        public class ChildAccessibleObject : AccessibleObject
        {
            ...
            public override string Name =>
                this.owner.AccessibilityObject.Name;
        }
        ...
        internal class FlatComboAdapter
        {
            ...
            public bool IsValid(ComboBox combo) => 
                ((combo.ClientRectangle == this.clientRect) && (combo.RightToLeft == this.origRightToLeft));
