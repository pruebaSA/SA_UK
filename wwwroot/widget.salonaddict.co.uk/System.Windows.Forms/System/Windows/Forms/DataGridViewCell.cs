namespace System.Windows.Forms
{
    ...
    public abstract class DataGridViewCell : DataGridViewElement, ICloneable, IDisposable
    {
        ...
        internal bool ContentClickUnsharesRowInternal(DataGridViewCellEventArgs e) => 
            this.ContentClickUnsharesRow(e);
        ...
        internal bool ContentDoubleClickUnsharesRowInternal(DataGridViewCellEventArgs e) => 
            this.ContentDoubleClickUnsharesRow(e);

        protected virtual AccessibleObject CreateAccessibilityInstance() => 
            new DataGridViewCellAccessibleObject(this);
        ...
        internal bool EnterUnsharesRowInternal(int rowIndex, bool throughMouseClick) => 
            this.EnterUnsharesRow(rowIndex, throughMouseClick);
        ...
        internal object GetClipboardContentInternal(int rowIndex, bool firstCell, bool lastCell, bool inFirstRow, bool inLastRow, string format) => 
            this.GetClipboardContent(rowIndex, firstCell, lastCell, inFirstRow, inLastRow, format);
        ...
        public Rectangle GetContentBounds(int rowIndex)
        {
            ...
            return this.GetContentBounds(base.DataGridView.CachedGraphics, cellStyle, rowIndex);
        }
        ...
        {
            DataGridViewCellStyle cellStyle = this.GetInheritedStyle(null, rowIndex, false);
            return this.GetErrorIconBounds(base.DataGridView.CachedGraphics, cellStyle, rowIndex);
        }
        ...
        internal DataGridViewCellStyle GetInheritedStyleInternal(int rowIndex) => 
            this.GetInheritedStyle(null, rowIndex, true);
        ...
        internal int GetPreferredHeight(int rowIndex, int width)
        {
            ...
            DataGridViewCellStyle cellStyle = this.GetInheritedStyle(null, rowIndex, false);
            return this.GetPreferredSize(base.DataGridView.CachedGraphics, cellStyle, rowIndex, new System.Drawing.Size(width, 0)).Height;
        }
        ...
        internal System.Drawing.Size GetPreferredSize(int rowIndex)
        {
            ...
            DataGridViewCellStyle cellStyle = this.GetInheritedStyle(null, rowIndex, false);
            return this.GetPreferredSize(base.DataGridView.CachedGraphics, cellStyle, rowIndex, System.Drawing.Size.Empty);
        }
        ...
        internal int GetPreferredWidth(int rowIndex, int height)
        {
            ...
            DataGridViewCellStyle cellStyle = this.GetInheritedStyle(null, rowIndex, false);
            return this.GetPreferredSize(base.DataGridView.CachedGraphics, cellStyle, rowIndex, new System.Drawing.Size(0, height)).Width;
        }
        ...
        internal bool KeyDownUnsharesRowInternal(KeyEventArgs e, int rowIndex) => 
            this.KeyDownUnsharesRow(e, rowIndex);
        ...
        internal bool KeyPressUnsharesRowInternal(KeyPressEventArgs e, int rowIndex) => 
            this.KeyPressUnsharesRow(e, rowIndex);
        ...
        internal bool KeyUpUnsharesRowInternal(KeyEventArgs e, int rowIndex) => 
            this.KeyUpUnsharesRow(e, rowIndex);
        ...
        internal bool LeaveUnsharesRowInternal(int rowIndex, bool throughMouseClick) => 
            this.LeaveUnsharesRow(rowIndex, throughMouseClick);
        ...
        internal bool MouseDoubleClickUnsharesRowInternal(DataGridViewCellMouseEventArgs e) => 
            this.MouseDoubleClickUnsharesRow(e);
                ...
                if (((currentCellAddress.X == -1) || (currentCellAddress.X != this.ColumnIndex)) || ((currentCellAddress.Y != rowIndex) || (base.DataGridView.EditingControl == null)))
                {
                    ...
                    if (string.IsNullOrEmpty(toolTipText))
                    {
                        if (this.FormattedValueType == stringType)
                        {
                            ...
                            else if ((((rowIndex != -1) && (this.OwningRow != null)) && ((base.DataGridView.RowHeadersVisible && (base.DataGridView.RowHeadersWidth > 0)) && (this.OwningColumn == null))) || (rowIndex == -1))
                            {
                                string str3 = this.GetValue(rowIndex) as string;
                                if (!string.IsNullOrEmpty(str3))
                                {
                                    DataGridViewCellStyle cellStyle = this.GetInheritedStyle(null, rowIndex, false);
                                    Rectangle rectangle = this.GetContentBounds(base.DataGridView.CachedGraphics, cellStyle, rowIndex);
                                    bool widthTruncated = false;
                                    int num3 = 0;
                                    if (rectangle.Width > 0)
                                    {
                                        num3 = GetPreferredTextHeight(base.DataGridView.CachedGraphics, base.DataGridView.RightToLeftInternal, str3, cellStyle, rectangle.Width, out widthTruncated);
                                    }
                                    else
                                    {
                                        widthTruncated = true;
                    ...
                    else if (base.DataGridView.IsRestricted)
                    {
        ...
        internal static bool PaintBackground(DataGridViewPaintParts paintParts) => 
            ((paintParts & DataGridViewPaintParts.Background) != DataGridViewPaintParts.None);
        ...
        internal static bool PaintSelectionBackground(DataGridViewPaintParts paintParts) => 
            ((paintParts & DataGridViewPaintParts.SelectionBackground) != DataGridViewPaintParts.None);
        ...
        public virtual object ParseFormattedValue(object formattedValue, DataGridViewCellStyle cellStyle, TypeConverter formattedValueTypeConverter, TypeConverter valueTypeConverter) => 
            this.ParseFormattedValueInternal(this.ValueType, formattedValue, cellStyle, formattedValueTypeConverter, valueTypeConverter);
        ...
        public override string ToString() => 
            ("DataGridViewCell { ColumnIndex=" + this.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + this.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");
        ...
        public int ColumnIndex =>
            this.owningColumn?.Index;

        [Browsable(false)]
        public Rectangle ContentBounds =>
            this.GetContentBounds(this.RowIndex);

        [DefaultValue((string) null)]
        public virtual System.Windows.Forms.ContextMenuStrip ContextMenuStrip
        {
            get => 
                this.GetContextMenuStrip(this.RowIndex);
            set
            {
        ...
        {
            get => 
                ((System.Windows.Forms.ContextMenuStrip) this.Properties.GetObject(PropCellContextMenuStrip));
            set
            {
        ...
        public Rectangle ErrorIconBounds =>
            this.GetErrorIconBounds(this.RowIndex);

        [Browsable(false)]
        public string ErrorText
        {
            get => 
                this.GetErrorText(this.RowIndex);
            set
            {
        ...
        internal bool HasErrorText =>
            (this.Properties.ContainsObject(PropCellErrorText) && (this.Properties.GetObject(PropCellErrorText) != null));

        [Browsable(false)]
        public bool HasStyle =>
            (this.Properties.ContainsObject(PropCellStyle) && (this.Properties.GetObject(PropCellStyle) != null));

        internal bool HasToolTipText =>
            (this.Properties.ContainsObject(PropCellToolTipText) && (this.Properties.GetObject(PropCellToolTipText) != null));

        internal bool HasValue =>
            (this.Properties.ContainsObject(PropCellValue) && (this.Properties.GetObject(PropCellValue) != null));

        internal virtual bool HasValueType =>
            (this.Properties.ContainsObject(PropCellValueType) && (this.Properties.GetObject(PropCellValueType) != null));

        [Browsable(false)]
        public DataGridViewElementStates InheritedState =>
            this.GetInheritedState(this.RowIndex);

        [Browsable(false)]
        public DataGridViewCellStyle InheritedStyle =>
            this.GetInheritedStyleInternal(this.RowIndex);
        ...
        public System.Drawing.Size PreferredSize =>
            this.GetPreferredSize(this.RowIndex);
        ...
        {
            get => 
                (((this.State & DataGridViewElementStates.ReadOnly) != DataGridViewElementStates.None) || ((((this.owningRow != null) && ((this.owningRow.DataGridView == null) || (this.RowIndex >= 0))) && this.owningRow.ReadOnly) || ((((base.DataGridView != null) && (this.RowIndex >= 0)) && (this.ColumnIndex >= 0)) && this.owningColumn.ReadOnly)));
            set
            {
                if (base.DataGridView != null)
                {
        ...
        public virtual bool Resizable =>
            ((((this.owningRow != null) && ((this.owningRow.DataGridView == null) || (this.RowIndex >= 0))) && (this.owningRow.Resizable == DataGridViewTriState.True)) || ((((base.DataGridView != null) && (this.RowIndex >= 0)) && (this.ColumnIndex >= 0)) && (this.owningColumn.Resizable == DataGridViewTriState.True)));

        [Browsable(false)]
        public int RowIndex =>
            this.owningRow?.Index;

        [Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public virtual bool Selected
        {
            get => 
                (((this.State & DataGridViewElementStates.Selected) != DataGridViewElementStates.None) || ((((this.owningRow != null) && ((this.owningRow.DataGridView == null) || (this.RowIndex >= 0))) && this.owningRow.Selected) || ((((base.DataGridView != null) && (this.RowIndex >= 0)) && (this.ColumnIndex >= 0)) && this.owningColumn.Selected)));
            set
            {
                if (base.DataGridView != null)
                {
        ...
        [System.Windows.Forms.SRCategory("CatData"), TypeConverter(typeof(StringConverter)), Localizable(false), Bindable(true), System.Windows.Forms.SRDescription("ControlTagDescr"), DefaultValue((string) null)]
        public object Tag
        {
            get => 
                this.Properties.GetObject(PropCellTag);
            set
            {
        ...
        {
            get => 
                this.GetToolTipText(this.RowIndex);
            set
            {
        ...
        protected class DataGridViewCellAccessibleObject : AccessibleObject
        {
            ...
            public override Rectangle Bounds =>
                this.GetAccessibleObjectBounds(this.GetAccessibleObjectParent());
            ...
            public override string Help =>
                (this.owner.GetType().Name + "(" + this.owner.GetType().BaseType.Name + ")");
            ...
            private AccessibleObject ParentPrivate =>
                this.owner?.OwningRow?.AccessibilityObject;
