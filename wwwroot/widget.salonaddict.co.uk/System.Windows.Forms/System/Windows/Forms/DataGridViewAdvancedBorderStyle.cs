namespace System.Windows.Forms
{
    ...
    public sealed class DataGridViewAdvancedBorderStyle : ICloneable
    {
        ...
        public override int GetHashCode() => 
            WindowsFormsUtils.GetCombinedHashCodes(new int[] { this.top, this.left, this.bottom, this.right });

        object ICloneable.Clone() => 
            new DataGridViewAdvancedBorderStyle(this.owner, this.banned1, this.banned2, this.banned3) { 
                all = this.all,
                top = this.top,
                right = this.right,
                bottom = this.bottom,
        ...
        public override string ToString() => 
            ("DataGridViewAdvancedBorderStyle { All=" + this.All.ToString() + ", Left=" + this.Left.ToString() + ", Right=" + this.Right.ToString() + ", Top=" + this.Top.ToString() + ", Bottom=" + this.Bottom.ToString() + " }");
