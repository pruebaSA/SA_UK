namespace System.Windows.Forms
{
    ...
    public class DataGridViewHeaderCell : DataGridViewCell
    {
        ...
        protected override bool MouseDownUnsharesRow(DataGridViewCellMouseEventArgs e) => 
            ((e.Button == MouseButtons.Left) && base.DataGridView.ApplyVisualStylesToHeaderCells);

        protected override bool MouseEnterUnsharesRow(int rowIndex) => 
            (((base.ColumnIndex == base.DataGridView.MouseDownCellAddress.X) && (rowIndex == base.DataGridView.MouseDownCellAddress.Y)) && base.DataGridView.ApplyVisualStylesToHeaderCells);

        protected override bool MouseLeaveUnsharesRow(int rowIndex) => 
            ((this.ButtonState != System.Windows.Forms.ButtonState.Normal) && base.DataGridView.ApplyVisualStylesToHeaderCells);
        ...
        public override string ToString() => 
            ("DataGridViewHeaderCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + base.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");
        ...
        {
            get => 
                ((Bitmap) base.Properties.GetObject(PropFlipXPThemesBitmap));
            set
            {
        ...
        internal override bool HasValueType =>
            (base.Properties.ContainsObject(PropValueType) && (base.Properties.GetObject(PropValueType) != null));
