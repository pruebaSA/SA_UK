namespace System.Windows.Forms
{
    ...
    [ClassInterface(ClassInterfaceType.AutoDispatch), DefaultProperty("Name"), DefaultEvent("Enter"), Designer("System.Windows.Forms.Design.AxDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a"), ComVisible(true), PermissionSet(SecurityAction.LinkDemand, Name="FullTrust"), PermissionSet(SecurityAction.InheritanceDemand, Name="FullTrust")]
    public class WebBrowserBase : Control
    {
        ...
        internal bool DoVerb(int verb) => 
            (this.axOleObject.DoVerb(verb, IntPtr.Zero, this.ActiveXSite, 0, base.Handle, new System.Windows.Forms.NativeMethods.COMRECT(base.Bounds)) == 0);
        ...
        private bool EditMode =>
            (this.axEditMode != WebBrowserHelper.AXEditMode.None);
        ...
        [EditorBrowsable(EditorBrowsableState.Never), Localizable(false), Browsable(false)]
