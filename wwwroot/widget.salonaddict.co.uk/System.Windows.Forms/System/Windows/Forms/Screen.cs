namespace System.Windows.Forms
{
    ...
    public class Screen
    {
        ...
        public static Screen FromControl(Control control) => 
            FromHandleInternal(control.Handle);
        ...
        public override string ToString() => 
            (base.GetType().Name + "[Bounds=" + this.bounds.ToString() + " WorkingArea=" + this.WorkingArea.ToString() + " Primary=" + this.primary.ToString() + " DeviceName=" + this.deviceName);
            ...
            get
            {
                if (screens == null)
                {
                    if (multiMonitorSupport)
                    {
                        ...
                        try
                        {
                            System.Windows.Forms.SafeNativeMethods.EnumDisplayMonitors(new HandleRef(null, dC), null, lpfnEnum, IntPtr.Zero);
                        }
                        finally
                        {
