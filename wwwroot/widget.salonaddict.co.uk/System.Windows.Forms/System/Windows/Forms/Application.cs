    ...
    public sealed class Application
    {
        ...
        private class ClickOnceUtility
        {
            ...
            private static System.Deployment.Internal.Isolation.StoreApplicationReference InstallReference =>
                new System.Deployment.Internal.Isolation.StoreApplicationReference(System.Deployment.Internal.Isolation.IsolationInterop.GUID_SXS_INSTALL_REFERENCE_SCHEME_OPAQUESTRING, "{3f471841-eef2-47d6-89c0-d028f03a4ad5}", null);
        ...
        private class ComponentManager : System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager
        {
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FInState(int uStateID, IntPtr pvoid) => 
                ((this.currentState & uStateID) != 0);

            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FOnComponentActivate(int dwComponentID)
            {
                ComponentHashtableEntry entry = (ComponentHashtableEntry) this.OleComponents[dwComponentID];
                if (entry == null)
                {
                    return false;
                }
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FOnComponentExitState(int dwComponentID, int uStateID, int uContext, int cpicmExclude, int rgpicmExclude)
            {
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FPushMessageLoop(int dwComponentID, int reason, int pvLoopData)
            {
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FRegisterComponent(System.Windows.Forms.UnsafeNativeMethods.IMsoComponent component, System.Windows.Forms.NativeMethods.MSOCRINFOSTRUCT pcrinfo, out int dwComponentID)
            {
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FRevokeComponent(int dwComponentID)
            {
                ComponentHashtableEntry entry = (ComponentHashtableEntry) this.OleComponents[dwComponentID];
                if (entry == null)
                {
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FSetTrackingComponent(int dwComponentID, bool fTrack)
            {
                ComponentHashtableEntry entry = (ComponentHashtableEntry) this.OleComponents[dwComponentID];
                if (entry == null)
                {
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.FUpdateComponentRegistration(int dwComponentID, System.Windows.Forms.NativeMethods.MSOCRINFOSTRUCT info)
            {
                ComponentHashtableEntry entry = (ComponentHashtableEntry) this.OleComponents[dwComponentID];
                if (entry == null)
                {
            ...
            void System.Windows.Forms.UnsafeNativeMethods.IMsoComponentManager.OnComponentEnterState(int dwComponentID, int uStateID, int uContext, int cpicmExclude, int rgpicmExclude, int dwReserved)
            {
                this.currentState |= uStateID;
                if ((uContext == 0) || (uContext == 1))
                {
        ...
        internal sealed class ParkingWindow : ContainerControl, IArrangedElement, IComponent, IDisposable
        {
            ...
            protected override void WndProc(ref Message m)
            {
                if (m.Msg != 0x18)
                {
                    ...
                    if (m.Msg == 0x210)
                    {
                        if (System.Windows.Forms.NativeMethods.Util.LOWORD((int) m.WParam) == 2)
                        {
        ...
        internal sealed class ThreadContext : MarshalByRefObject, System.Windows.Forms.UnsafeNativeMethods.IMsoComponent
        {
            ...
            internal void BeginModalMessageLoop(System.Windows.Forms.ApplicationContext context)
            {
                ...
                try
                {
                    ...
                    {
                        componentManager.OnComponentEnterState(this.componentID, 1, 0, 0, 0, 0);
                    }
                }
                finally
                {
            ...
            internal void EndModalMessageLoop(System.Windows.Forms.ApplicationContext context)
            {
                ...
                try
                {
                    ...
                    if (componentManager != null)
                    {
                        componentManager.FOnComponentExitState(this.componentID, 1, 0, 0, 0);
                    }
                }
                finally
                {
            ...
            internal void FormActivated(bool activate)
            {
                if (activate)
                {
                    ...
                    {
                        componentManager.FOnComponentActivate(this.componentID);
                    }
                }
            }
            ...
            internal bool GetAllowQuit() => 
                ((totalMessageLoopCount > 0) && (baseLoopReason == -1));
            ...
            bool System.Windows.Forms.UnsafeNativeMethods.IMsoComponent.FPreTranslateMessage(ref System.Windows.Forms.NativeMethods.MSG msg) => 
                this.PreTranslateMessage(ref msg);
            ...
            internal void TrackInput(bool track)
            {
                if (track != this.GetState(0x20))
                {
                    ...
                    if ((componentManager != null) && !(componentManager is System.Windows.Forms.Application.ComponentManager))
                    {
                        componentManager.FSetTrackingComponent(this.componentID, track);
                    ...
                    if (this.componentManager == null)
                    {
                        ...
                        try
                        {
                            ...
                            if ((componentManager != null) && (this.componentID == -1))
                            {
                                ...
                                if (componentManager.FRegisterComponent(this, pcrinfo, out this.componentID) && !(componentManager is System.Windows.Forms.Application.ComponentManager))
                                {
                                    this.messageLoopCount++;
                                }
