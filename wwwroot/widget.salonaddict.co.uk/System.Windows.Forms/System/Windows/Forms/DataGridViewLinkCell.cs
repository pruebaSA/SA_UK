namespace System.Windows.Forms
{
    ...
    public class DataGridViewLinkCell : DataGridViewCell
    {
        ...
        protected override AccessibleObject CreateAccessibilityInstance() => 
            new DataGridViewLinkCellAccessibleObject(this);
        ...
        protected override bool KeyUpUnsharesRow(KeyEventArgs e, int rowIndex) => 
            ((((e.KeyCode != Keys.Space) || e.Alt) || (e.Control || e.Shift)) || (this.TrackVisitedState && !this.LinkVisited));

        private bool LinkBoundsContainPoint(int x, int y, int rowIndex) => 
            base.GetContentBounds(rowIndex).Contains(x, y);

        protected override bool MouseDownUnsharesRow(DataGridViewCellMouseEventArgs e) => 
            this.LinkBoundsContainPoint(e.X, e.Y, e.RowIndex);
        ...
        protected override bool MouseUpUnsharesRow(DataGridViewCellMouseEventArgs e) => 
            (this.TrackVisitedState && this.LinkBoundsContainPoint(e.X, e.Y, e.RowIndex));
        ...
        public override string ToString() => 
            ("DataGridViewLinkCell { ColumnIndex=" + base.ColumnIndex.ToString(CultureInfo.CurrentCulture) + ", RowIndex=" + base.RowIndex.ToString(CultureInfo.CurrentCulture) + " }");
        ...
        {
            get => 
                (this.linkVisitedSet && this.linkVisited);
            set
            {
                this.linkVisitedSet = true;
        ...
        protected class DataGridViewLinkCellAccessibleObject : DataGridViewCell.DataGridViewCellAccessibleObject
        {
            ...
            public override string DefaultAction =>
                System.Windows.Forms.SR.GetString("DataGridView_AccLinkCellDefaultAction");
        }
    }
}
