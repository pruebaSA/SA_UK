namespace System.Windows.Forms
{
    ...
    public sealed class TableLayoutSettings : LayoutSettings, ISerializable
    {
        ...
        [System.Windows.Forms.SRDescription("TableLayoutSettingsGetCellPositionDescr"), System.Windows.Forms.SRCategory("CatLayout"), DefaultValue(-1)]
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), DefaultValue(-1), System.Windows.Forms.SRDescription("GridPanelColumnDescr")]
        ...
        internal IArrangedElement GetControlFromPosition(int column, int row) => 
            this.TableLayout.GetControlFromPosition(base.Owner, column, row);
        ...
        internal TableLayoutPanelCellPosition GetPositionFromControl(IArrangedElement element) => 
            this.TableLayout.GetPositionFromControl(base.Owner, element);

        [DefaultValue(-1), System.Windows.Forms.SRCategory("CatLayout"), System.Windows.Forms.SRDescription("GridPanelRowDescr")]
        ...
        [System.Windows.Forms.SRDescription("TableLayoutSettingsSetCellPositionDescr"), System.Windows.Forms.SRCategory("CatLayout"), DefaultValue(-1)]
        ...
        {
            string str = TypeDescriptor.GetConverter(this)?.ConvertToInvariantString(this);
        ...
        [DefaultValue(0), System.Windows.Forms.SRCategory("CatAppearance"), System.Windows.Forms.SRDescription("TableLayoutPanelCellBorderStyleDescr")]
        ...
        internal int CellBorderWidth =>
            System.Windows.Forms.Layout.TableLayout.GetContainerInfo(base.Owner).CellBorderWidth;

        [DefaultValue(0), System.Windows.Forms.SRDescription("GridPanelColumnsDescr"), System.Windows.Forms.SRCategory("CatLayout")]
        public int ColumnCount
        {
            get => 
                System.Windows.Forms.Layout.TableLayout.GetContainerInfo(base.Owner).MaxColumns;
            set
            {
                if (value < 0)
                {
        ...
        [System.Windows.Forms.SRDescription("GridPanelColumnStylesDescr"), System.Windows.Forms.SRCategory("CatLayout"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        ...
        [DefaultValue(1), System.Windows.Forms.SRDescription("TableLayoutPanelGrowStyleDescr"), System.Windows.Forms.SRCategory("CatLayout")]
        public TableLayoutPanelGrowStyle GrowStyle
        {
            get => 
                System.Windows.Forms.Layout.TableLayout.GetContainerInfo(base.Owner).GrowStyle;
            set
            {
        ...
        public override System.Windows.Forms.Layout.LayoutEngine LayoutEngine =>
            System.Windows.Forms.Layout.TableLayout.Instance;

        [System.Windows.Forms.SRDescription("GridPanelRowsDescr"), System.Windows.Forms.SRCategory("CatLayout"), DefaultValue(0)]
        public int RowCount
        {
            get => 
                System.Windows.Forms.Layout.TableLayout.GetContainerInfo(base.Owner).MaxRows;
            set
            {
                if (value < 0)
                {
        ...
        [System.Windows.Forms.SRCategory("CatLayout"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content), System.Windows.Forms.SRDescription("GridPanelRowStylesDescr")]
        ...
        private System.Windows.Forms.Layout.TableLayout TableLayout =>
            ((System.Windows.Forms.Layout.TableLayout) this.LayoutEngine);
        ...
        private class TableLayoutSettingsStub
        {
            ...
            public int GetColumn(object controlName) => 
                this.GetControlInformation(controlName).Column;

            public int GetColumnSpan(object controlName) => 
                this.GetControlInformation(controlName).ColumnSpan;
            ...
            public int GetRow(object controlName) => 
                this.GetControlInformation(controlName).Row;

            public int GetRowSpan(object controlName) => 
                this.GetControlInformation(controlName).RowSpan;
