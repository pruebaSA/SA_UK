namespace System.Windows.Forms
{
    ...
    internal class DataGridParentRows
    {
        ...
        {
            get => 
                this.dataGrid.ParentRowsVisible;
            set
            {
        ...
        internal protected class DataGridParentRowsAccessibleObject : AccessibleObject
        {
            ...
            public override AccessibleObject GetChild(int index) => 
                ((DataGridState) this.owner.parents[index]).ParentRowAccessibleObject;

            public override int GetChildCount() => 
                this.owner.parentsCount;
            ...
            public override Rectangle Bounds =>
                this.owner.dataGrid.RectangleToScreen(this.owner.dataGrid.ParentRowsBounds);

            public override string DefaultAction =>
                System.Windows.Forms.SR.GetString("AccDGNavigateBack");

            public override string Name =>
                System.Windows.Forms.SR.GetString("AccDGParentRows");

            internal DataGridParentRows Owner =>
                this.owner;

            public override AccessibleObject Parent =>
                this.owner.dataGrid.AccessibilityObject;
