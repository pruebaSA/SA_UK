namespace System.Windows.Forms
{
    ...
    public struct TableLayoutPanelCellPosition
    {
        ...
        public override string ToString() => 
            (this.Column.ToString(CultureInfo.CurrentCulture) + "," + this.Row.ToString(CultureInfo.CurrentCulture));

        public override int GetHashCode() => 
            WindowsFormsUtils.GetCombinedHashCodes(new int[] { this.row, this.column });
    }
}
