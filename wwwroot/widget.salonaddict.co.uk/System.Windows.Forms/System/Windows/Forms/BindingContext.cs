namespace System.Windows.Forms
{
    ...
    public class BindingContext : ICollection, IEnumerable
    {
        ...
        [System.Windows.Forms.SRDescription("collectionChangedEventDescr"), Browsable(false), EditorBrowsable(EditorBrowsableState.Never)]
        ...
        public bool Contains(object dataSource, string dataMember) => 
            this.listManagers.ContainsKey(this.GetKey(dataSource, dataMember));
        ...
        internal HashKey GetKey(object dataSource, string dataMember) => 
            new HashKey(dataSource, dataMember);
        ...
        public BindingManagerBase this[object dataSource, string dataMember] =>
            this.EnsureListManager(dataSource, dataMember);
        ...
        internal class HashKey
        {
            ...
            public override int GetHashCode() => 
                (this.dataSourceHashCode * this.dataMember.GetHashCode());
        }
    }
}
