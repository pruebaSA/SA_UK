<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Ticket-Alert-Delete.aspx.cs" Inherits="IFRAME.SecureArea.Ticket_Alert_DeletePage" %>
        ...
        <table class="details" cellpadding="0" cellspacing="0" >
           ...
           <tr>
              ...
              <td class="data-item" >
                  ...
                  <asp:Button ID="btnDelete" runat="server" SkinID="SubmitButtonSecure" OnClick="btnDelete_Click" Text="Confirm & Delete" />
              </td>
           </tr>
        </table>
    </asp:Panel>
