<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Scheduling-ReadOnly.aspx.cs" Inherits="IFRAME.SecureArea.Scheduling_ReadOnlyPage" %>
<%@ Register TagPrefix="IFRM" TagName="Menu" Src="~/SecureArea/Modules/Menu.ascx" %>
<%@ Register TagPrefix="IFRM" TagName="SchedulingLine" Src="~/SecureArea/Modules/SchedulingLineReadOnly.ascx" %>
        ...
        <table style="margin:-20px" cellpadding="0" cellspacing="20" >
           <tr>
              ...
              <td style="vertical-align:middle" >
                  <asp:Button ID="btnEdit" runat="server" SkinID="SubmitButtonSecure" OnClick="btnEdit_Click" meta:resourceKey="btnEdit" />
              </td>
           </tr>
        </table>
