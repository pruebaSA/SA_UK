<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Scheduling.aspx.cs" Inherits="IFRAME.SecureArea.Scheduling_Page" %>
<%@ Register TagPrefix="IFRM" TagName="Menu" Src="~/SecureArea/Modules/Menu.ascx" %>
<%@ Register TagPrefix="IFRM" TagName="SchedulingLine" Src="~/SecureArea/Modules/SchedulingLine.ascx" %>
        ...
        <table style="margin:-20px" cellpadding="0" cellspacing="20" >
           <tr>
              ...
              <td style="vertical-align:middle" >
                  <asp:Button ID="btnBack" runat="server" SkinID="SubmitButtonSecure" OnClick="btnBack_Click" meta:resourceKey="btnBack" />
              </td>
           </tr>
        </table>
               ...
               <tr>
                  ...
                  <td style="vertical-align:top;" >
                     <ul>
                        ...
                        <li>
                           <p><a href='<%= IFRMHelper.GetURL("opening-hours.aspx", String.Format("{0}={1}", Constants.QueryStrings.RETURN_URL, System.Web.HttpUtility.UrlEncode(Request.Url.PathAndQuery))) %>' ><b><u><%= base.GetLocaleResourceString("hlEditOpeningHours.Text") %></u></b></a></p>
                        </li>
                     </ul>
                  </td>
               </tr>
