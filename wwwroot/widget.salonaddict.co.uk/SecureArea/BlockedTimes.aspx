<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="BlockedTimes.aspx.cs" Inherits="IFRAME.SecureArea.BlockedTimesPage" %>
...
<%@ Register TagPrefix="IFRM" TagName="BlockedTimeLine" Src="~/SecureArea/Modules/BlockedTimeLine.ascx" %>
           ...
           <tr>
              ...
              <td style="vertical-align:middle" >
                 <% if(txtDate.Date.AddDays(-7) > DateTime.Today)
                    { %>
                 <a href='<%= IFRMHelper.GetURL("BlockedTimes.aspx", String.Format("{0}={1}", Constants.QueryStrings.DATE, IFRMHelper.ToUrlFriendlyDate(txtDate.Date.AddDays(-7)))) %>' >&lt;</a>
                 <% } %> 
                 <%= base.GetLocaleResourceString("hlWeek.Text") %> <a href='<%= IFRMHelper.GetURL("BlockedTimes.aspx", String.Format("{0}={1}", Constants.QueryStrings.DATE, IFRMHelper.ToUrlFriendlyDate(txtDate.Date.AddDays(7)))) %>' >&gt;</a>
              </td>
           </tr>
        </table>
           ...
           <tr>
              ...
              <td style="vertical-align:top;" >
                 <ul>
                    ...
                    <li><p><a href='<%= IFRMHelper.GetURL("scheduling-readonly.aspx") %>' ><b><u><%= base.GetLocaleResourceString("hlViewAvailability.Text") %></u></b></a></p></li>
                    <li><p><a href='<%= IFRMHelper.GetURL("opening-hours.aspx", String.Format("{0}={1}", Constants.QueryStrings.RETURN_URL, System.Web.HttpUtility.UrlEncode(Request.Url.PathAndQuery))) %>' ><b><u><%= base.GetLocaleResourceString("hlEditOpeningHours.Text") %></u></b></a></p></li>
                 </ul>
              </td>
           </tr>
        </table>
