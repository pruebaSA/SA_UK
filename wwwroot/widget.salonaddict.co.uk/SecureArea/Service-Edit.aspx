<%@ Page Language="C#" MasterPageFile="~/MasterPages/OneColumn.master" AutoEventWireup="true" CodeBehind="Service-Edit.aspx.cs" Inherits="IFRAME.SecureArea.Service_EditPage" %>
                      ...
                      <td style="width:500px" >
                        <table style="margin-top:10px" class="details" cellpadding="0" cellspacing="0" >
                           ...
                           <tr>
                              ...
                              <td class="data-item" >
                                 <asp:TextBox ID="txtDescription" runat="server" SkinID="TextBox" Width="270px" MaxLength="200" ></asp:TextBox>
                              </td>
                           </tr>
                           <tr>
