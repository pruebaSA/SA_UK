<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SchedulingLineReadOnly.ascx.cs" EnableViewState="false" Inherits="IFRAME.SecureArea.Modules.SchedulingLineReadOnly" %>
