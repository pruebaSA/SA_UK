namespace System.Configuration
{
    ...
    internal sealed class ClientConfigurationSystem : IInternalConfigSystem
    {
        ...
        private bool DoesSectionOnlyUseMachineConfig(string configKey) => 
            (this._isAppConfigHttp && configKey.StartsWith("system.net/", StringComparison.Ordinal));
        ...
        private void EnsureInit(string configKey)
        {
            ...
            if (flag)
            {
                try
                {
                    ...
                    {
                        this._initError = new ConfigurationErrorsException(System.Configuration.SR.GetString("Config_client_config_init_error"));
                        throw this._initError;
                    }
                }
                catch
        ...
        private bool IsSectionUsedInInit(string configKey) => 
            ((configKey == "system.diagnostics") || (this._isAppConfigHttp && configKey.StartsWith("system.net/", StringComparison.Ordinal)));
