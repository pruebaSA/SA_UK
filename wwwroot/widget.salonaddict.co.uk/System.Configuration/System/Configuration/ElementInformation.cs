namespace System.Configuration
{
    ...
    public sealed class ElementInformation
    {
        ...
        internal PropertySourceInfo PropertyInfoInternal() => 
            this._thisElement.PropertyInfoInternal(this._thisElement.ElementTagName);
        ...
        public bool IsLocked =>
            (((this._thisElement.ItemLocked & ConfigurationValueFlags.Locked) != ConfigurationValueFlags.Default) && ((this._thisElement.ItemLocked & ConfigurationValueFlags.Inherited) != ConfigurationValueFlags.Default));

        public bool IsPresent =>
            this._thisElement.ElementPresent;
        ...
        public System.Type Type =>
            this._thisElement.GetType();

        public ConfigurationValidatorBase Validator =>
            this._thisElement.ElementProperty.Validator;
    }
}
