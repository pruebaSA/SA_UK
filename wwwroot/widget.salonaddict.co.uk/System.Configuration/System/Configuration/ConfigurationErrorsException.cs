namespace System.Configuration
{
    ...
    public class ConfigurationErrorsException : ConfigurationException
    {
        ...
        public static string GetFilename(XmlNode node) => 
            SafeFilename(GetUnsafeFilename(node));

        public static string GetFilename(XmlReader reader) => 
            SafeFilename(GetUnsafeFilename(reader));
        ...
        public static int GetLineNumber(XmlNode node) => 
            GetConfigErrorInfoLineNumber(node as IConfigErrorInfo);

        public static int GetLineNumber(XmlReader reader) => 
            GetConfigErrorInfoLineNumber(reader as IConfigErrorInfo);
        ...
        private static string GetUnsafeFilename(XmlNode node) => 
            GetUnsafeConfigErrorInfoFilename(node as IConfigErrorInfo);

        private static string GetUnsafeFilename(XmlReader reader) => 
            GetUnsafeConfigErrorInfoFilename(reader as IConfigErrorInfo);
        ...
        internal ICollection<ConfigurationException> ErrorsGeneric =>
            ((ICollection<ConfigurationException>) this.Errors);

        public override string Filename =>
            SafeFilename(this._firstFilename);
