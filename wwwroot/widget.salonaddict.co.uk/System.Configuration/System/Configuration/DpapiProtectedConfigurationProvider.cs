    ...
    public sealed class DpapiProtectedConfigurationProvider : ProtectedConfigurationProvider
    {
        ...
        private string DecryptText(string encText)
        {
            ...
            try
            {
                ...
                {
                    flag = Microsoft.Win32.UnsafeNativeMethods.CryptUnprotectData(ref data_blob, ref description, ref data_blob2, IntPtr.Zero, ref promptStruct, flags, ref data_blob3);
                ...
                str2 = Encoding.Unicode.GetString(destination);
            }
            finally
            {
        ...
        private static DATA_BLOB PrepareDataBlob(string s) => 
            PrepareDataBlob((s != null) ? Encoding.Unicode.GetBytes(s) : new byte[0]);
