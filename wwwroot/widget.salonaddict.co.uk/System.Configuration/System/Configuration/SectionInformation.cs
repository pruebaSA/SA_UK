namespace System.Configuration
{
    ...
    public sealed class SectionInformation
    {
        ...
        internal bool AllowLocationModified =>
            this._modifiedFlags[8];

        public bool AllowOverride
        {
            get => 
                this._overrideMode.AllowOverride;
            set
            {
                this.VerifyIsEditable();
        ...
        private bool IsDefinitionAllowed =>
            ((this._configRecord == null) || this._configRecord.IsDefinitionAllowed(this._allowDefinition, this._allowExeDefinition));
        ...
        public bool IsProtected =>
            (this.ProtectionProvider != null);

        private bool IsRuntime =>
            (this._flags[1] && (this._configRecord == null));

        internal bool LocationAttributesAreDefault =>
            (this._overrideMode.IsDefaultForLocationTag && this._flags[0x100]);
        ...
        {
            get => 
                this._overrideModeDefault.OverrideMode;
            set
            {
                this.VerifyIsEditable();
                this.VerifyIsEditableFactory();
