namespace System.Configuration
{
    ...
    internal struct OverrideModeSetting
    {
        ...
        internal bool IsDefaultForLocationTag =>
            (((LocationDefault.OverrideMode == this.OverrideMode) && ((this._mode & 0x30) == 0)) && ((this._mode & 0xc0) == 0));
        internal bool IsLocked =>
            (this.OverrideMode == System.Configuration.OverrideMode.Deny);
        ...
        {
            get => 
                (((System.Configuration.OverrideMode) this._mode) & ((System.Configuration.OverrideMode) 15));
            set
            {
