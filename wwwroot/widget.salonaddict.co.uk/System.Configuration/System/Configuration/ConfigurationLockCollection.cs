namespace System.Configuration
{
    ...
    public sealed class ConfigurationLockCollection : ICollection, IEnumerable
    {
        ...
        public bool Contains(string name) => 
            ((this._bExceptionList && name.Equals(this._ignoreName)) || this.internalDictionary.Contains(name));
        ...
        public IEnumerator GetEnumerator() => 
            this.internalArraylist.GetEnumerator();
        ...
        internal bool IsValueModified(string name) => 
            (this.internalDictionary.Contains(name) && ((((ConfigurationValueFlags) this.internalDictionary[name]) & ConfigurationValueFlags.Modified) != ConfigurationValueFlags.Default));
        ...
        public int Count =>
            this.internalDictionary.Count;

        internal bool ExceptionList =>
            this._bExceptionList;
