namespace System.Configuration
{
    ...
    internal class ConfigurationSchemaErrors
    {
        ...
        internal int GlobalErrorCount =>
            ErrorsHelper.GetErrorCount(this._errorsGlobal);

        private bool HasAllErrors =>
            ErrorsHelper.GetHasErrors(this._errorsAll);

        internal bool HasGlobalErrors =>
            ErrorsHelper.GetHasErrors(this._errorsGlobal);

        internal bool HasLocalErrors =>
            ErrorsHelper.GetHasErrors(this._errorsLocal);
    }
}
