namespace PdfSharp.SharpZipLib.Zip.Compression
{
    ...
    internal class DeflaterHuffman
    {
        ...
        {
            this.literalTree.freqs[EOF_SYMBOL] = (short) (this.literalTree.freqs[EOF_SYMBOL] + 1);
        ...
        internal class Tree
        {
            ...
            public void BuildCodes()
            {
                ...
                if (DeflaterConstants.DEBUGGING && (num != 0x10000))
                {
            ...
            public void CalcBLFreq(DeflaterHuffman.Tree blTree)
            {
                ...
                while (num5 < this.numCodes)
                {
                    ...
                    else
                    {
                        if (index != 0)
                        {
                            blTree.freqs[DeflaterHuffman.REP_3_6] = (short) (blTree.freqs[DeflaterHuffman.REP_3_6] + 1);
                            continue;
                        }
                        if (num3 <= 10)
                        {
                            blTree.freqs[DeflaterHuffman.REP_3_10] = (short) (blTree.freqs[DeflaterHuffman.REP_3_10] + 1);
                            continue;
                        }
                        blTree.freqs[DeflaterHuffman.REP_11_138] = (short) (blTree.freqs[DeflaterHuffman.REP_11_138] + 1);
                    }
                }
            }
