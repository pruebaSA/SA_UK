namespace System.EnterpriseServices.CompensatingResourceManager
{
    ...
    internal class CrmMonitor
    {
        ...
        public unsafe CrmMonitor()
        {
            ...
            int errorCode = CoCreateInstance(&CLSID_CRMRecoveryClerk, null, 0x15, &IID_ICrmMonitor, (void**) &monitorPtr);
            if (errorCode < 0)
            {
        ...
        public unsafe object GetClerks()
        {
            ...
            int errorCode = **(((int*) monitorPtr))[12](monitorPtr, &clerksPtr);
            if (errorCode < 0)
            {
                Marshal.ThrowExceptionForHR(errorCode);
            }
        ...
        public unsafe CrmLogControl HoldClerk(object idx)
        {
            ...
            ICrmMonitor* monitorPtr = this._pMon;
            int errorCode = **(((int*) monitorPtr))[0x10](monitorPtr, gvariant, &gvariant2);
