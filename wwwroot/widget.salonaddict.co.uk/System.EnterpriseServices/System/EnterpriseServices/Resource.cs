namespace System.EnterpriseServices
{
    ...
    internal static class Resource
    {
        ...
        internal static string FormatString(string key, object a1) => 
            string.Format(CultureInfo.CurrentCulture, GetString(key), new object[] { a1 });

        internal static string FormatString(string key, object a1, object a2) => 
            string.Format(CultureInfo.CurrentCulture, GetString(key), new object[] { a1, a2 });

        internal static string FormatString(string key, object a1, object a2, object a3) => 
            string.Format(CultureInfo.CurrentCulture, GetString(key), new object[] { a1, a2, a3 });
