namespace System.EnterpriseServices
{
    ...
    [AttributeUsage(AttributeTargets.Interface | AttributeTargets.Method | AttributeTargets.Class | AttributeTargets.Assembly, Inherited=true, AllowMultiple=true), ComVisible(false)]
    public sealed class SecurityRoleAttribute : Attribute, IConfigurationAttribute
    {
        ...
        private void AddRoleFor(string target, Hashtable cache)
        {
            ...
            {
                ((IRoleAssociationUtil) collection.GetUtilInterface()).AssociateRoleByName(this._role);
            }
            else if (this.Search(collection, "Name", this._role) == null)
            {
