namespace System.EnterpriseServices
{
    ...
    internal class ComponentConfigCallback : IConfigCallback
    {
        ...
        public bool AfterSaveChanges(object a, object key) => 
            this._driver.AfterSaveChanges((Type) key, (ICatalogObject) a, this._coll, "Component", this._cache);

        public bool Configure(object a, object key) => 
            this._driver.ConfigureObject((Type) key, (ICatalogObject) a, this._coll, "Component", this._cache);
        ...
        public void ConfigureDefaults(object a, object key)
        {
            ...
            {
                obj2.SetValue("Transaction", "Not Supported");
                obj2.SetValue("SecurityEnabled", "N");
            }
            else
            {
        ...
        public IEnumerator GetEnumerator() => 
            this._spec.ConfigurableTypes.GetEnumerator();
    }
}
