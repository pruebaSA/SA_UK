namespace System.EnterpriseServices.Thunk
{
    ...
    internal class ContextThunk
    {
        ...
        public static unsafe void DisableCommit()
        {
            ...
            int context = GetContext(&IID_IObjectContext, (void**) &contextPtr);
        ...
        public static unsafe bool GetDeactivateOnReturn()
        {
            ...
            int context = GetContext(&IID_IContextState, (void**) &statePtr);
        ...
        public static unsafe object GetTransaction()
        {
            ...
            int context = GetContext(&IID_IObjectContextInfo, (void**) &infoPtr);
        ...
        {
            IContextTransactionInfoPrivate* privatePtr = null;
            int context = GetContext(&_GUID_7d40fcc8_f81e_462e_bba1_8a99ebdc826c, (void**) &privatePtr);
            if (context >= 0)
            {
                try
                {
