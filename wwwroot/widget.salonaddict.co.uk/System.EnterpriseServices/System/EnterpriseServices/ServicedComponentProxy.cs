namespace System.EnterpriseServices
{
    ...
    internal class ServicedComponentProxy : RealProxy, IProxyInvoke, IManagedPoolAction
    {
        ...
        public override ObjRef CreateObjRef(Type requestedType) => 
            new ServicedComponentMarshaler((MarshalByRefObject) this.GetTransparentProxy(), requestedType);
            ...
            if (this._fDeliverADC)
            {
                ...
                catch
                {
                    try
                    {
                        ...
                        string str2 = Resource.FormatString("Err_ActivationFailed", Resource.FormatString("Err_NonClsException", "ServicedComponentProxy.DispatchActivate"));
        ...
        private bool IsRealCall(MethodBase mb) => 
            ((((mb != _internalDeactivateMethod) && (mb != _initializeLifetimeServiceMethod)) && ((mb != _getLifetimeServiceMethod) && (mb != _getComIUnknownMethod))) && (((mb != _setCOMIUnknownMethod) && (mb != _getTypeMethod)) && (mb != _getHashCodeMethod)));
