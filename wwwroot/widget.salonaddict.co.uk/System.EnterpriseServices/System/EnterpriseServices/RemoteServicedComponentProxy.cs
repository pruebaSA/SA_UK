namespace System.EnterpriseServices
{
    ...
    internal class RemoteServicedComponentProxy : RealProxy
    {
        ...
        public override IMessage Invoke(IMessage reqMsg)
        {
            ...
            {
                if ((exception.ErrorCode != Util.CONTEXT_E_ABORTED) && (exception.ErrorCode != Util.CONTEXT_E_ABORTING))
                {
                    throw;
                }
                ...
                IMethodCallMessage message4 = reqMsg as IMethodCallMessage;
                message = new ReturnMessage(null, null, 0, message4.LogicalCallContext, message4);
            }
            if (this.IsDisposeRequest(reqMsg))
            {
                this.Dispose(true);
